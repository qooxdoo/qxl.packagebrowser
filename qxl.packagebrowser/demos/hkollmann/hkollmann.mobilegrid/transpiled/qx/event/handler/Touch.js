  ...
  qx.Class.define("qx.event.handler.Touch", {
    ...
    */
    ...
    construct: function construct(manager) {
      ...
      this.__P_162_2 = this.__P_162_1.document;
      qx.event.handler.TouchCore.apply(this, [this.__P_162_2]);
    },
    /*
    *****************************************************************************
       STATICS
    ...
    members: {
      ...
      */
      ...
      _fireEvent: function _fireEvent(domEvent, type, target, eventTypeClass) {
        ...
        qx.event.Registration.fireEvent(this.__P_162_1, "useraction", qx.event.type.Data, [type]);
      },
      /*
      ---------------------------------------------------------------------------
      ...
      */
      ...
      dispose: function dispose() {
        this.__P_162_4("dispose");
        this.__P_162_0 = this.__P_162_1 = this.__P_162_2 = null;
      },
      /**
       ...
       */
      __P_162_4: function __P_162_4(method, args) {
