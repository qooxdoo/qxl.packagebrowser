  ...
  qx.Class.define("qx.event.handler.Touch", {
    ...
    */
    ...
    construct: function construct(manager) {
      ...
      qx.event.handler.TouchCore.apply(this, [this.__P_158_2]);
    },
    /*
    *****************************************************************************
       STATICS
    ...
    members: {
      ...
      */
      ...
      _fireEvent: function _fireEvent(domEvent, type, target, eventTypeClass) {
        ...
        qx.event.Registration.fireEvent(this.__P_158_1, "useraction", qx.event.type.Data, [type]);
      },
      /*
      ---------------------------------------------------------------------------
      ...
      */
       ...
       */
      __P_158_4: function __P_158_4(method, args) {
