  ...
  ************************************************************************ */
  ...
  qx.Bootstrap.define("qx.bom.element.AnimationHandle", {
    ...
    construct: function construct() {
      ...
      this.__P_258_0 = css && css["play-state"];
      this.__P_258_1 = true;
      this.addListenerOnce("end", this.__P_258_2, this);
    },
    events: {
    ...
    members: {
      ...
      isPaused: function isPaused() {
        return this.el.style[this.__P_258_0] == "paused";
      },
      /**
      ...
      pause: function pause() {
        if (this.el) {
          this.el.style[this.__P_258_0] = "paused";
          this.el.$$animation.__P_258_1 = false;
      ...
      play: function play() {
        if (this.el) {
          this.el.style[this.__P_258_0] = "running";
          this.el.$$animation.__P_258_1 = true;
          // in case the animation is based on JS
      ...
      stop: function stop() {
        if (this.el && qx.core.Environment.get("css.animation") && !this.jsAnimation) {
          this.el.style[this.__P_258_0] = "";
          this.el.style[qx.core.Environment.get("css.animation").name] = "";
          this.el.$$animation.__P_258_1 = false;
          this.el.$$animation.__P_258_3 = true;
        }
        // in case the animation is based on JS
