  ...
  qx.Bootstrap.define("qx.bom.client.Engine", {
    ...
    statics: {
      ...
      getVersion: function getVersion() {
        ...
        var version = "";
        if (qx.bom.client.Engine.__P_32_0()) {
        ...
        } else if (qx.bom.client.Engine.__P_32_1()) {
        ...
        } else if (qx.bom.client.Engine.__P_32_2()) {
        ...
        } else if (qx.bom.client.Engine.__P_32_3()) {
      ...
      __P_32_0: function __P_32_0() {
        ...
        if (qx.bom.client.Engine.__P_32_4()) {
          return true;
        }
        return false;
      },
