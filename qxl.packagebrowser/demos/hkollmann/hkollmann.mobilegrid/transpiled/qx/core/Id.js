  ...
  qx.Class.define("qx.core.Id", {
    ...
    members: {
      ...
      getAbsoluteIdOf: function getAbsoluteIdOf(obj, suppressWarnings) {
        if (this.__P_124_1 && this.__P_124_1[obj.toHashCode()]) {
        ...
        while (obj) {
          ...
          if (owner) {
            ...
            if (owner === application) {
              ...
              ownerId = this.__P_124_1 && this.__P_124_1[owner.toHashCode()] || null;
            }
      ...
      register: function register(obj, id) {
        ...
        this.__P_124_0[id] = obj;
        this.__P_124_1[obj.toHashCode()] = id;
