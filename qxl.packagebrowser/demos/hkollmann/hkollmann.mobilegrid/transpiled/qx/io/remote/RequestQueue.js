  ...
  qx.Class.define("qx.io.remote.RequestQueue", {
    ...
    */
    construct: function construct() {
      ...
      // timeout handling
      this.__P_248_3 = new qx.event.Timer(500);
    ...
    members: {
      ...
      */
      ...
      _check: function _check() {
        ...
        if (this.__P_248_1.length == 0 && this.__P_248_0.length == 0) {
          this.__P_248_3.stop();
        }
        ...
        if (this.__P_248_0.length == 0 || this.__P_248_0[0].isAsynchronous() && this.__P_248_1.length >= this.getMaxConcurrentRequests()) {
          return;
        }

        // Checking number of total requests
        if (this.getMaxTotalRequests() != null && this.__P_248_2 >= this.getMaxTotalRequests()) {
          return;
        }
        var vRequest = this.__P_248_0.shift();
        ...
        // Add to active queue
        this.__P_248_1.push(vTransport);
      ...
      _remove: function _remove(vTransport) {
        ...
        qx.lang.Array.remove(this.__P_248_1, vTransport);
      ...
      */
      ...
      _applyEnabled: function _applyEnabled(value, old) {
        ...
        this.__P_248_3.setEnabled(value);
      },
      /*
      ---------------------------------------------------------------------------
        CORE METHODS
      ...
      */
      ...
      add: function add(vRequest) {
        ...
        if (vRequest.isAsynchronous()) {
          this.__P_248_0.push(vRequest);
        } else {
          this.__P_248_0.unshift(vRequest);
        }
        this._check();
        if (this.getEnabled()) {
      ...
      abort: function abort(vRequest) {
        ...
        if (vTransport) {
          vTransport.abort();
        } else if (this.__P_248_0.includes(vRequest)) {
          qx.lang.Array.remove(this.__P_248_0, vRequest);
        }
      }
    },
    /*
