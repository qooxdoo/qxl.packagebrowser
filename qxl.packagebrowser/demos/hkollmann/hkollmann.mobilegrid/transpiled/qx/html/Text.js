  ...
  qx.Class.define("qx.html.Text", {
    ...
    members: {
      ...
      _createDomElement: function _createDomElement() {
        return window.document.createTextNode(this.__P_123_0 || "");
      },
      /*
       * @Override
       */
      ...
      _serializeImpl: function _serializeImpl(serializer) {
        serializer.rawTextInBody(this.__P_123_0);
      },
      /**
       * @Override
       */
    ...
    defer: function defer(statics) {
      statics.__P_123_1 = new qx.util.DeferredCall(statics.flush, statics);
    },
    /*
     * ****************************************************************************
     * DESTRUCT
    ...
    destruct: function destruct() {
      ...
      this.__P_123_2 = this.__P_123_3 = this.__P_123_4 = this.__P_123_5 = this.__P_123_6 = this.__P_123_7 = this.__P_123_8 = null;
    }
  });
