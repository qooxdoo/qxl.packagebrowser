  ...
  qx.Class.define("qx.ui.root.Application", {
    ...
    */
    ...
    construct: function construct(doc) {
      // Symbolic links
      this.__P_32_0 = qx.dom.Node.getWindow(doc);
      this.__P_32_1 = doc;
      ...
      // Resize handling
      qx.event.Registration.addListener(this.__P_32_0, "resize", this._onResize, this);
      ...
      this.addListener("touchmove", this.__P_32_2, this);
    ...
    */
    ...
    members: {
      ...
      _computeSizeHint: function _computeSizeHint() {
        var width = qx.bom.Viewport.getWidth(this.__P_32_0);
        var height = qx.bom.Viewport.getHeight(this.__P_32_0);
        return {
          minWidth: width,
          width: width,
          maxWidth: width,
    ...
    */
    destruct: function destruct() {
      this.__P_32_0 = this.__P_32_1 = null;
    }
  });
