    ...
    members: {
      ...
      */
      ...
      __P_41_2: function __P_41_2() {
        ...
        if (!menuBounds) {
          this.addListenerOnce("resize", this.__P_41_2, this);
          return;
        }
      ...
      syncWidget: function syncWidget(jobs) {
        ...
        if (this.__P_41_1) {
          this.__P_41_1.call(this);
          delete this.__P_41_1;
        }
      },
      /*
      ---------------------------------------------------------------------------
