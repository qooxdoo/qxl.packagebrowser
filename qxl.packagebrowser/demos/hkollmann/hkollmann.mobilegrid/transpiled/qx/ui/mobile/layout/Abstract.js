    ...
    members: {
      ...
      connectToWidget: function connectToWidget(widget) {
        ...
        if (widget) {
          ...
          if (this.__P_167_0) {
            for (var property in this.__P_167_0) {
              this.reset(property);
              this.set(property, this.__P_167_0[property]);
            }
          }
        } else {
          this.__P_167_0 = null;
      ...
      _getChildLayoutPropertyValue: function _getChildLayoutPropertyValue(widget, property) {
        var cache = this.__P_167_2(widget);
       ...
       *     Key / value pairs.
       */
      __P_167_2: function __P_167_2(widget) {
        if (!this.__P_167_1) {
          this.__P_167_1 = {};
        }
