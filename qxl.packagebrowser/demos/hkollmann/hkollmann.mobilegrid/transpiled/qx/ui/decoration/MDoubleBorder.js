  ...
  ************************************************************************ */
  ...
  qx.Mixin.define("qx.ui.decoration.MDoubleBorder", {
    ...
    construct: function construct() {
      ...
      this._getDefaultInsetsForBorder = this.__P_184_0;
      this._styleBorder = this.__P_184_1;
    },
    /*
    *****************************************************************************
       PROPERTIES
    ...
    */
    ...
    members: {
       ...
       */
      __P_184_1: function __P_184_1(styles) {
        ...
        if (innerOpacity < 1) {
          this.__P_184_2(innerColor, innerOpacity);
        }
       ...
       */
      __P_184_2: function __P_184_2(innerColor, innerOpacity) {
