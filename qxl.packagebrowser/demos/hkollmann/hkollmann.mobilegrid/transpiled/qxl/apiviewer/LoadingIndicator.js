  ...
  ************************************************************************ */
  qx.Class.define("qxl.apiviewer.LoadingIndicator", {
    ...
    construct: function construct() {
      this.__P_72_0 = new qx.ui.core.Blocker(qxl.apiviewer.MWidgetRegistry.getWidgetById("tabView"));
      this.__P_72_0.setColor("#D5D5D5");
      this.__P_72_0.setOpacity(0.5);
