  ...
  ************************************************************************ */
  ...
  qx.Class.define("qxl.apiviewer.ui.panels.PropertyPanel", {
    ...
    members: {
      ...
      __P_252_0: function __P_252_0(node, currentClassDocNode) {
        if (node.isRefined()) {
          return "";
        }
        if (node.isPrivate()) {
      ...
      __P_252_1: function __P_252_1(node) {
        var attributes = [];
        if (node.isNullable()) {
       ...
       */
      __P_252_2: function __P_252_2(node) {
        if (node.isRefined()) {
      ...
      getItemTextHtml: function getItemTextHtml(node, currentClassDocNode, showDetails) {
        ...
        if (showDetails) {
          ...
          textHtml.add(this.__P_252_1(node));
          textHtml.add(this.__P_252_0(node, currentClassDocNode));
          textHtml.add(qxl.apiviewer.ui.panels.InfoPanel.createIncludedFromHtml(node, currentClassDocNode));
          textHtml.add(this.__P_252_2(node));
