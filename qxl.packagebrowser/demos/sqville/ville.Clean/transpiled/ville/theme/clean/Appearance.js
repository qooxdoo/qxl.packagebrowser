(function () {
  var $$dbClassInfo = {
    "dependsOn": {
      ...
      "ville.theme.clean.MImage": {
        "require": true
      },
      "ville.theme.clean.MButton": {
        "require": true
      },
      "ville.theme.clean.MHeaderCell": {
        "require": true
      },
      "qx.ui.tree.core.AbstractItem": {
        "require": true
      },
      "ville.theme.clean.MTreeItem": {
        "require": true
      },
      "qx.Theme": {
        "usage": "dynamic",
      ...
      */
      ...
      "scrollbar/button": {
        style: function style(states) {
          ...
          styles.icon = "", styles.iconDec = "ville-icon-arrow-" + icon, styles.cursor = "pointer";
