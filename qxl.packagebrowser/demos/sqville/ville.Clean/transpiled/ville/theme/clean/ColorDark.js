  ...
  ************************************************************************ */
  ...
  qx.Theme.define("ville.theme.clean.ColorDark", {
    colors: {
      ...
      "group-item": "#ffffff",
      // scrollbar
      "scrollbar-bright": "#292929",
      //"#F1F1F1",
      "scrollbar-dark": "#1f1f1f",
      //"#EBEBEB",
      ...
      "button-box-bright": "#292929",
      //"#e0e1e2",
      "button-box-bright-hovered": "#3d3d3d",
      //"#cacbcd",
      "button-box-dark": "#E3E3E3",
      "button-box-bright-pressed": "#1f1f1f",
      //"#babbbc",
      "button-box-bright-checked": "#383838",
      "button-box-dark-pressed": "#F5F5F5",
      "border-lead": "rgb(102, 102, 102)",
      //"#888888",
      "button-text": "#ffffff",
      //"rgba(0, 0, 0, 0.6)",
      ...
      // window
      "window-border": "rgb(102, 102, 102)",
      //"#2E3A46",
      "window-border-inner": "rgb(102, 102, 102)",
      //"white",
      "window-minimize-button": "gray",
      "window-minimize-button-hovered": "white",
      // group box
      "white-box-border": "rgb(102, 102, 102)",
      //"#D8D8D8",
      ...
      // text
      "text-combobox-listitem": "rgba(255, 255, 255, 0.6)",
      //NOT USED
      "text": "#ffffff",
      //"rgba(0, 0, 0, 0.8)",
      ...
      "tooltip-text": "#000000",
      // table
      "table-border": "rgb(102, 102, 102)",
      //"#858585",
      "table-header": "rgb(41, 41, 41)",
      //"#F9FAFB",
      "table-focus-indicator": [179, 217, 255],
      // used in table code
      "table-header-cell": "rgb(41, 41, 41)",
      //[ 235, 234, 219 ],
      ...
      "table-row-background-even": "rgb(41, 41, 41)",
      //"#ffffff",
      "table-row-background-odd": "rgb(41, 41, 41)",
      //"#ffffff",
      "table-row-selected": [255, 255, 255],
      "table-row": "#ffffff",
      "table-row-line": "rgb(102, 102, 102)",
      //"#EEE",
      "table-column-line": "rgb(102, 102, 102)",
      //"#EEE",
  ...
  ville.theme.clean.ColorDark.$$dbClassInfo = $$dbClassInfo;
})();
