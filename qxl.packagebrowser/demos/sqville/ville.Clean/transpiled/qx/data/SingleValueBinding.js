  ...
  qx.Class.define("qx.data.SingleValueBinding", {
    statics: {
      ...
      bind: function bind(sourceObject, sourcePropertyChain, targetObject, targetPropertyChain, options) {
        ...
        var targetListenerMap = this.__P_168_2(sourceObject, sourcePropertyChain, targetObject, targetPropertyChain, options);
        ...
        try {
          ...
          for (var i = 0; i < propertyNames.length; i++) {
            ...
            if (i == propertyNames.length - 1) {
              ...
              // create a listener
              var listener = qx.lang.Function.bind(this.__P_168_7, this, context);
      ...
      __P_168_4: function __P_168_4(source, propertyName) {
        ...
        var eventName = this.__P_168_14(source, propertyName);
      ...
      __P_168_5: function __P_168_5(value, targetObject, targetPropertyChain, options, sourceObject) {
        ...
        value = this.__P_168_11(value, targetObject, targetPropertyChain, options, sourceObject);
        ...
        if (value !== undefined) {
          try {
            var result = this.__P_168_9(targetObject, targetPropertyChain, value);
      ...
      __P_168_6: function __P_168_6(sourceObject, sourceEvent, targetObject, targetProperty, options, arrayIndex) {
        ...
        var bindListener = function bindListener(arrayIndex, e) {
          ...
          // convert the data
          data = qx.data.SingleValueBinding.__P_168_11(data, targetObject, targetProperty, options, sourceObject);
      ...
      __P_168_8: function __P_168_8(id, sourceObject, sourceEvent, targetObject, targetProperty) {
        ...
        this.__P_168_0[hash].push(binding);
      ...
      getAllBindingsForObject: function getAllBindingsForObject(object) {
        ...
        var sourceBindings = this.__P_168_0[hash];

        // get all bindings of object as target
        var targetBindings = this.__P_168_1[hash];
