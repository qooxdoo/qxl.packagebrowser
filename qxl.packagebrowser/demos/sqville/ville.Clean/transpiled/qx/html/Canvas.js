  ...
  qx.Class.define("qx.html.Canvas", {
    ...
    */
    ...
    construct: function construct(styles, attributes) {
      ...
      this.__P_84_0 = document.createElement("canvas");
    },
    /*
    *****************************************************************************
       MEMBERS
    ...
    */
    ...
    members: {
      ...
      getContext2d: function getContext2d() {
        return this.__P_84_0.getContext("2d");
      }
    }
  });
