  ...
  qx.Class.define("qx.ui.core.queue.Widget", {
    statics: {
      ...
      remove: function remove(widget, job) {
        ...
        if (this.__P_144_1[hash]) {
          delete this.__P_144_1[hash][job];
          if (qx.lang.Object.getLength(this.__P_144_1[hash]) == 0) {
            qx.lang.Array.remove(queue, widget);
          }
        }
      },
      ...
      flush: function flush() {
        ...
        for (var i = queue.length - 1; i >= 0; i--) {
          ...
          obj = queue[i];
          jobs = this.__P_144_1[obj.toHashCode()];
          queue.splice(i, 1);
          obj.syncWidget(jobs);
        }
