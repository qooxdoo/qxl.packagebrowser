  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.ui.virtual.core.Axis", {
    ...
    members: {
       ...
       */
      __P_268_2: function __P_268_2(position) {
        var ranges = this.__P_268_0 || this.__P_268_1();
        var start = 0;
      ...
      getItemAtPosition: function getItemAtPosition(position) {
        ...
        var range = this.__P_268_2(position);
       ...
       */
      __P_268_3: function __P_268_3(index) {
        var ranges = this.__P_268_0 || this.__P_268_1();
        var start = 0;
        var end = ranges.length - 1;
      ...
      getItemPosition: function getItemPosition(index) {
        ...
        var range = this.__P_268_3(index);
    ...
    destruct: function destruct() {
      this.customSizes = this.__P_268_0 = null;
    }
  });
