  ...
  qx.Mixin.define("qx.ui.list.core.MWidgetController", {
    ...
    members: {
      ...
      bindPropertyReverse: function bindPropertyReverse(targetPath, sourceProperty, options, sourceWidget, index) {
        ...
        var bindPath = this.__P_232_1(index, targetPath, type);
        var id = sourceWidget.bind(sourceProperty, this._list, bindPath, options);
        this.__P_232_2(sourceWidget, id);
      },
      /**
       * Remove all bindings from all bounded items.
       */
      removeBindings: function removeBindings() {
        while (this.__P_232_0.length > 0) {
          var item = this.__P_232_0.pop();
      ...
      _removeBindingsFrom: function _removeBindingsFrom(item) {
        var bindings = this.__P_232_3(item);
        ...
        if (this.__P_232_0.includes(item)) {
          qx.lang.Array.remove(this.__P_232_0, item);
        }
      },
      /**
       ...
       */
      __P_232_1: function __P_232_1(index, path, type) {
       ...
       */
      __P_232_2: function __P_232_2(widget, id) {
        var bindings = this.__P_232_3(widget);
        if (!bindings.includes(id)) {
          bindings.push(id);
        }
        if (!this.__P_232_0.includes(widget)) {
          this.__P_232_0.push(widget);
        }
      },
      /**
