    ...
    members: {
      ...
      */
      ...
      _onPointerDown: function _onPointerDown(e) {
        ...
        var isHorizontal = this.__P_114_13;
        ...
        var sliderLocation = this.__P_114_0 = qx.bom.element.Location.get(this.getContentElement().getDomElement())[locationProperty];
        sliderLocation += padding;
        var knobLocation = this.__P_114_1 = qx.bom.element.Location.get(knob.getContentElement().getDomElement())[locationProperty];
        if (e.getTarget() === knob) {
          // Switch into drag mode
          this.__P_114_3 = true;
          if (!this.__P_114_9) {
            // create a timer to fire delayed dragging events if dragging stops.
            this.__P_114_9 = new qx.event.Timer(100);
            this.__P_114_9.addListener("interval", this._fireValue, this);
          }
          this.__P_114_9.start();
          // Compute dragOffset (includes both: inner position of the widget and
          // cursor position on knob)
          this.__P_114_4 = cursorLocation + sliderLocation - knobLocation;
          ...
          this.__P_114_6 = cursorLocation <= knobLocation ? -1 : 1;
          ...
          if (!this.__P_114_8) {
            this.__P_114_8 = new qx.event.Timer(100);
            this.__P_114_8.addListener("interval", this._onInterval, this);
          }

          // Start timer
          this.__P_114_8.start();
        }
      ...
      _onPointerUp: function _onPointerUp(e) {
        if (this.__P_114_3) {
          ...
          if (e.getType() === "pointerup") {
            ...
            var positionSlider;
            if (this.__P_114_13) {
              deltaSlider = e.getDocumentLeft() - (this._valueToPosition(this.getValue()) + this.__P_114_0);
              ...
              deltaSlider = e.getDocumentTop() - (this._valueToPosition(this.getValue()) + this.__P_114_0);
            ...
            if (deltaPosition < 0 || deltaPosition > this.__P_114_2 || deltaSlider < 0 || deltaSlider > this.__P_114_2) {
              this.getChildControl("knob").removeState("hovered");
            }
          }
        } else if (this.__P_114_5) {
          // Stop timer interval
          this.__P_114_8.stop();
      ...
      _onPointerMove: function _onPointerMove(e) {
        if (this.__P_114_3) {
          var dragStop = this.__P_114_13 ? e.getDocumentLeft() : e.getDocumentTop();
          var position = dragStop - this.__P_114_4;
      ...
      _onInterval: function _onInterval(e) {
        // Compute new value
        var value = this.getValue() + this.__P_114_6 * this.getPageStep();
        ...
        var slideBack = this.__P_114_6 == -1;
        if (slideBack && value <= this.__P_114_7 || !slideBack && value >= this.__P_114_7) {
          value = this.__P_114_7;
        }
      ...
      _onUpdate: function _onUpdate(e) {
        ...
        var sizeProperty = this.__P_114_13 ? "width" : "height";

        // Sync knob size
        this._updateKnobSize();

        // Store knob size
        this.__P_114_15 = availSize[sizeProperty] - knobSize[sizeProperty];
        this.__P_114_2 = knobSize[sizeProperty];
      ...
      */
       ...
       * @param e {qx.event.type.Pointer} Incoming pointer event
       */
      __P_114_14: function __P_114_14(e) {
        var isHorizontal = this.__P_114_13;
        var cursorLocation = isHorizontal ? e.getDocumentLeft() : e.getDocumentTop();
        var sliderLocation = this.__P_114_0;
        var knobLocation = this.__P_114_1;
        var knobSize = this.__P_114_2;
        ...
        if (value < min) {
          ...
          var method = this.__P_114_6 < 0 ? "floor" : "ceil";
        ...
        if (this.__P_114_7 == null || this.__P_114_6 == -1 && value <= this.__P_114_7 || this.__P_114_6 == 1 && value >= this.__P_114_7) {
          this.__P_114_7 = value;
        }
      },
      /**
      ...
      */
      ...
      slideTo: function slideTo(value, duration) {
        ...
        if (duration) {
          this.__P_114_16(value, duration);
        } else {
      ...
      updatePosition: function updatePosition(value) {
        this.setValue(this.__P_114_17(value));
      },
      /**
      ...
      stopSlideAnimation: function stopSlideAnimation() {
        if (this.__P_114_12) {
          this.__P_114_12.cancelSequence();
          this.__P_114_12 = null;
        }
      },
      /**
       ...
       */
      __P_114_17: function __P_114_17(value) {
       ...
       * @param duration {Number} The time in milliseconds the slide to should take.
       */
      __P_114_16: function __P_114_16(to, duration) {
        to = this.__P_114_17(to);
        var from = this.getValue();
        this.__P_114_12 = new qx.bom.AnimationFrame();
        this.__P_114_12.on("frame", function (timePassed) {
          this.setValue(parseInt(timePassed / duration * (to - from) + from));
        }, this);
        this.__P_114_12.on("end", function () {
          this.setValue(to);
          this.__P_114_12 = null;
          this.fireEvent("slideAnimationEnd");
        }, this);
        this.__P_114_12.startSequence(duration);
      },
      /*
      ---------------------------------------------------------------------------
      ...
      */
      ...
      _applyOrientation: function _applyOrientation(value, old) {
        ...
        this.__P_114_13 = value === "horizontal";
      ...
      _fireValue: function _fireValue() {
        ...
        var tmp = this.__P_114_11;
        this.__P_114_11 = null;
