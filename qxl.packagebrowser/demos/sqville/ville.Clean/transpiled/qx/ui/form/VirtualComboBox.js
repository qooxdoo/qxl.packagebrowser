  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.ui.form.VirtualComboBox", {
    ...
    construct: function construct(model) {
      ...
      this.__P_108_0 = dropdown.getSelection();
      this.__P_108_0.addListener("change", this.__P_108_1, this);
    ...
    members: {
      ...
      */
       ...
       */
      __P_108_1: function __P_108_1(event) {
        if (this.__P_108_4 == true) {
          return;
        }
        var selected = this.__P_108_0.getItem(0);
        if (selected) {
          selected = this.__P_108_6(selected);
      ...
      */
      ...
      __P_108_5: function __P_108_5() {
        ...
        if (selected === undefined || this.__P_108_6(selected) !== value) {
          ...
          for (var i = 0, l = lookupTable.length; i < l; i++) {
            ...
            var itemLabel = this.__P_108_6(modelItem);
       ...
       */
      __P_108_6: function __P_108_6(modelItem) {
    ...
    destruct: function destruct() {
      ...
      this.__P_108_0.removeListener("change", this.__P_108_1, this);
      this.__P_108_0 = null;
    }
  });
