  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.ui.form.VirtualSelectBox", {
    ...
    construct: function construct(model) {
      ...
      this.__P_110_1 = new qx.event.Timer(500);
      ...
      this.initHtmlMarkers(['<span style="' + this.__P_110_4() + '">', "</span>"]);
    },
    properties: {
      // overridden
      appearance: {
    ...
    members: {
      ...
      */
      ...
      _removeBindings: function _removeBindings() {
        while (this.__P_110_0.length > 0) {
          var id = this.__P_110_0.pop();
      ...
      */
      ...
      _handleKeyboard: function _handleKeyboard(event) {
        ...
        switch (action) {
          case "search":
            if (!this.isIncrementalSearch()) {
              this.__P_110_6 += this.__P_110_7(event.getKeyIdentifier());
              this.__P_110_1.restart();
            }
            break;
          default:
      ...
      */
      ...
      __P_110_2: function __P_110_2() {
        this.__P_110_1.stop();
        var searchValue = this.__P_110_6;
       ...
       */
      __P_110_7: function __P_110_7(keyIdentifier) {
      ...
      */
      ...
      __P_110_13: function __P_110_13() {
        var _this = this;
        var input = this.__P_110_11 = new qx.ui.form.TextField().set({
          appearance: "widget",
          liveUpdate: true,
          height: 0,
          width: 1 // must be > 0
      ...
      _highlightFilterValuePlainFunction: function _highlightFilterValuePlainFunction(parts) {
        ...
        return parts[1] + this.__P_110_12[0] + parts[2] + this.__P_110_12[1] + parts[3];
      },
      ...
      _highlightFilterValueHtmlFunction: function _highlightFilterValueHtmlFunction(parts) {
        ...
        return qx.module.util.String.escapeHtml(parts[1]) + this.__P_110_12[0] + qx.module.util.String.escapeHtml(parts[2]) + this.__P_110_12[1] + qx.module.util.String.escapeHtml(parts[3]);
      },
      ...
      __P_110_14: function __P_110_14(lastFilterValue) {
        this.__P_110_10++;
        var filterValue = lastFilterValue !== undefined ? lastFilterValue : this.__P_110_11.getValue();
        this.__P_110_8 = filterValue;
        ...
        if (item) {
          this.__P_110_9 = filterValue;
          this.getSelection().setItem(0, item);
        } else {
          var len = filterValue.length;
          var last = len > this.__P_110_9.length + 1 ? this.__P_110_11.getValue().charAt(len - 1) : "";
          filterValue = this.__P_110_9 + last;
          this.__P_110_14(filterValue);
        }
      ...
      __P_110_3: function __P_110_3() {
        ...
        labelOptions.converter = function (data, model, source, target) {
          var filterValue = that.__P_110_8;
      ...
      __P_110_5: function __P_110_5(value, old) {
        this.__P_110_12 = value;
        ...
        if (value.length < 2) {
          this.__P_110_12[1] = this.__P_110_12[0];
        }
      },
      _applyIncrementalSearch: function _applyIncrementalSearch(value, old) {
        if (value) {
          this.__P_110_1.stop();
          this.__P_110_1.setEnabled(false);
          this.__P_110_3();
        } else {
          this.__P_110_1.setEnabled(true);
        }
      }
    },
    destruct: function destruct() {
      ...
      this.__P_110_1.removeListener("interval", this.__P_110_2, this);
      this.__P_110_1.dispose();
      this.__P_110_1 = null;
    }
  });
