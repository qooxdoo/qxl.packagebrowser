  ...
  qx.Class.define("qx.ui.table.cellrenderer.Boolean", {
    ...
    */
    construct: function construct() {
      ...
      {
        this.__P_42_1 = qx.theme.manager.Meta.getInstance().addListener("changeTheme", this._onChangeTheme, this);
      }
    },
    /*
     *****************************************************************************
    ...
    */
    ...
    members: {
      ...
      _applyIconFalse: function _applyIconFalse(value) {
        this.__P_42_3 = this.__P_42_0.resolve(value);
      },
      // overridden
      _identifyImage: function _identifyImage(cellInfo) {
        ...
        if (rm.has(this.__P_42_2)) {
          id = this.__P_42_2;
        } else {
          ids = rm.getIds(this.__P_42_2);
    ...
    */
    destruct: function destruct() {
      ...
      if (true && this.__P_42_1) {
        qx.theme.manager.Meta.getInstance().removeListenerById(this.__P_42_1);
      }
    }
  });
