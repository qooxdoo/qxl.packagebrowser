  ...
  qx.Class.define("qx.ui.table.pane.Scroller", {
    ...
    */
    ...
    construct: function construct(table) {
      ...
      this.__P_160_2 = this._showChildControl("pane");
      ...
      this.__P_160_6 = this._showChildControl("scrollbar-y");

      // init focus indicator
      this.__P_160_7 = this.getChildControl("focus-indicator");
    ...
    */
    ...
    members: {
      ...
      _onRoll: function _onRoll(e) {
        ...
        var scrolled = delta.y != 0 && !this.__P_160_29(this.__P_160_6, delta.y);
        ...
        this.__P_160_5.scrollBy(parseInt(delta.x, 10));

        // Update the focus
        if (this.__P_160_21 && this.getFocusCellOnPointerMove()) {
          this._focusCellAtPagePos(this.__P_160_21, this.__P_160_22);
        }
        scrolled = scrolled || delta.x != 0 && !this.__P_160_29(this.__P_160_5, delta.x);
      ...
      __P_160_31: function __P_160_31(pageX) {
        ...
        if (this.__P_160_1.isShowingColumnMoveFeedback() || pageX > this.__P_160_14 + tapTolerance || pageX < this.__P_160_14 - tapTolerance) {
          ...
          this.__P_160_1.showColumnMoveFeedback(this._moveColumn, this.__P_160_13);
      ...
      startEditing: function startEditing() {
        ...
        if (!this.isEditing() && col != null && tableModel.isColumnEditable(col)) {
          ...
          // Get a cell editor
          this._cellEditor = this.__P_160_25.createCellEditor(cellInfo);
          ...
          if (this._cellEditor === null) {
            ...
            this.__P_160_27 = this.__P_160_7.addListener("pointerdown", function (e) {
              _this.__P_160_18 = {
                row: _this.__P_160_24,
                col: _this.__P_160_23
              };
              e.stopPropagation();
            });
            ...
            this.__P_160_7.setKeepActive(false);
      ...
      _getRowForPagePos: function _getRowForPagePos(pageX, pageY) {
        ...
        if (pageY >= panePos.top && pageY <= panePos.bottom) {
          ...
          var rowHeight = this.__P_160_2.getRenderedRowHeight();
