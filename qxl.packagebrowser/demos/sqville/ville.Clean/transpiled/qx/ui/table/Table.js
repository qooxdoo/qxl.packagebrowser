  ...
  qx.Class.define("qx.ui.table.Table", {
    ...
    */
    ...
    construct: function construct(tableModel, custom) {
      ...
      {
        this.__P_40_4 = qx.locale.Manager.getInstance().addListener("changeLocale", this._onChangeLocale, this);
      }
    ...
    */
    ...
    members: {
      ...
      getEmptyTableModel: function getEmptyTableModel() {
        if (!this.__P_40_12) {
          this.__P_40_12 = new qx.ui.table.model.Simple();
          this.__P_40_12.setColumns([]);
          this.__P_40_12.setData([]);
        }
        return this.__P_40_12;
      },
      // property modifier
      ...
      getTableColumnModel: function getTableColumnModel() {
        if (!this.__P_40_11) {
          var columnModel = this.__P_40_11 = this.getNewTableColumnModel()(this);
      ...
      _applyMetaColumnCounts: function _applyMetaColumnCounts(value, old) {
        ...
        if (value > old) {
          ...
          for (var evName in qx.ui.table.Table.__P_40_5) {
            handlers[evName] = {};
        ...
        if (metaColumnCounts.length > scrollerArr.length) {
          ...
          for (var i = scrollerArr.length; i < metaColumnCounts.length; i++) {
            ...
            for (evName in qx.ui.table.Table.__P_40_5) {
      ...
      _updateTableData: function _updateTableData(firstRow, lastRow, firstColumn, lastColumn, removeStart, removeCount) {
        ...
        if (rowCount != this.__P_40_7) {
          this.__P_40_7 = rowCount;
          this._updateScrollBarVisibility();
          this._updateStatusBar();
        ...
        if (colCount != this.__P_40_8) {
          this.__P_40_8 = colCount;
      ...
      _onColVisibilityChanged: function _onColVisibilityChanged(evt) {
        ...
        var data = evt.getData();
        if (this.__P_40_10 != null && data.col != null && data.visible != null) {
          this.__P_40_10[data.col].setColumnVisible(data.visible);
        }
        this._updateScrollerWidths();
        this._updateScrollBarVisibility();
      },
      ...
      setFocusedCell: function setFocusedCell(col, row, scrollVisible) {
        var cellChanged = col != this.__P_40_2 || row != this.__P_40_3;
      ...
      _updateScrollBarVisibility: function _updateScrollBarVisibility() {
        ...
        for (var i = 0; i < scrollerArr.length; i++) {
          ...
          if (isLast) {
            ...
            if (this.__P_40_13 == null) {
              this.__P_40_13 = scrollerArr[i].getVerticalScrollBarVisible();
              this.__P_40_14 = qx.event.Timer.once(function () {
          ...
          // has changed...
          if (isLast && verNeeded != this.__P_40_13) {
      ...
      addListener: function addListener(type, listener, self, capture) {
        if (qx.ui.table.Table.__P_40_5[type]) {
    ...
    */
    destruct: function destruct() {
      ...
      this._disposeObjects("__P_40_1", "__P_40_0", "__P_40_12", "__P_40_12", "__P_40_11", "__P_40_14");
      this._disposeMap("__P_40_10");
    }
  });
