  ...
  qx.Class.define("qx.core.Init", {
    ...
    */
    defer: function defer(statics) {
      ...
      qx.event.Registration.addListener(window, "shutdown", statics.__P_58_1, statics);
      qx.event.Registration.addListener(window, "beforeunload", statics.__P_58_0, statics);
    }
  });
