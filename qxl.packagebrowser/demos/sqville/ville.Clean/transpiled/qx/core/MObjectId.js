    ...
    members: {
      ...
      _applyQxObjectId: function _applyQxObjectId(value, oldValue) {
        if (!this.__P_62_1) {
          ...
          if (owner) {
            owner.__P_62_2(this, value, oldValue);
          }
       ...
       */
      __P_62_2: function __P_62_2(obj, newId, oldId) {
        delete this.__P_62_0[oldId];
        this.__P_62_0[newId] = obj;
      },
      /**
      ...
      _cascadeQxObjectIdChanges: function _cascadeQxObjectIdChanges() {
        ...
        if (this.__P_62_0) {
          for (var name in this.__P_62_0) {
            var obj = this.__P_62_0[name];
       ...
       */
      __P_62_3: function __P_62_3(obj) {
        if (obj !== null) {
      ...
      getOwnedQxObjects: function getOwnedQxObjects() {
        return this.__P_62_0 ? Object.values(this.__P_62_0) : [];
      }
    }
  });
