    ...
    statics: {
      ...
      */
      ...
      assertObject: function assertObject(object, iface) {
        ...
        this.__P_55_4(clazz, iface, true);
      ...
      */
       ...
       */
      __P_55_2: qx.core.Environment.select("qx.debug", {
      ...
      __P_55_5: qx.core.Environment.select("qx.debug", {
        "true": {
          extend: "object",
          // Interface | Interface[]
          statics: "object",
       ...
       */
      __P_55_6: qx.core.Environment.select("qx.debug", {
