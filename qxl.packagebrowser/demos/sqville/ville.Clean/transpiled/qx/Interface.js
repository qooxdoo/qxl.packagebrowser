    ...
    statics: {
      ...
      */
      ...
      assertObject: function assertObject(object, iface) {
        ...
        this.__P_56_4(clazz, iface, true);
      ...
      */
       ...
       */
      __P_56_2: qx.core.Environment.select("qx.debug", {
      ...
      __P_56_5: qx.core.Environment.select("qx.debug", {
        "true": {
          extend: "object",
          // Interface | Interface[]
          statics: "object",
       ...
       */
      __P_56_6: qx.core.Environment.select("qx.debug", {
