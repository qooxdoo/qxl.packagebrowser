  ...
  qx.Bootstrap.define("qx.bom.client.Engine", {
    ...
    statics: {
      ...
      getVersion: function getVersion() {
        ...
        var version = "";
        if (qx.bom.client.Engine.__P_84_0()) {
        ...
        } else if (qx.bom.client.Engine.__P_84_1()) {
        ...
        } else if (qx.bom.client.Engine.__P_84_2()) {
        ...
        } else if (qx.bom.client.Engine.__P_84_3()) {
      ...
      __P_84_0: function __P_84_0() {
        ...
        if (qx.bom.client.Engine.__P_84_4()) {
          return true;
        }
        return false;
      },
