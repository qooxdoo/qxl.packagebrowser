  ...
  qx.Bootstrap.define("qx.bom.client.Engine", {
    ...
    statics: {
      ...
      getVersion: function getVersion() {
        ...
        var version = "";
        if (qx.bom.client.Engine.__P_54_0()) {
        ...
        } else if (qx.bom.client.Engine.__P_54_1()) {
        ...
        } else if (qx.bom.client.Engine.__P_54_2()) {
        ...
        } else if (qx.bom.client.Engine.__P_54_3()) {
      ...
      __P_54_0: function __P_54_0() {
        ...
        if (qx.bom.client.Engine.__P_54_4()) {
          return true;
        }
        return false;
      },
