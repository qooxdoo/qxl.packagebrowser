    ...
    statics: {
      ...
      */
      ...
      assertObject: function assertObject(object, iface) {
        ...
        this.__P_24_4(clazz, iface, true);
      ...
      */
       ...
       */
      __P_24_2: qx.core.Environment.select("qx.debug", {
      ...
      __P_24_5: qx.core.Environment.select("qx.debug", {
        "true": {
          extend: "object",
          // Interface | Interface[]
          statics: "object",
       ...
       */
      __P_24_6: qx.core.Environment.select("qx.debug", {
