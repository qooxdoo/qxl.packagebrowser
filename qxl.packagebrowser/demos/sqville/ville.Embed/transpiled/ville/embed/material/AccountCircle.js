(function () {
  ...
  ************************************************************************ */
  qx.Class.define("ville.embed.material.AccountCircle", {
    ...
    construct: function construct(iconstyle) {
      ville.embed.material.Abstract.constructor.call(this);
  ...
  ville.embed.material.AccountCircle.$$dbClassInfo = $$dbClassInfo;
})();
