  ...
  ************************************************************************ */
  qx.Class.define("widgetbrowser.view.TabView", {
    ...
    construct: function construct() {
      ...
      this.init();
      this.addListener("changeSelection", this.__P_19_0, this);
    ...
    members: {
      init: function init() {
        ...
        this.add(misc); // Extras

        classname = "widgetbrowser.pages.Extras";
        controls = {
          disabled: true
        };
        var misc = new widgetbrowser.view.TabPage("Extras", classname, controls);
        this.add(misc);
      },
...
//# sourceMappingURL=TabView.js.map?dt=1626060465487