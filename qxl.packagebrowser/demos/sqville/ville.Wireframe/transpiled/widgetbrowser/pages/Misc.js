(function () {
  ...
  ************************************************************************ */
   ...
   * @asset(ville/theme/wireframe/wireframe-image-med.png)
   * @asset(ville/theme/wireframe/wireframe-image-sm32.png)
   * @asset(ville/theme/wireframe/wireframe-image-sm16.png)
   */
    ...
    members: {
      ...
      initWidgets: function initWidgets() {
        ...
        icons.forEach(function (icon) {
          slideBar.add(new qx.ui.basic.Image("ville/theme/wireframe/wireframe-image-med.png").set({
            scale: true,
            width: 48,
            height: 48
          }).set({
        ...
        popup.add(new qx.ui.basic.Atom("Pop-Up", "ville/theme/wireframe/wireframe-image-sm32.png"));
        widgets.push(popup);
        ...
        for (var i = 0; i < 10; i++) {
          source.add(new qx.ui.form.ListItem("Item " + i, "ville/theme/wireframe/wireframe-image-sm16.png"));
        }
...
//# sourceMappingURL=Misc.js.map?dt=1626060462746