(function () {
  var $$dbClassInfo = {
    "dependsOn": {
      ...
      "ville.theme.wireframe.MFreestyleCss": {
        "construct": true
      },
  ...
  ************************************************************************ */
  ...
  qx.Class.define("widgetbrowser.pages.Extras", {
    ...
    construct: function construct() {
      ...
      var lblaboutthis = new qx.ui.basic.Label("<b>Apply a hand-drawn look to ui controls</b>").set({
        rich: true
      }); // Enables adding CSS to tag and psudo classes (after and before) to the Decorator class

      qx.Class.include(qx.ui.decoration.Decorator, ville.theme.wireframe.MFreestyleCss); //create decorator objects for the controls
      ...
      var gb1 = new qx.ui.groupbox.GroupBox("Hand drawn GroupBox border").set({
        width: 400,
        height: 250
      });
      gb1.getChildControl("frame").set({
        decorator: groupboxframedec
      });
      var hbtnbox = new qx.ui.container.Composite(new qx.ui.layout.HBox(20));
      var btn1 = new qx.ui.form.Button("Cancel", "ville/theme/wireframe/wireframe-image-sm.png").set({
        width: 180,
        decorator: buttonboxdec
      });
      var btn2 = new qx.ui.form.Button("Submit", "ville/theme/wireframe/wireframe-image-sm.png").set({
        width: 180,
        decorator: buttonboxdec
      });
      hbtnbox.add(new qx.ui.basic.Label("<b>Buttons:</b>").set({
        rich: true
      }));
      hbtnbox.add(btn1);
      hbtnbox.add(btn2);
...
//# sourceMappingURL=Extras.js.map?dt=1626060462529