  ...
  qx.Class.define("widgetbrowser.pages.ToolBar", {
    ...
    members: {
      ...
      getToolBar: function getToolBar() {
        ...
        var splitButton = new qx.ui.toolbar.SplitButton("Toolbar SplitButton", "ville/theme/wireframe/wireframe-image-sm16.png", this.getSplitButtonMenu());
        splitButton.setToolTip(new qx.ui.tooltip.ToolTip("Toolbar SplitButton"));

        this._widgets.push(splitButton); // Button


        var button = new qx.ui.toolbar.Button("Toolbar Button", "ville/theme/wireframe/wireframe-image-sm16.png");
        button.setToolTip(new qx.ui.tooltip.ToolTip("Toolbar Button"));

        this._widgets.push(button); // CheckBox


        var checkBox = new qx.ui.toolbar.CheckBox("Toggle", "ville/theme/wireframe/wireframe-image-sm16.png");
        checkBox.setToolTip(new qx.ui.tooltip.ToolTip("Toolbar CheckBox"));

        this._widgets.push(checkBox); // RadioButton


        var radioButton1 = new qx.ui.toolbar.RadioButton("Left", "ville/theme/wireframe/wireframe-image-sm16.png");
        radioButton1.setToolTip(new qx.ui.tooltip.ToolTip("Toolbar RadioButton"));

        this._widgets.push(radioButton1);

        var radioButton2 = new qx.ui.toolbar.RadioButton("Center", "ville/theme/wireframe/wireframe-image-sm16.png");
      ...
      getButtonMenu: function getButtonMenu() {
        ...
        var button = new qx.ui.menu.Button("Menu MenuButton", "ville/theme/wireframe/wireframe-image-sm16.png");
...
//# sourceMappingURL=ToolBar.js.map?dt=1626060463030