  ...
  qx.Class.define("qxl.formdemo.FormItems", {
    ...
    members: {
      ...
      _createView: function _createView() {
        ...
        this.__P_35_0.push(passwordField);
        ...
        this.__P_35_1(comboBox);

        this.__P_35_0.push(comboBox);
        ...
        this.__P_35_2(virtualComboBox);

        this.__P_35_0.push(virtualComboBox);
        ...
        this.__P_35_1(selectBox);

        this.__P_35_0.push(selectBox); // virtual select box
        ...
        this.__P_35_2(virtualSelectBox);

        this.__P_35_0.push(virtualSelectBox); // list
        ...
        this.__P_35_0.push(list); // radio button group
        ...
        this.__P_35_0.push(radioButtonGroup);
        ...
        this.__P_35_0.push(button); // toggle button
        ...
        this.__P_35_0.push(toggleButton); // toggle button
        ...
        this.__P_35_0.push(repeatButton); // menu button


        var menuButton = new qx.ui.form.MenuButton("MenuButton", null, this.__P_35_3()).set({
          tabIndex: tabIndex++
        });
        ...
        this.__P_35_0.push(menuButton); // split button


        var splitButton = new qx.ui.form.SplitButton("SplitButton", null, this.__P_35_4()).set({
          tabIndex: tabIndex++
        });
        ...
        this.__P_35_0.push(splitButton); // Listener
        ...
        this.__P_35_0.push(checkBox); // tri-state check box
        ...
        this.__P_35_0.push(triCheckBox); // radio button
        ...
        this.__P_35_0.push(radioButton);
        ...
        this.__P_35_0.push(spinner); // slider
      ...
      __P_35_1: function __P_35_1(widget) {
        for (var i = 0; i < 10; i++) {
          var tempItem = new qx.ui.form.ListItem("Item " + i);
          widget.add(tempItem);
        }
      },
      __P_35_2: function __P_35_2(widget) {
...
//# sourceMappingURL=FormItems.js.map?dt=1626060467638