  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.data.Array", {
    ...
    construct: function construct(param) {
      ...
      if (param == undefined) {
        this.__P_116_0 = []; // check for elements (create the array)
      } else if (arguments.length > 1) {
        // create an empty array and go through every argument and push it
        this.__P_116_0 = [];

        for (var i = 0; i < arguments.length; i++) {
          this.__P_116_0.push(arguments[i]);
        } // check for a number (length)

      } else if (typeof param == "number") {
        this.__P_116_0 = new Array(param); // check for an array itself
      } else if (param instanceof Array) {
        this.__P_116_0 = qx.lang.Array.clone(param); // error case
      } else {
        this.__P_116_0 = [];
        this.dispose();
      ...
      for (var i = 0; i < this.__P_116_0.length; i++) {
        this._applyEventPropagation(this.__P_116_0[i], null, i);
      } // update the length at startup


      this.__P_116_1(); // work against the console printout of the array
    ...
    */
    ...
    members: {
      ...
      concat: function concat(array) {
        ...
        if (array) {
          var newArray = this.__P_116_0.concat(array);
        } else {
          var newArray = this.__P_116_0.concat();
        }
      ...
      join: function join(connector) {
        return this.__P_116_0.join(connector);
      },
       ...
       */
      pop: function pop() {
        var item = this.__P_116_0.pop();

        this.__P_116_1(); // remove the possible added event listener
      ...
      push: function push(varargs) {
        for (var i = 0; i < arguments.length; i++) {
          ...
          this.__P_116_1(); // apply to every pushed item an event listener for the bubbling
      ...
      reverse: function reverse() {
        ...
        var oldArray = this.__P_116_0.concat();

        this.__P_116_0.reverse();

        this.__P_116_2(0, this.length);
        ...
        this.fireDataEvent("changeBubble", {
          value: this.__P_116_0,
          name: "0-" + (this.__P_116_0.length - 1),
          old: oldArray,
          item: this
        });
      },
      ...
      shift: function shift() {
        ...
        this.__P_116_2(0, this.length); // fire change bubbles event
      ...
      slice: function slice(from, to) {
        return new qx.data.Array(this.__P_116_0.slice(from, to));
      },
      ...
      splice: function splice(startIndex, amount, varargs) {
        ...
        var oldLength = this.__P_116_0.length; // invoke the slice on the array

        var returnArray = this.__P_116_0.splice.apply(this.__P_116_0, arguments); // fire a change event for the length


        if (this.__P_116_0.length != oldLength) {
          this.__P_116_1();
        ...
        this.__P_116_2(startIndex + (arguments.length - 2) - amount, this.length); // fire the changeBubble event
      ...
      sort: function sort(func) {
        ...
        this.__P_116_0.sort.apply(this.__P_116_0, arguments); // prevent changeBubble event if nothing has been changed


        if (qx.lang.Array.equals(this.__P_116_0, oldArray) === true) {
          return;
        }
      ...
      unshift: function unshift(varargs) {
        for (var i = arguments.length - 1; i >= 0; i--) {
          this.__P_116_0.unshift(arguments[i]);

          this.__P_116_1(); // apply to every item an event listener for the bubbling
          ...
          this.fireDataEvent("changeBubble", {
            value: [this.__P_116_0[0]],
            name: "0",
            old: [this.__P_116_0[1]],
            item: this
          }); // fire change event
      ...
      setItem: function setItem(index, item) {
        var oldItem = this.__P_116_0[index]; // ignore settings of already set items [BUG #4106]

        if (oldItem === item) {
          return;
        }

        this.__P_116_0[index] = item; // set an event listener for the bubbling

        this._registerEventChaining(item, oldItem, index); // only update the length if its changed


        if (this.length != this.__P_116_0.length) {
          this.__P_116_1();
      ...
      indexOf: function indexOf(item) {
        return this.__P_116_0.indexOf(item);
      },
      ...
      lastIndexOf: function lastIndexOf(item) {
        return this.__P_116_0.lastIndexOf(item);
      },
      ...
      toString: function toString() {
        if (this.__P_116_0 != null) {
          return this.__P_116_0.toString();
        }
      ...
      */
      ...
      includes: function includes(item) {
        return this.__P_116_0.indexOf(item) !== -1;
      },
      ...
      removeAll: function removeAll() {
        ...
        for (var i = 0; i < this.__P_116_0.length; i++) {
          this._registerEventChaining(null, this.__P_116_0[i], i);
        ...
        var items = this.__P_116_0.concat(); // change the length


        this.__P_116_0.length = 0;

        this.__P_116_1(); // fire change bubbles event
      ...
      append: function append(array) {
        ...
        var oldLength = this.__P_116_0.length;
        Array.prototype.push.apply(this.__P_116_0, array); // add a listener to the new items
        ...
        this.__P_116_1(); // fire change bubbles
      ...
      forEach: function forEach(callback, context) {
        for (var i = 0; i < this.__P_116_0.length; i++) {
          callback.call(context, this.__P_116_0[i], i, this);
        }
      },
      ...
      */
      ...
      filter: function filter(callback, self) {
        return new qx.data.Array(this.__P_116_0.filter(callback, self));
      },
      ...
      map: function map(callback, self) {
        return new qx.data.Array(this.__P_116_0.map(callback, self));
      },
      ...
      some: function some(callback, self) {
        return this.__P_116_0.some(callback, self);
      },
      ...
      every: function every(callback, self) {
        return this.__P_116_0.every(callback, self);
      },
      ...
      reduce: function reduce(callback, initValue) {
        return this.__P_116_0.reduce(callback, initValue);
      },
      ...
      reduceRight: function reduceRight(callback, initValue) {
        return this.__P_116_0.reduceRight(callback, initValue);
      },
      ...
      */
      ...
      __P_116_1: function __P_116_1() {
        var oldLength = this.length;
        this.length = this.__P_116_0.length;
       ...
       */
      __P_116_2: function __P_116_2(from, to) {
        for (var i = from; i < to; i++) {
          this._registerEventChaining(this.__P_116_0[i], this.__P_116_0[i], i);
        }
...
//# sourceMappingURL=Array.js.map?dt=1626060479191