    ...
    */
    members: {
      ...
      createFlash: function createFlash() {
        this.__P_85_3 = qx.bom.Flash.create(this.getDomElement(), this.getAttributes(), this.__P_85_1, this.__P_85_0);
      },
    ...
    destruct: function destruct() {
      if (this.__P_85_3) {
        qx.bom.Flash.destroy(this.__P_85_3);
      }
...
//# sourceMappingURL=Flash.js.map?dt=1626060476002