  ...
  qx.Class.define("qx.ui.form.DateField", {
    ...
    */
    statics: {
      ...
      getDefaultDateFormatter: function getDefaultDateFormatter() {
        ...
        this.__P_110_1 = new qx.util.format.DateFormat(format, qx.locale.Manager.getInstance().getLocale());
        this.__P_110_0 = format;
        return this.__P_110_1;
      }
    },
    ...
    */
    members: {
      ...
      */
      ...
      _addLocaleChangeListener: function _addLocaleChangeListener() {
        ...
        {
          this.__P_110_2 = qx.locale.Manager.getInstance().addListener("changeLocale", function () {
    ...
    destruct: function destruct() {
      ...
      {
        if (this.__P_110_2) {
          qx.locale.Manager.getInstance().removeListenerById(this.__P_110_2);
        }
      }
    }
  });
...
//# sourceMappingURL=DateField.js.map?dt=1626060478350