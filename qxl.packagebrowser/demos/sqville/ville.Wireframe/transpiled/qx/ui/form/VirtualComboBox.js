  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.ui.form.VirtualComboBox", {
    ...
    construct: function construct(model) {
      ...
      this.__P_109_0 = dropdown.getSelection();

      this.__P_109_0.addListener("change", this.__P_109_1, this);
    ...
    members: {
      ...
      */
       ...
       */
      __P_109_1: function __P_109_1(event) {
        if (this.__P_109_4 == true) {
          return;
        }

        var selected = this.__P_109_0.getItem(0);

        if (selected) {
          selected = this.__P_109_6(selected);
      ...
      */
      ...
      __P_109_5: function __P_109_5() {
        ...
        if (selected === undefined || this.__P_109_6(selected) !== value) {
          ...
          for (var i = 0, l = lookupTable.length; i < l; i++) {
            ...
            var itemLabel = this.__P_109_6(modelItem);
       ...
       */
      __P_109_6: function __P_109_6(modelItem) {
    ...
    destruct: function destruct() {
      ...
      this.__P_109_0.removeListener("change", this.__P_109_1, this);
...
//# sourceMappingURL=VirtualComboBox.js.map?dt=1626060478244