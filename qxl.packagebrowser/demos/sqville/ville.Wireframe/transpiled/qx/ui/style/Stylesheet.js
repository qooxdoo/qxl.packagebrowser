  ...
  qx.Class.define("qx.ui.style.Stylesheet", {
    ...
    members: {
      ...
      addRule: function addRule(selector, css) {
        ...
        qx.bom.Stylesheet.addRule(this.__P_194_0, selector, css);

        this.__P_194_1.push(selector);
      },
      ...
      hasRule: function hasRule(selector) {
        return this.__P_194_1.indexOf(selector) != -1;
      },
      ...
      removeRule: function removeRule(selector) {
        delete this.__P_194_1[this.__P_194_1.indexOf(selector)];
        qx.bom.Stylesheet.removeRule(this.__P_194_0, selector);
      }
    }
  });
...
//# sourceMappingURL=Stylesheet.js.map?dt=1626060487816