    ...
    */
    members: {
      ...
      _dispatchEvent: function _dispatchEvent(domEvent) {
        ...
        if (this.__P_140_1[domEvent.getType()]) {
        ...
        if (!currentWidget || !(currentWidget.isEnabled() || this.__P_140_2[type])) {
          return;
        } // PROCESS LISTENERS
        // Load listeners
        ...
        if (domEvent.getEventPhase() == qx.event.type.Event.AT_TARGET) {
          ...
          var otherListeners = this.__P_140_0.getListeners(currentWidget, type, !capture);
...
//# sourceMappingURL=EventHandler.js.map?dt=1626060481426