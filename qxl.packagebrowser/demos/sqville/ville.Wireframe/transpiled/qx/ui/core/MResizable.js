  ...
  qx.Mixin.define("qx.ui.core.MResizable", {
    ...
    */
    construct: function construct() {
      ...
      content.addListener("pointerdown", this.__P_139_0, this, true);
      content.addListener("pointerup", this.__P_139_1, this);
      content.addListener("pointermove", this.__P_139_2, this);
      content.addListener("pointerout", this.__P_139_3, this);
      content.addListener("losecapture", this.__P_139_4, this); // Get a reference of the drag and drop handler
      ...
      this.__P_139_5 = qx.event.Registration.getManager(domElement).getHandler(qx.event.handler.DragDrop);
    },
    ...
    members: {
      ...
      */
      ...
      _getResizeFrame: function _getResizeFrame() {
        var frame = this.__P_139_6;

        if (!frame) {
          frame = this.__P_139_6 = new qx.ui.core.Widget();
      ...
      */
       ...
       */
      __P_139_13: function __P_139_13(e) {
        // Detect mode
        var resizeActive = this.__P_139_7; // Read size hint

        var hint = this.getSizeHint();
        var range = this.__P_139_11; // Read original values

        var start = this.__P_139_10;
        ...
        if (resizeActive & this.RESIZE_TOP || resizeActive & this.RESIZE_BOTTOM) {
          diff = Math.max(range.top, Math.min(range.bottom, e.getDocumentTop())) - this.__P_139_9;
        ...
        if (resizeActive & this.RESIZE_LEFT || resizeActive & this.RESIZE_RIGHT) {
          diff = Math.max(range.left, Math.min(range.right, e.getDocumentLeft())) - this.__P_139_8;
       ...
       * @param e {qx.event.type.Pointer} Last pointer event
       */
      __P_139_15: function __P_139_15(e) {
        var location = this.getContentLocation();
        var pointerTolerance = this.getResizeSensitivity();
        var pointerLeft = e.getDocumentLeft();
        var pointerTop = e.getDocumentTop();

        var resizeActive = this.__P_139_16(location, pointerLeft, pointerTop, pointerTolerance); // check again in case we have a corner [BUG #1200]


        if (resizeActive > 0) {
          // this is really a | (or)!
          resizeActive = resizeActive | this.__P_139_16(location, pointerLeft, pointerTop, pointerTolerance * 2);
        }

        this.__P_139_7 = resizeActive;
      },
       ...
       */
      __P_139_16: function __P_139_16(location, pointerLeft, pointerTop, pointerTolerance) {
      ...
      */
      ...
      __P_139_0: function __P_139_0(e) {
        ...
        if (!this.__P_139_7 || !this.getEnabled() || e.getPointerType() == "touch") {
          return;
        } // Add resize state
        ...
        this.__P_139_8 = e.getDocumentLeft();
        this.__P_139_9 = e.getDocumentTop(); // Cache bounds
      ...
      __P_139_1: function __P_139_1(e) {
        ...
        var bounds = this.__P_139_13(e); // Sync with widget
        ...
        this.__P_139_7 = 0; // Remove resize state
       ...
       */
      __P_139_4: function __P_139_4(e) {
        // Check for active resize
        if (!this.__P_139_7) {
          return;
        } // Reset cursor
       ...
       * @param e {qx.event.type.Pointer} The pointer event instance
       */
      __P_139_2: function __P_139_2(e) {
        if (!this.getEnabled() || e.getPointerType() == "touch") {
          return;
        }

        if (this.hasState("resize")) {
          var bounds = this.__P_139_13(e); // Update widget
          ...
          e.stopPropagation();
        } else if (!this.hasState("maximized") && !this.__P_139_5.isSessionActive()) {
          this.__P_139_15(e);

          var resizeActive = this.__P_139_7;
          var root = this.getApplicationRoot();

          if (resizeActive) {
            var cursor = this.__P_139_14[resizeActive];
       ...
       * @param e {qx.event.type.Pointer} The pointer event instance
       */
      __P_139_3: function __P_139_3(e) {
    ...
    */
    destruct: function destruct() {
      ...
      if (this.__P_139_6 != null && !qx.core.ObjectRegistry.inShutDown) {
        this.__P_139_6.destroy();
...
//# sourceMappingURL=MResizable.js.map?dt=1626060481356