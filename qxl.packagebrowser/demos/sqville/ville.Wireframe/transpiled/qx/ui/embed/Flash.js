      ...
      */
      ...
      _checkLoading: function _checkLoading() {
        ...
        if (source != "" && source != null && source != "undefined") {
          if (!this.isLoaded()) {
            if (!this.__P_28_0) {
              this.__P_28_0 = new Date().getTime();
            }

            var timeDiff = new Date().getTime() - this.__P_28_0;
...
//# sourceMappingURL=Flash.js.map?dt=1626060466737