  ...
  qx.Class.define("qx.ui.basic.Image", {
    ...
    members: {
      ...
      */
      ...
      _getContentHint: function _getContentHint() {
        return {
          width: this.__P_39_1 || 0,
          height: this.__P_39_2 || 0
        };
      },
      // overridden
      ...
      */
       ...
       */
      __P_39_10: function __P_39_10(mode) {
        this.__P_39_3 = mode;
      },
      ...
      __P_39_9: function __P_39_9() {
        if (this.__P_39_3 == null) {
          ...
          if (this.getScale() && isPng && qx.core.Environment.get("css.alphaimageloaderneeded")) {
            this.__P_39_3 = "alphaScaled";
          } else if (this.getScale()) {
            this.__P_39_3 = "scaled";
          } else {
            this.__P_39_3 = "nonScaled";
          }
        }
       ...
       */
      __P_39_11: function __P_39_11(mode) {
        var scale;
        var tagName;
        ...
        if (mode == "font") {
          ...
          if (qx.core.Environment.get("css.alphaimageloaderneeded")) {
            var wrapper = this.__P_39_5 = new qx.html.Element("div");
            element.connectWidget(this);
      ...
      __P_39_7: function __P_39_7() {
        ...
        var mode = this.__P_39_9();

        if (this.__P_39_0[mode] == null) {
          this.__P_39_0[mode] = this.__P_39_11(mode);
        }

        var element = this.__P_39_0[mode];

        if (!this.__P_39_4) {
          this.__P_39_4 = element;
        }
      ...
      _styleSource: function _styleSource() {
        ...
        if (!source) {
          this.__P_39_12(element);

          return;
        }

        this.__P_39_13(source);
        ...
        var contentEl = this.__P_39_14(); // Detect if the image registry knows this image


        if (ResourceManager.isFontUri(source)) {
          this.__P_39_15(contentEl, source);
          ...
          if (highResolutionSource) {
            ...
            this.__P_39_4.setStyle("background-size", backgroundSize);
          ...
          this.__P_39_17(contentEl, source);

          this.__P_39_16();
        } else {
          this.__P_39_18(contentEl, source);
        }
      },
      ...
      __P_39_16: function __P_39_16() {
        ...
        qx.bom.AnimationFrame.request(function (rId) {
          ...
          if (rId === this.__P_39_6) {
            this.fireEvent("loaded");
          } else {
            this.fireEvent("aborted");
          }
        }.bind(this, this.__P_39_6));
      },
       ...
       */
      __P_39_14: function __P_39_14() {
        var contentEl = this.__P_39_4;
       ...
       */
      __P_39_13: qx.core.Environment.select("engine.name", {
        "mshtml": function mshtml(source) {
          ...
          if (isFont) {
            ...
            if (this.getScale() && this.__P_39_9() != "alphaScaled") {
              this.__P_39_10("alphaScaled");
            } else if (!this.getScale() && this.__P_39_9() != "nonScaled") {
              this.__P_39_10("nonScaled");
            }
          } else {
            if (this.getScale() && this.__P_39_9() != "scaled") {
              this.__P_39_10("scaled");
            } else if (!this.getScale() && this.__P_39_9() != "nonScaled") {
              this.__P_39_10("nonScaled");
            }
          }

          this.__P_39_19(this.__P_39_7());
        },
        "default": function _default(source) {
          ...
          if (isFont) {
            this.__P_39_10("font");
          } else if (this.getScale() && this.__P_39_9() != "scaled") {
            this.__P_39_10("scaled");
          } else if (!this.getScale() && this.__P_39_9() != "nonScaled") {
            this.__P_39_10("nonScaled");
          }
       ...
       */
      __P_39_19: function __P_39_19(elementToAdd) {
        var currentContentElement = this.__P_39_4;
        ...
        if (currentContentElement != elementToAdd) {
          if (currentContentElement != null) {
            ...
            styles.zIndex = 10;
            var newEl = this.__P_39_5 ? elementToAdd.getChild(0) : elementToAdd;
       ...
       */
      __P_39_15: function __P_39_15(el, source) {
        var ResourceManager = qx.util.ResourceManager.getInstance();
        ...
        if (isFont) {
          ...
          this.__P_39_20(width, height);

          this.__P_39_8(el, source); // Apply source

        } else {
          // Apply source
          this.__P_39_8(el, source); // Compare with old sizes and relayout if necessary


          this.__P_39_20(ResourceManager.getImageWidth(source), ResourceManager.getImageHeight(source));
        }
      },
       ...
       * @param source {String} source path
       */
      __P_39_17: function __P_39_17(el, source) {
       ...
       * @param el {Element} image DOM element
       */
      __P_39_12: function __P_39_12(el) {
        if (el != null) {
       ...
       * @param source {String} source path
       */
      __P_39_8: function __P_39_8(el, source) {
        var isFont = source && qx.lang.String.startsWith(source, "@");
        ...
        if (isFont) {
          ...
          if (this.getScale()) {
            el.setStyle("fontSize", (this.__P_39_1 > this.__P_39_2 ? this.__P_39_2 : this.__P_39_1) + "px");
          } else {
       ...
       */
      __P_39_21: function __P_39_21(source, imageInfo) {
        ...
        this.__P_39_17(this.__P_39_14(), source);
      },
       ...
       */
      __P_39_20: function __P_39_20(width, height) {
        if (width === undefined) {
          width = this.__P_39_1;
        }

        if (height === undefined) {
          height = this.__P_39_2;
        }
      ...
      _recalc: function _recalc(originalWidth, originalHeight) {
        ...
        if (width != this.__P_39_1 || height != this.__P_39_2) {
          this.__P_39_1 = width;
          this.__P_39_2 = height;
          return true;
        }
    ...
    */
    destruct: function destruct() {
      for (var mode in this.__P_39_0) {
        if (this.__P_39_0.hasOwnProperty(mode)) {
          this.__P_39_0[mode].disconnectWidget(this);
        }
      }

      delete this.__P_39_4;
...
//# sourceMappingURL=Image.js.map?dt=1626060468372