  ...
  qx.Class.define("qx.ui.tree.Tree", {
    ...
    */
    construct: function construct() {
      ...
      this.__P_50_0 = new qx.ui.container.Composite(new qx.ui.layout.VBox()).set({
        allowShrinkY: false,
        allowGrowX: true
      });
      this.getChildControl("pane").add(this.__P_50_0);
      this.initOpenMode();
...
//# sourceMappingURL=Tree.js.map?dt=1626060470848