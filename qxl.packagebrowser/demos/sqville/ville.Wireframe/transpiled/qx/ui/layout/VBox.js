  ...
  qx.Class.define("qx.ui.layout.VBox", {
    ...
    members: {
      ...
      */
      ...
      __P_22_4: function __P_22_4() {
        ...
        var reuse = this.__P_22_0 && this.__P_22_0.length != length && this.__P_22_1 && this.__P_22_0;
        var props; // Sparse array (keep old one if lengths has not been modified)

        var heights = reuse ? this.__P_22_0 : new Array(length);
        var flexs = reuse ? this.__P_22_1 : new Array(length); // Reverse support
        ...
        if (!reuse) {
          this.__P_22_0 = heights;
          this.__P_22_1 = flexs;
        }

        this.__P_22_2 = enableFlex;
        this.__P_22_3 = children; // Clear invalidation marker
      ...
      */
      ...
      renderLayout: function renderLayout(availWidth, availHeight, padding) {
        ...
        if (this.__P_22_2 && allocatedHeight != availHeight) {
          var flexibles = {};
          var flex, offset;
          var notEnoughSpace = allocatedHeight > availHeight;

          for (i = 0; i < length; i += 1) {
            flex = this.__P_22_1[i];
      ...
      _computeSizeHint: function _computeSizeHint() {
        ...
        var children = this.__P_22_3; // Initialize
        ...
        for (var i = 0, l = children.length; i < l; i += 1) {
          ...
          var flex = this.__P_22_1[i];
          var percent = this.__P_22_0[i];
    ...
    */
    destruct: function destruct() {
      this.__P_22_0 = this.__P_22_1 = this.__P_22_3 = null;
    }
  });
  qx.ui.layout.VBox.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=VBox.js.map?dt=1626060465841