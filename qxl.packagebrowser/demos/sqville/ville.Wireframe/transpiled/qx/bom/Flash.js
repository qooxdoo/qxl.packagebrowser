    ...
    statics: {
      ...
      */
      ...
      create: function create(element, attributes, variables, params, win) {
        ...
        var flash = this.__P_202_0(element, attributes, params, win);
      ...
      destroy: function destroy(element, win) {
        if (qx.core.Environment.get("engine.name") == "mshtml" && qx.core.Environment.get("browser.documentmode") < 11) {
          element = this.__P_202_1(element);
          ...
          if (element.readyState == 4) {
            ...
            qx.bom.Event.addNativeListener(win, "load", function () {
              qx.bom.Flash.__P_202_2(element);
            });
          }
        } else {
          element = this.__P_202_1(element);
       ...
       */
      __P_202_1: function __P_202_1(element) {
        if (!element) {
       ...
       */
      __P_202_2: qx.core.Environment.select("engine.name", {
       ...
       * @signature function()
       */
      __P_202_3: qx.event.GlobalError.observeMethod(function () {
        // IE Memory Leak Fix
        for (var key in qx.bom.Flash._flashObjects) {
          qx.bom.Flash.destroy(qx.bom.Flash._flashObjects[key]);
        }

        window.__P_202_4 = function () {};

        window.__P_202_5 = function () {}; // Remove listener again


        qx.bom.Event.removeNativeListener(window, "beforeunload", qx.bom.Flash.__P_202_3);
      }),
       ...
       */
      __P_202_0: function __P_202_0(element, attributes, params, win) {
        if (qx.core.Environment.get("engine.name") == "mshtml" && qx.core.Environment.get("browser.documentmode") < 11) {
    ...
    */
    defer: function defer(statics) {
      if (qx.core.Environment.get("engine.name") == "mshtml") {
        qx.bom.Event.addNativeListener(window, "beforeunload", statics.__P_202_3);
      }
    }
  });
...
//# sourceMappingURL=Flash.js.map?dt=1626060488713