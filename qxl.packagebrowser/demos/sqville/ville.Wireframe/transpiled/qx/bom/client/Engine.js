  ...
  qx.Bootstrap.define("qx.bom.client.Engine", {
    ...
    statics: {
      ...
      getVersion: function getVersion() {
        ...
        if (qx.bom.client.Engine.__P_56_0()) {
        ...
        } else if (qx.bom.client.Engine.__P_56_1()) {
        ...
        } else if (qx.bom.client.Engine.__P_56_2()) {
        ...
        } else if (qx.bom.client.Engine.__P_56_3()) {
      ...
      __P_56_0: function __P_56_0() {
        ...
        if (qx.bom.client.Engine.__P_56_4()) {
          return true;
        }
...
//# sourceMappingURL=Engine.js.map?dt=1626060472459