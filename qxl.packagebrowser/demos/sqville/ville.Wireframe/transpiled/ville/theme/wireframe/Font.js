  ...
  ************************************************************************ */
  ...
  qx.Theme.define("ville.theme.wireframe.Font", {
    fonts: {
      "default": {
        size: 14,
        family: qx.core.Environment.get("os.name") == "osx" ? ["Apple Chancery", "cursive"] : ["Comic Sans MS", "Comic Sans", "cursive"],
        color: "black"
      },
      "defaultold": {
        family: ["sans-serif"],
  ...
  ville.theme.wireframe.Font.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=Font.js.map?dt=1626060471646