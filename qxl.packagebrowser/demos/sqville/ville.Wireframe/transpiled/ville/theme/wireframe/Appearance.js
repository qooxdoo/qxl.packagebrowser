...
(function () {
  ...
  ************************************************************************* */
  ...
  /**
   * The Wireframe appearance theme.
   * @asset(ville/theme/wireframe/wireframe-calendar.png)
   */
  qx.Theme.define("ville.theme.wireframe.Appearance", {
    appearances: (_appearances = {
      ...
      "dragdrop-cursor": {
        style: function style(states) {
          ...
          if (states.copy) {
            icon = "copy";
            retval = {
              source: ville.theme.wireframe.Image.URLS["cursor-" + icon],
      ...
      */
      ...
      "slidebar/button-forward": {
        ...
        style: function style(states) {
          return {
            icon: ville.theme.wireframe.Image.URLS["arrow-" + (states.vertical ? "down" : "right")],
            padding: [10, 12]
          };
        }
      },
      "slidebar/button-backward": {
        ...
        style: function style(states) {
          return {
            icon: ville.theme.wireframe.Image.URLS["arrow-" + (states.vertical ? "up" : "left")],
            padding: [10, 12]
          };
        }
      },
      ...
      */
      ...
      "table/column-button/icon": {
        ...
        style: function style(states) {
          return {
            ...
            decorator: "select-column-order-vert"
          };
        }
      },
      ...
      "table-header-cell": {
        ...
        style: function style(states) {
          return {
            ...
            sortIcon: states.sorted ? ville.theme.wireframe.Image.URLS["" + (states.sortedAscending ? "arrow-up" : "arrow-down")] : undefined
          };
        }
      },
      ...
      style: function style(states) {
        return {
          icon: ville.theme.wireframe.Image.URLS["treevirtual-line"]
        };
      }
    }), _defineProperty(_appearances, "treevirtual-contract", {
      style: function style(states) {
        return {
          icon: ville.theme.wireframe.Image.URLS["tree-minus"]
        };
      }
    }), _defineProperty(_appearances, "treevirtual-expand", {
      style: function style(states) {
        return {
          icon: ville.theme.wireframe.Image.URLS["tree-plus"]
        };
      }
    }), _defineProperty(_appearances, "treevirtual-only-contract", {
      style: function style(states) {
        return {
          icon: ville.theme.wireframe.Image.URLS["treevirtual-minus-only"]
        };
      }
    }), _defineProperty(_appearances, "treevirtual-only-expand", {
      style: function style(states) {
        return {
          icon: ville.theme.wireframe.Image.URLS["treevirtual-plus-only"]
        };
      }
    }), _defineProperty(_appearances, "treevirtual-start-contract", {
      style: function style(states) {
        return {
          icon: ville.theme.wireframe.Image.URLS["treevirtual-minus-start"]
        };
      }
    }), _defineProperty(_appearances, "treevirtual-start-expand", {
      style: function style(states) {
        return {
          icon: ville.theme.wireframe.Image.URLS["treevirtual-plus-start"]
        };
      }
    }), _defineProperty(_appearances, "treevirtual-end-contract", {
      style: function style(states) {
        return {
          icon: ville.theme.wireframe.Image.URLS["treevirtual-minus-end"]
        };
      }
    }), _defineProperty(_appearances, "treevirtual-end-expand", {
      style: function style(states) {
        return {
          icon: ville.theme.wireframe.Image.URLS["treevirtual-plus-end"]
        };
      }
    }), _defineProperty(_appearances, "treevirtual-cross-contract", {
      style: function style(states) {
        return {
          icon: ville.theme.wireframe.Image.URLS["treevirtual-minus-cross"]
        };
      }
    }), _defineProperty(_appearances, "treevirtual-cross-expand", {
      style: function style(states) {
        return {
          icon: ville.theme.wireframe.Image.URLS["treevirtual-plus-cross"]
        };
      }
    }), _defineProperty(_appearances, "treevirtual-end", {
      style: function style(states) {
        return {
          icon: ville.theme.wireframe.Image.URLS["treevirtual-end"]
        };
      }
    }), _defineProperty(_appearances, "treevirtual-cross", {
      style: function style(states) {
        return {
          icon: ville.theme.wireframe.Image.URLS["treevirtual-cross"]
        };
      }
      ...
      style: function style(states) {
        return {
          icon: states.checked ? ville.theme.wireframe.Image.URLS["checkbox-checked"] : ville.theme.wireframe.Image.URLS["blank"]
        };
      }
      ...
      style: function style(states) {
        return {
          icon: !states.checked ? undefined : ville.theme.wireframe.Image.URLS["blank"]
        };
      }
      ...
      style: function style(states) {
        ...
        styles.icon = ville.theme.wireframe.Image.URLS["arrow-" + icon];
    ...
    }), _defineProperty(_appearances, "textarea", "textfield"), _defineProperty(_appearances, "textfield-form", "textfield"), _defineProperty(_appearances, "radiobutton", {
      style: function style(states) {
        return {
          icon: "",
          gap: 10
      ...
      style: function style(states) {
        var decorator = "radiobutton"; //decorator += states.invalid && !states.disabled ? "-invalid" : "";
      ...
      style: function style(states) {
        ...
        if (states.checked && !states.disabled) {
          icon = ville.theme.wireframe.Image.URLS["checkbox-checked"]; // Undetermined
        } else if (states.checked && states.disabled) {
          icon = ville.theme.wireframe.Image.URLS["checkbox-checked-disabled"];
      ...
      style: function style(states) {
        ...
        return {
          ...
          height: 17,
          padding: padding,
          backgroundColor: states.undetermined ? "main" : "background"
        };
      }
      ...
      style: function style(states) {
        return {
          icon: "ville/theme/wireframe/wireframe-calendar.png",
          padding: 0,
    ...
    }), _defineProperty(_appearances, "toggle-button", "button"), _defineProperty(_appearances, "hover-button", "button"), _defineProperty(_appearances, "menubutton", {
      include: "button",
      alias: "button",
      style: function style(states) {
        return {
    ...
    }), _defineProperty(_appearances, "groupbox", {}), _defineProperty(_appearances, "groupbox/legend", {
      alias: "atom",
      style: function style(states) {
        return {
          padding: 5,
    ...
    }), _defineProperty(_appearances, "groupbox/frame", {
      style: function style(states) {
        return {
          backgroundColor: "background",
          padding: [16, 19],
      ...
      style: function style(states) {
        return {
          padding: [3, 8, 3, 5],
          icon: states.opened ? ville.theme.wireframe.Image.URLS["tree-folder-open"] : ville.theme.wireframe.Image.URLS["tree-folder"],
          iconOpened: ville.theme.wireframe.Image.URLS["tree-folder-open"],
          opacity: states.drag ? 0.5 : undefined
        };
      }
      ...
      style: function style(states) {
        return {
          icon: ville.theme.wireframe.Image.URLS["tree-file"],
          opacity: states.drag ? 0.5 : undefined
        };
      }
      ...
      style: function style(states) {
        return {
          icon: ville.theme.wireframe.Image.URLS["tabview-close"],
          padding: [1, 1],
          marginLeft: 6,
          cursor: states.disabled ? undefined : "pointer"
        };
      ...
      style: function style(states) {
        ...
        return {
          cursor: states.disabled ? undefined : "pointer",
          decorator: decorator,
          textColor: states.checked ? "background" : textcolor,
          font: "button",
          margin: margin,
          center: true,
          padding: [10, 18],
      ...
      include: "toolbar-button",
      style: function style(states) {
        var decorator = "button-box"; // set the right left and right decoratos
  ...
  ville.theme.wireframe.Appearance.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=Appearance.js.map?dt=1626060472038