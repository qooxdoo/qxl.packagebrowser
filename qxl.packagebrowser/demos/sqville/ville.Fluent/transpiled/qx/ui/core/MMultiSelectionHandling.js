  ...
  qx.Mixin.define("qx.ui.core.MMultiSelectionHandling", {
    ...
    */
    construct: function construct() {
      ...
      var manager = this.__P_110_0 = new clazz(this);
    ...
    members: {
      ...
      */
      ...
      isSelected: function isSelected(item) {
        ...
        return this.__P_110_0.isItemSelected(item);
      },
      /**
      ...
      removeFromSelection: function removeFromSelection(item) {
        ...
        this.__P_110_0.removeItem(item);
      },
      /**
      ...
      selectRange: function selectRange(begin, end) {
        this.__P_110_0.selectItemRange(begin, end);
      },
      /**
      ...
      setSelection: function setSelection(items) {
        ...
        if (items.length === 0) {
          ...
          if (!qx.lang.Array.equals(currentSelection, items)) {
            this.__P_110_0.replaceSelection(items);
          }
        }
      },
      /**
      ...
      getSortedSelection: function getSortedSelection() {
        return this.__P_110_0.getSortedSelection();
      },
      /**
      ...
      getSelectionContext: function getSelectionContext() {
        return this.__P_110_0.getSelectionContext();
      },
      /**
      ...
      invertSelection: function invertSelection() {
        this.__P_110_0.invertSelection();
      },
      /**
      ...
      _getLeadItem: function _getLeadItem() {
        var mode = this.__P_110_0.getMode();
        if (mode === "single" || mode === "one") {
          return this.__P_110_0.getSelectedItem();
        } else {
          return this.__P_110_0.getLeadItem();
        }
      },
      /*
      ---------------------------------------------------------------------------
