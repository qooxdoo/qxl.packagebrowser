    ...
    members: {
      ...
      validate: function validate() {
        ...
        for (var i = 0; i < this.__P_217_0.length; i++) {
          ...
          var validator = this.__P_217_0[i].validator;
          ...
          var validatorResult = this._validateItem(this.__P_217_0[i], formItem.getValue());
      ...
      reset: function reset() {
        ...
        for (var i = 0; i < this.__P_217_0.length; i++) {
          var dataEntry = this.__P_217_0[i];
