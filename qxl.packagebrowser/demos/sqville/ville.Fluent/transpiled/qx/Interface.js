    ...
    statics: {
      ...
      */
      ...
      assertObject: function assertObject(object, iface) {
        ...
        this.__P_53_4(clazz, iface, true);
      ...
      */
       ...
       */
      __P_53_2: qx.core.Environment.select("qx.debug", {
      ...
      __P_53_5: qx.core.Environment.select("qx.debug", {
        "true": {
          extend: "object",
          // Interface | Interface[]
          statics: "object",
       ...
       */
      __P_53_6: qx.core.Environment.select("qx.debug", {
