  ...
  ************************************************************************ */
  ...
  qx.Theme.define("ville.theme.fluent.Brand1Dark", {
    ...
    colors: {
      ...
      "table-row-background-focused-selected": ville.global.color.Brand[30],
      //BrandBackground2
      "table-row-background-focused": ville.global.color.Brand[30],
      //BrandBackground2
      "table-row-background-selected": ville.global.color.Brand[30],
      //BrandBackground2
      "table-row-background-even": "transparent",
      "table-row-background-odd": "transparent",
      "table-row-selected": ville.global.color.White,
      //NeutralForeground1
      "table-row": ville.global.color.White,
      //NeutralForeground1
      "table-row-line": ville.global.color.Grey[32],
      //NeutralStorke2
      "table-column-line": "transparent" //ville.global.color.Grey[88], //NeutralStorke2
    }
  });
  ville.theme.fluent.Brand1Dark.$$dbClassInfo = $$dbClassInfo;
})();
