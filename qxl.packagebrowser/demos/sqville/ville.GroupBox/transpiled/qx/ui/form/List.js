  ...
  qx.Class.define("qx.ui.form.List", {
    ...
    */
    ...
    construct: function construct(horizontal) {
      ...
      // Create content
      this.__P_177_0 = this._createListItemContainer();

      // Used to fire item add/remove events
      this.__P_177_0.addListener("addChildWidget", this._onAddChild, this);
      this.__P_177_0.addListener("removeChildWidget", this._onRemoveChild, this);

      // Add to scrollpane
      this.getChildControl("pane").add(this.__P_177_0);
    ...
    members: {
      ...
      */
      ...
      _onAddChild: function _onAddChild(e) {
        var child = e.getData();
        this.__P_177_2.set(child.toHashCode(), this.bind("readOnly", child, "readOnly"));
      ...
      _onRemoveChild: function _onRemoveChild(e) {
        var child = e.getData();
        child.removeBinding(this.__P_177_2.get(child.toHashCode()));
        this.__P_177_2["delete"](child.toHashCode());
      ...
      */
      ...
      _applySpacing: function _applySpacing(value, old) {
        this.__P_177_0.getLayout().setSpacing(value);
      },
      // property readOnly
      ...
      */
      ...
      _onKeyInput: function _onKeyInput(e) {
        ...
        if (new Date().valueOf() - this.__P_177_3 > 1000) {
          this.__P_177_1 = "";
        }

        // Combine keys the user pressed to a string
        this.__P_177_1 += e.getChar();

        // Find matching item
        var matchedItem = this.findItemByLabelFuzzy(this.__P_177_1);
        ...
        // Store timestamp
        this.__P_177_3 = new Date().valueOf();
      },
      /**
