  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.ui.core.Blocker", {
    ...
    construct: function construct(widget) {
      ...
      {
        this.__P_8_2 = qx.theme.manager.Meta.getInstance().addListener("changeTheme", this._onChangeTheme, this);
      }
      this.__P_8_3 = [];
      this.__P_8_4 = [];
    },
    ...
    members: {
      ...
      __P_8_1: function __P_8_1() {
        if (this.isBlocked()) {
          ...
          this._widget.addListenerOnce("appear", this.__P_8_10, this);
        }
      },
      /**
      ...
      _updateBlockerBounds: function _updateBlockerBounds(bounds) {
        ...
        var left = this.__P_8_7 ? 0 : bounds.left;
        var top = this.__P_8_7 ? 0 : bounds.top;
      ...
      _applyColor: function _applyColor(value, old) {
        ...
        this.__P_8_11("backgroundColor", color);
      },
      // property apply
      _applyOpacity: function _applyOpacity(value, old) {
        this.__P_8_11("opacity", value);
      },
      /**
       ...
       */
      __P_8_11: function __P_8_11(key, value) {
        var blockers = [];
        this.__P_8_5 && blockers.push(this.__P_8_5);
      ...
      _backupActiveWidget: function _backupActiveWidget() {
        ...
        this.__P_8_3.push(activeWidget);
        this.__P_8_4.push(focusedWidget);
        if (activeWidget) {
      ...
      _restoreActiveWidget: function _restoreActiveWidget() {
        var widget;
        var focusElementsLength = this.__P_8_4.length;
        if (focusElementsLength > 0) {
          widget = this.__P_8_4.pop();
          if (widget && !widget.isDisposed() && widget.isFocusable()) {
            widget.focus();
          }
        }
        var activeElementsLength = this.__P_8_3.length;
      ...
      getBlockerElement: function getBlockerElement(widget) {
        if (!this.__P_8_5) {
          this.__P_8_5 = this.__P_8_12();
          this.__P_8_5.setStyle("zIndex", 15);
          if (!widget) {
            if (this._isRoot) {
              widget = this._widget;
            } else {
          ...
          widget.getContentElement().add(this.__P_8_5);
          this.__P_8_5.exclude();
        }
        return this.__P_8_5;
      },
      /**
      ...
      _block: function _block(zIndex, blockContent) {
        if (!this._isRoot && !this._widget.getLayoutParent()) {
          if (!this.__P_8_9) {
            this.__P_8_9 = this._widget.addListenerOnce("appear", this._block.bind(this, zIndex, blockContent));
          }
          return;
        }
        var parent;
        ...
        if (this.__P_8_6 < 2) {
          ...
          this.__P_8_7 = blockContent === true;
          ...
          blocker.addListener("deactivate", this.__P_8_13, this);
          blocker.addListener("keypress", this.__P_8_14, this);
          blocker.addListener("keydown", this.__P_8_14, this);
          blocker.addListener("keyup", this.__P_8_14, this);
      ...
      unblock: function unblock() {
        if (this.__P_8_9) {
          this._widget.removeListenerById(this.__P_8_9);
          this.__P_8_9 = null;
        }
        if (!this.isBlocked()) {
          return;
       ...
       */
      __P_8_15: function __P_8_15() {
        this._restoreActiveWidget();
        var blocker = this.getBlockerElement();
        blocker.removeListener("deactivate", this.__P_8_13, this);
        blocker.removeListener("keypress", this.__P_8_14, this);
        blocker.removeListener("keydown", this.__P_8_14, this);
        blocker.removeListener("keyup", this.__P_8_14, this);
        blocker.exclude();
    ...
    */
    destruct: function destruct() {
      ...
      if (true && this.__P_8_2) {
        qx.theme.manager.Meta.getInstance().removeListenerById(this.__P_8_2);
      }
      this._widget.removeListener("resize", this.__P_8_0, this);
      this._widget.removeListener("move", this.__P_8_0, this);
      this._widget.removeListener("appear", this.__P_8_10, this);
      this._widget.removeListener("disappear", this.__P_8_1, this);
      if (this.__P_8_9) {
        this._widget.removeListenerById(this.__P_8_9);
      }
      this._disposeObjects("__P_8_5", "__P_8_8");
      this.__P_8_3 = this.__P_8_4 = this._widget = null;
    }
  });
