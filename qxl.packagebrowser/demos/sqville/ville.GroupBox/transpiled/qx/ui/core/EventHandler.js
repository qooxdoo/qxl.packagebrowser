    ...
    */
    ...
    members: {
      ...
      _dispatchEvent: function _dispatchEvent(domEvent) {
        ...
        if (this.__P_142_1[domEvent.getType()]) {
        ...
        if (!currentWidget || !(currentWidget.isEnabled() || this.__P_142_2[type])) {
          return;
        }
        ...
        if (domEvent.getEventPhase() == qx.event.type.Event.AT_TARGET) {
          ...
          var otherListeners = this.__P_142_0.getListeners(currentWidget, type, !capture);
          if (otherListeners) {
