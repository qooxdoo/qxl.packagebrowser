    ...
    */
    ...
    members: {
      ...
      */
       ...
       */
      __P_21_10: function __P_21_10(mode) {
        this.__P_21_3 = mode;
      },
      /**
       ...
       */
      __P_21_11: function __P_21_11(mode) {
        var scale;
        var tagName;
       ...
       */
      __P_21_7: function __P_21_7() {
        if (this.$$disposed) {
          return null;
        }
        var mode = this.__P_21_9();
        if (this.__P_21_0[mode] == null) {
          this.__P_21_0[mode] = this.__P_21_11(mode);
        }
      ...
      _styleSource: function _styleSource() {
        ...
        if (!source) {
          this.__P_21_12(element);
          return;
        }
        this.__P_21_13(source);
        ...
        var contentEl = this.__P_21_14();

        // Detect if the image registry knows this image
        if (ResourceManager.isFontUri(source)) {
          this.__P_21_15(contentEl, source);
          ...
          this.__P_21_18(contentEl, source);
        }
      },
      /**
       ...
       */
      __P_21_13: qx.core.Environment.select("engine.name", {
        mshtml: function mshtml(source) {
          ...
          if (isFont) {
            ...
            if (this.getScale() && this.__P_21_9() != "alphaScaled") {
              this.__P_21_10("alphaScaled");
            } else if (!this.getScale() && this.__P_21_9() != "nonScaled") {
              this.__P_21_10("nonScaled");
            }
          } else {
            if (this.getScale() && this.__P_21_9() != "scaled") {
              this.__P_21_10("scaled");
            } else if (!this.getScale() && this.__P_21_9() != "nonScaled") {
              this.__P_21_10("nonScaled");
            }
          }
          this.__P_21_19(this.__P_21_7());
        },
        "default": function _default(source) {
          var isFont = source && qx.lang.String.startsWith(source, "@");
          if (isFont) {
            this.__P_21_10("font");
          } else if (this.getScale() && this.__P_21_9() != "scaled") {
            this.__P_21_10("scaled");
          } else if (!this.getScale() && this.__P_21_9() != "nonScaled") {
            this.__P_21_10("nonScaled");
          }
       ...
       */
      __P_21_19: function __P_21_19(elementToAdd) {
       ...
       */
      __P_21_15: function __P_21_15(el, source) {
        var ResourceManager = qx.util.ResourceManager.getInstance();
        ...
        if (isFont) {
          ...
          if (this.getScale()) {
            ...
            var font = this.__P_21_20(source);
          ...
          this.__P_21_21(ResourceManager.getImageWidth(source), ResourceManager.getImageHeight(source));
        }
      },
      __P_21_22: function __P_21_22(el, width, height) {
        if (this.getScale()) {
      ...
      _applyDimension: function _applyDimension() {
        ...
        if (isFont) {
          ...
          if (el) {
            ...
            this.__P_21_22(el, width, height);
          }
        } else {
          this.__P_21_21();
        }
       ...
       * @param source {String} source path
       */
      __P_21_18: function __P_21_18(el, source) {
        var ImageLoader = qx.io.ImageLoader;
        // only try to load the image if it not already failed
        if (!ImageLoader.isFailed(source)) {
          ImageLoader.load(source, this.__P_21_23, this);
        } else {
          this.__P_21_12(el);
        }
      },
       ...
       * @param el {Element} image DOM element
       */
      __P_21_12: function __P_21_12(el) {
        if (el != null) {
      ...
      __P_21_20: function __P_21_20(source) {
       ...
       * @param source {String} source path
       */
      __P_21_8: function __P_21_8(el, source) {
        var isFont = source && qx.lang.String.startsWith(source, "@");
        if (isFont) {
          var ResourceManager = qx.util.ResourceManager.getInstance();
          var font = this.__P_21_20(source);
          ...
          this.__P_21_22(el, this.__P_21_1, this.__P_21_2);
       ...
       */
      __P_21_23: function __P_21_23(source, imageInfo) {
        ...
        // Update image
        this.__P_21_17(this.__P_21_14(), source);
      },
      /**
       ...
       */
      __P_21_21: function __P_21_21(width, height) {
        if (width === undefined) {
          width = this.__P_21_1;
        }
        if (height === undefined) {
