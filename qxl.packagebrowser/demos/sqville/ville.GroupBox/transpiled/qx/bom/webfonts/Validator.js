  ...
  qx.Class.define("qx.bom.webfonts.Validator", {
    ...
    */
    ...
    statics: {
      ...
      removeDefaultHelperElements: function removeDefaultHelperElements() {
        var defaultHelpers = qx.bom.webfonts.Validator.__P_199_3;
        if (defaultHelpers) {
          for (var prop in defaultHelpers) {
            document.body.removeChild(defaultHelpers[prop]);
          }
        }
        delete qx.bom.webfonts.Validator.__P_199_3;
      }
    },
    /*
    *****************************************************************************
    ...
    members: {
      ...
      */
      ...
      validate: function validate() {
        ...
        var setValidImpl = function setValidImpl(valid) {
          if (_this.__P_199_4) {
            _this.__P_199_4.stop();
          }
          _this._reset();
          _this.__P_199_1.resolve(valid);
        ...
        if (document.fonts && typeof document.fonts.load == "function") {
          this.__P_199_5 = new Date().getTime();
          ...
          var timerCheck = function timerCheck() {
            if (_this._isFontValid()) {
              ...
              if (now - _this.__P_199_5 >= _this.getTimeout()) {
                setValidImpl(false);
              }
            }
          };
          ...
          qx.event.Timer.once(function () {
            _this.__P_199_4 = new qx.event.Timer(100);
            _this.__P_199_4.addListener("interval", timerCheck);
            _this.__P_199_4.start();
          }, this, 0);
        }
      },
      /**
      ...
      */
      ...
      _isFontValid: function _isFontValid() {
        if (!qx.bom.webfonts.Validator.__P_199_2) {
          this.__P_199_6();
        }
        if (!this.__P_199_0) {
          this.__P_199_0 = this._getRequestedHelpers();
        ...
        if (requestedSans !== cls.__P_199_2.sans || requestedSerif !== cls.__P_199_2.serif) {
          return true;
        }
        return false;
      },
      ...
      */
      ...
      __P_199_6: function __P_199_6() {
        ...
        cls.__P_199_2 = {
          sans: qx.bom.element.Dimension.getWidth(cls.__P_199_3.sans),
          serif: qx.bom.element.Dimension.getWidth(cls.__P_199_3.serif)
        };
      }
    },
    /*
    ...
    */
    destruct: function destruct() {
      ...
      this._disposeObjects("__P_199_4");
    }
  });
