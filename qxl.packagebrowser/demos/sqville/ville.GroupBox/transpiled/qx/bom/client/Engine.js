  ...
  qx.Bootstrap.define("qx.bom.client.Engine", {
    ...
    statics: {
      ...
      getVersion: function getVersion() {
        ...
        var version = "";
        if (qx.bom.client.Engine.__P_24_0()) {
        ...
        } else if (qx.bom.client.Engine.__P_24_1()) {
        ...
        } else if (qx.bom.client.Engine.__P_24_2()) {
        ...
        } else if (qx.bom.client.Engine.__P_24_3()) {
      ...
      __P_24_0: function __P_24_0() {
        ...
        if (qx.bom.client.Engine.__P_24_4()) {
          return true;
        }
        return false;
      },
