  ...
  qx.Bootstrap.define("qx.bom.rest.Resource", {
    ...
    members: {
      ...
      map: function map(action, method, url, check) {
        this.__P_45_1[action] = [method, url, check];
      ...
      invoke: function invoke(action, params, data) {
        ...
        // Cache parameters
        this.__P_45_1[action].params = params;

        // Check parameters
        this.__P_45_11(params, config.check);

        // Configure request
        this.__P_45_12(req, config, data);
      ...
      _getRequestConfig: function _getRequestConfig(action, params) {
        var route = this.__P_45_1[action];
