    ...
    statics: {
      ...
      set: qx.Bootstrap.getEnvironmentSetting("qx.environment.allowRuntimeMutations") ? function (key, value) {
        ...
        if (this.__P_33_3 === undefined) {
          ...
          this.__P_33_3 = Object.assign({}, this.__P_33_0);
          this.__P_33_4 = Object.assign({}, this._checks);
        }
        this.__P_33_0[key] = value;
      ...
      remove: qx.Bootstrap.getEnvironmentSetting("qx.environment.allowRuntimeMutations") ? function (key) {
        ...
        if (this.__P_33_3 === undefined || this.__P_33_3[key] === undefined) {
      ...
      reset: qx.Bootstrap.getEnvironmentSetting("qx.environment.allowRuntimeMutations") ? function (key) {
        ...
        if (key !== undefined && this.__P_33_3[key] === undefined) {
          throw new TypeError("Environment setting \"".concat(key, "\" does not exist."));
        }
        if (key === undefined) {
          // reset all keys
          this.__P_33_0 = Object.assign({}, this.__P_33_3);
          this._checks = Object.assign({}, this.__P_33_4);
          return;
        }
        // only reset the particular key 
        this.__P_33_0[key] = this.__P_33_3[key];
        this._checks[key] = this.__P_33_4[key];
      } : undefined,
      /**
