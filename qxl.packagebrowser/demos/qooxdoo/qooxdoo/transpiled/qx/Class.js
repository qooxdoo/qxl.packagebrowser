    ...
    statics: {
      ...
      */
      ...
      __P_80_1: function __P_80_1(name, config) {
        ...
        // Create the class
        var clazz = this.__P_80_2(name, config.type, config.extend, config.statics, config.construct, config.destruct, config.include);
        ...
        if (config.extend) {
          ...
          if (config.objects) {
            this.__P_80_7(clazz, config.objects);
          }
          ...
          if (config.include) {
            for (var i = 0, l = config.include.length; i < l; i++) {
              this.__P_80_8(clazz, config.include[i], false);
            }
          }
        }
        ...
        if (config.implement) {
          for (var i = 0, l = config.implement.length; i < l; i++) {
            this.__P_80_9(clazz, config.implement[i]);
          }
        }
        // Process defer
        if (config.defer) {
      ...
      include: function include(clazz, mixin) {
        qx.Class.__P_80_8(clazz, mixin, false);
      },
      /**
      ...
      patch: function patch(clazz, mixin) {
        qx.Class.__P_80_8(clazz, mixin, true);
      ...
      */
      ...
      __P_80_12: qx.core.Environment.select("qx.debug", {
        "true": function _true(name, config) {
          ...
          // Validate keys
          var allowed = config.type === "static" ? this.__P_80_11 : this.__P_80_10;
       ...
       */
      __P_80_13: qx.core.Environment.select("qx.debug", {
      ...
      __P_80_2: function __P_80_2(name, type, extend, statics, construct, destruct, mixins) {
        ...
        if (!extend && true) {
          ...
          if (extend) {
            ...
            if (!construct) {
              construct = this.__P_80_14();
            }
            clazz = this.__P_80_15(construct, name, type);
      ...
      */
      ...
      __P_80_7: function __P_80_7(clazz, objects) {
       ...
       */
      __P_80_16: qx.core.Environment.select("qx.debug", {
       ...
       */
      __P_80_9: function __P_80_9(clazz, iface) {
       ...
       */
      __P_80_8: function __P_80_8(clazz, mixin, patch) {
      ...
      */
       ...
       */
      __P_80_15: function __P_80_15(construct, name, type) {
