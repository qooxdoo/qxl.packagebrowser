  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.theme.manager.Decoration", {
    ...
    construct: function construct() {
      ...
      this.__P_175_0 = [];
      this.__P_175_1 = qx.core.Environment.get("engine.name") == "mshtml" && qx.core.Environment.get("browser.documentmode") < 9;
    },
    /*
    *****************************************************************************
       PROPERTIES
    ...
    */
    ...
    members: {
      ...
      addCssClass: function addCssClass(value) {
        ...
        Object.keys(styles).sort().forEach(function (key) {
          ...
          if (qx.Bootstrap.isObject(styles[key])) {
            ...
            var innerSelector = this.__P_175_1 ? selector : selector + (inner ? ":" : "");
            this.__P_175_0.push(innerSelector + key);
      ...
      removeAllCssClasses: function removeAllCssClasses() {
        // remove old rules
        for (var i = 0; i < this.__P_175_0.length; i++) {
          var selector = this.__P_175_0[i];
      ...
      resolve: function resolve(value) {
        ...
        var cache = this.__P_175_2;
        if (!cache) {
          cache = this.__P_175_2 = {};
        }
      ...
      isCached: function isCached(decorator) {
        return !this.__P_175_2 ? false : qx.lang.Object.contains(this.__P_175_2, decorator);
      },
      // property apply
