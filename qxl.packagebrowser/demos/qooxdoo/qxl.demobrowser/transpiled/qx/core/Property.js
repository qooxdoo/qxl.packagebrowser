  ...
  ************************************************************************ */
  ...
  qx.Bootstrap.define("qx.core.Property", {
    statics: {
       ...
       */
      __P_212_3: function __P_212_3(clazz) {
        var inheritables = this.__P_212_4(clazz);
        if (!inheritables.length) {
          var refresher = function refresher() {};
        } else {
          refresher = this.__P_212_5(inheritables);
        }
       ...
       */
      __P_212_4: function __P_212_4(clazz) {
        var inheritable = [];
        while (clazz) {
       ...
       */
      __P_212_5: function __P_212_5(inheritables) {
      ...
      attachRefreshInheritables: function attachRefreshInheritables(clazz) {
        clazz.prototype.$$refreshInheritables = function () {
          qx.core.Property.__P_212_3(clazz);
      ...
      attachMethods: function attachMethods(clazz, name, config) {
        ...
        config.group ? this.__P_212_6(clazz, config, name) : this.__P_212_7(clazz, config, name);
      },
      /**
       ...
       */
      __P_212_6: function __P_212_6(clazz, config, name) {
       ...
       * @param name {String} Name of the property
       */
      __P_212_7: function __P_212_7(clazz, config, name) {
        var upname = qx.Bootstrap.firstUp(name);
        var members = clazz.prototype;
        // Fill dispose value
        if (config.dereference === undefined && typeof config.check === "string") {
          config.dereference = this.__P_212_8(config.check);
        }
        ...
        members[method.get[name]].$$install = function () {
          qx.core.Property.__P_212_9(clazz, name, "get", arguments);
          if (config.async) {
            qx.core.Property.__P_212_9(clazz, name, "getAsync", arguments);
          }
        };
        ...
        members[setName].$$install = function () {
          qx.core.Property.__P_212_10(clazz, name, "set");
          qx.core.Property.__P_212_10(clazz, name, "setImpl");
          if (config.async) {
            qx.core.Property.__P_212_10(clazz, name, "setAsync");
          }
        };
        ...
        members[method.reset[name]].$$install = function () {
          qx.core.Property.__P_212_10(clazz, name, "reset");
        };
       ...
       */
      __P_212_8: function __P_212_8(check) {
        return !!this.__P_212_2[check];
      },
      ...
      error: function error(obj, id, property, variant, value) {
        ...
        throw new Error(msg + (this.__P_212_11[id] || "Unknown reason: " + id));
      },
      /**
       ...
       */
      __P_212_12: function __P_212_12(instance, members, name, variant, code, args) {
        var fn = this.__P_212_13(instance.constructor, name, variant, code, args);
       ...
       * @return {var} Return value of the generated function
       */
      __P_212_13: function __P_212_13(clazz, name, variant, code, args) {
      ...
      executeOptimizedGetter: function executeOptimizedGetter(instance, clazz, name, variant) {
        var code = this.__P_212_14(clazz, name, variant);
        var members = clazz.prototype;
        return this.__P_212_12(instance, members, name, variant, code);
      },
      /**
       ...
       * @param variant {String} Method variant.
       */
      __P_212_9: function __P_212_9(clazz, name, variant) {
        var code = this.__P_212_14(clazz, name, variant);
        this.__P_212_13(clazz, name, variant, code);
      },
      /**
       ...
       */
      __P_212_14: function __P_212_14(clazz, name, variant) {
      ...
      executeOptimizedSetter: function executeOptimizedSetter(instance, clazz, name, variant, args) {
        var code = this.__P_212_15(clazz, name, variant);
        var members = clazz.prototype;
        return this.__P_212_12(instance, members, name, variant, code, args);
      },
      /**
       ...
       * @return {var} Return value of the generated function
       */
      __P_212_10: function __P_212_10(clazz, name, variant) {
        var code = this.__P_212_15(clazz, name, variant);
        return this.__P_212_13(clazz, name, variant, code);
      },
      /**
       ...
       * @return {String[]} the string builder array
       */
      __P_212_15: function __P_212_15(clazz, name, variant) {
        var config = clazz.$$properties[name];
        var members = clazz.prototype;
        var code = [];
        ...
        var store = this.__P_212_16(variant, name);
        this.__P_212_17(code, clazz, config, name);
        this.__P_212_18(code, config, name, variant, incomingValue);
        if (incomingValue || hasCallback) {
          this.__P_212_19(code, config, name);
        }
        if (incomingValue) {
          this.__P_212_20(code, clazz, config, name);
        }
        if (hasCallback) {
          this.__P_212_21(code, incomingValue, store, variant);
        }
        if (config.inheritable) {
          code.push("var inherit=prop.$$inherit;");
        }
        if (!hasCallback) {
          this.__P_212_22(code, name, variant, incomingValue);
        } else {
          this.__P_212_23(code, config, name, variant, incomingValue);
        }
        if (config.inheritable) {
          this.__P_212_24(code, config, name, variant);
        } else if (hasCallback) {
          this.__P_212_25(code, config, name, variant);
        }
        if (hasCallback) {
          // Emit callback and event firing; Refreshing children (5th parameter) requires the parent/children interface
          this.__P_212_26(code, config, name, variant, !!(config.inheritable && members._getChildren));
        }
       ...
       */
      __P_212_16: function __P_212_16(variant, name) {
       ...
       * @param name {String} name of the property
       */
      __P_212_17: function __P_212_17(code, clazz, config, name) {
        code.push("var equ=");
       ...
       */
      __P_212_18: function __P_212_18(code, config, name, variant, incomingValue) {
        {
       ...
       * @param name {String} name of the property
       */
      __P_212_20: function __P_212_20(code, clazz, config, name) {
       ...
       * @param variant {String} Method variant.
       */
      __P_212_21: function __P_212_21(code, incomingValue, store, variant) {
       ...
       * @param variant {String} Method variant.
       */
      __P_212_27: qx.core.Environment.select("qx.debug", {
        "true": function _true(code, config, clazz, name, variant) {
          ...
          if (config.check !== undefined) {
            ...
            code.push("if(");
            if (this.__P_212_1[config.check] !== undefined) {
              code.push("!(", this.__P_212_1[config.check], ")");
       ...
       * @param incomingValue {Boolean} Whether the setter has an incoming value
       */
      __P_212_22: function __P_212_22(code, name, variant, incomingValue) {
       ...
       * @param incomingValue {Boolean} Whether the setter has an incoming value
       */
      __P_212_23: function __P_212_23(code, config, name, variant, incomingValue) {
       ...
       * @param name {String} name of the property
       */
      __P_212_19: function __P_212_19(code, config, name) {
        if (config.inheritable) {
       ...
       * @param variant {String} Method variant.
       */
      __P_212_24: function __P_212_24(code, config, name, variant) {
       ...
       * @param variant {String} Method variant.
       */
      __P_212_25: function __P_212_25(code, config, name, variant) {
       ...
       */
      __P_212_26: function __P_212_26(code, config, name, variant, refresh) {
