  ...
  qx.Bootstrap.define("qx.core.WindowError", {
    ...
    */
    ...
    construct: function construct(failMessage, uri, lineNumber, columnNumber, sourceException) {
      ...
      this.__P_357_0 = failMessage;
      this.__P_357_1 = uri || "";
      this.__P_357_2 = lineNumber === undefined ? -1 : lineNumber;
      this.__P_357_3 = columnNumber === undefined ? -1 : columnNumber;
      this.__P_357_4 = sourceException;
    },
    /*
    *****************************************************************************
       MEMBERS
