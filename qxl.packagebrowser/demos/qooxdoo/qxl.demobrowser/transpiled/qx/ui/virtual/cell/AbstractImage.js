  ...
  qx.Class.define("qx.ui.virtual.cell.AbstractImage", {
    ...
    */
    ...
    members: {
       ...
       *    <code>height</code>
       */
      __P_344_2: function __P_344_2(source) {
       ...
       *   </ul>
       */
      __P_344_3: function __P_344_3(imageData) {
      ...
      getContent: function getContent(value, states) {
        ...
        var content = "";
        var imageData = this.__P_344_3(this._identifyImage(value));
