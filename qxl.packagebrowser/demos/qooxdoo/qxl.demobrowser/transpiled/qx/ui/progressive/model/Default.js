  ...
  qx.Class.define("qx.ui.progressive.model.Default", {
    ...
    members: {
      ...
      addElements: function addElements(elems) {
        ...
        this.__P_139_0 = this.__P_139_0.concat(elems);

        // Tell Progressive that data is available
        this.fireDataEvent("dataAvailable", this.__P_139_0.length);
      },
      /**
      ...
      getNextElement: function getNextElement() {
        ...
        if (this.__P_139_0.length > 0) {
          ...
          return {
            element: this.__P_139_0.shift(),
            remaining: this.__P_139_0.length
          };
        }
        return null;
      }
