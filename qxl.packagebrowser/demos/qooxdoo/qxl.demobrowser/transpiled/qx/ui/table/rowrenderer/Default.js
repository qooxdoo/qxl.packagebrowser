  ...
  qx.Class.define("qx.ui.table.rowrenderer.Default", {
    ...
    */
    construct: function construct() {
      ...
      {
        this.__P_162_0 = qx.theme.manager.Meta.getInstance().addListener("changeTheme", this.initThemeValues, this);
      }
    },
    /*
    *****************************************************************************
    ...
    */
    destruct: function destruct() {
      ...
      if (true && this.__P_162_0) {
        qx.theme.manager.Meta.getInstance().removeListenerById(this.__P_162_0);
      }
    }
  });
