  ...
  qx.Class.define("qx.ui.table.Table", {
    ...
    */
    ...
    members: {
      ...
      getEmptyTableModel: function getEmptyTableModel() {
        if (!this.__P_151_11) {
          this.__P_151_11 = new qx.ui.table.model.Simple();
          this.__P_151_11.setColumns([]);
          this.__P_151_11.setData([]);
        }
      ...
      getTableColumnModel: function getTableColumnModel() {
        if (!this.__P_151_10) {
          var columnModel = this.__P_151_10 = this.getNewTableColumnModel()(this);
      ...
      _applyMetaColumnCounts: function _applyMetaColumnCounts(value, old) {
        ...
        if (value > old) {
          ...
          for (var evName in qx.ui.table.Table.__P_151_4) {
            handlers[evName] = {};
        ...
        if (metaColumnCounts.length > scrollerArr.length) {
          ...
          for (var i = scrollerArr.length; i < metaColumnCounts.length; i++) {
            ...
            for (evName in qx.ui.table.Table.__P_151_4) {
      ...
      _updateTableData: function _updateTableData(firstRow, lastRow, firstColumn, lastColumn, removeStart, removeCount) {
        ...
        if (rowCount != this.__P_151_6) {
          this.__P_151_6 = rowCount;
          this._updateScrollBarVisibility();
          this._updateStatusBar();
        ...
        if (colCount != this.__P_151_7) {
          this.__P_151_7 = colCount;
      ...
      _onColVisibilityChanged: function _onColVisibilityChanged(evt) {
        ...
        var data = evt.getData();
        if (this.__P_151_9 != null && data.col != null && data.visible != null) {
          this.__P_151_9[data.col].setColumnVisible(data.visible);
        }
        this._updateScrollerWidths();
        this._updateScrollBarVisibility();
      },
      ...
      setFocusedCell: function setFocusedCell(col, row, scrollVisible) {
        if (!this.isEditing() && (col != this.__P_151_2 || row != this.__P_151_3)) {
          if (col === null) {
            col = 0;
          }
          this.__P_151_2 = col;
      ...
      _updateScrollBarVisibility: function _updateScrollBarVisibility() {
        ...
        for (var i = 0; i < scrollerArr.length; i++) {
          ...
          if (isLast) {
            ...
            if (this.__P_151_12 == null) {
              this.__P_151_12 = scrollerArr[i].getVerticalScrollBarVisible();
              this.__P_151_13 = qx.event.Timer.once(function () {
                // reset the last visible state of the vertical scroll bar
                // in a timeout to prevent infinite loops.
                this.__P_151_12 = null;
          ...
          // has changed...
          if (isLast && verNeeded != this.__P_151_12) {
      ...
      addListener: function addListener(type, listener, self, capture) {
        if (qx.ui.table.Table.__P_151_4[type]) {
    ...
    */
    destruct: function destruct() {
      ...
      this._disposeObjects("__P_151_1", "__P_151_0", "__P_151_11", "__P_151_11", "__P_151_10", "__P_151_13");
      this._disposeMap("__P_151_9");
    }
  });
