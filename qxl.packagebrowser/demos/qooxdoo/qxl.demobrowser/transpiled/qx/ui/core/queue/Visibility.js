  ...
  qx.Class.define("qx.ui.core.queue.Visibility", {
    statics: {
      ...
      remove: function remove(widget) {
        if (this.__P_308_1[widget.toHashCode()]) {
          delete this.__P_308_1[widget.toHashCode()];
          qx.lang.Array.remove(this.__P_308_0, widget);
        }
        delete this.__P_308_2[widget.toHashCode()];
      },
      /**
      ...
      isVisible: function isVisible(widget) {
        return this.__P_308_2[widget.toHashCode()] || false;
      },
      /**
      ...
      add: function add(widget) {
        ...
        this.__P_308_0.unshift(widget);
        this.__P_308_1[widget.toHashCode()] = widget;
