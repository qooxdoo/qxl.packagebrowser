    ...
    members: {
      ...
      */
      ...
      __P_60_2: function __P_60_2() {
        ...
        if (!menuBounds) {
          this.addListenerOnce("resize", this.__P_60_2, this);
          return;
        }
