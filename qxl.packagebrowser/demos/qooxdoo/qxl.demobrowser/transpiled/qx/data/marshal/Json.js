  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.data.marshal.Json", {
    ...
    members: {
       ...
       */
      __P_106_1: function __P_106_1(data, includeBubbleEvents) {
      ...
      __P_106_2: function __P_106_2(data, includeBubbleEvents) {
        ...
        if (includeBubbleEvents === true) {
          return this.__P_106_1(data, true);
        }
        if (includeBubbleEvents === false) {
          return this.__P_106_1(data, false);
        }

        // automatic mode!
        //
        var hash = this.__P_106_1(data); // without bubble event feature
      ...
      toClass: function toClass(data, includeBubbleEvents) {
        this.__P_106_3(data, includeBubbleEvents, null, 0);
      },
      /**
       ...
       */
      __P_106_3: function __P_106_3(data, includeBubbleEvents, parentProperty, depth) {
        ...
        data instanceof qx.core.Object) {
          ...
          if (data instanceof Array || qx.Bootstrap.getClass(data) == "Array") {
            for (var i = 0; i < data.length; i++) {
              this.__P_106_3(data[i], includeBubbleEvents, parentProperty + "[" + i + "]", depth + 1);
            }
          }
        ...
        var hash = this.__P_106_1(data, includeBubbleEvents);

        // ignore rules
        if (this.__P_106_4(hash, parentProperty, depth)) {
          return;
        }

        // check for the possible child classes
        for (var key in data) {
          this.__P_106_3(data[key], includeBubbleEvents, key, depth + 1);
        }
       ...
       */
      __P_106_5: function __P_106_5(item) {
       ...
       * @return {qx.core.Object} An instance of the corresponding class.
       */
      __P_106_6: function __P_106_6(hash, data, parentProperty, depth) {
        var delegateClass;
       ...
       */
      __P_106_4: function __P_106_4(hash, parentProperty, depth) {
      ...
      toModel: function toModel(data, includeBubbleEvents) {
        return this.__P_106_7(data, includeBubbleEvents, null, 0);
      },
      /**
       ...
       * @return {qx.core.Object} The created model object.
       */
      __P_106_7: function __P_106_7(data, includeBubbleEvents, parentProperty, depth) {
        ...
        data instanceof qx.core.Object) {
          ...
          // ignore rules
        } else if (this.__P_106_4(this.__P_106_2(data, includeBubbleEvents), parentProperty, depth)) {
          return data;
        } else if (isArray) {
          ...
          for (var i = 0; i < data.length; i++) {
            array.push(this.__P_106_7(data[i], includeBubbleEvents, parentProperty + "[" + i + "]", depth + 1));
          }
          return array;
        } else if (isObject) {
          // create an instance for the object
          var hash = this.__P_106_2(data, includeBubbleEvents);
          var model = this.__P_106_6(hash, data, parentProperty, depth);
          ...
          for (var key in data) {
            ...
            if (model[setterName]) {
              model[setterName](this.__P_106_7(data[key], includeBubbleEvents, key, depth + 1));
            }
          }
          return model;
        }
