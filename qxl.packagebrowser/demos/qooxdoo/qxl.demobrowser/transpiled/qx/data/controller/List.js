  ...
  qx.Class.define("qx.data.controller.List", {
    ...
    */
    ...
    members: {
      ...
      */
      ...
      _applyModel: function _applyModel(value, old) {
        ...
        if (old != undefined) {
          if (this.__P_100_4 != undefined) {
            old.removeListenerById(this.__P_100_4);
          }
        }
        ...
        if (value != null) {
          // add a new listener
          this.__P_100_4 = value.addListener("change", this.__P_100_10, this);
        ...
        if (value != null) {
          if (this.getModel() != null) {
            ...
            for (var i = 0; i < this.__P_100_0.length; i++) {
              this.__P_100_13(this.__P_100_14(i));
            }
          }
        }
      },
      ...
      */
       ...
       */
      __P_100_10: function __P_100_10() {
        if (this.__P_100_15) {
          return;
        }
        this.__P_100_15 = true;
      ...
      syncWidget: function syncWidget() {
        ...
        this.__P_100_6 = this.__P_100_5 = null;
      },
      /**
      ...
      __P_100_7: function __P_100_7() {
        ...
        // get the length
        var newLength = this.__P_100_0.length;
        ...
        if (newLength > currentLength) {
          ...
          for (var j = currentLength; j < newLength; j++) {
            this.__P_100_13(this.__P_100_14(j));
          }
      ...
      __P_100_16: function __P_100_16() {
        ...
        if (model != null) {
          model.removeListenerById(this.__P_100_4);
          this.__P_100_4 = model.addListener("change", this.__P_100_10, this);
        }
      },
      /*
      ---------------------------------------------------------------------------
      ...
      */
       ...
       */
      __P_100_13: function __P_100_13(index) {
      ...
      */
      ...
      bindProperty: function bindProperty(sourcePath, targetProperty, options, targetWidget, index) {
        ...
        if (options != null) {
          ...
          this.__P_100_3[targetProperty] = options.onUpdate;
          delete options.onUpdate;
        } else {
          options = {};
          this.__P_100_3[targetProperty] = null;
        }
        ...
        if (!this.__P_100_1.includes(targetProperty)) {
          this.__P_100_1.push(targetProperty);
        }
      },
      /**
      ...
      bindPropertyReverse: function bindPropertyReverse(targetPath, sourcePath, options, sourceWidget, index) {
        ...
        // save the bound property
        if (!this.__P_100_2.includes(targetPath)) {
          this.__P_100_2.push(targetPath);
        }
      },
      /**
      ...
      _onBindingSet: function _onBindingSet(index, sourceObject, targetObject) {
        ...
        for (var i = 0; i < this.__P_100_1.length; i++) {
          // if there is an onUpdate for one of it, invoke it
          if (this.__P_100_3[this.__P_100_1[i]] != null) {
            this.__P_100_3[this.__P_100_1[i]]();
          }
        }
      },
      /**
      ...
      _removeBindingsFrom: function _removeBindingsFrom(item) {
        ...
        for (var i = 0; i < this.__P_100_1.length; i++) {
          ...
          var id = item.getUserData(this.__P_100_1[i] + "BindingId");
          if (id != null) {
            this.removeBinding(id);
            item.setUserData(this.__P_100_1[i] + "BindingId", null);
          }
        }
        // go through all reverse bound properties
        for (var i = 0; i < this.__P_100_2.length; i++) {
          // get the binding id and remove it, if possible
          var id = item.getUserData(this.__P_100_2[i] + "ReverseBindingId");
          if (id != null) {
            item.removeBinding(id);
            item.getUserData(this.__P_100_2[i] + "ReverseBindingId", null);
          }
        }
      },
      /**
      ...
      __P_100_8: function __P_100_8() {
        ...
        for (var i = 0; i < items.length; i++) {
          ...
          // add the new binding
          this._bindListItem(items[i], this.__P_100_14(i));
        }
      ...
      */
      ...
      _setFilter: function _setFilter(value, old) {
        ...
        var oldTable = this.__P_100_0;
        // generate a new lookup table
        this.__P_100_11();

        // if there are lesser items
        if (oldTable.length > this.__P_100_0.length) {
          // remove the unnecessary items
          for (var j = oldTable.length; j > this.__P_100_0.length; j--) {
            this.getTarget().removeAt(j - 1).destroy();
          }
          // if there are more items
        } else if (oldTable.length < this.__P_100_0.length) {
          // add the new elements
          for (var j = oldTable.length; j < this.__P_100_0.length; j++) {
        ...
        for (var i = 0; i < listItems.length; i++) {
          this._bindListItem(listItems[i], this.__P_100_14(i));
        }
      ...
      */
       ...
       */
      __P_100_14: function __P_100_14(index) {
    ...
    destruct: function destruct() {
      this.__P_100_0 = this.__P_100_3 = this.__P_100_1 = null;
      this.__P_100_2 = null;
