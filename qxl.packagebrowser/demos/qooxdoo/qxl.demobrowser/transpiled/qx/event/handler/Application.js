  ...
  qx.Class.define("qx.event.handler.Application", {
    ...
    */
    ...
    construct: function construct(manager) {
      ...
      this.__P_337_0 = false;
      this.__P_337_1 = false;
      this.__P_337_2 = false;
    ...
    members: {
      ...
      */
      ...
      __P_337_5: function __P_337_5() {
        ...
        if (!this.__P_337_2 && this.__P_337_0 && qx.$$loader.scriptLoaded) {
      ...
      */
      ...
      _onNativeLoad: function _onNativeLoad() {
        var callback = qx.core.Environment.select("qx.globalErrorHandling", {
          "true": qx.event.GlobalError.observeMethod(this.__P_337_7),
          "false": this.__P_337_7
        });
      ...
      _onNativeUnload: function _onNativeUnload() {
        var callback = qx.core.Environment.select("qx.globalErrorHandling", {
          "true": qx.event.GlobalError.observeMethod(this.__P_337_8),
          "false": this.__P_337_8
        });
        callback.apply(this, arguments);
      },
      /**
