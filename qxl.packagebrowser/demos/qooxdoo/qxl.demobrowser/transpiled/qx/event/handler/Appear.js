  ...
  qx.Class.define("qx.event.handler.Appear", {
    ...
    */
    ...
    construct: function construct(manager) {
      ...
      this.__P_278_0 = manager;
      this.__P_278_1 = {};

      // Register
      qx.event.handler.Appear.__P_278_2[this.toHashCode()] = this;
    },
    /*
    *****************************************************************************
       STATICS
        ...
        Object.keys(targets).forEach(function (hash) {
          ...
          qx.event.Utils.then(tracker, function () {
            ...
            if (!!elem.$$displayed !== displayed) {
              ...
              return self.__P_278_0.dispatchEvent(elem, evt);
            }
          });
        });
    ...
    */
    destruct: function destruct() {
      ...
      // Deregister
      delete qx.event.handler.Appear.__P_278_2[this.toHashCode()];
    },
    /*
    *****************************************************************************
       DEFER
