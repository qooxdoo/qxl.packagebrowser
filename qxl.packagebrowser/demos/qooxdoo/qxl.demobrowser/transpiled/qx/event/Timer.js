  ...
  qx.Class.define("qx.event.Timer", {
    ...
    members: {
      ...
      */
      ...
      _applyEnabled: function _applyEnabled(value, old) {
        if (old) {
          window.clearInterval(this.__P_50_2);
          this.__P_50_2 = null;
        } else if (value) {
          this.__P_50_2 = window.setInterval(this.__P_50_0, this.getInterval());
        }
      },
      /*
      ---------------------------------------------------------------------------
    ...
    */
    destruct: function destruct() {
      ...
      this.__P_50_2 = this.__P_50_0 = null;
    }
  });
