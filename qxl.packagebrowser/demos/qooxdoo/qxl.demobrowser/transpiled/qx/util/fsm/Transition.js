  ...
  qx.Class.define("qx.util.fsm.Transition", {
    ...
    construct: function construct(transitionName, transitionInfo) {
      ...
      for (var field in transitionInfo) {
        ...
        switch (field) {
          case "predicate":
            this.setPredicate(this.__P_185_0(transitionInfo[field], context));
            break;
          case "nextState":
            this.setNextState(transitionInfo[field]);
            break;
          case "autoActionsBeforeOntransition":
            this.setAutoActionsBeforeOntransition(this.__P_185_0(transitionInfo[field], context));
            break;
          case "autoActionsAfterOntransition":
            this.setAutoActionsAfterOntransition(this.__P_185_0(transitionInfo[field], context));
            break;
          case "ontransition":
            this.setOntransition(this.__P_185_0(transitionInfo[field], context));
            break;
          case "context":
            // already handled
            break;
    ...
    members: {
       ...
       */
      __P_185_1: function __P_185_1(value) {
       ...
       */
      __P_185_2: function __P_185_2(value) {
       ...
       * @return {Function} the final value
       */
      __P_185_3: function __P_185_3(value) {
       ...
       * @return {Function} the final value
       */
      __P_185_4: function __P_185_4(value) {
       ...
       *   unaltered.
       */
      __P_185_0: function __P_185_0(f, context) {
