  ...
  qx.Class.define("qx.util.fsm.State", {
    ...
    construct: function construct(stateName, stateInfo) {
      ...
      for (var field in stateInfo) {
        ...
        switch (field) {
          case "onentry":
            this.setOnentry(this.__P_184_0(stateInfo[field], context));
            break;
          case "onexit":
            this.setOnexit(this.__P_184_0(stateInfo[field], context));
            break;
    ...
    members: {
       ...
       */
      __P_184_1: function __P_184_1(value) {
       ...
       * @throws {Error} when an invalid value is detected
       */
      __P_184_2: function __P_184_2(value) {
       ...
       * @throws {Error} when an invalid value is detected
       */
      __P_184_3: function __P_184_3(value) {
       ...
       * @throws {Error} when an invalid value is detected
       */
      __P_184_8: function __P_184_8(value) {
       ...
       * @return {var} the final value
       */
      __P_184_6: function __P_184_6(value) {
       ...
       * @return {var} the final value
       */
      __P_184_7: function __P_184_7(value) {
       ...
       *   unaltered.
       */
      __P_184_0: function __P_184_0(f, context) {
