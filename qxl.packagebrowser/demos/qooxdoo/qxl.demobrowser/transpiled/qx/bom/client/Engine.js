  ...
  qx.Bootstrap.define("qx.bom.client.Engine", {
    ...
    statics: {
      ...
      getVersion: function getVersion() {
        ...
        var version = "";
        if (qx.bom.client.Engine.__P_129_0()) {
        ...
        } else if (qx.bom.client.Engine.__P_129_1()) {
        ...
        } else if (qx.bom.client.Engine.__P_129_2()) {
        ...
        } else if (qx.bom.client.Engine.__P_129_3()) {
      ...
      __P_129_0: function __P_129_0() {
        ...
        if (qx.bom.client.Engine.__P_129_4()) {
          return true;
        }
        return false;
      },
