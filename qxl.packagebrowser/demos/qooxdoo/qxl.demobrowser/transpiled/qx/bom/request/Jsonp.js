  ...
  qx.Bootstrap.define("qx.bom.request.Jsonp", {
    ...
    members: {
      ...
      open: function open(method, url) {
        ...
        this.__P_366_4 = false;
        callbackParam = this.__P_366_2 || "callback";
        callbackName = this.__P_366_3 || this.__P_366_8 + "qx.bom.request.Jsonp." + this.__P_366_1 + ".callback";

        // Default callback
        if (!this.__P_366_3) {
          // Store globally available reference to this object
          this.constructor[this.__P_366_1] = this;
          ...
          // callback method.
          if (!window[this.__P_366_3]) {
            this.__P_366_5 = true;
            window[this.__P_366_3] = function (data) {
              that.callback(data);
            };
          } else {
            if (qx.core.Environment.get("qx.debug.io")) {
              qx.Bootstrap.debug(qx.bom.request.Jsonp, "Callback " + this.__P_366_3 + " already exists");
            }
          }
        }
        if (qx.core.Environment.get("qx.debug.io")) {
        ...
        this.__P_366_6 = url = qx.util.Uri.appendParamsToUrl(url, query);
        this.__P_366_9("open", [method, url]);
      },
      /**
      ...
      callback: function callback(data) {
        ...
        this.constructor[this.__P_366_1] = undefined;
        this.__P_366_10();
      },
      /**
      ...
      _onNativeLoad: function _onNativeLoad() {
        ...
        this.status = this.__P_366_4 ? 200 : 500;
        this.__P_366_9("_onNativeLoad");
      },
      /**
       *  Delete custom callback if dynamically created before.
       */
      __P_366_10: function __P_366_10() {
        if (this.__P_366_5 && window[this.__P_366_3]) {
          window[this.__P_366_3] = undefined;
          this.__P_366_5 = false;
        }
      },
      /**
       ...
       */
      __P_366_9: function __P_366_9(method, args) {
      ...
      __P_366_0: function __P_366_0() {
        ...
        this.__P_366_1 = "qx" + new Date().valueOf() + ("" + Math.random()).substring(2, 5);
      }
    }
  });
