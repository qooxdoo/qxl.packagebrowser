  ...
  ************************************************************************ */
  ...
  qx.Class.define("qxl.logpane.LogPane", {
    ...
    construct: function construct() {
      this.__P_52_0 = [["debug", "Debug", "icon/16/categories/system.png"], ["info", "Info", "icon/16/status/dialog-information.png"], ["warn", "Warning", "icon/16/status/dialog-warning.png"], ["error", "Error", "icon/16/status/dialog-error.png"]];
      ...
      this.__P_52_1 = new qx.ui.toolbar.ToolBar();
      this.__P_52_1.add(caption);
      this.__P_52_1.addSpacer();
      this.__P_52_1.setBackgroundColor("white");
      ...
      this.__P_52_1.add(clearButton);
      this.add(this.__P_52_1);
      ...
      // log appender
      this.__P_52_2 = new qx.log.appender.Element();
      qx.log.Logger.unregister(this.__P_52_2);

      // Directly create DOM element to use
      this.__P_52_3 = document.createElement("DIV");
      this.__P_52_2.setElement(this.__P_52_3);
      logArea.addListenerOnce("appear", function () {
        logArea.getContentElement().getDomElement().appendChild(this.__P_52_3);
      }, this);
    },
    properties: {
      /** Shows the toolbar */
    ...
    members: {
      ...
      _applyShowToolBar: function _applyShowToolBar(value, old) {
        if (value) {
          ...
          this.__P_52_1.exclude();
        }
      },
      // property apply
      _applyShowLogLevel: function _applyShowLogLevel(value, old) {
        if (!this.__P_52_4) {
          this.__P_52_4 = this.__P_52_5();
          this.__P_52_1.add(this.__P_52_4);
        }
        if (value) {
          this.__P_52_4.show();
        } else {
          this.__P_52_4.exclude();
        }
      },
      /**
      ...
      __P_52_5: function __P_52_5() {
        ...
        for (var i = 0, l = this.__P_52_0.length; i < l; i++) {
          var data = this.__P_52_0[i];
