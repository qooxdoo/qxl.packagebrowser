  ...
  qx.Class.define("qxl.demobrowser.demo.mobile.Fingers", {
    ...
    */
    ...
    members: {
      ...
      main: function main() {
        // Call super class
        qxl.demobrowser.demo.mobile.Fingers.superclass.prototype.main.call(this);
      ...
      _onPointerDown: function _onPointerDown(e) {
        this.__P_15_0[e.getPointerId()] = parseInt(e.getTarget().style.left) - e.getDocumentLeft();
        this.__P_15_1[e.getPointerId()] = parseInt(e.getTarget().style.top) - e.getDocumentTop();
      },
      _onPointerMove: function _onPointerMove(e) {
        ...
        qx.bom.element.Style.setStyles(e.getTarget(), {
          left: e.getDocumentLeft() + this.__P_15_0[e.getPointerId()] + "px",
          top: e.getDocumentTop() + this.__P_15_1[e.getPointerId()] + "px"
        });
        e.preventDefault();
      }
    }
