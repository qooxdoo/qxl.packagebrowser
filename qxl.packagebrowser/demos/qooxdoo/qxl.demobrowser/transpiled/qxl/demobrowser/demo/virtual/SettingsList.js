  ...
  ************************************************************************ */
  ...
  qx.Class.define("qxl.demobrowser.demo.virtual.SettingsList", {
    ...
    members: {
      ...
      */
      main: function main() {
        qxl.demobrowser.demo.virtual.SettingsList.superclass.prototype.main.call(this);
        ...
        this.__P_34_0 = qx.data.marshal.Json.createModel(data, true);
        ...
        // Assign group
        this.__P_34_0.toArray().forEach(function (item, index) {
          index = index < 2 ? 0 : 1;
      ...
      */
      ...
      configureGroupItem: function configureGroupItem(group) {
        ...
        group.addListener("changeValue", function (e) {
          ...
          this.__P_34_0.forEach(function (entry) {
