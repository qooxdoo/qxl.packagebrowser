(function () {
  ...
  ************************************************************************ */
  ...
  qx.Class.define("qxl.demobrowser.demo.ui.FormRendererCustom", {
    ...
    members: {
      main: function main() {
        qxl.demobrowser.demo.ui.FormRendererCustom.superclass.prototype.main.call(this);
  ...
  qx.Class.define("qxl.demobrowser.demo.ui.CustomRenderer", {
    ...
    members: {
      ...
      addItems: function addItems(items, names, title, options) {
        ...
        this.__P_25_1 < row ? this.__P_25_1 = row : null;
      },
