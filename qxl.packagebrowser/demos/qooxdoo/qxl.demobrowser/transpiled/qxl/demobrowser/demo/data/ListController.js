(function () {
  ...
  ************************************************************************ */
  ...
  qx.Class.define("qxl.demobrowser.demo.data.ListController", {
    ...
    members: {
      main: function main() {
        qxl.demobrowser.demo.data.ListController.superclass.prototype.main.call(this);
        ...
        var controller3 = new qx.data.controller.List(controller1.getSelection(), list3);
