  ...
  ************************************************************************ */
  ...
  qx.Class.define("qxl.demobrowser.demo.util.FSMMouse", {
    ...
    construct: function construct(origin, maze, facing, view) {
      ...
      qx.util.fsm.FiniteStateMachine.constructor.call(this, mouseName);
          ...
          switch (_this.facing) {
            case qxl.demobrowser.demo.util.FSMMaze.Direction.WEST:
              ...
              if (_this.destinationCell !== null) {
                ...
                _this.destinationLocation = maze.getCellTopLeft(_this.destinationCell);
      ...
      var trans = new qx.util.fsm.Transition("Transition_Moving_to_Moving_via_Oneshot", {
        ...
        ontransition: function ontransition(_this, event) {
          ...
          var moveAmount = Math.ceil(maze.cellSize / (qxl.demobrowser.demo.util.FSMMouse.moveSeconds * qxl.demobrowser.demo.util.FSMMouse.ticksPerSec));
