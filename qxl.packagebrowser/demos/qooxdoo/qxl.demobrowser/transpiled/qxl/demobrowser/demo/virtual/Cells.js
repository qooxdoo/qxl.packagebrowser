  ...
  ************************************************************************ */
  ...
  qx.Class.define("qxl.demobrowser.demo.virtual.Cells", {
    ...
    */
    ...
    members: {
      main: function main() {
        qxl.demobrowser.demo.virtual.Cells.superclass.prototype.main.call(this);
      ...
      testStringCell: function testStringCell() {
        ...
        qx.util.Permutation.permute(cellData, function (cellData) {
          var cell = this.__P_29_0(stringCell, cellData.value, cellData.states);
      ...
      testNumberCell: function testNumberCell() {
        ...
        qx.util.Permutation.permute(cellData, function (cellData) {
          ...
          var cell = this.__P_29_0(cellRenderer, cellData.value, cellData.states);
          this.container.add(cell);
        }, this);
      },
      ...
      __P_29_0: function __P_29_0(cell, value, states) {
        var width = 100;
        var height = 30;
