  ...
  ************************************************************************ */
  ...
  qx.Class.define("qxl.demobrowser.demo.widget.SplitPane", {
    ...
    members: {
      __P_40_0: null,
      main: function main() {
        qxl.demobrowser.demo.widget.SplitPane.superclass.prototype.main.call(this);
      ...
      _toggle: function _toggle() {
        var orientation = this.__P_40_0.getOrientation();
        this.__P_40_0.setOrientation(orientation == "horizontal" ? "vertical" : "horizontal");
      },
      /**
    ...
    destruct: function destruct() {
      this._disposeObjects("__P_40_0", "_container1", "_container2");
    }
  });
