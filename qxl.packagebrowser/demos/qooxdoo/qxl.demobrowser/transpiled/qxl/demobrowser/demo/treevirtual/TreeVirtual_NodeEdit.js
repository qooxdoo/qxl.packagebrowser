(function () {
  ...
  qx.Class.define("qxl.demobrowser.demo.treevirtual.TreeVirtual_NodeEdit", {
    ...
    members: {
      main: function main() {
        qxl.demobrowser.demo.treevirtual.TreeVirtual_NodeEdit.superclass.prototype.main.call(this);
        ...
        function (e) {
          var data = e.getData();
          alert("dataEdited from ".concat(data.oldValue.label, " to ").concat(data.value.label));
        });
  ...
  qxl.demobrowser.demo.treevirtual.TreeVirtual_NodeEdit.$$dbClassInfo = $$dbClassInfo;
})();
