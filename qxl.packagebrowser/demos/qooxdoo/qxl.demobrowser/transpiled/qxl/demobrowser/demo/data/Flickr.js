(function () {
  ...
  ************************************************************************ */
  ...
  qx.Class.define("qxl.demobrowser.demo.data.Flickr", {
    ...
    members: {
      main: function main() {
        qxl.demobrowser.demo.data.Flickr.superclass.prototype.main.call(this);
  ...
  qx.Class.define("qxl.demobrowser.demo.data.store.Flickr", {
    ...
    construct: function construct(tag) {
      ...
      qx.data.store.Jsonp.constructor.call(this, this.__P_8_0(tag));
    },
    members: {
      searchForTag: function searchForTag(tag) {
        if (tag != "") {
          this.setUrl(this.__P_8_0(tag));
        }
      },
      __P_8_0: function __P_8_0(tag) {
        if (!tag) {
          return;
        }
