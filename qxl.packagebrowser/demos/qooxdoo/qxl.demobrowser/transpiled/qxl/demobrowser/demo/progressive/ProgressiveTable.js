(function () {
  ...
  ************************************************************************ */
  ...
  qx.Class.define("qxl.demobrowser.demo.progressive.ProgressiveTable", {
    ...
    members: {
      main: function main() {
        qxl.demobrowser.demo.progressive.ProgressiveTable.superclass.prototype.main.call(this);
        var nextId = 0;
        ...
        // Add a message
        var message = new qx.ui.basic.Atom("<span style='color:red;'>Last item is intentionally inserted at the top to show how it's done</span>");
  ...
  qxl.demobrowser.demo.progressive.ProgressiveTable.$$dbClassInfo = $$dbClassInfo;
})();
