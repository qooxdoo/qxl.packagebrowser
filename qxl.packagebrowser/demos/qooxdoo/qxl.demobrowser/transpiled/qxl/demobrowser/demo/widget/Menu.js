  ...
  ************************************************************************ */
  ...
  qx.Class.define("qxl.demobrowser.demo.widget.Menu", {
    ...
    members: {
      ...
      __P_39_7: null,
      main: function main() {
        qxl.demobrowser.demo.widget.Menu.superclass.prototype.main.call(this);
      ...
      createCommands: function createCommands() {
        this.__P_39_0 = new qx.ui.command.Command("Ctrl+N");
        this.__P_39_0.addListener("execute", this.debugCommand);
        this.__P_39_1 = new qx.ui.command.Command("Ctrl+O");
        this.__P_39_1.addListener("execute", this.debugCommand);
        this.__P_39_2 = new qx.ui.command.Command("Ctrl+S");
        this.__P_39_2.addListener("execute", this.debugCommand);
        this.__P_39_3 = new qx.ui.command.Command("Ctrl+Z");
        this.__P_39_3.addListener("execute", this.debugCommand);
        this.__P_39_4 = new qx.ui.command.Command("Ctrl+R");
        this.__P_39_4.addListener("execute", this.debugCommand);
        this.__P_39_5 = new qx.ui.command.Command("Ctrl+X");
        this.__P_39_5.addListener("execute", this.debugCommand);
        this.__P_39_6 = new qx.ui.command.Command("Ctrl+C");
        this.__P_39_6.addListener("execute", this.debugCommand);
        this.__P_39_7 = new qx.ui.command.Command("Ctrl+P");
        this.__P_39_7.addListener("execute", this.debugCommand);
        this.__P_39_7.setEnabled(false);
      },
      getMenuButton: function getMenuButton() {
        ...
        var menu = new qx.ui.menu.Menu();
        var undoButton = new qx.ui.menu.Button("Undo", "icon/16/actions/edit-undo.png", this.__P_39_3);
        var redoButton = new qx.ui.menu.Button("Redo", "icon/16/actions/edit-redo.png", this.__P_39_4);
        var cutButton = new qx.ui.menu.Button("Cut", "icon/16/actions/edit-cut.png", this.__P_39_5);
        var copyButton = new qx.ui.menu.Button("Copy", "icon/16/actions/edit-copy.png", this.__P_39_6);
        var pasteButton = new qx.ui.menu.Button("Paste", "icon/16/actions/edit-paste.png", this.__P_39_7);
      ...
      getMenuBar: function getMenuBar() {
        ...
        var newButton = new qx.ui.toolbar.Button("New", "icon/16/actions/document-new.png", this.__P_39_0);
        var openButton = new qx.ui.toolbar.Button("Open", "icon/16/actions/document-open.png", this.__P_39_1);
        var saveButton = new qx.ui.toolbar.Button("Save", "icon/16/actions/document-save.png", this.__P_39_2);
      ...
      getFileMenu: function getFileMenu() {
        var menu = new qx.ui.menu.Menu();
        var newButton = new qx.ui.menu.Button("New", "icon/16/actions/document-new.png", this.__P_39_0);
        var openButton = new qx.ui.menu.Button("Open", "icon/16/actions/document-open.png", this.__P_39_1);
        var closeButton = new qx.ui.menu.Button("Close");
        var saveButton = new qx.ui.menu.Button("Save", "icon/16/actions/document-save.png", this.__P_39_2);
    ...
    destruct: function destruct() {
      this._disposeObjects("__P_39_0", "__P_39_1", "__P_39_2", "__P_39_3", "__P_39_4", "__P_39_5", "__P_39_6", "__P_39_7");
    }
  });
