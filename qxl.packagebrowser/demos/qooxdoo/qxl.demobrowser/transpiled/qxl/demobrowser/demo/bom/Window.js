  ...
  ************************************************************************ */
  ...
  qx.Class.define("qxl.demobrowser.demo.bom.Window", {
    ...
    members: {
       ...
       */
      main: function main() {
        qxl.demobrowser.demo.bom.Window.superclass.prototype.main.call(this);
        var ResourceManager = qx.util.ResourceManager.getInstance();
        this.__P_7_0 = ["http://qooxdoo.org", "http://sourceforge.net", "http://slashdot.org", ResourceManager.toUri("demobrowser/demo/html/ModalWindow.html")];
        ...
        qx.event.Registration.addListener(button1, "tap", function (e) {
          ...
          this.window1 = qx.bom.Window.open(this.__P_7_0[0], "window1", options);
        }, this);
        ...
        qx.event.Registration.addListener(button3, "tap", function (e) {
          ...
          this.window2 = qx.bom.Window.open(this.__P_7_0[3], "window2", options, true);
        }, this);
        ...
        qx.event.Registration.addListener(button5, "tap", function (e) {
          ...
          this.window3 = qx.bom.Window.open(this.__P_7_0[0], "window3", options, true, false);
        }, this);
      }
    },
    /*
