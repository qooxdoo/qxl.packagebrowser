  ...
  qx.Class.define("qxl.demobrowser.demo.virtual.Table", {
    ...
    */
    ...
    members: {
      ...
      main: function main() {
        // Call super class
        qxl.demobrowser.demo.virtual.Table.superclass.prototype.main.call(this);
        ...
        this.__P_35_0 = new qx.ui.virtual.cell.Cell();
      },
      getCellProperties: function getCellProperties(row, column) {
        return this.__P_35_0.getCellProperties(row + " / " + column);
      }
    },
    /*
     *****************************************************************************
