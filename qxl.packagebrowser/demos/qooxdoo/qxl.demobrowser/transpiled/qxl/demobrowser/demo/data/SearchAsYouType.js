(function () {
  ...
  ************************************************************************ */
  ...
  qx.Class.define("qxl.demobrowser.demo.data.SearchAsYouType", {
    ...
    members: {
      main: function main() {
        qxl.demobrowser.demo.data.SearchAsYouType.superclass.prototype.main.call(this);

        // create some stuff for the list items
        var names = ["Bart", "Lisa", "Homer", "Marge", "Moe", "Smithers", "Nelson", "Flanders", "Maggy", "Skinner"];
