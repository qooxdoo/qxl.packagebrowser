  ...
  ************************************************************************ */
  ...
  qx.Class.define("qxl.demobrowser.demo.virtual.ComboBox", {
    ...
    members: {
       ...
       */
      main: function main() {
        qxl.demobrowser.demo.virtual.ComboBox.superclass.prototype.main.call(this);
      ...
      _createHtmlExample: function _createHtmlExample() {
        ...
        var items = ["... &gt; (as literal HTML entity)", "... &gt; (as Richtext)", "<b>Bold Text</b>", "<u>Underlined Text</u>", "<i>Italic Text</i>", "HTML entities: &laquo; &lt; &amp; &gt; &raquo;"];
