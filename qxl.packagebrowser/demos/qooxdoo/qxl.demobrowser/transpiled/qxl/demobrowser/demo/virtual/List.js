  ...
  ************************************************************************ */
  ...
  qx.Class.define("qxl.demobrowser.demo.virtual.List", {
    ...
    members: {
      ...
      __P_33_2: null,
      main: function main() {
        qxl.demobrowser.demo.virtual.List.superclass.prototype.main.call(this);
      ...
      createConfigurableList: function createConfigurableList() {
        ...
        var list = this.__P_33_0 = new qx.ui.list.List(model).set({
          scrollbarX: "on",
          selectionMode: "multi",
          height: 280,
          width: 150,
        ...
        var dragCheck = this.__P_33_1 = new qx.ui.form.CheckBox("Enable drag selection");
        var quickCheck = this.__P_33_2 = new qx.ui.form.CheckBox("Enable quick selection").set({
          enabled: false
        });
      ...
      onSelectionModeChange: function onSelectionModeChange(e) {
        ...
        this.__P_33_0.setSelectionMode(value);
        if (value == "single" || value == "one") {
          this.__P_33_1.setEnabled(false);
          this.__P_33_2.setEnabled(true);
        } else if (value == "multi" || value == "addaptive") {
          this.__P_33_1.setEnabled(true);
          this.__P_33_2.setEnabled(false);
        }
      },
      ...
      onDragCheckChange: function onDragCheckChange(e) {
        if (e.getData()) {
          var mode = this.__P_33_0.getSelectionMode();
          if (mode == "single" || mode == "one") {
            this.debug("Drag selection is only available for the modes multi or additive");
          }
        }
        this.__P_33_0.setDragSelection(e.getData());
      },
      onQuickCheckChange: function onQuickCheckChange(e) {
        ...
        this.__P_33_0.setQuickSelection(e.getData());
      }
    }
  });
