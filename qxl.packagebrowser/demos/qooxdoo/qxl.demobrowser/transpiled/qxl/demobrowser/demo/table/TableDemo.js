  ...
  ************************************************************************ */
  ...
  qx.Class.define("qxl.demobrowser.demo.table.TableDemo", {
    ...
    members: {
      __P_20_0: null,
      main: function main() {
        qxl.demobrowser.demo.table.TableDemo.superclass.prototype.main.call(this);
      ...
      showDialog: function showDialog(text) {
        if (!this.__P_20_0) {
          var dlg = this.__P_20_0 = new qx.ui.window.Window().set({
            modal: true,
            showMinimize: false,
            showMaximize: false,
            width: 180,
        ...
        this.__P_20_0.getChildren()[1].setValue(text);
        this.__P_20_0.open();
        this.__P_20_0.getChildren()[2].focus();
      }
    },
