(function () {
  ...
  ************************************************************************ */
  ...
  qx.Class.define("qxl.demobrowser.demo.ui.ColorUtil", {
    ...
    members: {
      main: function main() {
        qxl.demobrowser.demo.ui.ColorUtil.superclass.prototype.main.call(this);
        ...
        var row = 1;
        [["red", 255], ["green", 255], ["blue", 255], ["hue", 360], ["saturation", 100], ["brightness", 100], ["lightness", 100], ["alpha", 1]].forEach(function (prop) {
        ...
        c.add(this.swat.adjust, {
          row: row,
          column: 0,
          colSpan: 3
        });
        c.add(this.swat.scale, {
          row: row,
          column: 3,
          colSpan: 3
        });
      ...
      swat: null,
      baseRGB: null,
      addSlider: function addSlider(type, key, range, offset, row) {
      ...
      updateSwat: function updateSwat(type) {
        this.swat[type].setBackgroundColor(qx.util.ColorUtil[type](this.baseRGB, this.map[type]));
      }
    }
  });
  qxl.demobrowser.demo.ui.ColorUtil.$$dbClassInfo = $$dbClassInfo;
})();
