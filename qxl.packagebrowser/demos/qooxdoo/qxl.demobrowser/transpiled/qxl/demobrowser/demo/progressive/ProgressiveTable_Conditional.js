(function () {
  ...
  qx.Class.define("qxl.demobrowser.demo.progressive.ProgressiveTable_Conditional", {
    ...
    members: {
      main: function main() {
        qxl.demobrowser.demo.progressive.ProgressiveTable_Conditional.superclass.prototype.main.call(this);
        ...
        var r = new qx.ui.progressive.renderer.table.cell.Conditional("right", "", "", "");
  ...
  qxl.demobrowser.demo.progressive.ProgressiveTable_Conditional.$$dbClassInfo = $$dbClassInfo;
})();
