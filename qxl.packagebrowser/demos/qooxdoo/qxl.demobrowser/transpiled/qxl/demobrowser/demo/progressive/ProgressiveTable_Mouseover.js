(function () {
  ...
  qx.Class.define("qxl.demobrowser.demo.progressive.ProgressiveTable_Mouseover", {
    ...
    members: {
      main: function main() {
        qxl.demobrowser.demo.progressive.ProgressiveTable_Mouseover.superclass.prototype.main.call(this);
        var nextId = 0;
        ...
        rowRenderer.addRenderer(2, new qxl.demobrowser.demo.progressive.DateCellRenderer());
  ...
  qx.Class.define("qxl.demobrowser.demo.progressive.DateCellRenderer", {
    ...
    statics: {
      onmouseover: function onmouseover(cellDiv) {
        // Save the original text color
        cellDiv.__P_17_0 = qx.bom.element.Style.get(cellDiv, "color");
        ...
        cellDiv.__P_17_1 = cellDiv.innerHTML;

        // Generate an expanded date representation
        var ms = Date.parse(cellDiv.attributes.getNamedItem("celldata").nodeValue);
      ...
      onmouseout: function onmouseout(cellDiv) {
        // Restore the original color
        cellDiv.style.color = cellDiv.__P_17_0;

        // Restore the original row height
        cellDiv.parentNode.style.height = 16;

        // Restore the original cell data
        cellDiv.innerHTML = cellDiv.__P_17_1;
      }
    },
    members: {
      _getCellExtras: function _getCellExtras(cellInfo) {
        ...
        html.push(qxl.demobrowser.demo.progressive.DateCellRenderer.superclass.prototype._getCellExtras.call(this));
        ...
        html.push("onmouseover='qxl.demobrowser.demo.progressive.DateCellRenderer.onmouseover(this);' ", "onmouseout='qxl.demobrowser.demo.progressive.DateCellRenderer.onmouseout(this);' ");
        return html.join("");
      }
    }
  });
  qxl.demobrowser.demo.progressive.ProgressiveTable_Mouseover.$$dbClassInfo = $$dbClassInfo;
})();
