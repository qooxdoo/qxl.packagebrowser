(function () {
  ...
  qx.Class.define("qxl.demobrowser.demo.progressive.ProgressiveLoader", {
    ...
    members: {
      main: function main() {
        qxl.demobrowser.demo.progressive.ProgressiveLoader.superclass.prototype.main.call(this);
        ...
        var addFunc = function addFunc(func) {
          var ret = {
            renderer: "func",
            data: func
          };
        ...
        for (var page = 0; page < pages.length; page++) {
          ...
          for (var row = 0; row < 20; row++) {
            ...
            dataModel.addElement(addFunc(function (userData) {
              ...
              context.hBox = new qx.ui.container.Composite(new qx.ui.layout.HBox(4));
            ...
            for (var col = 0; col < 10; col++) {
              ...
              dataModel.addElement(addFunc(function (userData) {
                ...
                var o = new qx.ui.basic.Atom("row " + context.row + ", " + "col " + context.col);
                o.set({
                  width: 90,
  ...
  qxl.demobrowser.demo.progressive.ProgressiveLoader.$$dbClassInfo = $$dbClassInfo;
})();
