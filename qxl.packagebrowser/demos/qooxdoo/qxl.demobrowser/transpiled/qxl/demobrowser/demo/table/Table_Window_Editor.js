    ...
    members: {
      ...
      createCellEditor: function createCellEditor(cellInfo) {
        ...
        cellEditor.addListener("appear", function (e) {
          cellEditor.__P_22_0.focus();
          cellEditor.__P_22_0.setTextSelection(0, cellEditor.__P_22_0.getValue().length);
        });

        // Create a text field in which to edit the data
        cellEditor.__P_22_0 = new qx.ui.form.TextField(cellInfo.value + "").set({
          allowGrowY: true
        });
        cellEditor.add(cellEditor.__P_22_0);
      ...
      getCellEditorValue: function getCellEditorValue(cellEditor) {
        ...
        return parseFloat(cellEditor.__P_22_0.getValue());
      }
    }
  });
