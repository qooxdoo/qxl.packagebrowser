(function () {
  ...
  ************************************************************************ */
  ...
  qx.Class.define("qxl.demobrowser.demo.virtual.SelectBox", {
    ...
    members: {
      main: function main() {
        qxl.demobrowser.demo.virtual.SelectBox.superclass.prototype.main.call(this);
        ...
        container.add(incrementalSearch, {
          left: 20,
          top: 380
        });
      ...
      createBox8: function createBox8() {
        var container = new qx.ui.container.Composite(new qx.ui.layout.VBox(2));
        container.add(new qx.ui.basic.Label("Incremental Search, plain highlighting"));

        // Creates the model data
        var rawData = ["Elm street", "Abbey road", "Route 61", "Central station", "Central Park", "Park Avenue", "Broadway", "Hohle Gasse", "Überlandstrasse"];
        var model = qx.data.marshal.Json.createModel(rawData);
      ...
      createBox9: function createBox9() {
        var container = new qx.ui.container.Composite(new qx.ui.layout.VBox(2));
      ...
      createBox10: function createBox10() {
        var container = new qx.ui.container.Composite(new qx.ui.layout.VBox(2));
