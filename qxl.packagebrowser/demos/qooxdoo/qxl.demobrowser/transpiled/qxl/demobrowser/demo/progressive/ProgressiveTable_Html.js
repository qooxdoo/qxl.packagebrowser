(function () {
  ...
  qx.Class.define("qxl.demobrowser.demo.progressive.ProgressiveTable_Html", {
    ...
    members: {
      main: function main() {
        qxl.demobrowser.demo.progressive.ProgressiveTable_Html.superclass.prototype.main.call(this);
        var createRow = function createRow(html, height) {
          var ret = {
            renderer: "row",
            location: "end",
            data: [html, html]
        ...
        var rowData = [];
        var html = "<div style='background-color: cyan; text-align: center;'>  Hello world!</div>";
        rowData.push(createRow(html));
        var html = "<div style='background-color: cyan; text-align: center;'>  Hi there.  <span style='color: red;'>    &nbsp;&nbsp;&nbsp;    I'm red!  </span></div>";
        rowData.push(createRow(html));
  ...
  qxl.demobrowser.demo.progressive.ProgressiveTable_Html.$$dbClassInfo = $$dbClassInfo;
})();
