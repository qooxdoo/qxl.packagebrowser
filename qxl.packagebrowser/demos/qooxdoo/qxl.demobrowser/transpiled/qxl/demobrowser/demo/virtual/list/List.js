  ...
  ************************************************************************ */
  ...
  qx.Class.define("qxl.demobrowser.demo.virtual.list.List", {
    ...
    construct: function construct() {
      ...
      this.__P_37_0 = new qx.ui.virtual.layer.WidgetCell(this);
      this.getPane().addLayer(this.__P_37_0);
      this.getPane().addListener("resize", this._onResize, this);
      this.__P_37_1 = [];
      this.__P_37_2 = [];
      this.__P_37_3 = new qx.ui.virtual.selection.Row(this.getPane());
      this.__P_37_3.addListener("changeSelection", this._onChangeSelection, this);
      this.__P_37_3.attachPointerEvents();
      this.__P_37_3.attachKeyEvents(this);
      this.__P_37_3.attachListEvents(this);
    ...
    */
    ...
    members: {
      ...
      update: function update() {
        ...
        rowConfig.setItemCount(this.__P_37_1.length);
        rowConfig.resetItemSizes();
        for (var i = 0; i < this.__P_37_1.length; i++) {
          var height = this.__P_37_1[i].getHeight();
          if (height !== null) {
      ...
      updateSelection: function updateSelection() {
        var widgets = this.__P_37_0.getChildren();
        for (var i = 0; i < widgets.length; i++) {
          var widget = widgets[i];
          var row = widget.getUserData("row");
          if (this.__P_37_3.isItemSelected(row)) {
      ...
      */
      ...
      _onChangeSelection: function _onChangeSelection(e) {
        ...
        this.fireDataEvent("changeSelection", this.__P_37_4(e.getData()));
      },
      /*
      ---------------------------------------------------------------------------
        CELL PROVIDER API
      ...
      */
      ...
      getCellWidget: function getCellWidget(row, column) {
        var data = this.__P_37_1[row];
        if (!data) {
          return null;
        }
        var widget = this.__P_37_2.pop() || new qx.ui.form.ListItem();
        widget.set({
          label: data.getLabel(),
          icon: data.getIcon()
        });
      ...
      */
      ...
      remove: function remove(child) {
        qx.lang.Array.remove(this.__P_37_1, child);
      ...
      removeAll: function removeAll() {
        for (var i = 0, j = this.__P_37_1.length; i < j; i++) {
          this._removeHelper(this.__P_37_1[i]);
        }
        this.__P_37_1 = [];
      },
      /**
      ...
      indexOf: function indexOf(child) {
        return this.__P_37_1.indexOf(child);
      },
      /**
      ...
      addAt: function addAt(child, index) {
        qx.lang.Array.insertAt(this.__P_37_1, child, index);
        this._addHelper(child);
      },
      /**
      ...
      addBefore: function addBefore(child, before) {
        qx.lang.Array.insertBefore(this.__P_37_1, child, before);
        this._addHelper(child);
      },
      /**
      ...
      addAfter: function addAfter(child, after) {
        qx.lang.Array.insertAfter(this.__P_37_1, child, after);
        this._addHelper(child);
      },
      /**
      ...
      removeAt: function removeAt(index) {
        this.__P_37_1.splice(index, 1);
        this._removeHelper(this.__P_37_1[index]);
      },
      /*
      ---------------------------------------------------------------------------
        SELECTION HANDLING
      ---------------------------------------------------------------------------
      */
      __P_37_5: function __P_37_5(item) {
        var row = this.__P_37_1.indexOf(item);
        if (row < 0) {
          return null;
        }
        return row;
      },
      __P_37_6: function __P_37_6(row) {
        var item = this.__P_37_1[row];
        return item;
      },
      __P_37_7: function __P_37_7(items) {
        var rows = [];
        for (var i = 0; i < items.length; i++) {
          rows.push(this.__P_37_5(items[i]));
        }
        return rows;
      },
      __P_37_4: function __P_37_4(rows) {
        var items = [];
        for (var i = 0; i < rows.length; i++) {
          items.push(this.__P_37_1[rows[i]]);
        }
        return items;
      },
      /**
      ...
      setSelected: function setSelected(item) {
        this.__P_37_3.selectItem(this.__P_37_5(item));
      },
      /**
      ...
      isSelected: function isSelected(item) {
        return this.__P_37_3.isItemSelected(this.__P_37_5(item));
      },
      /**
      ...
      addToSelection: function addToSelection(item) {
        this.__P_37_3.addItem(this.__P_37_5(item));
      },
      /**
      ...
      removeFromSelection: function removeFromSelection(item) {
        this.__P_37_3.removeItem(this.__P_37_5(item));
      },
      /**
      ...
      selectRange: function selectRange(begin, end) {
        this.__P_37_3.selectItemRange(this.__P_37_5(begin), this.__P_37_5(end));
      },
      /**
      ...
      setSelection: function setSelection(items) {
        this.__P_37_3.replaceSelection(this.__P_37_7(items));
      },
      /**
      ...
      getSelectedItem: function getSelectedItem() {
        return this.__P_37_1[this.getSelected()];
      },
      /**
      ...
      getSelected: function getSelected() {
        return this.__P_37_1[this.__P_37_3.getSelectedItem()];
      },
      /**
      ...
      getSelection: function getSelection() {
        return this.__P_37_4(this.__P_37_3.getSelection());
      },
      /**
      ...
      getSortedSelection: function getSortedSelection() {
        return this.__P_37_4(this.__P_37_3.getSortedSelection());
      },
      /**
      ...
      isSelectionEmpty: function isSelectionEmpty() {
        return this.__P_37_3.isSelectionEmpty();
      },
      /**
      ...
      getSelectionContext: function getSelectionContext() {
        return this.__P_37_3.getSelectionContext();
      },
      /**
