  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.html.Text", {
    ...
    members: {
       ...
       */
      _createDomElement() {
        return window.document.createTextNode(this.__P_100_0 || "");
      },
      /*
       * @Override
       */
      ...
      _serializeImpl(serializer) {
        serializer.rawTextInBody(this.__P_100_0);
      },
      /**
       * @Override
       */
    ...
    defer(statics) {
      statics.__P_100_1 = new qx.util.DeferredCall(statics.flush, statics);
    },
    /*
     * ****************************************************************************
     * DESTRUCT
    ...
    destruct() {
      ...
      this.__P_100_2 = this.__P_100_3 = this.__P_100_4 = this.__P_100_5 = this.__P_100_6 = this.__P_100_7 = this.__P_100_8 = null;
    }
  });
