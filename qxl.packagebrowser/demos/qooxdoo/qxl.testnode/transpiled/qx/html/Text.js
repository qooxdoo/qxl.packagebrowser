  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.html.Text", {
    ...
    members: {
       ...
       */
      _createDomElement() {
        return window.document.createTextNode(this.__P_96_0 || "");
      },
      /*
       * @Override
       */
      ...
      _serializeImpl(serializer) {
        serializer.rawTextInBody(this.__P_96_0);
      },
      /**
       * @Override
       */
    ...
    defer(statics) {
      statics.__P_96_1 = new qx.util.DeferredCall(statics.flush, statics);
    },
    /*
     * ****************************************************************************
     * DESTRUCT
    ...
    destruct() {
      ...
      this.__P_96_2 = this.__P_96_3 = this.__P_96_4 = this.__P_96_5 = this.__P_96_6 = this.__P_96_7 = this.__P_96_8 = null;
    }
  });
