  ...
  qx.Class.define("qx.html.Element", {
    ...
    members: {
      ...
      _serializeImpl(serializer) {
        ...
        if (this.__P_61_1) {
          for (var key in this.__P_61_1) {
            let result = qx.bom.element.Attribute.serialize(key, this.__P_61_1[key]);
      ...
      */
      ...
      __P_61_19(element) {
        ...
        (_element$getChildren = element.getChildren()) === null || _element$getChildren === void 0 || _element$getChildren.forEach(child => slots.push(...this.__P_61_19(child)));
        return slots;
      },
      _slotScanAdd(element) {
        for (const slot of this.__P_61_19(element)) {
          this.__P_61_2.set(slot.getName(), slot);
        }
      },
      _slotScanRemove(child) {
        for (const slot of this.__P_61_19(child)) {
      ...
      */
       ...
       */
      setRoot(root) {
        if (root && !this.__P_61_10) {
          qx.html.Element._hasRoots++;
        } else if (!root && this.__P_61_10) {
          qx.html.Element._hasRoots--;
        }
        this.__P_61_10 = root;
      },
    ...
    */
    ...
    destruct() {
      ...
      this.setRoot(false);
      this.__P_61_1 = this.__P_61_0 = this.__P_61_16 = this.__P_61_15 = this.__P_61_11 = this.__P_61_12 = null;
    }
  });
