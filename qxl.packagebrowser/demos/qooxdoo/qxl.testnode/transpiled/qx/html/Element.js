  ...
  qx.Class.define("qx.html.Element", {
    ...
    */
    ...
    construct: function (tagName, styles, attributes) {
      ...
      this.__P_56_0 = tagName || "div";
      this.__P_56_1 = styles || null;
      this.__P_56_2 = attributes || null;
    },
    ...
    statics: {
      ...
      */
      ...
      _scheduleFlush: function (job) {
        qx.html.Element.__P_56_6.schedule();
      },
      ...
      flush: function () {
        ...
        var focusHandler = this.__P_56_7();

        var focusedDomElement = focusHandler.getFocus();

        if (focusedDomElement && this.__P_56_8(focusedDomElement)) {
        ...
        if (activeDomElement && this.__P_56_8(activeDomElement)) {
          qx.bom.Element.deactivate(activeDomElement);
        } // release capture for elements, which will be removed


        var captureDomElement = this.__P_56_9();

        if (captureDomElement && this.__P_56_8(captureDomElement)) {
        ...
        for (var hc in modified) {
          ...
          if (obj.__P_56_10() || obj.classname == "qx.html.Iframe") {
            // Separately queue rendered elements
            if (obj.__P_56_11 && qx.dom.Hierarchy.isRendered(obj.__P_56_11)) {
              later.push(obj);
        ...
        for (var hc in visibility) {
          ...
          if (!obj.$$disposed) {
            element.style.display = obj.__P_56_13 ? "" : "none"; // also hide the element (fixed some rendering problem in IE<8 & IE8 quirks)

            if (qx.core.Environment.get("engine.name") == "mshtml") {
              if (!(document.documentMode >= 8)) {
                element.style.visibility = obj.__P_56_13 ? "visible" : "hidden";
              }
            }
          }
        ...
        for (var hc in scroll) {
          obj = scroll[hc];
          var elem = obj.__P_56_11;

          if (elem && elem.offsetWidth) {
            var done = true; // ScrollToX

            if (obj.__P_56_14 != null) {
              obj.__P_56_11.scrollLeft = obj.__P_56_14;
              delete obj.__P_56_14;
            } // ScrollToY


            if (obj.__P_56_15 != null) {
              obj.__P_56_11.scrollTop = obj.__P_56_15;
              delete obj.__P_56_15;
            } // ScrollIntoViewX


            var intoViewX = obj.__P_56_16;
        ...
        for (var i = 0; i < this._actions.length; i++) {
          ...
          var element = action.element.__P_56_11;

          if (!element || !activityEndActions[action.type] && !action.element.__P_56_10()) {
            continue;
          }
        ...
        for (var hc in this.__P_56_3) {
          var selection = this.__P_56_3[hc];
          var elem = selection.element.__P_56_11;

          if (elem) {
            qx.bom.Selection.set(elem, selection.start, selection.end);
            delete this.__P_56_3[hc];
          }
      ...
      __P_56_7: function () {
        if (!this.__P_56_4) {
          ...
          this.__P_56_4 = eventManager.getHandler(qx.event.handler.Focus);
        }
      ...
      __P_56_9: function () {
        if (!this.__P_56_5) {
          var eventManager = qx.event.Registration.getManager(window);
          this.__P_56_5 = eventManager.getDispatcher(qx.event.dispatch.MouseCapture);
        }

        return this.__P_56_5.getCaptureElement();
      },
       ...
       */
      __P_56_8: function (domElement) {
        var element = this.fromDomElement(domElement);
        return element && !element.__P_56_10();
      },
    ...
    members: {
      ...
      */
      ...
      _createDomElement: function () {
        return qx.dom.Element.create(this.__P_56_0);
      },
      ...
      connectWidget: function (widget) {
        this.__P_56_18 = widget;

        if (this.__P_56_11) {
          this.__P_56_11.$$widget = widget.toHashCode();
          this.__P_56_11.$$widgetObject = widget;
        }
      ...
      disconnectWidget: function (widget) {
        delete this.__P_56_18;

        if (this.__P_56_11) {
          this.__P_56_11.$$widget = "";
          delete this.__P_56_11.$$widgetObject;
        }
       ...
       */
      __P_56_29: function (domElement) {
        ;
        this.__P_56_11 = domElement;
        domElement.$$elementObject = this;
        domElement.$$element = this.toHashCode();

        if (this.__P_56_18) {
          domElement.$$widget = this.__P_56_18.toHashCode();
          domElement.$$widgetObject = this.__P_56_18;
        }
      },
      ...
      __P_56_12: function () {
        ...
        if (children) {
          ...
          for (var i = 0; i < length; i++) {
            ...
            if (child.__P_56_13 && child.__P_56_20 && !child.__P_56_11) {
              child.__P_56_12();
            }
          }
        }
        ...
        if (!this.__P_56_11) {
          this.__P_56_29(this._createDomElement());
      ...
      */
      ...
      _insertChildren: function () {
        ...
        if (length > 2) {
          ...
          for (var i = 0; i < length; i++) {
            ...
            if (child.__P_56_11 && child.__P_56_20) {
              domElement.appendChild(child.__P_56_11);
            }
          }

          this.__P_56_11.appendChild(domElement);
        } else {
          var domElement = this.__P_56_11;
      ...
      _syncChildren: function () {
        var dataChildren = this.__P_56_26;
        var dataLength = dataChildren.length;
        var dataChild;
        var dataEl;
        var domParent = this.__P_56_11;
        ...
        for (var i = domChildren.length - 1; i >= 0; i--) {
          ...
          if (!dataEl || !dataEl.__P_56_20 || dataEl.__P_56_28 !== this) {
        ...
        for (var i = 0; i < dataLength; i++) {
          ...
          if (dataChild.__P_56_20) {
            dataEl = dataChild.__P_56_11;
      ...
      */
      updateObjectId: function () {
        ...
        if (qx.core.Environment.get("module.objectid")) {
          ...
          if (this.__P_56_18 && this.__P_56_18.getQxObjectId()) {
            id = qx.core.Id.getAbsoluteIdOf(this.__P_56_18, true) || null;
          }
      ...
      _copyData: function (fromMarkup) {
        var elem = this.__P_56_11; // Copy attributes

        var data = this.__P_56_2;
       ...
       */
      _syncData: function () {
        var elem = this.__P_56_11;
        var Attribute = qx.bom.element.Attribute;
        var Style = qx.bom.element.Style; // Sync attributes

        var jobs = this.__P_56_22;
      ...
      */
       ...
       *     of this element
       */
      __P_56_30: function (child) {
        if (child.__P_56_28 === this) {
        ...
        if (child.__P_56_28) {
          child.__P_56_28.remove(child);
        } // Convert to child of this object


        child.__P_56_28 = this; // Prepare array
      ...
      */
      ...
      add: function (varargs) {
        if (arguments[1]) {
          for (var i = 0, l = arguments.length; i < l; i++) {
            this.__P_56_30(arguments[i]);
          }

          this.__P_56_26.push.apply(this.__P_56_26, arguments);
        } else {
          this.__P_56_30(varargs);

          this.__P_56_26.push(varargs);
        } // Chaining support
      ...
      addAt: function (child, index) {
        this.__P_56_30(child);

        qx.lang.Array.insertAt(this.__P_56_26, child, index); // Chaining support
      ...
      remove: function (childs) {
        ...
        if (arguments[1]) {
          ...
          for (var i = 0, l = arguments.length; i < l; i++) {
            ...
            this.__P_56_31(child);

            qx.lang.Array.remove(children, child);
          }
        } else {
          this.__P_56_31(childs);
      ...
      removeAt: function (index) {
        ...
        qx.lang.Array.removeAt(this.__P_56_26, index); // Chaining support
      ...
      */
      ...
      insertInto: function (parent, index) {
        parent.__P_56_30(this);

        if (index == null) {
          parent.__P_56_26.push(this);
        } else {
          qx.lang.Array.insertAt(this.__P_56_26, this, index);
        }
      ...
      insertBefore: function (rel) {
        var parent = rel.__P_56_28;

        parent.__P_56_30(this);

        qx.lang.Array.insertBefore(parent.__P_56_26, this, rel);
        return this;
      },
      ...
      insertAfter: function (rel) {
        ...
        qx.lang.Array.insertAfter(parent.__P_56_26, this, rel);
        return this;
      },
      ...
      moveTo: function (index) {
        var parent = this.__P_56_28;

        parent.__P_56_32(this);

        var oldIndex = parent.__P_56_26.indexOf(this);
        ...
        qx.lang.Array.removeAt(parent.__P_56_26, oldIndex);
        qx.lang.Array.insertAt(parent.__P_56_26, this, index);
        return this;
      },
      ...
      moveBefore: function (rel) {
        var parent = this.__P_56_28;
        return this.moveTo(parent.__P_56_26.indexOf(rel));
      },
      ...
      moveAfter: function (rel) {
        var parent = this.__P_56_28;
        return this.moveTo(parent.__P_56_26.indexOf(rel) + 1);
      },
      ...
      free: function () {
        ...
        parent.__P_56_31(this);

        qx.lang.Array.remove(parent.__P_56_26, this);
        return this;
      },
      ...
      */
      ...
      useElement: function (elem) {
        ...
        this.__P_56_29(elem); // Copy currently existing data over to element
      ...
      isFocusable: function () {
        ...
        if (tabIndex >= 0 && focusable[this.__P_56_0]) {
          return true;
        }
      ...
      isNativelyFocusable: function () {
        return !!qx.event.handler.Focus.FOCUSABLE_ELEMENTS[this.__P_56_0];
      },
      ...
      */
      ...
      include: function () {
        ...
        delete this.__P_56_20;

        if (this.__P_56_28) {
          this.__P_56_28._scheduleChildrenUpdate();
        }
      ...
      */
      ...
      disableScrolling: function () {
        ...
        this.scrollToX(0);
        this.scrollToY(0);
        this.addListener("scroll", this.__P_56_33, this);
      },
      ...
      enableScrolling: function () {
        this.removeListener("scroll", this.__P_56_33, this);
      },
      __P_56_34: null,
       ...
       */
      __P_56_33: function (e) {
        if (!this.__P_56_34) {
          this.__P_56_34 = true;
          this.__P_56_11.scrollTop = 0;
          this.__P_56_11.scrollLeft = 0;
          delete this.__P_56_34;
        }
      },
      ...
      */
      ...
      setTextSelection: function (start, end) {
        ...
        qx.html.Element.__P_56_3[this.toHashCode()] = {
          element: this,
          start: start,
          end: end
        };
      ...
      clearTextSelection: function () {
        ...
        delete qx.html.Element.__P_56_3[this.toHashCode()];
      },
      ...
      */
       ...
       */
      __P_56_35: function (action, args) {
      ...
      capture: function (containerCapture) {
        this.__P_56_35("capture", [containerCapture !== false]);
      },
      ...
      */
      ...
      setStyle: function (key, value, direct) {
        ...
        if (this.__P_56_1[key] == value) {
          return this;
        }

        if (value == null) {
          delete this.__P_56_1[key];
        } else {
          this.__P_56_1[key] = value;
        ...
        if (this.__P_56_11) {
          ...
          if (direct) {
            qx.bom.element.Style.set(this.__P_56_11, key, value);
            return this;
          ...
          this.__P_56_21[key] = true; // Register modification
      ...
      setStyles: function (map, direct) {
        ...
        if (this.__P_56_11) {
          ...
          for (var key in map) {
            ...
            if (direct) {
              Style.set(this.__P_56_11, key, value);
              continue;
            } // Store job info


            this.__P_56_21[key] = true;
      ...
      getStyle: function (key) {
        return this.__P_56_1 ? this.__P_56_1[key] : null;
      },
      ...
      */
      ...
      setAttribute: function (key, value, direct) {
        ...
        if (this.__P_56_2[key] == value) {
          return this;
        }

        if (value == null) {
          delete this.__P_56_2[key];
        } else {
          this.__P_56_2[key] = value;
        } // Uncreated elements simply copy all data
        // on creation. We don't need to remember any
        // jobs. It is a simple full list copy.
        ...
        if (this.__P_56_11) {
          // Omit queuing in direct mode
          if (direct) {
            qx.bom.element.Attribute.set(this.__P_56_11, key, value);
            return this;
          } // Dynamically create if needed
          ...
          this.__P_56_22[key] = true; // Register modification
      ...
      getAttribute: function (key) {
        return this.__P_56_2 ? this.__P_56_2[key] : null;
      },
      ...
      */
      ...
      _setProperty: function (key, value, direct) {
        ...
        if (this.__P_56_24[key] == value) {
          return this;
        }

        if (value == null) {
          delete this.__P_56_24[key];
        } else {
          this.__P_56_24[key] = value;
        } // Uncreated elements simply copy all data
        // on creation. We don't need to remember any
        // jobs. It is a simple full list copy.
        ...
        if (this.__P_56_11) {
          ...
          this.__P_56_23[key] = true; // Register modification
      ...
      */
      ...
      addListener: function (type, listener, self, capture) {
        ...
        if (this.__P_56_11) {
          return qx.event.Registration.addListener(this.__P_56_11, type, listener, self, capture);
        }
      ...
      removeListener: function (type, listener, self, capture) {
        ...
        if (this.__P_56_11) {
          ...
          qx.event.Registration.removeListener(this.__P_56_11, type, listener, self, capture);
        } else {
          var values = this.__P_56_25;
          var entry;
      ...
      removeListenerById: function (id) {
        ...
        if (this.__P_56_11) {
          qx.event.Registration.removeListenerById(this.__P_56_11, id);
        } else {
          delete this.__P_56_25[id];
        }
      ...
      hasListener: function (type, capture) {
        ...
        if (this.__P_56_11) {
          return qx.event.Registration.hasListener(this.__P_56_11, type, capture);
        }
      ...
      getListeners: function () {
        ...
        if (this.__P_56_11) {
          return qx.event.Registration.getManager(this.__P_56_11).serializeListeners(this.__P_56_11);
        }

        var listeners = [];

        for (var id in this.__P_56_25) {
          var listenerData = this.__P_56_25[id];
          listeners.push({
    ...
    */
    defer: function (statics) {
      statics.__P_56_6 = new qx.util.DeferredCall(statics.flush, statics);
    },
    ...
    */
    destruct: function () {
      ...
      this._disposeArray("__P_56_26");

      this.__P_56_2 = this.__P_56_1 = this.__P_56_25 = this.__P_56_24 = this.__P_56_22 = this.__P_56_21 = this.__P_56_23 = this.__P_56_11 = this.__P_56_28 = this.__P_56_16 = this.__P_56_17 = null;
    }
  });
  qx.html.Element.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=Element.js.map?dt=1626058134134