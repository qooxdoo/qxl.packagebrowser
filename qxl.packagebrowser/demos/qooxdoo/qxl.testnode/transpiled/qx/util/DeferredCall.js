  ...
  qx.Class.define("qx.util.DeferredCall", {
    ...
    */
    ...
    construct(callback, context) {
      ...
      this.__P_70_0 = callback;
      this.__P_70_1 = context || null;
      this.__P_70_2 = qx.util.DeferredCallManager.getInstance();
    },
    /*
    *****************************************************************************
       MEMBERS
    ...
    */
    ...
    members: {
       ...
       */
      cancel() {
        this.__P_70_2.cancel(this);
      },
      /**
       * Issue a deferred call of the callback.
       */
      schedule() {
        this.__P_70_2.schedule(this);
      },
      /**
       * Calls the callback directly.
       */
      call() {
        this.__P_70_1 ? this.__P_70_0.apply(this.__P_70_1) : this.__P_70_0();
      }
    },
    /*
    *****************************************************************************
    ...
    */
    ...
    destruct() {
      this.cancel();
      this.__P_70_1 = this.__P_70_0 = this.__P_70_2 = null;
    }
  });
