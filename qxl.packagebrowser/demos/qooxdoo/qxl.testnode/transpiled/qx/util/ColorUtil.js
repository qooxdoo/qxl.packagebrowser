      ...
      */
      ...
      hexStringToRgb: function (value) {
        if (this.ishexShortString(value)) {
          return this.__P_87_2(value);
        }

        if (this.ishexLongString(value)) {
          return this.__P_87_3(value);
        }
       ...
       */
      __P_87_6: function (color, tuneMap, tuner, hue_tuner) {
      ...
      scale: function (color, scaleMap) {
        return this.__P_87_6(color, scaleMap, function (value, scale, max) {
          if (value > max) {
            value = max;
          }
      ...
      adjust: function (color, adjustMap) {
        return this.__P_87_6(color, adjustMap, function (value, offset, max) {
          value += offset;
...
//# sourceMappingURL=ColorUtil.js.map?dt=1626058136402