  ...
  qx.Class.define("qx.util.AliasManager", {
    ...
    */
    construct: function () {
      ...
      this.__P_74_0 = {}; // Define static alias from setting
    ...
    */
    members: {
      ...
      _preprocess: function (value) {
        ...
        if (dynamics[value] === false) {
          ...
          if (this.__P_74_0[value]) {
            return this.__P_74_0[value];
          }

          var alias = value.substring(0, value.indexOf("/"));
          var resolved = this.__P_74_0[alias];
      ...
      add: function (alias, base) {
        ...
        this.__P_74_0[alias] = base; // Localify stores
      ...
      remove: function (alias) {
        delete this.__P_74_0[alias]; // No signal for depending objects here. These
...
//# sourceMappingURL=AliasManager.js.map?dt=1626058135268