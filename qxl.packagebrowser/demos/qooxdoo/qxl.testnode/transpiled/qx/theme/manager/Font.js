    ...
    members: {
      ...
      resolve: function (value) {
        ...
        if (theme !== null && theme.fonts[value]) {
          var font = this.__P_96_0(theme.fonts[value]);
       ...
       */
      __P_96_1: function (fonts, fontName) {
        ...
        if (value) {
          ...
          for (var key in source) {
            if (source[key].include && source[source[key].include]) {
              this.__P_96_1(source, key);
            }

            var font = this.__P_96_0(source[key]);
...
//# sourceMappingURL=Font.js.map?dt=1626058137296