  ...
  ************************************************************************ */
  ...
  qx.Bootstrap.define("qx.bom.client.Stylesheet", {
    statics: {
       ...
       */
      __P_155_0() {
        if (!qx.bom.client.Stylesheet.__P_155_1) {
          qx.bom.client.Stylesheet.__P_155_1 = qx.bom.Stylesheet.createElement();
        }
        return qx.bom.client.Stylesheet.__P_155_1;
      },
      /**
       ...
       */
      getInsertRule() {
        return typeof qx.bom.client.Stylesheet.__P_155_0().insertRule === "function";
      },
      /**
       ...
       */
      getDeleteRule() {
        return typeof qx.bom.client.Stylesheet.__P_155_0().deleteRule === "function";
      },
      /**
       ...
       */
      getAddImport() {
        return typeof qx.bom.client.Stylesheet.__P_155_0().addImport === "object";
      },
      /**
       ...
       */
      getRemoveImport() {
        return typeof qx.bom.client.Stylesheet.__P_155_0().removeImport === "object";
      }
    },
    defer(statics) {
