  ...
  qx.Bootstrap.define("qx.bom.client.Css", {
    statics: {
      ...
      getLinearGradient: function () {
        qx.bom.client.Css.__P_84_0 = false;
        ...
        if (!style) {
          ...
          if (style) {
            qx.bom.client.Css.__P_84_0 = true;
          }
        } // not supported
      ...
      getLegacyWebkitGradient: function () {
        if (qx.bom.client.Css.__P_84_0 === null) {
          qx.bom.client.Css.getLinearGradient();
        }

        return qx.bom.client.Css.__P_84_0;
      },
...
//# sourceMappingURL=Css.js.map?dt=1626058136130