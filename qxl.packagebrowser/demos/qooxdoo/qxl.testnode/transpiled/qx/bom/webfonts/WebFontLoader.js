    ...
    */
    ...
    members: {
      ...
      getValidator(fontWeight, fontStyle) {
        ...
        let validator = this.__P_141_0[id];
        if (!validator) {
          validator = this.__P_141_0[id] = new qx.bom.webfonts.Validator(this.getFontFamily(), this.getComparisonString(), fontWeight, fontStyle);
      ...
      async load() {
        (this.getCss() || []).forEach(url => {
          ...
          qx.bom.webfonts.WebFontLoader.__P_141_3(url);
        });
        ...
        if (fontFaces) {
          ...
          this.__P_141_1 = qx.lang.Array.clone(fontFaces);
          this.__P_141_2 = new qx.Promise();
        }
        this.__P_141_4();
      },
      async promiseLoaded() {
        return await this.__P_141_2;
      },
      /**
      ...
      __P_141_4() {
        ...
        let fontFace = this.__P_141_1.pop();
        this.__P_141_5(fontFace);
        if (this.__P_141_1.length == 0) {
          this.__P_141_1 = null;
          this.__P_141_2.resolve(true);
        }
      ...
      __P_141_5(fontFace) {
        ...
        if (qx.bom.webfonts.WebFontLoader.__P_141_6[fontLookupKey]) {
          return;
        }
        if (!qx.bom.webfonts.WebFontLoader.__P_141_7) {
          let styleSheet = qx.bom.Stylesheet.createElement();
          qx.bom.webfonts.WebFontLoader.__P_141_7 = styleSheet;
        }
        let sourcesMap = {};
        ...
        rule = "@font-face {\n" + rule + "}\n";
        let styleSheet = qx.bom.webfonts.WebFontLoader.__P_141_7;
        try {
          if (qx.core.Environment.get("browser.name") == "ie" && qx.core.Environment.get("browser.documentmode") < 9) {
            let cssText = qx.bom.webfonts.WebFontLoader.__P_141_8(styleSheet.cssText);
            cssText += rule;
        ...
        qx.bom.webfonts.WebFontLoader.__P_141_6[fontLookupKey] = true;
      },
      // property apply
    ...
    statics: {
      ...
      getLoader(name, create) {
        let loader = qx.bom.webfonts.WebFontLoader.__P_141_11[name];
        if (!loader && create) {
          loader = qx.bom.webfonts.WebFontLoader.__P_141_11[name] = new qx.bom.webfonts.WebFontLoader(name);
        }
        return loader;
      },
      /**
       ...
       */
      __P_141_3(url) {
        if (qx.bom.webfonts.WebFontLoader.__P_141_10[url]) {
          return;
        }
        qx.bom.Stylesheet.includeFile(url);
        qx.bom.webfonts.WebFontLoader.__P_141_10[url] = true;
      },
      /**
       ...
       */
      getPreferredFormats() {
        if (qx.bom.webfonts.WebFontLoader.__P_141_9) {
          return qx.bom.webfonts.WebFontLoader.__P_141_9;
        }
        ...
        return qx.bom.webfonts.WebFontLoader.__P_141_9 = preferredFormats;
      },
      /**
