        ...
        if (document.fonts && typeof document.fonts.load == "function") {
          ...
          const timerCheck = () => {
            if (this._isFontValid()) {
              ...
              if (now - this.__P_155_5 >= this.getTimeout()) {
                setValidImpl(false);
              }
            }
          };
          ...
          qx.event.Timer.once(() => {
            this.__P_155_4 = new qx.event.Timer(100);
            this.__P_155_4.addListener("interval", timerCheck);
            this.__P_155_4.start();
          }, this, 0);
        }
      },
      /**
