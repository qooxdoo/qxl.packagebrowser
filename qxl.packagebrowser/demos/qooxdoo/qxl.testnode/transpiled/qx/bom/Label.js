    ...
    statics: {
      ...
      create(content, html, win) {
        ...
        if (!qx.core.Environment.get("css.textoverflow") && qx.core.Environment.get("html.xul")) {
          ...
          qx.bom.element.Style.setStyles(el, this.__P_143_5(html));
        }
        if (content) {
      ...
      setValue(element, value) {
        value = value || "";
        if (element.useHtml) {
          if (qx.bom.Label.__P_143_6 && typeof qx.bom.Label.__P_143_6 === "function") {
            value = qx.bom.Label.__P_143_6(value);
          }
      ...
      getHtmlSize(content, styles, width) {
        let cacheKey = this.__P_143_7(styles, width);
        let size = this.__P_143_8(cacheKey, content);
        if (size !== undefined) {
          return size;
        }
        var element = this._htmlElement || this.__P_143_4();

        // apply width
        element.style.width = width != undefined ? width + "px" : "auto";
        // insert content
        element.innerHTML = content;
        size = this.__P_143_9(element, styles);
        this.__P_143_10(cacheKey, content, size);
        return size;
      },
      /**
      ...
      getTextSize(text, styles) {
        let cacheKey = this.__P_143_7(styles);
        let size = this.__P_143_8(cacheKey, text);
        if (size !== undefined) {
          return size;
        }
        var element = this._textElement || this.__P_143_2();
        if (!qx.core.Environment.get("css.textoverflow") && qx.core.Environment.get("html.xul")) {
        ...
        size = this.__P_143_9(element, styles);
        this.__P_143_10(cacheKey, text, size);
        return size;
      },
      /**
       ...
       * @returns {*} size object
       */
      __P_143_8(cacheKey, text) {
        let cache = qx.bom.Label.__P_143_1[cacheKey];
       ...
       * @param {*} size
       */
      __P_143_10(cacheKey, text, size) {
        if (!size) {
          return;
        }
        let cache = qx.bom.Label.__P_143_1[cacheKey];
        if (cache === undefined) {
          cache = qx.bom.Label.__P_143_1[cacheKey] = {
            sizes: {}
          };
        }
       ...
       * @return {Map} A map with preferred <code>width</code> and <code>height</code>.
       */
      __P_143_9(element, styles) {
        // sync styles
        var keys = this.__P_143_0;
        if (!styles) {
          styles = {};
        }
        for (var key in keys) {
