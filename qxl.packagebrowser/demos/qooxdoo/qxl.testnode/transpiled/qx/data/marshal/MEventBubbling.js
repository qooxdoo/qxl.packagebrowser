    ...
    members: {
      ...
      _registerEventChaining: function (value, old, name) {
        ...
        if (value instanceof qx.core.Object && qx.Class.hasMixin(value.constructor, qx.data.marshal.MEventBubbling)) {
          // create the listener
          var listener = qx.lang.Function.bind(this.__P_44_0, this, name); // add the listener
...
//# sourceMappingURL=MEventBubbling.js.map?dt=1626058133199