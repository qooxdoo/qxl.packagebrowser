  ...
  qx.Class.define("qx.event.Manager", {
    ...
    */
    ...
    construct(win, registration) {
      ...
      this.__P_39_0 = win;
      this.__P_39_1 = qx.core.ObjectRegistry.toHashCode(win);
      this.__P_39_2 = registration;
      ...
      this.__P_39_5 = {};
      this.__P_39_6 = {};
      this.__P_39_7 = new qx.util.DeferredCall(function () {
        this.__P_39_8 = null;
      }, this);
      this.__P_39_7.$$blackListCleaner = true;
    },
    /*
    *****************************************************************************
       STATICS
    ...
    */
    ...
    statics: {
      ...
      removeGlobalEventMonitor(fn) {
        qx.core.Assert.assertFunction(fn);
        qx.lang.Array.remove(this.__P_39_10, fn);
      },
      /**
       * Remove all registered event monitors
       */
      resetGlobalEventMonitors() {
        qx.event.Manager.__P_39_10 = [];
      },
      /**
    ...
    */
    ...
    members: {
      ...
      */
       ...
       */
      getHandler(clazz) {
        var handler = this.__P_39_4[clazz.classname];
        if (handler) {
          return handler;
        }
        return this.__P_39_4[clazz.classname] = new clazz(this);
      },
      /**
       ...
       */
      getDispatcher(clazz) {
        var dispatcher = this.__P_39_5[clazz.classname];
        if (dispatcher) {
          return dispatcher;
        }
        return this.__P_39_5[clazz.classname] = new clazz(this, this.__P_39_2);
      },
      /*
      ---------------------------------------------------------------------------
      ...
      */
      ...
      getListeners(target, type, capture) {
        ...
        var targetMap = this.__P_39_3[targetKey];
        if (!targetMap) {
          return null;
        }
      ...
      toggleAttachedEvents(target, enable) {
        ...
        if (targetMap) {
          ...
          for (var entryKey in targetMap) {
            ...
            entryList = targetMap[entryKey];
            if (enable) {
              this.__P_39_12(target, type, capture);
            } else {
              this.__P_39_13(target, type, capture);
            }
          }
        }
      },
      ...
      importListeners(target, list) {
        ...
        for (var listKey in list) {
          ...
          if (!entryList) {
            ...
            this.__P_39_12(target, item.type, item.capture);
          }
          ...
          entryList.push({
            ...
            context: item.self,
            unique: item.unique || clazz.__P_39_9++ + ""
          });
        }
      },
      /**
      ...
      addListener(target, type, listener, self, capture) {
        ...
        var targetMap = this.__P_39_3[targetKey];
        if (!targetMap) {
          targetMap = this.__P_39_3[targetKey] = {};
        }
        var entryKey = type + (capture ? "|capture" : "|bubble");
        var entryList = targetMap[entryKey];
        if (!entryList) {
        ...
        // Append listener to list
        var unique = qx.event.Manager.__P_39_9++ + "";
        var entry = {
          handler: listener,
          context: self,
          unique: unique
      ...
      findHandler(target, type) {
        ...
        var cache = this.__P_39_6;
        if (cache[key]) {
          return cache[key];
        }
        var classes = this.__P_39_2.getHandlers();
      ...
      removeAllListeners(target) {
        ...
        delete this.__P_39_3[targetKey];
        return true;
      },
      /**
      ...
      */
      ...
      dispatchEvent(target, event) {
        ...
        var monitors = qx.event.Manager.__P_39_10;
        if (monitors.length) {
        ...
        // Interacion data
        var classes = this.__P_39_2.getDispatchers();
        var instance;
      ...
      dispose() {
        ...
        this.__P_39_2.removeManager(this);
        qx.util.DisposeUtil.disposeMap(this, "__P_39_4");
        qx.util.DisposeUtil.disposeMap(this, "__P_39_5");

        // Dispose data fields
        this.__P_39_3 = this.__P_39_0 = this.__P_39_11 = null;
        this.__P_39_2 = this.__P_39_6 = null;
      },
      /**
       ...
       */
      __P_39_14(uid) {
        if (this.__P_39_8 === null) {
          this.__P_39_8 = {};
          this.__P_39_7.schedule();
        }
        this.__P_39_8[uid] = true;
      },
      /**
       ...
       */
      isBlacklisted(uid) {
        return this.__P_39_8 !== null && this.__P_39_8[uid] === true;
      }
    }
  });
