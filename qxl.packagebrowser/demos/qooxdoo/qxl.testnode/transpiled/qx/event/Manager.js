  ...
  qx.Class.define("qx.event.Manager", {
    ...
    */
    ...
    construct(win, registration) {
      ...
      this.__P_41_0 = win;
      this.__P_41_1 = qx.core.ObjectRegistry.toHashCode(win);
      this.__P_41_2 = registration;
      ...
      this.__P_41_3 = new Map();

      // The handler and dispatcher instances
      this.__P_41_4 = {};
      this.__P_41_5 = {};
      this.__P_41_6 = {};
      this.__P_41_7 = new qx.util.DeferredCall(function () {
        this.__P_41_8 = null;
      }, this);
      this.__P_41_7.$$blackListCleaner = true;
    },
    /*
    *****************************************************************************
       STATICS
    ...
    */
    ...
    statics: {
      ...
      removeGlobalEventMonitor(fn) {
        qx.core.Assert.assertFunction(fn);
        qx.lang.Array.remove(this.__P_41_10, fn);
      },
      /**
       * Remove all registered event monitors
       */
      resetGlobalEventMonitors() {
        qx.event.Manager.__P_41_10 = [];
      },
      /**
    ...
    */
    ...
    members: {
      ...
      */
       ...
       */
      getHandler(clazz) {
        var handler = this.__P_41_4[clazz.classname];
        if (handler) {
          return handler;
        }
        return this.__P_41_4[clazz.classname] = new clazz(this);
      },
      /**
       ...
       */
      getDispatcher(clazz) {
        var dispatcher = this.__P_41_5[clazz.classname];
        if (dispatcher) {
          return dispatcher;
        }
        return this.__P_41_5[clazz.classname] = new clazz(this, this.__P_41_2);
      },
      /*
      ---------------------------------------------------------------------------
      ...
      */
      ...
      getListeners(target, type, capture) {
        ...
        var targetMap = this.__P_41_3.get(targetKey);
        if (!targetMap) {
          return null;
        }
       ...
       */
      getAllListeners() {
        return Object.fromEntries(this.__P_41_3.entries().map(([targetKey, targetMap]) => [targetKey, Object.fromEntries(targetMap.entries().map(([entryKey, entryMap]) => {
          var listeners = [...entryMap.values()];
      ...
      toggleAttachedEvents(target, enable) {
        ...
        if (targetMap) {
          ...
          for (const entryKey of targetMap.keys()) {
            ...
            if (enable) {
              this.__P_41_12(target, type, capture);
            } else {
              this.__P_41_13(target, type, capture);
            }
          }
        }
      },
      ...
      importListeners(target, list) {
        ...
        if (!targetMap) {
          targetMap = new Map();
          this.__P_41_3.set(targetKey, targetMap);
        }
        for (var listKey in list) {
          ...
          if (entryMap.size === 0) {
            ...
            this.__P_41_12(target, item.type, item.capture);
          }
      ...
      findHandler(target, type) {
        ...
        var cache = this.__P_41_6;
        if (cache[key]) {
          return cache[key];
        }
        var classes = this.__P_41_2.getHandlers();
      ...
      removeAllListeners(target) {
        ...
        this.__P_41_3.delete(targetKey);
        return true;
      },
      /**
      ...
      */
      ...
      dispatchEvent(target, event) {
        ...
        var monitors = qx.event.Manager.__P_41_10;
        if (monitors.length) {
        ...
        // Interacion data
        var classes = this.__P_41_2.getDispatchers();
        var instance;
      ...
      dispose() {
        ...
        this.__P_41_2.removeManager(this);
        qx.util.DisposeUtil.disposeMap(this, "__P_41_4");
        qx.util.DisposeUtil.disposeMap(this, "__P_41_5");

        // Dispose data fields
        this.__P_41_3 = this.__P_41_0 = this.__P_41_11 = null;
        this.__P_41_2 = this.__P_41_6 = null;
      },
      /**
       ...
       */
      __P_41_14(uid) {
        if (this.__P_41_8 === null) {
          this.__P_41_8 = {};
          this.__P_41_7.schedule();
        }
        this.__P_41_8[uid] = true;
      },
      /**
       ...
       */
      isBlacklisted(uid) {
        return this.__P_41_8 !== null && this.__P_41_8[uid] === true;
      }
    }
  });
