  ...
  qx.Class.define("qx.event.Manager", {
    ...
    */
    ...
    construct: function (win, registration) {
      ...
      this.__P_38_0 = win;
      this.__P_38_1 = qx.core.ObjectRegistry.toHashCode(win);
      this.__P_38_2 = registration; // Register to the page unload event.
      ...
      this.__P_38_3 = {}; // The handler and dispatcher instances

      this.__P_38_4 = {};
      this.__P_38_5 = {};
      this.__P_38_6 = {};
      this.__P_38_7 = new qx.util.DeferredCall(function () {
        this.__P_38_8 = null;
      }, this);
      this.__P_38_7.$$blackListCleaner = true;
    },
    ...
    */
    statics: {
      ...
      removeGlobalEventMonitor: function (fn) {
        qx.core.Assert.assertFunction(fn);
        qx.lang.Array.remove(this.__P_38_10, fn);
      },
    ...
    members: {
      ...
      */
      ...
      getHandler: function (clazz) {
        var handler = this.__P_38_4[clazz.classname];

        if (handler) {
          return handler;
        }

        return this.__P_38_4[clazz.classname] = new clazz(this);
      },
      ...
      getDispatcher: function (clazz) {
        var dispatcher = this.__P_38_5[clazz.classname];

        if (dispatcher) {
          return dispatcher;
        }

        return this.__P_38_5[clazz.classname] = new clazz(this, this.__P_38_2);
      },
      ...
      */
      ...
      getListeners: function (target, type, capture) {
        ...
        var targetMap = this.__P_38_3[targetKey];
      ...
      toggleAttachedEvents: function (target, enable) {
        ...
        if (targetMap) {
          ...
          for (var entryKey in targetMap) {
            ...
            if (enable) {
              this.__P_38_12(target, type, capture);
            } else {
              this.__P_38_13(target, type, capture);
            }
          }
        }
      },
      ...
      importListeners: function (target, list) {
        ...
        for (var listKey in list) {
          ...
          if (!entryList) {
            ...
            this.__P_38_12(target, item.type, item.capture);
          ...
          entryList.push({
            ...
            context: item.self,
            unique: item.unique || clazz.__P_38_9++ + ""
          });
        }
      },
      ...
      addListener: function (target, type, listener, self, capture) {
        ...
        if (!targetMap) {
          targetMap = this.__P_38_3[targetKey] = {};
        }
        ...
        var unique = qx.event.Manager.__P_38_9++ + "";
        var entry = {
          handler: listener,
          context: self,
          unique: unique
      ...
      findHandler: function (target, type) {
        ...
        var cache = this.__P_38_6;

        if (cache[key]) {
          return cache[key];
        }

        var classes = this.__P_38_2.getHandlers();
       ...
       */
      __P_38_12: function (target, type, capture) {
      ...
      removeAllListeners: function (target) {
        ...
        delete this.__P_38_3[targetKey];
        return true;
      },
       ...
       * @throws {Error} if there is no handler for the event
       */
      __P_38_13: function (target, type, capture) {
        var handler = this.findHandler(target, type);
      ...
      */
      ...
      dispatchEvent: function (target, event) {
        ...
        var monitors = qx.event.Manager.__P_38_10;
        ...
        var classes = this.__P_38_2.getDispatchers();
      ...
      dispose: function () {
        ...
        this.__P_38_2.removeManager(this);

        qx.util.DisposeUtil.disposeMap(this, "__P_38_4");
        qx.util.DisposeUtil.disposeMap(this, "__P_38_5"); // Dispose data fields

        this.__P_38_3 = this.__P_38_0 = this.__P_38_11 = null;
        this.__P_38_2 = this.__P_38_6 = null;
      },
       ...
       */
      __P_38_14: function (uid) {
        if (this.__P_38_8 === null) {
          this.__P_38_8 = {};

          this.__P_38_7.schedule();
        }

        this.__P_38_8[uid] = true;
      },
      ...
      isBlacklisted: function (uid) {
        return this.__P_38_8 !== null && this.__P_38_8[uid] === true;
      }
    }
  });
...
//# sourceMappingURL=Manager.js.map?dt=1626058132426