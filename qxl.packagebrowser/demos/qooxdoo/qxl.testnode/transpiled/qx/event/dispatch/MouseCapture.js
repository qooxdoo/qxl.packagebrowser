  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.event.dispatch.MouseCapture", {
    ...
    construct: function (manager, registration) {
      ...
      this.__P_57_0 = manager.getWindow();
      this.__P_57_1 = registration;
      manager.addListener(this.__P_57_0, "blur", this.releaseCapture, this);
      manager.addListener(this.__P_57_0, "focus", this.releaseCapture, this);
      manager.addListener(this.__P_57_0, "scroll", this.releaseCapture, this);
    },
    statics: {
    ...
    members: {
      ...
      */
      ...
      canDispatchEvent: function (target, event, type) {
        return !!(this.__P_57_2 && this.__P_57_4[type]);
      },
      // overridden
      dispatchEvent: function (target, event, type) {
        ...
        if (this.__P_57_3 || !qx.dom.Hierarchy.contains(this.__P_57_2, target)) {
          target = this.__P_57_2;
        }
      ...
      */
      ...
      activateCapture: function (element, containerCapture) {
        ...
        if (this.__P_57_2 === element && this.__P_57_3 == containerCapture) {
          return;
        }
        ...
        this.__P_57_3 = containerCapture;
        this.__P_57_2 = element;

        this.__P_57_1.fireEvent(element, "capture", qx.event.type.Event, [true, false]);
      },
      ...
      releaseCapture: function () {
        ...
        this.__P_57_1.fireEvent(element, "losecapture", qx.event.type.Event, [true, false]); // turn off native mouse capturing if the browser supports it
...
//# sourceMappingURL=MouseCapture.js.map?dt=1626058134181