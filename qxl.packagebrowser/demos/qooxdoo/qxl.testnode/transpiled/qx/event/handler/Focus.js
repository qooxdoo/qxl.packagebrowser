  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.event.handler.Focus", {
    ...
    */
    ...
    members: {
      ...
      */
       ...
       */
      tryActivate(element) {
        var active = this.__P_97_14(element);
        if (active) {
      ...
      */
       ...
       */
      __P_97_15(target, related, type, bubbles) {
      ...
      */
      ...
      __P_97_16() {
        ...
        if (this._windowFocused) {
          ...
          this.__P_97_15(this._window, null, "blur", false);
        }
      },
      /**
      ...
      __P_97_17() {
        ...
        if (!this._windowFocused) {
          ...
          this.__P_97_15(this._window, null, "focus", false);
        }
      },
      /*
      ---------------------------------------------------------------------------
      ...
      */
      ...
      _initObserver: qx.core.Environment.select("engine.name", {
        gecko() {
          // Bind methods
          this.__P_97_1 = qx.lang.Function.listener(this.__P_97_18, this);
          this.__P_97_2 = qx.lang.Function.listener(this.__P_97_19, this);
          this.__P_97_3 = qx.lang.Function.listener(this.__P_97_20, this);
          this.__P_97_4 = qx.lang.Function.listener(this.__P_97_21, this);
          this.__P_97_5 = qx.lang.Function.listener(this.__P_97_22, this);

          // Register events
          qx.bom.Event.addNativeListener(this._document, "mousedown", this.__P_97_1, true);
          qx.bom.Event.addNativeListener(this._document, "mouseup", this.__P_97_2, true);

          // Capturing is needed for gecko to correctly
          // handle focus of input and textarea fields
          qx.bom.Event.addNativeListener(this._window, "focus", this.__P_97_3, true);
          qx.bom.Event.addNativeListener(this._window, "blur", this.__P_97_4, true);

          // Capture drag events
          qx.bom.Event.addNativeListener(this._window, "draggesture", this.__P_97_5, true);
        },
        mshtml() {
          // Bind methods
          this.__P_97_1 = qx.lang.Function.listener(this.__P_97_18, this);
          this.__P_97_2 = qx.lang.Function.listener(this.__P_97_19, this);
          this.__P_97_7 = qx.lang.Function.listener(this.__P_97_23, this);
          this.__P_97_8 = qx.lang.Function.listener(this.__P_97_24, this);
          this.__P_97_6 = qx.lang.Function.listener(this.__P_97_25, this);

          // Register events
          qx.bom.Event.addNativeListener(this._document, "mousedown", this.__P_97_1);
          qx.bom.Event.addNativeListener(this._document, "mouseup", this.__P_97_2);
          ...
          qx.bom.Event.addNativeListener(this._document, "focusin", this.__P_97_7);
          qx.bom.Event.addNativeListener(this._document, "focusout", this.__P_97_8);

          // Add selectstart to prevent selection
          qx.bom.Event.addNativeListener(this._document, "selectstart", this.__P_97_6);
        },
        webkit: qx.core.Environment.select("browser.name", {
          ...
          edge(domEvent) {
            ...
            qx.bom.Event.addNativeListener(this._document, "mousedown", this.__P_97_1, true);
            qx.bom.Event.addNativeListener(this._document, "mouseup", this.__P_97_2, true);
            qx.bom.Event.addNativeListener(this._document, "selectstart", this.__P_97_6, false);
            qx.bom.Event.addNativeListener(this._document, "focusin", this.__P_97_7);
            qx.bom.Event.addNativeListener(this._document, "focusout", this.__P_97_8);
          },
          default(domEvent) {
            ...
            qx.bom.Event.addNativeListener(this._document, "mouseup", this.__P_97_2, true);
            qx.bom.Event.addNativeListener(this._document, "selectstart", this.__P_97_6, false);
            qx.bom.Event.addNativeListener(this._window, "DOMFocusOut", this.__P_97_8, true);
            qx.bom.Event.addNativeListener(this._window, "focus", this.__P_97_3, true);
            qx.bom.Event.addNativeListener(this._window, "blur", this.__P_97_4, true);
          }
        }),
        opera() {
          ...
          qx.bom.Event.addNativeListener(this._document, "mousedown", this.__P_97_1, true);
          qx.bom.Event.addNativeListener(this._document, "mouseup", this.__P_97_2, true);
          qx.bom.Event.addNativeListener(this._window, "DOMFocusIn", this.__P_97_7, true);
          qx.bom.Event.addNativeListener(this._window, "DOMFocusOut", this.__P_97_8, true);
        }
      }),
      /**
      ...
      _stopObserver: qx.core.Environment.select("engine.name", {
        gecko() {
          qx.bom.Event.removeNativeListener(this._document, "mousedown", this.__P_97_1, true);
          qx.bom.Event.removeNativeListener(this._document, "mouseup", this.__P_97_2, true);
          qx.bom.Event.removeNativeListener(this._window, "focus", this.__P_97_3, true);
          qx.bom.Event.removeNativeListener(this._window, "blur", this.__P_97_4, true);
          qx.bom.Event.removeNativeListener(this._window, "draggesture", this.__P_97_5, true);
        },
        mshtml() {
          qx.bom.Event.removeNativeListener(this._document, "mousedown", this.__P_97_1);
          qx.bom.Event.removeNativeListener(this._document, "mouseup", this.__P_97_2);
          qx.bom.Event.removeNativeListener(this._document, "focusin", this.__P_97_7);
          qx.bom.Event.removeNativeListener(this._document, "focusout", this.__P_97_8);
          qx.bom.Event.removeNativeListener(this._document, "selectstart", this.__P_97_6);
        },
        webkit: qx.core.Environment.select("browser.name", {
          // fix for [ISSUE #9174]
          // distinguish bettween MS Edge, which is reported
          ...
          default() {
            qx.bom.Event.removeNativeListener(this._document, "mousedown", this.__P_97_1, true);
            qx.bom.Event.removeNativeListener(this._document, "mouseup", this.__P_97_2, true);
            qx.bom.Event.removeNativeListener(this._document, "selectstart", this.__P_97_6, false);
            qx.bom.Event.removeNativeListener(this._window, "DOMFocusOut", this.__P_97_8, true);
            qx.bom.Event.removeNativeListener(this._window, "focus", this.__P_97_3, true);
            qx.bom.Event.removeNativeListener(this._window, "blur", this.__P_97_4, true);
          }
        }),
        opera() {
          qx.bom.Event.removeNativeListener(this._document, "mousedown", this.__P_97_1, true);
          qx.bom.Event.removeNativeListener(this._document, "mouseup", this.__P_97_2, true);
          qx.bom.Event.removeNativeListener(this._window, "DOMFocusIn", this.__P_97_7, true);
          qx.bom.Event.removeNativeListener(this._window, "DOMFocusOut", this.__P_97_8, true);
        }
      }),
      /*
      ...
      */
       ...
       */
      __P_97_22: qx.event.GlobalError.observeMethod(qx.core.Environment.select("engine.name", {
        gecko(domEvent) {
          var target = qx.bom.Event.getTarget(domEvent);
          if (!this.__P_97_26(target)) {
       ...
       * @param domEvent {Event} Native event
       */
      __P_97_23: qx.event.GlobalError.observeMethod(qx.core.Environment.select("engine.name", {
        mshtml(domEvent) {
          ...
          var focusTarget = this.__P_97_27(target);
          if (focusTarget) {
        ...
        opera(domEvent) {
          ...
          if (target == this._document || target == this._window) {
            this.__P_97_17();
            if (this.__P_97_9) {
              this.setFocus(this.__P_97_9);
              delete this.__P_97_9;
            }
            if (this.__P_97_10) {
              this.setActive(this.__P_97_10);
              delete this.__P_97_10;
            }
          } else {
       ...
       * @param domEvent {Event} Native event
       */
      __P_97_24: qx.event.GlobalError.observeMethod(qx.core.Environment.select("engine.name", {
        mshtml(domEvent) {
        ...
        opera(domEvent) {
          ...
          if (target == this._document) {
            ...
            this.__P_97_9 = this.getFocus();
            this.__P_97_10 = this.getActive();
            this.resetFocus();
            this.resetActive();
          } else {
            if (target === this.getFocus()) {
       ...
       * @param domEvent {Event} Native event
       */
      __P_97_21: qx.event.GlobalError.observeMethod(qx.core.Environment.select("engine.name", {
        gecko(domEvent) {
          var target = qx.bom.Event.getTarget(domEvent);
       ...
       * @param domEvent {Event} Native event
       */
      __P_97_20: qx.event.GlobalError.observeMethod(qx.core.Environment.select("engine.name", {
        gecko(domEvent) {
          var target = qx.bom.Event.getTarget(domEvent);
          if (target === this._window || target === this._document) {
            this.__P_97_17();
        ...
        webkit(domEvent) {
          ...
          if (target === this._window || target === this._document) {
            ...
            this.__P_97_13 = domEvent.relatedTarget;
            this.setFocus(target);
            this.__P_97_13 = null;
            this.tryActivate(target);
          }
       ...
       * @param domEvent {Event} Native event
       */
      __P_97_18: qx.event.GlobalError.observeMethod(qx.core.Environment.select("engine.name", {
        mshtml(domEvent) {
          var target = qx.bom.Event.getTarget(domEvent);
       ...
       * @param domEvent {Event} Native event
       */
      __P_97_19: qx.event.GlobalError.observeMethod(qx.core.Environment.select("engine.name", {
        mshtml(domEvent) {
          var target = qx.bom.Event.getTarget(domEvent);
          if (target.unselectable) {
            target.unselectable = "off";
          }
          this.tryActivate(this.__P_97_28(target));
        },
        gecko(domEvent) {
          // As of Firefox 3.0:
       ...
       */
      __P_97_28: qx.event.GlobalError.observeMethod(qx.core.Environment.select("engine.name", {
        mshtml(target) {
          return this.__P_97_29(target);
        },
        webkit(target) {
          return this.__P_97_29(target);
        },
       ...
       * @param domEvent {Event} Native event
       */
      __P_97_25: qx.event.GlobalError.observeMethod(qx.core.Environment.select("engine.name", {
        mshtml(domEvent) {
          var target = qx.bom.Event.getTarget(domEvent);
          if (!this.__P_97_26(target)) {
            qx.bom.Event.preventDefault(domEvent);
      ...
      */
      ...
      _applyActive(value, old) {
        // Fire events
        if (old) {
          this.__P_97_15(old, value, "deactivate", true);
        }
        if (value) {
          this.__P_97_15(value, old, "activate", true);
        }
      ...
      _applyFocus(value, old) {
        ...
        if (old) {
          this.__P_97_15(old, value, "focusout", true);
        }
        if (value) {
          this.__P_97_15(value, old, "focusin", true);
        }

        // Fire after events
        if (old) {
          this.__P_97_15(old, value, "blur", false);
        }
        if (value) {
          this.__P_97_15(value, old || this.__P_97_13, "focus", false);
        }
      }
    },
    /*
    ...
    */
    ...
    destruct() {
      this._stopObserver();
      this._manager = this._window = this._document = this._root = this._body = this.__P_97_31 = this.__P_97_13 = null;
    },
    /*
    *****************************************************************************
       DEFER
