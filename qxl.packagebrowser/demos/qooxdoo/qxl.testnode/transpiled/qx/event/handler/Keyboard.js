  ...
  qx.Class.define("qx.event.handler.Keyboard", {
    ...
    */
    ...
    construct: function (manager) {
      ...
      this.__P_68_1 = manager.getWindow(); // Gecko ignores key events when not explicitly clicked in the document.

      if (qx.core.Environment.get("engine.name") == "gecko") {
        this.__P_68_2 = this.__P_68_1;
      } else {
        this.__P_68_2 = this.__P_68_1.document.documentElement;
      } // Internal sequence cache


      this.__P_68_3 = {}; // Initialize observer
    ...
    members: {
      ...
      */
      ...
      _fireInputEvent: function (domEvent, charCode) {
        ...
        if (target && target.offsetWidth != 0) {
          ...
          qx.event.Utils.then(tracker, function () {
            self.__P_68_0.dispatchEvent(target, event);
          });
        ...
        if (this.__P_68_1) {
          var self = this;
          qx.event.Utils.then(tracker, function () {
            return qx.event.Registration.fireEvent(self.__P_68_1, "useraction", qx.event.type.Data, ["keyinput"]);
          });
        }
      ...
      _fireSequenceEvent: function (domEvent, type, keyIdentifier) {
        ...
        qx.event.Utils.then(tracker, function () {
          return self.__P_68_0.dispatchEvent(target, event);
        ...
        if (this.__P_68_1) {
          qx.event.Utils.then(tracker, function () {
            return qx.event.Registration.fireEvent(self.__P_68_1, "useraction", qx.event.type.Data, [type]);
          });
        }
       ...
       */
      __P_68_8: function () {
        var focusHandler = this.__P_68_0.getHandler(qx.event.handler.Focus);
        ...
        if (!target || target.offsetWidth == 0) {
          target = this.__P_68_0.getWindow().document.body;
        }
      ...
      */
      ...
      _initKeyObserver: function () {
        this.__P_68_4 = qx.lang.Function.listener(this.__P_68_9, this);
        this.__P_68_7 = qx.lang.Function.listener(this.__P_68_10, this);
        var Event = qx.bom.Event;
        Event.addNativeListener(this.__P_68_2, "keyup", this.__P_68_4);
        Event.addNativeListener(this.__P_68_2, "keydown", this.__P_68_4);
        Event.addNativeListener(this.__P_68_2, "keypress", this.__P_68_7);
      },
      ...
      _stopKeyObserver: function () {
        var Event = qx.bom.Event;
        Event.removeNativeListener(this.__P_68_2, "keyup", this.__P_68_4);
        Event.removeNativeListener(this.__P_68_2, "keydown", this.__P_68_4);
        Event.removeNativeListener(this.__P_68_2, "keypress", this.__P_68_7);

        for (var key in this.__P_68_6 || {}) {
          var listener = this.__P_68_6[key];
          Event.removeNativeListener(listener.target, "keypress", listener.callback);
        }

        delete this.__P_68_6;
      },
      ...
      */
       ...
       */
      __P_68_9: qx.event.GlobalError.observeMethod(qx.core.Environment.select("engine.name", {
        "gecko|webkit|mshtml": function (domEvent) {
          ...
          this.__P_68_3[keyCode] = type;
          return tracker.promise;
        },
        "opera": function (domEvent) {
          this.__P_68_5 = domEvent.keyCode;
       ...
       */
      __P_68_11: qx.core.Environment.select("engine.name", {
          ...
          if (type === "keydown" && (keyCode == 33 || keyCode == 34 || keyCode == 38 || keyCode == 40) && target.type == "text" && target.tagName.toLowerCase() === "input" && target.getAttribute("autoComplete") !== "off") {
            ...
            this.__P_68_6[hash] = {
              ...
              callback: function (domEvent) {
                ...
                self.__P_68_10(domEvent);
              }
            };
            var listener = qx.event.GlobalError.observeMethod(this.__P_68_6[hash].callback);
       ...
       * @param domEvent {Event} DOM event object
       */
      __P_68_10: qx.event.GlobalError.observeMethod(qx.core.Environment.select("engine.name", {
        ...
        "opera": function (domEvent) {
          ...
          if (keyCode != this.__P_68_5) {
            return this._idealKeyHandler(0, this.__P_68_5, type, domEvent);
          } else {
    ...
    */
    destruct: function () {
      ...
      this.__P_68_5 = this.__P_68_0 = this.__P_68_1 = this.__P_68_2 = this.__P_68_3 = null;
    },
...
//# sourceMappingURL=Keyboard.js.map?dt=1626058134912