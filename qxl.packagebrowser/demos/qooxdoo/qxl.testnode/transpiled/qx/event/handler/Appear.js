  ...
  qx.Class.define("qx.event.handler.Appear", {
    ...
    */
    ...
    construct: function (manager) {
      ...
      this.__P_79_1 = {}; // Register

      qx.event.handler.Appear.__P_79_2[this.toHashCode()] = this;
    },
        ...
        Object.keys(targets).forEach(function (hash) {
          ...
          qx.event.Utils.then(tracker, function () {
            ...
            if (!!elem.$$displayed !== displayed) {
              ...
              return self.__P_79_0.dispatchEvent(elem, evt);
            }
          });
        });
    ...
    */
    destruct: function () {
      this.__P_79_0 = this.__P_79_1 = null; // Deregister

      delete qx.event.handler.Appear.__P_79_2[this.toHashCode()];
    },
...
//# sourceMappingURL=Appear.js.map?dt=1626058135676