  ...
  qx.Class.define("qx.event.type.Touch", {
    ...
    */
    ...
    members: {
       ...
       */
      isMultiTouch() {
        return this.__P_162_0().length > 1;
      },
      /**
      ...
      getDocumentLeft(touchIndex) {
        return this.__P_162_1(touchIndex).pageX;
      },
      /**
      ...
      getDocumentTop(touchIndex) {
        return this.__P_162_1(touchIndex).pageY;
      },
      /**
      ...
      getScreenLeft(touchIndex) {
        return this.__P_162_1(touchIndex).screenX;
      },
      /**
      ...
      getScreenTop(touchIndex) {
        return this.__P_162_1(touchIndex).screenY;
      },
      /**
      ...
      getViewportLeft(touchIndex) {
        return this.__P_162_1(touchIndex).clientX;
      },
      /**
      ...
      getViewportTop(touchIndex) {
        return this.__P_162_1(touchIndex).clientY;
      },
      /**
      ...
      getIdentifier(touchIndex) {
        return this.__P_162_1(touchIndex).identifier;
      },
      /**
       ...
       */
      __P_162_1(touchIndex) {
        touchIndex = touchIndex == null ? 0 : touchIndex;
        return this.__P_162_0()[touchIndex];
      },
      /**
