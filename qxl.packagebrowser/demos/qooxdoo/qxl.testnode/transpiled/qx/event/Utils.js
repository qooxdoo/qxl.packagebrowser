  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.event.Utils", {
    ...
    statics: {
       ...
       */
      __P_39_0: function (tracker, newPromise) {
      ...
      then: function (tracker, fn) {
        ...
        if (tracker.promise) {
          if (qx.lang.Type.isPromise(fn)) {
            this.__P_39_0(tracker, tracker.promise.then(fn));
          } else {
            var self = this;

            this.__P_39_0(tracker, tracker.promise.then(function (result) {
              if (tracker.rejected) {
                return null;
              }
          ...
          this.__P_39_1(tracker);

          return tracker.promise;
        }

        if (qx.lang.Type.isPromise(fn)) {
          return this.__P_39_2(tracker, fn);
        }

        var result = fn(tracker.result);

        if (qx.lang.Type.isPromise(result)) {
          return this.__P_39_2(tracker, result);
        }
       ...
       * @return {qx.Promise} the new promise
       */
      __P_39_2: function (tracker, newPromise) {
        if (tracker.promise) {
          this.__P_39_0(tracker, tracker.promise.then(function () {
            return newPromise;
          }));
        } else {
          this.__P_39_0(tracker, newPromise);
        }
      ...
      reject: function (tracker) {
        ...
        var result = this.__P_39_3(tracker);
       ...
       * @param tracker {Object} the tracker object
       */
      __P_39_1: function (tracker) {
        if (tracker.promise && tracker.catch) {
          if (!tracker.promise["qx.event.Utils.hasCatcher"]) {
            this.__P_39_0(tracker, tracker.promise.catch(this.__P_39_3.bind(this, tracker)));
...
//# sourceMappingURL=Utils.js.map?dt=1626058132620