  ...
  qx.Class.define("qx.event.Timer", {
    ...
    members: {
      ...
      */
      ...
      _applyEnabled(value, old) {
        if (old) {
          window.clearInterval(this.__P_27_2);
          this.__P_27_2 = null;
        } else if (value) {
          this.__P_27_2 = window.setInterval(this.__P_27_0, this.getInterval());
        }
      },
      /*
      ---------------------------------------------------------------------------
    ...
    */
    ...
    destruct() {
      ...
      this.__P_27_2 = this.__P_27_0 = null;
    }
  });
