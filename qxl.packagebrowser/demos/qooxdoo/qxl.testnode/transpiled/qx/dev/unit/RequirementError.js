  ...
  qx.Class.define("qx.dev.unit.RequirementError", {
    ...
    */
    ...
    construct: function (requirement, message) {
      this.__P_29_0 = message || "Requirement not met";
      this.__P_29_1 = requirement;
      var inst = Error.call(this, this.__P_29_0); // map stack trace properties since they're not added by Error's constructor
...
//# sourceMappingURL=RequirementError.js.map?dt=1626058131453