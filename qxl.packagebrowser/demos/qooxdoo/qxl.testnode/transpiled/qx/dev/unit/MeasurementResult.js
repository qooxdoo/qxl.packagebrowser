  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.dev.unit.MeasurementResult", {
    ...
    construct(message, iterations, ownTime, renderTime) {
      this.__P_28_0 = message;
      this.__P_28_1 = iterations;
      this.__P_28_2 = ownTime;
      this.__P_28_3 = renderTime;
    },
    members: {
      __P_28_0: null,
      __P_28_1: null,
      ...
      getData() {
        return {
          message: this.__P_28_0,
          iterations: this.__P_28_1,
          ownTime: this.__P_28_2,
          renderTime: this.__P_28_3
        };
      },
      /**
       ...
       */
      toString() {
        return ["Measured: " + this.__P_28_0, "Iterations: " + this.__P_28_1, "Time: " + this.__P_28_2 + "ms", "Render time: " + this.__P_28_3 + "ms"].join("\n");
      }
    }
  });
