    ...
    statics: {
      ...
      */
      ...
      define(name, config) {
        ...
        config.include = this.__P_108_0(config.include);
        config.patch = this.__P_108_0(config.patch);
        ...
        this.__P_108_1(theme, config);
        this.__P_108_2(theme, config);
      ...
      */
       ...
       */
      __P_108_3(config) {
        for (var i = 0, keys = this.__P_108_4, l = keys.length; i < l; i++) {
          if (config[keys[i]]) {
            return keys[i];
          }
        }
       ...
       */
      __P_108_1(theme, config) {
        var type = this.__P_108_3(config);
      ...
      __P_108_4: ["colors", "borders", "decorations", "fonts", "icons", "widgets", "appearances", "meta"],
       ...
       */
      __P_108_7: qx.core.Environment.select("qx.debug", {
        true(name, config) {
          var allowed = this.__P_108_5;
      ...
      patch(theme, mixinTheme) {
        this.__P_108_8(mixinTheme);
        var type = this.__P_108_3(mixinTheme);
        if (type !== this.__P_108_3(theme)) {
