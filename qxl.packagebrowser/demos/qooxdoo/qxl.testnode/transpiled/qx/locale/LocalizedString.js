  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.locale.LocalizedString", {
    ...
    construct: function (translation, messageId, args, localized) {
      ...
      this.__P_46_0 = messageId;
      this.__P_46_1 = !!localized;
      this.__P_46_2 = args;
    },
    members: {
      __P_46_1: null,
      ...
      translate: function () {
        if (this.__P_46_1) {
          return qx.locale.Manager.getInstance().localize(this.__P_46_0, this.__P_46_2);
        }

        return qx.locale.Manager.getInstance().translate(this.__P_46_0, this.__P_46_2);
      },
...
//# sourceMappingURL=LocalizedString.js.map?dt=1626058133294