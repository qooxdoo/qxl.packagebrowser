  ...
  qx.Class.define("qx.locale.Manager", {
    ...
    */
    construct: function () {
      ...
      this.__P_28_0 = qx.$$translations || {};
      this.__P_28_1 = qx.$$locales || {};
      this.initLocale();
      this.__P_28_2 = this.getLocale();
    },
    ...
    */
    members: {
      __P_28_3: qx.core.Environment.get("locale.default"),
      __P_28_4: null,
      __P_28_5: null,
      __P_28_0: null,
      __P_28_1: null,
      ...
      getAvailableLocales: function (includeNonloaded) {
        ...
        for (var locale in this.__P_28_1) {
          if (locale != this.__P_28_3) {
            if (this.__P_28_1[locale] === null && !includeNonloaded) {
      ...
      _applyLocale: function (value, old) {
        this.__P_28_4 = value;
        this.__P_28_5 = this.__P_28_6(value);
      },
      ...
      translate: function (messageId, args, locale) {
        var catalog = this.__P_28_0;
        return this.__P_28_7(catalog, messageId, args, locale);
      },
       ...
       * @return {String | LocalizedString} translated message or localized string
       */
      __P_28_7: function (catalog, messageId, args, locale) {
        var txt;
        ...
        if (locale) {
          var language = this.__P_28_6(locale);
        } else {
          locale = this.__P_28_4;
          language = this.__P_28_5;
        } // e.g. DE_at
        ...
        if (!txt && catalog[this.__P_28_3]) {
          txt = catalog[this.__P_28_3][messageId];
        }
        ...
        {
          txt = new qx.locale.LocalizedString(txt, messageId, args, catalog === this.__P_28_1);
        }
        return txt;
      }
    }
...
//# sourceMappingURL=Manager.js.map?dt=1626058131344