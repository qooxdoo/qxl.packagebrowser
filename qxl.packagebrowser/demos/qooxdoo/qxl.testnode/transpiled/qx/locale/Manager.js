  ...
  qx.Class.define("qx.locale.Manager", {
    ...
    */
    ...
    construct() {
      ...
      this.__P_31_0 = qx.$$translations || {};
      this.__P_31_1 = qx.$$locales || {};
      this.initLocale();
      this.__P_31_2 = this.getLocale();
    ...
    */
    ...
    members: {
      __P_31_3: qx.core.Environment.get("locale.default"),
      __P_31_4: null,
      __P_31_5: null,
      __P_31_0: null,
      __P_31_1: null,
      ...
      getAvailableLocales(includeNonloaded) {
        var locales = [];
        for (var locale in this.__P_31_1) {
          if (locale != this.__P_31_3) {
            if (this.__P_31_1[locale] === null && !includeNonloaded) {
      ...
      _applyLocale(value, old) {
        this.__P_31_4 = value;
        this.__P_31_5 = this.__P_31_6(value);
      },
      /**
      ...
      translate(messageId, args, locale) {
        var catalog = this.__P_31_0;
        return this.__P_31_7(catalog, messageId, args, locale);
      },
      /**
       ...
       * @return {String|LocalizedString} translated message or localized string
       */
      __P_31_7(catalog, messageId, args, locale) {
        var txt;
        if (!catalog) {
          return messageId;
        }
        if (locale) {
          var language = this.__P_31_6(locale);
        } else {
          locale = this.__P_31_4;
          language = this.__P_31_5;
        }
        ...
        // C
        if (!txt && catalog[this.__P_31_3]) {
          txt = catalog[this.__P_31_3][messageId];
        }
        if (!txt) {
          txt = messageId;
        }
        ...
        {
          txt = new qx.locale.LocalizedString(txt, messageId, args, catalog === this.__P_31_1);
        }
        return txt;
      }
    }
