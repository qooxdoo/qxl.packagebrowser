  ...
  ************************************************************************ */
  ...
  qx.Mixin.define("qx.core.MEvent", {
    members: {
      ...
      __P_35_0: qx.event.Registration,
      ...
      addListener: function (type, listener, self, capture) {
        if (!this.$$disposed) {
          return this.__P_35_0.addListener(this, type, listener, self, capture);
        }
      ...
      removeListener: function (type, listener, self, capture) {
        if (!this.$$disposed) {
          ...
          return this.__P_35_0.removeListener(this, type, listener, self, capture);
        }
      ...
      removeListenerById: function (id) {
        if (!this.$$disposed) {
          return this.__P_35_0.removeListenerById(this, id);
        }
      ...
      hasListener: function (type, capture) {
        return this.__P_35_0.hasListener(this, type, capture);
      },
      ...
      dispatchEvent: function (evt) {
        if (!this.$$disposed) {
          return this.__P_35_0.dispatchEvent(this, evt);
        }
      ...
      fireEvent: function (type, clazz, args) {
        if (!this.$$disposed) {
          return this.__P_35_0.fireEvent(this, type, clazz, args);
        }
      ...
      fireEventAsync: function (type, clazz, args) {
        if (!this.$$disposed) {
          return this.__P_35_0.fireEventAsync(this, type, clazz, args);
        }
      ...
      fireNonBubblingEvent: function (type, clazz, args) {
        if (!this.$$disposed) {
          return this.__P_35_0.fireNonBubblingEvent(this, type, clazz, args);
        }
      ...
      fireNonBubblingEventAsync: function (type, clazz, args) {
        if (!this.$$disposed) {
          return this.__P_35_0.fireNonBubblingEventAsync(this, type, clazz, args);
        }
      ...
      fireDataEvent: function (type, data, oldData, cancelable) {
        if (!this.$$disposed) {
          ...
          return this.__P_35_0.fireEvent(this, type, qx.event.type.Data, [data, oldData, !!cancelable]);
        }
      ...
      fireDataEventAsync: function (type, data, oldData, cancelable) {
        if (!this.$$disposed) {
          ...
          return this.__P_35_0.fireEventAsync(this, type, qx.event.type.Data, [data, oldData, !!cancelable]);
        }
...
//# sourceMappingURL=MEvent.js.map?dt=1626058132142