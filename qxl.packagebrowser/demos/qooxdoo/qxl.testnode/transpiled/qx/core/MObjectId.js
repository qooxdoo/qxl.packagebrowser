  ...
  qx.Mixin.define("qx.core.MObjectId", {
    ...
    statics: {
      handleObjects(clazz, instance, id) {
        ...
        const clazzObject = objectsDef === null || objectsDef === void 0 || (_objectsDef$id = objectsDef[id]) === null || _objectsDef$id === void 0 ? void 0 : _objectsDef$id.call(instance);
        if (clazzObject !== undefined) {
          return clazzObject;
        }
        for (const mixin of (_clazz$$$includes = clazz.$$includes) !== null && _clazz$$$includes !== void 0 ? _clazz$$$includes : []) {
          var _clazz$$$includes;
          const mixinObject = qx.core.MObjectId.handleObjects(mixin, instance, id);
    ...
    members: {
      ...
      _applyQxObjectId(value, oldValue) {
        if (!this.__P_37_1) {
          ...
          if (owner) {
            owner.__P_37_2(this, value, oldValue);
          }
       ...
       */
      __P_37_2(obj, newId, oldId) {
        delete this.__P_37_0[oldId];
        this.__P_37_0[newId] = obj;
      },
      /**
      ...
      _cascadeQxObjectIdChanges() {
        ...
        if (this.__P_37_0) {
          for (var name in this.__P_37_0) {
            var obj = this.__P_37_0[name];
       ...
       */
      getOwnedQxObjects() {
        return this.__P_37_0 ? Object.values(this.__P_37_0) : [];
      }
    }
  });
