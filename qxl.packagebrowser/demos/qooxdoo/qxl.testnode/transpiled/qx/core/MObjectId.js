    ...
    members: {
      ...
      _applyQxObjectId: function (value, oldValue) {
        if (!this.__P_36_1) {
          ...
          if (owner) {
            owner.__P_36_2(this, value, oldValue);
          }
       ...
       */
      __P_36_2: function (obj, newId, oldId) {
        delete this.__P_36_0[oldId];
        this.__P_36_0[newId] = obj;
      },
      ...
      _cascadeQxObjectIdChanges: function () {
        ...
        if (this.__P_36_0) {
          for (var name in this.__P_36_0) {
            var obj = this.__P_36_0[name];
      ...
      getOwnedQxObjects: function () {
        return this.__P_36_0 ? Object.values(this.__P_36_0) : [];
      }
    }
  });
...
//# sourceMappingURL=MObjectId.js.map?dt=1626058132218