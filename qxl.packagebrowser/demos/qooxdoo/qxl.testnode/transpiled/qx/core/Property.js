  ...
  ************************************************************************ */
  ...
  qx.Bootstrap.define("qx.core.Property", {
    statics: {
       ...
       */
      __P_15_12(instance, members, name, variant, code, args) {
        var fn = this.__P_15_13(instance.constructor, name, variant, code, args);
       ...
       * @return {var} Return value of the generated function
       */
      __P_15_13(clazz, name, variant, code, args) {
       ...
       * @param name {String} name of the property
       */
      __P_15_17(code, clazz, config, name) {
        code.push("var equ=");
       ...
       */
      __P_15_18(code, config, name, variant, incomingValue) {
        {
       ...
       * @param name {String} name of the property
       */
      __P_15_20(code, clazz, config, name) {
       ...
       * @param variant {String} Method variant.
       */
      __P_15_21(code, incomingValue, store, variant) {
       ...
       * @param incomingValue {Boolean} Whether the setter has an incoming value
       */
      __P_15_22(code, name, variant, incomingValue) {
       ...
       * @param incomingValue {Boolean} Whether the setter has an incoming value
       */
      __P_15_23(code, config, name, variant, incomingValue) {
       ...
       * @param variant {String} Method variant.
       */
      __P_15_24(code, config, name, variant) {
       ...
       * @param variant {String} Method variant.
       */
      __P_15_25(code, config, name, variant) {
       ...
       */
      __P_15_26(code, config, name, variant, refresh) {
