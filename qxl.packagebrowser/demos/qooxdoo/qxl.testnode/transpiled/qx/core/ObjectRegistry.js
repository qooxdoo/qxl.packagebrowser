  ...
  qx.Bootstrap.define("qx.core.ObjectRegistry", {
    ...
    */
    ...
    statics: {
       ...
       */
      createHashCode() {
        var hash = String(this.__P_33_1++ + this.__P_33_2);
        return hash;
      },
      /**
      ...
      fromHashCode(hash, suppressWarnings) {
        var obj = this.__P_33_0[hash] || null;
