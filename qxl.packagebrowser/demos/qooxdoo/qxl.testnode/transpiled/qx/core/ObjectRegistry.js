    ...
    */
    statics: {
      ...
      createHashCode: function () {
        var hash = String(this.__P_32_1++ + this.__P_32_2);
        return hash;
      },
      ...
      fromHashCode: function (hash, suppressWarnings) {
        var obj = this.__P_32_0[hash] || null;
...
//# sourceMappingURL=ObjectRegistry.js.map?dt=1626058131990