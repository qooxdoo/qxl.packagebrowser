  ...
  ************************************************************************ */
  ...
  qx.Mixin.define("qx.core.MLogging", {
    members: {
       ...
       */
      __P_34_1: function (level, varargs) {
        var argumentsArray = qx.lang.Array.fromArguments(varargs);
        argumentsArray.unshift(this);

        this.__P_34_0[level].apply(this.__P_34_0, argumentsArray);
      }
    }
  });
...
//# sourceMappingURL=MLogging.js.map?dt=1626058132078