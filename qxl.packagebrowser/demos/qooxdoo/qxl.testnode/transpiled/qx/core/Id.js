  ...
  qx.Class.define("qx.core.Id", {
    ...
    members: {
      ...
      getAbsoluteIdOf: function (obj, suppressWarnings) {
        if (this.__P_82_1 && this.__P_82_1[obj.toHashCode()]) {
        ...
        while (obj) {
          ...
          if (owner) {
            ...
            if (owner === application) {
              ...
              ownerId = this.__P_82_1 && this.__P_82_1[owner.toHashCode()] || null;
      ...
      register: function (obj, id) {
        ...
        this.__P_82_1[obj.toHashCode()] = id;
...
//# sourceMappingURL=Id.js.map?dt=1626058135980