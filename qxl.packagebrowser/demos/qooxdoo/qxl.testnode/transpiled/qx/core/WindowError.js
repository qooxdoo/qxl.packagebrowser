  ...
  qx.Bootstrap.define("qx.core.WindowError", {
    ...
    */
    ...
    construct(failMessage, uri, lineNumber, columnNumber, sourceException) {
      ...
      this.__P_42_0 = failMessage;
      this.__P_42_1 = uri || "";
      this.__P_42_2 = lineNumber === undefined ? -1 : lineNumber;
      this.__P_42_3 = columnNumber === undefined ? -1 : columnNumber;
      this.__P_42_4 = sourceException;
    },
    /*
    *****************************************************************************
       MEMBERS
