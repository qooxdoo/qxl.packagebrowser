  ...
  qx.Class.define("qx.Promise", {
    ...
    construct(fn, context) {
      ...
      if (fn instanceof qx.Promise.Impl) {
        ...
        this.__P_10_1 = new qx.Promise.Impl(fn);
      } else {
        this.__P_10_1 = new qx.Promise.Impl(this.__P_10_2.bind(this));
      }
    ...
    members: {
       ...
       */
      bind(context) {
        return qx.Promise.__P_10_5(this.__P_10_1.bind(context));
      },
      /**
       ...
       */
      resolve(value) {
        this.__P_10_6().resolve(value);
      },
      /**
       * Rejects an external promise
       */
      reject(reason) {
        this.__P_10_6().reject(reason);
      },
      /* *********************************************************************************
       *
       * Utility methods
      ...
      _callIterableMethod(methodName, args) {
        args = qx.Promise.__P_10_7(args);
        return qx.Promise.__P_10_5(this.__P_10_1.then(function (value) {
          var newP = qx.Promise.Impl.resolve(value instanceof qx.data.Array ? value.toArray() : value);
          return qx.Promise.__P_10_5(newP[methodName].apply(newP, args));
        }));
      },
      /**
      ...
      _callMethod(methodName, args) {
        args = qx.Promise.__P_10_7(args);
        return qx.Promise.__P_10_5(this.__P_10_1[methodName].apply(this.__P_10_1, args));
      },
      /**
    ...
    statics: {
       ...
       */
      __P_10_8: new Error("Default Error"),
      /* *********************************************************************************
       *
       * Promise API methods
       *
      ...
      resolve(value, context) {
        ...
        if (value instanceof qx.Promise) {
          ...
          promise = qx.Promise.__P_10_5(qx.Promise.Impl.resolve(value));
        }
      ...
      reject(reason, context) {
        ...
        if (reason === undefined) {
          args.shift();
          args.unshift(qx.Promise.__P_10_8);
        } else if (!(reason instanceof Error)) {
          qx.log.Logger.warn("Rejecting a promise with a non-Error value");
        }
        var promise = qx.Promise.__P_10_9("reject", args, 0);
        if (context !== undefined) {
          promise = promise.bind(context);
        }
        return promise;
       ...
       */
      all(iterable) {
        return qx.Promise.__P_10_9("all", arguments);
      },
      /**
       ...
       */
      race(iterable) {
        return qx.Promise.__P_10_9("race", arguments);
      },
      /* *********************************************************************************
       *
       ...
       */
      any(iterable) {
        return qx.Promise.__P_10_9("any", arguments);
      },
      /**
       ...
       */
      some(iterable, count) {
        return qx.Promise.__P_10_9("some", arguments);
      },
      /**
      ...
      forEach(iterable, iterator) {
        return qx.Promise.__P_10_9("each", arguments);
      },
      /**
      ...
      filter(iterable, iterator, options) {
        return qx.Promise.__P_10_9("filter", arguments);
      },
      /**
      ...
      map(iterable, iterator, options) {
        return qx.Promise.__P_10_9("map", arguments);
      },
      /**
       * Given an <code>Iterable</code>(arrays are <code>Iterable</code>), or a promise of an
       * <code>Iterable</code>, which produces promises (or a mix of promises and values), iterate over
      ...
      mapSeries(iterable, iterator) {
        return qx.Promise.__P_10_9("mapSeries", arguments);
      },
      /**
       * Given an <code>Iterable</code> (arrays are <code>Iterable</code>), or a promise of an
      ...
      reduce(iterable, reducer, initialValue) {
        return qx.Promise.__P_10_9("reduce", arguments);
      },
      /**
      ...
      method(cb) {
        ...
        return function () {
          return qx.Promise.__P_10_5(wrappedCb.apply(this, arguments));
        };
      },
      /**
       ...
       */
      props(input) {
        return qx.Promise.__P_10_9("props", arguments);
      },
      /**
      ...
      __P_10_0() {
        ...
        if (isNode) {
          process.on("unhandledRejection", qx.Promise.__P_10_11.bind(this));
        } else {
       ...
       * @return {Object?}
       */
      __P_10_9(methodName, args, minArgs) {
        args = qx.Promise.__P_10_7(args, minArgs);
        return qx.Promise.__P_10_5(qx.Promise.Impl[methodName].apply(qx.Promise.Impl, qx.Promise.__P_10_12(args)));
      },
      /**
