  ...
  qx.Class.define("qx.ui.basic.Label", {
    ...
    */
    ...
    members: {
      ...
      */
      ...
      _getContentHint() {
        if (this.__P_111_1) {
          this.__P_111_4 = this.__P_111_5();
          delete this.__P_111_1;
        }
        return {
          width: this.__P_111_4.width,
          height: this.__P_111_4.height
        };
      },
      // overridden
      _hasHeightForWidth() {
      ...
      _getContentHeightForWidth(width) {
        ...
        return this.__P_111_5(width).height;
      },
      // overridden
      ...
      */
      ...
      _applyFont(value, old) {
        if (old && this.__P_111_0 && this.__P_111_3) {
          this.__P_111_0.removeListenerById(this.__P_111_3);
          this.__P_111_3 = null;
        }
        // Apply
        var styles;
        if (value) {
          ...
          if (this.__P_111_0 instanceof qx.bom.webfonts.WebFont && !this.__P_111_0.isValid()) {
            this.__P_111_3 = this.__P_111_0.addListener("changeStatus", evt => {
          ...
          styles = this.__P_111_0.getStyles();
        } else {
          this.__P_111_0 = null;
      ...
      __P_111_5(width) {
        ...
        var styles = font ? this.__P_111_0.getStyles() : qx.bom.Font.getDefaultStyles();
      ...
      */
      ...
      _applyBuddy(value, old) {
        if (old != null) {
          ...
          this.removeListenerById(this.__P_111_2);
          this.__P_111_2 = null;
        }
        if (value != null) {
          value.bind("enabled", this, "enabled");
          this.__P_111_2 = this.addListener("tap", () => {
    ...
    */
    ...
    destruct() {
      ...
      if (this.__P_111_0 && this.__P_111_3) {
        this.__P_111_0.removeListenerById(this.__P_111_3);
      }
      this.__P_111_0 = null;
    }
