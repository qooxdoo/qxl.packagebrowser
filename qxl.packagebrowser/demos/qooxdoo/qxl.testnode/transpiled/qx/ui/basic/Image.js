(function () {
  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.ui.basic.Image", {
    ...
    members: {
      ...
      */
      ...
      _getContentHint: function () {
        return {
          width: this.__P_88_1 || 0,
          height: this.__P_88_2 || 0
        };
      },
      // overridden
      _applyDecorator: function (value, old) {
        ...
        this.__P_88_8(el, source);
      },
      // overridden
      _applyTextColor: function (value) {
        if (this.__P_88_9() === "font") {
          var el = this.getContentElement();
      ...
      */
      ...
      __P_88_9: function () {
        if (this.__P_88_3 == null) {
          ...
          if (this.getScale() && isPng && qx.core.Environment.get("css.alphaimageloaderneeded")) {
            this.__P_88_3 = "alphaScaled";
          } else if (this.getScale()) {
            this.__P_88_3 = "scaled";
          } else {
            this.__P_88_3 = "nonScaled";
          }
        }
      ...
      __P_88_11: function (mode) {
        ...
        if (mode == "font") {
          ...
          if (qx.core.Environment.get("css.alphaimageloaderneeded")) {
            var wrapper = this.__P_88_5 = new qx.html.Element("div");
            element.connectWidget(this);
      ...
      __P_88_7: function () {
        ...
        var mode = this.__P_88_9();

        if (this.__P_88_0[mode] == null) {
          this.__P_88_0[mode] = this.__P_88_11(mode);
        }

        var element = this.__P_88_0[mode];

        if (!this.__P_88_4) {
          this.__P_88_4 = element;
        }
      ...
      _styleSource: function () {
        ...
        if (!source) {
          this.__P_88_12(element);

          return;
        }

        this.__P_88_13(source);
        ...
        var contentEl = this.__P_88_14(); // Detect if the image registry knows this image


        if (ResourceManager.isFontUri(source)) {
          this.__P_88_15(contentEl, source);
          ...
          if (highResolutionSource) {
            ...
            this.__P_88_4.setStyle("background-size", backgroundSize);
          ...
          this.__P_88_17(contentEl, source);

          this.__P_88_16();
        } else {
          this.__P_88_18(contentEl, source);
        }
      },
      ...
      __P_88_16: function () {
        ...
        qx.bom.AnimationFrame.request(function (rId) {
          ...
          if (rId === this.__P_88_6) {
            this.fireEvent("loaded");
          } else {
            this.fireEvent("aborted");
          }
        }.bind(this, this.__P_88_6));
      },
       ...
       */
      __P_88_13: qx.core.Environment.select("engine.name", {
        "mshtml": function (source) {
          ...
          if (isFont) {
            ...
            if (this.getScale() && this.__P_88_9() != "alphaScaled") {
              this.__P_88_10("alphaScaled");
            } else if (!this.getScale() && this.__P_88_9() != "nonScaled") {
              this.__P_88_10("nonScaled");
            }
          } else {
            if (this.getScale() && this.__P_88_9() != "scaled") {
              this.__P_88_10("scaled");
            } else if (!this.getScale() && this.__P_88_9() != "nonScaled") {
              this.__P_88_10("nonScaled");
            }
          }

          this.__P_88_19(this.__P_88_7());
        },
        "default": function (source) {
          ...
          if (isFont) {
            this.__P_88_10("font");
          } else if (this.getScale() && this.__P_88_9() != "scaled") {
            this.__P_88_10("scaled");
          } else if (!this.getScale() && this.__P_88_9() != "nonScaled") {
            this.__P_88_10("nonScaled");
          }
       ...
       */
      __P_88_19: function (elementToAdd) {
        var currentContentElement = this.__P_88_4;
        ...
        if (currentContentElement != elementToAdd) {
          if (currentContentElement != null) {
            ...
            styles.zIndex = 10;
            var newEl = this.__P_88_5 ? elementToAdd.getChild(0) : elementToAdd;
      ...
      __P_88_15: function (el, source) {
        ...
        if (isFont) {
          ...
          this.__P_88_20(width, height);

          this.__P_88_8(el, source); // Apply source

        } else {
          // Apply source
          this.__P_88_8(el, source); // Compare with old sizes and relayout if necessary


          this.__P_88_20(ResourceManager.getImageWidth(source), ResourceManager.getImageHeight(source));
        }
      },
      ...
      __P_88_8: function (el, source) {
        ...
        if (isFont) {
          ...
          if (this.getScale()) {
            el.setStyle("fontSize", (this.__P_88_1 > this.__P_88_2 ? this.__P_88_2 : this.__P_88_1) + "px");
          } else {
       ...
       */
      __P_88_21: function (source, imageInfo) {
        ...
        this.__P_88_17(this.__P_88_14(), source);
      },
       ...
       */
      __P_88_20: function (width, height) {
        if (width === undefined) {
          width = this.__P_88_1;
        }

        if (height === undefined) {
          height = this.__P_88_2;
        }
      ...
      _recalc: function (originalWidth, originalHeight) {
        ...
        if (width != this.__P_88_1 || height != this.__P_88_2) {
          this.__P_88_1 = width;
          this.__P_88_2 = height;
          return true;
        }
    ...
    */
    destruct: function () {
      for (var mode in this.__P_88_0) {
        if (this.__P_88_0.hasOwnProperty(mode)) {
          this.__P_88_0[mode].disconnectWidget(this);
        }
      }
      ...
      this._disposeMap("__P_88_0");
    }
  });
  qx.ui.basic.Image.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=Image.js.map?dt=1626058136558