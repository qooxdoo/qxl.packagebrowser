  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.ui.basic.Image", {
    ...
    members: {
      ...
      */
      ...
      __P_79_11() {
        if (this.__P_79_3 == null) {
          ...
          if (this.getScale() && isPng && qx.core.Environment.get("css.alphaimageloaderneeded")) {
            this.__P_79_3 = "alphaScaled";
          } else if (this.getScale()) {
            this.__P_79_3 = "scaled";
          } else {
            this.__P_79_3 = "nonScaled";
          }
        }
      ...
      __P_79_13(mode) {
        ...
        if (mode == "font") {
          ...
          if (qx.core.Environment.get("css.alphaimageloaderneeded")) {
            var wrapper = this.__P_79_5 = new qx.html.Element("div");
            element.connectObject(this);
      ...
      __P_79_9() {
        ...
        var mode = this.__P_79_11();
        if (this.__P_79_0[mode] == null) {
          this.__P_79_0[mode] = this.__P_79_13(mode);
        }
        var element = this.__P_79_0[mode];
        if (!this.__P_79_4) {
          this.__P_79_4 = element;
        }
        return element;
      },
      /**
      ...
      _styleSource() {
        ...
        var source = AliasManager.resolve(this.__P_79_8);
        var element = this.getContentElement();
        if (this.__P_79_5) {
          element = element.getChild(0);
        }
        if (!source) {
          this.__P_79_14(element);
          return;
        }
        this.__P_79_15(source);
        ...
        var contentEl = this.__P_79_16();

        // Detect if the image registry knows this image
        if (ResourceManager.isFontUri(source)) {
          this.__P_79_17(contentEl, source);
          ...
          if (highResolutionSource) {
            ...
            this.__P_79_4.setStyle("background-size", backgroundSize);
          ...
          this.__P_79_19(contentEl, source);
          this.__P_79_18();
        } else {
          this.__P_79_20(contentEl, source);
        }
      },
      /**
      ...
      __P_79_18() {
        ...
        qx.bom.AnimationFrame.request(function (rId) {
          ...
          if (rId === this.__P_79_6) {
            this.fireEvent("loaded");
          } else {
            this.fireEvent("aborted");
          }
        }.bind(this, this.__P_79_6));
      },
      /**
       ...
       */
      __P_79_15: qx.core.Environment.select("engine.name", {
        mshtml(source) {
          ...
          if (isFont) {
            ...
            if (this.getScale() && this.__P_79_11() != "alphaScaled") {
              this.__P_79_12("alphaScaled");
            } else if (!this.getScale() && this.__P_79_11() != "nonScaled") {
              this.__P_79_12("nonScaled");
            }
          } else {
            if (this.getScale() && this.__P_79_11() != "scaled") {
              this.__P_79_12("scaled");
            } else if (!this.getScale() && this.__P_79_11() != "nonScaled") {
              this.__P_79_12("nonScaled");
            }
          }
          this.__P_79_21(this.__P_79_9());
        },
        default(source) {
          var isFont = source && qx.lang.String.startsWith(source, "@");
          if (isFont) {
            this.__P_79_12("font");
          } else if (this.getScale() && this.__P_79_11() != "scaled") {
            this.__P_79_12("scaled");
          } else if (!this.getScale() && this.__P_79_11() != "nonScaled") {
            this.__P_79_12("nonScaled");
          }
       ...
       */
      __P_79_21(elementToAdd) {
        var currentContentElement = this.__P_79_4;
        if (currentContentElement != elementToAdd) {
          if (currentContentElement != null) {
            ...
            styles.zIndex = 10;
            var newEl = this.__P_79_5 ? elementToAdd.getChild(0) : elementToAdd;
      ...
      __P_79_17(el, source) {
        ...
        if (isFont) {
          ...
          if (this.getScale()) {
            ...
            var font = this.__P_79_22(source);
          ...
          this.__P_79_23(ResourceManager.getImageWidth(source), ResourceManager.getImageHeight(source));
        }
      },
      __P_79_24(el, width, height) {
        if (this.getScale()) {
          el.setStyle("fontSize", (width > height ? height : width) + "px");
        } else {
          var source = qx.util.AliasManager.getInstance().resolve(this.__P_79_8);
      ...
      _applyDimension() {
        ...
        var isFont = this.__P_79_8 && qx.lang.String.startsWith(this.__P_79_8, "@");
        if (isFont) {
          var el = this.getContentElement();
          if (el) {
            var hint = this.getSizeHint();
            ...
            this.__P_79_24(el, width, height);
          }
        } else {
          this.__P_79_23();
        }
      ...
      __P_79_20(el, source) {
        ...
        if (!ImageLoader.isFailed(source)) {
          ImageLoader.load(source, this.__P_79_25, this);
        } else {
          this.__P_79_14(el);
          if (!this.__P_79_7 && this.getFallbackSource()) {
            this.__P_79_7 = true;
            this.__P_79_8 = this.getFallbackSource();
            this._styleSource();
          }
        }
      },
      ...
      __P_79_10(el, source) {
        ...
        if (isFont) {
          ...
          this.__P_79_24(el, this.__P_79_1, this.__P_79_2);
      ...
      tryReload() {
        ...
        this.__P_79_7 = false;
        this.__P_79_8 = this.getSource();
        qx.io.ImageLoader.load(this.getSource(), () => this._styleSource(), undefined, {
          retryFailed: true
        });
      },
      /**
      ...
      __P_79_25(source, imageInfo) {
        ...
        if (source !== qx.util.AliasManager.getInstance().resolve(this.__P_79_8)) {
          this.fireEvent("aborted");
          return;
        }
        ...
        // Update image
        this.__P_79_19(this.__P_79_16(), source);
      },
      /**
       ...
       */
      __P_79_23(width, height) {
        if (width === undefined) {
          width = this.__P_79_1;
        }
        if (height === undefined) {
          height = this.__P_79_2;
        }
      ...
      _recalc(originalWidth, originalHeight) {
        ...
        if (width != this.__P_79_1 || height != this.__P_79_2) {
          this.__P_79_1 = width;
          this.__P_79_2 = height;
          return true;
        }
        return false;
      }
    ...
    */
    ...
    destruct() {
      for (var mode in this.__P_79_0) {
        if (this.__P_79_0.hasOwnProperty(mode)) {
          this.__P_79_0[mode].disconnectObject(this);
        }
      }
      delete this.__P_79_4;
      if (this.__P_79_5) {
        delete this.__P_79_5;
      }
