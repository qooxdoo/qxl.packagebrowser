  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.ui.basic.Image", {
    ...
    */
    ...
    members: {
      ...
      */
      ...
      _getContentHint() {
        return {
          width: this.__P_76_1 || 0,
          height: this.__P_76_2 || 0
        };
      },
      // overridden
      _applyDecorator(value, old) {
        ...
        this.__P_76_8(el, source);
      },
      // overridden
      _applyTextColor(value) {
        if (this.__P_76_9() === "font") {
          var el = this.getContentElement();
          if (this.__P_76_5) {
            el = el.getChild(0);
          }
      ...
      */
      ...
      __P_76_9() {
        if (this.__P_76_3 == null) {
          ...
          if (this.getScale() && isPng && qx.core.Environment.get("css.alphaimageloaderneeded")) {
            this.__P_76_3 = "alphaScaled";
          } else if (this.getScale()) {
            this.__P_76_3 = "scaled";
          } else {
            this.__P_76_3 = "nonScaled";
          }
        }
      ...
      __P_76_11(mode) {
        ...
        if (mode == "font") {
          ...
          if (qx.core.Environment.get("css.alphaimageloaderneeded")) {
            var wrapper = this.__P_76_5 = new qx.html.Element("div");
            element.connectObject(this);
      ...
      __P_76_7() {
        ...
        var mode = this.__P_76_9();
        if (this.__P_76_0[mode] == null) {
          this.__P_76_0[mode] = this.__P_76_11(mode);
        }
        var element = this.__P_76_0[mode];
        if (!this.__P_76_4) {
          this.__P_76_4 = element;
        }
        return element;
      },
      /**
      ...
      _styleSource() {
        ...
        if (!source) {
          this.__P_76_12(element);
          return;
        }
        this.__P_76_13(source);
        ...
        var contentEl = this.__P_76_14();

        // Detect if the image registry knows this image
        if (ResourceManager.isFontUri(source)) {
          this.__P_76_15(contentEl, source);
          ...
          if (highResolutionSource) {
            ...
            this.__P_76_4.setStyle("background-size", backgroundSize);
          ...
          this.__P_76_17(contentEl, source);
          this.__P_76_16();
        } else {
          this.__P_76_18(contentEl, source);
        }
      },
      /**
      ...
      __P_76_16() {
        ...
        qx.bom.AnimationFrame.request(function (rId) {
          ...
          if (rId === this.__P_76_6) {
            this.fireEvent("loaded");
          } else {
            this.fireEvent("aborted");
          }
        }.bind(this, this.__P_76_6));
      },
      /**
       ...
       */
      __P_76_13: qx.core.Environment.select("engine.name", {
        mshtml(source) {
          ...
          if (isFont) {
            ...
            if (this.getScale() && this.__P_76_9() != "alphaScaled") {
              this.__P_76_10("alphaScaled");
            } else if (!this.getScale() && this.__P_76_9() != "nonScaled") {
              this.__P_76_10("nonScaled");
            }
          } else {
            if (this.getScale() && this.__P_76_9() != "scaled") {
              this.__P_76_10("scaled");
            } else if (!this.getScale() && this.__P_76_9() != "nonScaled") {
              this.__P_76_10("nonScaled");
            }
          }
          this.__P_76_19(this.__P_76_7());
        },
        default(source) {
          var isFont = source && qx.lang.String.startsWith(source, "@");
          if (isFont) {
            this.__P_76_10("font");
          } else if (this.getScale() && this.__P_76_9() != "scaled") {
            this.__P_76_10("scaled");
          } else if (!this.getScale() && this.__P_76_9() != "nonScaled") {
            this.__P_76_10("nonScaled");
          }
       ...
       */
      __P_76_19(elementToAdd) {
        var currentContentElement = this.__P_76_4;
        if (currentContentElement != elementToAdd) {
          if (currentContentElement != null) {
            ...
            styles.zIndex = 10;
            var newEl = this.__P_76_5 ? elementToAdd.getChild(0) : elementToAdd;
      ...
      __P_76_15(el, source) {
        ...
        if (isFont) {
          ...
          if (this.getScale()) {
            ...
            var font = this.__P_76_20(source);
          ...
          this.__P_76_21(ResourceManager.getImageWidth(source), ResourceManager.getImageHeight(source));
        }
      },
      __P_76_22(el, width, height) {
        if (this.getScale()) {
      ...
      _applyDimension() {
        ...
        if (isFont) {
          ...
          if (el) {
            ...
            this.__P_76_22(el, width, height);
          }
        } else {
          this.__P_76_21();
        }
      ...
      __P_76_18(el, source) {
        ...
        if (!ImageLoader.isFailed(source)) {
          ImageLoader.load(source, this.__P_76_23, this);
        } else {
          this.__P_76_12(el);
        }
      },
      ...
      __P_76_8(el, source) {
        ...
        if (isFont) {
          ...
          this.__P_76_22(el, this.__P_76_1, this.__P_76_2);
      ...
      __P_76_23(source, imageInfo) {
        ...
        // Update image
        this.__P_76_17(this.__P_76_14(), source);
      },
      /**
       ...
       */
      __P_76_21(width, height) {
        if (width === undefined) {
          width = this.__P_76_1;
        }
        if (height === undefined) {
          height = this.__P_76_2;
        }
      ...
      _recalc(originalWidth, originalHeight) {
        ...
        if (width != this.__P_76_1 || height != this.__P_76_2) {
          this.__P_76_1 = width;
          this.__P_76_2 = height;
          return true;
        }
        return false;
      }
    ...
    */
    ...
    destruct() {
      for (var mode in this.__P_76_0) {
        if (this.__P_76_0.hasOwnProperty(mode)) {
          this.__P_76_0[mode].disconnectObject(this);
        }
      }
      delete this.__P_76_4;
      if (this.__P_76_5) {
        delete this.__P_76_5;
      }
      this._disposeMap("__P_76_0");
    }
  });
