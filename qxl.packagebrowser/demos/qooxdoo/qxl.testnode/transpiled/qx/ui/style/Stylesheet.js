  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.ui.style.Stylesheet", {
    ...
    construct: function () {
      ...
      this.__P_72_0 = qx.bom.Stylesheet.createElement();
      this.__P_72_1 = [];
    },
    members: {
      __P_72_1: null,
      ...
      addRule: function (selector, css) {
        ...
        qx.bom.Stylesheet.addRule(this.__P_72_0, selector, css);

        this.__P_72_1.push(selector);
      },
      ...
      hasRule: function (selector) {
        return this.__P_72_1.indexOf(selector) != -1;
      },
      ...
      removeRule: function (selector) {
        delete this.__P_72_1[this.__P_72_1.indexOf(selector)];
        qx.bom.Stylesheet.removeRule(this.__P_72_0, selector);
      }
    }
  });
...
//# sourceMappingURL=Stylesheet.js.map?dt=1626058135176