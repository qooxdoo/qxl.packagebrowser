    ...
    members: {
      ...
      */
      ...
      _recalculateOverflow(width, requiredWidth) {
        ...
        if (width < requiredWidth) {
        ...
        } else if (this.__P_151_0.length > 0) {
          do {
            var removedChild = this.__P_151_0[0];
            ...
            if (removedChild) {
              ...
              if (this.__P_151_0.length == 1 && overflowWidgetWidth > 0) {
          ...
          } while (width >= requiredWidth && this.__P_151_0.length > 0);
        }
      },
      /**
      ...
      _getNextToHide() {
        ...
        for (var i = this.__P_151_1.length - 1; i >= 0; i--) {
          var item = this.__P_151_1[i];
      ...
      setRemovePriority(item, priority, override) {
        ...
        if (!override && this.__P_151_1[priority] != undefined) {
          throw new Error("Priority already in use!");
        }
        this.__P_151_1[priority] = item;
      },
      // property apply
      _applyOverflowHandling(value, old) {
        ...
        if (value) {
          ...
          for (var i = 0; i < this.__P_151_0.length; i++) {
            this.__P_151_0[i].setVisibility("visible");
          }
