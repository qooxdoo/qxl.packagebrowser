  ...
  qx.Class.define("qx.ui.popup.Manager", {
    ...
    */
    ...
    construct() {
      ...
      qx.event.Registration.addListener(document.documentElement, "pointerdown", this.__P_113_1, this, true);
    ...
    */
    ...
    members: {
       ...
       */
      remove(obj) {
        qx.lang.Array.remove(this.__P_113_0, obj);
        this.__P_113_2();
      },
      /**
       ...
       */
      hideAll() {
        var l = this.__P_113_0.length,
          current = {};
        while (l--) {
          current = this.__P_113_0[l];
      ...
      */
      ...
      __P_113_2() {
        ...
        for (var i = 0; i < this.__P_113_0.length; i++) {
          this.__P_113_0[i].setZIndex(min++);
        }
      },
      /*
      ---------------------------------------------------------------------------
    ...
    */
    ...
    destruct() {
      qx.event.Registration.removeListener(document.documentElement, "pointerdown", this.__P_113_1, this, true);
