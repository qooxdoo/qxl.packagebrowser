    ...
    members: {
      ...
      */
      ...
      __P_74_4() {
        ...
        var widths = reuse ? this.__P_74_0 : new Array(length);
        var flexs = reuse ? this.__P_74_1 : new Array(length);
        ...
        // Store data
        if (!reuse) {
          this.__P_74_0 = widths;
          this.__P_74_1 = flexs;
        }
        this.__P_74_2 = enableFlex;
        this.__P_74_3 = children;
      ...
      */
      ...
      renderLayout(availWidth, availHeight, padding) {
        ...
        if (this.__P_74_2 && allocatedWidth != availWidth) {
          var flexibles = {};
          var flex, offset;
