    ...
    members: {
      ...
      */
      ...
      getSizeHint() {
        ...
        return this.__P_114_0 = this._computeSizeHint();
      },
      /**
      ...
      _renderSeparator(separator, bounds) {
        this.__P_114_1.renderSeparator(separator, bounds);
      },
      /**
      ...
      _applyLayoutChange() {
        if (this.__P_114_1) {
          this.__P_114_1.scheduleLayoutUpdate();
        }
      },
      /**
       ...
       */
      _getLayoutChildren() {
        return this.__P_114_1.getLayoutChildren();
      }
    },
    /*
    *****************************************************************************
