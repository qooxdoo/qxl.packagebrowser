  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.ui.layout.Abstract", {
    ...
    members: {
      ...
      */
      ...
      getSizeHint() {
        ...
        return this.__P_110_0 = this._computeSizeHint();
      },
      /**
      ...
      _renderSeparator(separator, bounds) {
        this.__P_110_1.renderSeparator(separator, bounds);
      },
      /**
      ...
      _applyLayoutChange() {
        if (this.__P_110_1) {
          this.__P_110_1.scheduleLayoutUpdate();
        }
      },
      /**
       ...
       */
      _getLayoutChildren() {
        return this.__P_110_1.getLayoutChildren();
      }
    },
    /*
    *****************************************************************************
    ...
    */
    ...
    destruct() {
      this.__P_110_1 = this.__P_110_0 = null;
    }
  });
