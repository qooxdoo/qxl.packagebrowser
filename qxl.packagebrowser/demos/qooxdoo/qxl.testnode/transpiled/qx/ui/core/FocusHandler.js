  ...
  qx.Class.define("qx.ui.core.FocusHandler", {
    ...
    */
    ...
    members: {
      ...
      connectTo(root) {
        ...
        root.addListener("keypress", this.__P_121_4, this);
      ...
      addRoot(widget) {
        ...
        this.__P_121_0[widget.toHashCode()] = widget;
      },
      /**
      ...
      removeRoot(widget) {
        ...
        delete this.__P_121_0[widget.toHashCode()];
      },
      /**
       ...
       */
      isFocusRoot(widget) {
        return !!this.__P_121_0[widget.toHashCode()];
      },
      /*
      ---------------------------------------------------------------------------
        EVENT HANDLER
      ...
      */
      ...
      _onActivate(e) {
        ...
        this.__P_121_1 = target;
        //this.debug("active: " + target);

        var root = this.__P_121_5(target);
        if (root != this.__P_121_3) {
          this.__P_121_3 = root;
        }
      },
      /**
      ...
      _onFocusIn(e) {
        var target = e.getTarget();
        if (target != this.__P_121_2) {
          this.__P_121_2 = target;
      ...
      __P_121_4(e) {
        ...
        var current = this.__P_121_2;
        if (!e.isShiftPressed()) {
          var next = current ? this.__P_121_6(current) : this.__P_121_7();
        } else {
          var next = current ? this.__P_121_8(current) : this.__P_121_9();
        }
      ...
      */
       ...
       */
      __P_121_7() {
        return this.__P_121_11(this.__P_121_3, null);
      },
      /**
       ...
       */
      __P_121_9() {
        return this.__P_121_12(this.__P_121_3, null);
      },
      /**
      ...
      __P_121_6(widget) {
        ...
        var result = [];
        this.__P_121_13(root, widget, result);
        result.sort(this.__P_121_10);
        var len = result.length;
        return len > 0 ? result[0] : this.__P_121_7();
      },
      /**
      ...
      __P_121_8(widget) {
        ...
        var result = [];
        this.__P_121_14(root, widget, result);
        result.sort(this.__P_121_10);
        var len = result.length;
        return len > 0 ? result[len - 1] : this.__P_121_9();
      },
      /*
      ---------------------------------------------------------------------------
      ...
      */
       ...
       */
      __P_121_13(parent, widget, result) {
        ...
        for (var i = 0, l = children.length; i < l; i++) {
          ...
          if (!this.isFocusRoot(child) && child.isEnabled() && child.isVisible()) {
            if (child.isTabable() && this.__P_121_10(widget, child) < 0) {
              result.push(child);
            }
            this.__P_121_13(child, widget, result);
          }
        }
      },
      /**
       ...
       * @param result {Array} Result list
       */
      __P_121_14(parent, widget, result) {
        var children = parent.getLayoutChildren();
        var child;
        for (var i = 0, l = children.length; i < l; i++) {
          child = children[i];
          ...
          if (!this.isFocusRoot(child) && child.isEnabled() && child.isVisible()) {
            ...
            this.__P_121_14(child, widget, result);
          }
        }
      },
      /**
      ...
      __P_121_11(parent, firstWidget) {
        ...
        for (var i = 0, l = children.length; i < l; i++) {
          ...
          if (!this.isFocusRoot(child) && child.isEnabled() && child.isVisible()) {
            if (child.isTabable()) {
              if (firstWidget == null || this.__P_121_10(child, firstWidget) < 0) {
                firstWidget = child;
              }
            }

            // Deep iteration into children hierarchy
            firstWidget = this.__P_121_11(child, firstWidget);
          }
        }
        return firstWidget;
      },
      ...
      __P_121_12(parent, lastWidget) {
        ...
        for (var i = 0, l = children.length; i < l; i++) {
          ...
          if (!this.isFocusRoot(child) && child.isEnabled() && child.isVisible()) {
            if (child.isTabable()) {
              if (lastWidget == null || this.__P_121_10(child, lastWidget) > 0) {
                lastWidget = child;
              }
            }

            // Deep iteration into children hierarchy
            lastWidget = this.__P_121_12(child, lastWidget);
          }
        }
        return lastWidget;
      }
    ...
    */
    ...
    destruct() {
      ...
      this.__P_121_2 = this.__P_121_1 = this.__P_121_3 = null;
    }
  });
