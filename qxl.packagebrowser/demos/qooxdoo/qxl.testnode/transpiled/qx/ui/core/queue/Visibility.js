  ...
  qx.Class.define("qx.ui.core.queue.Visibility", {
    statics: {
      ...
      remove: function (widget) {
        if (this.__P_53_1[widget.toHashCode()]) {
          delete this.__P_53_1[widget.toHashCode()];
          qx.lang.Array.remove(this.__P_53_0, widget);
        }

        delete this.__P_53_2[widget.toHashCode()];
      },
      ...
      isVisible: function (widget) {
        return this.__P_53_2[widget.toHashCode()] || false;
      },
      ...
      add: function (widget) {
        ...
        this.__P_53_0.unshift(widget);

        this.__P_53_1[widget.toHashCode()] = widget;
      ...
      flush: function () {
        ...
        var data = this.__P_53_2; // Dynamically add children to queue
...
//# sourceMappingURL=Visibility.js.map?dt=1626058133770