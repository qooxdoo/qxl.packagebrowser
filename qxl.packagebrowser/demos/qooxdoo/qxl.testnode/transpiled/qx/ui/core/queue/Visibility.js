  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.ui.core.queue.Visibility", {
    statics: {
       ...
       */
      remove(widget) {
        if (this.__P_55_1[widget.toHashCode()]) {
          delete this.__P_55_1[widget.toHashCode()];
          qx.lang.Array.remove(this.__P_55_0, widget);
        }
        delete this.__P_55_2[widget.toHashCode()];
      },
      /**
       ...
       */
      isVisible(widget) {
        return this.__P_55_2[widget.toHashCode()] || false;
      },
      /**
      ...
      add(widget) {
        ...
        this.__P_55_0.unshift(widget);
        this.__P_55_1[widget.toHashCode()] = widget;
