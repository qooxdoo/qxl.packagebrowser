  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.ui.core.queue.Layout", {
    statics: {
       ...
       */
      remove(widget) {
        delete this.__P_57_0[widget.toHashCode()];
      },
      /**
       ...
       */
      add(widget) {
        this.__P_57_0[widget.toHashCode()] = widget;
       ...
       */
      isScheduled(widget) {
        return !!this.__P_57_0[widget.toHashCode()];
      },
      /**
