  ...
  qx.Class.define("qx.ui.core.queue.Layout", {
    statics: {
      ...
      remove: function (widget) {
        delete this.__P_52_0[widget.toHashCode()];
      },
       ...
       */
      add: function (widget) {
        this.__P_52_0[widget.toHashCode()] = widget;
      ...
      */
      isScheduled: function (widget) {
        return !!this.__P_52_0[widget.toHashCode()];
      },
      ...
      flush: function () {
        ...
        var queue = this.__P_52_2(); // iterate in reversed order to process widgets with the smallest nesting
      ...
      __P_52_3: function () {
        ...
        this.__P_52_1 = {}; // sparse level array
...
//# sourceMappingURL=Layout.js.map?dt=1626058133742