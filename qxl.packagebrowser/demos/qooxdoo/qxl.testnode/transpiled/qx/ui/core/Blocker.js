  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.ui.core.Blocker", {
    ...
    construct(widget) {
      ...
      this._widget = widget;
      widget.addListener("resize", this.__P_80_0, this);
      widget.addListener("move", this.__P_80_0, this);
      widget.addListener("disappear", this.__P_80_1, this);
    ...
    members: {
      ...
      __P_80_1() {
        if (this.isBlocked()) {
          ...
          this._widget.addListenerOnce("appear", this.__P_80_8, this);
        }
      },
      /**
      ...
      _applyColor(value, old) {
        ...
        this.__P_80_9("backgroundColor", color);
      },
      // property apply
      _applyOpacity(value, old) {
        this.__P_80_9("opacity", value);
      },
      /**
      ...
      __P_80_9(key, value) {
        var blockers = [];
        this.__P_80_4 && blockers.push(this.__P_80_4);
      ...
      _backupActiveWidget() {
        ...
        this.__P_80_2.push(activeWidget);
        this.__P_80_3.push(focusedWidget);
        if (activeWidget) {
      ...
      _restoreActiveWidget() {
        var widget;
        var focusElementsLength = this.__P_80_3.length;
        if (focusElementsLength > 0) {
          widget = this.__P_80_3.pop();
          if (widget && !widget.isDisposed() && widget.isFocusable()) {
            widget.focus();
          }
        }
        var activeElementsLength = this.__P_80_2.length;
        if (activeElementsLength > 0) {
          widget = this.__P_80_2.pop();
      ...
      getBlockerElement(widget) {
        if (!this.__P_80_4) {
          this.__P_80_4 = this.__P_80_10();
          this.__P_80_4.setStyle("zIndex", 15);
          if (!widget) {
            if (this._isRoot) {
              widget = this._widget;
            } else {
          ...
          widget.getContentElement().add(this.__P_80_4);
      ...
      _block(zIndex, blockContent) {
        if (!this._isRoot && !this._widget.getLayoutParent()) {
          if (!this.__P_80_7) {
            this.__P_80_7 = this._widget.addListenerOnce("appear", this._block.bind(this, zIndex));
          }
          return;
        }
        var parent;
        ...
        if (this.__P_80_5 < 2) {
          ...
          blocker.addListener("deactivate", this.__P_80_11, this);
          blocker.addListener("keypress", this.__P_80_12, this);
          blocker.addListener("keydown", this.__P_80_12, this);
          blocker.addListener("keyup", this.__P_80_12, this);
      ...
      unblock() {
        if (this.__P_80_7) {
          this._widget.removeListenerById(this.__P_80_7);
          this.__P_80_7 = null;
        }
        if (!this.isBlocked()) {
          return;
      ...
      __P_80_13() {
        ...
        blocker.removeListener("deactivate", this.__P_80_11, this);
        blocker.removeListener("keypress", this.__P_80_12, this);
        blocker.removeListener("keydown", this.__P_80_12, this);
        blocker.removeListener("keyup", this.__P_80_12, this);
        blocker.exclude();
    ...
    */
    ...
    destruct() {
      ...
      this._widget.removeListener("resize", this.__P_80_0, this);
      this._widget.removeListener("move", this.__P_80_0, this);
      this._widget.removeListener("appear", this.__P_80_8, this);
      this._widget.removeListener("disappear", this.__P_80_1, this);
      if (this.__P_80_7) {
        this._widget.removeListenerById(this.__P_80_7);
      }
      this._disposeObjects("__P_80_4", "__P_80_6");
      this.__P_80_2 = this.__P_80_3 = this._widget = null;
    }
  });
