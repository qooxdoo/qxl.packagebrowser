  ...
  ************************************************************************ */
  ...
  qx.Mixin.define("qx.ui.decoration.MLinearBackgroundGradient", {
    ...
    members: {
      ...
      _styleLinearBackgroundGradient: function (styles) {
        ...
        (function (startColors, endColors, units, orientations, startColorPositions, endColorPositions) {
          for (var i = 0; i < startColors.length; i++) {
            var startColor = this.__P_100_4(startColors[i]);

            var endColor = this.__P_100_4(endColors[i]);
       ...
       */
      __P_100_1: function (startColor, endColor, unit, orientation, startColorPosition, endColorPosition, styles, backgroundStyle) {
       ...
       * @return {Boolean} Whether this implementation supports multiple gradients atop each other (true).
       */
      __P_100_2: function me(startColor, endColor, unit, orientation, startColorPosition, endColorPosition, styles, backgroundStyle) {
        if (!me.__P_100_5) {
          me.__P_100_5 = document.createElement("canvas");
        }
        ...
        me.__P_100_5.width = width;
        me.__P_100_5.height = height;

        var ctx = me.__P_100_5.getContext('2d');
        ...
        backgroundStyle.push("url(" + me.__P_100_5.toDataURL() + ") " + size);
        return true;
      },
       ...
       */
      __P_100_3: function (startColor, endColor, unit, orientation, startColorPosition, endColorPosition, styles, backgroundStyle) {
       ...
       * @return {Boolean} Whether this implementation supports multiple gradients atop each other (true).
       */
      __P_100_0: function (startColor, endColor, unit, orientation, startColorPosition, endColorPosition, styles, backgroundStyle) {
...
//# sourceMappingURL=MLinearBackgroundGradient.js.map?dt=1626058137695