  ...
  qx.Class.define("qxl.mobiletweets.page.Input", {
    ...
    members: {
      ...
      _initialize: function _initialize() {
        ...
        var form = this.__P_602_0 = new qx.ui.mobile.form.Form();
        var input = this.__P_602_1 = new qx.ui.mobile.form.TextField();
      ...
      _onTap: function _onTap(evt) {
        // validate the form
        if (this.__P_602_0.validate()) {
          var username = this.__P_602_1.getValue();
