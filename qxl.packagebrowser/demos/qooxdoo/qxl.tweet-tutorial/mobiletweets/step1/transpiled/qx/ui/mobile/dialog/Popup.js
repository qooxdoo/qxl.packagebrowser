  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.ui.mobile.dialog.Popup", {
    ...
    members: {
      ...
      _updatePosition: function _updatePosition() {
        ...
        if (this.__P_468_0) {
          ...
          var anchorPosition = qx.bom.element.Location.get(this.__P_468_0.getContainerElement());
          var popupDimension = qx.bom.element.Dimension.getSize(this.getContainerElement());
          this.__P_468_7 = popupDimension;
        ...
        } else if (this.__P_468_3 && !this.__P_468_2) {
      ...
      _trackUserTap: function _trackUserTap(evt) {
        ...
        var isOutsideWidget = clientX < popupLocation.left || clientX > popupLocation.left + this.__P_468_7.width || clientY > popupLocation.top + this.__P_468_7.height || clientY < popupLocation.top;
        if (isOutsideWidget) {
          this.hide();
        }
      },
      ...
      __P_468_9: function __P_468_9() {
        ...
        if (this.__P_468_0) {
          this.__P_468_0.addCssClass("anchor-target");
       ...
       */
      __P_468_10: function __P_468_10() {
        ...
        if (this.__P_468_0) {
          this.__P_468_0.removeCssClass("anchor-target");
      ...
      _initializeChild: function _initializeChild(widget) {
        var _this = this;
        if (this.__P_468_3 == null) {
          this.__P_468_3 = new qx.ui.mobile.container.Composite(new qx.ui.mobile.layout.VBox());
          this.__P_468_3.setDefaultCssClass("popup-content");
          this._add(this.__P_468_3);
        }
        if (this._createTitleWidget()) {
          this.__P_468_3.remove(this._createTitleWidget());
          this.__P_468_3.add(this._createTitleWidget());
        }
        this.__P_468_3.add(widget, {
          flex: 1
        });
        widget.addListener("domupdated", function () {
          if (!_this.__P_468_8) {
            ...
            _this.__P_468_8 = false;
          }
        }, this);
        this.__P_468_5 = widget;
      },
      /**
      ...
      _createTitleWidget: function _createTitleWidget() {
        ...
        if (this.getTitle() || this.getIcon()) {
          this.__P_468_6 = new qx.ui.mobile.basic.Atom(this.getTitle(), this.getIcon());
          this.__P_468_6.addCssClass("popup-title");
          return this.__P_468_6;
        } else {
          return null;
        }
      ...
      _applyTitle: function _applyTitle(value, old) {
        if (value) {
          if (this.__P_468_6) {
            this.__P_468_6.setLabel(value);
          } else {
            this.__P_468_6 = new qx.ui.mobile.basic.Atom(value, this.getIcon());
            this.__P_468_6.addCssClass("popup-title");
            if (this.__P_468_5) {
              this.__P_468_3.addBefore(this._createTitleWidget(), this.__P_468_5);
            } else {
              if (this.__P_468_3) {
                this.__P_468_3.add(this._createTitleWidget());
              }
      ...
      _applyIcon: function _applyIcon(value, old) {
        if (value) {
          if (this.__P_468_6) {
            this.__P_468_6.setIcon(value);
          } else {
            this.__P_468_6 = new qx.ui.mobile.basic.Atom(this.getTitle(), value);
            this.__P_468_6.addCssClass("popup-title");
            if (this.__P_468_5) {
              this.__P_468_3.addBefore(this._createTitleWidget(), this.__P_468_5);
            } else {
      ...
      removeWidget: function removeWidget() {
        if (this.__P_468_5) {
          this.__P_468_5.removeListener("domupdated", this._updatePosition, this);
          this.__P_468_3.remove(this.__P_468_5);
          return this.__P_468_5;
        } else {
          return null;
        }
      }
    ...
    destruct: function destruct() {
      this.__P_468_10();
      this._disposeObjects("__P_468_3");
      this.__P_468_1 = this.__P_468_2 = this.__P_468_4 = this._anchor = this.__P_468_5 = this.__P_468_7 = null;
    }
  });
