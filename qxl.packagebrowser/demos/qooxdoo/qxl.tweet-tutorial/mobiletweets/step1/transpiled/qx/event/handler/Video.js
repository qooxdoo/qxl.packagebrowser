  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.event.handler.Video", {
    ...
    construct: function construct() {
      ...
      this.__P_141_0 = qx.lang.Function.listener(this._onNative, this);
    },
    statics: {
    ...
    members: {
      ...
      registerEvent: function registerEvent(target, type, capture) {
        qx.bom.Event.addNativeListener(target, type, this.__P_141_0);
      },
      /**
      ...
      unregisterEvent: function unregisterEvent(target, type) {
        qx.bom.Event.removeNativeListener(target, type, this.__P_141_0);
      }
    },
