  ...
  qx.Class.define("qx.test.ui.form.FormManager", {
    ...
    members: {
      ...
      testAddTwo: function testAddTwo() {
        ...
        // get the view
        var view = new qx.test.DummyFormRenderer(this.__P_298_0);
      ...
      testRemove: function testRemove() {
        ...
        this.assertFalse(this.__P_298_0.remove(this.__P_298_1));
      ...
      testAddTwoWithValidator: function testAddTwoWithValidator() {
        ...
        this.__P_298_0.add(this.__P_298_1, "TF1");
        this.__P_298_0.add(this.__P_298_2, "TF2", qx.util.Validate.email());
        ...
        this.__P_298_2.setValue("ab@cd.ef");
      ...
      testRemoveHeader: function testRemoveHeader() {
        ...
        // check the items
        this.assertEquals(view.groups[0].items[0], this.__P_298_1);
        this.assertEquals(view.groups[1].items[0], this.__P_298_2);
        ...
        this.assertFalse(this.__P_298_0.removeGroupHeader("affe1"));
      ...
      testRemoveButton: function testRemoveButton() {
        ...
        this.assertFalse(this.__P_298_0.removeButton(b1));
