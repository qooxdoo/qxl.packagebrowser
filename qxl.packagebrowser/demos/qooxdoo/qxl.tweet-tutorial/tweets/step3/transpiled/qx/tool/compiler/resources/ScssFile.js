...
(function () {
  ...
  qx.Class.define("qx.tool.compiler.resources.ScssFile", {
    ...
    construct: function construct(target, library, filename) {
      ...
      this.__P_616_0 = library;
      this.__filename = filename;
      this.__P_616_1 = target;
      this.__P_616_2 = {};
      this.__P_616_3 = {};
    },
    properties: {
    ...
    members: {
        ...
        return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee() {
          ...
          return _regenerator().w(function (_context) {
            while (1) switch (_context.n) {
              case 0:
                _this.__P_616_4 = path.dirname(outputFilename);
                _this.__P_616_5 = {};
                _context.n = 1;
                return _this.loadSource(_this.__filename, _this.__P_616_0);
              case 1:
                ...
                return new qx.Promise(function (resolve, reject) {
                  sass.render({
                    ...
                    importer: function importer(url, prev, done) {
                      var contents = _this.__P_616_2[url];
                      if (!contents) {
                        var tmp = _this.__P_616_3[url];
                        if (tmp) {
                          contents = _this.__P_616_2[tmp];
                        }
                      }
                      return contents ? {
                        contents: contents
                    ...
                    functions: {
                      "qooxdooUrl($filename, $url)": function qooxdooUrl$filename_$url($filename, $url, done) {
                        return _this.__P_616_6($filename, $url, done);
                      }
                    }
              ...
              case 2:
                return _context.a(2, Object.keys(_this.__P_616_2));
            }
          }, _callee);
        }))();
      },
      _analyseFilename: function _analyseFilename(url, currentFilename) {
        ...
        var library = this.__P_616_1.getAnalyser().getLibraries().find(function (library) {
      ...
      reloadSource: function reloadSource(filename) {
        ...
        delete this.__P_616_2[filename];
          ...
          return _regenerator().w(function (_context2) {
            while (1) switch (_context2.n) {
              case 0:
                ...
                _this2.__P_616_2[absFilename] = null;
                return _context2.a(2, null);
              case 1:
                if (!(_this2.__P_616_2[absFilename] !== undefined)) {
                  _context2.n = 2;
                  break;
                }
                return _context2.a(2, qx.Promise.resolve(_this2.__P_616_2[absFilename]));
              case 2:
                _context2.n = 3;
              ...
              case 3:
                ...
                contents = contents.replace(/@import\s+["']([^;]+)["']/gi, function (match, p1, offset) {
                  ...
                  var newLibrary = _this2.__P_616_1.getAnalyser().findLibrary(pathInfo.namespace);
                  if (!newLibrary) {
                ...
                contents = contents.replace(/\burl\s*\(\s*([^\)]+)*\)/gi, function (match, url) {
                  ...
                  if (pathInfo) {
                    ...
                    if (pathInfo.namespace) {
                      var targetFile = path.relative(process.cwd(), path.join(_this2.__P_616_1.getOutputDir(), "resource", pathInfo.filename));
                      var relative = path.relative(_this2.__P_616_4, targetFile);
                      return "url(\"".concat(relative, "\")");
                    }
                  }
                  return "url(\"".concat(url, "\")");
                });
                _this2.__P_616_2[absFilename] = contents;
                _this2.__P_616_3[filename] = absFilename;
                _context2.n = 4;
      ...
      getSourceFilenames: function getSourceFilenames() {
        return Object.keys(this.__P_616_2);
      },
      __P_616_6: function __P_616_6($filename, $url, done) {
        ...
        if (pathInfo) {
          ...
          if (pathInfo.namespace) {
            var targetFile = path.relative(process.cwd(), path.join(this.__P_616_1.getOutputDir(), "resource", pathInfo.filename));
            var relative = path.relative(this.__P_616_4, targetFile);
