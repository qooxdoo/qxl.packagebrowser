  ...
  qx.Class.define("qx.ui.mobile.basic.Label", {
    ...
    */
    ...
    construct: function construct(value) {
      ...
      this.initWrap();
      {
        this.__P_454_0 = qx.locale.Manager.getInstance().addListener("changeLocale", this._onChangeLocale, this);
      }
    },
    /*
    *****************************************************************************
    ...
    */
    destruct: function destruct() {
      if (true && this.__P_454_0) {
        qx.locale.Manager.getInstance().removeListenerById(this.__P_454_0);
      }
    }
  });
