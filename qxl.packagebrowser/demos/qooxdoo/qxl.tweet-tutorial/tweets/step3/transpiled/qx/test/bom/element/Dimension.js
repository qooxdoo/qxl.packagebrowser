  ...
  qx.Class.define("qx.test.bom.element.Dimension", {
    ...
    members: {
      setUp: function setUp() {
        this.__P_217_0 = document.createElement("span");
        document.body.appendChild(this.__P_217_0);
        this.__P_217_1 = document.createElement("span");
        this.__P_217_1.style.padding = "2px";
        document.body.appendChild(this.__P_217_1);
        this.__P_217_2 = document.createElement("div");
        this.__P_217_2.style.width = "200px";
        document.body.appendChild(this.__P_217_2);
        this.__P_217_3 = document.createElement("div");
        this.__P_217_3.style.padding = "2px";
        this.__P_217_3.style.width = "200px";
        document.body.appendChild(this.__P_217_3);
      },
      tearDown: function tearDown() {
        ...
        this.__P_217_1 = null;
        document.body.removeChild(this.__P_217_2);
        this.__P_217_2 = null;
        document.body.removeChild(this.__P_217_3);
        this.__P_217_3 = null;
      },
      testContentWidthOfInlineElement: function testContentWidthOfInlineElement() {
        this.assertEquals(0, qx.bom.element.Dimension.getContentWidth(this.__P_217_0));
      },
      testContentWidthOfInlineElementWithPadding: function testContentWidthOfInlineElementWithPadding() {
        this.assertEquals(0, qx.bom.element.Dimension.getContentWidth(this.__P_217_1));
      },
      testContentWidthOfBlockElement: function testContentWidthOfBlockElement() {
        this.assertEquals(200, qx.bom.element.Dimension.getContentWidth(this.__P_217_2));
      },
      testContentWidthOfBlockElementWithPadding: function testContentWidthOfBlockElementWithPadding() {
        this.assertEquals(200, qx.bom.element.Dimension.getContentWidth(this.__P_217_3));
      },
