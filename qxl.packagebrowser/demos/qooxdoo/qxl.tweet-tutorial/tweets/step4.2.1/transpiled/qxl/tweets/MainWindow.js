(function () {
  ...
  qx.Class.define("qxl.tweets.MainWindow", {
    ...
    construct: function construct() {
      ...
      // list
      this.__P_593_0 = new qx.ui.form.List();
      this.add(this.__P_593_0, {
        row: 1,
        column: 0,
        colSpan: 2
      });
      ...
      // textarea
      this.__P_593_1 = new qx.ui.form.TextArea();
      this.add(this.__P_593_1, {
        row: 2,
        column: 0
      });
      this.__P_593_1.setPlaceholder("Enter your message here...");
      this.__P_593_1.addListener("input", function (e) {
        var value = e.getData();
      ...
      postButton.addListener("execute", function () {
        this.fireDataEvent("post", this.__P_593_1.getValue());
      }, this);
    ...
    members: {
      ...
      getList: function getList() {
        return this.__P_593_0;
      },
      clearPostMessage: function clearPostMessage() {
        this.__P_593_1.setValue(null);
      }
    }
  });
