(function () {
  ...
  ************************************************************************ */
  qx.Class.define("qx.test.ui.form.ModelSelection", {
    ...
    members: {
      __P_306_0: function __P_306_0(widget, children) {
      ...
      __P_306_1: function __P_306_1(widget, children) {
        var children = children || widget.getChildren();
      ...
      __P_306_2: function __P_306_2(widget, children) {
        var children = children || widget.getChildren();
      ...
      __P_306_3: function __P_306_3(widget, children) {
        var children = children || widget.getChildren();
      ...
      __P_306_5: function __P_306_5(widget) {
        for (var i = 0; i < 3; i++) {
      ...
      __P_306_8: function __P_306_8(widget) {
        for (var i = 0; i < 3; i++) {
      ...
      __P_306_10: function __P_306_10() {
      ...
      __P_306_11: function __P_306_11(box) {
      ...
      testListGetSingle: function testListGetSingle() {
        var list = this.__P_306_6();
        this.__P_306_0(list);
        this.__P_306_11(list);
      },
      ...
      testTreeGetSingle: function testTreeGetSingle() {
        var widget = this.__P_306_10();
        var children = widget.getItems(true);
        this.__P_306_0(widget, children);
        widget.destroy();
      },
      testTreeSetSingle: function testTreeSetSingle() {
        var widget = this.__P_306_10();
        var children = widget.getItems(true);
        this.__P_306_2(widget, children);
        widget.destroy();
      },
      testTreeGetMulti: function testTreeGetMulti() {
        ...
        var children = widget.getItems(true);
        this.__P_306_1(widget, children);
        widget.destroy();
      },
      testTreeSetMulti: function testTreeSetMulti() {
        ...
        widget.setSelectionMode("multi");
        var children = widget.getItems(true);
        this.__P_306_3(widget, children);
        widget.destroy();
      }
    }
  });
