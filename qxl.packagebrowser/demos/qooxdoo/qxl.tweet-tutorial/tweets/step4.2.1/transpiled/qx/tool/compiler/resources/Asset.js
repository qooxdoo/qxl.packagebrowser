...
(function () {
  ...
  qx.Class.define("qx.tool.compiler.resources.Asset", {
    ...
    construct: function construct(library, filename, fileInfo) {
      ...
      this.__P_603_0 = library;
      this.__filename = filename;
      this.__P_603_1 = fileInfo;
    },
    members: {
      ...
      isThemeFile: function isThemeFile() {
        return this.__P_603_1.resourcePath == "themePath";
      },
      getSourceFilename: function getSourceFilename() {
        return path.relative(process.cwd(), this.isThemeFile() ? this.__P_603_0.getThemeFilename(this.__filename) : this.__P_603_0.getResourceFilename(this.__filename));
      },
      getDestFilename: function getDestFilename(target) {
        var filename = null;
        if (this.__P_603_3) {
          filename = this.__P_603_3[this.__P_603_3.length - 1].getDestFilename(target, this);
        }
      ...
      setLoaders: function setLoaders(loaders) {
        this.__P_603_2 = loaders.length ? loaders : null;
      },
      setConverters: function setConverters(converters) {
        this.__P_603_3 = converters.length ? converters : null;
      },
      addMetaReferee: function addMetaReferee(asset) {
        if (!this.__P_603_4) {
          this.__P_603_4 = [];
        }
        if (!qx.lang.Array.contains(this.__P_603_4, asset)) {
          this.__P_603_4.push(asset);
        }
      },
      ...
      addMetaReferTo: function addMetaReferTo(asset) {
        ...
        if (!qx.lang.Array.contains(this.__P_603_5, asset)) {
          this.__P_603_5.push(asset);
        }
      },
      getMetaReferTo: function getMetaReferTo() {
        return this.__P_603_5;
      },
      setDependsOn: function setDependsOn(assets) {
        var _this = this;
        if (this.__P_603_6) {
          this.__P_603_6.forEach(function (thatAsset) {
            return delete thatAsset.__P_603_7[_this.getFilename];
          });
        }
        if (assets && assets.length) {
          this.__P_603_6 = assets;
          this.__P_603_1.dependsOn = assets.map(function (asset) {
            return asset.toUri();
          });
          assets.forEach(function (thatAsset) {
            if (!thatAsset.__P_603_7) {
              thatAsset.__P_603_7 = {};
            }
            thatAsset.__P_603_7[_this.getFilename()] = _this;
          });
        } else {
          this.__P_603_6 = null;
          delete this.__P_603_1.dependsOn;
        }
      },
      getDependsOn: function getDependsOn() {
        return this.__P_603_6;
      },
      getDependsOnThisAsset: function getDependsOnThisAsset() {
        return this.__P_603_7 ? Object.values(this.__P_603_7) : null;
      },
      load: function load() {
        var _this2 = this;
        return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
          return _regeneratorRuntime().wrap(function _callee$(_context) {
            while (1) switch (_context.prev = _context.next) {
              case 0:
                if (_this2.__P_603_2) {
                  _this2.__P_603_2.forEach(function (loader) {
          ...
          return _regeneratorRuntime().wrap(function _callee4$(_context4) {
            while (1) switch (_context4.prev = _context4.next) {
              case 0:
                ...
                _context4.next = 5;
                return qx.tool.utils.Promisify.some(_this3.__P_603_3, function (converter) {
              ...
              case 10:
                ...
                if (_this3.__P_603_6) {
                  _this3.__P_603_6.forEach(function (asset) {
              ...
              case 25:
                ...
                dependsOn = [];
                if (!(_this3.__P_603_3.length == 1)) {
                  _context4.next = 36;
                  break;
                }
                _context4.next = 30;
                return _this3.__P_603_3[0].convert(target, _this3, srcFilename, destFilename, _this3.isThemeFile());
              case 30:
              ...
              case 36:
                ...
                qx.tool.utils.Promisify.each(_this3.__P_603_3, /*#__PURE__*/function () {
                    ...
                    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
                      while (1) switch (_context3.prev = _context3.next) {
                        case 0:
                          ...
                          tmpDest = index === _this3.__P_603_3.length - 1 ? destFilename : path.join(require("os").tmpdir(), path.basename(srcFilename) + "-pass" + (index + 1) + "-");
                          _context3.next = 4;
      ...
      toUri: function toUri() {
        return this.__P_603_0.getNamespace() + ":" + this.__filename;
      },
