  ...
  qx.Bootstrap.define("qx.bom.Label", {
    ...
    */
    ...
    statics: {
       ...
       */
      __P_22_2: function __P_22_2(html) {
       ...
       */
      __P_22_4: function __P_22_4(html) {
        var styles = {};
      ...
      create: function create(content, html, win) {
        ...
        if (!qx.core.Environment.get("css.textoverflow") && qx.core.Environment.get("html.xul")) {
          ...
          qx.bom.element.Style.setStyles(el, this.__P_22_4(html));
        }
        if (content) {
      ...
      setValue: function setValue(element, value) {
        value = value || "";
        if (element.useHtml) {
          if (qx.bom.Label.__P_22_5 && typeof qx.bom.Label.__P_22_5 === "function") {
            value = qx.bom.Label.__P_22_5(value);
          }
      ...
      getHtmlSize: function getHtmlSize(content, styles, width) {
        var element = this._htmlElement || this.__P_22_3();

        // apply width
        element.style.width = width != undefined ? width + "px" : "auto";
        // insert content
        element.innerHTML = content;
        return this.__P_22_6(element, styles);
      },
      /**
      ...
      getTextSize: function getTextSize(text, styles) {
        var element = this._textElement || this.__P_22_1();
        if (!qx.core.Environment.get("css.textoverflow") && qx.core.Environment.get("html.xul")) {
       ...
       * @return {Map} A map with preferred <code>width</code> and <code>height</code>.
       */
      __P_22_6: function __P_22_6(element, styles) {
        // sync styles
