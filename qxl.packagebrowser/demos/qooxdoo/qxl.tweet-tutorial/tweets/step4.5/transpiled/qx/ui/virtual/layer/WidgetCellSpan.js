  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.ui.virtual.layer.WidgetCellSpan", {
    ...
    construct: function construct(widgetCellProvider, rowConfig, columnConfig) {
      ...
      this.__P_552_0 = [];
      this._cellLayer = new qx.ui.virtual.layer.WidgetCell(this.__P_552_1());
    ...
    */
    ...
    members: {
       ...
       */
      __P_552_2: function __P_552_2(firstRow, firstColumn, rowCount, columnCount) {
      ...
      _fullUpdate: function _fullUpdate(firstRow, firstColumn, rowSizes, columnSizes) {
        this.__P_552_2(firstRow, firstColumn, rowSizes.length, columnSizes.length);
        this.__P_552_3();
    ...
    destruct: function destruct() {
      ...
      this._cellProvider = this.__P_552_0 = this._cells = this._bounds = this._spanMap = null;
    }
  });
