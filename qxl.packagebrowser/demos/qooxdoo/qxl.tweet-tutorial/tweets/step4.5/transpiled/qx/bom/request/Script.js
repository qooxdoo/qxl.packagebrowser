  ...
  ************************************************************************ */
  ...
  qx.Bootstrap.define("qx.bom.request.Script", {
    ...
    construct: function construct() {
      this.__P_59_0();
      this.__P_59_1 = qx.Bootstrap.bind(this._onNativeLoad, this);
      this.__P_59_2 = qx.Bootstrap.bind(this._onNativeError, this);
      this.__P_59_3 = qx.Bootstrap.bind(this._onTimeout, this);
      this.__P_59_4 = document.head || document.getElementsByTagName("head")[0] || document.documentElement;
      ...
      this.timeout = this.__P_59_5() ? 0 : 15000;
    },
    events: {
    ...
    members: {
      ...
      setRequestHeader: function setRequestHeader(key, value) {
        ...
        param[key] = value;
        this.__P_59_9 = qx.util.Uri.appendParamsToUrl(this.__P_59_9, param);
        return this;
      },
      /**
       * Sends request.
      ...
      send: function send() {
        ...
        var script = this.__P_59_11(),
          head = this.__P_59_4,
          that = this;
        if (this.timeout > 0) {
          this.__P_59_12 = window.setTimeout(this.__P_59_3, this.timeout);
        }
        if (this.__P_59_10("qx.debug.io")) {
      ...
      dispose: function dispose() {
        ...
        if (!this.__P_59_7) {
          ...
          if (this.__P_59_12) {
            window.clearTimeout(this.__P_59_12);
          }
          this.__P_59_7 = true;
        }
      },
      ...
      */
      ...
      _onNativeLoad: function _onNativeLoad() {
        var script = this.__P_59_14,
          determineSuccess = this.__P_59_6,
          that = this;
        ...
        if (this.__P_59_10("engine.name") === "mshtml" && this.__P_59_10("browser.documentmode") < 9) {
      ...
      */
      ...
      __P_59_5: function __P_59_5() {
        var isLegacyIe = this.__P_59_10("engine.name") === "mshtml" && this.__P_59_10("browser.documentmode") < 9;
        var isOpera = this.__P_59_10("engine.name") === "opera";
      ...
      __P_59_11: function __P_59_11() {
        var script = this.__P_59_14 = document.createElement("script");
        script.src = this.__P_59_9;
        script.onerror = this.__P_59_2;
        script.onload = this.__P_59_1;

        // BUGFIX: IE < 9
        // Legacy IEs do not fire the "load" event for script elements.
        // Instead, they support the "readystatechange" event
        if (this.__P_59_10("engine.name") === "mshtml" && this.__P_59_10("browser.documentmode") < 9) {
          script.onreadystatechange = this.__P_59_1;
        }
        return script;
      },
      /**
      ...
      __P_59_13: function __P_59_13() {
        ...
        if (script && script.parentNode) {
          this.__P_59_4.removeChild(script);
        }
      },
      /**
       ...
       */
      __P_59_10: function __P_59_10(key) {
