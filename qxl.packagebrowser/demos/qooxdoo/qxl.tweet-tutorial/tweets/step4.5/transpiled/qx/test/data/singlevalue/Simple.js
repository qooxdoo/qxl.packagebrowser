  ...
  qx.Class.define("qx.test.data.singlevalue.Simple", {
    ...
    members: {
      ...
      testDefaultConversion: function testDefaultConversion() {
        ...
        this.assertEquals(4879, this.__P_238_1.getZIndex(), "String --> Number does not work!");
        ...
        this.assertEquals("1234", this.__P_238_1.getAppearance(), "Number --> String does not work!");

        // boolean to string
        qx.data.SingleValueBinding.bind(this.__P_238_0, "enabled", this.__P_238_1, "appearance");
        this.__P_238_0.setEnabled(true);
        this.assertEquals("true", this.__P_238_1.getAppearance(), "Boolean --> String does not work!");
      ...
      testRemoveBinding: function testRemoveBinding() {
        ...
        // remove the binding
        qx.data.SingleValueBinding.removeBindingFromObject(this.__P_238_0, id);
        // set and chech the name
        this.__P_238_0.setAppearance("hans2");
        this.assertEquals("hans", this.__P_238_1.getAppearance(), "Did not remove the binding!");
      ...
      testGetAllBindingsForObject: function testGetAllBindingsForObject() {
        ...
        this.assertEquals(89, this.__P_238_1.getZIndex(), "Number binding does not work!");
      ...
      testRemoveAllBindingsForObject: function testRemoveAllBindingsForObject() {
        ...
        this.assertEquals(89, this.__P_238_1.getZIndex(), "Number binding not removed!");
      ...
      testGetAllBindings: function testGetAllBindings() {
        ...
        var id2 = qx.data.SingleValueBinding.bind(this.__P_238_0, "zIndex", this.__P_238_1, "zIndex");
        var id3 = qx.data.SingleValueBinding.bind(this.__P_238_1, "zIndex", this.__P_238_0, "zIndex");
        ...
        this.assertEquals(id3, allBindings[this.__P_238_1.toHashCode()][0][0], "This id should be in!");
      ...
      testDebugStuff: function testDebugStuff() {
        ...
        qx.data.SingleValueBinding.bind(this.__P_238_1, "zIndex", this.__P_238_0, "zIndex");
        // test the single log
        qx.data.SingleValueBinding.showBindingInLog(this.__P_238_0, id1);
      },
      testMixinSupport: function testMixinSupport() {
        ...
        this.assertEquals("hulk", this.__P_238_1.getAppearance(), "String binding does not work!");

        // remove the binding
        this.__P_238_0.removeBinding(id1);
        this.__P_238_0.setAppearance("hulk2");
        this.assertEquals("hulk", this.__P_238_1.getAppearance(), "Unbinding does not work!");

        // add another two bindings
        var id1 = this.__P_238_0.bind("changeAppearance", this.__P_238_1, "appearance");
        var id2 = this.__P_238_0.bind("zIndex", this.__P_238_1, "zIndex");
      ...
      testFallback: function testFallback() {
        ...
        this.assertEquals(this.__P_238_0.getValue(), this.__P_238_1.getValue(), "change event binding is not working.");
      ...
      testNullWithConverter: function testNullWithConverter() {
        ...
        this.assertEquals(this.__P_238_0.getZIndex() + "", t.getA(), "Wrong start binding.");
      ...
      testRemoveRelatedBindings: function testRemoveRelatedBindings() {
        ...
        qx.data.SingleValueBinding.bind(c, "appearance", this.__P_238_0, "appearance");

        // add another binding to __b, which should not be affected
        qx.data.SingleValueBinding.bind(c, "appearance", this.__P_238_1, "appearance");
        ...
        qx.data.SingleValueBinding.removeRelatedBindings(this.__P_238_0, this.__P_238_1);
