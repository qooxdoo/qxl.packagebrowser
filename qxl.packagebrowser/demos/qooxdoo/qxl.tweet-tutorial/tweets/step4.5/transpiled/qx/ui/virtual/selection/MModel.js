  ...
  ************************************************************************ */
  ...
  qx.Mixin.define("qx.ui.virtual.selection.MModel", {
    construct: function construct() {
      ...
      this.__P_560_0 = new qx.data.Array();
      this.__P_560_0.addListener("change", this._onChangeSelection, this);
      this._applySelection(this.__P_560_0, null);
    },
    properties: {
    ...
    members: {
      ...
      */
      ...
      setSelection: function setSelection(value) {
        if (value) {
          this.__P_560_0.replace(value);
        } else {
          this.__P_560_0.removeAll();
        }
      },
      /**
      ...
      */
      ...
      _onManagerChangeSelection: function _onManagerChangeSelection(e) {
        if (this.__P_560_1 == true) {
          return;
        }
        this.__P_560_2 = true;
        this.__P_560_3();
        this.__P_560_2 = false;
       ...
       */
      __P_560_5: function __P_560_5(newSelection) {
        var selection = this.getSelection();
