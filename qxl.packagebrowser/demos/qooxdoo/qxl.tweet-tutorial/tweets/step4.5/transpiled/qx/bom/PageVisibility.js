  ...
  ************************************************************************ */
  ...
  qx.Bootstrap.define("qx.bom.PageVisibility", {
    ...
    construct: function construct(document) {
      this.__P_26_0 = document || window.document;
      this.__P_26_1();
      var self = this;
      // forward the event
      qx.bom.Event.addNativeListener(this.__P_26_0, this.__P_26_2, function (e) {
        self.emit("change", e);
      });
    },
    events: {
    ...
    members: {
      ...
      __P_26_1: function __P_26_1() {
        ...
        for (var i = 0; i < prefix.length; i++) {
          ...
          if (this.__P_26_0[attr] != undefined) {
            this.__P_26_3 = attr;
            // also use the same prefix for the event name
            this.__P_26_2 = prefix[i].toLowerCase() + "visibilitychange";
            break;
          }
        }
        ...
        if (this.__P_26_3 == null) {
          this.__P_26_3 = "hidden";
          this.__P_26_2 = "visibilitychange";
        }
        if (this.__P_26_4 == null) {
          this.__P_26_4 = "visibilityState";
        }
      },
      /**
      ...
      isHidden: function isHidden() {
        return !!this.__P_26_0[this.__P_26_3];
      },
      /**
      ...
      getVisibilityState: function getVisibilityState() {
        return this.__P_26_0[this.__P_26_4] || "visible";
      }
    }
  });
