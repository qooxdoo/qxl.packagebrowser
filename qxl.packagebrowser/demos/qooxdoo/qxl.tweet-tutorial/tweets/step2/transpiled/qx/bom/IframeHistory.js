  ...
  qx.Class.define("qx.bom.IframeHistory", {
    ...
    members: {
      ...
      _readState: function _readState() {
        ...
        var doc = this.__P_20_1.contentWindow.document;
      ...
      _writeState: function _writeState(state) {
        if (!this.__P_20_2) {
          this.__P_20_6();
          this.__P_20_3 = qx.event.Timer.once(function () {
      ...
      __P_20_0: function __P_20_0() {
        this.__P_20_7(function () {
          qx.event.Idle.getInstance().addListener("interval", this.__P_20_8, this);
        });
      },
      /**
       ...
       * @return {String}
       */
      __P_20_10: function __P_20_10(locationState) {
       ...
       * @return {Boolean}
       */
      __P_20_9: function __P_20_9(locationState) {
        return qx.lang.Type.isString(locationState) && locationState == this.__P_20_5;
      },
      /**
       ...
       */
      __P_20_7: function __P_20_7(handler) {
        this.__P_20_1 = this.__P_20_11();
        document.body.appendChild(this.__P_20_1);
        this.__P_20_12(function () {
       ...
       */
      __P_20_12: function __P_20_12(callback, context, retry) {
        if (typeof retry === "undefined") {
          retry = 0;
        }
        if (!this.__P_20_1.contentWindow || !this.__P_20_1.contentWindow.document) {
          if (retry > 20) {
            throw new Error("can't initialize iframe");
          }
          qx.event.Timer.once(function () {
            this.__P_20_12(callback, context, ++retry);
          }, this, 10);
          return;
        }
        this.__P_20_2 = true;
    ...
    destruct: function destruct() {
      ...
      qx.event.Idle.getInstance().removeListener("interval", this.__P_20_8, this);
    }
  });
