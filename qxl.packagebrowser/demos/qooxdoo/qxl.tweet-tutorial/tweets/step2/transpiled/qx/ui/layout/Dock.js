  ...
  qx.Class.define("qx.ui.layout.Dock", {
    ...
    */
    ...
    members: {
      ...
      __P_438_4: function __P_438_4() {
        ...
        this.__P_438_0 = result;

        // Cache edges for faster access
        var edges = [];
        for (var i = 0; i < length; i++) {
          edge = result[i].getLayoutProperties().edge;
          edges[i] = this.__P_438_2[edge] || 5;
        }
        this.__P_438_1 = edges;
    ...
    */
    destruct: function destruct() {
      this.__P_438_1 = this.__P_438_0 = null;
    }
  });
