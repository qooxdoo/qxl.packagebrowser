    ...
    */
    ...
    members: {
      ...
      */
       ...
       * and position.
       */
      __P_447_2: function __P_447_2() {
        var menuBounds = this._getMenuBounds();
        if (!menuBounds) {
          this.addListenerOnce("resize", this.__P_447_2, this);
          return;
        }
      ...
      syncWidget: function syncWidget(jobs) {
        ...
        if (this.__P_447_1) {
          this.__P_447_1.call(this);
          delete this.__P_447_1;
        }
      },
      /*
      ---------------------------------------------------------------------------
