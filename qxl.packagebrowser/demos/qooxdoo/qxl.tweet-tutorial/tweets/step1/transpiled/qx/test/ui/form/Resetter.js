  ...
  qx.Class.define("qx.test.ui.form.Resetter", {
    ...
    members: {
      ...
      testRemove: function testRemove() {
        ...
        this.__P_311_1.setValue("b");
        // remove one item
        this.assertTrue(this.__P_311_3.remove(this.__P_311_1));
        // remove again to see that it has not been removed
        this.assertFalse(this.__P_311_3.remove(this.__P_311_1));
        // reset the manager
        this.__P_311_3.reset();
      ...
      testResetOneItem: function testResetOneItem() {
        ...
        this.__P_311_3.resetItem(this.__P_311_1);
      ...
      testRedefineOneItem: function testRedefineOneItem() {
        ...
        this.__P_311_3.redefineItem(this.__P_311_1);
        // change the first two items
        this.__P_311_0.setValue("1");
        this.__P_311_1.setValue("2");
