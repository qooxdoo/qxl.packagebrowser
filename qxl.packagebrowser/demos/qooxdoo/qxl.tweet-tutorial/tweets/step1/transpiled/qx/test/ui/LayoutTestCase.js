    ...
    members: {
      ...
      tearDown: function tearDown() {
        ...
        if (cls._root) {
          cls._root.destroy();
          cls._root = null;
          qx.core.Init.getApplication = cls.__P_276_0;
        }
      },
      getRoot: function getRoot() {
        ...
        cls.__P_276_1 = qx.core.Init.getApplication();
        cls.__P_276_0 = qx.core.Init.getApplication;
      ...
      getRunnerApplication: function getRunnerApplication() {
        return qx.test.ui.LayoutTestCase.__P_276_1 || qx.core.Init.getApplication();
      },
