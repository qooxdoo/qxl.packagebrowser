  ...
  qx.Class.define("qx.test.data.controller.List", {
    ...
    members: {
      ...
      testModelChangeCombobox: function testModelChangeCombobox() {
        ...
        var controller = new qx.data.controller.List(this.__P_230_3, box);
      ...
      testBooleanArray: function testBooleanArray() {
        this.__P_230_2 = [true, false, false];
        // create a new array
        this.__P_230_3 = new qx.data.Array(this.__P_230_2);
      ...
      testSelectBox: function testSelectBox() {
        ...
        this.__P_230_1 = new qx.data.controller.List(this.__P_230_3, box);
      ...
      testResetSelectionSingle: function testResetSelectionSingle() {
        ...
        this.__P_230_1.getSelection().push("b");

        // change the model (should reset the selection)
        this.__P_230_1.setModel(model);
      ...
      testSelectionMultiple: function testSelectionMultiple() {
        ...
        this.__P_230_0.addToSelection(this.__P_230_0.getChildren()[1]);
        this.__P_230_0.addToSelection(this.__P_230_0.getChildren()[2]);

        // test the selection
        this.assertEquals(this.__P_230_3.getItem(1), this.__P_230_1.getSelection().getItem(0), "Selection does not work.");
        this.assertEquals(this.__P_230_3.getItem(2), this.__P_230_1.getSelection().getItem(1), "Selection does not work.");
      ...
      testSelectionBackSingle: function testSelectionBackSingle() {
        ...
        this.__P_230_1.getSelection().push(this.__P_230_3.getItem(0));
      ...
      testSelectionArrayChange: function testSelectionArrayChange() {
        ...
        this.__P_230_1.setSelection(new qx.data.Array([this.__P_230_3.getItem(0)]));
      ...
      testSelectionAfterDelete: function testSelectionAfterDelete() {
        ...
        this.assertTrue(this.__P_230_1.getSelection().contains("b"), "Selection array wrong!");
      ...
      testSelectionAfterDeleteEmpty: function testSelectionAfterDeleteEmpty() {
        ...
        this.__P_230_1.getSelection().push("c");
        // remove the c
        this.__P_230_3.splice(2, 1);
      ...
      testResetBug: function testResetBug() {
        ...
        this.__P_230_1.bind("selection[0]", label, "value");
      ...
      testDates: function testDates() {
        this.__P_230_2 = [new Date(0), new Date(100)];
        // create a new array
        this.__P_230_3 = new qx.data.Array(this.__P_230_2);
      ...
      testSelectBoxSelectionSingle: function testSelectBoxSelectionSingle() {
        ...
        this.__P_230_1.getSelection().push("10");
      ...
      testSelectionWithModelChange: function testSelectionWithModelChange() {
        ...
        // change the model
        this.__P_230_1.setModel(new qx.data.Array(["x", "y", "z"]));

        // test for an empty selection
        this.assertEquals(0, this.__P_230_1.getSelection().length, "Selection is not empty.");

        // select an item
        this.__P_230_1.getSelection().push("x");
      ...
      testSelectionWithModelChangeSelectBox: function testSelectionWithModelChangeSelectBox() {
        ...
        var selectBox = new qx.ui.form.SelectBox();
        // create the controller
        this.__P_230_1 = new qx.data.controller.List(this.__P_230_3, selectBox);
        ...
        // select an item
        this.__P_230_1.getSelection().push("y");
      ...
      testFilterChange: function testFilterChange() {
        ...
        this.__P_230_1.setDelegate(delegate2);
      ...
      testFilterChangeModel: function testFilterChangeModel() {
        ...
        // check the length
        this.assertEquals(3, this.__P_230_0.getChildren().length, "Wrong number of list items");
      ...
      testFilterReverseModel: function testFilterReverseModel() {
        ...
        // check for the right length
        this.assertEquals(3, this.__P_230_0.getChildren().length, "Some list items created.");
      ...
      testFilterRemove: function testFilterRemove() {
        ...
        // remove the filter
        this.__P_230_1.setDelegate(null);

        // check for the right length
        this.assertEquals(5, this.__P_230_0.getChildren().length, "Some list items created.");
      ...
      testFilterChangeTarget: function testFilterChangeTarget() {
        ...
        this.assertEquals(2, this.__P_230_0.getChildren().length, "Wrong number of list items");

        // change the target
        this.__P_230_1.setTarget(null);
        // check if everything is cleaned up
        this.assertEquals(0, this.__P_230_0.getChildren().length, "Wrong number of list items");
      ...
      testFilterWithSelection: function testFilterWithSelection() {
        ...
        this.__P_230_0.addToSelection(this.__P_230_0.getChildren()[1]);
        // test the selection
        this.assertEquals(this.__P_230_3.getItem(4), this.__P_230_1.getSelection().getItem(0), "Selection does not work.");
      ...
      testDelegateBindItem: function testDelegateBindItem() {
        this.__P_230_2 = [true, true, false, true, false];
        // create a new array
        this.__P_230_3 = new qx.data.Array(this.__P_230_2);
        this.__P_230_1 = new qx.data.controller.List();
        var delegate = {};
      ...
      testSelectionSequence: function testSelectionSequence() {
        ...
        this.__P_230_0.addToSelection(this.__P_230_0.getChildren()[3]);
      ...
      testScrollBySelection: function testScrollBySelection() {
        ...
        var selectables = this.__P_230_0.getSelectables();

        // select the first item
        this.__P_230_0.setSelection([selectables[0]]);
        // scroll a bit down (scrollY is 40)
        this.__P_230_0.scrollByY(40);
        // select the current visible item
        this.__P_230_0.addToSelection(selectables[2]);
