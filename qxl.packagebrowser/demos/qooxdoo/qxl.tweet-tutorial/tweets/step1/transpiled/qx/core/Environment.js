  ...
  qx.Bootstrap.define("qx.core.Environment", {
    statics: {
      ...
      get: function get(key) {
        // check the cache
        if (this.__P_73_0[key] != undefined) {
          return this.__P_73_0[key];
        }
      ...
      getAsync: function getAsync(key, callback, self) {
        ...
        if (this.__P_73_0[key] != undefined) {
          ...
          window.setTimeout(function () {
            callback.call(self, env.__P_73_0[key]);
          }, 0);
          return;
        }
      ...
      select: function select(key, values) {
        return this.__P_73_1(this.get(key), values);
      },
      /**
      ...
      selectAsync: function selectAsync(key, values, self) {
        this.getAsync(key, function (result) {
          var value = this.__P_73_1(key, values);
       ...
       */
      __P_73_1: function __P_73_1(key, values) {
      ...
      add: function add(key, check) {
        ...
        if (this._checks[key] == undefined) {
          ...
          if (check instanceof Function) {
            ...
            this._checks[key] = this.__P_73_2(check);
          }
        }
      },
      /**
      ...
      set: qx.Bootstrap.getEnvironmentSetting("qx.environment.allowRuntimeMutations") ? function (key, value) {
        ...
        if (this.__P_73_3 === undefined) {
          ...
          this.__P_73_3 = Object.assign({}, this.__P_73_0);
          this.__P_73_4 = Object.assign({}, this._checks);
        }
        this.__P_73_0[key] = value;
      ...
      remove: qx.Bootstrap.getEnvironmentSetting("qx.environment.allowRuntimeMutations") ? function (key) {
        ...
        if (this.__P_73_3 === undefined || this.__P_73_3[key] === undefined) {
      ...
      reset: qx.Bootstrap.getEnvironmentSetting("qx.environment.allowRuntimeMutations") ? function (key) {
        ...
        if (key !== undefined && this.__P_73_3[key] === undefined) {
          throw new TypeError("Environment setting \"".concat(key, "\" does not exist."));
        }
        if (key === undefined) {
          // reset all keys
          this.__P_73_0 = Object.assign({}, this.__P_73_3);
          this._checks = Object.assign({}, this.__P_73_4);
          return;
        }
        // only reset the particular key 
        this.__P_73_0[key] = this.__P_73_3[key];
        this._checks[key] = this.__P_73_4[key];
      } : undefined,
      /**
      ...
      __P_73_5: function __P_73_5() {
        ...
        if (qx && qx.$$environment) {
          for (var key in qx.$$environment) {
            ...
            this._checks[key] = this.__P_73_2(value);
          }
        }
      },
      /**
