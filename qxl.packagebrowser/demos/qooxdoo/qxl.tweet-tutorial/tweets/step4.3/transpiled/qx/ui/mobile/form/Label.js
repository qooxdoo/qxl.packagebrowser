  ...
  qx.Class.define("qx.ui.mobile.form.Label", {
    ...
    */
    ...
    construct: function construct(value) {
      ...
      this.initWrap();
      {
        this.__P_470_0 = qx.locale.Manager.getInstance().addListener("changeLocale", this._onChangeLocale, this);
      }
    ...
    */
    ...
    members: {
      ...
      setLabelFor: function setLabelFor(elementId) {
        if (this.__P_470_1) {
          this.__P_470_1.removeListener("changeEnabled", this._changeEnabled, this);
        }
        this.__P_470_1 = qx.ui.mobile.core.Widget.getWidgetById(elementId);
        if (this.__P_470_1) {
          this.__P_470_1.addListener("changeEnabled", this._changeEnabled, this);
          this.setEnabled(this.__P_470_1.getEnabled());
        }
      ...
      _onTap: function _onTap(evt) {
        if (this.__P_470_1 && qx.core.Environment.get("event.dispatchevent")) {
          var target = this.__P_470_1.getContentElement();
    ...
    destruct: function destruct() {
      ...
      if (true && this.__P_470_0) {
        qx.locale.Manager.getInstance().removeListenerById(this.__P_470_0);
      }
    }
  });
