  ...
  qx.Class.define("qx.test.ui.decoration.LinearGradient", {
    ...
    members: {
      setUp: function setUp() {
        this.__P_289_0 = new qx.ui.core.Widget();
        this.__P_289_0.setHeight(100);
        this.__P_289_1 = new qx.ui.decoration.Decorator();
        this.__P_289_1.set({
          startColor: "red",
          endColor: "black"
        });
      ...
      testDefault: function testDefault() {
        ...
        this.__P_289_0.setDecorator(this.__P_289_1);
        this.flush();
      },
