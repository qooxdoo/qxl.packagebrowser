  ...
  qx.Class.define("qx.test.data.DataArray", {
    ...
    members: {
      ...
      testGetItem: function testGetItem() {
        ...
        this.assertEquals("three", this.__P_227_0.getItem(2), "IndexAt does not work at position 2");
      ...
      testReverse: function testReverse() {
        ...
        this.assertEquals("one", this.__P_227_0.getItem(2), "Reverse does not work");
      ...
      testSort: function testSort() {
        ...
        this.assertEquals("two three one", this.__P_227_0.join(" "), "Own sort does not work");
      ...
      testInsertAt: function testInsertAt() {
        ...
        this.__P_227_0.insertAt(3, "drei");
      ...
      testInsertBefore: function testInsertBefore() {
        ...
        this.__P_227_0.insertBefore("three", "drei");
      ...
      testInsertAfter: function testInsertAfter() {
        ...
        this.__P_227_0.insertAfter("two", "drei");
      ...
      testRemoveAt: function testRemoveAt() {
        var removed = this.__P_227_0.removeAt(1);
      ...
      testAppend: function testAppend() {
        ...
        this.__P_227_0.append(dArray.toArray());
      ...
      testForEach: function testForEach() {
        ...
        var forEachHandler = function forEachHandler(item, index, array) {
          ...
          self.assertEquals(self.__P_227_0, array);
        ...
        // invoke the forEach
        this.__P_227_0.forEach(forEachHandler, thisContext);
      ...
      testFind: function testFind() {
        var self = this;
        var found = this.__P_227_0.find(function (item, index, array) {
          self.assertEquals(self, this);
          self.assertString(item);
          self.assertNumber(index);
          self.assertEquals(self.__P_227_0.toArray(), array);
