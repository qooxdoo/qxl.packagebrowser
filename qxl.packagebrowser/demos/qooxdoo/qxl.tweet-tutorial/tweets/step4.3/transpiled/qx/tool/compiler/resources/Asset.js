...
(function () {
  ...
  qx.Class.define("qx.tool.compiler.resources.Asset", {
    ...
    construct: function construct(library, filename, fileInfo) {
      ...
      this.__P_612_0 = library;
      this.__filename = filename;
      this.__P_612_1 = fileInfo;
    },
    members: {
      ...
      getFileInfo: function getFileInfo() {
        return this.__P_612_1;
      },
      isThemeFile: function isThemeFile() {
        return this.__P_612_1.resourcePath == "themePath";
      },
      getSourceFilename: function getSourceFilename() {
        return path.relative(process.cwd(), this.isThemeFile() ? this.__P_612_0.getThemeFilename(this.__filename) : this.__P_612_0.getResourceFilename(this.__filename));
      },
      getDestFilename: function getDestFilename(target) {
        var filename = null;
        if (this.__P_612_3) {
          filename = this.__P_612_3[this.__P_612_3.length - 1].getDestFilename(target, this);
        }
      ...
      setLoaders: function setLoaders(loaders) {
        this.__P_612_2 = loaders.length ? loaders : null;
      },
      setConverters: function setConverters(converters) {
        this.__P_612_3 = converters.length ? converters : null;
      },
      addMetaReferee: function addMetaReferee(asset) {
        if (!this.__P_612_4) {
          this.__P_612_4 = [];
        }
        if (!qx.lang.Array.contains(this.__P_612_4, asset)) {
          this.__P_612_4.push(asset);
        }
      },
      getMetaReferees: function getMetaReferees() {
        return this.__P_612_4;
      },
      addMetaReferTo: function addMetaReferTo(asset) {
        if (!this.__P_612_5) {
          this.__P_612_5 = [];
        }
        if (!qx.lang.Array.contains(this.__P_612_5, asset)) {
          this.__P_612_5.push(asset);
        }
      },
      getMetaReferTo: function getMetaReferTo() {
        return this.__P_612_5;
      },
      setDependsOn: function setDependsOn(assets) {
        var _this = this;
        if (this.__P_612_6) {
          this.__P_612_6.forEach(function (thatAsset) {
            return delete thatAsset.__P_612_7[_this.getFilename];
          });
        }
        if (assets && assets.length) {
          this.__P_612_6 = assets;
          this.__P_612_1.dependsOn = assets.map(function (asset) {
            return asset.toUri();
          });
          assets.forEach(function (thatAsset) {
            if (!thatAsset.__P_612_7) {
              thatAsset.__P_612_7 = {};
            }
            thatAsset.__P_612_7[_this.getFilename()] = _this;
          });
        } else {
          this.__P_612_6 = null;
          delete this.__P_612_1.dependsOn;
        }
      },
      getDependsOn: function getDependsOn() {
        return this.__P_612_6;
      },
      getDependsOnThisAsset: function getDependsOnThisAsset() {
        return this.__P_612_7 ? Object.values(this.__P_612_7) : null;
      },
      load: function load() {
        var _this2 = this;
          ...
          return _regenerator().w(function (_context) {
            while (1) switch (_context.n) {
              case 0:
                ...
                _context.n = 1;
                return Promise.all(_this2.__P_612_2.map(function (loader) {
          ...
          return _regenerator().w(function (_context4) {
            while (1) switch (_context4.n) {
              case 0:
                ...
                _context4.n = 1;
                return qx.tool.utils.Promisify.some(_this3.__P_612_3, function (converter) {
              ...
              case 3:
                ...
                if (_this3.__P_612_6) {
                  _this3.__P_612_6.forEach(function (asset) {
              ...
              case 8:
                ...
                dependsOn = [];
                if (!(_this3.__P_612_3.length == 1)) {
                  _context4.n = 11;
                  break;
                }
                _context4.n = 9;
                return _this3.__P_612_3[0].convert(target, _this3, srcFilename, destFilename, _this3.isThemeFile());
              case 9:
                _t2 = _context4.v;
                if (_t2) {
                  _context4.n = 10;
              ...
              case 11:
                ...
                qx.tool.utils.Promisify.each(_this3.__P_612_3, /*#__PURE__*/function () {
                    ...
                    return _regenerator().w(function (_context3) {
                      while (1) switch (_context3.n) {
                        case 0:
                          ...
                          tmpDest = index === _this3.__P_612_3.length - 1 ? destFilename : path.join(require("os").tmpdir(), path.basename(srcFilename) + "-pass" + (index + 1) + "-");
                          _context3.n = 1;
      ...
      toUri: function toUri() {
        return this.__P_612_0.getNamespace() + ":" + this.__filename;
      },
