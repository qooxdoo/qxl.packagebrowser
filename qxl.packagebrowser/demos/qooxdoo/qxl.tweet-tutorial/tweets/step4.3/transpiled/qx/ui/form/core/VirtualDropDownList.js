  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.ui.form.core.VirtualDropDownList", {
    ...
    construct: function construct(target) {
      ...
      this.addListener("changeVisibility", this.__P_431_0, this);
      this.__P_431_1 = new qx.data.Array();
      this.initSelection(this.__P_431_1);
    },
    properties: {
      // overridden
      autoHide: {
    ...
    members: {
      ...
      */
      ...
      setPreselected: function setPreselected(modelItem) {
        ...
        this.__P_431_5(helper, listSelection);
        helper.dispose();
      ...
      */
       ...
       */
      __P_431_7: function __P_431_7(event) {
        if (this.__P_431_2) {
          return;
        }
        ...
        var listSelection = this.getChildControl("list").getSelection();
        this.__P_431_3 = true;
        this.__P_431_5(selection, listSelection);
        this.__P_431_3 = false;
        this.__P_431_2 = true;
        this.__P_431_5(listSelection, selection);
        this.__P_431_2 = false;
      },
      /**
      ...
      _onListChangeSelection: function _onListChangeSelection(event) {
        ...
        if (this.isVisible()) {
          ...
          this.__P_431_2 = true;
          this.__P_431_5(listSelection, this.getSelection());
          this.__P_431_2 = false;
        }
      },
      /**
      ...
      */
      ...
      _applySelection: function _applySelection(value, old) {
        value.addListener("change", this.__P_431_7, this);
        if (old != null) {
          old.removeListener("change", this.__P_431_7, this);
        }
        this.__P_431_5(value, this.getChildControl("list").getSelection(value));
      },
      /*
      ---------------------------------------------------------------------------
        HELPER METHODS
      ...
      */
       ...
       */
      __P_431_5: function __P_431_5(source, target) {
      ...
      _adjustWidth: function _adjustWidth() {
        ...
        if (this.getAllowGrowDropDown()) {
          ...
          this.setWidth(null);
          if (this.__P_431_4 > 0) {
            uiList.setWidth(this.__P_431_4);
          } else {
