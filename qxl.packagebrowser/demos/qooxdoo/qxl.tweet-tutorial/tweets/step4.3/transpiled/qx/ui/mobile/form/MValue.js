    ...
    */
    ...
    members: {
      ...
      _onChangeContent: function _onChangeContent(evt) {
        this.__P_467_3(this._convertValue(evt.getData()));
      },
      /**
      ...
      _onInput: function _onInput(evt) {
        ...
        if (this.getLiveUpdate()) {
          if (this._setValue) {
            ...
            this.__P_467_3(this._convertValue(data));
          }
        }
      },
      /**
       ...
       */
      __P_467_3: function __P_467_3(value) {
        if (this.__P_467_0 != value) {
          this.__P_467_0 = value;
