    ...
    members: {
      ...
      connectToWidget: function connectToWidget(widget) {
        ...
        if (widget) {
          ...
          if (this.__P_473_0) {
            for (var property in this.__P_473_0) {
              this.reset(property);
              this.set(property, this.__P_473_0[property]);
            }
          }
        } else {
          this.__P_473_0 = null;
      ...
      _getChildLayoutPropertyValue: function _getChildLayoutPropertyValue(widget, property) {
        var cache = this.__P_473_2(widget);
       ...
       *     Key / value pairs.
       */
      __P_473_2: function __P_473_2(widget) {
        if (!this.__P_473_1) {
          this.__P_473_1 = {};
        }
        var cache = this.__P_473_1;
