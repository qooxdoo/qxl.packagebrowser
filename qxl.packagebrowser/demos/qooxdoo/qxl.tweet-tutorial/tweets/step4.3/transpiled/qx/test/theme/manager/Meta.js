  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.test.theme.manager.Meta", {
    ...
    members: {
      __P_271_0: null,
      __P_271_1: null,
      __P_271_2: /(orange.*yellow|rgb\(255, 0, 0\).*rgb\(0, 0, 255\)|none|data:image\/png;base64,iVBORw0K)/,
      setUp: function setUp() {
        ...
        this.__P_271_0 = this.manager.getTheme();
        ...
        this.__P_271_1 = _objectSpread({}, listener[hash]);
        delete listener[hash];
        // add a theme able widget
        this.__P_271_3 = new qx.ui.form.Button("Foo").set({
          appearance: "test-button-gradient"
        });
        this.getRoot().add(this.__P_271_3);
        qx.ui.core.queue.Manager.flush();
      },
      tearDown: function tearDown() {
        this.__P_271_3.destroy();
        this.manager.setTheme(this.__P_271_0);
        this.__P_271_0 = null;
        var listener = qx.event.Registration.getManager(this.manager).getAllListeners();
        var hash = this.manager.$$hash || qx.core.ObjectRegistry.toHashCode(this.manager);
        listener[hash] = this.__P_271_1;
        this.__P_271_1 = null;
        qx.ui.core.queue.Manager.flush();
      },
      testAllThemeManagerChanged: function testAllThemeManagerChanged() {
        ...
        // button element
        var elem = this.__P_271_3.getContentElement().getDomElement();
        ...
        this.assertNotNull(qx.bom.element.Style.get(elem, "backgroundImage").match(this.__P_271_2));
        ...
        elem = this.__P_271_3.getChildControl("label").getContentElement().getDomElement();
