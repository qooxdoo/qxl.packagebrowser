(function () {
  ...
  ************************************************************************ */
  ...
  qx.Bootstrap.define("qx.bom.client.Pdfjs", {
    statics: {
      ...
      getPdfjs: function getPdfjs(callback, context) {
        qx.bom.client.Pdfjs.__P_40_0(callback, context);
      },
      /**
  ...
  (function () {
    ...
    // Expose to qooxdoo
    qx.bom.client.Pdfjs.__P_40_1 = function () {
