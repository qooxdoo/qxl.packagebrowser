  ...
  qx.Class.define("qx.ui.command.GroupManager", {
    ...
    members: {
      ...
      add: function add(group) {
        if (this.__P_367_0.includes(group)) {
          return false;
        }
        this.__P_367_0.push(group);
      ...
      remove: function remove(group) {
        var index = this.__P_367_0.indexOf(group);
        if (index === -1) {}
      ...
      block: function block() {
        if (this.__P_367_1) {
          this.__P_367_1.setActive(false);
        }
      },
      /**
