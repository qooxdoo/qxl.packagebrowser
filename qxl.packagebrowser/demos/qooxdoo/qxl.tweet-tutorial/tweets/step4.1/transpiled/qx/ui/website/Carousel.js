  ...
  qx.Bootstrap.define("qx.ui.website.Carousel", {
    ...
    members: {
      ...
      init: function init() {
        ...
        this.__P_562_2 = qxWeb.create("<div>").addClass(prefix + "-container").appendTo(this);
        this.__P_562_1 = qxWeb.create("<div>").addClass("qx-hbox").setStyle("height", "100%").appendTo(this.__P_562_2);
        this.__P_562_3 = [];
        this.__P_562_5 = qxWeb.create("<div>").addClasses([prefix + "-pagination", "qx-hbox", "qx-flex1"]).setStyle("visibility", "excluded").appendTo(this);
        if (this._ie9) {
          this.__P_562_1.setStyle("display", "table");
          this.__P_562_5.setStyle("textAlign", "center");
        } else {
      ...
      addPage: function addPage(child) {
        child.addClasses(["qx-flex1", this.getCssPrefix() + "-page"]).appendTo(this.__P_562_1);
        if (this.find("." + this.getCssPrefix() + "-page").length > this.__P_562_3.length) {
          var paginationLabel = this._createPaginationLabel();
          this.__P_562_3.push(paginationLabel);
          this.__P_562_5.append(paginationLabel);
        }
        this._updateWidth();
        if (!this.getActive()) {
        ...
        if (this._getPages().length === 3 && !this._ie9) {
          this.__P_562_2.translate([-this.getWidth() + "px", 0, 0]);
        }
      ...
      removePage: function removePage(child) {
        ...
        this.__P_562_3.splice(child.priorPosition, 1)[0].remove();
        for (var i = 0; i < this.__P_562_3.length; i++) {
          this.__P_562_3[i].getChildren(".label").setHtml(i + 1 + "");
        }
        this._updatePagination();
      },
      /**
      ...
      _update: function _update() {
        ...
        if (!this._ie9) {
          ...
          if (direction == "right") {
            left = this._getPositionLeft() - this.__P_562_2.getWidth();
          ...
          if (left !== undefined) {
            ...
            this.__P_562_2.translate([-left + "px", 0, 0]);
      ...
      _updateWidth: function _updateWidth() {
        ...
        this.__P_562_1.setStyle("width", containerWidth + "px");
      ...
      _onTrack: function _onTrack(e) {
        ...
        if (e.delta.axis == "x" && this._getPages().length > 2) {
          this.__P_562_2.translate([-(this.__P_562_4 - e.delta.x) + "px", 0, 0]);
        }
      },
      /**
      ...
      _onTrackEnd: function _onTrackEnd() {
        if (this.__P_562_4 == null || this.__P_562_6) {
        ...
        window.setTimeout(function () {
          if (this._getPages().length < 3 || this.__P_562_2.isPlaying()) {
            return;
          }
          this.__P_562_4 = null;
      ...
      _onPaginationLabelTap: function _onPaginationLabelTap(e) {
        this.__P_562_3.forEach(function (label, index) {
          if (label[0] === e.currentTarget) {
            ...
            this.__P_562_2.translate([-activeIndex * this.getWidth() + "px", 0, 0]);
            this.__P_562_6 = true;
            // animate to the desired page
            this._translateTo((activeIndex + distance) * this.getWidth());
            this.__P_562_2.once("animationEnd", function (page) {
              this.__P_562_6 = false;
      ...
      _updatePagination: function _updatePagination() {
        ...
        this._getPages().length < 2 ? this.__P_562_5.setStyle("visibility", "excluded") : this.__P_562_5.setStyle("visibility", "visible");
        this.__P_562_5.find("." + this.getCssPrefix() + "-pagination-label").removeClass("active");
        var pages = this._getPages();
        this.__P_562_3[pages.indexOf(this.getActive())].addClass("active");
      },
      /**
      ...
      _getPages: function _getPages() {
        return this.__P_562_1.find("." + this.getCssPrefix() + "-page");
      },
      /**
      ...
      _getPositionLeft: function _getPositionLeft() {
        var containerRect = this.__P_562_2[0].getBoundingClientRect();
