  ...
  qx.Class.define("qx.tool.compiler.app.Library", {
    ...
    members: {
      ...
      loadManifest: function loadManifest(loadFromDir) {
        if (this.__P_597_3) {
          return this.__P_597_3;
        }
        return this.__P_597_3 = this.__P_597_5(loadFromDir);
      },
      __P_597_5: function __P_597_5(loadFromDir) {
        var _this = this;
          ...
          return _regenerator().w(function (_context2) {
            while (1) switch (_context2.n) {
              ...
              case 6:
                ...
                _this.__P_597_4 = data.provides.fonts || {};
            ...
            async.each(filenames, function (filename, cb) {
              ...
              fs.stat(path.join(folder, filename), function (err, stat) {
                ...
                if (extension == ".js" || extension == ".ts") {
                  t.__P_597_0[className] = "class";
                  t.__P_597_1[className] = extension;
                  classes.push(className);
                } else {
                  t.__P_597_0[filename] = "resource";
                }
                if (Boolean(packageName) && !t.__P_597_0[packageName]) {
                  t.__P_597_0[packageName] = "package";
                  var pos;
                  tmp = packageName;
                  while ((pos = tmp.lastIndexOf(".")) > -1) {
                    tmp = tmp.substring(0, pos);
                    t.__P_597_0[tmp] = "package";
                  }
                }
                cb();
              });
      ...
      isFontAsset: function isFontAsset(filename) {
        ...
        if (filename.endsWith("svg")) {
          ...
          if (!isWebFont) {
            for (var fontId in this.__P_597_4) {
              var fontData = this.__P_597_4[fontId];
      ...
      getSymbolType: function getSymbolType(name) {
        ...
        var t = this;
        var type = this.__P_597_0[name];
        if (type) {
          return {
            symbolType: t.__P_597_0[name],
        ...
        var result = testEnvironment(this.__P_597_2[name]);
        if (result) {
          return result;
        }
        for (var key in this.__P_597_2) {
          var check = this.__P_597_2[key];
          if (check.startsWith) {
      ...
      isClass: function isClass(classname) {
        var type = this.__P_597_0[classname];
        return type === "class";
      },
      /**
      ...
      getSourceFileExtension: function getSourceFileExtension(className) {
        return this.__P_597_1[className];
      },
      /**
