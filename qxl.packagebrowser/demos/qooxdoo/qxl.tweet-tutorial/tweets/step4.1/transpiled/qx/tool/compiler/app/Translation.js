  ...
  qx.Class.define("qx.tool.compiler.app.Translation", {
    ...
    members: {
        ...
        return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
          ...
          return _regeneratorRuntime().wrap(function _callee$(_context) {
            while (1) switch (_context.prev = _context.next) {
              ...
              case 5:
                stat = _context.sent;
                if (!(stat && _this.__P_601_2 == stat.mtime)) {
                  _context.next = 8;
                  break;
                }
      ...
      read: function read() {
        ...
        return t.__P_601_3 = new Promise(function (resolve, reject) {
          t.__P_601_0 = {};
          t.__P_601_1 = {};
      ...
      writeTo: function writeTo(filename, cb) {
        ...
        for (var msgid in t.__P_601_0) {
          var entry = t.__P_601_0[msgid];
          if (entry.comments) {
      ...
      deleteEntry: function deleteEntry(id) {
        var entry = this.__P_601_0[id] || null;
        delete this.__P_601_0[id];
        return entry;
      },
      /**
      ...
      getOrCreateEntry: function getOrCreateEntry(id) {
        var t = this;
        var entry = t.__P_601_0[id];
        if (!entry) {
          entry = t.__P_601_0[id] = {
            msgid: id
          };
        }
        return entry;
