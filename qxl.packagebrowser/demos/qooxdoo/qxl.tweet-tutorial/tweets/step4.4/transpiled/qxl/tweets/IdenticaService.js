  ...
  qx.Class.define("qxl.tweets.IdenticaService", {
    ...
    members: {
      ...
      fetchTweets: function fetchTweets() {
        if (this.__P_603_0 === null) {
          var location = window.location;
          var url = location.origin + "/resource/qxl/tweets/service.js";
          this.__P_603_0 = new qx.data.store.Jsonp();
          this.__P_603_0.setCallbackName("callback");
          this.__P_603_0.setUrl(url);
          this.__P_603_0.bind("model", this, "tweets");
        } else {
          this.__P_603_0.reload();
        }
      },
      /**
       * @param message
