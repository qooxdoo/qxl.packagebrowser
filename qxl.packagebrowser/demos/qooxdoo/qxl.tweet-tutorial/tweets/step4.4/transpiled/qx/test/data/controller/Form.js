  ...
  qx.Class.define("qx.test.data.controller.Form", {
    ...
    members: {
      ...
      testUnidirectionalDeep: function testUnidirectionalDeep() {
        ...
        this.__P_228_0.add(this.__P_228_2, "label2", null, "a.tf2");
        ...
        this.assertEquals("affe", this.__P_228_1.getValue());
      ...
      testUnidirectionalOptions: function testUnidirectionalOptions() {
        ...
        this.assertEquals(null, this.__P_228_4.getTf1());

        // use the commit method
        c.updateModel();
        this.assertEquals("affea", this.__P_228_4.getTf1());
      ...
      testUnidirectional: function testUnidirectional() {
        ...
        // check if the other direction does not work
        this.__P_228_2.setValue("affee");
        this.assertEquals(null, this.__P_228_4.getTf2());

        // use the commit method
        c.updateModel();
        this.assertEquals("affee", this.__P_228_4.getTf2());
      ...
      testCreateWithModel: function testCreateWithModel() {
        // just create the controller
        var c = new qx.data.controller.Form(this.__P_228_4);
      ...
      testBindingChangeModel: function testBindingChangeModel() {
        ...
        this.assertEquals(this.__P_228_3.getValue(), model2.getCb());
      ...
      testBindingChangeForm: function testBindingChangeForm() {
        ...
        this.assertEquals(cb.getValue(), this.__P_228_4.getCb());
      ...
      testBindingModelSelection: function testBindingModelSelection() {
        ...
        // create the controller
        var c = new qx.data.controller.Form(model, this.__P_228_0);
      ...
      testModelCreation: function testModelCreation() {
        ...
        this.assertEquals(this.__P_228_3.getValue(), model.getCb());
