  ...
  qx.Class.define("qx.ui.root.Application", {
    ...
    */
    ...
    construct: function construct(doc) {
      // Symbolic links
      this.__P_501_0 = qx.dom.Node.getWindow(doc);
      this.__P_501_1 = doc;
      ...
      this.addListener("touchmove", this.__P_501_2, this);
    ...
    */
    ...
    members: {
      ...
      _computeSizeHint: function _computeSizeHint() {
        var width = qx.bom.Viewport.getWidth(this.__P_501_0);
        var height = qx.bom.Viewport.getHeight(this.__P_501_0);
        return {
          minWidth: width,
          width: width,
          maxWidth: width,
       ...
       */
      __P_501_2: function __P_501_2(e) {
