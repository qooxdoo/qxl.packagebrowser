  ...
  ************************************************************************ */
  ...
  qx.Bootstrap.define("qx.module.Blocker", {
    statics: {
       ...
       */
      __P_186_0: function __P_186_0(item, color, opacity, zIndex) {
        ...
        if (isDocument) {
          item.__P_186_1.div.insertBefore(qxWeb(win.document.body).getChildren(":first"));
        } else {
          item.__P_186_1.div.appendTo(win.document.body);
        }
        qx.module.Blocker.__P_186_2(item, color, opacity, zIndex, isDocument);
      },
      /**
       ...
       */
      __P_186_2: function __P_186_2(item, color, opacity, zIndex, isDocument) {
        ...
        item.__P_186_1.div.setStyles(styles);
      },
      /**
       ...
       */
      __P_186_3: function __P_186_3(item, index) {
        if (!item.__P_186_1) {
          return;
        }
        item.__P_186_1.div.remove();
      },
      /**
       ...
       */
      __P_186_4: function __P_186_4(collection) {
        var blockerElements = qxWeb();
        collection.forEach(function (item, index) {
          if (typeof item.__P_186_1 !== "undefined") {
            blockerElements = blockerElements.concat(item.__P_186_1.div);
          }
        });
    ...
    members: {
      ...
      block: function block(color, opacity, zIndex) {
        ...
        this.forEach(function (item, index) {
          qx.module.Blocker.__P_186_0(item, color, opacity, zIndex);
        });
        return this;
      },
      /**
      ...
      unblock: function unblock() {
        ...
        this.forEach(qx.module.Blocker.__P_186_3);
        return this;
      },
      /**
      ...
      getBlocker: function getBlocker() {
        ...
        var collection = qx.module.Blocker.__P_186_4(this);
        return collection;
      }
    },
