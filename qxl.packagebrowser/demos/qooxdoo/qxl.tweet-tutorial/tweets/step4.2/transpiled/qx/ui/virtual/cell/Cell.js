  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.ui.virtual.cell.Cell", {
    ...
    construct: function construct() {
      ...
      this.__P_540_0 = qx.ui.virtual.cell.CellStylesheet.getInstance();
      this.__P_540_1 = {};
      this.__P_540_2 = {};
      this.__P_540_3 = {};
      this.__P_540_4 = {};
    ...
    */
    ...
    members: {
      ...
      _storeStyle: function _storeStyle(propertyName, styles) {
        var store;
        if (this.__P_540_10) {
          store = this.__P_540_2;
        } else {
          store = this.__P_540_1;
        }
        if (styles === null) {
      ...
      _applyPadding: function _applyPadding(value, old, name) {
        var value = this._getValue(name);
        if (this.__P_540_10) {
          var paddingStore = this.__P_540_4;
        } else {
          paddingStore = this.__P_540_3;
        }
        if (value === null) {
      ...
      */
      ...
      getCssClasses: function getCssClasses(value, states) {
        var cssClass = this.__P_540_0.getCssClass(this.__P_540_9) || "";
       ...
       */
      __P_540_11: function __P_540_11(states) {
        ...
        if (this.__P_540_9 == statesKey) {
          return;
        }
        this.__P_540_9 = statesKey;
        var themeStyles = this.__P_540_5[this.__P_540_9];
        if (!themeStyles) {
          this.__P_540_12();
          this.__P_540_13(states);
          this.__P_540_14(states);
          this.__P_540_15();
          this.__P_540_5[this.__P_540_9] = 1;
        }
        this.__P_540_16();
      },
      /**
       ...
       * @param states {Object} A map containing the cell's state names as map keys.
       */
      __P_540_13: function __P_540_13(states) {
        this.__P_540_2 = {};
        ...
        this.__P_540_10 = false;
      },
      /**
       * Compute a CSS class for the current values of all CSS properties
       */
      __P_540_14: function __P_540_14() {
        var styleString = Object.values(this.__P_540_2).join(";");
        this.__P_540_0.computeClassForStyles(this.__P_540_9, styleString);
      },
      /**
       * Cache the themed values for the current state combination
       */
      __P_540_15: function __P_540_15() {
        var properties = this.__P_540_8;
        var PropertyUtil = qx.util.PropertyUtil;
        var themeValues = {};
        ...
        this.__P_540_6[this.__P_540_9] = themeValues;
      },
      /**
       * Apply the themed values to the properties
       */
      __P_540_16: function __P_540_16() {
        var PropertyUtil = qx.util.PropertyUtil;
        var themeValues = this.__P_540_6[this.__P_540_9] || {};
      ...
      getStyles: function getStyles(value, states) {
        return Object.values(this.__P_540_1).join(";");
      },
      // overridden
      getInsets: function getInsets(value, states) {
        var user = this.__P_540_3;
        var theme = this.__P_540_4;
    ...
    destruct: function destruct() {
      this.__P_540_0 = this.__P_540_1 = this.__P_540_2 = this.__P_540_3 = this.__P_540_4 = this.__P_540_5 = this.__P_540_6 = this.__P_540_8 = null;
    }
  });
