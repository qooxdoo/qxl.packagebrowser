  ...
  qx.Bootstrap.define("qx.bom.Html", {
    ...
    */
    ...
    statics: {
       ...
       */
      __P_471_0: function __P_471_0(all, front, tag) {
      ...
      fixEmptyTags: function fixEmptyTags(html) {
        return html.replace(/(<(\w+)[^>]*?)\/>/g, this.__P_471_0);
      },
      /**
       ...
       */
      __P_471_2: function __P_471_2(html, context) {
      ...
      clean: function clean(objs, context, fragment) {
        ...
        for (var i = 0, l = objs.length; i < l; i++) {
          ...
          if (typeof obj === "string") {
            obj = this.__P_471_2(obj, context);
          }
