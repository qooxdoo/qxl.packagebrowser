  ...
  qx.Bootstrap.define("qx.bom.Html", {
    ...
    */
    ...
    statics: {
       ...
       */
      __P_466_0: function __P_466_0(all, front, tag) {
      ...
      fixEmptyTags: function fixEmptyTags(html) {
        return html.replace(/(<(\w+)[^>]*?)\/>/g, this.__P_466_0);
      },
      /**
       ...
       */
      __P_466_2: function __P_466_2(html, context) {
      ...
      clean: function clean(objs, context, fragment) {
        ...
        for (var i = 0, l = objs.length; i < l; i++) {
          ...
          if (typeof obj === "string") {
            obj = this.__P_466_2(obj, context);
          }
