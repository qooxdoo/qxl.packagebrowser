  ...
  qx.Bootstrap.define("qx.core.WindowError", {
    ...
    */
    ...
    construct: function construct(failMessage, uri, lineNumber, columnNumber, sourceException) {
      ...
      this.__P_280_0 = failMessage;
      this.__P_280_1 = uri || "";
      this.__P_280_2 = lineNumber === undefined ? -1 : lineNumber;
      this.__P_280_3 = columnNumber === undefined ? -1 : columnNumber;
      this.__P_280_4 = sourceException;
    },
    /*
    *****************************************************************************
       MEMBERS
