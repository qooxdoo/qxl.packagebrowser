  ...
  qx.Class.define("qx.event.handler.Application", {
    ...
    */
    ...
    construct: function construct(manager) {
      ...
      this.__P_415_0 = false;
      this.__P_415_1 = false;
      this.__P_415_2 = false;
      this.__P_415_3 = false;
      this.__P_415_4 = false;
    ...
    members: {
      ...
      */
      ...
      __P_415_5: function __P_415_5() {
        ...
        if (!this.__P_415_2 && this.__P_415_0 && qx.$$loader.scriptLoaded) {
      ...
      */
      ...
      _onNativeLoad: function _onNativeLoad() {
        var callback = qx.core.Environment.select("qx.globalErrorHandling", {
          "true": qx.event.GlobalError.observeMethod(this.__P_415_7),
          "false": this.__P_415_7
        });
      ...
      _onNativeUnload: function _onNativeUnload() {
        var callback = qx.core.Environment.select("qx.globalErrorHandling", {
          "true": qx.event.GlobalError.observeMethod(this.__P_415_8),
          "false": this.__P_415_8
        });
        callback.apply(this, arguments);
      },
      /**
