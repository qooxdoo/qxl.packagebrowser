  ...
  qx.Class.define("qx.event.handler.ElementResize", {
    ...
    */
    ...
    construct: function construct(manager) {
      ...
      this.__P_488_0 = manager;
      this.__P_488_1 = {};
      this.__P_488_2 = new qx.event.Timer(200);
      this.__P_488_2.addListener("interval", this._onInterval, this);
    },
    /*
    *****************************************************************************
       STATICS
    ...
    */
    destruct: function destruct() {
      ...
      this._disposeObjects("__P_488_2");
    },
    /*
    *****************************************************************************
       DEFER
