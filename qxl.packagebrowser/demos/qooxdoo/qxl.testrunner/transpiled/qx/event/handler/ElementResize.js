  ...
  qx.Class.define("qx.event.handler.ElementResize", {
    ...
    */
    ...
    construct: function construct(manager) {
      ...
      this.__P_493_0 = manager;
      this.__P_493_1 = {};
      this.__P_493_2 = new qx.event.Timer(200);
      this.__P_493_2.addListener("interval", this._onInterval, this);
    },
    /*
    *****************************************************************************
       STATICS
    ...
    */
    destruct: function destruct() {
      ...
      this._disposeObjects("__P_493_2");
    },
    /*
    *****************************************************************************
       DEFER
