  ...
  qx.Class.define("qx.util.fsm.State", {
    ...
    construct: function construct(stateName, stateInfo) {
      ...
      for (var field in stateInfo) {
        ...
        switch (field) {
          case "onentry":
            this.setOnentry(this.__P_512_0(stateInfo[field], context));
            break;
          case "onexit":
            this.setOnexit(this.__P_512_0(stateInfo[field], context));
            break;
    ...
    members: {
       ...
       */
      __P_512_1: function __P_512_1(value) {
       ...
       * @throws {Error} when an invalid value is detected
       */
      __P_512_2: function __P_512_2(value) {
       ...
       * @throws {Error} when an invalid value is detected
       */
      __P_512_3: function __P_512_3(value) {
       ...
       * @throws {Error} when an invalid value is detected
       */
      __P_512_8: function __P_512_8(value) {
       ...
       * @return {var} the final value
       */
      __P_512_4: function __P_512_4(value) {
       ...
       * @return {var} the final value
       */
      __P_512_5: function __P_512_5(value) {
       ...
       * @return {var} the final value
       */
      __P_512_6: function __P_512_6(value) {
       ...
       * @return {var} the final value
       */
      __P_512_7: function __P_512_7(value) {
       ...
       *   unaltered.
       */
      __P_512_0: function __P_512_0(f, context) {
