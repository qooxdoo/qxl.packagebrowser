  ...
  qx.Class.define("qx.util.fsm.State", {
    ...
    construct: function construct(stateName, stateInfo) {
      ...
      for (var field in stateInfo) {
        ...
        switch (field) {
          case "onentry":
            this.setOnentry(this.__P_506_0(stateInfo[field], context));
            break;
          case "onexit":
            this.setOnexit(this.__P_506_0(stateInfo[field], context));
            break;
    ...
    members: {
       ...
       */
      __P_506_1: function __P_506_1(value) {
       ...
       * @throws {Error} when an invalid value is detected
       */
      __P_506_2: function __P_506_2(value) {
       ...
       * @throws {Error} when an invalid value is detected
       */
      __P_506_3: function __P_506_3(value) {
       ...
       * @throws {Error} when an invalid value is detected
       */
      __P_506_8: function __P_506_8(value) {
       ...
       * @return {var} the final value
       */
      __P_506_4: function __P_506_4(value) {
       ...
       * @return {var} the final value
       */
      __P_506_5: function __P_506_5(value) {
       ...
       * @return {var} the final value
       */
      __P_506_6: function __P_506_6(value) {
       ...
       * @return {var} the final value
       */
      __P_506_7: function __P_506_7(value) {
       ...
       *   unaltered.
       */
      __P_506_0: function __P_506_0(f, context) {
