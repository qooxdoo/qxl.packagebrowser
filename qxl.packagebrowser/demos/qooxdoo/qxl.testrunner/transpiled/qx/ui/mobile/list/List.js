  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.ui.mobile.list.List", {
    ...
    construct: function construct(delegate) {
      ...
      {
        this.__P_309_1 = qx.locale.Manager.getInstance().addListener("changeLocale", this._onChangeLocale, this);
      }
    },
    events: {
      /**
    ...
    members: {
      ...
      _onTrackStart: function _onTrackStart(evt) {
        ...
        if (element && qx.bom.element.Class.has(element, "list-item") && qx.bom.element.Class.has(element, "removable")) {
          this.__P_309_4 = element;
          this.__P_309_2 = qx.bom.element.Dimension.getWidth(element) / 2;
      ...
      _onTrack: function _onTrack(evt) {
        ...
        var element = this.__P_309_4;
        var delta = evt.getDelta();
        var deltaX = Math.round(delta.x * 0.1) / 0.1;
        if (this.__P_309_3 === null) {
          this.__P_309_3 = delta.axis == "x";
        }
        if (!this.__P_309_3) {
          return;
        }
        var opacity = 1 - Math.abs(deltaX) / this.__P_309_2;
      ...
      _onTrackEnd: function _onTrackEnd(evt) {
        ...
        var element = this.__P_309_4;
        if (Math.abs(evt.getDelta().x) > this.__P_309_2) {
      ...
      _applyModel: function _applyModel(value, old) {
        if (old != null) {
          old.removeListener("changeBubble", this.__P_309_5, this);
        }
        if (value != null) {
          value.addListener("changeBubble", this.__P_309_5, this);
        }
        if (old != null) {
          old.removeListener("change", this.__P_309_6, this);
        }
        if (value != null) {
          value.addListener("change", this.__P_309_6, this);
        }
        if (old != null) {
          old.removeListener("changeLength", this.__P_309_7, this);
        }
        if (value != null) {
          value.addListener("changeLength", this.__P_309_7, this);
        }
        this.__P_309_8();
      },
      // property apply
       ...
       */
      __P_309_7: function __P_309_7(evt) {
        this.__P_309_8();
      },
      /**
       ...
       */
      __P_309_9: function __P_309_9(index) {
      ...
      _renderGroup: function _renderGroup(itemIndex, groupIndex) {
        var group = this.__P_309_11(itemIndex);
        if (itemIndex === 0) {
          return this.__P_309_0.getGroupElement(group, groupIndex);
        } else {
          var previousGroup = this.__P_309_11(itemIndex - 1);
       ...
       */
      __P_309_10: function __P_309_10() {
       ...
       */
      __P_309_11: function __P_309_11(index) {
    ...
    destruct: function destruct() {
      ...
      if (true && this.__P_309_1) {
        qx.locale.Manager.getInstance().removeListenerById(this.__P_309_1);
      }
    }
  });
