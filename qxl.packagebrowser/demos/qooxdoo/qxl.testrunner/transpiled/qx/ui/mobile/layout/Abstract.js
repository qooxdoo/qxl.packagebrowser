    ...
    members: {
      ...
      connectToWidget: function connectToWidget(widget) {
        ...
        if (widget) {
          ...
          if (this.__P_476_0) {
            for (var property in this.__P_476_0) {
              this.reset(property);
              this.set(property, this.__P_476_0[property]);
            }
          }
        } else {
          this.__P_476_0 = null;
      ...
      _getChildLayoutPropertyValue: function _getChildLayoutPropertyValue(widget, property) {
        var cache = this.__P_476_2(widget);
       ...
       *     Key / value pairs.
       */
      __P_476_2: function __P_476_2(widget) {
        if (!this.__P_476_1) {
          this.__P_476_1 = {};
        }
        var cache = this.__P_476_1;
