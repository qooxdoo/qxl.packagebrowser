  ...
  qx.Class.define("qx.ui.mobile.list.renderer.Default", {
    ...
    members: {
      ...
      setImage: function setImage(source) {
        this.__P_328_0.setSource(source);
      },
      /**
      ...
      setTitle: function setTitle(title) {
        if (title && title.translate) {
          this.__P_328_1.setValue(title.translate());
        } else {
          this.__P_328_1.setValue(title);
        }
      },
      /**
      ...
      setSubtitle: function setSubtitle(subtitle) {
        if (subtitle && subtitle.translate) {
          this.__P_328_2.setValue(subtitle.translate());
        } else {
          this.__P_328_2.setValue(subtitle);
        }
      },
      /**
      ...
      _init: function _init() {
        this.__P_328_0 = this._createImage();
        this.add(this.__P_328_0);
        this.__P_328_3 = this._createRightContainer();
        this.add(this.__P_328_3, {
          flex: 1
        });
        this.__P_328_1 = this._createTitle();
        this.__P_328_3.add(this.__P_328_1);
        this.__P_328_2 = this._createSubtitle();
        this.__P_328_3.add(this.__P_328_2);
      },
      /**
      ...
      reset: function reset() {
        this.__P_328_0.setSource(null);
        this.__P_328_1.setValue("");
        this.__P_328_2.setValue("");
      }
    },
