  ...
  qx.Class.define("qx.ui.virtual.layer.Abstract", {
    ...
    */
    ...
    members: {
      ...
      syncWidget: function syncWidget(jobs) {
        ...
        if (this.__P_401_0.fullUpdate || this.__P_401_0.updateLayerWindow && this.__P_401_0.updateLayerData) {
          this._fullUpdate.apply(this, this.__P_401_1);
        } else if (this.__P_401_0.updateLayerWindow) {
          this._updateLayerWindow.apply(this, this.__P_401_1);
        } else if (this.__P_401_0.updateLayerData && this.__P_401_4) {
          this._updateLayerData();
        }
        if (this.__P_401_0.fullUpdate || this.__P_401_0.updateLayerWindow) {
          var args = this.__P_401_1;
          this.__P_401_2 = args[0];
          this.__P_401_3 = args[1];
          this.__P_401_4 = args[2];
          this.__P_401_5 = args[3];
        }
        this.__P_401_0 = {};
      },
      /**
      ...
      _updateLayerData: function _updateLayerData() {
        this._fullUpdate(this.__P_401_2, this.__P_401_3, this.__P_401_4, this.__P_401_5);
      },
      /**
    ...
    */
    destruct: function destruct() {
      this.__P_401_0 = this.__P_401_1 = this.__P_401_4 = this.__P_401_5 = null;
    }
  });
