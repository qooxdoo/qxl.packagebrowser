    ...
    members: {
      ...
      */
      ...
      _applyDecorator: function _applyDecorator(value, old) {
        ...
        this.__P_174_8(el, source);
      },
      // overridden
      _applyTextColor: function _applyTextColor(value) {
        if (this.__P_174_9() === "font") {
          var el = this.getContentElement();
          if (this.__P_174_5) {
            el = el.getChild(0);
          }
      ...
      */
       ...
       */
      __P_174_10: function __P_174_10(mode) {
        this.__P_174_3 = mode;
      },
      /**
       ...
       */
      __P_174_11: function __P_174_11(mode) {
        var scale;
        var tagName;
      ...
      __P_174_7: function __P_174_7() {
        ...
        var mode = this.__P_174_9();
        if (this.__P_174_0[mode] == null) {
          this.__P_174_0[mode] = this.__P_174_11(mode);
        }
      ...
      _styleSource: function _styleSource() {
        ...
        if (!source) {
          this.__P_174_12(element);
          return;
        }
        this.__P_174_13(source);
        ...
        var contentEl = this.__P_174_14();

        // Detect if the image registry knows this image
        if (ResourceManager.isFontUri(source)) {
          this.__P_174_15(contentEl, source);
          ...
          this.__P_174_18(contentEl, source);
        }
      },
      /**
       ...
       */
      __P_174_14: function __P_174_14() {
       ...
       */
      __P_174_13: qx.core.Environment.select("engine.name", {
        mshtml: function mshtml(source) {
          ...
          if (isFont) {
            this.__P_174_10("font");
          } else if (alphaImageLoader && isPng) {
            if (this.getScale() && this.__P_174_9() != "alphaScaled") {
              this.__P_174_10("alphaScaled");
            } else if (!this.getScale() && this.__P_174_9() != "nonScaled") {
              this.__P_174_10("nonScaled");
            }
          } else {
            if (this.getScale() && this.__P_174_9() != "scaled") {
              this.__P_174_10("scaled");
            } else if (!this.getScale() && this.__P_174_9() != "nonScaled") {
              this.__P_174_10("nonScaled");
            }
          }
          this.__P_174_19(this.__P_174_7());
        },
        "default": function _default(source) {
          var isFont = source && qx.lang.String.startsWith(source, "@");
          if (isFont) {
            this.__P_174_10("font");
          } else if (this.getScale() && this.__P_174_9() != "scaled") {
            this.__P_174_10("scaled");
          } else if (!this.getScale() && this.__P_174_9() != "nonScaled") {
            this.__P_174_10("nonScaled");
          }
       ...
       */
      __P_174_19: function __P_174_19(elementToAdd) {
       ...
       */
      __P_174_15: function __P_174_15(el, source) {
        var ResourceManager = qx.util.ResourceManager.getInstance();
        ...
        if (isFont) {
          ...
          if (this.getScale()) {
            ...
            var font = this.__P_174_20(source);
          ...
          this.__P_174_21(ResourceManager.getImageWidth(source), ResourceManager.getImageHeight(source));
        }
      },
      __P_174_22: function __P_174_22(el, width, height) {
        if (this.getScale()) {
      ...
      _applyDimension: function _applyDimension() {
        ...
        if (isFont) {
          ...
          if (el) {
            ...
            this.__P_174_22(el, width, height);
          }
        } else {
          this.__P_174_21();
        }
       ...
       * @param source {String} source path
       */
      __P_174_18: function __P_174_18(el, source) {
        var ImageLoader = qx.io.ImageLoader;
        // only try to load the image if it not already failed
        if (!ImageLoader.isFailed(source)) {
          ImageLoader.load(source, this.__P_174_23, this);
        } else {
          this.__P_174_12(el);
        }
      },
       ...
       * @param el {Element} image DOM element
       */
      __P_174_12: function __P_174_12(el) {
        if (el != null) {
      ...
      __P_174_20: function __P_174_20(source) {
       ...
       * @param source {String} source path
       */
      __P_174_8: function __P_174_8(el, source) {
        var isFont = source && qx.lang.String.startsWith(source, "@");
        if (isFont) {
          var ResourceManager = qx.util.ResourceManager.getInstance();
          var font = this.__P_174_20(source);
          ...
          this.__P_174_22(el, this.__P_174_1, this.__P_174_2);
       ...
       */
      __P_174_23: function __P_174_23(source, imageInfo) {
        ...
        // Update image
        this.__P_174_17(this.__P_174_14(), source);
      },
      /**
       ...
       */
      __P_174_21: function __P_174_21(width, height) {
        if (width === undefined) {
