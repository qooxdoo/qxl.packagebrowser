    ...
    */
    ...
    members: {
      ...
      getTable: function getTable() {
        return this.__P_494_1.getTable();
      },
      /**
      ...
      setPointerOverColumn: function setPointerOverColumn(col) {
        if (col != this.__P_494_3) {
          if (this.__P_494_3 != null) {
            var widget = this.getHeaderWidgetAtColumn(this.__P_494_3);
            if (widget != null) {
      ...
      showColumnMoveFeedback: function showColumnMoveFeedback(col, x) {
        ...
        if (this.__P_494_2 == null) {
          ...
          this.__P_494_2 = feedback;
        }
        this.__P_494_2.setLayoutProperties({
          left: pos.left + x
        });
        this.__P_494_2.show();
      },
