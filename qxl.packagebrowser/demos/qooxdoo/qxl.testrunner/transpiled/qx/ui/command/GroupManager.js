  ...
  qx.Class.define("qx.ui.command.GroupManager", {
    ...
    members: {
      ...
      add: function add(group) {
        if (this.__P_358_0.includes(group)) {
          return false;
        }
        this.__P_358_0.push(group);
      ...
      remove: function remove(group) {
        var index = this.__P_358_0.indexOf(group);
        if (index === -1) {}
      ...
      block: function block() {
        if (this.__P_358_1) {
          this.__P_358_1.setActive(false);
        }
      },
      /**
      ...
      _getGroup: function _getGroup(group) {
        ...
        return this.__P_358_0[index];
      }
    },
    destruct: function destruct() {
      this.__P_358_0 = this.__P_358_1 = null;
    }
  });
