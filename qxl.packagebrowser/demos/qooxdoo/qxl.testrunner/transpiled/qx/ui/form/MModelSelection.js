  ...
  ************************************************************************ */
  ...
  qx.Mixin.define("qx.ui.form.MModelSelection", {
    construct: function construct() {
      ...
      this.__P_462_0.addListener("change", this.__P_462_1, this);
      this.addListener("changeSelection", this.__P_462_2, this);
    },
    events: {
      /**
    ...
    members: {
       ...
       */
      __P_462_1: function __P_462_1() {
        this.__P_462_3 = true;
        var selectables = this.getSelectables(true);
        var itemSelection = [];
        var modelSelection = this.__P_462_0.toArray();
      ...
      setModelSelection: function setModelSelection(modelSelection) {
        ...
        modelSelection.unshift(this.__P_462_0.getLength()); // remove index
        modelSelection.unshift(0); // start index

        var returnArray = this.__P_462_0.splice.apply(this.__P_462_0, modelSelection);
        returnArray.dispose();
      }
    },
    destruct: function destruct() {
      this._disposeObjects("__P_462_0");
    }
  });
