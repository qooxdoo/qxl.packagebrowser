  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.locale.LocalizedString", {
    ...
    construct: function construct(translation, messageId, args, localized) {
      ...
      this.__P_303_0 = messageId;
      this.__P_303_1 = !!localized;
      this.__P_303_2 = args;
    },
    members: {
      __P_303_1: null,
      ...
      translate: function translate() {
        if (this.__P_303_1) {
          return qx.locale.Manager.getInstance().localize(this.__P_303_0, this.__P_303_2);
        }
        return qx.locale.Manager.getInstance().translate(this.__P_303_0, this.__P_303_2);
      },
      /**
