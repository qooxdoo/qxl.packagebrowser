  ...
  qx.Class.define("qx.io.jsonrpc.protocol.Request", {
    ...
    statics: {
      ...
      getCurrentId: function getCurrentId() {
        return qx.io.jsonrpc.protocol.Request.__P_297_0;
      },
      /**
       * Resets the request id to zero
       */
      resetId: function resetId() {
        qx.io.jsonrpc.protocol.Request.__P_297_0 = 0;
      }
    },
    properties: {
      /**
    ...
    construct: function construct(method, params, id) {
      ...
      if (id === undefined) {
        id = ++qx.io.jsonrpc.protocol.Request.__P_297_0;
      }
      this.set({
        id: id
      });
      this.__P_297_1 = new qx.Promise();
    },
    members: {
      __P_297_1: null,
      /**
      ...
      handleTransportException: function handleTransportException(exception) {
        this.__P_297_1.reject(exception);
      }
    }
  });
