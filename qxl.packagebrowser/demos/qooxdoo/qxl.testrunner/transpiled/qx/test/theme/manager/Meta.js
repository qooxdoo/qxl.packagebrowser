  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.test.theme.manager.Meta", {
    ...
    members: {
      __P_75_0: null,
      __P_75_1: null,
      __P_75_2: /(orange.*yellow|rgb\(255, 0, 0\).*rgb\(0, 0, 255\)|none|data:image\/png;base64,iVBORw0K)/,
      setUp: function setUp() {
        ...
        this.__P_75_1 = eventMgr.serializeListeners(this.manager);

        // Remove all listeners
        eventMgr.removeAllListeners(this.manager);

        // add a theme able widget
        this.__P_75_3 = new qx.ui.form.Button("Foo").set({
          appearance: "test-button-gradient"
        });
        this.getRoot().add(this.__P_75_3);
        qx.ui.core.queue.Manager.flush();
      },
      tearDown: function tearDown() {
        var _this = this;
        this.__P_75_3.destroy();
        this.manager.setTheme(this.__P_75_0);
        this.__P_75_0 = null;

        // Restore all listeners
        if (this.__P_75_1) {
          this.__P_75_1.forEach(function (entry) {
      ...
      testAllThemeManagerChanged: function testAllThemeManagerChanged() {
        ...
        // button element
        var elem = this.__P_75_3.getContentElement().getDomElement();
        ...
        this.assertNotNull(qx.bom.element.Style.get(elem, "backgroundImage").match(this.__P_75_2));
        ...
        elem = this.__P_75_3.getChildControl("label").getContentElement().getDomElement();
