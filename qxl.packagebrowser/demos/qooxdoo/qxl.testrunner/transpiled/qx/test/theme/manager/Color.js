  ...
  qx.Class.define("qx.test.theme.manager.Color", {
    ...
    members: {
      ...
      tearDown: function tearDown() {
        ...
        this.manager.setTheme(this.__P_71_0);
        this.__P_71_0 = null;

        // Restore all listeners
        if (this.__P_71_1) {
          this.__P_71_1.forEach(function (entry) {
