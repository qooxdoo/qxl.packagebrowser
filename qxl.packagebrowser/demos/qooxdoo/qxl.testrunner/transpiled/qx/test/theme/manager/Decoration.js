  ...
  qx.Class.define("qx.test.theme.manager.Decoration", {
    ...
    members: {
      ...
      tearDown: function tearDown() {
        ...
        this.manager.setTheme(this.__P_72_0);
        this.__P_72_0 = null;

        // Restore all listeners
        if (this.__P_72_1) {
          this.__P_72_1.forEach(function (entry) {
