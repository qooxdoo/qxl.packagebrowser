  ...
  qx.Class.define("qx.test.theme.manager.Font", {
    ...
    members: {
      ...
      tearDown: function tearDown() {
        ...
        this.manager.setTheme(this.__P_73_0);
        this.__P_73_0 = null;

        // Restore all listeners
        if (this.__P_73_1) {
          this.__P_73_1.forEach(function (entry) {
