  ...
  qx.Class.define("qx.test.theme.manager.Icon", {
    ...
    members: {
      ...
      tearDown: function tearDown() {
        ...
        this.manager.setTheme(this.__P_74_0);
        this.__P_74_0 = null;

        // Restore all listeners
        if (this.__P_74_1) {
          this.__P_74_1.forEach(function (entry) {
