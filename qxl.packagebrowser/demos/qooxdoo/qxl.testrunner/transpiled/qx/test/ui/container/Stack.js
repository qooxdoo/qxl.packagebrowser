  ...
  qx.Class.define("qx.test.ui.container.Stack", {
    ...
    members: {
      ...
      setUp: function setUp() {
        var stack = this.__P_85_0 = new qx.ui.container.Stack();
        var c1 = this.__P_85_1 = new qx.ui.container.Composite();
        var c2 = this.__P_85_2 = new qx.ui.container.Composite();
        var c3 = this.__P_85_3 = new qx.ui.container.Composite();
        c1.set({
          backgroundColor: "#F00",
          width: 200,
          height: 200
      ...
      tearDown: function tearDown() {
        this.__P_85_0.destroy();
        this.__P_85_1.destroy();
        this.__P_85_2.destroy();
        this.__P_85_3.destroy();
      },
      /**
      ...
      testAddAndSelectChild: function testAddAndSelectChild() {
        this.__P_85_0.add(this.__P_85_1);
        this.assertIdentical(this.__P_85_1, this.__P_85_0.getSelection()[0]);
      },
      /**
      ...
      testAddAndDontSelectChildInADynamicStack: function testAddAndDontSelectChildInADynamicStack() {
        this.__P_85_0.setDynamic(false);
        this.__P_85_0.add(this.__P_85_1);
        this.__P_85_0.add(this.__P_85_2);
        this.assertIdentical(this.__P_85_1, this.__P_85_0.getSelection()[0]);
        this.assertTrue(this.__P_85_2.isHidden());
      },
      /**
       * if stack has a selected child,
       * the new added one should be excluded/hide but not selected.
      ...
      testAddAndDontSelectChildInANonDynamicStack: function testAddAndDontSelectChildInANonDynamicStack() {
        this.__P_85_0.setDynamic(true);
        this.__P_85_0.add(this.__P_85_1);
        this.__P_85_0.add(this.__P_85_2);
        this.assertIdentical(this.__P_85_1, this.__P_85_0.getSelection()[0]);
        this.assertTrue(this.__P_85_2.isExcluded());
      },
      /**
      ...
      testRemoveSelectedChildSelectFirstOne: function testRemoveSelectedChildSelectFirstOne() {
        this.__P_85_0.add(this.__P_85_1);
        this.__P_85_0.add(this.__P_85_2);
        this.__P_85_0.setSelection([this.__P_85_2]);
        this.__P_85_0.remove(this.__P_85_2);
        this.assertIdentical(this.__P_85_1, this.__P_85_0.getSelection()[0]);
      },
      /**
      ...
      testRemoveSelectedChildResetSelection: function testRemoveSelectedChildResetSelection() {
        this.__P_85_0.add(this.__P_85_1);
        this.__P_85_0.add(this.__P_85_2);
        this.__P_85_0.add(this.__P_85_3);
        this.__P_85_0.remove(this.__P_85_1);
        this.__P_85_0.remove(this.__P_85_2);
        this.__P_85_0.remove(this.__P_85_3);
        this.assertArrayEquals([], this.__P_85_0.getSelection());
      }
    }
  });
