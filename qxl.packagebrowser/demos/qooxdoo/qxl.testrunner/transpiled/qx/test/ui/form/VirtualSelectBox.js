  ...
  qx.Class.define("qx.test.ui.form.VirtualSelectBox", {
    ...
    members: {
      setUp: function setUp() {
        this.__P_121_0 = new qx.ui.form.VirtualSelectBox();
      ...
      "test dropdown list same width as selectbox": function testDropdownListSameWidthAsSelectbox() {
        ...
        this.__P_121_0.setAllowGrowDropDown(false);
        this.__P_121_0.setModel(m);
        this.__P_121_0.setWidth(150);
        this.__P_121_0.open();
        this.flush();
        setTimeout(function () {
          test.assertIdentical(test.__P_121_0.getWidth(), test.__P_121_0.getBounds().width);
          test.assertIdentical(test.__P_121_0.getWidth(), test.__P_121_0.getChildControl("dropdown").getBounds().width);
          test.resume();
        }, 10);
        this.wait();
      },
      "test dropdown list wider than selectbox": function testDropdownListWiderThanSelectbox() {
        ...
        this.__P_121_0.setAllowGrowDropDown(true);
        this.__P_121_0.setModel(m);
        this.__P_121_0.setWidth(150);
        this.__P_121_0.open();
        this.flush();
        setTimeout(function () {
          test.assertIdentical(test.__P_121_0.getWidth(), test.__P_121_0.getBounds().width);
          test.assertTrue(test.__P_121_0.getChildControl("dropdown").getBounds().width > 666, "dropdown could not fit the whole item");
          test.resume();
        }, 10);
        this.wait();
      }
