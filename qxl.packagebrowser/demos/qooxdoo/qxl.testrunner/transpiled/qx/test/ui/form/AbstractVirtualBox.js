  ...
  qx.Class.define("qx.test.ui.form.AbstractVirtualBox", {
    ...
    members: {
      setUp: function setUp() {
        this.__P_94_0 = new qx.ui.form.VirtualSelectBox();
        this.getRoot().add(this.__P_94_0);
        this.__P_94_1 = new qx.ui.form.VirtualComboBox();
        this.getRoot().add(this.__P_94_1);
        this.flush();
      },
      ...
      testStatePopupOpen: function testStatePopupOpen() {
        this.__P_94_0.open();
        this.flush();
        this.assertTrue(this.__P_94_0.hasState("popupOpen"));
        this.__P_94_0.close();
        this.flush();
        this.assertFalse(this.__P_94_0.hasState("popupOpen"));
        this.__P_94_1.open();
        this.flush();
        this.assertTrue(this.__P_94_1.hasState("popupOpen"));
        this.__P_94_1.close();
        this.flush();
        this.assertFalse(this.__P_94_1.hasState("popupOpen"));
      },
      testListLengthAfterModelChangeSelectBox: function testListLengthAfterModelChangeSelectBox() {
        ...
        this.__P_94_0.setModel(model);
        this.__P_94_0.open();
        this.flush();
        var dropDown = this.__P_94_0.getChildControl("dropdown");
        ...
        this.__P_94_0.close();
        this.__P_94_0.resetModel();
      },
      testListLengthAfterModelChangeComboBox: function testListLengthAfterModelChangeComboBox() {
        var model = new qx.data.Array(["a", "b", "c"]);
        this.__P_94_1.setModel(model);
        this.__P_94_1.open();
        this.flush();
        var dropDown = this.__P_94_1.getChildControl("dropdown");
        var firstHeight = dropDown.getBounds().height;
        this.assertPositiveInteger(firstHeight);
        model.replace(["d", "e", "f", "g", "h", "j", "k", "l"]);
        this.flush();
