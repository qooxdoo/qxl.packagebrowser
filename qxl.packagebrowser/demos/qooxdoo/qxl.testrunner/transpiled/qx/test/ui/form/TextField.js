  ...
  qx.Class.define("qx.test.ui.form.TextField", {
    ...
    members: {
      ...
      "test: reset max length": function testResetMaxLength() {
        ...
        var l = this.__P_119_0.getMaxLength();
        this.assertEquals(4, l);
        this.__P_119_0.resetMaxLength();
        var l = this.__P_119_0.getMaxLength();
        this.assertEquals(Infinity, l);
      },
      "test: validate input with filter": function testValidateInputWithFilter() {
        this.__P_119_0.setFilter(/[0-9]/);
        var s = this.__P_119_0._validateInput("a");
        this.assertEquals("", s);
        var s = this.__P_119_0._validateInput("111");
        this.assertEquals("111", s);
      },
      "test: validate input with complex filter": function testValidateInputWithComplexFilter() {
        this.__P_119_0.setFilter(/^(\+|-)?\d*$/);
        var s = this.__P_119_0._validateInput("a");
        this.assertEquals("", s);
        var s = this.__P_119_0._validateInput("1");
        this.assertEquals("1", s);
        var s = this.__P_119_0._validateInput("-");
        this.assertEquals("-", s);
        var s = this.__P_119_0._validateInput("111");
        this.assertEquals("111", s);
        var s = this.__P_119_0._validateInput("-111");
        this.assertEquals("-111", s);
        var s = this.__P_119_0._validateInput("-11-1");
        this.assertEquals("", s);
      },
      "test: validate input with complex filter 2": function testValidateInputWithComplexFilter2() {
        this.__P_119_0.setFilter(/^xy$/);
        var s = this.__P_119_0._validateInput("x? y?");
        this.assertEquals("", s);
      },
      __P_119_0: null
    }
