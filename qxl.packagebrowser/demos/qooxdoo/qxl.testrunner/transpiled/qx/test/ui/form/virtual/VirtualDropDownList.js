  ...
  qx.Class.define("qx.test.ui.form.virtual.VirtualDropDownList", {
    ...
    members: {
      ...
      setUp: function setUp() {
        ...
        this.__P_123_0 = new qx.ui.form.core.AbstractVirtualBoxMock();
        this.__P_123_1 = new qx.ui.form.core.VirtualDropDownList(this.__P_123_0);
        this.__P_123_2 = this.__P_123_3();
        this.__P_123_1.getChildControl("list").setModel(this.__P_123_2);
        this.getRoot().add(this.__P_123_0);
      },
      tearDown: function tearDown() {
        qx.test.ui.form.virtual.VirtualDropDownList.superclass.prototype.tearDown.call(this);
        this.__P_123_0.destroy();
        this.__P_123_1.destroy();
        this.__P_123_0 = null;
        this.__P_123_1 = null;
        this.__P_123_2.dispose();
        this.__P_123_2 = null;
      },
      ...
      testCreation: function testCreation() {
        var model = this.__P_123_2;
        var listModel = this.__P_123_1.getChildControl("list").getModel();
        this.assertEquals(model, listModel, "Model instance not equals!");
        this.__P_123_4(model);
      },
      testCreationWithSorter: function testCreationWithSorter() {
        var sortedModel = this.__P_123_5();
        this.__P_123_4(sortedModel);
        sortedModel.dispose();
      },
      testCreationWithFilter: function testCreationWithFilter() {
        var filteredModel = this.__P_123_6();
        this.__P_123_4(filteredModel);
        filteredModel.dispose();
      },
      __P_123_4: function __P_123_4(model) {
        var list = this.__P_123_1.getChildControl("list");
        this.assertModelEqualsRowData(model, list);
        this.__P_123_7(model.getItem(0));
      },
      testSelection: function testSelection() {
        this.__P_123_8(this.__P_123_2);
      },
      testSelectionWithSorter: function testSelectionWithSorter() {
        var sortedModel = this.__P_123_5();
        this.__P_123_8(sortedModel);
        sortedModel.dispose();
      },
      testSelectionWithFilter: function testSelectionWithFilter() {
        ...
        this.__P_123_4(filteredModel);
        var model = this.__P_123_2;
        var selection = this.__P_123_1.getSelection();
        var invalidItem = model.getItem(2);
        this.assertFalse(filteredModel.contains(invalidItem));
        var that = this;
        this.__P_123_9(selection, function () {
          selection.push(invalidItem);
        }, 2);
        this.__P_123_7(filteredModel.getItem(0));
        filteredModel.dispose();
      },
      __P_123_8: function __P_123_8(model) {
        var selection = this.__P_123_1.getSelection();
        var that = this;
      ...
      __P_123_7: function __P_123_7(item) {
        this.assertTrue(this.__P_123_2.contains(item), "The itme '" + item + "' is not in the model!");
        var modelIndex = this.__P_123_2.indexOf(item);
        var selection = this.__P_123_1.getSelection();
        var listSelection = this.__P_123_1.getChildControl("list").getSelection();
        this.assertEquals(1, selection.getLength(), "Selection length not equals!");
        this.assertEquals(this.__P_123_2.getItem(modelIndex), selection.getItem(0), "Selection instance not equals!");
      ...
      __P_123_9: function __P_123_9(target, callback, fired) {
        var count = 0;
      ...
      __P_123_5: function __P_123_5() {
        ...
        this.__P_123_1.getChildControl("list").setDelegate({
          sorter: sorter
        });
        var sortedModel = this.__P_123_2.copy();
      ...
      __P_123_6: function __P_123_6() {
        ...
        for (var i = 0; i < this.__P_123_2.getLength(); i++) {
          var item = this.__P_123_2.getItem(i);
          if (filter(item)) {
