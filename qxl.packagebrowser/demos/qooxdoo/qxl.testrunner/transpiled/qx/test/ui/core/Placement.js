  ...
  qx.Class.define("qx.test.ui.core.Placement", {
    ...
    members: {
      ...
      setUp: function setUp() {
        this.__P_89_0 = new qx.ui.core.Widget().set({
          backgroundColor: "red",
          width: 100,
          height: 300
        });
        this.getRoot().add(this.__P_89_0, {
          left: 150
        });

        // set the always visible element
        qx.ui.core.MPlacement.setVisibleElement(this.__P_89_0);
      },
      ...
      __P_89_3: function __P_89_3(w) {
        // force an addition to the dom!
        w.show();
        w.hide();
        this.__P_89_0.setLayoutProperties({
          top: 100
        });
