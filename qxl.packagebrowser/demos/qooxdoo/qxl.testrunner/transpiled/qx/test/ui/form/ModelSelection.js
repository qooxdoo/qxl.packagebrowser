(function () {
  ...
  ************************************************************************ */
  qx.Class.define("qx.test.ui.form.ModelSelection", {
    ...
    members: {
      __P_108_0: function __P_108_0(widget, children) {
      ...
      __P_108_1: function __P_108_1(widget, children) {
        var children = children || widget.getChildren();
      ...
      __P_108_2: function __P_108_2(widget, children) {
        var children = children || widget.getChildren();
      ...
      __P_108_3: function __P_108_3(widget, children) {
        var children = children || widget.getChildren();
      ...
      __P_108_5: function __P_108_5(widget) {
        for (var i = 0; i < 3; i++) {
      ...
      __P_108_8: function __P_108_8(widget) {
        for (var i = 0; i < 3; i++) {
      ...
      __P_108_11: function __P_108_11(box) {
      ...
      testListGetSingle: function testListGetSingle() {
        var list = this.__P_108_6();
        this.__P_108_0(list);
        this.__P_108_11(list);
      },
      ...
      testTreeGetSingle: function testTreeGetSingle() {
        var widget = this.__P_108_10();
        var children = widget.getItems(true);
        this.__P_108_0(widget, children);
        widget.destroy();
      },
      testTreeSetSingle: function testTreeSetSingle() {
        var widget = this.__P_108_10();
        var children = widget.getItems(true);
        this.__P_108_2(widget, children);
        widget.destroy();
      },
      testTreeGetMulti: function testTreeGetMulti() {
        ...
        var children = widget.getItems(true);
        this.__P_108_1(widget, children);
        widget.destroy();
      },
      testTreeSetMulti: function testTreeSetMulti() {
        ...
        widget.setSelectionMode("multi");
        var children = widget.getItems(true);
        this.__P_108_3(widget, children);
        widget.destroy();
      }
    }
  });
