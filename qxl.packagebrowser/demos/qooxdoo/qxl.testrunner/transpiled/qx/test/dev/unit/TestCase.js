  ...
  qx.Class.define("qx.test.dev.unit.TestCase", {
    ...
    members: {
      ...
      testResumeHandler: function testResumeHandler() {
        this.__P_44_0(this.resumeHandler(function (param) {
          this.assertEquals(param, "foo");
          return "bar";
        }, this));
        this.wait();
      },
      __P_44_0: function __P_44_0(callback) {
        window.setTimeout(this.__P_44_1.bind(this, callback), 0);
      },
      __P_44_1: function __P_44_1(callback) {
