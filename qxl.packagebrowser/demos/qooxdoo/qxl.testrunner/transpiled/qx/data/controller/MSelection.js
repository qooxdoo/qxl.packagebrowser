    ...
    */
    construct: function construct() {
      ...
      if (this.getSelection() == null) {
        this.__P_459_0 = new qx.data.Array();
        this.setSelection(this.__P_459_0);
      }
    },
    /*
    *****************************************************************************
    ...
    members: {
      ...
      */
      ...
      _applySelection: function _applySelection(value, old) {
        ...
        if (this.__P_459_2 != undefined && old != undefined) {
          old.removeListenerById(this.__P_459_2);
          this.__P_459_2 = null;
        }
        // add a new change listener to the changeArray
        if (value) {
          this.__P_459_2 = value.addListener("change", this.__P_459_3, this);
        }
      ...
      */
      ...
      _changeTargetSelection: function _changeTargetSelection() {
        ...
        if (!this.__P_459_4() && !this.__P_459_5()) {
          return;
        }
      ...
      */
      ...
      _addChangeTargetListener: function _addChangeTargetListener(value, old) {
        ...
        if (this.__P_459_1 != undefined && old != undefined) {
          old.removeListenerById(this.__P_459_1);
        }
        if (value != null) {
          // if a selection API is supported
          if (this.__P_459_4() || this.__P_459_5()) {
            // add a new selection listener
            this.__P_459_1 = value.addListener("changeSelection", this._changeTargetSelection, this);
          }
        }
      },
      /**
      ...
      _updateSelection: function _updateSelection() {
        ...
        if (this.__P_459_4()) {
          ...
          for (var i = 0; i < this.getSelection().length; i++) {
            ...
            var selectable = this.__P_459_6(model);
            if (selectable != null) {
       ...
       */
      __P_459_7: function __P_459_7(item) {
        var selectable = this.__P_459_6(item);
       ...
       */
      __P_459_6: function __P_459_6(model) {
        // get all list items
