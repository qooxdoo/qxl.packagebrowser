  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.dev.unit.MeasurementResult", {
    ...
    construct: function construct(message, iterations, ownTime, renderTime) {
      this.__P_482_0 = message;
      this.__P_482_1 = iterations;
      this.__P_482_2 = ownTime;
      this.__P_482_3 = renderTime;
    },
    members: {
      __P_482_0: null,
      __P_482_1: null,
      ...
      getData: function getData() {
        return {
          message: this.__P_482_0,
          iterations: this.__P_482_1,
          ownTime: this.__P_482_2,
          renderTime: this.__P_482_3
        };
      },
      /**
      ...
      toString: function toString() {
        return ["Measured: " + this.__P_482_0, "Iterations: " + this.__P_482_1, "Time: " + this.__P_482_2 + "ms", "Render time: " + this.__P_482_3 + "ms"].join("\n");
      }
    }
  });
