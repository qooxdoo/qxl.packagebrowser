  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.dev.unit.MeasurementResult", {
    ...
    construct: function construct(message, iterations, ownTime, renderTime) {
      this.__P_477_0 = message;
      this.__P_477_1 = iterations;
      this.__P_477_2 = ownTime;
      this.__P_477_3 = renderTime;
    },
    members: {
      __P_477_0: null,
      __P_477_1: null,
      ...
      getData: function getData() {
        return {
          message: this.__P_477_0,
          iterations: this.__P_477_1,
          ownTime: this.__P_477_2,
          renderTime: this.__P_477_3
        };
      },
      /**
      ...
      toString: function toString() {
        return ["Measured: " + this.__P_477_0, "Iterations: " + this.__P_477_1, "Time: " + this.__P_477_2 + "ms", "Render time: " + this.__P_477_3 + "ms"].join("\n");
      }
    }
  });
