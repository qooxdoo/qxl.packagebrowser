  ...
  ************************************************************************ */
  ...
  qx.Mixin.define("qx.dev.unit.MMock", {
    construct: function construct() {
      var sinon = this.__P_204_0();
      this.__P_204_1();
      this.__P_204_2 = sinon.createSandbox();
    },
    members: {
      __P_204_2: null,
      __P_204_3: null,
      ...
      spy: function spy(function_or_object, method) {
        return this.__P_204_2.spy.apply(this.__P_204_2, arguments);
      },
      /**
      ...
      stub: function stub(object, method, func) {
        var res = this.__P_204_2.stub.bind(this.__P_204_2)(object, method);
      ...
      useFakeXMLHttpRequest: function useFakeXMLHttpRequest() {
        return this.__P_204_3 = this.__P_204_2.useFakeServer();
      },
      /**
      ...
      getRequests: function getRequests() {
        return this.__P_204_3.requests;
      },
      /**
      ...
      deepStub: function deepStub(object) {
        this.__P_204_4(object).forEach(function (prop) {
          this.__P_204_5(object, prop);
        }, this);
        return object;
      },
      /**
      ...
      shallowStub: function shallowStub(object, targetClazz, propsToExclude) {
        this.__P_204_4(object, targetClazz).forEach(function (prop) {
      ...
      revealMock: function revealMock(object, property, customObject) {
        var source = customObject || this.__P_204_6(new object[property]());
       ...
       */
      __P_204_6: function __P_204_6(obj) {
        var clone = {};
       ...
       */
      __P_204_4: function __P_204_4(object, targetClazz) {
       ...
       */
      __P_204_5: function __P_204_5(object, prop) {
