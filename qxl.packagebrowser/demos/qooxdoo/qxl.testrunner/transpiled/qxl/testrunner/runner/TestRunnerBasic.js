    ...
    */
    ...
    members: {
      ...
      runTests: function runTests() {
        ...
        var testResult = this.__P_414_2(currentTest);
        window.setTimeout(function () {
      ...
      __P_414_2: function __P_414_2() {
        ...
        testResult.addListener("startTest", function (e) {
          ...
          if (!this.__P_414_0.includes(this.currentTestData.fullName)) {
            this.view.addTestResult(this.currentTestData);
            this.__P_414_0.push(this.currentTestData.fullName);
          }
        }, this);
      ...
      _onTestFailure: function _onTestFailure(ev) {
        this.__P_414_3(this.currentTestData, ev.getData());
       ...
       */
      __P_414_3: function __P_414_3(testResult, exceptions) {
