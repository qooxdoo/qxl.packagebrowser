  ...
  qx.Bootstrap.define("qx.ui.website.DatePicker", {
    ...
    members: {
      ...
      setConfig: function setConfig(name, config) {
        if (name === "position") {
          var validPositions = qx.ui.website.DatePicker.__P_555_0;
       ...
       */
      __P_555_1: function __P_555_1(collection) {
       ...
       * @param collection {qxWeb} collection to work on
       */
      __P_555_2: function __P_555_2(collection) {
        var icon;
       ...
       * @param collection {qxWeb} collection to work on
       */
      __P_555_3: function __P_555_3(collection) {
    ...
    defer: function defer(statics) {
      ...
      statics.__P_555_0 = ["top-left", "top-center", "top-right", "bottom-left", "bottom-center", "bottom-right", "left-top", "left-middle", "left-bottom", "right-top", "right-middle", "right-bottom"];
    }
  });
