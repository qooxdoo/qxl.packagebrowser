  ...
  qx.Bootstrap.define("qx.ui.website.DatePicker", {
    ...
    members: {
      ...
      setConfig: function setConfig(name, config) {
        if (name === "position") {
          var validPositions = qx.ui.website.DatePicker.__P_562_0;
       ...
       */
      __P_562_1: function __P_562_1(collection) {
       ...
       * @param collection {qxWeb} collection to work on
       */
      __P_562_2: function __P_562_2(collection) {
        var icon;
       ...
       * @param collection {qxWeb} collection to work on
       */
      __P_562_3: function __P_562_3(collection) {
    ...
    defer: function defer(statics) {
      ...
      statics.__P_562_0 = ["top-left", "top-center", "top-right", "bottom-left", "bottom-center", "bottom-right", "left-top", "left-middle", "left-bottom", "right-top", "right-middle", "right-bottom"];
    }
  });
