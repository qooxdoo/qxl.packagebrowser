    ...
    members: {
      ...
      */
      ...
      handlePointerDown: function handlePointerDown(event) {
        ...
        if (this.getDrag() && mode !== "single" && mode !== "one" && !isShiftPressed && !isCtrlPressed && event.getPointerType() == "mouse") {
          ...
          this.__P_395_4 = this._getScroll();

          // Store position at start
          this.__P_395_8 = event.getDocumentLeft() + this.__P_395_4.left;
          this.__P_395_9 = event.getDocumentTop() + this.__P_395_4.top;
      ...
      handlePointerMove: function handlePointerMove(event) {
        ...
        this.__P_395_12 = event.getDocumentTop();
      ...
      */
      ...
      _onInterval: function _onInterval(e) {
        ...
        this._scrollBy(this.__P_395_1, this.__P_395_2);
      ...
      _autoSelect: function _autoSelect() {
        ...
        var relY = Math.max(0, Math.min(this.__P_395_12 - this.__P_395_7.top, inner.height)) + this.__P_395_4.top;
