    ...
    members: {
      ...
      placeToWidget: function placeToWidget(target, liveupdate) {
        ...
        if (liveupdate) {
          ...
          qx.event.Idle.getInstance().addListener("interval", this.__P_380_2);
      ...
      placeToElement: function placeToElement(elem, liveupdate) {
        ...
        if (liveupdate) {
          ...
          this.addListener("disappear", function () {
            if (_this.__P_380_2) {
              qx.event.Idle.getInstance().removeListener("interval", _this.__P_380_2);
              _this.__P_380_2 = null;
            }
          });
        }
        this._place(coords);
