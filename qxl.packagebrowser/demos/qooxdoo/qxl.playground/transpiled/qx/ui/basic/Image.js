      ...
      */
      ...
      __P_362_15: function __P_362_15(el, source) {
        ...
        if (isFont) {
          ...
          if (this.getScale()) {
            ...
            var font = this.__P_362_20(source);
          ...
          this.__P_362_21(ResourceManager.getImageWidth(source), ResourceManager.getImageHeight(source));
        }
      },
      __P_362_22: function __P_362_22(el, width, height) {
        if (this.getScale()) {
      ...
      _applyDimension: function _applyDimension() {
        ...
        if (isFont) {
          ...
          if (el) {
            ...
            this.__P_362_22(el, width, height);
          }
        } else {
          this.__P_362_21();
        }
      ...
      __P_362_18: function __P_362_18(el, source) {
        ...
        if (!ImageLoader.isFailed(source)) {
          ImageLoader.load(source, this.__P_362_23, this);
        } else {
          this.__P_362_12(el);
        }
      },
      ...
      __P_362_20: function __P_362_20(source) {
      ...
      __P_362_8: function __P_362_8(el, source) {
        ...
        if (isFont) {
          ...
          this.__P_362_22(el, this.__P_362_1, this.__P_362_2);
       ...
       */
      __P_362_23: function __P_362_23(source, imageInfo) {
       ...
       */
      __P_362_21: function __P_362_21(width, height) {
        if (width === undefined) {
    ...
    destruct: function destruct() {
      for (var mode in this.__P_362_0) {
        if (this.__P_362_0.hasOwnProperty(mode)) {
          this.__P_362_0[mode].disconnectObject(this);
        }
      }
