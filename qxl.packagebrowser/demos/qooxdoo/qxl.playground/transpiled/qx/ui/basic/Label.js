      ...
      */
      ...
      _applyFont: function _applyFont(value, old) {
        ...
        if (value) {
          ...
          if (this.__P_363_0 instanceof qx.bom.webfonts.WebFont && !this.__P_363_0.isValid()) {
            this.__P_363_3 = this.__P_363_0.addListener("changeStatus", function (evt) {
              if (evt.getData().valid) {
                _this.__P_363_1 = true;
