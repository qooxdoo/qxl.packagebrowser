    ...
    members: {
      ...
      __P_497_11: function __P_497_11(orientation) {
        ...
        splitter.addListener("resize", function (e) {
          ...
          if (_this.getChildControl("splitter").isKnobVisible() && (bounds.height == 0 || bounds.width == 0)) {
            _this.__P_497_1.hide();
          } else {
            _this.__P_497_1.show();
          }
        });
      },
      /**
      ...
      */
      ...
      _applyOrientation: function _applyOrientation(value, old) {
        ...
        // update the blocker
        this.__P_497_1.setOrientation(value);
      ...
      */
      ...
      _onPointerDown: function _onPointerDown(e) {
        ...
        this.__P_497_2 = this.__P_497_6 ? e.getDocumentLeft() - splitterLocation.left + paneLocation.left : e.getDocumentTop() - splitterLocation.top + paneLocation.top;
