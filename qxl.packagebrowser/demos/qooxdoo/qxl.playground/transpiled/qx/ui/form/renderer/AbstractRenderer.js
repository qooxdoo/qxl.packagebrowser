  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.ui.form.renderer.AbstractRenderer", {
    ...
    construct: function construct(form) {
      ...
      // translation support
      {
        this.__P_433_0 = qx.locale.Manager.getInstance().addListener("changeLocale", this._onChangeLocale, this);
        this._names = [];
      }
      this._form = form;
      this._render();
    ...
    */
    destruct: function destruct() {
      if (true && this.__P_433_0) {
        qx.locale.Manager.getInstance().removeListenerById(this.__P_433_0);
      }
      this._names = null;
