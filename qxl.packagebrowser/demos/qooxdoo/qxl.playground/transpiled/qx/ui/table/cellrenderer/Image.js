  ...
  qx.Class.define("qx.ui.table.cellrenderer.Image", {
    ...
    */
    ...
    construct: function construct(width, height) {
      ...
      if (width) {
        this.__P_512_0 = width;
      }
      if (height) {
        this.__P_512_1 = height;
      }
      this.__P_512_2 = qx.util.AliasManager.getInstance();
    },
    /*
    *****************************************************************************
       MEMBERS
    ...
    */
    ...
    members: {
      ...
      _identifyImage: function _identifyImage(cellInfo) {
        var imageHints = {
          imageWidth: this.__P_512_0,
          imageHeight: this.__P_512_1
        };
        if (cellInfo.value == "") {
          imageHints.url = null;
        } else {
          imageHints.url = this.__P_512_2.resolve(cellInfo.value);
        }
