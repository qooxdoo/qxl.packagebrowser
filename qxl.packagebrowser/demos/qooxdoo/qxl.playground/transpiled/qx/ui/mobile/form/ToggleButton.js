  ...
  qx.Class.define("qx.ui.mobile.form.ToggleButton", {
    ...
    construct: function construct(value, labelChecked, labelUnchecked) {
      ...
      if (labelChecked && labelUnchecked) {
        this.__P_470_0 = labelUnchecked;
        this.__P_470_1 = labelChecked;
      }
      this._setAttribute("data-label-checked", this.__P_470_1);
      this._setAttribute("data-label-unchecked", this.__P_470_0);
      this.__P_470_2 = this._createSwitch();
      this._add(this.__P_470_2);
      if (value) {
        this.setValue(value);
      }
    ...
    members: {
      ...
      _onSwipe: function _onSwipe(evt) {
        if (this._checkLastPointerTime()) {
          ...
          if (direction == "left") {
            if (this.__P_470_3 == true) {
              this.toggle();
            }
          } else {
            if (this.__P_470_3 == false) {
              this.toggle();
            }
          }
        }
      ...
      _checkLastPointerTime: function _checkLastPointerTime() {
        var elapsedTime = new Date().getTime() - this.__P_470_4;
        this.__P_470_4 = new Date().getTime();
    ...
    destruct: function destruct() {
      ...
      this._disposeObjects("__P_470_2", "__P_470_0", "__P_470_1");
    }
  });
