    ...
    members: {
      ...
      connectToWidget: function connectToWidget(widget) {
        ...
        if (widget) {
          ...
          if (this.__P_477_0) {
            for (var property in this.__P_477_0) {
              this.reset(property);
              this.set(property, this.__P_477_0[property]);
            }
          }
        } else {
          this.__P_477_0 = null;
      ...
      _getChildLayoutPropertyValue: function _getChildLayoutPropertyValue(widget, property) {
        var cache = this.__P_477_2(widget);
       ...
       *     Key / value pairs.
       */
      __P_477_2: function __P_477_2(widget) {
        if (!this.__P_477_1) {
          this.__P_477_1 = {};
        }
        var cache = this.__P_477_1;
