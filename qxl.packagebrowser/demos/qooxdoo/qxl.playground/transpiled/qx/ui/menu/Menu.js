    ...
    */
    ...
    members: {
      ...
      */
       ...
       * and position.
       */
      __P_446_2: function __P_446_2() {
        var menuBounds = this._getMenuBounds();
        if (!menuBounds) {
          this.addListenerOnce("resize", this.__P_446_2, this);
          return;
        }
      ...
      syncWidget: function syncWidget(jobs) {
        ...
        if (this.__P_446_1) {
          this.__P_446_1.call(this);
          delete this.__P_446_1;
        }
      },
      /*
      ---------------------------------------------------------------------------
