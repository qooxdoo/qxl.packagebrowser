  ...
  qx.Class.define("qx.ui.virtual.cell.AbstractImage", {
    ...
    */
    ...
    members: {
       ...
       *    <code>height</code>
       */
      __P_536_2: function __P_536_2(source) {
        ...
        if (ResourceManager.has(source)) {
          ...
          width = this.__P_536_0;
          height = this.__P_536_1;
        }
        return {
          width: width,
          height: height
       ...
       *   </ul>
       */
      __P_536_3: function __P_536_3(imageData) {
      ...
      getContent: function getContent(value, states) {
        ...
        var content = "";
        var imageData = this.__P_536_3(this._identifyImage(value));
