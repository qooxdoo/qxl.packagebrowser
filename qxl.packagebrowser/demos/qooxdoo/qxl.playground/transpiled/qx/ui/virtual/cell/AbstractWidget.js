(function () {
  ...
  qx.Class.define("qx.ui.virtual.cell.AbstractWidget", {
    ...
    members: {
       ...
       */
      __P_544_1: function __P_544_1() {
        var widget = this.__P_544_0.shift();
        if (widget == null) {
