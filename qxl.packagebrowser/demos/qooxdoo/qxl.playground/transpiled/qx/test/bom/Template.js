  ...
  qx.Class.define("qx.test.bom.Template", {
    ...
    members: {
      ...
      tearDown: function tearDown() {
        if (this.__P_211_0) {
          qx.dom.Element.removeChild(this.__P_211_0, document.body);
        }
      },
      /**
       * render()
      ...
      testGet: function testGet() {
        ...
        qx.bom.element.Attribute.set(this.__P_211_0, "id", "qx-test-template");
        qx.bom.element.Style.set(this.__P_211_0, "display", "none");
        this.__P_211_0.innerHTML = "<div>{{a}}</div>";
        qx.dom.Element.insertEnd(this.__P_211_0, document.body);
      ...
      testGetMixed: function testGetMixed() {
        ...
        qx.bom.element.Attribute.set(this.__P_211_0, "id", "qx-test-template");
        qx.bom.element.Style.set(this.__P_211_0, "display", "none");
        this.__P_211_0.innerHTML = "<div>{{a}}<span>{{b}}</span></div>";
        qx.dom.Element.insertEnd(this.__P_211_0, document.body);
