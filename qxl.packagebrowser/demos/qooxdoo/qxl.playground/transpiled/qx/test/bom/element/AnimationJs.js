  ...
  qx.Class.define("qx.test.bom.element.AnimationJs", {
    ...
    members: {
      ...
      setUp: function setUp() {
        this.__P_213_0 = qx.dom.Element.create("img");
        qx.bom.element.Style.setStyles(this.__P_213_0, {
          width: "200px",
          height: "200px"
        });
      ...
      "test animate properties which are CSS properties and element attributes": function testAnimatePropertiesWhichAreCSSPropertiesAndElementAttributes() {
        ...
        var handle = qx.bom.element.Animation.animate(this.__P_213_0, {
          duration: 100,
          keyFrames: {
            0: {
              width: "200px",
        ...
        this.wait(500, function () {
          this.assertEquals("400px", qx.bom.element.Style.get(this.__P_213_0, "width"));
          this.assertEquals("400px", qx.bom.element.Style.get(this.__P_213_0, "height"));
        }, this);
      }
    }
  });
