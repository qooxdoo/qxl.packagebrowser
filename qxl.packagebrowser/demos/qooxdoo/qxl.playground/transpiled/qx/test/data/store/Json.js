  ...
  qx.Class.define("qx.test.data.store.Json", {
    ...
    members: {
      ...
      setUp: function setUp() {
        this.__P_238_0 = new qx.data.store.Json();
        this.__P_238_1 = eval("({s: 'String', n: 12, b: true})");
        this.__P_238_2 = ["s", "n", "b"];
      ...
      testLoadUrl: function testLoadUrl() {
        var _this = this;
        this.__P_238_0.addListener("loaded", function () {
          _this.resume(function () {
            var model = this.__P_238_0.getModel();
            this.assertEquals("String", model.getString(), "The model is not created how it should!");
          }, _this);
        });
        var url = this.url;
        this.__P_238_0.setUrl(url);
        this.wait();
      },
      testProgressStates: function testProgressStates() {
        ...
        var url = this.url,
          states = [];
        this.__P_238_0.addListener("changeState", function (evt) {
      ...
      testLoadResource: function testLoadResource() {
        ...
        this.__P_238_0.setUrl(resource);
        this.wait();
      },
      testParseErrorForResource: function testParseErrorForResource() {
        var _this4 = this;
        this.__P_238_0.addListener("parseError", function (ev) {
      ...
      testLoadAlias: function testLoadAlias() {
        ...
        this.__P_238_0.setUrl(alias);
        this.wait();
      },
      testDispose: function testDispose() {
        this.__P_238_0.setUrl(this.url);
        this.__P_238_0.dispose();
      },
      ...
      testOwnClassWith: function testOwnClassWith() {
        ...
        this.__P_238_0 = new qx.data.store.Json(null, delegate);
        this.__P_238_0.addListener("loaded", function () {
      ...
      testDisposeOldModel: function testDisposeOldModel() {
        ...
        this.__P_238_0.setModel(fakeModel);
        var url = this.url;
        this.__P_238_0.setUrl(url);
        this.wait();
      },
      ...
      testErrorEvent: function testErrorEvent() {
        var _this18 = this;
        this.__P_238_0.addListener("error", function (ev) {
          _this18.resume(function () {
            this.assertNotNull(ev);
          }, _this18);
        });
        this.__P_238_0.setUrl("not-found");
        this.wait();
      },
