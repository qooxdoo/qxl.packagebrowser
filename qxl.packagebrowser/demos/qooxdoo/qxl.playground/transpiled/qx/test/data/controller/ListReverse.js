  ...
  qx.Class.define("qx.test.data.controller.ListReverse", {
    ...
    members: {
      ...
      testStringListModel: function testStringListModel() {
        this.__P_228_4.bindItem = function (controller, item, id) {
        ...
        this.__P_228_1.set({
          target: this.__P_228_0,
          delegate: this.__P_228_4,
          iconPath: "",
          model: this.__P_228_3
        });

        // check for the binding model --> target
        var items = this.__P_228_0.getChildren();
        for (var i = 0; i < items.length; i++) {
          this.__P_228_3.setItem(i, "abc" + i);
        ...
        for (var i = 0; i < items.length; i++) {
          ...
          this.assertEquals(items[i].getLabel(), this.__P_228_3.getItem(i));
        }

        // check for the binding target(icon) --> model
        for (var i = 0; i < items.length; i++) {
          items[i].setIcon("AFFE" + i);
          this.assertEquals(items[i].getIcon(), this.__P_228_3.getItem(i));
        }
        ...
        this.__P_228_1.update();

        // check for the removed binding target(icon) --> model
        for (var i = 0; i < items.length; i++) {
          items[i].setIcon("123-" + i);
          this.assertEquals("AFFE" + i, this.__P_228_3.getItem(i));
        }
      },
      ...
      testStringListModelDeepTarget: function testStringListModelDeepTarget() {
        ...
        this.__P_228_4.configureItem = function (item) {
        ...
        for (var i = 0; i < items.length; i++) {
          ...
          this.assertEquals(items[i].getChild().getLabel(), this.__P_228_3.getItem(i));
        }
      ...
      testStringListModelArrayTarget: function testStringListModelArrayTarget() {
        ...
        for (var i = 0; i < items.length; i++) {
          ...
          this.assertEquals(items[i].getChildren().getItem(0).getLabel(), this.__P_228_3.getItem(i));
        }
