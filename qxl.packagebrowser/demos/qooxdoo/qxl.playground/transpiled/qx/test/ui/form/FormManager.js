  ...
  qx.Class.define("qx.test.ui.form.FormManager", {
    ...
    members: {
      ...
      testAddTwo: function testAddTwo() {
        ...
        // get the view
        var view = new qx.test.DummyFormRenderer(this.__P_297_0);
      ...
      testRemove: function testRemove() {
        ...
        this.assertFalse(this.__P_297_0.remove(this.__P_297_1));
      ...
      testRemoveHeader: function testRemoveHeader() {
        ...
        // check the items
        this.assertEquals(view.groups[0].items[0], this.__P_297_1);
        this.assertEquals(view.groups[1].items[0], this.__P_297_2);
        ...
        this.assertFalse(this.__P_297_0.removeGroupHeader("affe1"));
      ...
      testRemoveButton: function testRemoveButton() {
        ...
        this.assertFalse(this.__P_297_0.removeButton(b1));
