  ...
  qx.Class.define("qx.test.ui.form.Placeholder", {
    ...
    members: {
      ...
      __P_305_5: function __P_305_5(clazz) {
        ...
        this.assertTrue(this.__P_305_2(widget));
        this.assertEquals("abc", this.__P_305_4(widget), "wrong visible value");
      ...
      __P_305_6: function __P_305_6(clazz) {
        ...
        this.assertFalse(this.__P_305_2(widget), "1");
        ...
        window.setTimeout(function () {
          this.resume(function () {
            ...
            this.assertEquals("abc", this.__P_305_4(widget), "wrong visible value after blur");
