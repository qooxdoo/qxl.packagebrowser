  ...
  qx.Class.define("qx.test.ui.form.virtual.VirtualComboBox", {
    ...
    members: {
      ...
      setUp: function setUp() {
        ...
        this.__P_319_0 = new qx.ui.form.VirtualComboBox();
      ...
      testPreselectOnOpen: function testPreselectOnOpen() {
        ...
        this.__P_319_0.setModel(this.__P_319_1);
        this.__P_319_0.setValue("i");
        this.flush();
        this.__P_319_0.open();
        this.flush();
        this.__P_319_0.close();
        this.flush();
        // Preselection may not change the actual value
        this.assertNotEquals("item 1", this.__P_319_0.getValue());
        this.assertEquals("i", this.__P_319_0.getValue());
      },
      testSelectFirstMatch: function testSelectFirstMatch() {
        this.__P_319_1 = this.__P_319_2();
        this.__P_319_0.setModel(this.__P_319_1);
        this.__P_319_0.setValue("item 4");
        this.flush();
        this.__P_319_0.open();
        this.flush();
        var preselected = this.__P_319_0.getChildControl("dropdown")._preselected;
        this.assertEquals("item 4", preselected);
        this.assertEquals("item 4", this.__P_319_0.getValue());
      },
      testSelectFirstMatchWithSortedModel: function testSelectFirstMatchWithSortedModel() {
        ...
        this.__P_319_0.setDelegate(delegate);
        this.__P_319_0.setValue("item 4");
        this.flush();
        this.__P_319_0.open();
        this.flush();
      ...
      testSelectFirstMatchWithFilteredModel: function testSelectFirstMatchWithFilteredModel() {
        ...
        this.__P_319_0.setDelegate(delegate);
        this.__P_319_0.setValue("item 22");
        this.flush();
        this.__P_319_0.open();
        this.flush();
        ...
        this.assertEquals("item 22", this.__P_319_0.getValue());
      },
      testSelectFirstMatchWithFormatter: function testSelectFirstMatchWithFormatter() {
        this.__P_319_1 = this.__P_319_3();
        this.__P_319_0.setModel(this.__P_319_1);
        var delegate = {
        ...
        this.__P_319_0.setDelegate(delegate);
        this.__P_319_0.setDefaultFormat(function (data) {
          if (data) {
      ...
      testSelectFirstMatchByLabelPath: function testSelectFirstMatchByLabelPath() {
        this.__P_319_1 = this.__P_319_4();
        this.__P_319_0.setLabelPath("lastname");
        this.__P_319_0.setModel(this.__P_319_1);
        this.__P_319_0.setValue("Si");
        this.flush();
        this.__P_319_0.open();
        this.flush();
        var preselected = this.__P_319_0.getChildControl("dropdown")._preselected.getLastname();
        this.assertEquals("Sisko", preselected);
        this.assertEquals("Si", this.__P_319_0.getValue());
      },
      testEmptySelection: function testEmptySelection() {
        this.__P_319_0.setLabelPath("label");
        var rawData = [{
          label: "foo"
        }];
        var model = this.__P_319_1 = qx.data.marshal.Json.createModel(rawData);
        this.__P_319_0.setModel(model);
        var selection = this.__P_319_0.getChildControl("dropdown").getSelection();
        selection.push(this.__P_319_0.getModel().getItem(0));
        selection.removeAll();
      },
