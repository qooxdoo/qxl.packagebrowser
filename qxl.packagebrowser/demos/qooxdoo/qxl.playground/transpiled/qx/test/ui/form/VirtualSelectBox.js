  ...
  qx.Class.define("qx.test.ui.form.VirtualSelectBox", {
    ...
    members: {
      setUp: function setUp() {
        this.__P_318_0 = new qx.ui.form.VirtualSelectBox();
      ...
      "test dropdown list same width as selectbox": function test_dropdown_list_same_width_as_selectbox() {
        ...
        this.__P_318_0.setAllowGrowDropDown(false);
        this.__P_318_0.setModel(m);
        this.__P_318_0.setWidth(150);
        this.__P_318_0.open();
        this.flush();
        setTimeout(function () {
          test.assertIdentical(test.__P_318_0.getWidth(), test.__P_318_0.getBounds().width);
          test.assertIdentical(test.__P_318_0.getWidth(), test.__P_318_0.getChildControl("dropdown").getBounds().width);
          test.resume();
        }, 10);
        this.wait();
      },
      "test dropdown list wider than selectbox": function test_dropdown_list_wider_than_selectbox() {
        ...
        this.__P_318_0.setAllowGrowDropDown(true);
        this.__P_318_0.setModel(m);
        this.__P_318_0.setWidth(150);
        this.__P_318_0.open();
        this.flush();
        setTimeout(function () {
          test.assertIdentical(test.__P_318_0.getWidth(), test.__P_318_0.getBounds().width);
          test.assertTrue(test.__P_318_0.getChildControl("dropdown").getBounds().width > 666, "dropdown could not fit the whole item");
          test.resume();
        }, 10);
        this.wait();
      }
