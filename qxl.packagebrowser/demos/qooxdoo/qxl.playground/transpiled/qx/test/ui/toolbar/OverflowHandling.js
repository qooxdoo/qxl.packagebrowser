  ...
  qx.Class.define("qx.test.ui.toolbar.OverflowHandling", {
    ...
    members: {
      ...
      testHideItem: function testHideItem() {
        ...
        var bounds = this.__P_329_4.getBounds();
        var self = this;
        this.assertEventFired(this.__P_329_1, "hideItem", function () {
          self.__P_329_0.setWidth(bounds.left + 10);
          self.flush();
        }, function (e) {
          self.assertTrue(self.__P_329_4 === e.getData());
          self.assertTrue("excluded" === self.__P_329_4.getVisibility());
        });
      },
      testShowItem: function testShowItem() {
        ...
        this.assertEventFired(this.__P_329_1, "showItem", function () {
          ...
          self.assertTrue(self.__P_329_4 === e.getData() || self.__P_329_3 === e.getData());
      ...
      testShowItemPriority: function testShowItemPriority() {
        ...
        this.__P_329_1.setRemovePriority(this.__P_329_3, 2);
        var bounds = this.__P_329_4.getBounds();
        this.__P_329_0.setWidth(bounds.left + 10);
        this.flush();
        var self = this;
        this.assertEventFired(this.__P_329_1, "showItem", function () {
          self.__P_329_0.setWidth(200);
          self.flush();
        }, function (e) {
          self.assertEquals(self.__P_329_3, e.getData());
      ...
      testHideItemRemoved: function testHideItemRemoved() {
        ...
        this.assertEventNotFired(this.__P_329_1, "hideItem", function () {
          var bounds = self.__P_329_4.getBounds();
          self.__P_329_0.setWidth(bounds.left + 10);
          self.flush();
        });
      },
      testShowItemRemoved: function testShowItemRemoved() {
        this.__P_329_6();
        this.__P_329_0.setWidth(200);
        this.flush();
        this.__P_329_1.setOverflowHandling(true);
        var bounds = this.__P_329_4.getBounds();
        this.__P_329_0.setWidth(bounds.left + 40);
        this.flush();
        var self = this;
        setTimeout(function () {
          self.resume(function () {
            console.log("" + JSON.stringify(self.__P_329_0.getBounds()));
            console.log("1: " + JSON.stringify(self.__P_329_2.getBounds()));
            console.log("2: " + JSON.stringify(self.__P_329_3.getBounds()));
            console.log("3: " + JSON.stringify(self.__P_329_4.getBounds()));
            var bounds = self.__P_329_3.getBounds();
            console.log(JSON.stringify(bounds));
            self.__P_329_0.setWidth(bounds.left + 60);
            self.flush();
            console.log("" + JSON.stringify(self.__P_329_0.getBounds()));
            this.assertEventFired(this.__P_329_1, "showItem", function () {
              self.__P_329_1.remove(self.__P_329_3);
              self.flush();
              var i = 10;
            }, function (e) {
