  ...
  qx.Class.define("qx.test.ui.core.Blocker", {
    ...
    members: {
      ...
      setUp: function setUp() {
        ...
        this.__P_285_0 = new qx.ui.core.Blocker(this.getRoot());
        this.__P_285_0.setColor("green");
        this.__P_285_0.setOpacity(0.5);
      },
      ...
      testBlocker: function testBlocker() {
        var blockerElement = this.__P_285_0.getBlockerElement();
        this.__P_285_0.block();
        this.flush();
        this.assertTrue(this.__P_285_0.isBlocked(), "isBlocked()");
        this.assertTrue(blockerElement.isIncluded(), "isIncluded()");
        this.__P_285_0.unblock();
        this.flush();
        this.assertFalse(this.__P_285_0.isBlocked(), "isBlocked()");
      ...
      testBlockedEvent: function testBlockedEvent() {
        ...
        this.__P_285_0.addListenerOnce("blocked", function (e) {
          _this.__P_285_1 = true;
        });
        this.__P_285_0.addListenerOnce("unblocked", function (e) {
          _this.__P_285_2 = true;
        });
        this.__P_285_0.block();
        this.__P_285_0.unblock();
        this.wait(100, function () {
          this.assertTrue(this.__P_285_1, "'blocked' event was not fired, after block() was executed!");
          this.assertTrue(this.__P_285_2, "'unblocked' event was not fired, after unblock() was executed!");
        }, this);
      },
