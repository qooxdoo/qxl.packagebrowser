  ...
  qx.Class.define("qx.test.ui.tree.TreeFolder", {
    ...
    members: {
      ...
      setUp: function setUp() {
        ...
        // - AA ("item")
        // - BB
        var tree = this.__P_334_0 = new qx.ui.tree.Tree();
        var root = this.__P_334_1 = new qx.ui.tree.TreeFolder("A");
        tree.setRoot(root);
        root.setOpen(true);
        var aa = this.__P_334_2 = new qx.ui.tree.TreeFolder("AA");
        var ab = this.__P_334_3 = new qx.ui.tree.TreeFolder("AB");
        root.add(aa, ab);

        // Reference to "aa" as "item"
        this.__P_334_4 = this.__P_334_2;
      ...
      testIconWhenClosed: function testIconWhenClosed() {
        var item = this.__P_334_4;
        this.flush();
        this.__P_334_5(item, this.__P_334_6(item));
      },
      testIconWhenClosedWithIcon: function testIconWhenClosedWithIcon() {
        var item = this.__P_334_4;
        item.setIcon(this.icon_closed);
        this.flush();
        this.__P_334_5(item, this.icon_closed);
      },
      ...
      testIconWhenOpened: function testIconWhenOpened() {
        ...
        item.setOpen(true);
        this.flush();
        this.__P_334_5(item, this.__P_334_7(item));
      },
      ...
      testIconWhenOpenedWithIconOpened: function testIconWhenOpenedWithIconOpened() {
        ...
        item.setIconOpened(this.icon_opened);
        this.flush();
        this.__P_334_5(item, this.icon_opened);
      },
      ...
      testRemoveAll: function testRemoveAll() {
        var removed = this.__P_334_1.removeAll();
        this.assertEquals(2, removed.length);
        this.assertEquals(this.__P_334_2, removed[0]);
        this.assertEquals(this.__P_334_3, removed[1]);
      },
      //
      // Helper methods
      //
      __P_334_6: function __P_334_6(item) {
        return qx.util.PropertyUtil.getThemeValue(item, "icon");
      },
      __P_334_7: function __P_334_7(item) {
        return qx.util.PropertyUtil.getThemeValue(item, "iconOpened");
      },
      __P_334_5: function __P_334_5(item, expected) {
      ...
      tearDown: function tearDown() {
        ...
        this.__P_334_0.destroy();
        this.__P_334_1.destroy();
        this.__P_334_2.destroy();
        this.__P_334_3.destroy();
      }
    }
  });
