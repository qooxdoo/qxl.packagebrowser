(function () {
  ...
  ************************************************************************ */
  qx.Class.define("qx.test.ui.form.ModelSelection", {
    ...
    members: {
      __P_305_0: function __P_305_0(widget, children) {
      ...
      __P_305_1: function __P_305_1(widget, children) {
        var children = children || widget.getChildren();
      ...
      __P_305_2: function __P_305_2(widget, children) {
        var children = children || widget.getChildren();
      ...
      __P_305_3: function __P_305_3(widget, children) {
        var children = children || widget.getChildren();
      ...
      __P_305_5: function __P_305_5(widget) {
        for (var i = 0; i < 3; i++) {
      ...
      __P_305_7: function __P_305_7() {
        ...
        this.__P_305_8(group);
        return group;
      },
      __P_305_9: function __P_305_9() {
        var group = new qx.ui.form.RadioButtonGroup();
        this.__P_305_8(group);
        return group;
      },
      __P_305_8: function __P_305_8(widget) {
        for (var i = 0; i < 3; i++) {
      ...
      __P_305_11: function __P_305_11(box) {
      ...
      testListGetSingle: function testListGetSingle() {
        var list = this.__P_305_6();
        this.__P_305_0(list);
        this.__P_305_11(list);
      },
      ...
      testTreeGetSingle: function testTreeGetSingle() {
        var widget = this.__P_305_10();
        var children = widget.getItems(true);
        this.__P_305_0(widget, children);
        widget.destroy();
      },
      testTreeSetSingle: function testTreeSetSingle() {
        var widget = this.__P_305_10();
        var children = widget.getItems(true);
        this.__P_305_2(widget, children);
        widget.destroy();
      },
      testTreeGetMulti: function testTreeGetMulti() {
        ...
        var children = widget.getItems(true);
        this.__P_305_1(widget, children);
        widget.destroy();
      },
      testTreeSetMulti: function testTreeSetMulti() {
        ...
        widget.setSelectionMode("multi");
        var children = widget.getItems(true);
        this.__P_305_3(widget, children);
        widget.destroy();
      }
    }
  });
