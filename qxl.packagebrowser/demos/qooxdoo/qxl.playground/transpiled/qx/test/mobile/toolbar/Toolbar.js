(function () {
  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.test.mobile.toolbar.Toolbar", {
    ...
    members: {
      __P_263_0: function __P_263_0() {
        var toolBar = new qx.ui.mobile.toolbar.ToolBar();
        this.getRoot().add(toolBar);
        return toolBar;
      },
      __P_263_1: function __P_263_1(toolBar, toolbarKidsNumber) {
