  ...
  qx.Class.define("qx.test.application.Routing", {
    ...
    members: {
      ...
      setUp: function setUp() {
        this.__P_200_1 = qx.bom.History.getInstance().getState();
        this.__P_200_0 = new qx.application.Routing();
      },
      tearDown: function tearDown() {
        qx.bom.History.getInstance().setState(this.__P_200_1);
        this.__P_200_0.dispose();
      },
      testGet: function testGet() {
        var handler = this.spy();
        this.__P_200_0.onGet("/abc", handler);
        this.__P_200_0.executeGet("/abc");
        this.assertCalledOnce(handler);
      },
      testBack: function testBack() {
        var aHandler = this.spy();
        var bHandler = this.spy();
        this.__P_200_0.onGet("/a", aHandler);
        this.__P_200_0.onGet("/b", bHandler);
        this.__P_200_0.executeGet("/a");
        this.__P_200_0.executeGet("/b");
        this.__P_200_0.back();
      ...
      testBackCycle: function testBackCycle() {
        ...
        this.__P_200_0.onGet("/a", aHandler);
        this.__P_200_0.onGet("/b", bHandler);
        this.__P_200_0.onGet("/c", cHandler);
        this.__P_200_0.executeGet("/a");
        this.__P_200_0.executeGet("/b");
        this.__P_200_0.executeGet("/c");
        this.__P_200_0.executeGet("/b");
        this.__P_200_0.back();
        this.assertCalledTwice(aHandler);
      ...
      testOn: function testOn() {
        var handler = this.spy();
        this.__P_200_0.on("/", handler);
        this.__P_200_0.execute("/");
        this.assertCalledOnce(handler);
      },
      testPost: function testPost() {
        var handler = this.spy();
        this.__P_200_0.onPost("/abc", handler);
        this.__P_200_0.executePost("/abc");
        this.assertCalledOnce(handler);
      },
      testPostParam: function testPostParam() {
        ...
        this.__P_200_0.onPost("/{id}/affe", handler);
        this.__P_200_0.executePost("/123456/affe", data, "custom data");
        this.assertCalledOnce(handler);
      ...
      testDelete: function testDelete() {
        var handler = this.spy();
        this.__P_200_0.onDelete("/abc", handler);
        this.__P_200_0.executeDelete("/abc");
        this.assertCalledOnce(handler);
      },
      testPut: function testPut() {
        var handler = this.spy();
        this.__P_200_0.onPut("/abc", handler);
        this.__P_200_0.executePut("/abc");
        this.assertCalledOnce(handler);
      },
      testAny: function testAny() {
        var handler = this.spy();
        this.__P_200_0.onAny("/abc", handler);
        this.__P_200_0.executePost("/abc");
        this.__P_200_0.executeDelete("/abc");
      ...
      testInit: function testInit() {
        ...
        this.__P_200_0.dispose();
        this.__P_200_0 = new qx.application.Routing();
        this.__P_200_0.onGet("/a/b/c", handler);
        this.assertNotCalled(handler);
        this.__P_200_0.onGet("/", defaultHandler);
      ...
      testGetPathOrFallback: function testGetPathOrFallback() {
        this.__P_200_0.on("/registered", function () {});
        this.assertEquals("/", this.__P_200_0._getPathOrFallback(""));
        this.assertEquals("/", this.__P_200_0._getPathOrFallback(null));
        this.assertEquals("/", this.__P_200_0._getPathOrFallback("/not/registered"));
        this.assertEquals("/given/default", this.__P_200_0._getPathOrFallback("use_default_instead_of_this", "/given/default"));
        this.assertEquals("/registered", this.__P_200_0._getPathOrFallback("/registered"));
      }
    }
  });
