  ...
  qx.Class.define("qx.test.dev.unit.TestCase", {
    ...
    members: {
      ...
      testResumeHandler: function testResumeHandler() {
        this.__P_239_0(this.resumeHandler(function (param) {
          this.assertEquals(param, "foo");
          return "bar";
        }, this));
        this.wait();
      },
      __P_239_0: function __P_239_0(callback) {
        window.setTimeout(this.__P_239_1.bind(this, callback), 0);
      },
      __P_239_1: function __P_239_1(callback) {
