  ...
  ************************************************************************ */
  ...
  qx.Class.define("qxl.playground.view.Toolbar", {
    ...
    construct: function construct() {
      ...
      // sample button
      this.__P_602_1 = new qx.ui.form.ToggleButton(this.tr("Samples"), "icon/22/actions/edit-copy.png");
      this.__P_602_1.setValue(true);
      this.add(this.__P_602_1);
      this.__P_602_1.setToolTipText(this.tr("Show samples"));
      this.__P_602_1.setAppearance("toolbar-button");
      this.__P_602_1.addListener("changeValue", function (e) {
        this.fireDataEvent("changeSample", e.getData(), e.getOldData());
      }, this);

      // highlighting button
      this.__P_602_2 = new qx.ui.form.ToggleButton(this.tr("Syntax Highlighting"), "icon/22/actions/check-spelling.png");
      this.add(this.__P_602_2);
      this.__P_602_2.setAppearance("toolbar-button");
      this.__P_602_2.addListener("changeValue", function (e) {
        this.fireDataEvent("changeHighlight", e.getData(), e.getOldData());
      }, this);
      var initValue = qx.bom.Cookie.get("playgroundHighlight") !== "false";
      this.__P_602_2.setValue(initValue);

      // spacer
      this.addSpacer();

      // log Check button
      this.__P_602_3 = new qx.ui.toolbar.CheckBox(this.tr("Log"), "icon/22/apps/utilities-log-viewer.png");
      this.add(this.__P_602_3);
      this.__P_602_3.setToolTipText(this.tr("Show log output"));
      this.__P_602_3.addListener("changeValue", function (e) {
      ...
      this.setRemovePriority(this.__P_602_3, 5);
      this.setRemovePriority(this.__P_602_1, 4);
      this.setRemovePriority(this.__P_602_2, 3);
      ...
      this.__P_602_4 = new qx.ui.menu.Menu();
      chevron.setMenu(this.__P_602_4);
    ...
    members: {
      ...
      enableHighlighting: function enableHighlighting(value) {
        this.__P_602_2.setEnabled(value);
        // if the button will be disable, remove the pressed state
        if (!value) {
          this.__P_602_2.setValue(false);
        }
      },
      /**
      ...
      _getMenuItem: function _getMenuItem(toolbarItem) {
        var cachedItem = this.__P_602_0[toolbarItem.toHashCode()];
        if (!cachedItem) {
          ...
          this.__P_602_4.addAt(cachedItem, 0);
          this.__P_602_0[toolbarItem.toHashCode()] = cachedItem;
        }
        return cachedItem;
      }
    },
    ...
    destruct: function destruct() {
      this._disposeObjects("__P_602_2", "__P_602_3", "__P_602_4");
    }
  });
