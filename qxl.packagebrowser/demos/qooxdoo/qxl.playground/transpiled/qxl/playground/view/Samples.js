  ...
  qx.Class.define("qxl.playground.view.Samples", {
    ...
    members: {
      ...
      select: function select(sample) {
        this.__P_595_0.getSelection().setItem(0, sample);
      },
      /**
      ...
      selectByCode: function selectByCode(code) {
        var model = this.__P_595_0.getModel();
      ...
      _createList: function _createList() {
        ...
        this.__P_595_0 = new qx.ui.list.List();
        this.__P_595_0.setAppearance("sample-list");
        this.__P_595_0.setLabelPath("name");

        // CAREFUL: HACK TO GET THE SELECTION PREVENTED
        this.__P_595_0._manager.detatchPointerEvents();
        // store the old pointer handler
        var oldHandler = this.__P_595_0._manager.handleTap;
        var self = this;
        // attach a new handler function
        this.__P_595_0._manager.handleTap = function (e) {
          ...
          if (changeOk) {
            ...
            oldHandler.call(self.__P_595_0._manager, e);
          }
        };
        this.__P_595_0._manager.attachPointerEvents();
        // ////////////////////////////////////////////

        // set the delegate
        this.__P_595_0.setDelegate({
        ...
        this.__P_595_0.getSelection().addListener("change", function () {
          var sample = this.__P_595_0.getSelection().getItem(0);
          if (sample) {
      ...
      _createToolbar: function _createToolbar() {
        ...
        // delete button
        this.__P_595_1 = new qx.ui.toolbar.Button(null, "icon/16/places/user-trash.png");
        toolbar.add(this.__P_595_1);
        this.__P_595_1.setToolTipText(this.tr("Delete"));
        this.__P_595_1.addListener("execute", function () {
          this.fireEvent("delete");
        }, this);

        // rename button
        this.__P_595_2 = new qx.ui.toolbar.Button(null, "icon/16/actions/format-text-direction-ltr.png");
        toolbar.add(this.__P_595_2);
        this.__P_595_2.setToolTipText(this.tr("Rename"));
        this.__P_595_2.addListener("execute", function () {
      ...
      _applyCurrentSample: function _applyCurrentSample(value) {
        ...
        if (this.__P_595_1 && this.__P_595_2) {
          if (value && value.getCategory() != "static") {
            this.__P_595_1.setEnabled(true);
            this.__P_595_2.setEnabled(true);
          } else {
            this.__P_595_1.setEnabled(false);
            this.__P_595_2.setEnabled(false);
          }
        }
      },
      // property apply
