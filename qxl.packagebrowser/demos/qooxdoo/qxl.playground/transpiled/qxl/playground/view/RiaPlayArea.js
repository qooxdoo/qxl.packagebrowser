  ...
  ************************************************************************ */
  ...
  qx.Class.define("qxl.playground.view.RiaPlayArea", {
    ...
    construct: function construct() {
      ...
      // caption label
      this.__P_607_0 = new qx.ui.basic.Label().set({
        font: "bold",
        padding: 7,
        allowGrowX: true,
        allowGrowY: true
      ...
      this._caption.add(this.__P_607_0);
      ...
      // playfield
      this.__P_607_1 = new qx.ui.container.Scroll();
      this.__P_607_1.getChildControl("scrollbar-x");
      this.__P_607_1.getChildControl("scrollbar-y");
      this.__P_607_1.getChildControl("corner");
      this._dummy = new qx.ui.core.Widget();
      this.__P_607_1.add(this._dummy);
      this.add(this.__P_607_1, {
        flex: 1
      });
    },
    events: {
    ...
    members: {
      ...
      init: function init() {
        ...
        this._playRoot.getLayoutParent = function () {
          return self.__P_607_1;
        };
        this.__P_607_1.getChildren = this.__P_607_1._getChildren = function () {
          return [self._playRoot];
        };

        // copy the initial size which is availbale due to the flush at the beginning
        this._playRoot.setMinWidth(this.__P_607_1.getBounds().width);
        this._playRoot.setMinHeight(this.__P_607_1.getBounds().height);
        this.__P_607_1.addListener("resize", function (e) {
          var data = e.getData();
    ...
    destruct: function destruct() {
      this._disposeObjects("__P_607_0", "__P_607_1", "_dummy", "_playRoot", "_playApp");
    }
  });
