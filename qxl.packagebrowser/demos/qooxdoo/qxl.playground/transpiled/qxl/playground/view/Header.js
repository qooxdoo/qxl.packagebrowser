  ...
  ************************************************************************ */
  ...
  qx.Class.define("qxl.playground.view.Header", {
    ...
    construct: function construct() {
      ...
      this.__P_601_0 = [riaButton, mobileButton];
      this.__P_601_1 = new qx.ui.form.RadioGroup(riaButton, mobileButton);
      this.__P_601_1.bind("modelSelection[0]", this, "mode");
    ...
    members: {
      ...
      _applyMode: function _applyMode(value) {
        if (this.__P_601_1.getModelSelection().getItem(0) != value) {
          this.__P_601_1.setModelSelection([value]);
        }
      },
      /**
      ...
      setEnabledMode: function setEnabledMode(mode, value) {
        for (var i = 0; i < this.__P_601_0.length; i++) {
          if (this.__P_601_0[i].getModel() == mode) {
            var button = this.__P_601_0[i];
            break;
          }
        }
