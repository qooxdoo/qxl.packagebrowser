  ...
  qx.Class.define("qxl.playground.Application", {
    ...
    */
    members: {
      ...
      __P_586_17: null,
      __P_586_18: null,
      __P_586_19: qx.locale.Manager.tr("Unfortunately, an unrecoverable internal error was caused by your code. This may prevent the playground application to run properly.||"),
      __P_586_20: null,
      __P_586_21: null,
      /**
      ...
      main: function main() {
        ...
        qx.event.GlobalError.setErrorHandler(this.__P_586_22, this);
        ...
        // qooxdoo header
        this.__P_586_0 = new qxl.playground.view.Header();
        mainContainer.add(this.__P_586_0, {
          flex: 0
        });
        this.__P_586_0.addListener("changeMode", this._onChangeMode, this);

        // toolbar
        this.__P_586_2 = new qxl.playground.view.Toolbar();
        mainContainer.add(this.__P_586_2, {
          flex: 0
        });

        // toolbar listener
        this.__P_586_2.addListener("run", this.run, this);
        this.__P_586_2.addListener("changeSample", this.__P_586_23, this);
        this.__P_586_2.addListener("changeHighlight", this.__P_586_24, this);
        this.__P_586_2.addListener("changeLog", this.__P_586_25, this);
        this.__P_586_2.addListener("shortenUrl", this.__P_586_26, this);
        this.__P_586_2.addListener("openApi", this.__P_586_27, this);
        this.__P_586_2.addListener("openManual", this.__P_586_28, this);
        this.__P_586_2.addListener("openDemoBrowser", this.__P_586_29, this);

        // mainsplit, contains the editor splitpane and the info splitpane
        this.__P_586_1 = new qx.ui.splitpane.Pane("horizontal");
        mainContainer.add(this.__P_586_1, {
          flex: 1
        });
        this.__P_586_1.setAppearance("app-splitpane");

        // editor split (left side of main split)
        this.__P_586_7 = new qx.ui.splitpane.Pane("horizontal");
        this.__P_586_7.setDecorator(null); // get rid of the 3px broder
        // info split (right side of the main split)
        var infosplit = new qx.ui.splitpane.Pane("vertical");
        infosplit.setDecorator(null);

        // examples pane
        this.__P_586_6 = new qxl.playground.view.Samples();
        this.__P_586_6.addListener("save", this.__P_586_30, this);
        this.__P_586_6.addListener("saveAs", this.__P_586_31, this);
        this.__P_586_6.addListener("delete", this.__P_586_32, this);
        this.__P_586_6.addListener("rename", this.__P_586_33, this);
        this.bind("currentSample", this.__P_586_6, "currentSample");
        this.__P_586_6.addListener("beforeSelectSample", function (e) {
          if (this.__P_586_34()) {
            e.stop();
          }
        }, this);
        this.__P_586_6.addListener("selectSample", function (e) {
          this.setCurrentSample(e.getData());
        }, this);

        // initialize custom samples
        this.__P_586_10 = new qx.data.store.Offline("qooxdoo-playground-samples");
        // if the local storage is not empty
        if (this.__P_586_10.getModel() !== null) {
          // use the stored array to initialize the built in samples
          this.__P_586_9 = new qxl.playground.Samples(this.__P_586_10.getModel());
        } else {
          // init the samples and store in the local storage
          this.__P_586_9 = new qxl.playground.Samples();
          this.__P_586_10.setModel(this.__P_586_9.getModel());
        }
        this.__P_586_10.bind("model", this.__P_586_6, "model");

        // need to split up the creation process
        this.__P_586_4 = new qxl.playground.view.Editor();
        this.__P_586_4.addListener("disableHighlighting", function () {
          this.__P_586_2.enableHighlighting(false);
        }, this);
        qxl.playground.view.Editor.loadAce(function () {
          this.init();
        }, this);
        this.__P_586_7.add(this.__P_586_6, 1);
        this.__P_586_7.add(this.__P_586_4, 4);
        this.__P_586_1.add(this.__P_586_7, 6);
        this.__P_586_1.add(infosplit, 3);
        this.__P_586_5 = new qxl.playground.view.PlayArea();
        this.__P_586_5.addListener("toggleMaximize", this._onToggleMaximize, this);
        infosplit.add(this.__P_586_5, 2);
        this.__P_586_1.getChildControl("splitter").addListener("pointerdown", function () {
          this.__P_586_4.block();
        }, this);
        this.__P_586_1.addListener("losecapture", function () {
          this.__P_586_4.unblock();
        }, this);
        this.__P_586_3 = new qxl.logpane.LogPane();
        infosplit.add(this.__P_586_3, 1);
        this.__P_586_3.exclude();
      },
      /**
      ...
      init: function init() {
        ...
        if (this.__P_586_35("mobile")) {
          ...
          this.setMode("ria");
          this.__P_586_0.setEnabledMode("mobile", false);
        }
        ...
        if (qx.bom.Cookie.get("playgroundHighlight") === "false") {
          this.__P_586_4.useHighlight(false);
        }
        if (qx.bom.Cookie.get("playgroundShowExamples") === "false") {
          this.__P_586_2.showExamples(false);
        }
      },
      // ***************************************************
      // PROPERTY APPLY
      ...
      _applyName: function _applyName(value, old) {
        ...
        this.__P_586_5.updateCaption(value);
        this.__P_586_37(value);
      },
      // property apply
      _applyOriginCode: function _applyOriginCode(value, old) {
        this.__P_586_15 = false;
      },
      // property apply
      _applyCurrentSample: function _applyCurrentSample(newSample, old) {
        ...
        // in the code
        this.__P_586_4.setCode(newSample.getCode());
        this.setOriginCode(this.__P_586_4.getCode());

        // only add static samples to the url as name
        if (newSample.getCategory() == "static") {
          this.__P_586_11.addToHistory(newSample.getName() + "-" + newSample.getMode());
        } else {
          this.__P_586_38(newSample.getCode());
        }
      ...
      // MODE HANDLING
      // ***************************************************
      __P_586_39: function __P_586_39(enabled) {
        if (enabled) {
          this.__P_586_2.exclude();
          this.__P_586_1.exclude();
        } else {
          this.__P_586_2.show();
          this.__P_586_1.show();
        }
        ...
        // on demand creation
        if (!this.__P_586_8 && enabled) {
          this.__P_586_8 = new qxl.playground.view.WebsiteContent();
          this.getRoot().getChildren()[0].add(this.__P_586_8, {
            flex: 1
          });
        }
        if (this.__P_586_8) {
          if (!enabled) {
            this.__P_586_8.exclude();
          } else {
            this.__P_586_8.show();
          }
        }
      ...
      _onChangeMode: function _onChangeMode(e) {
        ...
        if (mode == this.__P_586_20) {
          return;
        }
        if (!this.setMode(mode)) {
          this.__P_586_0.setMode(e.getOldData());
        } else {
          // select the first sample
          this.setCurrentSample(this.__P_586_9.getFirstSample(mode));
        }
      },
      /**
       ...
       */
      __P_586_35: function __P_586_35(mode) {
        if (mode == "mobile") {
      ...
      setMode: function setMode(mode) {
        ...
        if (!this.__P_586_35(mode)) {
          throw new Error("Mode '" + mode + "' not supported");
        }

        // only set new mode if not already set
        if (this.__P_586_20 == mode) {
          return true;
        }
        ...
        this.__P_586_20 = mode;
        this.__P_586_39(mode == "website");

        // update the views (changes the play application)
        this.__P_586_5.setMode(mode);
        this.__P_586_0.setMode(mode);
        this.__P_586_6.setMode(mode);

        // erase the code
        this.__P_586_4.setCode("");
        return true;
      },
      // ***************************************************
      // SAMPEL SAVE / DELETE
       ...
       * offline store.
       */
      __P_586_30: function __P_586_30() {
        ...
        if (!current || current.getCategory() == "static") {
          ...
          current.setCode(this.__P_586_4.getCode());
       ...
       */
      __P_586_31: function __P_586_31() {
        ...
        var samples = this.__P_586_10.getModel();
       ...
       */
      __P_586_33: function __P_586_33() {
        var current = this.getCurrentSample();
      ...
      _onToggleMaximize: function _onToggleMaximize() {
        this.__P_586_21 = !this.__P_586_21;
        if (this.__P_586_21) {
          this.__P_586_7.exclude();
        } else {
          this.__P_586_7.show();
        }
      },
       ...
       */
      __P_586_23: function __P_586_23(e) {
        qx.bom.Cookie.set("playgroundShowExamples", e.getData(), 100);
        if (e.getData()) {
          this.__P_586_6.show();
        } else {
          this.__P_586_6.exclude();
        }
      },
      /**
       ...
       */
      __P_586_24: function __P_586_24(e) {
        qx.bom.Cookie.set("playgroundHighlight", e.getData(), 100);
        this.__P_586_4.useHighlight(e.getData());
      },
      /**
       ...
       *   be shown.
       */
      __P_586_25: function __P_586_25(e) {
        e.getData() ? this.__P_586_3.show() : this.__P_586_3.exclude();
      },
      /**
       * Handler for the url shortening service.
       */
      __P_586_26: function __P_586_26() {
       ...
       * Back button and bookmark support
       */
      __P_586_36: function __P_586_36() {
        this.__P_586_11 = qx.bom.History.getInstance();
        this.__P_586_11.addListener("changeState", this.__P_586_40, this);

        // Handle bookmarks
        var state = this.__P_586_11.getState();
        var code = "";

        // checks if the state corresponds to a sample. If yes, the application
        // will be initialized with the selected sample
        if (state && this.__P_586_9.isAvailable(state)) {
          var _sample = this.__P_586_9.get(state);
          ...
          var _sample2 = this.__P_586_9.getFirstSample(this.__P_586_20);
          ...
          code = this.__P_586_41(state);
          // need to get the code from the editor in case he changes something
          // in the code
          this.__P_586_4.setCode(code);
          this.setOriginCode(this.__P_586_4.getCode());

          // try to select a custom sample
          this.__P_586_6.selectByCode(code);
          this.setName(name);
          this.run();

          // if no state is given
        } else {
          var sample = this.__P_586_9.getFirstSample(this.__P_586_20);
       ...
       */
      __P_586_40: function __P_586_40(e) {
        var state = e.getData();

        // is a sample name given
        if (this.__P_586_9.isAvailable(state)) {
          var sample = this.__P_586_9.get(state);
          if (this.__P_586_42(sample.getCode(), this.__P_586_4.getCode())) {
            this.setCurrentSample(sample);
          }

          // is code given
        } else if (state != "") {
          var code = this.__P_586_41(state);
          if (code != this.__P_586_4.getCode()) {
            this.__P_586_4.setCode(code);
       ...
       * @lint ignoreDeprecated(confirm)
       */
      __P_586_38: function __P_586_38(code) {
        var codeJson = /* eslint-disable-next-line no-useless-concat */
        "{\"code\":\"" + encodeURIComponent(code) + '", "mode":"' + this.__P_586_20 + '"}';
        if (qx.core.Environment.get("engine.name") == "mshtml" && codeJson.length > 1300) {
          if (!this.__P_586_14 && window.confirm(this.tr("Cannot append sample code to URL, as it is too long. Disable this warning in the future?"))) {
            this.__P_586_14 = true;
          }
          return;
        }
        this.__P_586_11.addToHistory(codeJson);
      },
      // ***************************************************
      // UPDATE & RUN & COMPARE
      // ***************************************************
       ...
       */
      __P_586_34: function __P_586_34() {
        var userCode = this.__P_586_4.getCode();
        if (userCode && this.__P_586_42(userCode, this.getOriginCode())) {
       ...
       */
      __P_586_42: function __P_586_42(code1, code2) {
       ...
       */
      __P_586_37: function __P_586_37(label) {
       ...
       */
      __P_586_43: function __P_586_43() {
        var exc;
        this.__P_586_3.clear();
        this.__P_586_5.reset(this.__P_586_16, this.__P_586_17, this.__P_586_18);
        var reg = qx.Class.$$registry;
        delete reg[this.__P_586_13];

        // build the code to run
        var code = this.__P_586_4.getCode();
        ...
        try {
          ...
          this.__P_586_16 = qx.lang.Object.clone(qx.core.ObjectRegistry.getRegistry());

          // run the application
          this.fun.call(this.__P_586_5.getApp());
          qx.ui.core.queue.Manager.flush();
          this.__P_586_17 = qx.lang.Object.clone(qx.core.ObjectRegistry.getRegistry());
        } catch (ex) {
          exc = ex;
        }
        ...
        for (var name in reg) {
          if (this.__P_586_44(name)) {
            this.__P_586_13 = name;
            this.__P_586_45(name);
            break;
          }
        }
        ...
        // error handling
        if (exc) {
          this.error(this.__P_586_19.replace(/\|/g, "\n") + exc);
          this.__P_586_2.showLog(true);
          this.__P_586_3.show();
          this.__P_586_5.reset(this.__P_586_16, this.__P_586_17, this.__P_586_18);
        }
        this.__P_586_3.fetch();
      },
      /**
      ...
      run: function run(e) {
        var code = this.__P_586_4.getCode();
        if (code && this.__P_586_42(code, this.getOriginCode())) {
          this.__P_586_38(code);
          if (!this.__P_586_15) {
            this.setName(this.tr("%1 (modified)", this.getName()));
          }
          this.__P_586_15 = true;
        }
        this.__P_586_43();
      },
      /**
       ...
       */
      __P_586_22: function __P_586_22(e) {
        this.error(e);
      },
      // ***************************************************
      // STANDALONE SUPPORT
      ...
      __P_586_44: function __P_586_44(name) {
        ...
        } else if (this.__P_586_20 == "mobile") {
       ...
       */
      __P_586_45: function __P_586_45(name) {
        var self = this;
        qx.application.Standalone.prototype._createRootWidget = function () {
          return self.__P_586_5.getApp().getRoot();
        };
    ...
    destruct: function destruct() {
      this.__P_586_11 = this.__P_586_16 = this.__P_586_17 = null;
      this._disposeObjects("__P_586_13", "__P_586_9", "__P_586_2", "__P_586_4", "__P_586_5", "__P_586_3");
    }
  });
