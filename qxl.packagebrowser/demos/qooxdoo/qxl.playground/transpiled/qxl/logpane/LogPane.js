  ...
  ************************************************************************ */
  ...
  qx.Class.define("qxl.logpane.LogPane", {
    ...
    construct: function construct() {
      this.__P_606_0 = [["debug", "Debug", "icon/16/categories/system.png"], ["info", "Info", "icon/16/status/dialog-information.png"], ["warn", "Warning", "icon/16/status/dialog-warning.png"], ["error", "Error", "icon/16/status/dialog-error.png"]];
      ...
      this.__P_606_1 = new qx.ui.toolbar.ToolBar();
      this.__P_606_1.add(caption);
      this.__P_606_1.addSpacer();
      this.__P_606_1.setBackgroundColor("white");
      ...
      this.__P_606_1.add(clearButton);
      this.add(this.__P_606_1);
      ...
      // log appender
      this.__P_606_2 = new qx.log.appender.Element();
      qx.log.Logger.unregister(this.__P_606_2);

      // Directly create DOM element to use
      this.__P_606_3 = document.createElement("DIV");
      this.__P_606_2.setElement(this.__P_606_3);
      logArea.addListenerOnce("appear", function () {
        logArea.getContentElement().getDomElement().appendChild(this.__P_606_3);
      }, this);
    },
    properties: {
      /** Shows the toolbar */
    ...
    members: {
      ...
      fetch: function fetch(Logger) {
        ...
        Logger.register(this.__P_606_2);
      ...
      getAppenderElement: function getAppenderElement() {
        return this.__P_606_3;
      },
      _applyShowToolBar: function _applyShowToolBar(value, old) {
        if (value) {
          this.__P_606_1.show();
        } else {
          this.__P_606_1.exclude();
        }
      },
      // property apply
      _applyShowLogLevel: function _applyShowLogLevel(value, old) {
        if (!this.__P_606_4) {
          this.__P_606_4 = this.__P_606_5();
          this.__P_606_1.add(this.__P_606_4);
        }
        if (value) {
          this.__P_606_4.show();
        } else {
          this.__P_606_4.exclude();
        }
      },
      /**
      ...
      __P_606_5: function __P_606_5() {
        ...
        for (var i = 0, l = this.__P_606_0.length; i < l; i++) {
          var data = this.__P_606_0[i];
    ...
    destruct: function destruct() {
      this._disposeObjects("__P_606_2");
      this.__P_606_3 = null;
    }
  });
