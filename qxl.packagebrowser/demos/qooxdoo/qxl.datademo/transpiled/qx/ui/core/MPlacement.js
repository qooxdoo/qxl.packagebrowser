    ...
    members: {
      ...
      placeToWidget: function placeToWidget(target, liveupdate) {
        ...
        if (liveupdate) {
          ...
          this.__P_145_2 = qx.lang.Function.bind(this.placeToWidget, this, target, false);
          qx.event.Idle.getInstance().addListener("interval", this.__P_145_2);

          // Remove the listener when the element disappears.
          this.__P_145_4 = function () {
            this.__P_145_7();
          };
          this.addListener("disappear", this.__P_145_4, this);
        }
        var coords = target.getContentLocation() || this.getLayoutLocation(target);
        var size = this.__P_145_8();
        if (coords != null) {
          ...
          if (boundsAreEqual(coords, this.__P_145_5) && boundsAreEqual(size, this.__P_145_6)) {
            return true;
          }
          this.__P_145_5 = coords;
          this.__P_145_6 = size;
          this._place(coords);
          return true;
        } else {
      ...
      __P_145_7: function __P_145_7() {
        if (this.__P_145_2) {
          qx.event.Idle.getInstance().removeListener("interval", this.__P_145_2);
          this.__P_145_2 = null;
        }
        if (this.__P_145_4) {
          this.removeListener("disappear", this.__P_145_4, this);
          this.__P_145_4 = null;
        }
      },
      /**
      ...
      placeToElement: function placeToElement(elem, liveupdate) {
        ...
        if (liveupdate) {
          // Bind target and livupdate to placeToWidget
          this.__P_145_2 = qx.lang.Function.bind(this.placeToElement, this, elem, false);
          qx.event.Idle.getInstance().addListener("interval", this.__P_145_2);

          // Remove the listener when the element disappears.
          this.addListener("disappear", function () {
            if (_this.__P_145_2) {
              qx.event.Idle.getInstance().removeListener("interval", _this.__P_145_2);
              _this.__P_145_2 = null;
            }
          });
        }
        this._place(coords);
       ...
       */
      __P_145_8: function __P_145_8(callback) {
        var _this2 = this;
        var size = null;
