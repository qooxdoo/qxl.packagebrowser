    ...
    members: {
      ...
      */
      ...
      __P_60_4: function __P_60_4() {
        ...
        var widths = reuse ? this.__P_60_0 : new Array(length);
        var flexs = reuse ? this.__P_60_1 : new Array(length);
        ...
        // Store data
        if (!reuse) {
          this.__P_60_0 = widths;
          this.__P_60_1 = flexs;
        }
        this.__P_60_2 = enableFlex;
        this.__P_60_3 = children;
      ...
      */
      ...
      renderLayout: function renderLayout(availWidth, availHeight, padding) {
        ...
        if (this.__P_60_2 && allocatedWidth != availWidth) {
          var flexibles = {};
          var flex, offset;
