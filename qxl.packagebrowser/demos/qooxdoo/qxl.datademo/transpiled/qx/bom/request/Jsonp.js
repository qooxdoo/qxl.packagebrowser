  ...
  qx.Bootstrap.define("qx.bom.request.Jsonp", {
    ...
    members: {
      ...
      open: function open(method, url) {
        ...
        this.__P_130_4 = false;
        callbackParam = this.__P_130_2 || "callback";
        callbackName = this.__P_130_3 || this.__P_130_8 + "qx.bom.request.Jsonp." + this.__P_130_1 + ".callback";

        // Default callback
        if (!this.__P_130_3) {
          // Store globally available reference to this object
          this.constructor[this.__P_130_1] = this;
          ...
          // callback method.
          if (!window[this.__P_130_3]) {
            this.__P_130_5 = true;
            window[this.__P_130_3] = function (data) {
              that.callback(data);
            };
          } else {
            if (qx.core.Environment.get("qx.debug.io")) {
              qx.Bootstrap.debug(qx.bom.request.Jsonp, "Callback " + this.__P_130_3 + " already exists");
            }
          }
        }
        if (qx.core.Environment.get("qx.debug.io")) {
        ...
        this.__P_130_6 = url = qx.util.Uri.appendParamsToUrl(url, query);
        this.__P_130_9("open", [method, url]);
      },
      /**
      ...
      callback: function callback(data) {
        ...
        this.constructor[this.__P_130_1] = undefined;
        this.__P_130_10();
      },
      /**
      ...
      getGeneratedUrl: function getGeneratedUrl() {
        return this.__P_130_6;
      },
      dispose: function dispose() {
        // In case callback was not called
        this.__P_130_10();
        this.__P_130_9("dispose");
      },
      /**
       * Handle native load.
       */
      _onNativeLoad: function _onNativeLoad() {
        ...
        this.status = this.__P_130_4 ? 200 : 500;
        this.__P_130_9("_onNativeLoad");
      },
      /**
       *  Delete custom callback if dynamically created before.
       */
      __P_130_10: function __P_130_10() {
        if (this.__P_130_5 && window[this.__P_130_3]) {
          window[this.__P_130_3] = undefined;
          this.__P_130_5 = false;
        }
      },
      /**
