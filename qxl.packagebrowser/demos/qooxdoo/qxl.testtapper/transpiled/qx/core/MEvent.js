  ...
  ************************************************************************ */
  ...
  qx.Mixin.define("qx.core.MEvent", {
    members: {
       ...
       */
      __P_87_3: function __P_87_3(result) {
        var _this = this;
        {
          ...
          var newPromise = result.then(function (result) {
            delete _this.__P_87_1[hashCode];
            var promise = _this.__P_87_2;
            if (promise && Object.keys(_this.__P_87_1).length == 0) {
              _this.__P_87_1 = null;
              _this.__P_87_2 = null;
              promise.resolve();
            }
          ...
          this.__P_87_1[hashCode] = newPromise;
          return newPromise;
        }
      },
      /**
        ...
        return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
          ...
          return _regeneratorRuntime().wrap(function _callee$(_context) {
            while (1) switch (_context.prev = _context.next) {
              ...
              case 2:
                if (!_this2.__P_87_2) {
                  _this2.__P_87_2 = new qx.Promise();
                }
                promise = _this2.__P_87_2;
                _context.next = 6;
                return promise;
              case 6:
              case "end":
      ...
      fireEvent: function fireEvent(type, clazz, args) {
        if (!this.$$disposed) {
          return this.__P_87_3(this.__P_87_0.fireEvent(this, type, clazz, args));
        }
        return true;
      },
      /**
      ...
      fireEventAsync: function fireEventAsync(type, clazz, args) {
        if (!this.$$disposed) {
          return this.__P_87_3(this.__P_87_0.fireEventAsync(this, type, clazz, args));
        }
      ...
      fireNonBubblingEvent: function fireNonBubblingEvent(type, clazz, args) {
        if (!this.$$disposed) {
          return this.__P_87_3(this.__P_87_0.fireNonBubblingEvent(this, type, clazz, args));
        }
        return true;
      },
      /**
      ...
      fireNonBubblingEventAsync: function fireNonBubblingEventAsync(type, clazz, args) {
        if (!this.$$disposed) {
          return this.__P_87_3(this.__P_87_0.fireNonBubblingEventAsync(this, type, clazz, args));
        }
        return qx.Promise.resolve(true);
      },
      /**
      ...
      fireDataEvent: function fireDataEvent(type, data, oldData, cancelable) {
        if (!this.$$disposed) {
          ...
          return this.__P_87_3(this.__P_87_0.fireEvent(this, type, qx.event.type.Data, [data, oldData, !!cancelable]));
        }
        return true;
      },
      /**
      ...
      fireDataEventAsync: function fireDataEventAsync(type, data, oldData, cancelable) {
        if (!this.$$disposed) {
          ...
          return this.__P_87_3(this.__P_87_0.fireEventAsync(this, type, qx.event.type.Data, [data, oldData, !!cancelable]));
        }
        return qx.Promise.resolve(true);
      }
    }
