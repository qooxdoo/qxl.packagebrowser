  ...
  qx.Class.define("qx.data.marshal.Json", {
    ...
    statics: {
      ...
      checkIfWarnAboutNotBreakingOnNonPojos: function checkIfWarnAboutNotBreakingOnNonPojos() {
        if (!qx.core.Environment.get("qx.data.marshal.Json.breakOnNonPojos") && !this.__P_5_1) {
    ...
    members: {
       ...
       * @return {String} The hash representation of the given JavaScript object.
       */
      __P_5_3: function __P_5_3(data, includeBubbleEvents) {
        // forced mode?
        //
        if (includeBubbleEvents === true) {
          return this.__P_5_2(data, true);
        }
        if (includeBubbleEvents === false) {
          return this.__P_5_2(data, false);
        }

        // automatic mode!
        //
        var hash = this.__P_5_2(data); // without bubble event feature
      ...
      toClass: function toClass(data, includeBubbleEvents) {
        this.__P_5_4(data, includeBubbleEvents, null, 0);
      },
      /**
       ...
       */
      __P_5_4: function __P_5_4(data, includeBubbleEvents, parentProperty, depth) {
        ...
        if (shouldBreak) {
          ...
          if (data instanceof Array || qx.Bootstrap.getClass(data) == "Array") {
            for (var i = 0; i < data.length; i++) {
              this.__P_5_4(data[i], includeBubbleEvents, parentProperty + "[" + i + "]", depth + 1);
            }
          }
        ...
        // ignore rules
        if (this.__P_5_5(hash, parentProperty, depth)) {
          return;
        }

        // check for the possible child classes
        for (var key in data) {
          this.__P_5_4(data[key], includeBubbleEvents, key, depth + 1);
        }
        ...
        if (this.__P_5_0 && this.__P_5_0.getModelMixins) {
          var delegateMixins = this.__P_5_0.getModelMixins(hash, parentProperty, depth);
       ...
       * @return {qx.core.Object} An instance of the corresponding class.
       */
      __P_5_7: function __P_5_7(hash, data, parentProperty, depth) {
        var delegateClass;
       ...
       */
      __P_5_5: function __P_5_5(hash, parentProperty, depth) {
      ...
      toModel: function toModel(data, includeBubbleEvents) {
        return this.__P_5_8(data, includeBubbleEvents, null, 0);
      },
      /**
       ...
       * @return {qx.core.Object} The created model object.
       */
      __P_5_8: function __P_5_8(data, includeBubbleEvents, parentProperty, depth) {
        var breakOnNonPojos = qx.core.Environment.get("qx.data.marshal.Json.breakOnNonPojos");
        this.constructor.checkIfWarnAboutNotBreakingOnNonPojos();
        ...
        if (shouldBreak) {
          ...
          // ignore rules
        } else if (this.__P_5_5(this.__P_5_3(data, includeBubbleEvents), parentProperty, depth)) {
          return data;
        } else if (isArray) {
          ...
          for (var i = 0; i < data.length; i++) {
            array.push(this.__P_5_8(data[i], includeBubbleEvents, parentProperty + "[" + i + "]", depth + 1));
          }
          return array;
        } else if (breakOnNonPojos ? isPojo : isObject) {
          // create an instance for the object
          var hash = this.__P_5_3(data, includeBubbleEvents);
          var model = this.__P_5_7(hash, data, parentProperty, depth);
          ...
          for (var key in data) {
            ...
            if (model[setterName]) {
              model[setterName](this.__P_5_8(data[key], includeBubbleEvents, key, depth + 1));
            }
          }
          return model;
        }
