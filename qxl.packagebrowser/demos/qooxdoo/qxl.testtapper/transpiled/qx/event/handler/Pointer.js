  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.event.handler.Pointer", {
    ...
    construct: function construct(manager) {
      ...
      this.__P_183_2 = this.__P_183_1.document;
      qx.event.handler.PointerCore.apply(this, [this.__P_183_2]);
    },
    members: {
      __P_183_0: null,
      __P_183_1: null,
        ...
        if (target && target.nodeType) {
          ...
          qx.event.Utils.then(tracker, function () {
            if ((domEvent.getPointerType() !== "mouse" || domEvent.button <= qx.event.handler.PointerCore.LEFT_BUTTON) && (type == "pointerdown" || type == "pointerup" || type == "pointermove" || type == "pointercancel")) {
              return qx.event.Registration.fireEvent(self.__P_183_2, qx.event.handler.PointerCore.POINTER_TO_GESTURE_MAPPING[type], qx.event.type.Pointer, [domEvent, target, null, false, false]);
            }
          });
          qx.event.Utils.then(tracker, function () {
      ...
      dispose: function dispose() {
        this.__P_183_3("dispose");
        this.__P_183_0 = this.__P_183_1 = this.__P_183_2 = null;
      },
      /**
       ...
       */
      __P_183_3: function __P_183_3(method, args) {
