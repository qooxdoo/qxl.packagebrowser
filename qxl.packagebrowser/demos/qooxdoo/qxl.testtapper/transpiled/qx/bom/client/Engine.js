  ...
  qx.Bootstrap.define("qx.bom.client.Engine", {
    ...
    statics: {
      ...
      getVersion: function getVersion() {
        ...
        var version = "";
        if (qx.bom.client.Engine.__P_45_0()) {
        ...
        } else if (qx.bom.client.Engine.__P_45_1()) {
        ...
        } else if (qx.bom.client.Engine.__P_45_2()) {
        ...
        } else if (qx.bom.client.Engine.__P_45_3()) {
      ...
      __P_45_0: function __P_45_0() {
        ...
        if (qx.bom.client.Engine.__P_45_4()) {
          return true;
        }
        return false;
      },
