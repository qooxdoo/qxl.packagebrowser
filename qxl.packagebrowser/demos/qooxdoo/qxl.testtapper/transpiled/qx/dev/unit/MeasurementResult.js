  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.dev.unit.MeasurementResult", {
    ...
    construct: function construct(message, iterations, ownTime, renderTime) {
      this.__P_69_0 = message;
      this.__P_69_1 = iterations;
      this.__P_69_2 = ownTime;
      this.__P_69_3 = renderTime;
    },
    members: {
      __P_69_0: null,
      __P_69_1: null,
      ...
      getData: function getData() {
        return {
          message: this.__P_69_0,
          iterations: this.__P_69_1,
          ownTime: this.__P_69_2,
          renderTime: this.__P_69_3
        };
      },
      /**
      ...
      toString: function toString() {
        return ["Measured: " + this.__P_69_0, "Iterations: " + this.__P_69_1, "Time: " + this.__P_69_2 + "ms", "Render time: " + this.__P_69_3 + "ms"].join("\n");
      }
    }
  });
