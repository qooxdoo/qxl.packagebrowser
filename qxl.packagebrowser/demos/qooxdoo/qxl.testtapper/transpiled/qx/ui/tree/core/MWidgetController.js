  ...
  qx.Mixin.define("qx.ui.tree.core.MWidgetController", {
    ...
    members: {
      ...
      bindDefaultProperties: function bindDefaultProperties(item, index) {
        ...
        var bindPath = this.__P_115_1(index);
      ...
      bindProperty: function bindProperty(sourcePath, targetProperty, options, targetWidget, index) {
        var bindPath = this.__P_115_1(index, sourcePath);
        var bindTarget = this._tree.getLookupTable();
        var id = bindTarget.bind(bindPath, targetWidget, targetProperty, options);
        this.__P_115_2(targetWidget, id);
      },
      /**
      ...
      _removeBindingsFrom: function _removeBindingsFrom(item) {
        var bindings = this.__P_115_3(item);
        ...
        if (this.__P_115_0.includes(item)) {
          qx.lang.Array.remove(this.__P_115_0, item);
        }
      },
      /**
       ...
       */
      __P_115_1: function __P_115_1(index, path) {
        var bindPath = "[" + index + "]";
        if (path != null && path != "") {
          bindPath += "." + path;
        }
       ...
       */
      __P_115_2: function __P_115_2(widget, id) {
        var bindings = this.__P_115_3(widget);
        if (!bindings.includes(id)) {
          bindings.push(id);
        }
        if (!this.__P_115_0.includes(widget)) {
