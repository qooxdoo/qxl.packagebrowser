  ...
  qx.Mixin.define("qx.ui.tree.core.MWidgetController", {
    ...
    members: {
      ...
      bindDefaultProperties: function bindDefaultProperties(item, index) {
        ...
        var bindPath = this.__P_113_1(index);
      ...
      bindProperty: function bindProperty(sourcePath, targetProperty, options, targetWidget, index) {
        var bindPath = this.__P_113_1(index, sourcePath);
        var bindTarget = this._tree.getLookupTable();
        var id = bindTarget.bind(bindPath, targetWidget, targetProperty, options);
        this.__P_113_2(targetWidget, id);
      },
      /**
      ...
      _removeBindingsFrom: function _removeBindingsFrom(item) {
        var bindings = this.__P_113_3(item);
        ...
        if (this.__P_113_0.includes(item)) {
          qx.lang.Array.remove(this.__P_113_0, item);
        }
      },
      /**
       ...
       */
      __P_113_1: function __P_113_1(index, path) {
        var bindPath = "[" + index + "]";
        if (path != null && path != "") {
          bindPath += "." + path;
        }
       ...
       */
      __P_113_2: function __P_113_2(widget, id) {
        var bindings = this.__P_113_3(widget);
        if (!bindings.includes(id)) {
          bindings.push(id);
        }
        if (!this.__P_113_0.includes(widget)) {
          this.__P_113_0.push(widget);
        }
      },
      /**
       ...
       */
      __P_113_3: function __P_113_3(widget) {
