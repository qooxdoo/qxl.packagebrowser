  ...
  qx.Class.define("qx.ui.popup.Manager", {
    ...
    */
    construct: function construct() {
      ...
      qx.event.Registration.addListener(document.documentElement, "pointerdown", this.__P_181_1, this, true);
    ...
    */
    ...
    members: {
      ...
      remove: function remove(obj) {
        qx.lang.Array.remove(this.__P_181_0, obj);
        this.__P_181_2();
      },
      /**
      ...
      hideAll: function hideAll() {
        var l = this.__P_181_0.length,
          current = {};
        while (l--) {
          current = this.__P_181_0[l];
      ...
      */
      ...
      __P_181_2: function __P_181_2() {
        ...
        for (var i = 0; i < this.__P_181_0.length; i++) {
          this.__P_181_0[i].setZIndex(min++);
        }
      },
      /*
      ---------------------------------------------------------------------------
    ...
    */
    destruct: function destruct() {
      qx.event.Registration.removeListener(document.documentElement, "pointerdown", this.__P_181_1, this, true);
      this._disposeArray("__P_181_0");
    }
  });
