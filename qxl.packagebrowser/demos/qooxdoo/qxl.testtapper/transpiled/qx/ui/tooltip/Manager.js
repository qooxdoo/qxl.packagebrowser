  ...
  qx.Class.define("qx.ui.tooltip.Manager", {
    ...
    */
    construct: function construct() {
      ...
      // Register events
      qx.event.Registration.addListener(document.body, "pointerover", this.__P_78_0, this, true);

      // Instantiate timers
      this.__P_78_1 = new qx.event.Timer();
      this.__P_78_1.addListener("interval", this.__P_78_2, this);
      this.__P_78_3 = new qx.event.Timer();
      this.__P_78_3.addListener("interval", this.__P_78_4, this);
    ...
    */
    ...
    members: {
      ...
      getSharedTooltip: function getSharedTooltip() {
        if (!this.__P_78_6) {
          this.__P_78_6 = new qx.ui.tooltip.ToolTip().set({
            rich: true
          });
        }
        return this.__P_78_6;
      },
      /**
       * Get the shared tooltip, which is used to display the
       * {@link qx.ui.core.Widget#toolTipText} and
      ...
      getSharedErrorTooltip: function getSharedErrorTooltip() {
        if (!this.__P_78_7) {
          this.__P_78_7 = new qx.ui.tooltip.ToolTip().set({
            appearance: "tooltip-error",
            rich: true
          });
          this.__P_78_7.setLabel(""); // trigger label widget creation
          this.__P_78_7.syncAppearance();
        }
      ...
      */
      ...
      _applyCurrent: function _applyCurrent(value, old) {
        ...
        if (value) {
          this.__P_78_1.startWith(value.getShowTimeout());

          // Register hide handler
          Registration.addListener(el, "pointerout", this.__P_78_8, this, true);
          Registration.addListener(el, "focusout", this.__P_78_9, this, true);
          Registration.addListener(el, "pointermove", this.__P_78_10, this, true);
        } else {
          // Deregister hide handler
          Registration.removeListener(el, "pointerout", this.__P_78_8, this, true);
          Registration.removeListener(el, "focusout", this.__P_78_9, this, true);
          Registration.removeListener(el, "pointermove", this.__P_78_10, this, true);
        }
      },
      /*
      ---------------------------------------------------------------------------
      ...
      */
       ...
       */
      __P_78_2: function __P_78_2(e) {
        var current = this.getCurrent();
        if (current && !current.isDisposed()) {
          this.__P_78_3.startWith(current.getHideTimeout());
          if (current.getPlaceMethod() == "widget") {
            current.placeToWidget(current.getOpener());
          } else {
            current.placeToPoint(this.__P_78_5);
          }
          current.show();
        }
        this.__P_78_1.stop();
      ...
      */
       ...
       */
      __P_78_10: function __P_78_10(e) {
        var pos = this.__P_78_5;
    ...
    */
    destruct: function destruct() {
      // Deregister events
      qx.event.Registration.removeListener(document.body, "pointerover", this.__P_78_0, this, true);

      // Dispose timers
      this._disposeObjects("__P_78_1", "__P_78_3", "__P_78_6");
      this.__P_78_5 = null;
    }
  });
