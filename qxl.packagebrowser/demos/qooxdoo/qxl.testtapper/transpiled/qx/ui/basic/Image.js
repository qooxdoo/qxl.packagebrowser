      ...
      */
      ...
      __P_55_15: function __P_55_15(el, source) {
        ...
        if (isFont) {
          ...
          if (this.getScale()) {
            ...
            var font = this.__P_55_20(source);
          ...
          this.__P_55_21(ResourceManager.getImageWidth(source), ResourceManager.getImageHeight(source));
        }
      },
      __P_55_22: function __P_55_22(el, width, height) {
        if (this.getScale()) {
      ...
      _applyDimension: function _applyDimension() {
        ...
        if (isFont) {
          ...
          if (el) {
            ...
            this.__P_55_22(el, width, height);
          }
        } else {
          this.__P_55_21();
        }
      ...
      __P_55_18: function __P_55_18(el, source) {
        ...
        if (!ImageLoader.isFailed(source)) {
          ImageLoader.load(source, this.__P_55_23, this);
        } else {
          this.__P_55_12(el);
        }
      },
      ...
      __P_55_20: function __P_55_20(source) {
      ...
      __P_55_8: function __P_55_8(el, source) {
        ...
        if (isFont) {
          ...
          this.__P_55_22(el, this.__P_55_1, this.__P_55_2);
       ...
       */
      __P_55_23: function __P_55_23(source, imageInfo) {
       ...
       */
      __P_55_21: function __P_55_21(width, height) {
        if (width === undefined) {
          width = this.__P_55_1;
        }
        if (height === undefined) {
