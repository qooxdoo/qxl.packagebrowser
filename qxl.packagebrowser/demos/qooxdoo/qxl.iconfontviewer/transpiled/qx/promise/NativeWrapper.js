  ...
  qx.Class.define("qx.promise.NativeWrapper", {
    ...
    members: {
      ...
      bind: function bind(context) {
        var promise = new qx.promise.NativeWrapper(this.__P_84_0);
       ...
       */
      __P_84_2: function __P_84_2(context) {
    ...
    statics: {
       ...
       * @returns
       */
      __P_84_3: function __P_84_3(promise) {
      ...
      all: function all(iterable) {
        return qx.promise.NativeWrapper.resolve(iterable).then(function (iterable) {
          return qx.promise.NativeWrapper.__P_84_3(Promise.all(iterable));
        });
      },
      /**
      ...
      method: function method(cb) {
        ...
        return function () {
          ...
          return new qx.promise.NativeWrapper(function (resolve) {
            return resolve(cb.call.apply(cb, [_this.__P_84_1].concat(args)));
          });
        };
      },
      /**
