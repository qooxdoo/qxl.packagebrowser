    ...
    members: {
      ...
      */
      ...
      add: function add(page) {
        ...
        // Register button
        this.__P_3_1.add(button);

        // Add state to page
        page.addState(this.__P_3_0[this.getBarPosition()]);
        this.__P_3_2();
        page.addListener("close", this._onPageClose, this);
        page.addListener("changeTabVisibility", this.__P_3_3, this);
      },
      /**
       * Adds a page to the tabview including its needed button
       * (contained in the page).
      ...
      remove: function remove(page) {
        ...
        this.__P_3_1.remove(button);

        // Remove state from page
        page.removeState(this.__P_3_0[this.getBarPosition()]);
        this.__P_3_2();
        page.removeListener("close", this._onPageClose, this);
        page.removeListener("changeTabVisibility", this.__P_3_3, this);
      },
      /**
      ...
      */
      ...
      _applyBarPosition: function _applyBarPosition(value, old) {
        ...
        if (value) {
          var newState = this.__P_3_0[value];
