  ...
  ************************************************************************ */
  ...
  qx.Class.define("qxl.apiviewer.ui.panels.PropertyPanel", {
    ...
    members: {
      ...
      __P_233_0: function __P_233_0(node, currentClassDocNode) {
        if (node.isRefined()) {
          return "";
        }
        if (node.isPrivate()) {
       ...
       */
      __P_233_2: function __P_233_2(node) {
        if (node.isRefined()) {
      ...
      getItemTextHtml: function getItemTextHtml(node, currentClassDocNode, showDetails) {
        ...
        if (showDetails) {
          ...
          textHtml.add(this.__P_233_1(node));
          textHtml.add(this.__P_233_0(node, currentClassDocNode));
          textHtml.add(qxl.apiviewer.ui.panels.InfoPanel.createIncludedFromHtml(node, currentClassDocNode));
          textHtml.add(this.__P_233_2(node));
