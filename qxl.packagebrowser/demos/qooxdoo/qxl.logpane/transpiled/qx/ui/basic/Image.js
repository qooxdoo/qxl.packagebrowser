  ...
  qx.Class.define("qx.ui.basic.Image", {
    ...
    members: {
      ...
      */
      ...
      _getContentHint: function _getContentHint() {
        return {
          width: this.__P_95_1 || 0,
          height: this.__P_95_2 || 0
        };
      },
      // overridden
      ...
      */
       ...
       */
      __P_95_10: function __P_95_10(mode) {
        this.__P_95_3 = mode;
      },
      /**
      ...
      __P_95_9: function __P_95_9() {
        if (this.__P_95_3 == null) {
          ...
          if (this.getScale() && isPng && qx.core.Environment.get("css.alphaimageloaderneeded")) {
            this.__P_95_3 = "alphaScaled";
          } else if (this.getScale()) {
            this.__P_95_3 = "scaled";
          } else {
            this.__P_95_3 = "nonScaled";
          }
        }
       ...
       */
      __P_95_11: function __P_95_11(mode) {
        var scale;
        var tagName;
        ...
        if (mode == "font") {
          ...
          if (qx.core.Environment.get("css.alphaimageloaderneeded")) {
            var wrapper = this.__P_95_5 = new qx.html.Element("div");
            element.connectObject(this);
      ...
      __P_95_7: function __P_95_7() {
        ...
        var mode = this.__P_95_9();
        if (this.__P_95_0[mode] == null) {
          this.__P_95_0[mode] = this.__P_95_11(mode);
        }
        var element = this.__P_95_0[mode];
        if (!this.__P_95_4) {
      ...
      _styleSource: function _styleSource() {
        ...
        if (!source) {
          this.__P_95_12(element);
          return;
        }
        this.__P_95_13(source);
        ...
        var contentEl = this.__P_95_14();

        // Detect if the image registry knows this image
        if (ResourceManager.isFontUri(source)) {
          this.__P_95_15(contentEl, source);
          ...
          if (highResolutionSource) {
            ...
            this.__P_95_4.setStyle("background-size", backgroundSize);
          ...
          this.__P_95_17(contentEl, source);
          this.__P_95_16();
        } else {
          this.__P_95_18(contentEl, source);
        }
      },
      /**
       ...
       */
      __P_95_13: qx.core.Environment.select("engine.name", {
        mshtml: function mshtml(source) {
          ...
          if (isFont) {
            ...
            if (this.getScale() && this.__P_95_9() != "alphaScaled") {
              this.__P_95_10("alphaScaled");
            } else if (!this.getScale() && this.__P_95_9() != "nonScaled") {
              this.__P_95_10("nonScaled");
            }
          } else {
            if (this.getScale() && this.__P_95_9() != "scaled") {
              this.__P_95_10("scaled");
            } else if (!this.getScale() && this.__P_95_9() != "nonScaled") {
              this.__P_95_10("nonScaled");
            }
          }
          this.__P_95_19(this.__P_95_7());
        },
        "default": function _default(source) {
          var isFont = source && qx.lang.String.startsWith(source, "@");
          if (isFont) {
            this.__P_95_10("font");
          } else if (this.getScale() && this.__P_95_9() != "scaled") {
            this.__P_95_10("scaled");
          } else if (!this.getScale() && this.__P_95_9() != "nonScaled") {
            this.__P_95_10("nonScaled");
          }
       ...
       */
      __P_95_19: function __P_95_19(elementToAdd) {
        var currentContentElement = this.__P_95_4;
        if (currentContentElement != elementToAdd) {
          if (currentContentElement != null) {
            ...
            styles.zIndex = 10;
            var newEl = this.__P_95_5 ? elementToAdd.getChild(0) : elementToAdd;
       ...
       */
      __P_95_15: function __P_95_15(el, source) {
        var ResourceManager = qx.util.ResourceManager.getInstance();
        ...
        if (isFont) {
          ...
          if (this.getScale()) {
            ...
            var font = this.__P_95_20(source);
          ...
          this.__P_95_21(ResourceManager.getImageWidth(source), ResourceManager.getImageHeight(source));
        }
      },
      __P_95_22: function __P_95_22(el, width, height) {
        if (this.getScale()) {
      ...
      _applyDimension: function _applyDimension() {
        ...
        if (isFont) {
          ...
          if (el) {
            ...
            this.__P_95_22(el, width, height);
          }
        } else {
          this.__P_95_21();
        }
       ...
       * @param source {String} source path
       */
      __P_95_17: function __P_95_17(el, source) {
       ...
       * @param source {String} source path
       */
      __P_95_18: function __P_95_18(el, source) {
        var ImageLoader = qx.io.ImageLoader;
        // only try to load the image if it not already failed
        if (!ImageLoader.isFailed(source)) {
          ImageLoader.load(source, this.__P_95_23, this);
        } else {
          this.__P_95_12(el);
        }
      },
       ...
       * @param el {Element} image DOM element
       */
      __P_95_12: function __P_95_12(el) {
        if (el != null) {
      ...
      __P_95_20: function __P_95_20(source) {
       ...
       * @param source {String} source path
       */
      __P_95_8: function __P_95_8(el, source) {
        var isFont = source && qx.lang.String.startsWith(source, "@");
        if (isFont) {
          var ResourceManager = qx.util.ResourceManager.getInstance();
          var font = this.__P_95_20(source);
          ...
          this.__P_95_22(el, this.__P_95_1, this.__P_95_2);
       ...
       */
      __P_95_23: function __P_95_23(source, imageInfo) {
        ...
        // Update image
        this.__P_95_17(this.__P_95_14(), source);
      },
      /**
       ...
       */
      __P_95_21: function __P_95_21(width, height) {
        if (width === undefined) {
          width = this.__P_95_1;
        }
        if (height === undefined) {
          height = this.__P_95_2;
        }
      ...
      _recalc: function _recalc(originalWidth, originalHeight) {
        ...
        if (width != this.__P_95_1 || height != this.__P_95_2) {
          this.__P_95_1 = width;
          this.__P_95_2 = height;
          return true;
        }
        return false;
      }
    ...
    */
    destruct: function destruct() {
      for (var mode in this.__P_95_0) {
        if (this.__P_95_0.hasOwnProperty(mode)) {
          this.__P_95_0[mode].disconnectObject(this);
        }
      }
      delete this.__P_95_4;
      if (this.__P_95_5) {
        delete this.__P_95_5;
      }
      this._disposeMap("__P_95_0");
    }
  });
