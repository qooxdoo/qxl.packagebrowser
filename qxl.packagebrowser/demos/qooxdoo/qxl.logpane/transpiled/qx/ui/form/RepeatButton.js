  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.ui.form.RepeatButton", {
    ...
    construct: function construct(label, icon) {
      ...
      this.__P_213_0 = new qx.event.AcceleratingTimer();
    ...
    members: {
      ...
      */
      ...
      _onPointerUp: function _onPointerUp(e) {
        ...
        if (!this.hasState("abandoned")) {
          this.addState("hovered");
          if (this.hasState("pressed") && !this.__P_213_1) {
            this.execute();
          }
        }
        this.__P_213_3();
      ...
      */
       ...
       *
       */
      __P_213_2: function __P_213_2() {
        this.fireEvent("press");
        this.__P_213_1 = false;
        this.__P_213_0.set({
