  ...
  ************************************************************************ */
  ...
  qx.Mixin.define("qx.ui.form.MModelSelection", {
    construct: function construct() {
      ...
      this.__P_135_0.addListener("change", this.__P_135_1, this);
      this.addListener("changeSelection", this.__P_135_2, this);
    },
    events: {
      /**
    ...
    members: {
      ...
      __P_135_1: function __P_135_1() {
        ...
        var itemSelection = [];
        var modelSelection = this.__P_135_0.toArray();
      ...
      setModelSelection: function setModelSelection(modelSelection) {
        ...
        modelSelection.unshift(this.__P_135_0.getLength()); // remove index
        modelSelection.unshift(0); // start index

        var returnArray = this.__P_135_0.splice.apply(this.__P_135_0, modelSelection);
        returnArray.dispose();
      }
    },
