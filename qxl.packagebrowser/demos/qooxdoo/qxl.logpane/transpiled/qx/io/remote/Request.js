  ...
  qx.Class.define("qx.io.remote.Request", {
    ...
    */
    ...
    construct: function construct(vUrl, vMethod, vResponseType) {
      ...
      this.__P_206_4 = ++qx.io.remote.Request.__P_206_4;
    },
    /*
    *****************************************************************************
       EVENTS
    ...
    */
    ...
    members: {
      ...
      */
       ...
       */
      __P_206_5: qx.event.GlobalError.observeMethod(function (e) {
      ...
      */
      ...
      getRequestHeader: function getRequestHeader(vId) {
        return this.__P_206_0[vId] || null;
      },
      /**
      ...
      */
      ...
      setParameter: function setParameter(vId, vValue, bAsData) {
        if (bAsData) {
          this.__P_206_2[vId] = vValue;
        } else {
          this.__P_206_1[vId] = vValue;
        }
      },
      /**
      ...
      removeParameter: function removeParameter(vId, bFromData) {
        if (bFromData) {
          delete this.__P_206_2[vId];
        } else {
          delete this.__P_206_1[vId];
        }
      },
      /**
      ...
      getParameter: function getParameter(vId, bFromData) {
        if (bFromData) {
          return this.__P_206_2[vId] || null;
        } else {
          return this.__P_206_1[vId] || null;
        }
      },
      /**
      ...
      getParameters: function getParameters(bFromData) {
        return bFromData ? this.__P_206_2 : this.__P_206_1;
      },
      /*
      ---------------------------------------------------------------------------
        FORM FIELDS
      ...
      */
      ...
      getFormField: function getFormField(vId) {
        return this.__P_206_3[vId] || null;
      },
      /**
    ...
    */
    destruct: function destruct() {
      ...
      this.__P_206_0 = this.__P_206_1 = this.__P_206_2 = this.__P_206_3 = null;
    }
  });
