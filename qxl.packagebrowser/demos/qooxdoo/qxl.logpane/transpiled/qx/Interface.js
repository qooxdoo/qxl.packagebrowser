    ...
    statics: {
      ...
      */
      ...
      assertObject: function assertObject(object, iface) {
        ...
        this.__P_11_4(clazz, iface, true);
      ...
      */
       ...
       */
      __P_11_2: qx.core.Environment.select("qx.debug", {
      ...
      __P_11_5: qx.core.Environment.select("qx.debug", {
        "true": {
          extend: "object",
          // Interface | Interface[]
          statics: "object",
       ...
       */
      __P_11_6: qx.core.Environment.select("qx.debug", {
