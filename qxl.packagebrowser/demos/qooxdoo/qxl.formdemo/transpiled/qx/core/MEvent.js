  ...
  ************************************************************************ */
  ...
  qx.Mixin.define("qx.core.MEvent", {
    members: {
      ...
      __P_120_0: qx.event.Registration,
      /**
      ...
      addListener: function addListener(type, listener, self, capture) {
        if (!this.$$disposed) {
          return this.__P_120_0.addListener(this, type, listener, self, capture);
        }
        return null;
      },
      /**
      ...
      removeListener: function removeListener(type, listener, self, capture) {
        if (!this.$$disposed) {
          ...
          return this.__P_120_0.removeListener(this, type, listener, self, capture);
        }
        return false;
      },
      /**
      ...
      removeListenerById: function removeListenerById(id) {
        if (!this.$$disposed) {
          return this.__P_120_0.removeListenerById(this, id);
        }
        return false;
      },
      /**
      ...
      hasListener: function hasListener(type, capture) {
        return this.__P_120_0.hasListener(this, type, capture);
      },
      /**
      ...
      dispatchEvent: function dispatchEvent(evt) {
        if (!this.$$disposed) {
          return this.__P_120_0.dispatchEvent(this, evt);
        }
        return true;
      },
       ...
       */
      __P_120_3: function __P_120_3(result) {
        var _this = this;
        {
          ...
          var newPromise = result.then(function (result) {
            delete _this.__P_120_1[hashCode];
            var promise = _this.__P_120_2;
            if (promise && Object.keys(_this.__P_120_1).length == 0) {
              _this.__P_120_1 = null;
              _this.__P_120_2 = null;
              promise.resolve();
            }
            return result;
          })["catch"](function (err) {
          ...
          this.__P_120_1[hashCode] = newPromise;
          return newPromise;
        }
      },
      /**
        ...
        return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee() {
          ...
          return _regenerator().w(function (_context) {
            while (1) switch (_context.n) {
              ...
              case 1:
                if (!_this2.__P_120_2) {
                  _this2.__P_120_2 = new qx.Promise();
                }
                promise = _this2.__P_120_2;
                _context.n = 2;
                return promise;
              case 2:
                return _context.a(2);
      ...
      fireEvent: function fireEvent(type, clazz, args) {
        if (!this.$$disposed) {
          return this.__P_120_3(this.__P_120_0.fireEvent(this, type, clazz, args));
        }
        return true;
      },
      /**
      ...
      fireEventAsync: function fireEventAsync(type, clazz, args) {
        if (!this.$$disposed) {
          return this.__P_120_3(this.__P_120_0.fireEventAsync(this, type, clazz, args));
        }
      ...
      fireNonBubblingEvent: function fireNonBubblingEvent(type, clazz, args) {
        if (!this.$$disposed) {
          return this.__P_120_3(this.__P_120_0.fireNonBubblingEvent(this, type, clazz, args));
        }
        return true;
      },
      /**
      ...
      fireNonBubblingEventAsync: function fireNonBubblingEventAsync(type, clazz, args) {
        if (!this.$$disposed) {
          return this.__P_120_3(this.__P_120_0.fireNonBubblingEventAsync(this, type, clazz, args));
        }
        return qx.Promise.resolve(true);
      },
      /**
      ...
      fireDataEvent: function fireDataEvent(type, data, oldData, cancelable) {
        if (!this.$$disposed) {
          ...
          return this.__P_120_3(this.__P_120_0.fireEvent(this, type, qx.event.type.Data, [data, oldData, !!cancelable]));
        }
        return true;
      },
      /**
      ...
      fireDataEventAsync: function fireDataEventAsync(type, data, oldData, cancelable) {
        if (!this.$$disposed) {
          ...
          return this.__P_120_3(this.__P_120_0.fireEventAsync(this, type, qx.event.type.Data, [data, oldData, !!cancelable]));
        }
        return qx.Promise.resolve(true);
      }
    }
