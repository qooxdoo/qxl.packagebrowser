    ...
    */
    ...
    statics: {
      ...
      createHashCode: function createHashCode() {
        var hash = String(this.__P_103_1++ + this.__P_103_2);
        return hash;
      },
      /**
      ...
      fromHashCode: function fromHashCode(hash, suppressWarnings) {
        var obj = this.__P_103_0[hash] || null;
