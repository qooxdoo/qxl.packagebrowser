  ...
  qx.Class.define("qx.ui.form.Resetter", {
    ...
    members: {
      ...
      remove: function remove(field) {
        this.__P_58_1(field);
        for (var i = 0; i < this.__P_58_0.length; i++) {
          var storedItem = this.__P_58_0[i];
          if (storedItem.item === field) {
            this.__P_58_0.splice(i, 1);
            return true;
          }
        }
        return false;
      ...
      redefine: function redefine() {
        ...
        for (var i = 0; i < this.__P_58_0.length; i++) {
          var item = this.__P_58_0[i].item;
          // set the new init value for the item
          this.__P_58_0[i].init = item.getValue();
        }
      },
      /**
       ...
       * @private
       */
      __P_58_1: function __P_58_1(field) {
