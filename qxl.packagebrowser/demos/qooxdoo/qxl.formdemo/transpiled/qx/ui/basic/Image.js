      ...
      */
      ...
      __P_80_15: function __P_80_15(el, source) {
        ...
        if (isFont) {
          ...
          if (this.getScale()) {
            ...
            var font = this.__P_80_20(source);
          ...
          this.__P_80_21(ResourceManager.getImageWidth(source), ResourceManager.getImageHeight(source));
        }
      },
      __P_80_22: function __P_80_22(el, width, height) {
        if (this.getScale()) {
      ...
      _applyDimension: function _applyDimension() {
        ...
        if (isFont) {
          ...
          if (el) {
            ...
            this.__P_80_22(el, width, height);
          }
        } else {
          this.__P_80_21();
        }
      ...
      __P_80_18: function __P_80_18(el, source) {
        ...
        if (!ImageLoader.isFailed(source)) {
          ImageLoader.load(source, this.__P_80_23, this);
        } else {
          this.__P_80_12(el);
        }
      },
      ...
      __P_80_20: function __P_80_20(source) {
      ...
      __P_80_8: function __P_80_8(el, source) {
        ...
        if (isFont) {
          ...
          this.__P_80_22(el, this.__P_80_1, this.__P_80_2);
       ...
       */
      __P_80_23: function __P_80_23(source, imageInfo) {
       ...
       */
      __P_80_21: function __P_80_21(width, height) {
        if (width === undefined) {
          width = this.__P_80_1;
        }
        if (height === undefined) {
    ...
    destruct: function destruct() {
      for (var mode in this.__P_80_0) {
        if (this.__P_80_0.hasOwnProperty(mode)) {
          this.__P_80_0[mode].disconnectObject(this);
        }
      }
