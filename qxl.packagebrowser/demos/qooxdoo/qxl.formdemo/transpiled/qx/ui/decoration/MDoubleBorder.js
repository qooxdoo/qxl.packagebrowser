  ...
  ************************************************************************ */
  ...
  qx.Mixin.define("qx.ui.decoration.MDoubleBorder", {
    ...
    construct: function construct() {
      ...
      this._getDefaultInsetsForBorder = this.__P_205_0;
      this._styleBorder = this.__P_205_1;
    },
    /*
    *****************************************************************************
       PROPERTIES
    ...
    */
    ...
    members: {
       ...
       */
      __P_205_1: function __P_205_1(styles) {
        ...
        if (innerOpacity < 1) {
          this.__P_205_2(innerColor, innerOpacity);
        }
       ...
       */
      __P_205_2: function __P_205_2(innerColor, innerOpacity) {
