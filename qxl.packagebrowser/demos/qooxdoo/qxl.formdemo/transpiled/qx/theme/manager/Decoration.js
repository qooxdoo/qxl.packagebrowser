  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.theme.manager.Decoration", {
    ...
    construct: function construct() {
      ...
      this.__P_97_0 = [];
      this.__P_97_1 = qx.core.Environment.get("engine.name") == "mshtml" && qx.core.Environment.get("browser.documentmode") < 9;
    },
    /*
    *****************************************************************************
       PROPERTIES
    ...
    */
    ...
    members: {
      ...
      addCssClass: function addCssClass(value) {
        ...
        Object.keys(styles).sort().forEach(function (key) {
          ...
          if (qx.Bootstrap.isObject(styles[key])) {
            ...
            var innerSelector = this.__P_97_1 ? selector : selector + (inner ? ":" : "");
            this.__P_97_0.push(innerSelector + key);
      ...
      isCached: function isCached(decorator) {
        return !this.__P_97_2 ? false : qx.lang.Object.contains(this.__P_97_2, decorator);
      },
      // property apply
