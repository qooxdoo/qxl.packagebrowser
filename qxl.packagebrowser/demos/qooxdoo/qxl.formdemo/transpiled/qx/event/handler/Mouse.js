  ...
  qx.Class.define("qx.event.handler.Mouse", {
    ...
    */
    ...
    construct: function construct(manager) {
      ...
      this.__P_148_3 = qx.lang.Function.listener(this._onNative, this);
    ...
    */
    ...
    members: {
      ...
      */
      ...
      registerEvent: function registerEvent(target, type, capture) {
        if (qx.event.handler.Mouse.NON_BUBBLING_EVENTS[type]) {
          qx.bom.Event.addNativeListener(target, type, this.__P_148_3);
      ...
      unregisterEvent: function unregisterEvent(target, type, capture) {
        if (qx.event.handler.Mouse.NON_BUBBLING_EVENTS[type]) {
          qx.bom.Event.removeNativeListener(target, type, this.__P_148_3);
        } else if (qx.core.Environment.get("os.name") === "ios") {
      ...
      */
       ...
       */
      __P_148_10: function __P_148_10(domEvent, type, target) {
        if (!target) {
      ...
      */
      ...
      _initButtonObserver: function _initButtonObserver() {
        this.__P_148_4 = qx.lang.Function.listener(this._onButtonEvent, this);
        var Event = qx.bom.Event;
        Event.addNativeListener(this.__P_148_2, "mousedown", this.__P_148_4);
        Event.addNativeListener(this.__P_148_2, "mouseup", this.__P_148_4);
        Event.addNativeListener(this.__P_148_2, "click", this.__P_148_4);
        Event.addNativeListener(this.__P_148_2, "auxclick", this.__P_148_4);
        Event.addNativeListener(this.__P_148_2, "dblclick", this.__P_148_4);
        Event.addNativeListener(this.__P_148_2, "contextmenu", this.__P_148_4);
      },
      /**
      ...
      _initMoveObserver: function _initMoveObserver() {
        this.__P_148_5 = qx.lang.Function.listener(this._onMoveEvent, this);
        var Event = qx.bom.Event;
        Event.addNativeListener(this.__P_148_2, "mousemove", this.__P_148_5);
        Event.addNativeListener(this.__P_148_2, "mouseout", this.__P_148_5);
        Event.addNativeListener(this.__P_148_2, "mouseover", this.__P_148_5);
      },
      /**
      ...
      _initWheelObserver: function _initWheelObserver() {
        this.__P_148_6 = qx.lang.Function.listener(this._onWheelEvent, this);
        var data = qx.bom.client.Event.getMouseWheel(this.__P_148_1);
        qx.bom.Event.addNativeListener(data.target, data.type, this.__P_148_6);
      },
      /*
      ---------------------------------------------------------------------------
        OBSERVER STOP
      ...
      */
      ...
      _stopButtonObserver: function _stopButtonObserver() {
        var Event = qx.bom.Event;
        Event.removeNativeListener(this.__P_148_2, "mousedown", this.__P_148_4);
        Event.removeNativeListener(this.__P_148_2, "mouseup", this.__P_148_4);
        Event.removeNativeListener(this.__P_148_2, "click", this.__P_148_4);
        Event.removeNativeListener(this.__P_148_2, "dblclick", this.__P_148_4);
        Event.removeNativeListener(this.__P_148_2, "contextmenu", this.__P_148_4);
      },
      /**
      ...
      _stopMoveObserver: function _stopMoveObserver() {
        var Event = qx.bom.Event;
        Event.removeNativeListener(this.__P_148_2, "mousemove", this.__P_148_5);
        Event.removeNativeListener(this.__P_148_2, "mouseover", this.__P_148_5);
        Event.removeNativeListener(this.__P_148_2, "mouseout", this.__P_148_5);
      },
      /**
      ...
      _stopWheelObserver: function _stopWheelObserver() {
        var data = qx.bom.client.Event.getMouseWheel(this.__P_148_1);
        qx.bom.Event.removeNativeListener(data.target, data.type, this.__P_148_6);
      },
      /*
      ---------------------------------------------------------------------------
      ...
      */
      ...
      _onButtonEvent: qx.event.GlobalError.observeMethod(function (domEvent) {
        ...
        var target = qx.bom.Event.getTarget(domEvent);
        if (type == "click" && this.__P_148_9) {
          delete this.__P_148_9;
          return;
        }
        ...
        if (type == "auxclick" && domEvent.button == 1) {
          this.__P_148_10(domEvent, "click", target);
        }
        if (this.__P_148_12) {
          this.__P_148_12(domEvent, type, target);
        }
        if (this.__P_148_13 && !isDrag) {
          this.__P_148_13(domEvent, type, target);
        }
        this.__P_148_7 = type;
      }),
      /**
      ...
      _onWheelEvent: qx.event.GlobalError.observeMethod(function (domEvent) {
        this.__P_148_10(domEvent, "mousewheel");
      }),
      /*
      ---------------------------------------------------------------------------
      ...
      */
      ...
      __P_148_12: qx.core.Environment.select("engine.name", {
        opera: function opera(domEvent, type, target) {
          if (type == "mouseup" && domEvent.button == 2) {
            this.__P_148_10(domEvent, "contextmenu", target);
          }
        },
        "default": null
      }),
      ...
      __P_148_11: qx.core.Environment.select("engine.name", {
        mshtml: function mshtml(domEvent, type, target) {
          ...
          if (type == "mouseup" && this.__P_148_7 == "click") {
            this.__P_148_10(domEvent, "mousedown", target);
        ...
        "default": function _default(domEvent, type, target) {
          switch (type) {
            case "mousedown":
              ...
              break;
            case "mouseup":
              if (target !== this.__P_148_8) {
                var commonParent = qx.dom.Hierarchy.getCommonParent(target, this.__P_148_8);
                if (commonParent) {
                  this.__P_148_10(domEvent, "click", commonParent);
                }
              }
          }
        }
    ...
    */
    destruct: function destruct() {
      ...
      this.__P_148_0 = this.__P_148_1 = this.__P_148_2 = this.__P_148_8 = null;
    },
    /*
    *****************************************************************************
       DEFER
