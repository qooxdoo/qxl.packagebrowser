  ...
  qx.Bootstrap.define("qx.bom.client.Engine", {
    ...
    statics: {
      ...
      getVersion: function getVersion() {
        ...
        var version = "";
        if (qx.bom.client.Engine.__P_51_0()) {
        ...
        } else if (qx.bom.client.Engine.__P_51_1()) {
        ...
        } else if (qx.bom.client.Engine.__P_51_2()) {
        ...
        } else if (qx.bom.client.Engine.__P_51_3()) {
      ...
      __P_51_0: function __P_51_0() {
        ...
        if (qx.bom.client.Engine.__P_51_4()) {
          return true;
        }
        return false;
      },
