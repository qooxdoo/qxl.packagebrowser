  ...
  qx.Class.define("qxl.mobileshowcase.page.Form", {
    ...
    members: {
      ...
      _initialize: function _initialize() {
        qxl.mobileshowcase.page.Form.superclass.prototype._initialize.call(this);
      ...
      __P_9_16: function __P_9_16() {
        ...
        form.add(this.__P_9_1, "Username");
        ...
        form.add(this.__P_9_0, "Password");
        ...
        this.__P_9_0.bind("value", this.__P_9_9, "model");
      ...
      /**  Event handler */_onResetButtonTap: function _onResetButtonTap() {
        this.__P_9_12.reset();
      },
      /** Event handler. */_onSubmitButtonTap: function _onSubmitButtonTap() {
      ...
      _stop: function _stop() {
        ...
        qxl.mobileshowcase.page.Form.superclass.prototype._stop.call(this);
      }
    }
  });
