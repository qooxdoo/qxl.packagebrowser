  ...
  qx.Class.define("qxl.mobileshowcase.page.Dialog", {
    ...
    members: {
      ...
      _initialize: function _initialize() {
        qxl.mobileshowcase.page.Dialog.superclass.prototype._initialize.call(this);
        this.__P_11_8 = new qx.ui.mobile.basic.Label("No events received so far.");
        var resultsGroup = new qx.ui.mobile.form.Group([this.__P_11_8]);

        // EXAMPLE WIDGETS
        var busyIndicator = new qx.ui.mobile.dialog.BusyIndicator("Please wait...");
        this.__P_11_2 = new qx.ui.mobile.dialog.Popup(busyIndicator);
        ...
        this.__P_11_0 = this.__P_11_9(showAnchorButton);
        ...
        this.__P_11_3.setVisibleListItems(10);
        ...
        this.__P_11_7.addListener("changeSelection", this.__P_11_10, this);
