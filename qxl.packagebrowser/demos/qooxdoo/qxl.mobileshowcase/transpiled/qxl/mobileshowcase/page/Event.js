  ...
  qx.Class.define("qxl.mobileshowcase.page.Event", {
    ...
    members: {
      ...
      _initialize: function _initialize() {
        qxl.mobileshowcase.page.Event.superclass.prototype._initialize.call(this);
        ...
        this.__P_6_5.setTranslateX(-5000);
      ...
      ";
        ...
        qx.bom.element.Style.set(this.__P_6_3.getContentElement(), "background", "-" + this.__P_6_2 + "-radial-gradient(50% 50%, cover, #1a82f7, #2F2727)");
