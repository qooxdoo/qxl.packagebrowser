  ...
  ************************************************************************ */
  ...
  qx.Class.define("qxl.mobileshowcase.Application", {
    ...
    members: {
      ...
      main: function main() {
        // Call super class
        qxl.mobileshowcase.Application.superclass.prototype.main.call(this);
        ...
        */
        ...
        manager.addDetail([basic, events, carousel, drawer, list, tab, toolbar, form, animation, animationLanding, dialogs, dataBinding, maps, canvas, theming]);
