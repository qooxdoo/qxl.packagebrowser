  ...
  ************************************************************************ */
  ...
  qx.Bootstrap.define("qx.bom.request.Xhr", {
    ...
    construct: function construct() {
      var boundFunc = qx.Bootstrap.bind(this.__P_66_0, this);
    ...
    members: {
      ...
      */
        ...
        try {
          ...
          if (this.__P_66_16) {
            ...
            if (window.XDomainRequest) {
              this.readyState = 4;
              this.__P_66_18 = new window.XDomainRequest();
      ...
      send: function send(data) {
        ...
        data = data !== null && this.__P_66_22.indexOf(dataType) === -1 ? data.toString() : data;
      ...
      */
      ...
      dispose: function dispose() {
        ...
        this.__P_66_18.onprogress = noop;
      ...
      */
      ...
      __P_66_8: function __P_66_8() {
        ...
        this.__P_66_18 = this._createNativeXhr();
        ...
        // Reset flags
        this.__P_66_20 = this.__P_66_13 = this.__P_66_12 = false;
