    ...
    members: {
      ...
      */
      ...
      __P_166_2: function __P_166_2() {
        ...
        if (!menuBounds) {
          this.addListenerOnce("resize", this.__P_166_2, this);
          return;
        }
