  ...
  qx.Class.define("qx.ui.mobile.core.DomUpdatedHandler", {
    ...
    */
    ...
    construct: function construct(manager) {
      ...
      // Register
      qx.ui.mobile.core.DomUpdatedHandler.__P_146_2[this.toHashCode()] = this;
    },
    /*
    *****************************************************************************
       STATICS
      ...
      refresh: function refresh() {
        ...
        for (var hash in targets) {
          ...
          if (target && !target.$$disposed && target.isSeeable()) {
            ...
            this.__P_146_0.dispatchEvent(target, evt);
          }
        }
      }
    },
    ...
    */
    destruct: function destruct() {
      ...
      // Deregister
      delete qx.ui.mobile.core.DomUpdatedHandler.__P_146_2[this.toHashCode()];
    },
    /*
    *****************************************************************************
       DEFER
