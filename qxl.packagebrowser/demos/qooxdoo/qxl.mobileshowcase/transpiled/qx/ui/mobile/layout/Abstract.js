    ...
    members: {
      ...
      connectToWidget: function connectToWidget(widget) {
        ...
        if (widget) {
          ...
          if (this.__P_149_0) {
            for (var property in this.__P_149_0) {
              this.reset(property);
              this.set(property, this.__P_149_0[property]);
            }
          }
        } else {
          this.__P_149_0 = null;
      ...
      _getChildLayoutPropertyValue: function _getChildLayoutPropertyValue(widget, property) {
        var cache = this.__P_149_2(widget);
