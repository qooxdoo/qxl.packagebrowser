  ...
  qx.Class.define("qx.ui.form.RadioGroup", {
    ...
    */
    ...
    construct: function construct(varargs) {
      ...
      this.addListener("changeSelection", this.__P_109_1, this);
      if (varargs != null) {
    ...
    members: {
      ...
      */
      ...
      _applyInvalidMessage: function _applyInvalidMessage(value, old) {
        for (var i = 0; i < this.__P_109_0.length; i++) {
          this.__P_109_0[i].setInvalidMessage(value);
        }
      },
      // property apply
      _applyValid: function _applyValid(value, old) {
        for (var i = 0; i < this.__P_109_0.length; i++) {
          this.__P_109_0[i].setValid(value);
        }
      },
      // property apply
      ...
      */
      ...
      __P_109_1: function __P_109_1(e) {
        ...
        if (value) {
          ...
          if (this.__P_109_2() && value.isFocusable()) {
            value.focus();
          }
        }
      },
