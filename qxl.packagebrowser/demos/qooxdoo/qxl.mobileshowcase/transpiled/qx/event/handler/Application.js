    ...
    */
    ...
    members: {
      ...
      */
       ...
       *
       */
      __P_87_5: function __P_87_5() {
        // Wrapper qxloader needed to be compatible with old generator
        if (!this.__P_87_2 && this.__P_87_0 && qx.$$loader.scriptLoaded) {
      ...
      */
      ...
      _onNativeLoad: function _onNativeLoad() {
        var callback = qx.core.Environment.select("qx.globalErrorHandling", {
          "true": qx.event.GlobalError.observeMethod(this.__P_87_7),
          "false": this.__P_87_7
        });
      ...
      _onNativeUnload: function _onNativeUnload() {
        var callback = qx.core.Environment.select("qx.globalErrorHandling", {
          "true": qx.event.GlobalError.observeMethod(this.__P_87_8),
          "false": this.__P_87_8
        });
        callback.apply(this, arguments);
      },
