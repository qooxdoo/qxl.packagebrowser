    ...
    */
    ...
    members: {
      ...
      __P_85_10: function __P_85_10(date) {
        ...
        var thursdayWeek1 = this.__P_85_9(new Date(weekYear, 0, 4));
      ...
      parse: function parse(dateStr) {
        ...
        var date;
        if (this.__P_85_3 || dateValues.tzOffsetMins !== null) {
          ...
          date = new Date(utcMs);
          if (this.__P_85_3 && (dateValues.month !== date.getUTCMonth() || dateValues.year !== date.getUTCFullYear())) {
