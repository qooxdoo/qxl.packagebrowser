          ...
          var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
            ...
            return _regeneratorRuntime().wrap(function _callee$(_context) {
              while (1) switch (_context.prev = _context.next) {
                case 0:
                  _this.__P_58_0 = qxl.apiviewer.ClassLoader.getBaseUri() + _this._className.replace(/\./g, "/") + ".json";
                  _context.prev = 1;
                  _context.next = 4;
                  return qxl.apiviewer.RequestUtil.get(_this.__P_58_0);
                case 4:
                ...
                case 7:
                  ...
                  _this.error("Couldn't load file: " + _this.__P_58_0 + " " + _context.t0.message);
                case 10:
