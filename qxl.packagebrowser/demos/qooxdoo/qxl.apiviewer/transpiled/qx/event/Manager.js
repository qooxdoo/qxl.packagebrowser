    ...
    members: {
      ...
      */
      ...
      getListeners: function getListeners(target, type, capture) {
        ...
        var targetMap = this.__P_110_3.get(targetKey);
        if (!targetMap) {
          return null;
        }
      ...
      getAllListeners: function getAllListeners() {
        return Object.fromEntries(this.__P_110_3.entries().map(function (_ref) {
      ...
      importListeners: function importListeners(target, list) {
        ...
        if (!targetMap) {
          targetMap = new Map();
          this.__P_110_3.set(targetKey, targetMap);
        }
      ...
      removeAllListeners: function removeAllListeners(target) {
        ...
        this.__P_110_3["delete"](targetKey);
        return true;
      },
      /**
      ...
      */
      ...
      dispose: function dispose() {
        ...
        qx.util.DisposeUtil.disposeMap(this, "__P_110_5");
