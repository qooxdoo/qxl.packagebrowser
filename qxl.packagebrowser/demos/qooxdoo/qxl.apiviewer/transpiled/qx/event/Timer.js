  ...
  qx.Class.define("qx.event.Timer", {
    ...
    */
    ...
    statics: {
      ...
      once: function once(func, obj, timeout) {
        ...
        // read by a debugger
        timer.__P_134_1 = func;

        // Add event listener to interval
        timer.addListener("interval", function (e) {
          timer.stop();
          func.call(obj, e);
          delete timer.__P_134_1;
          timer.dispose();
          obj = null;
        }, obj);
    ...
    members: {
      ...
      */
      ...
      _applyEnabled: function _applyEnabled(value, old) {
        if (old) {
          window.clearInterval(this.__P_134_2);
          this.__P_134_2 = null;
        } else if (value) {
          this.__P_134_2 = window.setInterval(this.__P_134_0, this.getInterval());
        }
      },
      /*
      ---------------------------------------------------------------------------
    ...
    */
    destruct: function destruct() {
      ...
      this.__P_134_2 = this.__P_134_0 = null;
    }
  });
