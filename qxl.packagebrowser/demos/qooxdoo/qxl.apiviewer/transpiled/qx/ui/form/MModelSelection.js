  ...
  ************************************************************************ */
  ...
  qx.Mixin.define("qx.ui.form.MModelSelection", {
    construct: function construct() {
      ...
      this.__P_124_0.addListener("change", this.__P_124_1, this);
      this.addListener("changeSelection", this.__P_124_2, this);
    },
    events: {
      /**
    ...
    members: {
      ...
      __P_124_1: function __P_124_1() {
        ...
        var itemSelection = [];
        var modelSelection = this.__P_124_0.toArray();
      ...
      setModelSelection: function setModelSelection(modelSelection) {
        ...
        modelSelection.unshift(this.__P_124_0.getLength()); // remove index
        modelSelection.unshift(0); // start index

        var returnArray = this.__P_124_0.splice.apply(this.__P_124_0, modelSelection);
        returnArray.dispose();
      }
    },
