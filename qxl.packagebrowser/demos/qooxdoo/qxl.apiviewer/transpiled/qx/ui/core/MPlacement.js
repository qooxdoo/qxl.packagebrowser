    ...
    members: {
      ...
      placeToWidget: function placeToWidget(target, liveupdate) {
        ...
        if (liveupdate) {
          ...
          qx.event.Idle.getInstance().addListener("interval", this.__P_88_2);
        ...
        if (coords != null) {
          ...
          if (boundsAreEqual(coords, this.__P_88_5) && boundsAreEqual(size, this.__P_88_6)) {
            return true;
          }
          this.__P_88_5 = coords;
          this.__P_88_6 = size;
          this._place(coords);
          return true;
        } else {
      ...
      placeToElement: function placeToElement(elem, liveupdate) {
        ...
        if (liveupdate) {
          ...
          this.addListener("disappear", function () {
            if (_this.__P_88_2) {
              qx.event.Idle.getInstance().removeListener("interval", _this.__P_88_2);
              _this.__P_88_2 = null;
            }
          });
        }
       ...
       */
      __P_88_8: function __P_88_8(callback) {
        var _this2 = this;
        var size = null;
