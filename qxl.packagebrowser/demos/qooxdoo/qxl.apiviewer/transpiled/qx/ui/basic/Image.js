      ...
      */
      ...
      __P_87_15: function __P_87_15(el, source) {
        ...
        if (isFont) {
          ...
          if (this.getScale()) {
            ...
            var font = this.__P_87_20(source);
          ...
          this.__P_87_21(ResourceManager.getImageWidth(source), ResourceManager.getImageHeight(source));
        }
      },
      __P_87_22: function __P_87_22(el, width, height) {
        if (this.getScale()) {
      ...
      _applyDimension: function _applyDimension() {
        ...
        if (isFont) {
          ...
          if (el) {
            ...
            this.__P_87_22(el, width, height);
          }
        } else {
          this.__P_87_21();
        }
      ...
      __P_87_18: function __P_87_18(el, source) {
        ...
        if (!ImageLoader.isFailed(source)) {
          ImageLoader.load(source, this.__P_87_23, this);
        } else {
          this.__P_87_12(el);
        }
      },
      ...
      __P_87_20: function __P_87_20(source) {
      ...
      __P_87_8: function __P_87_8(el, source) {
        ...
        if (isFont) {
          ...
          this.__P_87_22(el, this.__P_87_1, this.__P_87_2);
       ...
       */
      __P_87_23: function __P_87_23(source, imageInfo) {
       ...
       */
      __P_87_21: function __P_87_21(width, height) {
        if (width === undefined) {
          width = this.__P_87_1;
        }
        if (height === undefined) {
