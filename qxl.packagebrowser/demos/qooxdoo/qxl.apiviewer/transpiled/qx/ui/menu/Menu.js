    ...
    members: {
      ...
      */
      ...
      __P_28_2: function __P_28_2() {
        ...
        if (!menuBounds) {
          this.addListenerOnce("resize", this.__P_28_2, this);
          return;
        }
