    ...
    members: {
      ...
      */
      ...
      __P_45_2: function __P_45_2() {
        ...
        if (!menuBounds) {
          this.addListenerOnce("resize", this.__P_45_2, this);
          return;
        }
      ...
      syncWidget: function syncWidget(jobs) {
        ...
        if (this.__P_45_1) {
          this.__P_45_1.call(this);
          delete this.__P_45_1;
        }
      },
      /*
      ---------------------------------------------------------------------------
