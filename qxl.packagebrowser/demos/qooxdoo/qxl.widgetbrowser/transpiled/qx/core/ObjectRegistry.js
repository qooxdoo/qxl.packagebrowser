    ...
    */
    ...
    statics: {
      ...
      createHashCode: function createHashCode() {
        var hash = String(this.__P_142_1++ + this.__P_142_2);
        return hash;
      },
      /**
      ...
      fromHashCode: function fromHashCode(hash, suppressWarnings) {
        var obj = this.__P_142_0[hash] || null;
