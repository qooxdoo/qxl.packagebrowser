    ...
    members: {
      ...
      _applyQxObjectId: function _applyQxObjectId(value, oldValue) {
        if (!this.__P_193_1) {
          ...
          if (owner) {
            owner.__P_193_2(this, value, oldValue);
          }
       ...
       */
      __P_193_2: function __P_193_2(obj, newId, oldId) {
        delete this.__P_193_0[oldId];
        this.__P_193_0[newId] = obj;
      },
      /**
      ...
      _cascadeQxObjectIdChanges: function _cascadeQxObjectIdChanges() {
        ...
        if (this.__P_193_0) {
          for (var name in this.__P_193_0) {
            var obj = this.__P_193_0[name];
       ...
       */
      __P_193_3: function __P_193_3(obj) {
        if (obj !== null) {
      ...
      getOwnedQxObjects: function getOwnedQxObjects() {
        return this.__P_193_0 ? Object.values(this.__P_193_0) : [];
      }
    }
  });
