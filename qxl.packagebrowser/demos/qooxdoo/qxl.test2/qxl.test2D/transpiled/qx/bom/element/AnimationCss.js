  ...
  ************************************************************************ */
  ...
  qx.Bootstrap.define("qx.bom.element.AnimationCss", {
    statics: {
      ...
      __P_102_5: qx.core.Environment.get("css.animation"),
      /**
      ...
      _animate: function _animate(el, desc, duration, reverse) {
        ...
        if (!this.__P_102_0) {
          this.__P_102_0 = qx.bom.Stylesheet.createElement();
        }
        ...
        if (this.__P_102_5 != null) {
          var name = this.__P_102_7(keyFrames, reverse);
          var style = name + " " + duration + "ms " + desc.timing + " " + (desc.delay ? desc.delay + "ms " : "") + desc.repeat + " " + (desc.alternate ? "alternate" : "");
          qx.bom.Event.addNativeListener(el, this.__P_102_5["start-event"], this.__P_102_8);
          qx.bom.Event.addNativeListener(el, this.__P_102_5["iteration-event"], this.__P_102_9);
          qx.bom.Event.addNativeListener(el, this.__P_102_5["end-event"], this.__P_102_10);
          el.style[qx.lang.String.camelCase(this.__P_102_5["name"])] = style;
          // use the fill mode property if available and suitable
          if (keep && keep == 100 && this.__P_102_5["fill-mode"]) {
            el.style[this.__P_102_5["fill-mode"]] = "forwards";
          }
        }
        ...
        if (this.__P_102_5 == null) {
          window.setTimeout(function () {
            qx.bom.element.AnimationCss.__P_102_10({
              target: el
            });
          }, 0);
        }
       ...
       */
      __P_102_8: function __P_102_8(e) {
       ...
       * @param e {Event} The native event from the browser.
       */
      __P_102_10: function __P_102_10(e) {
        var el = e.target;
        ...
        if (qx.bom.element.AnimationCss.__P_102_5 != null) {
          // reset the styling
          var key = qx.lang.String.camelCase(qx.bom.element.AnimationCss.__P_102_5["name"]);
          el.style[key] = "";
          qx.bom.Event.removeNativeListener(el, qx.bom.element.AnimationCss.__P_102_5["name"], qx.bom.element.AnimationCss.__P_102_10);
        }
        if (desc.origin != null) {
          qx.bom.element.Transform.setOrigin(el, "");
        }
        qx.bom.element.AnimationCss.__P_102_11(el, desc.keyFrames[animation.keep]);
        el.$$animation = null;
        animation.el = null;
       ...
       */
      __P_102_11: function __P_102_11(el, endFrame) {
        // keep the element at this animation step
        var transforms;
        for (var style in endFrame) {
          if (style in qx.bom.element.AnimationCss.__P_102_4) {
            if (!transforms) {
              transforms = {};
            }
       ...
       */
      __P_102_6: function __P_102_6(desc) {
       ...
       * @param desc {Map} The description of the animation.
       */
      __P_102_12: qx.core.Environment.select("qx.debug", {
       ...
       */
      __P_102_7: function __P_102_7(frames, reverse) {
        var rule = "";
        ...
        // cached shorthand
        if (this.__P_102_3[rule]) {
          return this.__P_102_3[rule];
        }
        var name = this.__P_102_1 + this.__P_102_2++;
        var selector = this.__P_102_5["keyframes"] + " " + name;
        qx.bom.Stylesheet.addRule(this.__P_102_0, selector, rule);
        this.__P_102_3[rule] = name;
        return name;
      },
      /**
      ...
      __P_102_13: function __P_102_13() {
        this.__P_102_2 = 0;
        if (this.__P_102_0) {
          this.__P_102_0.ownerNode.remove();
          this.__P_102_0 = null;
          this.__P_102_3 = {};
        }
      }
