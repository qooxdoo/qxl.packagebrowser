  ...
  qx.Class.define("qx.core.Init", {
    ...
    */
    defer: function defer(statics) {
      ...
      qx.event.Registration.addListener(window, "shutdown", statics.__P_9_1, statics);
      qx.event.Registration.addListener(window, "beforeunload", statics.__P_9_0, statics);
    }
  });
