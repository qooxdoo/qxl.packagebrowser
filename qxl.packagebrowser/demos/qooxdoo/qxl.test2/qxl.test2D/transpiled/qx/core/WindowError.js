  ...
  qx.Bootstrap.define("qx.core.WindowError", {
    ...
    */
    ...
    construct: function construct(failMessage, uri, lineNumber, columnNumber, sourceException) {
      ...
      this.__P_45_0 = failMessage;
      this.__P_45_1 = uri || "";
      this.__P_45_2 = lineNumber === undefined ? -1 : lineNumber;
      this.__P_45_3 = columnNumber === undefined ? -1 : columnNumber;
      this.__P_45_4 = sourceException;
    },
    /*
    *****************************************************************************
       MEMBERS
