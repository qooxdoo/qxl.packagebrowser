  ...
  qx.Class.define("qx.ui.core.queue.Manager", {
    statics: {
      ...
      flush: function flush() {
        ...
        self.__P_26_1 = true;
        var jobs = self.__P_26_2;
        self.__P_26_5(function () {
          // Process jobs
       ...
       */
      __P_26_5: qx.core.Environment.select("qx.debug", {
        ...
        "false": function _false(callback, finallyCode) {
          ...
          try {
            ...
            self.__P_26_4 = false;
            self.__P_26_3 += 1;
            if (self.__P_26_3 <= self.MAX_RETRIES) {
              self.scheduleFlush();
            } else {
              throw new Error("Fatal Error: Flush terminated " + (self.__P_26_3 - 1) + " times in a row" + " due to exceptions in user code. The application has to be reloaded!");
            }
            throw e;
          } finally {
            finallyCode();
    ...
    */
    defer: function defer(statics) {
      ...
      qx.event.Registration.addListener(window, "useraction", qx.core.Environment.get("event.touch") ? statics.__P_26_6 : statics.flush);
    }
  });
