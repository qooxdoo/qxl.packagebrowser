    ...
    members: {
      ...
      */
      ...
      __P_76_2: function __P_76_2() {
        ...
        if (!menuBounds) {
          this.addListenerOnce("resize", this.__P_76_2, this);
          return;
        }
      ...
      syncWidget: function syncWidget(jobs) {
        ...
        if (this.__P_76_1) {
          this.__P_76_1.call(this);
          delete this.__P_76_1;
        }
      },
      /*
      ---------------------------------------------------------------------------
