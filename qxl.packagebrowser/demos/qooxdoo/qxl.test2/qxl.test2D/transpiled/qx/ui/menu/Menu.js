    ...
    members: {
      ...
      */
      ...
      __P_78_2: function __P_78_2() {
        ...
        if (!menuBounds) {
          this.addListenerOnce("resize", this.__P_78_2, this);
          return;
        }
      ...
      syncWidget: function syncWidget(jobs) {
        ...
        if (this.__P_78_1) {
          this.__P_78_1.call(this);
          delete this.__P_78_1;
        }
      },
      /*
      ---------------------------------------------------------------------------
