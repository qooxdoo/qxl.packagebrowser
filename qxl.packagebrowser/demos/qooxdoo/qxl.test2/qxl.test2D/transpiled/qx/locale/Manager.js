  ...
  qx.Class.define("qx.locale.Manager", {
    ...
    */
    construct: function construct() {
      ...
      this.__P_80_0 = qx.$$translations || {};
      this.__P_80_1 = qx.$$locales || {};
      this.initLocale();
      this.__P_80_2 = this.getLocale();
    },
    /*
    *****************************************************************************
       STATICS
    ...
    */
    ...
    members: {
      __P_80_3: qx.core.Environment.get("locale.default"),
      __P_80_4: null,
      __P_80_5: null,
      __P_80_0: null,
      __P_80_1: null,
      ...
      getAvailableLocales: function getAvailableLocales(includeNonloaded) {
        var locales = [];
        for (var locale in this.__P_80_1) {
          if (locale != this.__P_80_3) {
            if (this.__P_80_1[locale] === null && !includeNonloaded) {
       ...
       */
      __P_80_6: function __P_80_6(locale) {
        var language;
        if (locale == null) {
          return null;
        }
      ...
      _applyLocale: function _applyLocale(value, old) {
        this.__P_80_4 = value;
        this.__P_80_5 = this.__P_80_6(value);
      },
      /**
      ...
      translate: function translate(messageId, args, locale) {
        var catalog = this.__P_80_0;
        return this.__P_80_7(catalog, messageId, args, locale);
      },
      /**
       ...
       * @return {String|LocalizedString} translated message or localized string
       */
      __P_80_7: function __P_80_7(catalog, messageId, args, locale) {
        var txt;
        if (!catalog) {
          return messageId;
        }
        if (locale) {
          var language = this.__P_80_6(locale);
        } else {
          locale = this.__P_80_4;
          language = this.__P_80_5;
        }
        ...
        // C
        if (!txt && catalog[this.__P_80_3]) {
          txt = catalog[this.__P_80_3][messageId];
        }
        if (!txt) {
          txt = messageId;
        }
        ...
        {
          txt = new qx.locale.LocalizedString(txt, messageId, args, catalog === this.__P_80_1);
        }
        return txt;
      }
    }
