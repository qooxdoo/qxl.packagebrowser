    ...
    members: {
      ...
      */
      ...
      _applyNumberFormat: function _applyNumberFormat(value, old) {
        ...
        this._applyValue(this.__P_425_0, undefined);
      },
      /**
      ...
      */
      ...
      _onTextChange: function _onTextChange(e) {
        ...
        if (!isNaN(value)) {
          ...
          if (value === this.__P_425_0) {
            this._applyValue(this.__P_425_0);
          } else {
            this.setValue(value);
          }
        } else {
