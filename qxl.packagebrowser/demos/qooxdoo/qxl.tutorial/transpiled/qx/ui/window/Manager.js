  ...
  qx.Class.define("qx.ui.window.Manager", {
    ...
    */
    ...
    members: {
      ...
      syncWidget: function syncWidget() {
        ...
        this.__P_569_0.forceUnblock();
        var windows = this.__P_569_0.getWindows();
        ...
        for (var i = 0, l = windows.length; i < l; i++) {
          ...
          if (win.isModal()) {
            ...
            this.__P_569_0.blockContent(zIndexModal - 1);
            zIndexModal += 2;
        ...
        this.__P_569_0.setActiveWindow(active);
      },
      // interface implementation
    ...
    */
    destruct: function destruct() {
      this._disposeObjects("__P_569_0");
    }
  });
