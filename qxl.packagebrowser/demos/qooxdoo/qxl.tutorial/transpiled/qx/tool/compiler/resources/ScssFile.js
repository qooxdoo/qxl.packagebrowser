...
(function () {
  ...
  qx.Class.define("qx.tool.compiler.resources.ScssFile", {
    ...
    construct: function construct(target, library, filename) {
      ...
      this.__P_619_0 = library;
      this.__filename = filename;
      this.__P_619_1 = target;
      this.__P_619_2 = {};
      this.__P_619_3 = {};
    },
    properties: {
    ...
    members: {
        ...
        return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
          ...
          return _regeneratorRuntime().wrap(function _callee$(_context) {
            while (1) switch (_context.prev = _context.next) {
              case 0:
                _this.__P_619_4 = path.dirname(outputFilename);
                _this.__P_619_5 = {};
                _context.next = 4;
                return _this.loadSource(_this.__filename, _this.__P_619_0);
              case 4:
                ...
                return new qx.Promise(function (resolve, reject) {
                  sass.render({
                    ...
                    importer: function importer(url, prev, done) {
                      var contents = _this.__P_619_2[url];
                      if (!contents) {
                        var tmp = _this.__P_619_3[url];
                        if (tmp) {
                          contents = _this.__P_619_2[tmp];
                        }
                      }
                      return contents ? {
                        contents: contents
                    ...
                    functions: {
                      "qooxdooUrl($filename, $url)": function qooxdooUrl$filename$url($filename, $url, done) {
                        return _this.__P_619_6($filename, $url, done);
                      }
                    }
              ...
              case 7:
                return _context.abrupt("return", Object.keys(_this.__P_619_2));
              case 8:
              case "end":
      ...
      _analyseFilename: function _analyseFilename(url, currentFilename) {
        ...
        var library = this.__P_619_1.getAnalyser().getLibraries().find(function (library) {
      ...
      reloadSource: function reloadSource(filename) {
        ...
        delete this.__P_619_2[filename];
          ...
          return _regeneratorRuntime().wrap(function _callee2$(_context2) {
            while (1) switch (_context2.prev = _context2.next) {
              case 0:
                ...
                _this2.__P_619_2[absFilename] = null;
                return _context2.abrupt("return", null);
              case 8:
                if (!(_this2.__P_619_2[absFilename] !== undefined)) {
                  _context2.next = 10;
                  break;
                }
                return _context2.abrupt("return", qx.Promise.resolve(_this2.__P_619_2[absFilename]));
              case 10:
                _context2.next = 12;
              ...
              case 12:
                ...
                contents = contents.replace(/@import\s+["']([^;]+)["']/gi, function (match, p1, offset) {
                  ...
                  var newLibrary = _this2.__P_619_1.getAnalyser().findLibrary(pathInfo.namespace);
                  if (!newLibrary) {
                ...
                contents = contents.replace(/\burl\s*\(\s*([^\)]+)*\)/gi, function (match, url) {
                  ...
                  if (pathInfo) {
                    ...
                    if (pathInfo.namespace) {
                      var targetFile = path.relative(process.cwd(), path.join(_this2.__P_619_1.getOutputDir(), "resource", pathInfo.filename));
                      var relative = path.relative(_this2.__P_619_4, targetFile);
                      return "url(\"".concat(relative, "\")");
                    }
                  }
                  return "url(\"".concat(url, "\")");
                });
                _this2.__P_619_2[absFilename] = contents;
                _this2.__P_619_3[filename] = absFilename;
                _context2.next = 20;
      ...
      getSourceFilenames: function getSourceFilenames() {
        return Object.keys(this.__P_619_2);
      },
      __P_619_6: function __P_619_6($filename, $url, done) {
        ...
        if (pathInfo) {
          ...
          if (pathInfo.namespace) {
            var targetFile = path.relative(process.cwd(), path.join(this.__P_619_1.getOutputDir(), "resource", pathInfo.filename));
            var relative = path.relative(this.__P_619_4, targetFile);
