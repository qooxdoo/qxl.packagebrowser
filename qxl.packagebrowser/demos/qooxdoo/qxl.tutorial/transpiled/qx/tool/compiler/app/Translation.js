  ...
  qx.Class.define("qx.tool.compiler.app.Translation", {
    ...
    members: {
        ...
        return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee() {
          ...
          return _regenerator().w(function (_context) {
            while (1) switch (_context.n) {
              ...
              case 2:
                stat = _context.v;
                if (!(stat && _this.__P_617_2 == stat.mtime)) {
                  _context.n = 3;
                  break;
                }
      ...
      read: function read() {
        ...
        return t.__P_617_3 = new Promise(function (resolve, reject) {
          t.__P_617_0 = {};
          t.__P_617_1 = {};
      ...
      writeTo: function writeTo(filename, cb) {
        ...
        for (var msgid in t.__P_617_0) {
          var entry = t.__P_617_0[msgid];
          if (entry.comments) {
      ...
      deleteEntry: function deleteEntry(id) {
        var entry = this.__P_617_0[id] || null;
        delete this.__P_617_0[id];
        return entry;
      },
      /**
      ...
      getOrCreateEntry: function getOrCreateEntry(id) {
        var t = this;
        var entry = t.__P_617_0[id];
        if (!entry) {
          entry = t.__P_617_0[id] = {
            msgid: id
          };
        }
        return entry;
