...
(function () {
  ...
  qx.Class.define("qx.tool.compiler.resources.Manager", {
    ...
    construct: function construct(analyser) {
      ...
      this.__P_616_0 = analyser;
      this.__P_616_1 = analyser.getResDbFilename() || "resource-db.json";
      this.__P_616_2 = [new qx.tool.compiler.resources.ImageLoader(this), new qx.tool.compiler.resources.MetaLoader(this)];
      this.__P_616_3 = [new qx.tool.compiler.resources.ScssConverter(), new qx.tool.compiler.resources.ScssIncludeConverter()];
    },
    members: {
        ...
        return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee() {
          ...
          return _regenerator().w(function (_context) {
            while (1) switch (_context.n) {
              case 0:
                _context.n = 1;
                return qx.tool.utils.Json.loadJsonAsync(_this.__P_616_1);
              case 1:
                _t = _context.v;
                if (_t) {
                  _context.n = 2;
          ...
          return _regenerator().w(function (_context2) {
            while (1) switch (_context2.n) {
              case 0:
                ...
                return _context2.a(2, qx.tool.utils.Json.saveJsonAsync(_this2.__P_616_1, _this2.__P_616_4));
            }
          }, _callee2);
        }))();
      },
      ...
      findLibrariesForResource: function findLibrariesForResource(uri) {
        ...
        var findLibrariesForResourceImpl = function findLibrariesForResourceImpl() {
          ...
          if (path.isAbsolute(uri)) {
            var library = _this3.__P_616_0.getLibraries().find(function (lib) {
          ...
          if (pos !== -1) {
            ...
            var _library = _this3.__P_616_0.findLibrary(ns);
          ...
          if (pos === -1) {
            var _library2 = _this3.__P_616_5[uri] || null;
            return _library2;
          }
          ...
          // Fast folder match
          if (isFolderMatch) {
            var _library3 = _this3.__P_616_5[uri] || null;
            return _library3;
          }

          // Slow scan
          if (!_this3.__P_616_6) {
            _this3.__P_616_6 = Object.keys(_this3.__P_616_5).sort();
          }
          var thisUriPos = qx.tool.utils.Values.binaryStartsWith(_this3.__P_616_6, uri);
          if (thisUriPos > -1) {
            var libraries = {};
            for (; thisUriPos < _this3.__P_616_6.length; thisUriPos++) {
              var thisUri = _this3.__P_616_6[thisUriPos];
              ...
              if (pos !== -1) {
                ns = uri.substring(0, pos);
                if (!libraries[ns]) {
                  libraries[ns] = _this3.__P_616_0.findLibrary(ns);
                }
              }
            }
          ...
          return _regenerator().w(function (_context8) {
            while (1) switch (_context8.n) {
              case 0:
                ...
                t.__P_616_5 = {};
                _this4.__P_616_6 = null;
                _this4.__P_616_7 = {};
                _context8.n = 1;
                return qx.Promise.all(t.__P_616_0.getLibraries().map(/*#__PURE__*/function () {
              ...
              case 1:
                _context8.n = 2;
                return qx.tool.utils.Promisify.poolEachOf(Object.values(_this4.__P_616_7), 10, /*#__PURE__*/function () {
                        ...
                        case 1:
                          ...
                          if (fileInfo.meta) {
                            for (altPath in fileInfo.meta) {
                              ...
                              otherAsset = _this4.__P_616_7[lib.getNamespace() + ":" + altPath];
                              if (otherAsset) {
                          ...
                          if (fileInfo.dependsOn) {
                            ...
                            fileInfo.dependsOn.forEach(function (str) {
                              var otherAsset = _this4.__P_616_7[str];
                              if (!otherAsset) {
       ...
       */
      __P_616_8: function __P_616_8(asset) {
        var _this5 = this;
        this.__P_616_7[asset.toUri()] = asset;
        ...
        filename.split("/").forEach(function (seg, index) {
          ...
          tmp += seg;
          var current = _this5.__P_616_5[tmp];
          if (current) {
            if (qx.lang.Type.isArray(current)) {
              ...
              current = _this5.__P_616_5[tmp] = [current, library];
            }
          } else {
            _this5.__P_616_5[tmp] = library;
          }
        });
        asset.setLoaders(this.__P_616_2.filter(function (loader) {
          return loader.matches(filename, library);
        }));
        asset.setConverters(this.__P_616_3.filter(function (converter) {
      ...
      getAsset: function getAsset(srcPath, create, isThemeFile) {
        ...
        var asset = this.__P_616_7[library.getNamespace() + ":" + srcPath];
        if (!asset && create) {
          asset = new qx.tool.compiler.resources.Asset(library, srcPath, {
            resourcePath: "resourcePath"
          });
          this.__P_616_8(asset);
        }
        return asset;
      },
      /**
      ...
      getAssetsForPaths: function getAssetsForPaths(srcPaths) {
        ...
        srcPaths.forEach(function (srcPath) {
          ...
          if (pos > -1) {
            ...
            var tmp = _this6.__P_616_0.findLibrary(ns);
            libraries = tmp ? [tmp] : [];
          ...
          libraries.forEach(function (library) {
            ...
            resourceNames.forEach(function (resourceName) {
              ...
              var asset = _this6.__P_616_7[library.getNamespace() + ":" + resourceName];
