...
(function () {
  ...
  qx.Class.define("qx.tool.compiler.Analyser", {
    ...
    construct: function construct(dbFilename) {
      ...
      this.__P_599_0 = dbFilename || "db.json";
      this.__P_599_1 = [];
      this.__P_599_2 = {};
      this.__P_599_3 = new qx.tool.utils.IndexedArray();
      this.__P_599_4 = {};
      this.__P_599_5 = {};
      this.__P_599_6 = {};
      this.__P_599_7 = {};
    ...
    members: {
      ...
      initialScan: function initialScan(cb) {
        ...
        function (cb) {
          ...
          t.__P_599_10.findAllResources().then(function () {
            return cb();
          })["catch"](cb);
        },
        // Find all classes
        function (cb) {
          async.each(t.__P_599_1, function (library, cb) {
      ...
      resetDatabase: function resetDatabase() {
        this.__P_599_11 = null;
        if (this.__P_599_10) {
          this.__P_599_10.dispose();
          this.__P_599_10 = null;
        }
        this.__P_599_9 = false;
        return this.open();
      },
      /**
       * Saves the database
          ...
          return _regenerator().w(function (_context2) {
            while (1) switch (_context2.n) {
              case 0:
                ...
                _context2.n = 1;
                return _this2.fireDataEventAsync("saveDatabase", _this2.__P_599_11);
              case 1:
                _context2.n = 2;
                return qx.tool.utils.Json.saveJsonAsync(_this2.getDbFilename(), _this2.__P_599_11).then(function () {
                  return _this2.__P_599_10 && _this2.__P_599_10.saveDatabase();
                });
              case 2:
            ...
            while (1) switch (_context4.p = _context4.n) {
              case 0:
                getIndirectLoadDependencies = function _getIndirectLoadDepen(className) {
                  var deps = [];
                  var info = t.__P_599_11.classInfo[className];
                ...
                t = _this3;
                if (!_this3.__P_599_11) {
                  _this3.__P_599_11 = {};
                }
                db = _this3.__P_599_11;
                metaWrittenLog = {};
                compiledClasses = {};
                ...
                //  in mid parse)
                _context4.n = 1;
                return qx.tool.utils.Promisify.map(_this3.__P_599_1, /*#__PURE__*/function () {
              ...
              case 1:
                classes = t.__P_599_12 = t.__P_599_3.toArray();
                classIndex = 0;
              case 2:
      ...
      _addRequiredClass: function _addRequiredClass(className) {
        ...
        // Add it
        if (t.__P_599_12.indexOf(className) == -1) {
          t.__P_599_12.push(className);
        }
      },
      /**
      ...
      getCachedClassInfo: function getCachedClassInfo(className) {
        return this.__P_599_11 ? this.__P_599_11.classInfo[className] : null;
      },
      /**
       * Loads a class
            ...
            while (1) switch (_context6.n) {
              ...
              case 1:
                return _context6.a(2, qx.tool.compiler.app.Cldr.loadCLDR(locale).then(function (cldr) {
                  return t.__P_599_4[locale] = cldr;
                }));
            }
          }, _callee6);
        }))();
          ...
          return _regenerator().w(function (_context7) {
            while (1) switch (_context7.n) {
              case 0:
                ...
                translation = t.__P_599_5[id];
                if (translation) {
                  _context7.n = 1;
                  break;
                }
                translation = t.__P_599_5[id] = new qx.tool.compiler.app.Translation(library, locale);
                    ...
                    return _regenerator().w(function (_context0) {
                      while (1) switch (_context0.n) {
                        ...
                        case 2:
                          ...
                          _context0.n = 3;
                          return qx.Promise.all(_this6.__P_599_12.map(/*#__PURE__*/function () {
      ...
      addLibrary: function addLibrary(library) {
        var existingLibrary = this.__P_599_2[library.getNamespace()];
        if (existingLibrary) {
        ...
        this.__P_599_1.push(library);
        this.__P_599_2[library.getNamespace()] = library;
      },
      /**
      ...
      getFont: function getFont(name, create) {
        var font = this.__P_599_8[name] || null;
        if (!font && create) {
          font = this.__P_599_8[name] = new qx.tool.compiler.app.ManifestFont(name);
        }
        return font;
      },
      /**
      ...
      isFontAsset: function isFontAsset(filename) {
        ...
        if (filename.endsWith("svg")) {
          for (var fontName in this.__P_599_8) {
            var font = this.__P_599_8[fontName];
      ...
      removeClass: function removeClass(classname) {
        this.__P_599_3.remove(classname);
      },
      /**
      ...
      getSymbolType: function getSymbolType(name) {
        var t = this;
        for (var j = 0; j < t.__P_599_1.length; j++) {
          var library = t.__P_599_1[j];
      ...
      getLibraryFromClassname: function getLibraryFromClassname(className) {
        var t = this;
        var info = this.__P_599_6[className];
        if (info) {
          return info.library;
        }
        for (var j = 0; j < t.__P_599_1.length; j++) {
      ...
      setEnvironmentCheck: function setEnvironmentCheck(key, value) {
        if (_typeof(key) == "object") {
          var map = key;
          for (key in map) {
            this.__P_599_7[key] = map[key];
          }
        } else if (value === undefined) {
          delete this.__P_599_7[key];
        } else {
          this.__P_599_7[key] = value;
        }
      },
      /**
      ...
      getQooxdooVersion: function getQooxdooVersion() {
        if (this.__P_599_14) {
          return this.__P_599_14;
        }
        if (!this.__P_599_14) {
          var lib = this.findLibrary("qx");
          if (lib) {
            this.__P_599_14 = lib.getVersion();
          }
        }
        return this.__P_599_14;
      },
      ...
      isContextChanged: function isContextChanged() {
        ...
        // changed
        if (this.__P_599_15 && this.__P_599_15 !== db.environmentHash) {
          return true;
        }
      ...
      updateEnvironmentData: function updateEnvironmentData() {
        ...
        db.environmentHash = this.__P_599_15;
