...
(function () {
  ...
  qx.Class.define("qx.tool.compiler.Analyser", {
    ...
    construct: function construct(dbFilename) {
      ...
      this.__P_591_0 = dbFilename || "db.json";
      this.__P_591_1 = [];
      this.__P_591_2 = {};
      this.__P_591_3 = new qx.tool.utils.IndexedArray();
      this.__P_591_4 = {};
      this.__P_591_5 = {};
      this.__P_591_6 = {};
      this.__P_591_7 = {};
    ...
    members: {
      ...
      initialScan: function initialScan(cb) {
        ...
        function (cb) {
          ...
          t.__P_591_10.findAllResources().then(function () {
            return cb();
          })["catch"](cb);
        },
        // Find all classes
        function (cb) {
          async.each(t.__P_591_1, function (library, cb) {
      ...
      resetDatabase: function resetDatabase() {
        this.__P_591_11 = null;
        if (this.__P_591_10) {
          this.__P_591_10.dispose();
          this.__P_591_10 = null;
        }
        this.__P_591_9 = false;
        return this.open();
      },
      /**
       * Saves the database
          ...
          return _regeneratorRuntime().wrap(function _callee2$(_context2) {
            while (1) switch (_context2.prev = _context2.next) {
              case 0:
                ...
                _context2.next = 3;
                return _this2.fireDataEventAsync("saveDatabase", _this2.__P_591_11);
              case 3:
                _context2.next = 5;
                return qx.tool.utils.Json.saveJsonAsync(_this2.getDbFilename(), _this2.__P_591_11).then(function () {
                  return _this2.__P_591_10 && _this2.__P_591_10.saveDatabase();
                });
              case 5:
              case "end":
            ...
            while (1) switch (_context4.prev = _context4.next) {
              case 0:
                getIndirectLoadDependencies = function _getIndirectLoadDepen(className) {
                  var deps = [];
                  var info = t.__P_591_11.classInfo[className];
                ...
                t = _this3;
                if (!_this3.__P_591_11) {
                  _this3.__P_591_11 = {};
                }
                db = _this3.__P_591_11;
                metaWrittenLog = {};
                compiledClasses = {};
                ...
                //  in mid parse)
                _context4.next = 11;
                return qx.tool.utils.Promisify.map(_this3.__P_591_1, /*#__PURE__*/function () {
              ...
              case 11:
                classes = t.__P_591_12 = t.__P_591_3.toArray();
                classIndex = 0;
              case 13:
      ...
      _addRequiredClass: function _addRequiredClass(className) {
        ...
        // Add it
        if (t.__P_591_12.indexOf(className) == -1) {
          t.__P_591_12.push(className);
        }
      },
      /**
      ...
      getCachedClassInfo: function getCachedClassInfo(className) {
        return this.__P_591_11 ? this.__P_591_11.classInfo[className] : null;
      },
      /**
       * Loads a class
            ...
            while (1) switch (_context6.prev = _context6.next) {
              ...
              case 4:
                return _context6.abrupt("return", qx.tool.compiler.app.Cldr.loadCLDR(locale).then(function (cldr) {
                  return t.__P_591_4[locale] = cldr;
                }));
              case 5:
              case "end":
          ...
          return _regeneratorRuntime().wrap(function _callee7$(_context7) {
            while (1) switch (_context7.prev = _context7.next) {
              case 0:
                ...
                translation = t.__P_591_5[id];
                if (translation) {
                  _context7.next = 8;
                  break;
                }
                translation = t.__P_591_5[id] = new qx.tool.compiler.app.Translation(library, locale);
                    ...
                    return _regeneratorRuntime().wrap(function _callee10$(_context10) {
                      while (1) switch (_context10.prev = _context10.next) {
                        ...
                        case 7:
                          ...
                          _context10.next = 11;
                          return qx.Promise.all(_this6.__P_591_12.map( /*#__PURE__*/function () {
      ...
      addLibrary: function addLibrary(library) {
        var existingLibrary = this.__P_591_2[library.getNamespace()];
        if (existingLibrary) {
        ...
        this.__P_591_1.push(library);
        this.__P_591_2[library.getNamespace()] = library;
      },
      /**
      ...
      getFont: function getFont(name, create) {
        var font = this.__P_591_8[name] || null;
        if (!font && create) {
          font = this.__P_591_8[name] = new qx.tool.compiler.app.ManifestFont(name);
        }
        return font;
      },
      /**
      ...
      isFontAsset: function isFontAsset(filename) {
        ...
        if (filename.endsWith("svg")) {
          for (var fontName in this.__P_591_8) {
            var font = this.__P_591_8[fontName];
      ...
      removeClass: function removeClass(classname) {
        this.__P_591_3.remove(classname);
      },
      /**
      ...
      getSymbolType: function getSymbolType(name) {
        var t = this;
        for (var j = 0; j < t.__P_591_1.length; j++) {
          var library = t.__P_591_1[j];
      ...
      getLibraryFromClassname: function getLibraryFromClassname(className) {
        var t = this;
        var info = this.__P_591_6[className];
        if (info) {
          return info.library;
        }
        for (var j = 0; j < t.__P_591_1.length; j++) {
      ...
      setEnvironmentCheck: function setEnvironmentCheck(key, value) {
        if (_typeof(key) == "object") {
          var map = key;
          for (key in map) {
            this.__P_591_7[key] = map[key];
          }
        } else if (value === undefined) {
          delete this.__P_591_7[key];
        } else {
          this.__P_591_7[key] = value;
        }
      },
      /**
      ...
      getQooxdooVersion: function getQooxdooVersion() {
        if (this.__P_591_14) {
          return this.__P_591_14;
        }
        if (!this.__P_591_14) {
          var lib = this.findLibrary("qx");
          if (lib) {
            this.__P_591_14 = lib.getVersion();
          }
        }
        return this.__P_591_14;
      },
      ...
      isContextChanged: function isContextChanged() {
        ...
        // changed
        if (this.__P_591_15 && this.__P_591_15 !== db.environmentHash) {
          return true;
        }
      ...
      updateEnvironmentData: function updateEnvironmentData() {
        ...
        db.environmentHash = this.__P_591_15;
