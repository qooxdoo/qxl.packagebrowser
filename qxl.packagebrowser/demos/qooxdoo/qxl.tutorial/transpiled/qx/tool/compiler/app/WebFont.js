...
(function () {
  ...
  qx.Class.define("qx.tool.compiler.app.WebFont", {
    ...
    members: {
        ...
        return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee() {
          ...
          return _regenerator().w(function (_context) {
            while (1) switch (_context.n) {
              case 0:
                fontpath = path.join(_this.__P_614_0.getRootDir(), path.join(_this.__P_614_0.getResourcePath(), filename));
                _context.n = 1;
                return _this.__P_614_2(fontpath);
              case 1:
          ...
          return _regenerator().w(function (_context2) {
            while (1) switch (_context2.n) {
              ...
              case 1:
                ...
                _context2.n = 2;
                return _this2.__P_614_2(tmpFilename);
              case 2:
                result = _context2.v;
       ...
       * @return {Map<String,String>} mapping of glyphs to codepoints
       */
      __P_614_2: function __P_614_2(filename) {
        var _this3 = this;
          ...
          return _regenerator().w(function (_context3) {
            while (1) switch (_context3.p = _context3.n) {
              ...
              case 1:
                ...
                mapPath = path.join(_this3.__P_614_0.getRootDir(), path.join(_this3.__P_614_0.getResourcePath(), _this3.getMapping()));
                _context3.p = 2;
                _context3.n = 3;
            ...
            return _regenerator().w(function (_context4) {
              while (1) switch (_context4.p = _context4.n) {
                ...
                case 6:
                  _this4.__P_614_1 = _context4.v;
                case 7:
                  return _context4.a(2, _this4.__P_614_1);
                case 8:
                  _context4.n = 2;
                  break;
                case 9:
        ...
        return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee5() {
          return _regenerator().w(function (_context5) {
            while (1) switch (_context5.n) {
              case 0:
                return _context5.a(2, _this5.__P_614_1 || null);
            }
          }, _callee5);
        }))();
      },
