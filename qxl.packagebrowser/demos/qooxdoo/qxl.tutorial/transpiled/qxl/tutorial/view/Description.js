  ...
  qx.Class.define("qxl.tutorial.view.Description", {
    ...
    */
    construct: function construct() {
      ...
      this.__P_603_0 = new qx.ui.embed.Html();
      this.__P_603_0.setMargin(10);
      this.__P_603_0.setOverflow("auto", "auto");
      if (qx.core.Environment.get("device.type") !== "desktop") {
        this.__P_603_0.getContentElement().setStyle("WebkitOverflowScrolling", "touch");
        this.__P_603_0.getContentElement().setStyle("touchAction", "auto");
      }
      this.add(this.__P_603_0, {
        flex: 1
      });
    ...
    members: {
      ...
      _applyTutorial: function _applyTutorial(value) {
        if (this.getStep() == 0) {
          this.updateView();
          this.__P_603_2.setEnabled(value && value.steps.length > 1);
        } else {
          this.setStep(0);
        }
      },
      ...
      updateView: function updateView() {
        ...
        this.__P_603_0.setHtml(html);
        qx.html.Element.flush();
        q(this.__P_603_0.getContentElement().getDomElement()).getChildren("pre").setStyles({
          color: "#262626",
          backgroundColor: "#EEE",
          borderRadius: "4px",
          padding: "7px"
