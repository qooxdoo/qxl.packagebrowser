  ...
  ************************************************************************ */
  ...
  qx.Class.define("qxl.tutorial.view.SelectionWindow", {
    ...
    construct: function construct(desktopTutorials, mobileTutorials) {
      ...
      this.__P_606_0 = new qx.bom.Font(12, ["Lucida Grande", "DejaVu Sans", "Verdana", "sans-serif"]);
      this.__P_606_0.set({
        color: "font",
        lineHeight: 1.3
      });
      ...
      this.__P_606_1(desktopTutorials, mobileTutorials);
      this.center();
    },
    events: {
    ...
    members: {
      __P_606_0: null,
      __P_606_2: function __P_606_2(name, desc) {
      ...
      __P_606_1: function __P_606_1(desktopTutorials, mobileTutorials) {
        var i = 0;
        for (var key in desktopTutorials) {
          var name = key.replace(/_/g, " ");
          var desc = desktopTutorials[key];
          var button = this.__P_606_2(name, desc);
          this.add(button, {
            row: i + 1,
            column: 0
          });
        ...
        for (key in mobileTutorials) {
          ...
          var _button = this.__P_606_2(_name, _desc);
          this.add(_button, {
            row: i + 1,
            column: 1
          });
