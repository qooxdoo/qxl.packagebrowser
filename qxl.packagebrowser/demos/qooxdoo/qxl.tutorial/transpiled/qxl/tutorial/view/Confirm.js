  ...
  ************************************************************************ */
  qx.Class.define("qxl.tutorial.view.Confirm", {
    ...
    construct: function construct(desktopTutorials, mobileTutorials) {
      qx.ui.window.Window.constructor.call(this, "Confirm");
      ...
      // message
      this.__P_599_0 = new qx.ui.basic.Label();
      this.__P_599_0.setFont("bold");
      this.__P_599_0.set({
        rich: true,
        wrap: true
      });
      this.add(this.__P_599_0, {
        row: 0,
        column: 0,
        colSpan: 3
      });
