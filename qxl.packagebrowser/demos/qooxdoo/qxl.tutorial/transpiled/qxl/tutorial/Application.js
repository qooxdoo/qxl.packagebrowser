  ...
  qx.Class.define("qxl.tutorial.Application", {
    ...
    members: {
      ...
      main: function main() {
        ...
        // Create header
        this.__P_595_0 = new qxl.tutorial.view.Header();
        this.__P_595_0.addListener("selectTutorial", this.openSelectionWindow, this);
        mainComposite.add(this.__P_595_0);
        ...
        this.__P_595_3 = new qxl.tutorial.view.Description();
        this.__P_595_3.addListener("run", this.run, this);
        this.__P_595_3.addListener("update", this.updateEditor, this);
        content.add(this.__P_595_3, 1);
        var actionArea = new qx.ui.splitpane.Pane();
        this.__P_595_5 = actionArea;
        this.__P_595_2 = new qxl.playground.view.Editor();
        actionArea.add(this.__P_595_2);
        qxl.playground.view.Editor.loadAce(function () {
          this.__P_595_2.init();
        }, this);
        this.__P_595_1 = new qxl.playground.view.PlayArea();
        this.__P_595_1.setBackgroundColor("white");
        actionArea.add(this.__P_595_1);
        this.__P_595_1.updateCaption("");
        this.__P_595_1.addListener("toggleMaximize", function (e) {
          if (!this.__P_595_2.isExcluded()) {
            this.__P_595_2.exclude();
            this.__P_595_3.exclude();
          } else {
            this.__P_595_2.show();
            this.__P_595_3.show();
          }
      ...
      openSelectionWindow: function openSelectionWindow() {
        if (!this.__P_595_4) {
          this.__P_595_4 = new qxl.tutorial.view.SelectionWindow(this.__P_595_6, this.__P_595_7);
          this.__P_595_4.addListener("changeTutorial", this.__P_595_9, this);
        }
        this.__P_595_4.open();
        this.render(); // make sure the DOM object is available for the fade
        if (qxl.tutorial.Application.allowFade()) {
          this.__P_595_4.fadeIn(300);
        } else {
          this.__P_595_4.show();
        }
      },
      __P_595_9: function __P_595_9(e) {
        var type = e.getData().type;
        var name = e.getData().name;
        this.loadTutorial(name, type);
        this.__P_595_2.setCode("");
        this.__P_595_2.setError();
        this.__P_595_1.reset();
      ...
      confirm: function confirm(text, callback, ctx) {
        if (!this.__P_595_8) {
          this.__P_595_8 = new qxl.tutorial.view.Confirm();
        }
        if (this.__P_595_8.getIgnore()) {
          callback.call(ctx, {
        ...
        this.__P_595_8.setMessage(text);
        this.__P_595_8.open();
        this.render();
        if (qxl.tutorial.Application.allowFade()) {
          this.__P_595_8.fadeIn(300);
        } else {
          this.__P_595_8.show();
        }
        this.__P_595_8.addListenerOnce("confirm", callback, ctx);
      },
      run: function run() {
        var code = this.__P_595_2.getCode();
        ...
        try {
          // run the application
          this.fun.call(this.__P_595_1.getApp());
        } catch (ex) {
          exc = ex;
        }
        if (exc) {
          this.__P_595_2.setBackgroundColor("#FFF0F0");
          this.__P_595_2.setError(exc);
          this.error(exc);
        } else {
          this.__P_595_2.setError();
          this.__P_595_2.setBackgroundColor("white");
        }
      },
      /**
       * @param name
      ...
      loadTutorial: function loadTutorial(name, type) {
        ...
        req.addListener("success", function (e) {
          var req = e.getTarget();
          this.__P_595_3.setTutorial(this.parseTutorial(name, type, req.getResponse()));
          this.__P_595_1.updateCaption(name.replace(/_/g, " ") + " (" + type + ")");
          this.__P_595_1.setMode(type !== "desktop" ? "mobile" : "ria");
          this.__P_595_5.setOrientation(type == "desktop" ? "vertical" : "horizontal");
        }, this);
        req.send();
