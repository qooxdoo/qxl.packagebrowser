  ...
  ************************************************************************ */
  ...
  qx.Class.define("qxl.playground.view.PlayArea", {
    ...
    construct: function construct() {
      ...
      this.__P_605_0 = new qxl.playground.view.RiaPlayArea();
      this.__P_605_1 = new qxl.playground.view.MobilePlayArea();
      this.__P_605_0.addListener("toggleMaximize", this._onToggleMaximize, this);
      this.__P_605_1.addListener("toggleMaximize", this._onToggleMaximize, this);
      this.add(this.__P_605_0);
      this.add(this.__P_605_1);
    ...
    members: {
      ...
      _applyMode: function _applyMode(value) {
        ...
        if (value == "mobile") {
          this.setSelection([this.__P_605_1]);
          this.__P_605_1.init();
        } else {
          this.setSelection([this.__P_605_0]);
          this.__P_605_0.init();
        }
      },
      /**
      ...
      updateCaption: function updateCaption(text) {
        this.__P_605_0.updateCaption(text);
        this.__P_605_1.updateCaption(text);
      },
      /**
