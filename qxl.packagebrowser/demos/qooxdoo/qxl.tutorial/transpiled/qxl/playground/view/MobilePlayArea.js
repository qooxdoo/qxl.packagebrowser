  ...
  qx.Class.define("qxl.playground.view.MobilePlayArea", {
    ...
    construct: function construct() {
      ...
      sizeSelect.addListener("changeSelection", function (e) {
        ...
        if (newRes) {
          this.__P_621_0(newRes[0], newRes[1]);
        } else {
          this.__P_621_0(null, null);
        }
      }, this);
    ...
    members: {
       ...
       */
      __P_621_0: function __P_621_0(width, height) {
      ...
      reset: function reset(beforeReg, afterReg, code) {
        ...
        if (this.__P_621_1) {
          this.__P_621_1.dispose();
          this.__P_621_1 = null;
        }
        this.__P_621_1 = new qx.ui.mobile.page.Manager(false, this._playRoot);
      }
    }
  });
