  ...
  qx.Class.define("qxl.playground.view.Editor", {
    ...
    members: {
      ...
      init: function init() {
        ...
        this.__P_596_4 = new qx.ui.basic.Label().set({
          textColor: "red"
        });
        caption.add(this.__P_596_4);

        // plain text area
        this.__P_596_0 = new qx.ui.form.TextArea().set({
          wrap: false,
        ...
        this.add(this.__P_596_0, {
          flex: 1
        });
        this.__P_596_2 = new qx.ui.core.Widget();
        ...
        if (!document.createElement("div").getBoundingClientRect || badIE || opera || !window.ace) {
          ...
          this.__P_596_2.addListenerOnce("appear", function () {
            this.__P_596_5();
          }, this);
        }
        this.__P_596_2.setVisibility("excluded");
        this.add(this.__P_596_2, {
          flex: 1
        });
       ...
       */
      __P_596_5: function __P_596_5() {
        // timout needed for chrome to not get the ACE layout wrong and show the
        // text on top of the gutter
        qx.event.Timer.once(function () {
          var container = this.__P_596_2.getContentElement().getDomElement();

          // create the editor
          var editor = this.__P_596_3 = ace.edit(container);
          ...
          session.setValue(this.__P_596_0.getValue() || "");
          var self = this;
          // append resize listener
          this.__P_596_2.addListener("resize", function () {
            // use a timeout to let the layout queue apply its changes to the dom
            window.setTimeout(function () {
              self.__P_596_3.resize();
            }, 0);
          });
        }, this, 500);
      },
      ...
      getCode: function getCode() {
        if (this.__P_596_1 && this.__P_596_3) {
          return this.__P_596_3.getSession().getValue();
        }
        return this.__P_596_0.getValue();
      },
      /**
      ...
      setCode: function setCode(code) {
        if (this.__P_596_3) {
          this.__P_596_3.getSession().setValue(code);

          // move cursor to start to prevent scrolling to the bottom
          this.__P_596_3.renderer.scrollToX(0);
          this.__P_596_3.renderer.scrollToY(0);
          this.__P_596_3.selection.moveCursorFileStart();
        }
        this.__P_596_0.setValue(code);
      },
      /**
      ...
      setError: function setError(ex) {
        this.__P_596_4.setValue(ex ? ex.toString() : "");
      },
      /**
      ...
      useHighlight: function useHighlight(value) {
        this.__P_596_1 = value;
        if (value) {
          // change the visibility
          this.__P_596_2.setVisibility("visible");
          this.__P_596_0.setVisibility("excluded");

          // copy the value, if the editor already availabe
          if (this.__P_596_3) {
            this.__P_596_3.getSession().setValue(this.__P_596_0.getValue());
          }
        } else {
          // change the visibility
          this.__P_596_2.setVisibility("excluded");
          this.__P_596_0.setVisibility("visible");

          // copy the value, if the editor already availabe
          if (this.__P_596_3) {
            this.__P_596_0.setValue(this.__P_596_3.getSession().getValue());
          }
        }
      }
    },
    ...
    destruct: function destruct() {
      this._disposeObjects("__P_596_0");
      this.__P_596_3 = null;
    }
  });
