  ...
  qx.Class.define("qx.html.Text", {
    ...
    members: {
      ...
      _createDomElement: function _createDomElement() {
        return window.document.createTextNode(this.__P_111_0 || "");
      },
      /*
       * @Override
       */
      ...
      _serializeImpl: function _serializeImpl(serializer) {
        serializer.rawTextInBody(this.__P_111_0);
      },
      /**
       * @Override
       */
    ...
    defer: function defer(statics) {
      statics.__P_111_1 = new qx.util.DeferredCall(statics.flush, statics);
    },
    /*
     * ****************************************************************************
     * DESTRUCT
    ...
    destruct: function destruct() {
      ...
      this.__P_111_2 = this.__P_111_3 = this.__P_111_4 = this.__P_111_5 = this.__P_111_6 = this.__P_111_7 = this.__P_111_8 = null;
    }
  });
