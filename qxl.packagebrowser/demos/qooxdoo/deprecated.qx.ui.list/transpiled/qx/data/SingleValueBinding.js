  ...
  qx.Class.define("qx.data.SingleValueBinding", {
    statics: {
      ...
      bind: function bind(sourceObject, sourcePropertyChain, targetObject, targetPropertyChain, options) {
        ...
        var targetListenerMap = this.__P_93_2(sourceObject, sourcePropertyChain, targetObject, targetPropertyChain, options);
        ...
        try {
          ...
          for (var i = 0; i < propertyNames.length; i++) {
            ...
            if (i == propertyNames.length - 1) {
              ...
              // create a listener
              var listener = qx.lang.Function.bind(this.__P_93_7, this, context);
       ...
       */
      __P_93_7: function __P_93_7(context) {
       ...
       */
      __P_93_2: function __P_93_2(sourceObject, sourcePropertyChain, targetObject, targetPropertyChain, options) {
        // get the property names
       ...
       */
      __P_93_4: function __P_93_4(source, propertyName) {
        // get the current event name from the property definition
        var eventName = this.__P_93_14(source, propertyName);
       ...
       */
      __P_93_10: function __P_93_10(targetObject, targetPropertyChain) {
       ...
       */
      __P_93_9: function __P_93_9(targetObject, targetPropertyChain, value) {
        // get the last target object of the chain
        var properties = this.__P_93_12(targetPropertyChain);
        var target = this.__P_93_13(targetObject, properties);
        if (target) {
       ...
       */
      __P_93_15: function __P_93_15(propertyName) {
        var arrayExp = /^\[(\d+|last)\]$/;
       ...
       */
      __P_93_12: function __P_93_12(targetPropertyChain) {
       ...
       *   should be set.
       */
      __P_93_13: function __P_93_13(targetObject, targetProperties, index) {
       ...
       */
      __P_93_5: function __P_93_5(value, targetObject, targetPropertyChain, options, sourceObject) {
        // first convert the initial value
        value = this.__P_93_11(value, targetObject, targetPropertyChain, options, sourceObject);
        ...
        if (value !== undefined) {
          try {
            var result = this.__P_93_9(targetObject, targetPropertyChain, value);
       ...
       */
      __P_93_3: function __P_93_3(propertyNames) {
       ...
       *   property.
       */
      __P_93_6: function __P_93_6(sourceObject, sourceEvent, targetObject, targetProperty, options, arrayIndex) {
        // checks
        ...
        var bindListener = function bindListener(arrayIndex, e) {
          ...
          // convert the data
          data = qx.data.SingleValueBinding.__P_93_11(data, targetObject, targetProperty, options, sourceObject);
       ...
       *   object.
       */
      __P_93_8: function __P_93_8(id, sourceObject, sourceEvent, targetObject, targetProperty) {
        var hash;
        ...
        this.__P_93_0[hash].push(binding);
       ...
       */
      __P_93_11: function __P_93_11(value, targetObject, targetPropertyChain, options, sourceObject) {
       ...
       */
      __P_93_14: function __P_93_14(sourceObject, sourceProperty) {
        // get the event name
       ...
       */
      __P_93_16: function __P_93_16(data, targetCheck) {
      ...
      getAllBindingsForObject: function getAllBindingsForObject(object) {
        ...
        var sourceBindings = this.__P_93_0[hash];

        // get all bindings of object as target
        var targetBindings = this.__P_93_1[hash];
