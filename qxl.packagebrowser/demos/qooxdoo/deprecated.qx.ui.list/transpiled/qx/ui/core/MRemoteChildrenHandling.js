  ...
  qx.Mixin.define("qx.ui.core.MRemoteChildrenHandling", {
    ...
    */
    ...
    members: {
       ...
       */
      __P_116_0: function __P_116_0(functionName, a1, a2, a3) {
      ...
      getChildren: function getChildren() {
        return this.__P_116_0("getChildren");
      },
      /**
      ...
      hasChildren: function hasChildren() {
        return this.__P_116_0("hasChildren");
      },
      /**
      ...
      add: function add(child, options) {
        return this.__P_116_0("add", child, options);
      },
      /**
      ...
      remove: function remove(child) {
        return this.__P_116_0("remove", child);
      },
      /**
       * Remove all children.
      ...
      removeAll: function removeAll() {
        return this.__P_116_0("removeAll");
      },
      /**
      ...
      indexOf: function indexOf(child) {
        return this.__P_116_0("indexOf", child);
      },
      /**
      ...
      addAt: function addAt(child, index, options) {
        this.__P_116_0("addAt", child, index, options);
      },
      /**
      ...
      addBefore: function addBefore(child, before, options) {
        this.__P_116_0("addBefore", child, before, options);
      },
      /**
      ...
      addAfter: function addAfter(child, after, options) {
        this.__P_116_0("addAfter", child, after, options);
      },
      /**
      ...
      removeAt: function removeAt(index) {
        return this.__P_116_0("removeAt", index);
      }
    }
  });
