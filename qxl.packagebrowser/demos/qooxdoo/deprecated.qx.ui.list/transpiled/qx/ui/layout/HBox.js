    ...
    members: {
      ...
      */
      ...
      __P_100_4: function __P_100_4() {
        ...
        var widths = reuse ? this.__P_100_0 : new Array(length);
        var flexs = reuse ? this.__P_100_1 : new Array(length);
      ...
      */
      ...
      renderLayout: function renderLayout(availWidth, availHeight, padding) {
        ...
        if (this.__P_100_2 && allocatedWidth != availWidth) {
          var flexibles = {};
          var flex, offset;
