  ...
  ************************************************************************ */
  ...
  qx.Class.define("qxl.apiviewer.ui.panels.PropertyPanel", {
    ...
    members: {
      ...
      __P_467_0: function __P_467_0(node, currentClassDocNode) {
        if (node.isRefined()) {
          return "";
        }
        if (node.isPrivate()) {
      ...
      __P_467_1: function __P_467_1(node) {
        var attributes = [];
        if (node.isNullable()) {
       ...
       */
      __P_467_2: function __P_467_2(node) {
        if (node.isRefined()) {
      ...
      getItemTextHtml: function getItemTextHtml(node, currentClassDocNode, showDetails) {
        ...
        if (showDetails) {
          ...
          textHtml.add(this.__P_467_1(node));
          textHtml.add(this.__P_467_0(node, currentClassDocNode));
          textHtml.add(qxl.apiviewer.ui.panels.InfoPanel.createIncludedFromHtml(node, currentClassDocNode));
          textHtml.add(this.__P_467_2(node));
