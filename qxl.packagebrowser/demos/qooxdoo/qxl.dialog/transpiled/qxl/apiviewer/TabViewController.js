  ...
  ************************************************************************ */
  qx.Class.define("qxl.apiviewer.TabViewController", {
    ...
    construct: function construct(widgetRegistry) {
      ...
      this._tabView.addListener("changeSelection", this.__P_450_0, this);
    },
    events: {
    ...
    members: {
      ...
      openPackage: function openPackage(classNode, newTab) {
        return this.__P_450_1(classNode, qxl.apiviewer.ui.tabview.PackagePage, newTab);
      },
      openClass: function openClass(classNode, newTab) {
        return this.__P_450_1(classNode, qxl.apiviewer.ui.tabview.ClassPage, newTab);
      },
      __P_450_1: function __P_450_1(classNode, clazz, newTab) {
