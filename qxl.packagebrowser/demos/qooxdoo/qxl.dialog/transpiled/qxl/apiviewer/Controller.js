  ...
  ************************************************************************ */
  ...
  qx.Class.define("qxl.apiviewer.Controller", {
    ...
    construct: function construct(widgetRegistry) {
      ...
      btn_inherited.addListener("changeValue", this.__P_452_3, this);
      btn_included.addListener("changeValue", this.__P_452_3, this);
      this._history = qx.bom.History.getInstance();
      this.__P_452_4();
      qx.core.Init.getApplication().getRoot().addListener("pointerdown", function (e) {
        this.__P_452_5 = e.isShiftPressed() || e.isCtrlOrCommandPressed();
      }, this, true);
    },
    members: {
      __P_452_5: false,
      ...
      load: function load(classes) {
        ...
        setTimeout(function () {
          ...
          setTimeout(function () {
            ...
            if (state) {
              _this.__P_452_6(_this.__P_452_7(state));
            } else {
              _this.__P_452_6("");
            }
          });
       ...
       * bind history events
       */
      __P_452_4: function __P_452_4() {
        this._history.addListener("changeState", function (evt) {
          var item = this.__P_452_7(evt.getData());
          if (item) {
            this.__P_452_6(item);
          }
        }, this);
      ...
      _updateHistory: function _updateHistory(className) {
        ...
        qx.bom.History.getInstance().addToHistory(this.__P_452_8(className), newTitle);
      },
      /**
          ...
          return _regenerator().w(function (_context) {
            while (1) switch (_context.n) {
              ...
              case 1:
                ...
                _context.n = 2;
                return _this2._tabViewController.openClass(classNode, _this2.__P_452_5);
              case 2:
                _context.n = 4;
                break;
              case 3:
                _context.n = 4;
                return _this2._tabViewController.openPackage(classNode, _this2.__P_452_5);
              case 4:
       ...
       *
       */
      __P_452_6: function __P_452_6(fullItemName) {
        var _this3 = this;
      ...
      __P_452_8: function __P_452_8(state) {
        return state.replace(/(.*)#(.*)/g, "$1~$2");
      },
      __P_452_7: function __P_452_7(encodedState) {
