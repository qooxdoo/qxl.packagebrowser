  ...
  qx.Class.define("qx.util.fsm.State", {
    ...
    construct: function construct(stateName, stateInfo) {
      ...
      for (var field in stateInfo) {
        ...
        switch (field) {
          case "onentry":
            this.setOnentry(this.__P_443_0(stateInfo[field], context));
            break;
          case "onexit":
            this.setOnexit(this.__P_443_0(stateInfo[field], context));
            break;
    ...
    members: {
       ...
       */
      __P_443_1: function __P_443_1(value) {
       ...
       * @throws {Error} when an invalid value is detected
       */
      __P_443_2: function __P_443_2(value) {
       ...
       * @throws {Error} when an invalid value is detected
       */
      __P_443_3: function __P_443_3(value) {
       ...
       * @throws {Error} when an invalid value is detected
       */
      __P_443_8: function __P_443_8(value) {
       ...
       * @return {var} the final value
       */
      __P_443_4: function __P_443_4(value) {
       ...
       * @return {var} the final value
       */
      __P_443_5: function __P_443_5(value) {
       ...
       * @return {var} the final value
       */
      __P_443_6: function __P_443_6(value) {
       ...
       * @return {var} the final value
       */
      __P_443_7: function __P_443_7(value) {
       ...
       *   unaltered.
       */
      __P_443_0: function __P_443_0(f, context) {
