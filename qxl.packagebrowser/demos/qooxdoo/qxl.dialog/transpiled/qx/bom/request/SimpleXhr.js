  ...
  ************************************************************************ */
  ...
  qx.Bootstrap.define("qx.bom.request.SimpleXhr", {
    ...
    construct: function construct(url, method) {
      ...
      this.__P_61_0 = {};
      this.__P_61_1 = this._createResponseParser();
    },
    members: {
      /*
      ---------------------------------------------------------------------------
      ...
      */
      ...
      setParser: function setParser(parser) {
        return this.__P_61_1.setParser(parser);
      },
      /**
      ...
      send: function send() {
        var curTimeout = this.getTimeout(),
          ...
          hasCacheControlHeader = this.__P_61_0.hasOwnProperty("Cache-Control"),
        ...
        for (var key in this.__P_61_0) {
          this._transport.setRequestHeader(key, this.__P_61_0[key]);
        }
      ...
      */
      ...
      __P_61_9: function __P_61_9() {
        ...
        if (qx.util.Request.isSuccessful(this._transport.status)) {
          ...
          this._setResponse(this.__P_61_1.parse(response, contentType));
          this.emit("success");
