  ...
  ************************************************************************ */
  ...
  qx.Bootstrap.define("qx.bom.element.AnimationHandle", {
    ...
    construct: function construct() {
      ...
      this.__P_46_0 = css && css["play-state"];
      this.__P_46_1 = true;
    ...
    members: {
      ...
      isPaused: function isPaused() {
        return this.el.style[this.__P_46_0] == "paused";
      },
      /**
      ...
      pause: function pause() {
        if (this.el) {
          ...
          this.el.$$animation.__P_46_1 = false;
      ...
      play: function play() {
        if (this.el) {
          ...
          this.el.$$animation.__P_46_1 = true;
          // in case the animation is based on JS
      ...
      stop: function stop() {
        if (this.el && qx.core.Environment.get("css.animation") && !this.jsAnimation) {
          ...
          this.el.$$animation.__P_46_1 = false;
          this.el.$$animation.__P_46_3 = true;
        }
        // in case the animation is based on JS
