    ...
    members: {
      ...
      */
      ...
      __P_92_7: function __P_92_7(ev) {
        ...
        var modelNode = this.__P_92_2[children.toHashCode()].modelNode;
        // update the subtree
        this.__P_92_8(treeNode, modelNode);
      ...
      __P_92_9: function __P_92_9(e) {
        ...
        delete this.__P_92_2[oldChildren.toHashCode()];
      ...
      */
      ...
      __P_92_6: function __P_92_6() {
        ...
        if (this.getModel() != null) {
          ...
          this.__P_92_8(rootNode, this.getModel());
      ...
      __P_92_8: function __P_92_8(rootNode, modelNode) {
        ...
        if (this.__P_92_2[children.toHashCode()] == undefined) {
          ...
          var changeListenerId = children.addListener("change", this.__P_92_7, this);
        ...
        for (var i = 0; i < children.length; i++) {
          ...
          if (rootNode.getChildren()[i] == null || children.getItem(i) != rootNode.getChildren()[i].getModel()) {
            ...
            if (oldIndex != undefined) {
              ...
              this.__P_92_10(children.getItem(i), treeNode);
