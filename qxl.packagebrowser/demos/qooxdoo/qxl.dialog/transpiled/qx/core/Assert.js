  ...
  ************************************************************************ */
  ...
  qx.Bootstrap.define("qx.core.Assert", {
    statics: {
       ...
       *
       */
      __P_71_1: function __P_71_1(comment, msgvarargs) {
       ...
       */
      __P_71_2: function __P_71_2(value) {
        var stringValue;
        if (value === null) {
          stringValue = "null";
      ...
      assertType: function assertType(value, type, msg) {
        ...
        _typeof(value) === type || this.__P_71_1(msg || "", "Expected value to be typeof '", type, "' but found ", value, "!");
      },
      /**
       ...
       * class
       */
      __P_71_3: function __P_71_3(object, classname) {
        if (!object) {
          return false;
        }
