  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.ui.mobile.list.List", {
    ...
    construct: function construct(delegate) {
      ...
      this.__P_332_0 = new qx.ui.mobile.list.provider.Provider(this);
      ...
      {
        this.__P_332_1 = qx.locale.Manager.getInstance().addListener("changeLocale", this._onChangeLocale, this);
      }
    },
    events: {
      /**
    ...
    members: {
      ...
      _onTrackStart: function _onTrackStart(evt) {
        ...
        if (element && qx.bom.element.Class.has(element, "list-item") && qx.bom.element.Class.has(element, "removable")) {
          ...
          this.__P_332_2 = qx.bom.element.Dimension.getWidth(element) / 2;
      ...
      _onTrack: function _onTrack(evt) {
        ...
        var element = this.__P_332_4;
        var delta = evt.getDelta();
        var deltaX = Math.round(delta.x * 0.1) / 0.1;
        if (this.__P_332_3 === null) {
          this.__P_332_3 = delta.axis == "x";
        }
        if (!this.__P_332_3) {
          return;
        }
        var opacity = 1 - Math.abs(deltaX) / this.__P_332_2;
      ...
      _onTrackEnd: function _onTrackEnd(evt) {
        ...
        var element = this.__P_332_4;
        if (Math.abs(evt.getDelta().x) > this.__P_332_2) {
      ...
      _applyModel: function _applyModel(value, old) {
        if (old != null) {
          old.removeListener("changeBubble", this.__P_332_5, this);
        }
        if (value != null) {
          value.addListener("changeBubble", this.__P_332_5, this);
        }
        if (old != null) {
          old.removeListener("change", this.__P_332_6, this);
        }
        if (value != null) {
          value.addListener("change", this.__P_332_6, this);
        }
        if (old != null) {
          old.removeListener("changeLength", this.__P_332_7, this);
        }
        if (value != null) {
          value.addListener("changeLength", this.__P_332_7, this);
        }
        this.__P_332_8();
      },
      // property apply
      _applyDelegate: function _applyDelegate(value, old) {
        this.__P_332_0.setDelegate(value);
      },
      /**
       * Listen on model 'changeLength' event.
       * @param evt {qx.event.type.Data} data event which contains model change data.
       */
      __P_332_7: function __P_332_7(evt) {
        this.__P_332_8();
      },
      /**
       ...
       * @param evt {qx.event.type.Data} data event which contains model change data.
       */
      __P_332_6: function __P_332_6(evt) {
       ...
       */
      __P_332_5: function __P_332_5(evt) {
        if (evt) {
       ...
       */
      __P_332_9: function __P_332_9(index) {
        var renderedItems = qx.bom.Selector.query(".list-item", this.getContentElement());
        var oldNode = renderedItems[index];
        var newNode = this.__P_332_0.getItemElement(this.getModel().getItem(index), index);
      ...
      __P_332_8: function __P_332_8() {
        ...
        for (var index = 0; index < this.getItemCount(); index++) {
          ...
          var itemElement = this.__P_332_0.getItemElement(item, index);
          var itemHeight = null;
      ...
      _renderGroup: function _renderGroup(itemIndex, groupIndex) {
        var group = this.__P_332_11(itemIndex);
        if (itemIndex === 0) {
          return this.__P_332_0.getGroupElement(group, groupIndex);
        } else {
          var previousGroup = this.__P_332_11(itemIndex - 1);
       ...
       */
      __P_332_10: function __P_332_10() {
       ...
       */
      __P_332_11: function __P_332_11(index) {
    ...
    destruct: function destruct() {
      ...
      if (true && this.__P_332_1) {
        qx.locale.Manager.getInstance().removeListenerById(this.__P_332_1);
      }
    }
  });
