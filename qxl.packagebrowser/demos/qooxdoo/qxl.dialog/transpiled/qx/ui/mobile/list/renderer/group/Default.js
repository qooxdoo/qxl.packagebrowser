  ...
  qx.Class.define("qx.ui.mobile.list.renderer.group.Default", {
    ...
    members: {
      ...
      setImage: function setImage(source) {
        this.__P_330_0.setSource(source);
      },
      /**
      ...
      setTitle: function setTitle(title) {
        if (title && title.translate) {
          this.__P_330_1.setValue(title.translate());
        } else {
          this.__P_330_1.setValue(title);
        }
      },
      /**
      ...
      _init: function _init() {
        this.__P_330_0 = this._createImage();
        this.add(this.__P_330_0);
        this.__P_330_2 = this._createRightContainer();
        this.add(this.__P_330_2, {
          flex: 1
        });
        this.__P_330_1 = this._createTitle();
        this.__P_330_2.add(this.__P_330_1);
      },
      /**
      ...
      reset: function reset() {
        this.__P_330_0.setSource(null);
        this.__P_330_1.setValue("");
      }
    },
    destruct: function destruct() {
      this._disposeObjects("__P_330_0", "__P_330_1", "__P_330_2");
    }
  });
