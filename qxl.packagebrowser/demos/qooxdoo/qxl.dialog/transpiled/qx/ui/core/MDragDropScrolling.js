  ...
  qx.Mixin.define("qx.ui.core.MDragDropScrolling", {
    ...
    */
    construct: function construct() {
      ...
      widget.addListener("drag", this.__P_231_0, this);
      widget.addListener("dragend", this.__P_231_1, this);
      this.__P_231_2 = ["left", "right"];
      this.__P_231_3 = ["top", "bottom"];
    },
    /*
    *****************************************************************************
       PROPERTIES
    ...
    */
    ...
    members: {
      ...
      _getAxis: function _getAxis(edgeType) {
        if (this.__P_231_2.indexOf(edgeType) !== -1) {
          return "x";
        } else if (this.__P_231_3.indexOf(edgeType) !== -1) {
          return "y";
        } else {
      ...
      __P_231_0: function __P_231_0(e) {
        ...
        while (scrollable) {
          ...
          if (this._isScrollbarVisible(scrollable, axis)) {
            ...
            this.__P_231_4 = new qx.event.Timer(50);
            this.__P_231_4.addListener("interval", function (scrollable, axis, amount) {
              this._scrollBy(scrollable, axis, amount);
            }.bind(this, scrollable, axis, exceedanceAmount));
            this.__P_231_4.start();
            e.stopPropagation();
            return;
          } else {
            scrollable = this._findScrollableParent(scrollable);
