    ...
    members: {
      ...
      */
      ...
      __P_299_2: function __P_299_2() {
        ...
        if (!menuBounds) {
          this.addListenerOnce("resize", this.__P_299_2, this);
          return;
        }
