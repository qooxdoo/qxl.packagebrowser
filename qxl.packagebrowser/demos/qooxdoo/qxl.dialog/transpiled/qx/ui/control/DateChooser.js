  ...
  qx.Class.define("qx.ui.control.DateChooser", {
    ...
    */
    ...
    construct: function construct(date) {
      ...
      {
        this.__P_223_0 = qx.locale.Manager.getInstance().addListener("changeLocale", this._updateDatePane, this);
      }
      ...
      */
      ...
      _updateDatePane: function _updateDatePane() {
        ...
        for (var week = 0; week < 6; week++) {
          this.__P_223_3[week].setValue(weekFormat.format(helpDate));
          for (var i = 0; i < 7; i++) {
            var dayLabel = this.__P_223_2[week * 7 + i];
            ...
            dayLabel.setEnabled(!this.__P_223_4(helpDate));
      ...
      __P_223_4: function __P_223_4(date) {
        var d = new Date(date);
        d.setHours(0, 0, 0, 0);
    ...
    */
    destruct: function destruct() {
      if (true && this.__P_223_0) {
        qx.locale.Manager.getInstance().removeListenerById(this.__P_223_0);
      }
      this.__P_223_1 = this.__P_223_2 = this.__P_223_3 = null;
    }
  });
