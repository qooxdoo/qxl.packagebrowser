  ...
  qx.Class.define("qx.ui.virtual.cell.Boolean", {
    ...
    */
    construct: function construct() {
      ...
      this.__P_391_0 = qx.util.AliasManager.getInstance();
    },
    /*
    *****************************************************************************
       PROPERTIES
    ...
    */
    ...
    members: {
      ...
      _applyIconTrue: function _applyIconTrue(value) {
        this.__P_391_1 = this.__P_391_0.resolve(value);
      },
      // property apply
      _applyIconFalse: function _applyIconFalse(value) {
        this.__P_391_2 = this.__P_391_0.resolve(value);
      },
      // overridden
      _identifyImage: function _identifyImage(value) {
        return value == true ? this.__P_391_1 : this.__P_391_2;
      }
    }
  });
