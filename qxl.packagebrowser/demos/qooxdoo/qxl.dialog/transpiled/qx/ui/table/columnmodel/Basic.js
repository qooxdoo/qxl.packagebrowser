  ...
  qx.Class.define("qx.ui.table.columnmodel.Basic", {
    ...
    */
    ...
    members: {
      ...
      init: function init(colCount, table) {
        ...
        var headerRenderer = this.__P_361_5 || (this.__P_361_5 = new qx.ui.table.columnmodel.Basic.DEFAULT_HEADER_RENDERER());
        var dataRenderer = this.__P_361_6 || (this.__P_361_6 = new qx.ui.table.columnmodel.Basic.DEFAULT_DATA_RENDERER());
        var editorFactory = this.__P_361_7 || (this.__P_361_7 = new qx.ui.table.columnmodel.Basic.DEFAULT_EDITOR_FACTORY());
        this.__P_361_0 = [];
        this.__P_361_1 = [];
        ...
        for (var col = 0; col < colCount; col++) {
          ...
          this.__P_361_0[col] = col;
          this.__P_361_1[col] = col;
        }
        this.__P_361_3 = null;
      ...
      getVisibleColumns: function getVisibleColumns() {
        return this.__P_361_1 != null ? this.__P_361_1 : [];
      },
      /**
      ...
      setColumnWidth: function setColumnWidth(col, width, isPointerAction) {
        var oldWidth = this.__P_361_4[col].width;
        if (oldWidth != width) {
          this.__P_361_4[col].width = width;
          var data = {
            col: col,
            newWidth: width,
            oldWidth: oldWidth,
      ...
      getColumnWidth: function getColumnWidth(col) {
        return this.__P_361_4[col].width;
      },
      /**
      ...
      setHeaderCellRenderer: function setHeaderCellRenderer(col, renderer) {
        var oldRenderer = this.__P_361_4[col].headerRenderer;
        if (oldRenderer !== this.__P_361_5) {
          oldRenderer.dispose();
        }
        this.__P_361_4[col].headerRenderer = renderer;
        if (!this.__P_361_2) {
      ...
      getHeaderCellRenderer: function getHeaderCellRenderer(col) {
        return this.__P_361_4[col].headerRenderer;
      },
      /**
      ...
      setDataCellRenderer: function setDataCellRenderer(col, renderer) {
        var oldRenderer = this.__P_361_4[col].dataRenderer;
        this.__P_361_4[col].dataRenderer = renderer;
        if (oldRenderer !== this.__P_361_6) {
          return oldRenderer;
        }
        return null;
      },
      ...
      getDataCellRenderer: function getDataCellRenderer(col) {
        return this.__P_361_4[col].dataRenderer;
      },
      /**
      ...
      setCellEditorFactory: function setCellEditorFactory(col, factory) {
        var oldFactory = this.__P_361_4[col].editorFactory;
        if (oldFactory === factory) {
          return;
        }
        if (oldFactory !== this.__P_361_7) {
          oldFactory.dispose();
        }
        this.__P_361_4[col].editorFactory = factory;
      },
      /**
      ...
      getCellEditorFactory: function getCellEditorFactory(col) {
        return this.__P_361_4[col].editorFactory;
      },
      /**
      ...
      _getColToXPosMap: function _getColToXPosMap() {
        if (this.__P_361_3 == null) {
          this.__P_361_3 = {};
          for (var overX = 0; overX < this.__P_361_0.length; overX++) {
            var col = this.__P_361_0[overX];
            this.__P_361_3[col] = {
              overX: overX
            };
          }
          for (var visX = 0; visX < this.__P_361_1.length; visX++) {
            var col = this.__P_361_1[visX];
            this.__P_361_3[col].visX = visX;
          }
        }
      ...
      getVisibleColumnCount: function getVisibleColumnCount() {
        return this.__P_361_1 != null ? this.__P_361_1.length : 0;
      },
      /**
      ...
      getOverallColumnAtX: function getOverallColumnAtX(overXPos) {
        return this.__P_361_0[overXPos];
      },
      /**
      ...
      setColumnVisible: function setColumnVisible(col, visible) {
        if (visible != this.isColumnVisible(col)) {
          if (visible) {
            ...
            var nextVisX;
            for (var x = overX + 1; x < this.__P_361_0.length; x++) {
              var currCol = this.__P_361_0[x];
            ...
            // at the end
            if (nextVisX == null) {
              nextVisX = this.__P_361_1.length;
            }

            // Add the column to the visible columns
            this.__P_361_1.splice(nextVisX, 0, col);
          } else {
            var visX = this.getVisibleX(col);
            this.__P_361_1.splice(visX, 1);
          }
      ...
      moveColumn: function moveColumn(fromOverXPos, toOverXPos) {
        this.__P_361_2 = true;
        var col = this.__P_361_0[fromOverXPos];
        var visible = this.isColumnVisible(col);
        if (visible) {
          this.setColumnVisible(col, false);
        }
        this.__P_361_0.splice(fromOverXPos, 1);
        this.__P_361_0.splice(toOverXPos, 0, col);
      ...
      setColumnsOrder: function setColumnsOrder(newPositions) {
        if (newPositions.length == this.__P_361_0.length) {
          this.__P_361_2 = true;
          ...
          for (var colIdx = 0; colIdx < this.__P_361_0.length; colIdx++) {
          ...
          this.__P_361_0 = qx.lang.Array.clone(newPositions);
          ...
          throw new Error("setColumnsOrder: Invalid number of column positions given, expected " + this.__P_361_0.length + ", got " + newPositions.length);
        }
      }
    },
    /*
    ...
    */
    destruct: function destruct() {
      for (var i = 0; i < this.__P_361_4.length; i++) {
        this.__P_361_4[i].headerRenderer.dispose();
        this.__P_361_4[i].dataRenderer.dispose();
        this.__P_361_4[i].editorFactory.dispose();
      }
      this.__P_361_0 = this.__P_361_1 = this.__P_361_4 = this.__P_361_3 = null;
      this._disposeObjects("__P_361_5", "__P_361_6", "__P_361_7");
    }
  });
