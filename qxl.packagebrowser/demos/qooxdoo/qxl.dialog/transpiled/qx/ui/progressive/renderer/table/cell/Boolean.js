  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.ui.progressive.renderer.table.cell.Boolean", {
    ...
    construct: function construct() {
      ...
      {
        this.__P_348_0 = qx.theme.manager.Meta.getInstance().addListener("changeTheme", this._resolveImages, this);
      }
    },
    properties: {
      /**
    ...
    destruct: function destruct() {
      ...
      if (true && this.__P_348_0) {
        qx.theme.manager.Meta.getInstance().removeListenerById(this.__P_348_0);
      }
    }
  });
