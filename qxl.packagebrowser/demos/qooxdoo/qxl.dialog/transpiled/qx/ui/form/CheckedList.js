  ...
  qx.Class.define("qx.ui.form.CheckedList", {
    ...
    members: {
      ...
      setChecked: function setChecked(checked) {
        ...
        try {
          var toUncheck = {};
          Object.values(this.__P_261_0).forEach(function (item) {
          ...
          this.__P_261_0 = replacement;
        } finally {
          this.__P_261_1 = false;
        }
      ...
      _onAddChild: function _onAddChild(evt) {
        ...
        item.addListener("changeValue", this.__P_261_3, this);
      },
      /*
       * @Override
       */
      _onRemoveChild: function _onRemoveChild(evt) {
        ...
        var item = evt.getData();
        item.removeListener("changeValue", this.__P_261_3, this);
        if (item.getValue()) {
          this.__P_261_2(item, true);
        }
      },
      /**
       ...
       */
      __P_261_3: function __P_261_3(evt) {
        if (this.__P_261_1) {
          return;
        }
        this.__P_261_2(evt.getTarget());
      },
      /**
       ...
       */
      __P_261_2: function __P_261_2(item, removing) {
        var hash = item.toHashCode();
