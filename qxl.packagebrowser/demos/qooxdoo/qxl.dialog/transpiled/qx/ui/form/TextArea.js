    ...
    members: {
      ...
      */
      ...
      __P_281_3: function __P_281_3() {
        var _this = this;
        if (this.isAutoSize()) {
          var clone = this.__P_281_4();
          if (clone && this.getBounds()) {
            // Remember original area height
            this.__P_281_2 = this.__P_281_2 || this._getAreaHeight();
            ...
            var desiredHeight = Math.max(scrolledHeight, this.__P_281_2);
      ...
      __P_281_4: function __P_281_4() {
        this.__P_281_0 = this.__P_281_0 || this.__P_281_7();
       ...
       */
      __P_281_6: function __P_281_6(clone) {
      ...
      */
      ...
      _applyAutoSize: function _applyAutoSize(value, old) {
        if (value) {
          this.__P_281_3();
          this.addListener("input", this.__P_281_3, this);
          ...
          this.removeListener("input", this.__P_281_3);
          this.getContentElement().setStyle("overflowY", "auto");
        }
      },
      // property apply
      ...
      */
      ...
      _getContentHint: function _getContentHint() {
        ...
        if (this.isAutoSize()) {
          hint.height = this.__P_281_1 || hint.height;
        }
        return hint;
      }
    },
