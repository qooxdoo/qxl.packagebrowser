  ...
  qx.Class.define("qx.ui.form.Spinner", {
    ...
    */
    ...
    construct: function construct(min, value, max) {
      ...
      {
        this.__P_279_0 = qx.locale.Manager.getInstance().addListener("changeLocale", this._onChangeLocale, this);
      }
    ...
    */
    ...
    members: {
      ...
      */
      ...
      _applyNumberFormat: function _applyNumberFormat(value, old) {
        ...
        this._applyValue(this.__P_279_1, undefined);
      },
      /**
      ...
      */
      ...
      _onTextChange: function _onTextChange(e) {
        ...
        if (!isNaN(value)) {
          ...
          if (value === this.__P_279_1) {
            this._applyValue(this.__P_279_1);
          } else {
            this.setValue(value);
          }
        } else {
    ...
    destruct: function destruct() {
      ...
      if (true && this.__P_279_0) {
        qx.locale.Manager.getInstance().removeListenerById(this.__P_279_0);
      }
    }
  });
