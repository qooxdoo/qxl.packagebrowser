    ...
    members: {
      ...
      */
      ...
      __P_124_5: function __P_124_5() {
        ...
        if (!this.__P_124_2 && this.__P_124_0 && qx.$$loader.scriptLoaded) {
      ...
      */
      ...
      _onNativeLoad: function _onNativeLoad() {
        var callback = qx.core.Environment.select("qx.globalErrorHandling", {
          "true": qx.event.GlobalError.observeMethod(this.__P_124_7),
          "false": this.__P_124_7
        });
      ...
      _onNativeUnload: function _onNativeUnload() {
        var callback = qx.core.Environment.select("qx.globalErrorHandling", {
          "true": qx.event.GlobalError.observeMethod(this.__P_124_8),
          "false": this.__P_124_8
        });
        callback.apply(this, arguments);
      },
      /**
