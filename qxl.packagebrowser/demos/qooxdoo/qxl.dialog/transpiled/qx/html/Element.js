  ...
  qx.Class.define("qx.html.Element", {
    ...
    */
    ...
    construct: function construct(tagName, styles, attributes) {
      ...
      this.__P_151_0 = styles || null;
      this.__P_151_1 = attributes || null;
      this.__P_151_2 = new Map();
      if (attributes) {
        ...
        }
        {
          ...
          for (var hc in scroll) {
            ...
            if (elem && elem.offsetWidth) {
              ...
              // ScrollToX
              if (obj.__P_151_10 != null) {
                obj._domNode.scrollLeft = obj.__P_151_10;
                delete obj.__P_151_10;
              }

              // ScrollToY
              if (obj.__P_151_11 != null) {
                obj._domNode.scrollTop = obj.__P_151_11;
                delete obj.__P_151_11;
              }

              // ScrollIntoViewX
              var intoViewX = obj.__P_151_12;
              if (intoViewX != null) {
    ...
    members: {
      ...
      */
      ...
      _serializeImpl: function _serializeImpl(serializer) {
        ...
        // Copy attributes
        if (this.__P_151_1) {
          for (var key in this.__P_151_1) {
            var result = qx.bom.element.Attribute.serialize(key, this.__P_151_1[key]);
      ...
      */
      ...
      hasSlots: function hasSlots(projection) {
        if (projection === null || projection === undefined) {
          return this.__P_151_2.size > 0;
        }
        if (projection === true || projection === qx.html.Slot.DEFAULT) {
          return this.__P_151_2.has(qx.html.Slot.DEFAULT);
        }
        if (typeof projection === "string") {
          return this.__P_151_2.has(projection);
        }
       ...
       */
      __P_151_18: function __P_151_18(slotName) {
      ...
      inject: function inject(childNode, slotNameOverride) {
        ...
        if (!this.__P_151_18(slotName)) {
          return;
        }
        this.__P_151_2.get(slotName).add(childNode);

        // Chaining support
        return this;
      },
      __P_151_19: function __P_151_19(element) {
        ...
        (_element$getChildren = element.getChildren()) === null || _element$getChildren === void 0 || _element$getChildren.forEach(function (child) {
          return slots.push.apply(slots, _toConsumableArray(_this.__P_151_19(child)));
        });
        return slots;
      },
      _slotScanAdd: function _slotScanAdd(element) {
        var _iterator = _createForOfIteratorHelper(this.__P_151_19(element)),
          _step;
        try {
          for (_iterator.s(); !(_step = _iterator.n()).done;) {
            var slot = _step.value;
            this.__P_151_2.set(slot.getName(), slot);
          }
        } catch (err) {
          _iterator.e(err);
        } finally {
      ...
      _slotScanRemove: function _slotScanRemove(child) {
        var _iterator2 = _createForOfIteratorHelper(this.__P_151_19(child)),
          _step2;
        try {
          for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
            var slot = _step2.value;
            this.__P_151_2["delete"](slot.getName());
          }
        } catch (err) {
          _iterator2.e(err);
        } finally {
      ...
      */
      ...
      _syncData: function _syncData() {
        ...
        if (jobs) {
          ...
          this.__P_151_16 = null;
        }

        // Sync styles
        var jobs = this.__P_151_15;
        if (jobs) {
          var data = this.__P_151_0;
          if (data) {
            var styles = {};
      ...
      */
      ...
      setRoot: function setRoot(root) {
        if (root && !this.__P_151_14) {
          qx.html.Element._hasRoots++;
        } else if (!root && this.__P_151_14) {
          qx.html.Element._hasRoots--;
        }
        this.__P_151_14 = root;
      },
      /*
       * @Override
       */
      isRoot: function isRoot() {
        return this.__P_151_14;
      },
      /**
      ...
      */
      ...
      disableScrolling: function disableScrolling() {
        ...
        this.scrollToX(0);
        this.scrollToY(0);
        this.addListener("scroll", this.__P_151_20, this);
      },
      /**
       * Re-enables browser-native scrolling
       */
      enableScrolling: function enableScrolling() {
        this.removeListener("scroll", this.__P_151_20, this);
      },
      __P_151_21: null,
      /**
       ...
       */
      __P_151_20: function __P_151_20(e) {
        if (!this.__P_151_21) {
          this.__P_151_21 = true;
          this._domNode.scrollTop = 0;
          this._domNode.scrollLeft = 0;
          delete this.__P_151_21;
        }
      },
      /*
      ---------------------------------------------------------------------------
      ...
      */
       ...
       */
      __P_151_22: function __P_151_22(action, args) {
        {
      ...
      capture: function capture(containerCapture) {
        {
          this.__P_151_22("capture", [containerCapture !== false]);
        }
      },
      /**
      ...
      releaseCapture: function releaseCapture() {
        {
          this.__P_151_22("releaseCapture");
        }
      },
      /*
      ---------------------------------------------------------------------------
      ...
      */
      ...
      setStyle: function setStyle(key, value, direct) {
        ...
        if (this.__P_151_0[key] == value) {
          return this;
        }
        this._applyStyle(key, value, this.__P_151_0[key]);
        if (value == null) {
          delete this.__P_151_0[key];
        } else {
          this.__P_151_0[key] = value;
        }
      ...
      getStyle: function getStyle(key) {
        return this.__P_151_0 ? this.__P_151_0[key] : null;
      },
      /**
      ...
      ---------------------------------------------------------------------------
      */
      __P_151_23: function __P_151_23() {
        var map = {};
      ...
      __P_151_24: function __P_151_24(map) {
      ...
      addClass: function addClass(name) {
        ...
        this.setAttribute("class", this.__P_151_24(classes));
        return this;
      },
      /**
    ...
    */
    destruct: function destruct() {
      ...
      this.setRoot(false);
      this.__P_151_1 = this.__P_151_0 = this.__P_151_16 = this.__P_151_15 = this.__P_151_12 = this.__P_151_13 = null;
    }
  });
