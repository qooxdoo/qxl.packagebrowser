    ...
    */
    members: {
      ...
      */
       ...
       */
      __P_24_10: function __P_24_10(mode) {
        this.__P_24_3 = mode;
      },
       ...
       */
      __P_24_11: function __P_24_11(mode) {
        var scale;
        var tagName;
      ...
      __P_24_7: function __P_24_7() {
        ...
        var mode = this.__P_24_9();

        if (this.__P_24_0[mode] == null) {
          this.__P_24_0[mode] = this.__P_24_11(mode);
        }
      ...
      _styleSource: function _styleSource() {
        ...
        if (!source) {
          this.__P_24_12(element);

          return;
        }

        this.__P_24_13(source);
        ...
        var contentEl = this.__P_24_14(); // Detect if the image registry knows this image


        if (ResourceManager.isFontUri(source)) {
          this.__P_24_15(contentEl, source);
          ...
          this.__P_24_18(contentEl, source);
        }
      },
       ...
       */
      __P_24_13: qx.core.Environment.select("engine.name", {
        "mshtml": function mshtml(source) {
          ...
          if (isFont) {
            ...
            if (this.getScale() && this.__P_24_9() != "alphaScaled") {
              this.__P_24_10("alphaScaled");
            } else if (!this.getScale() && this.__P_24_9() != "nonScaled") {
              this.__P_24_10("nonScaled");
            }
          } else {
            if (this.getScale() && this.__P_24_9() != "scaled") {
              this.__P_24_10("scaled");
            } else if (!this.getScale() && this.__P_24_9() != "nonScaled") {
              this.__P_24_10("nonScaled");
            }
          }

          this.__P_24_19(this.__P_24_7());
        },
        "default": function _default(source) {
          ...
          if (isFont) {
            this.__P_24_10("font");
          } else if (this.getScale() && this.__P_24_9() != "scaled") {
            this.__P_24_10("scaled");
          } else if (!this.getScale() && this.__P_24_9() != "nonScaled") {
            this.__P_24_10("nonScaled");
          }
       ...
       */
      __P_24_19: function __P_24_19(elementToAdd) {
       ...
       */
      __P_24_15: function __P_24_15(el, source) {
        var ResourceManager = qx.util.ResourceManager.getInstance();
        ...
        if (isFont) {
          ...
          this.__P_24_20(width, height);

          this.__P_24_8(el, source); // Apply source

        } else {
          // Apply source
          this.__P_24_8(el, source); // Compare with old sizes and relayout if necessary


          this.__P_24_20(ResourceManager.getImageWidth(source), ResourceManager.getImageHeight(source));
        }
      },
       ...
       * @param el {Element} image DOM element
       */
      __P_24_12: function __P_24_12(el) {
        if (el != null) {
       ...
       * @param source {String} source path
       */
      __P_24_8: function __P_24_8(el, source) {
        var isFont = source && qx.lang.String.startsWith(source, "@");
        ...
        if (isFont) {
          ...
          if (this.getScale()) {
            el.setStyle("fontSize", (this.__P_24_1 > this.__P_24_2 ? this.__P_24_2 : this.__P_24_1) + "px");
          } else {
       ...
       */
      __P_24_21: function __P_24_21(source, imageInfo) {
        ...
        this.__P_24_17(this.__P_24_14(), source);
      },
       ...
       */
      __P_24_20: function __P_24_20(width, height) {
        if (width === undefined) {
          width = this.__P_24_1;
        }
    ...
    destruct: function destruct() {
      for (var mode in this.__P_24_0) {
        if (this.__P_24_0.hasOwnProperty(mode)) {
          this.__P_24_0[mode].disconnectWidget(this);
        }
      }
...
//# sourceMappingURL=Image.js.map?dt=1626056868982