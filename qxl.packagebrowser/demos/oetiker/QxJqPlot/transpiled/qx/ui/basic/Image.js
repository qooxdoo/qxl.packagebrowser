      ...
      */
      ...
      __P_24_15: function __P_24_15(el, source) {
        ...
        if (isFont) {
          ...
          if (this.getScale()) {
            ...
            var font = this.__P_24_20(source);
          ...
          this.__P_24_21(ResourceManager.getImageWidth(source), ResourceManager.getImageHeight(source));
        }
      },
      __P_24_22: function __P_24_22(el, width, height) {
        if (this.getScale()) {
      ...
      _applyDimension: function _applyDimension() {
        ...
        if (isFont) {
          ...
          if (el) {
            ...
            this.__P_24_22(el, width, height);
          }
        } else {
          this.__P_24_21();
        }
      ...
      __P_24_18: function __P_24_18(el, source) {
        ...
        if (!ImageLoader.isFailed(source)) {
          ImageLoader.load(source, this.__P_24_23, this);
        } else {
          this.__P_24_12(el);
        }
      },
      ...
      __P_24_20: function __P_24_20(source) {
      ...
      __P_24_8: function __P_24_8(el, source) {
        ...
        if (isFont) {
          ...
          this.__P_24_22(el, this.__P_24_1, this.__P_24_2);
       ...
       */
      __P_24_23: function __P_24_23(source, imageInfo) {
       ...
       */
      __P_24_21: function __P_24_21(width, height) {
        if (width === undefined) {
          width = this.__P_24_1;
        }
        if (height === undefined) {
