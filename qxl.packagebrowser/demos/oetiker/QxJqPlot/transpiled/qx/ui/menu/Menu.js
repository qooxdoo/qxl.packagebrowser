    ...
    members: {
      ...
      */
      ...
      __P_51_2: function __P_51_2() {
        ...
        if (!menuBounds) {
          this.addListenerOnce("resize", this.__P_51_2, this);
          return;
        }
