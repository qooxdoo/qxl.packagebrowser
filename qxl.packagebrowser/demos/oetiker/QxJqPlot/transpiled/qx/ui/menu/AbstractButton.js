      ...
      */
      ...
      _onChangeCommand: function _onChangeCommand(e) {
        ...
        }
        {
          ...
          if (!oldCommand) {
            this.__P_112_0 = qx.locale.Manager.getInstance().addListener("changeLocale", this._onChangeLocale, this);
          }
          if (!command && this.__P_112_0) {
            qx.locale.Manager.getInstance().removeListenerById(this.__P_112_0);
          }
        }
