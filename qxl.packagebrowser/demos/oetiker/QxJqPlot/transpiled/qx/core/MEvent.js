  ...
  qx.Mixin.define("qx.core.MEvent", {
    members: {
      ...
      fireEventAsync: function fireEventAsync(type, clazz, args) {
        if (!this.$$disposed) {
          return this.__P_87_0.fireEventAsync(this, type, clazz, args);
        }
      ...
      fireNonBubblingEventAsync: function fireNonBubblingEventAsync(type, clazz, args) {
        if (!this.$$disposed) {
          return this.__P_87_0.fireNonBubblingEventAsync(this, type, clazz, args);
        }
      ...
      fireDataEventAsync: function fireDataEventAsync(type, data, oldData, cancelable) {
        if (!this.$$disposed) {
          ...
          return this.__P_87_0.fireEventAsync(this, type, qx.event.type.Data, [data, oldData, !!cancelable]);
        }
...
//# sourceMappingURL=MEvent.js.map?dt=1626056876360