  ...
  qx.Class.define("qx.bom.webfonts.Validator", {
    ...
    */
    ...
    construct: function construct(fontFamily, comparisonString, fontWeight, fontStyle) {
      ...
      if (fontFamily) {
        ...
        this.__P_164_0 = this._getRequestedHelpers();
      }
      this.__P_164_1 = new qx.Promise();
    },
    /*
    *****************************************************************************
       STATICS
    ...
    */
    ...
    statics: {
      ...
      removeDefaultHelperElements: function removeDefaultHelperElements() {
        var defaultHelpers = qx.bom.webfonts.Validator.__P_164_3;
        if (defaultHelpers) {
          for (var prop in defaultHelpers) {
            document.body.removeChild(defaultHelpers[prop]);
          }
        }
        delete qx.bom.webfonts.Validator.__P_164_3;
      }
    },
    /*
    *****************************************************************************
    ...
    members: {
      ...
      */
      ...
      validate: function validate() {
        ...
        var setValidImpl = function setValidImpl(valid) {
          if (_this.__P_164_4) {
            _this.__P_164_4.stop();
          }
          _this._reset();
          _this.__P_164_1.resolve(valid);
        ...
        if (document.fonts && typeof document.fonts.load == "function") {
          this.__P_164_5 = new Date().getTime();
          ...
          var timerCheck = function timerCheck() {
            if (_this._isFontValid()) {
              ...
              if (now - _this.__P_164_5 >= _this.getTimeout()) {
                setValidImpl(false);
              }
            }
          };
          ...
          qx.event.Timer.once(function () {
            _this.__P_164_4 = new qx.event.Timer(100);
            _this.__P_164_4.addListener("interval", timerCheck);
            _this.__P_164_4.start();
          }, this, 0);
        }
      },
      /**
      ...
      */
      ...
      _reset: function _reset() {
        if (this.__P_164_0) {
          for (var prop in this.__P_164_0) {
            var elem = this.__P_164_0[prop];
      ...
      _isFontValid: function _isFontValid() {
        if (!qx.bom.webfonts.Validator.__P_164_2) {
          this.__P_164_6();
        }
        if (!this.__P_164_0) {
          this.__P_164_0 = this._getRequestedHelpers();
        ...
        this.__P_164_0.sans.style.visibility = "visible";
        this.__P_164_0.sans.style.visibility = "hidden";
        this.__P_164_0.serif.style.visibility = "visible";
        this.__P_164_0.serif.style.visibility = "hidden";
        var requestedSans = qx.bom.element.Dimension.getWidth(this.__P_164_0.sans);
        var requestedSerif = qx.bom.element.Dimension.getWidth(this.__P_164_0.serif);
        var cls = qx.bom.webfonts.Validator;
        if (requestedSans !== cls.__P_164_2.sans || requestedSerif !== cls.__P_164_2.serif) {
          return true;
        }
        return false;
      },
      ...
      */
      ...
      __P_164_6: function __P_164_6() {
        ...
        cls.__P_164_2 = {
          sans: qx.bom.element.Dimension.getWidth(cls.__P_164_3.sans),
          serif: qx.bom.element.Dimension.getWidth(cls.__P_164_3.serif)
        };
      }
    },
    /*
    ...
    */
    destruct: function destruct() {
      ...
      this._disposeObjects("__P_164_4");
    }
  });
