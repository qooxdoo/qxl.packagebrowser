  ...
  ************************************************************************ */
  ...
  qx.Bootstrap.define("qx.bom.request.Script", {
    ...
    construct: function construct() {
      ...
      this.__P_116_1 = qx.Bootstrap.bind(this._onNativeLoad, this);
      this.__P_116_2 = qx.Bootstrap.bind(this._onNativeError, this);
      this.__P_116_3 = qx.Bootstrap.bind(this._onTimeout, this);
      this.__P_116_4 = document.head || document.getElementsByTagName("head")[0] || document.documentElement;
      ...
      this.timeout = this.__P_116_5() ? 0 : 15000;
    },
    events: {
    ...
    members: {
      ...
      open: function open(method, url) {
        ...
        if (this.__P_116_10("qx.debug.io")) {
      ...
      setRequestHeader: function setRequestHeader(key, value) {
        ...
        param[key] = value;
        this.__P_116_9 = qx.util.Uri.appendParamsToUrl(this.__P_116_9, param);
        return this;
      },
      ...
      send: function send() {
        ...
        var script = this.__P_116_11(),
            head = this.__P_116_4,
            that = this;

        if (this.timeout > 0) {
          this.__P_116_12 = window.setTimeout(this.__P_116_3, this.timeout);
        }
      ...
      */
      ...
      dispose: function dispose() {
        ...
        if (!this.__P_116_7) {
          ...
          if (this.__P_116_12) {
            window.clearTimeout(this.__P_116_12);
          }
      ...
      */
      ...
      _onNativeLoad: function _onNativeLoad() {
        var script = this.__P_116_14,
            determineSuccess = this.__P_116_6,
        ...
        if (this.__P_116_10("engine.name") === "mshtml" && this.__P_116_10("browser.documentmode") < 9) {
      ...
      */
       ...
       * Handle failure.
       */
      __P_116_15: function __P_116_15() {
        this.__P_116_13();
      ...
      __P_116_5: function __P_116_5() {
        var isLegacyIe = this.__P_116_10("engine.name") === "mshtml" && this.__P_116_10("browser.documentmode") < 9;
        var isOpera = this.__P_116_10("engine.name") === "opera";
      ...
      __P_116_11: function __P_116_11() {
        var script = this.__P_116_14 = document.createElement("script");
        script.src = this.__P_116_9;
        script.onerror = this.__P_116_2;
        script.onload = this.__P_116_1; // BUGFIX: IE < 9
        // Legacy IEs do not fire the "load" event for script elements.
        // Instead, they support the "readystatechange" event

        if (this.__P_116_10("engine.name") === "mshtml" && this.__P_116_10("browser.documentmode") < 9) {
          script.onreadystatechange = this.__P_116_1;
        }
      ...
      __P_116_13: function __P_116_13() {
        ...
        if (script && script.parentNode) {
          this.__P_116_4.removeChild(script);
        }
      },
       ...
       */
      __P_116_10: function __P_116_10(key) {
...
//# sourceMappingURL=Script.js.map?dt=1626056879271