    ...
    members: {
      ...
      resolve: function resolve(value) {
        ...
        if (theme !== null && theme.fonts[value]) {
          var font = this.__P_65_0(theme.fonts[value]);
       ...
       */
      __P_65_1: function __P_65_1(fonts, fontName) {
        ...
        if (value) {
          ...
          for (var key in source) {
            if (source[key].include && source[source[key].include]) {
              this.__P_65_1(source, key);
            }

            var font = this.__P_65_0(source[key]);
       ...
       * @return {Class}
       */
      __P_65_0: function __P_65_0(config) {
        if (config.sources) {
...
//# sourceMappingURL=Font.js.map?dt=1626056874447