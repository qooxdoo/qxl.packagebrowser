  ...
  qx.Class.define("qx.Promise", {
    ...
    construct: function construct(fn, context) {
      ...
      if (fn instanceof qx.Promise.Impl) {
        ...
        this.__P_30_1 = new qx.Promise.Impl(fn);
      } else {
        this.__P_30_1 = new qx.Promise.Impl(this.__P_30_2.bind(this));
      }
    ...
    members: {
      ...
      bind: function bind(context) {
        return qx.Promise.__P_30_5(this.__P_30_1.bind(context));
      },
      /**
      ...
      resolve: function resolve(value) {
        this.__P_30_6().resolve(value);
      },
      /**
       * Rejects an external promise
       */
      reject: function reject(reason) {
        this.__P_30_6().reject(reason);
      },
      /* *********************************************************************************
       *
       * Utility methods
      ...
      _callIterableMethod: function _callIterableMethod(methodName, args) {
        args = qx.Promise.__P_30_7(args);
        return qx.Promise.__P_30_5(this.__P_30_1.then(function (value) {
          var newP = qx.Promise.Impl.resolve(value instanceof qx.data.Array ? value.toArray() : value);
          return qx.Promise.__P_30_5(newP[methodName].apply(newP, args));
        }));
      },
      /**
      ...
      _callMethod: function _callMethod(methodName, args) {
        args = qx.Promise.__P_30_7(args);
        return qx.Promise.__P_30_5(this.__P_30_1[methodName].apply(this.__P_30_1, args));
      },
      /**
    ...
    statics: {
       ...
       */
      __P_30_8: new Error("Default Error"),
      /* *********************************************************************************
       *
       * Promise API methods
       *
      ...
      resolve: function resolve(value, context) {
        ...
        if (value instanceof qx.Promise) {
          ...
          promise = qx.Promise.__P_30_5(qx.Promise.Impl.resolve(value));
        }
      ...
      reject: function reject(reason, context) {
        ...
        if (reason === undefined) {
          args.shift();
          args.unshift(qx.Promise.__P_30_8);
        } else if (!(reason instanceof Error)) {
          qx.log.Logger.warn("Rejecting a promise with a non-Error value");
        }
        var promise = qx.Promise.__P_30_9("reject", args, 0);
        if (context !== undefined) {
          promise = promise.bind(context);
        }
        return promise;
      ...
      all: function all(iterable) {
        return qx.Promise.__P_30_9("all", arguments);
      },
      /**
       ...
       */
      race: function race(iterable) {
        return qx.Promise.__P_30_9("race", arguments);
      },
      /* *********************************************************************************
       *
       ...
       */
      any: function any(iterable) {
        return qx.Promise.__P_30_9("any", arguments);
      },
      /**
       ...
       */
      some: function some(iterable, count) {
        return qx.Promise.__P_30_9("some", arguments);
      },
      /**
      ...
      forEach: function forEach(iterable, iterator) {
        return qx.Promise.__P_30_9("each", arguments);
      },
      /**
      ...
      filter: function filter(iterable, iterator, options) {
        return qx.Promise.__P_30_9("filter", arguments);
      },
      /**
      ...
      map: function map(iterable, iterator, options) {
        return qx.Promise.__P_30_9("map", arguments);
      },
      /**
       * Given an <code>Iterable</code>(arrays are <code>Iterable</code>), or a promise of an
       * <code>Iterable</code>, which produces promises (or a mix of promises and values), iterate over
      ...
      mapSeries: function mapSeries(iterable, iterator) {
        return qx.Promise.__P_30_9("mapSeries", arguments);
      },
      /**
       * Given an <code>Iterable</code> (arrays are <code>Iterable</code>), or a promise of an
      ...
      reduce: function reduce(iterable, reducer, initialValue) {
        return qx.Promise.__P_30_9("reduce", arguments);
      },
      /**
      ...
      method: function method(cb) {
        ...
        return function () {
          return qx.Promise.__P_30_5(wrappedCb.apply(this, arguments));
        };
      },
      /**
      ...
      props: function props(input) {
        return qx.Promise.__P_30_9("props", arguments);
      },
      /**
       ...
       * @return {Object}
       */
      __P_30_5: function __P_30_5(value) {
       ...
       */
      __P_30_7: function __P_30_7(args, minArgs) {
       ...
       * @return {Object?}
       */
      __P_30_9: function __P_30_9(methodName, args, minArgs) {
        args = qx.Promise.__P_30_7(args, minArgs);
        return qx.Promise.__P_30_5(qx.Promise.Impl[methodName].apply(qx.Promise.Impl, qx.Promise.__P_30_12(args)));
      },
      /**
