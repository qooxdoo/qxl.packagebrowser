  ...
  qx.Bootstrap.define("qx.util.ColorUtil", {
    statics: {
      ...
      */
       ...
       */
      __P_108_6: function __P_108_6(color, tuneMap, tuner, hue_tuner) {
      ...
      scale: function scale(color, scaleMap) {
        return this.__P_108_6(color, scaleMap, function (value, scale, max) {
          if (value > max) {
            value = max;
          }
      ...
      adjust: function adjust(color, adjustMap) {
        return this.__P_108_6(color, adjustMap, function (value, offset, max) {
          value += offset;
...
//# sourceMappingURL=ColorUtil.js.map?dt=1626056878624