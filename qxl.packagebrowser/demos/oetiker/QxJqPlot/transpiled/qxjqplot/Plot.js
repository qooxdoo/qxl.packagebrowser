(function () {
  ...
  ************************************************************************ */
  ...
  qx.Class.define("qxjqplot.Plot", {
     ...
     *
     */
    construct: function construct(dataSeries, getOptions, pluginArr) {
      qx.ui.core.Widget.constructor.call(this);

      this._setup(dataSeries, getOptions, pluginArr);
    },
    members: {
      _getDomElement: function _getDomElement() {
        return this.getContentElement().getDomElement();
      },
      _bindResizeEvent: function _bindResizeEvent(plot, id, dataSeries, options) {
        this.addListener('resize', qx.lang.Function.bind(this._redraw, this, plot, id, dataSeries, options), this);
      }
    }
  });
  qxjqplot.Plot.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=Plot.js.map?dt=1626056865166