(function () {
  ...
  ************************************************************************ */
  qx.Class.define("qxjqplot.demo.Application", {
    ...
    members: {
      main: function main() {
        qxjqplot.demo.Application.prototype.main.base.call(this);
        ;
        var plotDemo = [{
          title: 'Data Point Highlighting',
          data: [[['23-May-08', 578.55], ['20-Jun-08', 566.5], ['25-Jul-08', 480.88], ['22-Aug-08', 509.84], ['26-Sep-08', 454.13], ['24-Oct-08', 379.75], ['21-Nov-08', 303], ['26-Dec-08', 308.56], ['23-Jan-09', 299.14], ['20-Feb-09', 346.51], ['20-Mar-09', 325.99], ['24-Apr-09', 386.15]]],
          options: function options($jqplot) {
            return {
          ...
          data: [[[1, 1], [1.5, 2.25], [2, 4], [2.5, 6.25], [3, 9], [3.5, 12.25], [4, 16]], [25, 17.5, 12.25, 8.6, 6.0, 4.2, 2.9], [4, 25, 13, 22, 14, 17, 15]],
          options: {
            legend: {
              show: true
            },
      ...
      x: 0,
      y: 0,
      makePlot: function makePlot(data, options, plugins, title) {
  ...
  qxjqplot.demo.Application.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=Application.js.map?dt=1626056863837