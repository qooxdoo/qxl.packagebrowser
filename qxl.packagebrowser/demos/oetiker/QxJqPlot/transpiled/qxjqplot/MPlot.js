(function () {
  ...
  ************************************************************************ */
  ...
  qx.Mixin.define("qxjqplot.MPlot", {
    statics: {
      ...
      DEFAULT_OPTIONS: {
        ...
        seriesColors: ['#005796', '#ffbf17', '#46b535', '#e93f80', '#bbe3ff', '#ff811b', '#007333', '#ffe370', '#a6004f', '#a6004f', '#bde734', '#0094d8', '#ffbedd'],
        grid: {
          background: '#ffffff'
        },
        seriesDefaults: {
    ...
    members: {
       ...
       *
       */
      _setup: function _setup(dataSeries, getOptions, pluginArr) {
        var min = '.min';
        ...
        var codeArr = [prefix + "jquery" + min + ".js", prefix + "jquery.jqplot" + min + ".js"];
        ...
        this.__P_27_0("jquery.jqplot" + min + ".css");

        var dynLoader = new qx.util.DynamicScriptLoader(codeArr);
        dynLoader.addListenerOnce('ready', function (e) {
          this.__P_27_1(dataSeries, getOptions);
        }, this);
       ...
       */
      __P_27_0: function __P_27_0(url) {
       ...
       */
      __P_27_1: function __P_27_1(dataSeries, getOptions) {
        ...
        if (el == null || el.offsetParent === null) {
          this.addListenerOnce('appear', qx.lang.Function.bind(this.__P_27_1, this, dataSeries, getOptions), this);
        } else {
          ...
          var plot = this.__P_27_2 = jQuery.jqplot(id, dataSeries, options);
          this.fireDataEvent('plotCreated', plot);

          this._bindResizeEvent(plot, id, dataSeries, options);
        }
      },
      _redraw: function _redraw(plot, id, dataSeries, options) {
  ...
  qxjqplot.MPlot.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=MPlot.js.map?dt=1626056869309