  ...
  ************************************************************************ */
  ...
  qx.Mixin.define("qx.ui.decoration.MDoubleBorder", {
    ...
    construct: function construct() {
      ...
      this._getDefaultInsetsForBorder = this.__P_193_0;
      this._styleBorder = this.__P_193_1;
    },
    /*
    *****************************************************************************
       PROPERTIES
    ...
    */
    ...
    members: {
       ...
       */
      __P_193_1: function __P_193_1(styles) {
        ...
        if (innerOpacity < 1) {
          this.__P_193_2(innerColor, innerOpacity);
        }
       ...
       */
      __P_193_2: function __P_193_2(innerColor, innerOpacity) {
