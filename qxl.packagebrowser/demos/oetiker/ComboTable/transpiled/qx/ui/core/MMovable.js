  ...
  qx.Mixin.define("qx.ui.core.MMovable", {
    ...
    members: {
      ...
      */
      ...
      _activateMoveHandle: function _activateMoveHandle(widget) {
        ...
        widget.addListener("losecapture", this.__P_184_10, this);
      },
      /**
      ...
      __P_184_11: function __P_184_11() {
        var frame = this.__P_184_1;
        if (!frame) {
          frame = this.__P_184_1 = new qx.ui.core.Widget();
      ...
      */
       ...
       */
      __P_184_13: function __P_184_13(e) {
        var range = this.__P_184_2;
        ...
        var viewportLeft = this.__P_184_3 + pointerLeft;
        var viewportTop = this.__P_184_4 + pointerTop;
        return {
          viewportLeft: parseInt(viewportLeft, 10),
          viewportTop: parseInt(viewportTop, 10),
          parentLeft: parseInt(viewportLeft - this.__P_184_5, 10),
          parentTop: parseInt(viewportTop - this.__P_184_6, 10)
        };
      },
      /*
      ---------------------------------------------------------------------------
      ...
      */
      ...
      _onMovePointerDown: function _onMovePointerDown(e) {
        ...
        if (qx.Class.implementsInterface(parent, qx.ui.window.IDesktop)) {
          if (!parent.isBlocked()) {
            this.__P_184_8 = parent.getBlockerColor();
            this.__P_184_9 = parent.getBlockerOpacity();
        ...
        this.__P_184_5 = parentLocation.left;
        this.__P_184_6 = parentLocation.top;
        this.__P_184_3 = widgetLocation.left - e.getDocumentLeft();
        this.__P_184_4 = widgetLocation.top - e.getDocumentTop();
      ...
      _onMovePointerMove: function _onMovePointerMove(e) {
        ...
        var coords = this.__P_184_13(e);
        if (this.getUseMoveFrame()) {
          this.__P_184_11().setDomPosition(coords.viewportLeft, coords.viewportTop);
        } else {
      ...
      _onMovePointerUp: function _onMovePointerUp(e) {
        ...
        if (qx.Class.implementsInterface(parent, qx.ui.window.IDesktop)) {
          if (this.__P_184_7) {
            parent.unblock();
            parent.setBlockerColor(this.__P_184_8);
            parent.setBlockerOpacity(this.__P_184_9);
            this.__P_184_8 = null;
            this.__P_184_9 = 0;
            this.__P_184_7 = false;
          }
        }
    ...
    */
    destruct: function destruct() {
      this._disposeObjects("__P_184_1", "__P_184_0");
      this.__P_184_2 = null;
    }
  });
