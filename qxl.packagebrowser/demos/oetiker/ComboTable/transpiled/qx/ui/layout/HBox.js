    ...
    members: {
      ...
      */
      ...
      __P_78_4: function __P_78_4() {
        ...
        var widths = reuse ? this.__P_78_0 : new Array(length);
        var flexs = reuse ? this.__P_78_1 : new Array(length);
        ...
        // Store data
        if (!reuse) {
          this.__P_78_0 = widths;
          this.__P_78_1 = flexs;
        }
        this.__P_78_2 = enableFlex;
        this.__P_78_3 = children;
      ...
      */
      ...
      renderLayout: function renderLayout(availWidth, availHeight, padding) {
        ...
        if (this.__P_78_2 && allocatedWidth != availWidth) {
          var flexibles = {};
          var flex, offset;
