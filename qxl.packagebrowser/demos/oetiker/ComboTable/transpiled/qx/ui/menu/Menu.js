    ...
    members: {
      ...
      */
      ...
      __P_117_2: function __P_117_2() {
        ...
        if (!menuBounds) {
          this.addListenerOnce("resize", this.__P_117_2, this);
          return;
        }
      ...
      syncWidget: function syncWidget(jobs) {
        ...
        if (this.__P_117_1) {
          this.__P_117_1.call(this);
          delete this.__P_117_1;
        }
      },
      /*
      ---------------------------------------------------------------------------
