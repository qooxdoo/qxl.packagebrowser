    ...
    statics: {
      ...
      */
      ...
      define: function define(name, config) {
        ...
        config.patch = this.__P_6_0(config.patch);
      ...
      */
      ...
      __P_6_5: qx.core.Environment.select("qx.debug", {
        "true": {
          title: "string",
          // String
          aliases: "object",
      ...
      __P_6_6: qx.core.Environment.select("qx.debug", {
        "true": {
          color: "object",
          border: "object",
          decoration: "object",
       ...
       */
      __P_6_7: qx.core.Environment.select("qx.debug", {
        "true": function _true(name, config) {
          var allowed = this.__P_6_5;
