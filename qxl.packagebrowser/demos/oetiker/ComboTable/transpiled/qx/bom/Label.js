  ...
  qx.Bootstrap.define("qx.bom.Label", {
    ...
    */
    ...
    statics: {
       ...
       */
      __P_75_3: function __P_75_3(html) {
       ...
       */
      __P_75_5: function __P_75_5(html) {
        var styles = {};
      ...
      create: function create(content, html, win) {
        ...
        if (!qx.core.Environment.get("css.textoverflow") && qx.core.Environment.get("html.xul")) {
          ...
          qx.bom.element.Style.setStyles(el, this.__P_75_5(html));
        }
        if (content) {
      ...
      setValue: function setValue(element, value) {
        value = value || "";
        if (element.useHtml) {
          if (qx.bom.Label.__P_75_6 && typeof qx.bom.Label.__P_75_6 === "function") {
            value = qx.bom.Label.__P_75_6(value);
          }
      ...
      getHtmlSize: function getHtmlSize(content, styles, width) {
        var cacheKey = this.__P_75_7(styles, width);
        var size = this.__P_75_8(cacheKey, content);
        if (size !== undefined) {
          return size;
        }
        var element = this._htmlElement || this.__P_75_4();

        // apply width
        element.style.width = width != undefined ? width + "px" : "auto";
        // insert content
        element.innerHTML = content;
        size = this.__P_75_9(element, styles);
        this.__P_75_10(cacheKey, content, size);
        return size;
      },
      /**
      ...
      getTextSize: function getTextSize(text, styles) {
        var cacheKey = this.__P_75_7(styles);
        var size = this.__P_75_8(cacheKey, text);
        if (size !== undefined) {
          return size;
        }
        var element = this._textElement || this.__P_75_2();
        if (!qx.core.Environment.get("css.textoverflow") && qx.core.Environment.get("html.xul")) {
        ...
        size = this.__P_75_9(element, styles);
        this.__P_75_10(cacheKey, text, size);
        return size;
      },
      /**
       ...
       * @returns
       */
      __P_75_7: function __P_75_7(styles, width) {
        var cacheKey = [];
       ...
       * @returns {*} size object
       */
      __P_75_8: function __P_75_8(cacheKey, text) {
        var cache = qx.bom.Label.__P_75_1[cacheKey];
       ...
       * @param {*} size
       */
      __P_75_10: function __P_75_10(cacheKey, text, size) {
        if (!size) {
          return;
        }
        var cache = qx.bom.Label.__P_75_1[cacheKey];
        if (cache === undefined) {
          cache = qx.bom.Label.__P_75_1[cacheKey] = {
            sizes: {}
          };
        }
       ...
       * @return {Map} A map with preferred <code>width</code> and <code>height</code>.
       */
      __P_75_9: function __P_75_9(element, styles) {
        // sync styles
