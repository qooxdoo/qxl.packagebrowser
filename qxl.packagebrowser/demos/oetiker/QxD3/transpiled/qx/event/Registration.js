    ...
    */
    ...
    statics: {
      ...
      getManager: function getManager(target) {
        ...
        var manager = this.__P_38_0[hash];
        if (!manager) {
          manager = new qx.event.Manager(target, this);
          this.__P_38_0[hash] = manager;
        }
        return manager;
      },
      /**
       ...
       * @see #createEvent
       */
      __P_38_1: function __P_38_1(target, type, clazz, args) {
       ...
       * @see #createEvent
       */
      __P_38_2: function __P_38_2(target, type, clazz, args) {
      ...
      fireNonBubblingEvent: function fireNonBubblingEvent(target, type, clazz, args) {
        var evt = this.__P_38_2.apply(this, arguments);
        if (evt === null) {
          return true;
        }
        return !evt.getDefaultPrevented();
      ...
      */
      ...
      addHandler: function addHandler(handler) {
        // Append to list
        this.__P_38_3.push(handler);

        // Re-sort list
        this.__P_38_3.sort(function (a, b) {
      ...
      */
      ...
      addDispatcher: function addDispatcher(dispatcher, priority) {
        // Append to list
        this.__P_38_4.push(dispatcher);

        // Re-sort list
        this.__P_38_4.sort(function (a, b) {
          return a.PRIORITY - b.PRIORITY;
        });
      },
      /**
