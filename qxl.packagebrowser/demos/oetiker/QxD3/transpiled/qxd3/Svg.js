  ...
  ************************************************************************ */
  ...
  if ({
    ...
    qx.bom.Event.stopPropagation = function (e) {
      if (_typeof(e.target.className) !== "object") {
  ...
  qx.Class.define("qxd3.Svg", {
    ...
    */
    construct: function construct() {
      ...
      ID++;
      var node = d3.select("body").append('svg').attr('width', '100%').attr('height', '100%');
      ...
      this.__P_4_0 = '#qxd3-' + ID;
      this.__P_4_1 = qx.bom.Stylesheet.createElement();
    },
    properties: {
      d3SvgNode: {}
    },
    members: {
      ...
      * </pre>
      */
      addCssRule: function addCssRule(selector, ruleMap) {
        selector.split(/\s*,\s*/).forEach(function (selectorItem) {
          for (var property in ruleMap) {
            qx.bom.Stylesheet.addRule(this.__P_4_1, this.__P_4_0 + ' ' + selectorItem, property + ':' + ruleMap[property]);
          }
        }, this);
      },
       ...
       */
      removeCssRule: function removeCssRule(selector) {
        selector.split(/\s*,\s*/).forEach(function (selectorItem) {
          qx.bom.Stylesheet.removeRule(this.__P_4_1, this.__P_4_0 + ' ' + selectorItem);
        }, this);
      }
    },
    ...
    destruct: function destruct() {
      qx.bom.Stylesheet.removeSheet(this.__P_4_1);
      this.__P_4_1 = null;
    }
  ...
  !function () {
    ...
    d3_selectionPrototype.select = function (selector) {
      ...
      for (var j = -1, m = this.length; ++j < m;) {
        ...
        for (var i = -1, n = group.length; ++i < n;) {
          if (node = group[i]) {
            subgroup.push(subnode = selector.call(node, node.__P_4_2, i, j));
            if (subnode && "__P_4_2" in node) subnode.__P_4_2 = node.__P_4_2;
          } else {
            subgroup.push(null);
          }
        }
    ...
    d3_selectionPrototype.selectAll = function (selector) {
      ...
      for (var j = -1, m = this.length; ++j < m;) {
        for (var group = this[j], i = -1, n = group.length; ++i < n;) {
          if (node = group[i]) {
            subgroups.push(subgroup = d3_array(selector.call(node, node.__P_4_2, i, j)));
    ...
    d3_selectionPrototype.data = function (value, key) {
      ...
      function bind(group, groupData) {
        ...
        if (key) {
          ...
          for (i = -1; ++i < n;) {
            if (node = group[i]) {
              if (nodeByKeyValue.has(keyValue = key.call(node, node.__P_4_2, i))) {
                exitNodes[i] = node;
              } else {
      ...
      if (typeof value === "function") {
        while (++i < n) {
          bind(group = this[i], value.call(group, group.parentNode.__P_4_2, i));
        }
      } else {
        while (++i < n) {
    ...
    d3_selectionPrototype.datum = function (value) {
      return arguments.length ? this.property("__P_4_2", value) : this.property("__P_4_2");
    };
    ...
    d3_selectionPrototype.filter = function (filter) {
      ...
      for (var j = 0, m = this.length; j < m; j++) {
        ...
        for (var i = 0, n = group.length; i < n; i++) {
          if ((node = group[i]) && filter.call(node, node.__P_4_2, i, j)) {
            subgroup.push(node);
          }
        }
      }
    ...
    function d3_selection_sortComparator(comparator) {
      ...
      return function (a, b) {
        return a && b ? comparator(a.__P_4_2, b.__P_4_2) : !a - !b;
      };
    }

    d3_selectionPrototype.each = function (callback) {
      return d3_selection_each(this, function (node, i, j) {
        callback.call(node, node.__P_4_2, i, j);
      });
    };
    ...
    d3_selection_enterPrototype.select = function (selector) {
      ...
      for (var j = -1, m = this.length; ++j < m;) {
        ...
        for (var i = -1, n = group.length; ++i < n;) {
          if (node = group[i]) {
            subgroup.push(upgroup[i] = subnode = selector.call(group.parentNode, node.__P_4_2, i, j));
            subnode.__P_4_2 = node.__P_4_2;
          } else {
            subgroup.push(null);
          }
        }
    ...
    function d3_lab_xyz(x) {
      return x > .206893034 ? x * x * x : (x - 0.13793103448275862) / 7.787037;
    }

    function d3_xyz_lab(x) {
      return x > .008856 ? Math.pow(x, 0.3333333333333333) : 7.787037 * x + 0.13793103448275862;
    }

    function d3_xyz_rgb(r) {
      return Math.round(255 * (r <= .00304 ? 12.92 * r : 1.055 * Math.pow(r, 0.4166666666666667) - .055));
    }
    ...
    var d3_format_types = d3.map({
      ...
      r: function r(x, p) {
        return (x = d3.round(x, d3_format_precision(x, p))).toFixed(Math.max(0, Math.min(20, d3_format_precision(x * 1.000000000000001, p))));
      }
    });
    ...
    var d3_svg_lineBasisBezier1 = [0, 0.6666666666666666, 0.3333333333333333, 0],
        d3_svg_lineBasisBezier2 = [0, 0.3333333333333333, 0.6666666666666666, 0],
        d3_svg_lineBasisBezier3 = [0, 0.16666666666666666, 0.6666666666666666, 0.16666666666666666];
    ...
    function d3_selection_interruptNS(ns) {
      return function () {
        ...
        if ((lock = this[ns]) && (active = lock[activeId = lock.active])) {
          ...
          lock.active += .5;
          active.event && active.event.interrupt.call(this, this.__P_4_2, active.index);
        }
      };
    }
    ...
    d3_transitionPrototype.select = function (selector) {
      ...
      for (var j = -1, m = this.length; ++j < m;) {
        ...
        for (var group = this[j], i = -1, n = group.length; ++i < n;) {
          if ((node = group[i]) && (subnode = selector.call(node, node.__P_4_2, i, j))) {
            if ("__P_4_2" in node) subnode.__P_4_2 = node.__P_4_2;
      ...
      for (var j = -1, m = this.length; ++j < m;) {
        for (var group = this[j], i = -1, n = group.length; ++i < n;) {
          if (node = group[i]) {
            ...
            subnodes = selector.call(node, node.__P_4_2, i, j);
            subgroups.push(subgroup = []);
    ...
    function d3_transition_tween(groups, name, value, tween) {
      ...
      return d3_selection_each(groups, typeof value === "function" ? function (node, i, j) {
        node[ns][id].tween.set(name, tween(value.call(node, node.__P_4_2, i, j)));
    ...
    d3_transitionPrototype.delay = function (value) {
      ...
      return d3_selection_each(this, typeof value === "function" ? function (node, i, j) {
        node[ns][id].delay = +value.call(node, node.__P_4_2, i, j);
    ...
    d3_transitionPrototype.duration = function (value) {
      ...
      return d3_selection_each(this, typeof value === "function" ? function (node, i, j) {
        node[ns][id].duration = Math.max(1, value.call(node, node.__P_4_2, i, j));
      ...
      if (arguments.length < 2) {
        ...
        try {
          ...
          d3_selection_each(this, function (node, i, j) {
            ...
            type.call(node, node.__P_4_2, i, j);
          });
        } finally {
    ...
    function d3_transitionNode(node, i, ns, id, inherit) {
      ...
      function start(elapsed) {
        ...
        if (active) {
          ...
          active.event && active.event.interrupt.call(node, node.__P_4_2, active.index);
        }
        ...
        lock.active = id;
        transition.event && transition.event.start.call(node, node.__P_4_2, i);
        tweens = [];
        transition.tween.forEach(function (key, value) {
          if (value = value.call(node, node.__P_4_2, i)) {
            tweens.push(value);
          }
        });
        ease = transition.ease;
      ...
      function tick(elapsed) {
        ...
        if (t >= 1) {
          transition.event && transition.event.end.call(node, node.__P_4_2, i);
    ...
    d3.svg.axis = function () {
      ...
      function axis(g) {
        g.each(function () {
          ...
          var scale0 = this.__P_4_3 || scale,
              scale1 = this.__P_4_3 = scale.copy();
        ...
        g.each(function () {
          var event_ = event.of(this, arguments),
            ...
            j: yExtentDomain
              ...
              extent0 = this.__P_4_3 || extent1;
          this.__P_4_3 = extent1;
  ...
  qxd3.Svg.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=Svg.js.map?dt=1626056751200