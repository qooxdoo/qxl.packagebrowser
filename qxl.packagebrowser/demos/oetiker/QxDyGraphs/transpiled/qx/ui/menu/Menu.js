    ...
    members: {
      ...
      */
      ...
      __P_54_2: function __P_54_2() {
        ...
        if (!menuBounds) {
          this.addListenerOnce("resize", this.__P_54_2, this);
          return;
        }
      ...
      syncWidget: function syncWidget(jobs) {
        ...
        if (this.__P_54_1) {
          this.__P_54_1.call(this);
          delete this.__P_54_1;
        }
      },
      /*
      ---------------------------------------------------------------------------
