  ...
  qx.Mixin.define("qx.ui.core.MPlacement", {
    ...
    members: {
      ...
      placeToWidget: function placeToWidget(target, liveupdate) {
        ...
        if (liveupdate) {
          this.__P_108_5(); // Bind target and livupdate to placeToWidget


          this.__P_108_2 = qx.lang.Function.bind(this.placeToWidget, this, target, false);
          qx.event.Idle.getInstance().addListener("interval", this.__P_108_2); // Remove the listener when the element disappears.
       ...
       *    first argument
       */
      __P_108_6: function __P_108_6(callback) {
        var size = null;
...
//# sourceMappingURL=MPlacement.js.map?dt=1626056821661