  ...
  qx.Bootstrap.define("qx.core.WindowError", {
    ...
    */
    ...
    construct: function construct(failMessage, uri, lineNumber, columnNumber, sourceException) {
      ...
      this.__P_128_0 = failMessage;
      this.__P_128_1 = uri || "";
      this.__P_128_2 = lineNumber === undefined ? -1 : lineNumber;
      this.__P_128_3 = columnNumber === undefined ? -1 : columnNumber;
      this.__P_128_4 = sourceException;
    },
...
//# sourceMappingURL=WindowError.js.map?dt=1626056823891