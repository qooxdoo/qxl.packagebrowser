  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.theme.manager.Decoration", {
    ...
    construct: function construct() {
      ...
      this.__P_55_0 = [];
      this.__P_55_1 = qx.core.Environment.get("engine.name") == "mshtml" && qx.core.Environment.get("browser.documentmode") < 9;
    },
    ...
    */
    members: {
      ...
      addCssClass: function addCssClass(value) {
        ...
        Object.keys(styles).sort().forEach(function (key) {
          ...
          if (qx.Bootstrap.isObject(styles[key])) {
            ...
            var innerSelector = this.__P_55_1 ? selector : selector + (inner ? ":" : "");

            this.__P_55_0.push(innerSelector + key);
      ...
      isCached: function isCached(decorator) {
        return !this.__P_55_2 ? false : qx.lang.Object.contains(this.__P_55_2, decorator);
      },
      // property apply
...
//# sourceMappingURL=Decoration.js.map?dt=1626056815899