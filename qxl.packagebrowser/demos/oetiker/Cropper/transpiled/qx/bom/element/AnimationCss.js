  ...
  qx.Bootstrap.define("qx.bom.element.AnimationCss", {
    statics: {
      ...
      _animate: function _animate(el, desc, duration, reverse) {
        this.__P_147_6(desc); // debug validation
        ...
        if (this.__P_147_5 != null) {
          ...
          el.style[qx.lang.String.camelCase(this.__P_147_5["name"])] = style; // use the fill mode property if available and suitable
...
//# sourceMappingURL=AnimationCss.js.map?dt=1626056715898