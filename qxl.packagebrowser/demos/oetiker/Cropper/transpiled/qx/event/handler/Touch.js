  ...
  qx.Class.define("qx.event.handler.Touch", {
    ...
    */
    ...
    construct: function construct(manager) {
      ...
      qx.event.handler.TouchCore.apply(this, [this.__P_151_2]);
    },
    /*
    *****************************************************************************
       STATICS
    ...
    members: {
      ...
      */
      ...
      _fireEvent: function _fireEvent(domEvent, type, target, eventTypeClass) {
        ...
        qx.event.Registration.fireEvent(this.__P_151_1, "useraction", qx.event.type.Data, [type]);
      },
      /*
      ---------------------------------------------------------------------------
      ...
      */
       ...
       */
      __P_151_4: function __P_151_4(method, args) {
