  ...
  ************************************************************************ */
  ...
  qx.Bootstrap.define("qx.bom.element.AnimationCss", {
    statics: {
      ...
      __P_184_5: qx.core.Environment.get("css.animation"),
      ...
      _animate: function _animate(el, desc, duration, reverse) {
        this.__P_184_6(desc); // debug validation
        ...
        if (!this.__P_184_0) {
          this.__P_184_0 = qx.bom.Stylesheet.createElement();
        }
        ...
        if (this.__P_184_5 != null) {
          var name = this.__P_184_7(keyFrames, reverse);

          var style = name + " " + duration + "ms " + desc.timing + " " + (desc.delay ? desc.delay + "ms " : "") + desc.repeat + " " + (desc.alternate ? "alternate" : "");
          qx.bom.Event.addNativeListener(el, this.__P_184_5["start-event"], this.__P_184_8);
          qx.bom.Event.addNativeListener(el, this.__P_184_5["iteration-event"], this.__P_184_9);
          qx.bom.Event.addNativeListener(el, this.__P_184_5["end-event"], this.__P_184_10);
          el.style[qx.lang.String.camelCase(this.__P_184_5["name"])] = style; // use the fill mode property if available and suitable

          if (keep && keep == 100 && this.__P_184_5["fill-mode"]) {
            el.style[this.__P_184_5["fill-mode"]] = "forwards";
          }
        }
        ...
        if (this.__P_184_5 == null) {
          window.setTimeout(function () {
            qx.bom.element.AnimationCss.__P_184_10({
              target: el
            });
          }, 0);
        }
      ...
      __P_184_10: function __P_184_10(e) {
        ...
        if (qx.bom.element.AnimationCss.__P_184_5 != null) {
          // reset the styling
          var key = qx.lang.String.camelCase(qx.bom.element.AnimationCss.__P_184_5["name"]);
          el.style[key] = "";
          qx.bom.Event.removeNativeListener(el, qx.bom.element.AnimationCss.__P_184_5["name"], qx.bom.element.AnimationCss.__P_184_10);
        }
        ...
        qx.bom.element.AnimationCss.__P_184_11(el, desc.keyFrames[animation.keep]);
       ...
       */
      __P_184_11: function __P_184_11(el, endFrame) {
        // keep the element at this animation step
        var transforms;

        for (var style in endFrame) {
          if (style in qx.bom.element.AnimationCss.__P_184_4) {
            if (!transforms) {
              transforms = {};
            }
       ...
       */
      __P_184_6: function __P_184_6(desc) {
       ...
       */
      __P_184_7: function __P_184_7(frames, reverse) {
        ...
        if (this.__P_184_3[rule]) {
          return this.__P_184_3[rule];
        }

        var name = this.__P_184_1 + this.__P_184_2++;
        var selector = this.__P_184_5["keyframes"] + " " + name;
        qx.bom.Stylesheet.addRule(this.__P_184_0, selector, rule);
        this.__P_184_3[rule] = name;
        return name;
      },
       ...
       */
      __P_184_13: function __P_184_13() {
        this.__P_184_2 = 0;

        if (this.__P_184_0) {
          this.__P_184_0.ownerNode.remove();
...
//# sourceMappingURL=AnimationCss.js.map?dt=1626056597941