  ...
  qx.Class.define("qx.bom.webfonts.Validator", {
    ...
    */
    ...
    construct: function construct(fontFamily, comparisonString, fontWeight, fontStyle) {
      ...
      if (fontFamily) {
        ...
        this.__P_173_0 = this._getRequestedHelpers();
      }
    },
    ...
    */
    statics: {
      ...
      removeDefaultHelperElements: function removeDefaultHelperElements() {
        var defaultHelpers = qx.bom.webfonts.Validator.__P_173_2;
        ...
        delete qx.bom.webfonts.Validator.__P_173_2;
      }
    },
    ...
    members: {
      ...
      */
      ...
      validate: function validate() {
        this.__P_173_4 = new Date().getTime();

        if (this.__P_173_3) {
          this.__P_173_3.restart();
        } else {
          this.__P_173_3 = new qx.event.Timer(100);

          this.__P_173_3.addListener("interval", this.__P_173_5, this); // Give the browser a chance to render the new elements


          qx.event.Timer.once(function () {
            this.__P_173_3.start();
          }, this, 0);
        }
      },
      ...
      */
      ...
      _reset: function _reset() {
        if (this.__P_173_0) {
          for (var prop in this.__P_173_0) {
            var elem = this.__P_173_0[prop];
      ...
      _isFontValid: function _isFontValid() {
        if (!qx.bom.webfonts.Validator.__P_173_1) {
          this.__P_173_6();
        }
        ...
        this.__P_173_0.sans.style.visibility = "visible";
        this.__P_173_0.sans.style.visibility = "hidden";
        this.__P_173_0.serif.style.visibility = "visible";
        this.__P_173_0.serif.style.visibility = "hidden";
        var requestedSans = qx.bom.element.Dimension.getWidth(this.__P_173_0.sans);
        var requestedSerif = qx.bom.element.Dimension.getWidth(this.__P_173_0.serif);
        var cls = qx.bom.webfonts.Validator;

        if (requestedSans !== cls.__P_173_1.sans || requestedSerif !== cls.__P_173_1.serif) {
          return true;
        }
      ...
      */
      ...
      __P_173_6: function __P_173_6() {
        ...
        cls.__P_173_1 = {
          sans: qx.bom.element.Dimension.getWidth(cls.__P_173_2.sans),
          serif: qx.bom.element.Dimension.getWidth(cls.__P_173_2.serif)
        };
      },
      ...
      __P_173_5: function __P_173_5() {
        if (this._isFontValid()) {
          ...
          if (now - this.__P_173_4 >= this.getTimeout()) {
            this.__P_173_3.stop();
    ...
    */
    destruct: function destruct() {
      ...
      this.__P_173_3.removeListener("interval", this.__P_173_5, this);

      this._disposeObjects("__P_173_3");
    }
  });
  qx.bom.webfonts.Validator.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=Validator.js.map?dt=1626056596540