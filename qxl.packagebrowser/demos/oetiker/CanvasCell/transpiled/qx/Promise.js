  ...
  qx.Class.define("qx.Promise", {
    ...
    construct: function construct(fn, context) {
      ...
      if (fn instanceof qx.Promise.Impl) {
        ...
        this.__P_60_1 = new qx.Promise.Impl(fn);
      } else {
        this.__P_60_1 = new qx.Promise.Impl(this.__P_60_2.bind(this));
      }
      qx.core.Assert.assertTrue(!this.__P_60_1.$$qxPromise);
      this.__P_60_1.$$qxPromise = this;
      if (context !== undefined && context !== null) {
        this.__P_60_1 = this.__P_60_1.bind(context);
      }
    },
    /**
     * Destructor
    ...
    destruct: function destruct() {
      delete this.__P_60_1.$$qxPromise;
      delete this.__P_60_1;
    },
    members: {
      /** The Promise */
      __P_60_1: null,
      ...
      bind: function bind(context) {
        return qx.Promise.__P_60_5(this.__P_60_1.bind(context));
      },
      /**
       ...
       */
      __P_60_2: function __P_60_2(resolve, reject) {
        this.__P_60_3 = {
          resolve: resolve,
          reject: reject,
          complete: false
      ...
      resolve: function resolve(value) {
        this.__P_60_6().resolve(value);
      },
      /**
       * Rejects an external promise
       */
      reject: function reject(reason) {
        this.__P_60_6().reject(reason);
      },
      /* *********************************************************************************
       *
       * Utility methods
      ...
      _callIterableMethod: function _callIterableMethod(methodName, args) {
        args = qx.Promise.__P_60_7(args);
        return qx.Promise.__P_60_5(this.__P_60_1.then(function (value) {
          var newP = qx.Promise.Impl.resolve(value instanceof qx.data.Array ? value.toArray() : value);
          return qx.Promise.__P_60_5(newP[methodName].apply(newP, args));
        }));
      },
      /**
      ...
      _callMethod: function _callMethod(methodName, args) {
        args = qx.Promise.__P_60_7(args);
        return qx.Promise.__P_60_5(this.__P_60_1[methodName].apply(this.__P_60_1, args));
      },
      /**
    ...
    statics: {
       ...
       */
      __P_60_8: new Error("Default Error"),
      /* *********************************************************************************
       *
       * Promise API methods
       *
      ...
      resolve: function resolve(value, context) {
        ...
        if (value instanceof qx.Promise) {
          ...
          promise = qx.Promise.__P_60_5(qx.Promise.Impl.resolve(value));
        }
      ...
      reject: function reject(reason, context) {
        ...
        if (reason === undefined) {
          args.shift();
          args.unshift(qx.Promise.__P_60_8);
        } else if (!(reason instanceof Error)) {
          qx.log.Logger.warn("Rejecting a promise with a non-Error value");
        }
        var promise = qx.Promise.__P_60_9("reject", args, 0);
        if (context !== undefined) {
          promise = promise.bind(context);
        }
        return promise;
      ...
      all: function all(iterable) {
        return qx.Promise.__P_60_9("all", arguments);
      },
      /**
       ...
       */
      race: function race(iterable) {
        return qx.Promise.__P_60_9("race", arguments);
      },
      /* *********************************************************************************
       *
       ...
       */
      any: function any(iterable) {
        return qx.Promise.__P_60_9("any", arguments);
      },
      /**
       ...
       */
      some: function some(iterable, count) {
        return qx.Promise.__P_60_9("some", arguments);
      },
      /**
      ...
      forEach: function forEach(iterable, iterator) {
        return qx.Promise.__P_60_9("each", arguments);
      },
      /**
      ...
      filter: function filter(iterable, iterator, options) {
        return qx.Promise.__P_60_9("filter", arguments);
      },
      /**
      ...
      map: function map(iterable, iterator, options) {
        return qx.Promise.__P_60_9("map", arguments);
      },
      /**
       * Given an <code>Iterable</code>(arrays are <code>Iterable</code>), or a promise of an
       * <code>Iterable</code>, which produces promises (or a mix of promises and values), iterate over
      ...
      mapSeries: function mapSeries(iterable, iterator) {
        return qx.Promise.__P_60_9("mapSeries", arguments);
      },
      /**
       * Given an <code>Iterable</code> (arrays are <code>Iterable</code>), or a promise of an
      ...
      reduce: function reduce(iterable, reducer, initialValue) {
        return qx.Promise.__P_60_9("reduce", arguments);
      },
      /**
      ...
      method: function method(cb) {
        ...
        return function () {
          return qx.Promise.__P_60_5(wrappedCb.apply(this, arguments));
        };
      },
      /**
      ...
      props: function props(input) {
        return qx.Promise.__P_60_9("props", arguments);
      },
      /**
      ...
      __P_60_0: function __P_60_0() {
        if (qx.Promise.__P_60_10) {
          return;
        }
        qx.Promise.__P_60_10 = true;
        var isNode = typeof process !== "undefined";
        if (isNode) {
          process.on("unhandledRejection", qx.Promise.__P_60_11.bind(this));
        } else {
          qx.bom.Event.addNativeListener(window, "unhandledrejection", qx.Promise.__P_60_11.bind(this));
        }
      },
      /**
       ...
       * @param e {NativeEvent}
       */
      __P_60_11: function __P_60_11(e) {
       ...
       * @return {Object}
       */
      __P_60_5: function __P_60_5(value) {
       ...
       */
      __P_60_7: function __P_60_7(args, minArgs) {
       ...
       * @return {Object?}
       */
      __P_60_9: function __P_60_9(methodName, args, minArgs) {
        args = qx.Promise.__P_60_7(args, minArgs);
        return qx.Promise.__P_60_5(qx.Promise.Impl[methodName].apply(qx.Promise.Impl, qx.Promise.__P_60_12(args)));
      },
      /**
       ...
       */
      __P_60_12: function __P_60_12(args) {
        var dest = [];
