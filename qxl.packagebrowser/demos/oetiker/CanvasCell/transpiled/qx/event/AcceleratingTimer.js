  ...
  qx.Class.define("qx.event.AcceleratingTimer", {
    ...
    members: {
      ...
      start: function start() {
        this.__P_193_0.setInterval(this.getFirstInterval());

        this.__P_193_0.start();
      },
      ...
      _onInterval: function _onInterval() {
        ...
        if (this.__P_193_1 == null) {
          this.__P_193_1 = this.getInterval();
        }

        this.__P_193_1 = Math.max(this.getMinimum(), this.__P_193_1 - this.getDecrease());

        this.__P_193_0.setInterval(this.__P_193_1);
...
//# sourceMappingURL=AcceleratingTimer.js.map?dt=1626056599124