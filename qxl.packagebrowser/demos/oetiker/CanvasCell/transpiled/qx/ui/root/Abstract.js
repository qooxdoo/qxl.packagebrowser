  ...
  qx.Class.define("qx.ui.root.Abstract", {
    ...
    */
    construct: function construct() {
      ...
      this.initNativeHelp();
      this.addListener("keypress", this.__P_68_0, this);
    },
    ...
    members: {
      ...
      _applyGlobalCursor: qx.core.Environment.select("engine.name", {
        ...
        "default": function _default(value, old) {
          ...
          var sheet = this.__P_68_1;

          if (!sheet) {
            this.__P_68_1 = sheet = Stylesheet.createElement();
          }
...
//# sourceMappingURL=Abstract.js.map?dt=1626056585488