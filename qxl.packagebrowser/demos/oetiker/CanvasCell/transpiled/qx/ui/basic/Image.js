      ...
      */
      ...
      __P_33_15: function __P_33_15(el, source) {
        ...
        if (isFont) {
          ...
          if (this.getScale()) {
            ...
            var font = this.__P_33_20(source);
          ...
          this.__P_33_21(ResourceManager.getImageWidth(source), ResourceManager.getImageHeight(source));
        }
      },
      __P_33_22: function __P_33_22(el, width, height) {
        if (this.getScale()) {
      ...
      _applyDimension: function _applyDimension() {
        ...
        if (isFont) {
          ...
          if (el) {
            ...
            this.__P_33_22(el, width, height);
          }
        } else {
          this.__P_33_21();
        }
      ...
      __P_33_18: function __P_33_18(el, source) {
        ...
        if (!ImageLoader.isFailed(source)) {
          ImageLoader.load(source, this.__P_33_23, this);
        } else {
          this.__P_33_12(el);
        }
      },
      ...
      __P_33_20: function __P_33_20(source) {
      ...
      __P_33_8: function __P_33_8(el, source) {
        ...
        if (isFont) {
          ...
          this.__P_33_22(el, this.__P_33_1, this.__P_33_2);
       ...
       */
      __P_33_23: function __P_33_23(source, imageInfo) {
       ...
       */
      __P_33_21: function __P_33_21(width, height) {
        if (width === undefined) {
          width = this.__P_33_1;
        }
        if (height === undefined) {
