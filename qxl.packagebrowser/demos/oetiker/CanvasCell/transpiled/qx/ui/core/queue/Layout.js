  ...
  qx.Class.define("qx.ui.core.queue.Layout", {
    statics: {
      ...
      remove: function remove(widget) {
        delete this.__P_69_0[widget.toHashCode()];
      },
      ...
      add: function add(widget) {
        this.__P_69_0[widget.toHashCode()] = widget;
      ...
      */
      isScheduled: function isScheduled(widget) {
        return !!this.__P_69_0[widget.toHashCode()];
      },
      ...
      flush: function flush() {
        ...
        var queue = this.__P_69_2(); // iterate in reversed order to process widgets with the smallest nesting
      ...
      __P_69_3: function __P_69_3() {
        ...
        this.__P_69_1 = {}; // sparse level array
...
//# sourceMappingURL=Layout.js.map?dt=1626056585638