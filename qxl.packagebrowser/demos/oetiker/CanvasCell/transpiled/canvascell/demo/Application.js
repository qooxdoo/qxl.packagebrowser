(function () {
  var $$dbClassInfo = {
    "dependsOn": {
      ...
      "qx.ui.table.Table": {},
      "canvascell.Renderer": {},
      "canvascell.plotter.Bar": {},
      "canvascell.plotter.SparkLine": {},
      "canvascell.plotter.TwoBar": {},
      "canvascell.plotter.QBars": {},
      "canvascell.plotter.DoubleBar": {}
    }
  };
  ...
  ************************************************************************ */
  ...
  qx.Class.define("canvascell.demo.Application", {
    ...
    members: {
      main: function main() {
        canvascell.demo.Application.prototype.main.base.call(this);
        ...
        var resizeBehavior = tColMod.getBehavior(); // This uses the set() method to set all attriutes at once; uses flex
        ...
        resizeBehavior.set(4, {
          width: "1*"
        });
        resizeBehavior.set(5, {
          width: "1*"
        });
        var barRenderer = new canvascell.Renderer(new canvascell.plotter.Bar({
          fill: '#280',
          border: '#260'
        }));
        tColMod.setDataCellRenderer(1, barRenderer);
        var sparkRenderer = new canvascell.Renderer(new canvascell.plotter.SparkLine({
          lineWidth: 0.5,
          lineColor: '#228',
          sparkRadius: 1,
          sparkColor: '#f22',
        ...
        var twoBarRenderer = new canvascell.Renderer(new canvascell.plotter.TwoBar({
          mainbarFill: '#b00',
          mainbarBorder: '#a00',
          stackbarFill: '#b80',
          stackbarBorder: '#a70'
      ...
      createRandomRows: function createRandomRows(rowCount) {
        ...
        for (var row = 0; row < rowCount; row++) {
          ...
          var dbl = [Math.random() * 10, Math.random() * 10];
  ...
  canvascell.demo.Application.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=Application.js.map?dt=1626056575281