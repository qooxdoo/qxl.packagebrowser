  ...
  qx.Class.define("qx.event.handler.Focus", {
    ...
    members: {
      ...
      */
      ...
      tryActivate: function tryActivate(element) {
        var active = this.__P_105_14(element);
        if (active) {
      ...
      */
       ...
       */
      __P_105_15: function __P_105_15(target, related, type, bubbles) {
      ...
      */
      ...
      __P_105_17: function __P_105_17() {
        ...
        if (!this._windowFocused) {
          ...
          this.__P_105_15(this._window, null, "focus", false);
        }
      },
      /*
      ---------------------------------------------------------------------------
      ...
      */
      ...
      _initObserver: qx.core.Environment.select("engine.name", {
        gecko: function gecko() {
          // Bind methods
          this.__P_105_1 = qx.lang.Function.listener(this.__P_105_18, this);
          this.__P_105_2 = qx.lang.Function.listener(this.__P_105_19, this);
          this.__P_105_3 = qx.lang.Function.listener(this.__P_105_20, this);
          this.__P_105_4 = qx.lang.Function.listener(this.__P_105_21, this);
          this.__P_105_5 = qx.lang.Function.listener(this.__P_105_22, this);

          // Register events
          qx.bom.Event.addNativeListener(this._document, "mousedown", this.__P_105_1, true);
          qx.bom.Event.addNativeListener(this._document, "mouseup", this.__P_105_2, true);

          // Capturing is needed for gecko to correctly
          // handle focus of input and textarea fields
          qx.bom.Event.addNativeListener(this._window, "focus", this.__P_105_3, true);
          qx.bom.Event.addNativeListener(this._window, "blur", this.__P_105_4, true);

          // Capture drag events
          qx.bom.Event.addNativeListener(this._window, "draggesture", this.__P_105_5, true);
        },
        mshtml: function mshtml() {
          // Bind methods
          this.__P_105_1 = qx.lang.Function.listener(this.__P_105_18, this);
          this.__P_105_2 = qx.lang.Function.listener(this.__P_105_19, this);
          this.__P_105_7 = qx.lang.Function.listener(this.__P_105_23, this);
          this.__P_105_8 = qx.lang.Function.listener(this.__P_105_24, this);
          this.__P_105_6 = qx.lang.Function.listener(this.__P_105_25, this);

          // Register events
          qx.bom.Event.addNativeListener(this._document, "mousedown", this.__P_105_1);
          qx.bom.Event.addNativeListener(this._document, "mouseup", this.__P_105_2);
          ...
          qx.bom.Event.addNativeListener(this._document, "focusin", this.__P_105_7);
          qx.bom.Event.addNativeListener(this._document, "focusout", this.__P_105_8);

          // Add selectstart to prevent selection
          qx.bom.Event.addNativeListener(this._document, "selectstart", this.__P_105_6);
        },
        webkit: qx.core.Environment.select("browser.name", {
          ...
          edge: function edge(domEvent) {
            ...
            qx.bom.Event.addNativeListener(this._document, "mousedown", this.__P_105_1, true);
            qx.bom.Event.addNativeListener(this._document, "mouseup", this.__P_105_2, true);
            qx.bom.Event.addNativeListener(this._document, "selectstart", this.__P_105_6, false);
            qx.bom.Event.addNativeListener(this._document, "focusin", this.__P_105_7);
            qx.bom.Event.addNativeListener(this._document, "focusout", this.__P_105_8);
          },
          "default": function _default(domEvent) {
            ...
            qx.bom.Event.addNativeListener(this._document, "mouseup", this.__P_105_2, true);
            qx.bom.Event.addNativeListener(this._document, "selectstart", this.__P_105_6, false);
            qx.bom.Event.addNativeListener(this._window, "DOMFocusOut", this.__P_105_8, true);
            qx.bom.Event.addNativeListener(this._window, "focus", this.__P_105_3, true);
            qx.bom.Event.addNativeListener(this._window, "blur", this.__P_105_4, true);
          }
        }),
        opera: function opera() {
          ...
          qx.bom.Event.addNativeListener(this._document, "mousedown", this.__P_105_1, true);
          qx.bom.Event.addNativeListener(this._document, "mouseup", this.__P_105_2, true);
          qx.bom.Event.addNativeListener(this._window, "DOMFocusIn", this.__P_105_7, true);
          qx.bom.Event.addNativeListener(this._window, "DOMFocusOut", this.__P_105_8, true);
        }
      }),
      /**
      ...
      _stopObserver: qx.core.Environment.select("engine.name", {
        gecko: function gecko() {
          qx.bom.Event.removeNativeListener(this._document, "mousedown", this.__P_105_1, true);
          qx.bom.Event.removeNativeListener(this._document, "mouseup", this.__P_105_2, true);
          qx.bom.Event.removeNativeListener(this._window, "focus", this.__P_105_3, true);
          qx.bom.Event.removeNativeListener(this._window, "blur", this.__P_105_4, true);
          qx.bom.Event.removeNativeListener(this._window, "draggesture", this.__P_105_5, true);
        },
        mshtml: function mshtml() {
          qx.bom.Event.removeNativeListener(this._document, "mousedown", this.__P_105_1);
          qx.bom.Event.removeNativeListener(this._document, "mouseup", this.__P_105_2);
          qx.bom.Event.removeNativeListener(this._document, "focusin", this.__P_105_7);
          qx.bom.Event.removeNativeListener(this._document, "focusout", this.__P_105_8);
          qx.bom.Event.removeNativeListener(this._document, "selectstart", this.__P_105_6);
        },
        webkit: qx.core.Environment.select("browser.name", {
          // fix for [ISSUE #9174]
          // distinguish bettween MS Edge, which is reported
          ...
          "default": function _default() {
            qx.bom.Event.removeNativeListener(this._document, "mousedown", this.__P_105_1, true);
            qx.bom.Event.removeNativeListener(this._document, "mouseup", this.__P_105_2, true);
            qx.bom.Event.removeNativeListener(this._document, "selectstart", this.__P_105_6, false);
            qx.bom.Event.removeNativeListener(this._window, "DOMFocusOut", this.__P_105_8, true);
            qx.bom.Event.removeNativeListener(this._window, "focus", this.__P_105_3, true);
            qx.bom.Event.removeNativeListener(this._window, "blur", this.__P_105_4, true);
          }
        }),
        opera: function opera() {
          qx.bom.Event.removeNativeListener(this._document, "mousedown", this.__P_105_1, true);
          qx.bom.Event.removeNativeListener(this._document, "mouseup", this.__P_105_2, true);
          qx.bom.Event.removeNativeListener(this._window, "DOMFocusIn", this.__P_105_7, true);
          qx.bom.Event.removeNativeListener(this._window, "DOMFocusOut", this.__P_105_8, true);
        }
      }),
      /*
      ...
      */
       ...
       */
      __P_105_22: qx.event.GlobalError.observeMethod(qx.core.Environment.select("engine.name", {
        gecko: function gecko(domEvent) {
          var target = qx.bom.Event.getTarget(domEvent);
          if (!this.__P_105_26(target)) {
       ...
       * @param domEvent {Event} Native event
       */
      __P_105_23: qx.event.GlobalError.observeMethod(qx.core.Environment.select("engine.name", {
        mshtml: function mshtml(domEvent) {
          ...
          var focusTarget = this.__P_105_27(target);
          if (focusTarget) {
        ...
        opera: function opera(domEvent) {
          ...
          if (target == this._document || target == this._window) {
            this.__P_105_17();
            if (this.__P_105_9) {
              this.setFocus(this.__P_105_9);
              delete this.__P_105_9;
            }
            if (this.__P_105_10) {
              this.setActive(this.__P_105_10);
              delete this.__P_105_10;
            }
          } else {
       ...
       * @param domEvent {Event} Native event
       */
      __P_105_24: qx.event.GlobalError.observeMethod(qx.core.Environment.select("engine.name", {
        mshtml: function mshtml(domEvent) {
        ...
        opera: function opera(domEvent) {
          ...
          if (target == this._document) {
            ...
            this.__P_105_9 = this.getFocus();
            this.__P_105_10 = this.getActive();
            this.resetFocus();
            this.resetActive();
          } else {
            if (target === this.getFocus()) {
       ...
       * @param domEvent {Event} Native event
       */
      __P_105_21: qx.event.GlobalError.observeMethod(qx.core.Environment.select("engine.name", {
        gecko: function gecko(domEvent) {
          var target = qx.bom.Event.getTarget(domEvent);
       ...
       * @param domEvent {Event} Native event
       */
      __P_105_20: qx.event.GlobalError.observeMethod(qx.core.Environment.select("engine.name", {
        gecko: function gecko(domEvent) {
          var target = qx.bom.Event.getTarget(domEvent);
          if (target === this._window || target === this._document) {
            this.__P_105_17();
        ...
        webkit: function webkit(domEvent) {
          ...
          if (target === this._window || target === this._document) {
            ...
            this.__P_105_13 = domEvent.relatedTarget;
            this.setFocus(target);
            this.__P_105_13 = null;
            this.tryActivate(target);
          }
        },
        "default": null
       ...
       * @param domEvent {Event} Native event
       */
      __P_105_18: qx.event.GlobalError.observeMethod(qx.core.Environment.select("engine.name", {
        mshtml: function mshtml(domEvent) {
          var target = qx.bom.Event.getTarget(domEvent);
       ...
       * @param domEvent {Event} Native event
       */
      __P_105_19: qx.event.GlobalError.observeMethod(qx.core.Environment.select("engine.name", {
        mshtml: function mshtml(domEvent) {
          var target = qx.bom.Event.getTarget(domEvent);
          if (target.unselectable) {
            target.unselectable = "off";
          }
          this.tryActivate(this.__P_105_28(target));
        },
        gecko: function gecko(domEvent) {
          // As of Firefox 3.0:
       ...
       */
      __P_105_29: function __P_105_29(target) {
       ...
       */
      __P_105_28: qx.event.GlobalError.observeMethod(qx.core.Environment.select("engine.name", {
        mshtml: function mshtml(target) {
          return this.__P_105_29(target);
        },
       ...
       * @param domEvent {Event} Native event
       */
      __P_105_25: qx.event.GlobalError.observeMethod(qx.core.Environment.select("engine.name", {
        mshtml: function mshtml(domEvent) {
          var target = qx.bom.Event.getTarget(domEvent);
          if (!this.__P_105_26(target)) {
            qx.bom.Event.preventDefault(domEvent);
      ...
      */
       ...
       */
      __P_105_30: function __P_105_30(el) {
       ...
       */
      __P_105_27: function __P_105_27(el) {
        while (el && el.nodeType === 1) {
          if (el.getAttribute("qxKeepFocus") == "on") {
            return null;
          }
          if (this.__P_105_30(el)) {
            return el;
          }
          el = el.parentNode;
        }
       ...
       */
      __P_105_14: function __P_105_14(el) {
        var orig = el;
        while (el && el.nodeType === 1) {
       ...
       */
      __P_105_26: function __P_105_26(node) {
      ...
      */
      ...
      _applyActive: function _applyActive(value, old) {
        // Fire events
        if (old) {
          this.__P_105_15(old, value, "deactivate", true);
        }
        if (value) {
          this.__P_105_15(value, old, "activate", true);
        }
      ...
      _applyFocus: function _applyFocus(value, old) {
        ...
        if (old) {
          this.__P_105_15(old, value, "focusout", true);
        }
        if (value) {
          this.__P_105_15(value, old, "focusin", true);
        }

        // Fire after events
        if (old) {
          this.__P_105_15(old, value, "blur", false);
        }
        if (value) {
          this.__P_105_15(value, old || this.__P_105_13, "focus", false);
        }
      }
    },
    /*
    ...
    */
    destruct: function destruct() {
      this._stopObserver();
      this._manager = this._window = this._document = this._root = this._body = this.__P_105_31 = this.__P_105_13 = null;
    },
    /*
    *****************************************************************************
       DEFER
