  ...
  qx.Class.define("qx.ui.tooltip.Manager", {
    ...
    */
    construct: function construct() {
      ...
      // Register events
      qx.event.Registration.addListener(document.body, "pointerover", this.__P_81_0, this, true);

      // Instantiate timers
      this.__P_81_1 = new qx.event.Timer();
      this.__P_81_1.addListener("interval", this.__P_81_2, this);
      this.__P_81_3 = new qx.event.Timer();
      this.__P_81_3.addListener("interval", this.__P_81_4, this);
    ...
    members: {
      ...
      */
      ...
      _applyCurrent: function _applyCurrent(value, old) {
        ...
        if (value) {
          this.__P_81_1.startWith(value.getShowTimeout());
    ...
    */
    destruct: function destruct() {
      // Deregister events
      qx.event.Registration.removeListener(document.body, "pointerover", this.__P_81_0, this, true);
