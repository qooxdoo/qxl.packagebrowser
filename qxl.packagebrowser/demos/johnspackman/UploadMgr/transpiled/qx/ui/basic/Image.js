      ...
      */
      ...
      __P_5_15: function __P_5_15(el, source) {
        ...
        if (isFont) {
          ...
          this.__P_5_21(ResourceManager.getImageWidth(source), ResourceManager.getImageHeight(source));
        }
      },
      __P_5_22: function __P_5_22(el, width, height) {
        if (this.getScale()) {
      ...
      __P_5_18: function __P_5_18(el, source) {
        ...
        if (!ImageLoader.isFailed(source)) {
          ImageLoader.load(source, this.__P_5_23, this);
        } else {
          this.__P_5_12(el);
        }
      },
      ...
      __P_5_20: function __P_5_20(source) {
      ...
      __P_5_8: function __P_5_8(el, source) {
        ...
        if (isFont) {
          ...
          this.__P_5_22(el, this.__P_5_1, this.__P_5_2);
       ...
       */
      __P_5_23: function __P_5_23(source, imageInfo) {
       ...
       */
      __P_5_21: function __P_5_21(width, height) {
        if (width === undefined) {
          width = this.__P_5_1;
        }
        if (height === undefined) {
