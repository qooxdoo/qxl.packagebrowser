  ...
  qx.Class.define("qx.ui.core.Blocker", {
    ...
    members: {
      ...
      __P_110_1: function __P_110_1() {
        if (this.isBlocked()) {
          ...
          this._widget.addListenerOnce("appear", this.__P_110_8, this);
        }
      },
      /**
      ...
      _applyColor: function _applyColor(value, old) {
        ...
        this.__P_110_9("backgroundColor", color);
      },
      // property apply
      _applyOpacity: function _applyOpacity(value, old) {
        this.__P_110_9("opacity", value);
      },
      /**
       ...
       */
      __P_110_9: function __P_110_9(key, value) {
        var blockers = [];
        this.__P_110_4 && blockers.push(this.__P_110_4);
      ...
      _backupActiveWidget: function _backupActiveWidget() {
        ...
        this.__P_110_2.push(activeWidget);
        this.__P_110_3.push(focusedWidget);
        if (activeWidget) {
      ...
      _restoreActiveWidget: function _restoreActiveWidget() {
        var widget;
        var focusElementsLength = this.__P_110_3.length;
        ...
        var activeElementsLength = this.__P_110_2.length;
        if (activeElementsLength > 0) {
          widget = this.__P_110_2.pop();
      ...
      getBlockerElement: function getBlockerElement(widget) {
        if (!this.__P_110_4) {
          this.__P_110_4 = this.__P_110_10();
          this.__P_110_4.setStyle("zIndex", 15);
          if (!widget) {
            if (this._isRoot) {
              widget = this._widget;
            } else {
          ...
          widget.getContentElement().add(this.__P_110_4);
          this.__P_110_4.exclude();
        }
        return this.__P_110_4;
      },
      /**
      ...
      _block: function _block(zIndex, blockContent) {
        if (!this._isRoot && !this._widget.getLayoutParent()) {
          if (!this.__P_110_7) {
            this.__P_110_7 = this._widget.addListenerOnce("appear", this._block.bind(this, zIndex));
          }
          return;
        }
        var parent;
        ...
        if (this.__P_110_5 < 2) {
          ...
          blocker.addListener("deactivate", this.__P_110_11, this);
          blocker.addListener("keypress", this.__P_110_12, this);
          blocker.addListener("keydown", this.__P_110_12, this);
          blocker.addListener("keyup", this.__P_110_12, this);
      ...
      unblock: function unblock() {
        if (this.__P_110_7) {
          this._widget.removeListenerById(this.__P_110_7);
          this.__P_110_7 = null;
        }
        if (!this.isBlocked()) {
          return;
      ...
      __P_110_13: function __P_110_13() {
        ...
        blocker.removeListener("deactivate", this.__P_110_11, this);
        blocker.removeListener("keypress", this.__P_110_12, this);
        blocker.removeListener("keydown", this.__P_110_12, this);
        blocker.removeListener("keyup", this.__P_110_12, this);
        blocker.exclude();
       ...
       */
      __P_110_12: function __P_110_12(e) {
       ...
       */
      __P_110_11: function __P_110_11() {
        //
    ...
    */
    destruct: function destruct() {
      ...
      this._widget.removeListener("appear", this.__P_110_8, this);
      this._widget.removeListener("disappear", this.__P_110_1, this);
      if (this.__P_110_7) {
        this._widget.removeListenerById(this.__P_110_7);
      }
      this._disposeObjects("__P_110_4", "__P_110_6");
      this.__P_110_2 = this.__P_110_3 = this._widget = null;
    }
  });
