      ...
      */
      ...
      __P_83_15: function __P_83_15(el, source) {
        ...
        if (isFont) {
          ...
          if (this.getScale()) {
            ...
            var font = this.__P_83_20(source);
          ...
          this.__P_83_21(ResourceManager.getImageWidth(source), ResourceManager.getImageHeight(source));
        }
      },
      __P_83_22: function __P_83_22(el, width, height) {
        if (this.getScale()) {
      ...
      _applyDimension: function _applyDimension() {
        ...
        if (isFont) {
          ...
          if (el) {
            ...
            this.__P_83_22(el, width, height);
          }
        } else {
          this.__P_83_21();
        }
      ...
      __P_83_18: function __P_83_18(el, source) {
        ...
        if (!ImageLoader.isFailed(source)) {
          ImageLoader.load(source, this.__P_83_23, this);
        } else {
          this.__P_83_12(el);
        }
      },
      ...
      __P_83_20: function __P_83_20(source) {
      ...
      __P_83_8: function __P_83_8(el, source) {
        ...
        if (isFont) {
          ...
          this.__P_83_22(el, this.__P_83_1, this.__P_83_2);
       ...
       */
      __P_83_23: function __P_83_23(source, imageInfo) {
       ...
       */
      __P_83_21: function __P_83_21(width, height) {
        if (width === undefined) {
          width = this.__P_83_1;
        }
        if (height === undefined) {
