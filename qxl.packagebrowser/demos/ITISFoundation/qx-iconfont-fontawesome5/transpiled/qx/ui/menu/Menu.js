    ...
    members: {
      ...
      */
      ...
      __P_58_2: function __P_58_2() {
        ...
        if (!menuBounds) {
          this.addListenerOnce("resize", this.__P_58_2, this);
          return;
        }
