  ...
  qx.Class.define("qx.promise.NativeWrapper", {
    ...
    construct: function construct(arg0) {
      ...
      if (typeof arg0 === "function") {
        this.__P_88_0 = new Promise(arg0);
    ...
    members: {
      ...
      bind: function bind(context) {
        var promise = new qx.promise.NativeWrapper(this.__P_88_0);
        return promise.__P_88_2(context);
      },
      /**
      ...
      then: function then(onResolved, onRejected) {
        onResolved = onResolved.bind(this.__P_88_1);
        if (onRejected) {
          onRejected = onRejected.bind(this.__P_88_1);
        }
        return qx.promise.NativeWrapper.__P_88_3(this.__P_88_0.then(onResolved, onRejected)).__P_88_2(this.__P_88_1);
      },
      /**
       * Same as for Native Promise
       * @returns {qx.promise.NativeWrapper}
      ...
      "catch": function _catch(handler) {
        handler = handler.bind(this.__P_88_1);
        return qx.promise.NativeWrapper.__P_88_3(this.__P_88_0["catch"](handler)).__P_88_2(this.__P_88_1);
      },
      /**
       * Same as for Native Promise
       * @returns {qx.promise.NativeWrapper}
      ...
      "finally": function _finally(handler) {
        handler = handler.bind(this.__P_88_1);
        return qx.promise.NativeWrapper.__P_88_3(this.__P_88_0["finally"](handler)).__P_88_2(this.__P_88_1);
      },
      /**
       ...
       */
      __P_88_2: function __P_88_2(context) {
        this.__P_88_1 = context;
        return this;
      }
    },
    statics: {
       ...
       * @returns
       */
      __P_88_3: function __P_88_3(promise) {
      ...
      resolve: function resolve(value) {
        return qx.promise.NativeWrapper.__P_88_3(Promise.resolve(value));
      },
      /**
      ...
      reject: function reject(reason) {
        return qx.promise.NativeWrapper.__P_88_3(Promise.reject(reason));
      },
      /**
      ...
      all: function all(iterable) {
        return qx.promise.NativeWrapper.resolve(iterable).then(function (iterable) {
          return qx.promise.NativeWrapper.__P_88_3(Promise.all(iterable));
        });
      },
      /**
      ...
      method: function method(cb) {
        ...
        return function () {
          ...
          return new qx.promise.NativeWrapper(function (resolve) {
            return resolve(cb.call.apply(cb, [_this.__P_88_1].concat(args)));
          });
        };
      },
      /**
