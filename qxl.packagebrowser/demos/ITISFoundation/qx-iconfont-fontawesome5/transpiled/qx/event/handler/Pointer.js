  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.event.handler.Pointer", {
    ...
    construct: function construct(manager) {
      ...
      qx.event.handler.PointerCore.apply(this, [this.__P_147_2]);
    },
    members: {
      __P_147_0: null,
      __P_147_1: null,
        ...
        if (target && target.nodeType) {
          ...
          qx.event.Utils.then(tracker, function () {
            if ((domEvent.getPointerType() !== "mouse" || domEvent.button <= qx.event.handler.PointerCore.LEFT_BUTTON) && (type == "pointerdown" || type == "pointerup" || type == "pointermove" || type == "pointercancel")) {
              return qx.event.Registration.fireEvent(self.__P_147_2, qx.event.handler.PointerCore.POINTER_TO_GESTURE_MAPPING[type], qx.event.type.Pointer, [domEvent, target, null, false, false]);
            }
          });
          qx.event.Utils.then(tracker, function () {
       ...
       */
      __P_147_3: function __P_147_3(method, args) {
