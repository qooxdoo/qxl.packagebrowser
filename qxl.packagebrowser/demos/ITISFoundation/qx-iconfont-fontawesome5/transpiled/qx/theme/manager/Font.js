    ...
    members: {
      ...
      resolve: function resolve(value) {
        ...
        if (theme !== null && theme.fonts[value]) {
          var createdFonts = this.__P_26_0(theme.fonts);
       ...
       */
      __P_26_2: function __P_26_2(fonts, fontName) {
       ...
       */
      __P_26_0: function __P_26_0(fontDefs) {
        var _this = this;
        var webFontDefs = [];
        var createdFonts = {};
        var _loop = function _loop() {
            ...
            if (fontDef.include && fontDefs[fontDef.include]) {
              _this.__P_26_2(fontDefs, fontId);
            }
            if (fontDef.fontName) {
            ...
            fontClass = _this.__P_26_1(fontDef);
       ...
       * @return {Class}
       */
      __P_26_1: function __P_26_1(config) {
