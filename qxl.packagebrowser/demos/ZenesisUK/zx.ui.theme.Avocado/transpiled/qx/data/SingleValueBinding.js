  ...
  qx.Class.define("qx.data.SingleValueBinding", {
    statics: {
      ...
      bind(sourceObject, sourcePropertyChain, targetObject, targetPropertyChain, options) {
        ...
        var targetListenerMap = this.__P_173_2(sourceObject, sourcePropertyChain, targetObject, targetPropertyChain, options);
        ...
        try {
          ...
          for (var i = 0; i < propertyNames.length; i++) {
            ...
            if (i == propertyNames.length - 1) {
              ...
              // create a listener
              var listener = qx.lang.Function.bind(this.__P_173_7, this, context);
       ...
       */
      __P_173_2(sourceObject, sourcePropertyChain, targetObject, targetPropertyChain, options) {
        // get the property names
       ...
       */
      __P_173_4(source, propertyName) {
        // get the current event name from the property definition
        var eventName = this.__P_173_14(source, propertyName);
       ...
       */
      __P_173_10(targetObject, targetPropertyChain) {
       ...
       */
      __P_173_9(targetObject, targetPropertyChain, value) {
        // get the last target object of the chain
        var properties = this.__P_173_12(targetPropertyChain);
        var target = this.__P_173_13(targetObject, properties);
        if (target) {
       ...
       */
      __P_173_12(targetPropertyChain) {
       ...
       *   should be set.
       */
      __P_173_13(targetObject, targetProperties, index) {
       ...
       */
      __P_173_5(value, targetObject, targetPropertyChain, options, sourceObject) {
        // first convert the initial value
        value = this.__P_173_11(value, targetObject, targetPropertyChain, options, sourceObject);
        ...
        if (value !== undefined) {
          try {
            var result = this.__P_173_9(targetObject, targetPropertyChain, value);
       ...
       *   property.
       */
      __P_173_6(sourceObject, sourceEvent, targetObject, targetProperty, options, arrayIndex) {
        // checks
        ...
        var bindListener = function bindListener(arrayIndex, e) {
          ...
          // convert the data
          data = qx.data.SingleValueBinding.__P_173_11(data, targetObject, targetProperty, options, sourceObject);
       ...
       *   object.
       */
      __P_173_8(id, sourceObject, sourceEvent, targetObject, targetProperty) {
        var hash;
        ...
        this.__P_173_0[hash].push(binding);
       ...
       */
      __P_173_11(value, targetObject, targetPropertyChain, options, sourceObject) {
       ...
       */
      __P_173_14(sourceObject, sourceProperty) {
        // get the event name
      ...
      getAllBindingsForObject(object) {
        ...
        var sourceBindings = this.__P_173_0[hash];

        // get all bindings of object as target
        var targetBindings = this.__P_173_1[hash];
