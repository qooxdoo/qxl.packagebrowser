  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.data.SingleValueBinding", {
    statics: {
       ...
       */
      __P_170_2(sourceObject, sourcePropertyChain, targetObject, targetPropertyChain, options) {
        // get the property names
       ...
       */
      __P_170_10(targetObject, targetPropertyChain) {
       ...
       */
      __P_170_9(targetObject, targetPropertyChain, value) {
        // get the last target object of the chain
        var properties = this.__P_170_12(targetPropertyChain);
        var target = this.__P_170_13(targetObject, properties);
        if (target) {
       ...
       */
      __P_170_12(targetPropertyChain) {
       ...
       *   should be set.
       */
      __P_170_13(targetObject, targetProperties, index) {
       ...
       */
      __P_170_5(value, targetObject, targetPropertyChain, options, sourceObject) {
       ...
       *   property.
       */
      __P_170_6(sourceObject, sourceEvent, targetObject, targetProperty, options, arrayIndex) {
        // checks
       ...
       *   object.
       */
      __P_170_8(id, sourceObject, sourceEvent, targetObject, targetProperty) {
        var hash;
       ...
       */
      __P_170_11(value, targetObject, targetPropertyChain, options, sourceObject) {
       ...
       */
      __P_170_14(sourceObject, sourceProperty) {
        // get the event name
