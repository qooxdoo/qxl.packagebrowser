  ...
  qx.Class.define("qx.data.Array", {
    ...
    construct(param) {
      ...
      if (param == undefined) {
        ...
        this.__P_100_0 = new Array(param);
        // check for an array itself
      } else if (param instanceof Array) {
        this.__P_100_0 = qx.lang.Array.clone(param);
    ...
    */
    ...
    members: {
      ...
      splice(startIndex, amount, varargs) {
        ...
        var returnArray = this.__P_100_0.splice.apply(this.__P_100_0, arguments);
        ...
        this.__P_100_2(startIndex + (arguments.length - 2) - amount, this.length);
      ...
      sort(func) {
        ...
        var oldArray = this.__P_100_0.concat();
        this.__P_100_0.sort.apply(this.__P_100_0, arguments);
       ...
       */
      setItem(index, item) {
        var oldItem = this.__P_100_0[index];
        // ignore settings of already set items [BUG #4106]
        if (oldItem === item) {
          return;
        }
        this.__P_100_0[index] = item;
      ...
      */
      ...
      removeAll() {
        ...
        var items = this.__P_100_0.concat();
      ...
      append(array) {
        ...
        var oldLength = this.__P_100_0.length;
        Array.prototype.push.apply(this.__P_100_0, array);
      ...
      forEach(callback, context) {
        this.__P_100_0.forEach((element, index) => callback.call(context, element, index, this));
      },
      /*
      ---------------------------------------------------------------------------
      ...
      */
       ...
       */
      find(callback, self) {
        return this.__P_100_0.find(callback, self);
      },
      /**
