  ...
  ************************************************************************ */
  ...
  qx.Bootstrap.define("qx.lang.String", {
    statics: {
       ...
       */
      hyphenate(str) {
        var result = this.__P_36_3[str];
        if (!result) {
          result = str.replace(/[A-Z]/g, function (match) {
            return "-" + match.charAt(0).toLowerCase();
          });
          this.__P_36_3[str] = result;
        }
        return result;
      },
      /**
       ...
       */
      isUpperCase(str) {
        return qx.lang.String.__P_36_5.upper.test(str);
      },
      /**
       ...
       */
      isLowerCase(str) {
        return qx.lang.String.__P_36_5.lower.test(str);
      },
      /**
       ...
       */
      isLetters(str) {
        return qx.lang.String.__P_36_5.letter.test(str);
      },
      /**
       ...
       */
      isDigits(str) {
        return qx.lang.String.__P_36_5.digit.test(str);
      },
      /**
