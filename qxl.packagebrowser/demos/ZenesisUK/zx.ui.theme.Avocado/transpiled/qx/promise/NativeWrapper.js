  ...
  qx.Class.define("qx.promise.NativeWrapper", {
    ...
    construct(arg0) {
      ...
      if (typeof arg0 === "function") {
        this.__P_101_0 = new Promise(arg0);
    ...
    members: {
       ...
       */
      bind(context) {
        let promise = new qx.promise.NativeWrapper(this.__P_101_0);
        return promise.__P_101_2(context);
      },
      /**
      ...
      then(onResolved, onRejected) {
        onResolved = onResolved.bind(this.__P_101_1);
        if (onRejected) {
          onRejected = onRejected.bind(this.__P_101_1);
        }
        return qx.promise.NativeWrapper.__P_101_3(this.__P_101_0.then(onResolved, onRejected)).__P_101_2(this.__P_101_1);
      },
      /**
       * Same as for Native Promise
       * @returns {qx.promise.NativeWrapper}
       */
        ...
        handler = handler.bind(this.__P_101_1);
        return qx.promise.NativeWrapper.__P_101_3(this.__P_101_0.catch(handler)).__P_101_2(this.__P_101_1);
      },
      /**
       * Same as for Native Promise
       * @returns {qx.promise.NativeWrapper}
       ...
       */
        ...
        handler = handler.bind(this.__P_101_1);
        return qx.promise.NativeWrapper.__P_101_3(this.__P_101_0.finally(handler)).__P_101_2(this.__P_101_1);
      },
      /**
    ...
    statics: {
       ...
       */
      resolve(value) {
        return qx.promise.NativeWrapper.__P_101_3(Promise.resolve(value));
      },
      /**
       ...
       */
      reject(reason) {
        return qx.promise.NativeWrapper.__P_101_3(Promise.reject(reason));
      },
      /**
       ...
       */
      all(iterable) {
        return qx.promise.NativeWrapper.resolve(iterable).then(iterable => qx.promise.NativeWrapper.__P_101_3(Promise.all(iterable)));
      },
      /**
       ...
       */
      race(iterable) {
        return qx.promise.NativeWrapper.resolve(iterable).then(iterableResolved => new qx.promise.NativeWrapper(Promise.race(iterableResolved)));
      },
      /* *********************************************************************************
       *
       ...
       */
      any(iterable) {
        return qx.promise.NativeWrapper.resolve(iterable).then(iterableResolved => new qx.promise.NativeWrapper(Promise.any(iterableResolved)));
      },
      /**
      ...
      filter(iterable, iterator, options) {
        let limiter = new qx.util.ConcurrencyLimiter(options === null || options === void 0 ? void 0 : options.concurrency);
        const doit = async () => {
          let iterableResolved = await iterable;
          let resultsPromises = iterableResolved.map((item, index) => limiter.add(async () => {
            let itemResolved = await item;
            let keep = await iterator(itemResolved, index, iterableResolved.length);
            return {
              keep,
              val: itemResolved
            };
      ...
      map(iterable, iterator, options) {
        return qx.promise.NativeWrapper.resolve(iterable).then(iterable => {
          let limiter = new qx.util.ConcurrencyLimiter(options === null || options === void 0 ? void 0 : options.concurrency);
          let resultsPromises = iterable.map((item, index) => limiter.add(async () => {
            let itemResolved = await item;
       ...
       */
      method(cb) {
        return (...args) => new qx.promise.NativeWrapper(resolve => resolve(cb.call(this.__P_101_1, ...args)));
      },
      /**
      ...
      props(input) {
        return qx.promise.NativeWrapper.resolve(input).then(input => {
          ...
          let promises = entries.map(entry => new qx.promise.NativeWrapper(async resolve => {
