    ...
    members: {
      ...
      */
      ...
      getListeners(target, type, capture) {
        ...
        var targetMap = this.__P_105_3.get(targetKey);
        if (!targetMap) {
          return null;
        }
       ...
       */
      getAllListeners() {
        return Object.fromEntries(this.__P_105_3.entries().map(([targetKey, targetMap]) => [targetKey, Object.fromEntries(targetMap.entries().map(([entryKey, entryMap]) => {
          var listeners = [...entryMap.values()];
      ...
      importListeners(target, list) {
        ...
        if (!targetMap) {
          targetMap = new Map();
          this.__P_105_3.set(targetKey, targetMap);
        }
       ...
       */
      __P_105_12(target, type, capture) {
      ...
      removeAllListeners(target) {
        ...
        this.__P_105_3.delete(targetKey);
        return true;
      },
      /**
       ...
       * @throws {Error} if there is no handler for the event
       */
      __P_105_13(target, type, capture) {
        var handler = this.findHandler(target, type);
        if (handler) {
      ...
      */
      ...
      dispose() {
        ...
        qx.util.DisposeUtil.disposeMap(this, "__P_105_5");
