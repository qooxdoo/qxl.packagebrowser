  ...
  ************************************************************************ */
  ...
  qx.Bootstrap.define("qx.event.handler.GestureCore", {
    ...
    members: {
       ...
       */
      __P_181_22(deltaX, deltaY, domEvent, target, time) {
        ...
        if (Math.abs(deltaY) < 1 && Math.abs(deltaX) < 1 || this.__P_181_4[oldTimeoutId] || this.getWindow && !this.getWindow()) {
       ...
       * @param target {Element} event target
       */
      __P_181_19(type, domEvent, target) {
       ...
       */
      __P_181_25(domEvent, target, rollFactor) {
        domEvent.delta = {
