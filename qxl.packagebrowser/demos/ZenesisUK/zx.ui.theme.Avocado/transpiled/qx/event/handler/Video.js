  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.event.handler.Video", {
    ...
    construct() {
      ...
      this.__P_199_0 = qx.lang.Function.listener(this._onNative, this);
    },
    statics: {
    ...
    members: {
      ...
      registerEvent(target, type, capture) {
        qx.bom.Event.addNativeListener(target, type, this.__P_199_0);
      },
      /**
      ...
      unregisterEvent(target, type) {
        qx.bom.Event.removeNativeListener(target, type, this.__P_199_0);
      }
    },
    defer(statics) {
