  ...
  qx.Class.define("qx.event.handler.Mouse", {
    ...
    */
    ...
    construct(manager) {
      ...
      this.__P_195_2 = this.__P_195_1.document;
      this.__P_195_3 = qx.lang.Function.listener(this._onNative, this);
    ...
    */
    ...
    members: {
      ...
      */
      ...
      registerEvent(target, type, capture) {
        if (qx.event.handler.Mouse.NON_BUBBLING_EVENTS[type]) {
          qx.bom.Event.addNativeListener(target, type, this.__P_195_3);
      ...
      unregisterEvent(target, type, capture) {
        if (qx.event.handler.Mouse.NON_BUBBLING_EVENTS[type]) {
          qx.bom.Event.removeNativeListener(target, type, this.__P_195_3);
        } else if (qx.core.Environment.get("os.name") === "ios") {
      ...
      */
       ...
       */
      __P_195_10(domEvent, type, target) {
        if (!target) {
        ...
        qx.event.Registration.fireEvent(this.__P_195_1, "useraction", qx.event.type.Data, [type || domEvent.type]);
      },
      /**
      ...
      */
       ...
       */
      _initButtonObserver() {
        this.__P_195_4 = qx.lang.Function.listener(this._onButtonEvent, this);
        var Event = qx.bom.Event;
        Event.addNativeListener(this.__P_195_2, "mousedown", this.__P_195_4);
        Event.addNativeListener(this.__P_195_2, "mouseup", this.__P_195_4);
        Event.addNativeListener(this.__P_195_2, "click", this.__P_195_4);
        Event.addNativeListener(this.__P_195_2, "auxclick", this.__P_195_4);
        Event.addNativeListener(this.__P_195_2, "dblclick", this.__P_195_4);
        Event.addNativeListener(this.__P_195_2, "contextmenu", this.__P_195_4);
      },
      /**
       ...
       */
      _initMoveObserver() {
        this.__P_195_5 = qx.lang.Function.listener(this._onMoveEvent, this);
        var Event = qx.bom.Event;
        Event.addNativeListener(this.__P_195_2, "mousemove", this.__P_195_5);
        Event.addNativeListener(this.__P_195_2, "mouseout", this.__P_195_5);
        Event.addNativeListener(this.__P_195_2, "mouseover", this.__P_195_5);
      },
      /**
       ...
       */
      _initWheelObserver() {
        this.__P_195_6 = qx.lang.Function.listener(this._onWheelEvent, this);
        var data = qx.bom.client.Event.getMouseWheel(this.__P_195_1);
        qx.bom.Event.addNativeListener(data.target, data.type, this.__P_195_6);
      },
      /*
      ---------------------------------------------------------------------------
        OBSERVER STOP
      ...
      */
      ...
      _stopButtonObserver() {
        var Event = qx.bom.Event;
        Event.removeNativeListener(this.__P_195_2, "mousedown", this.__P_195_4);
        Event.removeNativeListener(this.__P_195_2, "mouseup", this.__P_195_4);
        Event.removeNativeListener(this.__P_195_2, "click", this.__P_195_4);
        Event.removeNativeListener(this.__P_195_2, "dblclick", this.__P_195_4);
        Event.removeNativeListener(this.__P_195_2, "contextmenu", this.__P_195_4);
      },
      /**
      ...
      _stopMoveObserver() {
        var Event = qx.bom.Event;
        Event.removeNativeListener(this.__P_195_2, "mousemove", this.__P_195_5);
        Event.removeNativeListener(this.__P_195_2, "mouseover", this.__P_195_5);
        Event.removeNativeListener(this.__P_195_2, "mouseout", this.__P_195_5);
      },
      /**
      ...
      _stopWheelObserver() {
        var data = qx.bom.client.Event.getMouseWheel(this.__P_195_1);
        qx.bom.Event.removeNativeListener(data.target, data.type, this.__P_195_6);
      },
      /*
      ---------------------------------------------------------------------------
      ...
      */
      ...
      _onButtonEvent: qx.event.GlobalError.observeMethod(function (domEvent) {
        ...
        if (type == "click" && this.__P_195_9) {
          delete this.__P_195_9;
          return;
        }
        ...
        var isDrag = qx.event.handler.DragDrop && this.__P_195_0.getHandler(qx.event.handler.DragDrop).isSessionActive();
        if (isDrag && type == "click") {
          return;
        }
        if (this.__P_195_11) {
          this.__P_195_11(domEvent, type, target);
        }
        this.__P_195_10(domEvent, type, target);
        ...
        if (type == "auxclick" && domEvent.button == 1) {
          this.__P_195_10(domEvent, "click", target);
        }
        if (this.__P_195_12) {
          this.__P_195_12(domEvent, type, target);
        }
        if (this.__P_195_13 && !isDrag) {
          this.__P_195_13(domEvent, type, target);
        }
        this.__P_195_7 = type;
      }),
      /**
      ...
      _onWheelEvent: qx.event.GlobalError.observeMethod(function (domEvent) {
        this.__P_195_10(domEvent, "mousewheel");
      }),
      /*
      ---------------------------------------------------------------------------
      ...
      */
       ...
       */
      __P_195_12: qx.core.Environment.select("engine.name", {
        opera(domEvent, type, target) {
          if (type == "mouseup" && domEvent.button == 2) {
            this.__P_195_10(domEvent, "contextmenu", target);
          }
        },
        default: null
      }),
       ...
       * @signature function(domEvent, type, target)
       */
      __P_195_11: qx.core.Environment.select("engine.name", {
        mshtml(domEvent, type, target) {
          ...
          if (type == "mouseup" && this.__P_195_7 == "click") {
            this.__P_195_10(domEvent, "mousedown", target);
       ...
       * @signature function(domEvent, type, target)
       */
      __P_195_13: qx.core.Environment.select("engine.name", {
        mshtml: null,
        default(domEvent, type, target) {
          switch (type) {
            case "mousedown":
              this.__P_195_8 = target;
              break;
            case "mouseup":
              if (target !== this.__P_195_8) {
                var commonParent = qx.dom.Hierarchy.getCommonParent(target, this.__P_195_8);
                if (commonParent) {
                  this.__P_195_10(domEvent, "click", commonParent);
                }
              }
          }
        }
    ...
    */
    ...
    destruct() {
      ...
      this.__P_195_0 = this.__P_195_1 = this.__P_195_2 = this.__P_195_8 = null;
    },
    /*
    *****************************************************************************
       DEFER
