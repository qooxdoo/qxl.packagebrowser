  ...
  qx.Class.define("qx.event.handler.Appear", {
    ...
    */
    ...
    construct(manager) {
      ...
      // Register
      qx.event.handler.Appear.__P_133_2[this.toHashCode()] = this;
    },
    /*
    *****************************************************************************
       STATICS
        ...
        Object.keys(targets).forEach(function (hash) {
          ...
          qx.event.Utils.then(tracker, function () {
            ...
            if (!!elem.$$displayed !== displayed) {
              ...
              return self.__P_133_0.dispatchEvent(elem, evt);
            }
          });
        });
    ...
    */
    ...
    destruct() {
      ...
      // Deregister
      delete qx.event.handler.Appear.__P_133_2[this.toHashCode()];
    },
    /*
    *****************************************************************************
       DEFER
