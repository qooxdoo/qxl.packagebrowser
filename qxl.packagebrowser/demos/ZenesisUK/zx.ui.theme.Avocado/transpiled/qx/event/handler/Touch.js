  ...
  qx.Class.define("qx.event.handler.Touch", {
    ...
    */
    ...
    construct(manager) {
      ...
      this.__P_192_2 = this.__P_192_1.document;
      qx.event.handler.TouchCore.apply(this, [this.__P_192_2]);
    },
    /*
    *****************************************************************************
       STATICS
    ...
    members: {
      ...
      */
      ...
      _fireEvent(domEvent, type, target, eventTypeClass) {
        ...
        qx.event.Registration.fireEvent(this.__P_192_1, "useraction", qx.event.type.Data, [type]);
      },
      /*
      ---------------------------------------------------------------------------
      ...
      */
      ...
      dispose() {
        ...
        this.__P_192_0 = this.__P_192_1 = this.__P_192_2 = null;
      },
      /**
