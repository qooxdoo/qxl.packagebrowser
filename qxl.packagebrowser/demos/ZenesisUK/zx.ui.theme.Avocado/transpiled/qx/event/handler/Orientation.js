  ...
  qx.Class.define("qx.event.handler.Orientation", {
    ...
    */
    ...
    construct(manager) {
      ...
      // Define shorthands
      this.__P_254_0 = manager;
      this.__P_254_1 = manager.getWindow();
      this._initObserver();
    },
    /*
    *****************************************************************************
    ...
    */
    ...
    members: {
      ...
      */
       ...
       */
      _initObserver() {
        this.__P_254_3 = qx.lang.Function.listener(this._onNative, this);
        ...
        this.__P_254_2 = qx.bom.Event.supportsEvent(this.__P_254_1, "orientationchange") ? "orientationchange" : "resize";
        var Event = qx.bom.Event;
        Event.addNativeListener(this.__P_254_1, this.__P_254_2, this.__P_254_3);
      },
      /*
      ---------------------------------------------------------------------------
        OBSERVER STOP
      ...
      */
      ...
      _stopObserver() {
        var Event = qx.bom.Event;
        Event.removeNativeListener(this.__P_254_1, this.__P_254_2, this.__P_254_3);
      },
      /*
      ---------------------------------------------------------------------------
      ...
      */
      ...
      _onOrientationChange(domEvent) {
        ...
        if (this._currentOrientation != orientation) {
          ...
          qx.event.Registration.fireEvent(this.__P_254_1, "orientationchange", qx.event.type.Orientation, [orientation, mode]);
        }
      }
    },
    /*
