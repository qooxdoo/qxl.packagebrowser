  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.util.LibraryManager", {
    ...
    members: {
       ...
       */
      has(namespace) {
        return !!qx.util.LibraryManager.__P_209_0[namespace];
      },
      /**
       ...
       */
      getNamespaces() {
        return Object.keys(qx.util.LibraryManager.__P_209_0);
      },
      /**
       ...
       */
      get(namespace, key) {
        return qx.util.LibraryManager.__P_209_0[namespace][key] ? qx.util.LibraryManager.__P_209_0[namespace][key] : null;
      },
      /**
      ...
      set(namespace, key, value) {
        qx.util.LibraryManager.__P_209_0[namespace][key] = value;
      }
    }
  });
