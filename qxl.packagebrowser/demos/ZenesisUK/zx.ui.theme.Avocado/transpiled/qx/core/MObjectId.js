    ...
    members: {
      ...
      _applyQxObjectId(value, oldValue) {
        if (!this.__P_94_1) {
          ...
          if (owner) {
            owner.__P_94_2(this, value, oldValue);
          }
       ...
       */
      __P_94_2(obj, newId, oldId) {
        delete this.__P_94_0[oldId];
        this.__P_94_0[newId] = obj;
      },
      /**
      ...
      _cascadeQxObjectIdChanges() {
        ...
        if (this.__P_94_0) {
          for (var name in this.__P_94_0) {
            var obj = this.__P_94_0[name];
       ...
       */
      getOwnedQxObjects() {
        return this.__P_94_0 ? Object.values(this.__P_94_0) : [];
      }
    }
  });
