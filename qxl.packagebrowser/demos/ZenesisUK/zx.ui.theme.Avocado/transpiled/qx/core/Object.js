  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.core.Object", {
    ...
    */
    ...
    members: {
      __P_32_0: true ? qx.core.Property : null,
      /*
      ---------------------------------------------------------------------------
        BASICS
      ---------------------------------------------------------------------------
      ...
      */
      ...
      clone() {
        ...
        var user = this.__P_32_0.$$store.user;
        var setter = this.__P_32_0.$$method.set;
        var name;
