  ...
  qx.Bootstrap.define("qx.core.WindowError", {
    ...
    */
    ...
    construct(failMessage, uri, lineNumber, columnNumber, sourceException) {
      ...
      this.__P_101_0 = failMessage;
      this.__P_101_1 = uri || "";
      this.__P_101_2 = lineNumber === undefined ? -1 : lineNumber;
      this.__P_101_3 = columnNumber === undefined ? -1 : columnNumber;
      this.__P_101_4 = sourceException;
    },
    /*
    *****************************************************************************
       MEMBERS
