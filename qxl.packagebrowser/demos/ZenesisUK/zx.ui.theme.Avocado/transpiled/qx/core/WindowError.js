  ...
  qx.Bootstrap.define("qx.core.WindowError", {
    ...
    */
    ...
    construct(failMessage, uri, lineNumber, columnNumber, sourceException) {
      ...
      this.__P_103_0 = failMessage;
      this.__P_103_1 = uri || "";
      this.__P_103_2 = lineNumber === undefined ? -1 : lineNumber;
      this.__P_103_3 = columnNumber === undefined ? -1 : columnNumber;
      this.__P_103_4 = sourceException;
    },
    /*
    *****************************************************************************
       MEMBERS
