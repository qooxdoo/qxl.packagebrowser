  ...
  qx.Class.define("qx.html.Canvas", {
    ...
    */
    ...
    construct(styles, attributes) {
      ...
      this.__P_245_0 = document.createElement("canvas");
    },
    /*
    *****************************************************************************
       MEMBERS
    ...
    */
    ...
    members: {
       ...
       */
      getContext2d() {
        return this.__P_245_0.getContext("2d");
      }
    }
  });
