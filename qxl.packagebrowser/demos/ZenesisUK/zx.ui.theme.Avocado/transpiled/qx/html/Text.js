  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.html.Text", {
    ...
    members: {
       ...
       */
      _createDomElement() {
        return window.document.createTextNode(this.__P_136_0 || "");
      },
      /*
       * @Override
       */
      ...
      _serializeImpl(serializer) {
        serializer.rawTextInBody(this.__P_136_0);
      },
      /**
       * @Override
       */
    ...
    defer(statics) {
      statics.__P_136_1 = new qx.util.DeferredCall(statics.flush, statics);
    },
    /*
     * ****************************************************************************
     * DESTRUCT
    ...
    destruct() {
      ...
      this.__P_136_2 = this.__P_136_3 = this.__P_136_4 = this.__P_136_5 = this.__P_136_6 = this.__P_136_7 = this.__P_136_8 = null;
    }
  });
