  ...
  qx.Class.define("qx.html.Element", {
    ...
    */
    ...
    construct(tagName, styles, attributes) {
      ...
      this.__P_59_0 = styles || null;
      this.__P_59_1 = attributes || null;
      this.__P_59_2 = new Map();
      if (attributes) {
        ...
        }
        {
          ...
          for (var hc in scroll) {
            ...
            if (elem && elem.offsetWidth) {
              ...
              // ScrollToX
              if (obj.__P_59_10 != null) {
                obj._domNode.scrollLeft = obj.__P_59_10;
                delete obj.__P_59_10;
              }

              // ScrollToY
              if (obj.__P_59_11 != null) {
                obj._domNode.scrollTop = obj.__P_59_11;
                delete obj.__P_59_11;
              }

              // ScrollIntoViewX
              var intoViewX = obj.__P_59_12;
              if (intoViewX != null) {
    ...
    members: {
      ...
      */
      ...
      _serializeImpl(serializer) {
        ...
        // Copy attributes
        if (this.__P_59_1) {
          for (var key in this.__P_59_1) {
            let result = qx.bom.element.Attribute.serialize(key, this.__P_59_1[key]);
      ...
      */
      ...
      hasSlots(projection) {
        if (projection === null || projection === undefined) {
          return this.__P_59_2.size > 0;
        }
        if (projection === true || projection === qx.html.Slot.DEFAULT) {
          return this.__P_59_2.has(qx.html.Slot.DEFAULT);
        }
        if (typeof projection === "string") {
          return this.__P_59_2.has(projection);
        }
      ...
      inject(childNode, slotNameOverride) {
        ...
        if (!this.__P_59_18(slotName)) {
          return;
        }
        this.__P_59_2.get(slotName).add(childNode);
      ...
      __P_59_19(element) {
        ...
        (_element$getChildren = element.getChildren()) === null || _element$getChildren === void 0 || _element$getChildren.forEach(child => slots.push(...this.__P_59_19(child)));
        return slots;
      },
      _slotScanAdd(element) {
        for (const slot of this.__P_59_19(element)) {
          this.__P_59_2.set(slot.getName(), slot);
        }
      },
      _slotScanRemove(child) {
        for (const slot of this.__P_59_19(child)) {
          this.__P_59_2.delete(slot.getName());
        }
      },
      /*
      ---------------------------------------------------------------------------
      ...
      */
       ...
       */
      setRoot(root) {
        if (root && !this.__P_59_14) {
          qx.html.Element._hasRoots++;
        } else if (!root && this.__P_59_14) {
          qx.html.Element._hasRoots--;
        }
        this.__P_59_14 = root;
      },
      ...
      */
      ...
      disableScrolling() {
        ...
        this.scrollToX(0);
        this.scrollToY(0);
        this.addListener("scroll", this.__P_59_20, this);
      },
      /**
       * Re-enables browser-native scrolling
       */
      enableScrolling() {
        this.removeListener("scroll", this.__P_59_20, this);
      },
      __P_59_21: null,
      /**
      ...
      */
      ...
      capture(containerCapture) {
        {
          this.__P_59_22("capture", [containerCapture !== false]);
        }
      },
      /**
      ...
      */
      ...
      setStyle(key, value, direct) {
        ...
        if (this.__P_59_0[key] == value) {
          return this;
        }
        this._applyStyle(key, value, this.__P_59_0[key]);
        if (value == null) {
       ...
       */
      getStyle(key) {
        return this.__P_59_0 ? this.__P_59_0[key] : null;
      },
      /**
      ...
      */
      ...
      addClass(name) {
        ...
        this.setAttribute("class", this.__P_59_24(classes));
        return this;
      },
      /**
    ...
    */
    ...
    destruct() {
      ...
      this.setRoot(false);
      this.__P_59_1 = this.__P_59_0 = this.__P_59_16 = this.__P_59_15 = this.__P_59_12 = this.__P_59_13 = null;
    }
  });
