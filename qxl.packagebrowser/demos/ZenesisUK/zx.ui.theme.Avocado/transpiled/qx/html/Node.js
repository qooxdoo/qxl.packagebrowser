  ...
  qx.Class.define("qx.html.Node", {
    ...
    members: {
      ...
      */
      ...
      getListeners() {
        ...
        for (var id in this.__P_127_0) {
          var listenerData = this.__P_127_0[id];
          listeners.push({
    ...
    */
    ...
    destruct() {
      ...
      this._properties = this._propertyJobs = this._domNode = this._parent = this.__P_127_0 = null;
    }
  });
