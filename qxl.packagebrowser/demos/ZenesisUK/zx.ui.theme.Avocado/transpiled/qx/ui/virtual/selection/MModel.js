  ...
  ************************************************************************ */
  ...
  qx.Mixin.define("qx.ui.virtual.selection.MModel", {
    construct() {
      ...
      this.__P_202_0 = new qx.data.Array();
      this.__P_202_0.addListener("change", this._onChangeSelection, this);
      this._applySelection(this.__P_202_0, null);
    },
    properties: {
    ...
    members: {
      ...
      */
      ...
      setSelection(value) {
        if (value) {
          this.__P_202_0.replace(value);
        } else {
          this.__P_202_0.removeAll();
        }
      },
      /**
      ...
      */
      ...
      _onManagerChangeSelection(e) {
        if (this.__P_202_1 == true) {
          return;
        }
        this.__P_202_2 = true;
        this.__P_202_3();
        this.__P_202_2 = false;
