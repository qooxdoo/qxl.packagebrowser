  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.ui.virtual.layer.Abstract", {
    ...
    */
    ...
    members: {
      ...
      syncWidget(jobs) {
        ...
        if (this.__P_282_0.fullUpdate || this.__P_282_0.updateLayerWindow && this.__P_282_0.updateLayerData) {
          this._fullUpdate.apply(this, this.__P_282_1);
        } else if (this.__P_282_0.updateLayerWindow) {
          this._updateLayerWindow.apply(this, this.__P_282_1);
        } else if (this.__P_282_0.updateLayerData && this.__P_282_4) {
          this._updateLayerData();
        }
        if (this.__P_282_0.fullUpdate || this.__P_282_0.updateLayerWindow) {
          var args = this.__P_282_1;
          this.__P_282_2 = args[0];
          this.__P_282_3 = args[1];
          this.__P_282_4 = args[2];
          this.__P_282_5 = args[3];
        }
        this.__P_282_0 = {};
      },
      /**
       ...
       */
      _updateLayerData() {
        this._fullUpdate(this.__P_282_2, this.__P_282_3, this.__P_282_4, this.__P_282_5);
      },
      /**
      ...
      updateLayerData() {
        this.__P_282_0.updateLayerData = true;
        qx.ui.core.queue.Widget.add(this);
      },
      // interface implementation
      fullUpdate(firstRow, firstColumn, rowSizes, columnSizes) {
        this.__P_282_1 = arguments;
        this.__P_282_0.fullUpdate = true;
        qx.ui.core.queue.Widget.add(this);
      },
      // interface implementation
      updateLayerWindow(firstRow, firstColumn, rowSizes, columnSizes) {
        this.__P_282_1 = arguments;
        this.__P_282_0.updateLayerWindow = true;
        qx.ui.core.queue.Widget.add(this);
      }
    },
    /*
    ...
    */
    ...
    destruct() {
      this.__P_282_0 = this.__P_282_1 = this.__P_282_4 = this.__P_282_5 = null;
    }
  });
