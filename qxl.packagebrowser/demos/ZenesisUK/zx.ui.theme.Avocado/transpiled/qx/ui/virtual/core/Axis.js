  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.ui.virtual.core.Axis", {
    ...
    members: {
       ...
       */
      __P_275_2(position) {
        var ranges = this.__P_275_0 || this.__P_275_1();
        var start = 0;
      ...
      getItemAtPosition(position) {
        ...
        var range = this.__P_275_2(position);
      ...
      getItemPosition(index) {
        ...
        var range = this.__P_275_3(index);
    ...
    destruct() {
      this.customSizes = this.__P_275_0 = null;
    }
  });
