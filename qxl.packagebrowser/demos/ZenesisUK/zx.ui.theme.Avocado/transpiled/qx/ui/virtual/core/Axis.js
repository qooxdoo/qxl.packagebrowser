  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.ui.virtual.core.Axis", {
    ...
    members: {
       ...
       */
      __P_281_2(position) {
        var ranges = this.__P_281_0 || this.__P_281_1();
        var start = 0;
      ...
      getItemAtPosition(position) {
        ...
        var range = this.__P_281_2(position);
      ...
      getItemPosition(index) {
        ...
        var range = this.__P_281_3(index);
    ...
    destruct() {
      this.customSizes = this.__P_281_0 = null;
    }
  });
