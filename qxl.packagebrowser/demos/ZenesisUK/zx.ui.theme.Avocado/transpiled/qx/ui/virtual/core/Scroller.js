  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.ui.virtual.core.Scroller", {
    ...
    construct(rowCount, columnCount, cellHeight, cellWidth) {
      ...
      this.__P_201_0 = new qx.ui.virtual.core.Pane(rowCount, columnCount, cellHeight, cellWidth);
      this.__P_201_0.addListener("update", this._computeScrollbars, this);
      this.__P_201_0.addListener("scrollX", this._onScrollPaneX, this);
      this.__P_201_0.addListener("scrollY", this._onScrollPaneY, this);
      if (qx.core.Environment.get("os.scrollBarOverlayed")) {
        this._add(this.__P_201_0, {
          edge: 0
        });
      } else {
        this._add(this.__P_201_0, {
    ...
    members: {
      ...
      */
      ...
      _onScrollBarX(e) {
        ...
        // set in the browser
        this.__P_201_0.setScrollX(Math.round(e.getData()));
      },
      // overridden
      _onScrollBarY(e) {
        // Use Math.round to convert possible decimal values to 
        // integer values if a zoom level not equal to 100 is 
        // set in the browser
        this.__P_201_0.setScrollY(Math.round(e.getData()));
      }
    },
    destruct() {
