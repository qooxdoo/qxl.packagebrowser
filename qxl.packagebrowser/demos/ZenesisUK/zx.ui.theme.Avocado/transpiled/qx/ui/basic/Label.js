  ...
  qx.Class.define("qx.ui.basic.Label", {
    ...
    */
    ...
    construct(value) {
      ...
      {
        this.__P_26_0 = qx.locale.Manager.getInstance().addListener("changeLocale", this._onChangeLocale, this);
      }
    },
    /*
    *****************************************************************************
    ...
    */
    ...
    members: {
      ...
      */
      ...
      _getContentHint() {
        if (this.__P_26_2) {
          this.__P_26_5 = this.__P_26_6();
          delete this.__P_26_2;
        }
        return {
          width: this.__P_26_5.width,
          height: this.__P_26_5.height
        };
      },
      // overridden
      _hasHeightForWidth() {
      ...
      _getContentHeightForWidth(width) {
        ...
        return this.__P_26_6(width).height;
      },
      // overridden
      ...
      */
      ...
      _applyFont(value, old) {
        if (old && this.__P_26_1 && this.__P_26_4) {
          this.__P_26_1.removeListenerById(this.__P_26_4);
          this.__P_26_4 = null;
        }
        // Apply
        var styles;
        if (value) {
          ...
          this.__P_26_1 = value;
          if (this.__P_26_1 instanceof qx.bom.webfonts.WebFont && !this.__P_26_1.isValid()) {
            this.__P_26_4 = this.__P_26_1.addListener("changeStatus", evt => {
          ...
          styles = this.__P_26_1.getStyles();
        } else {
          this.__P_26_1 = null;
      ...
      __P_26_6(width) {
        ...
        var styles = font ? this.__P_26_1.getStyles() : qx.bom.Font.getDefaultStyles();
      ...
      */
      ...
      _applyBuddy(value, old) {
        if (old != null) {
          ...
          this.removeListenerById(this.__P_26_3);
          this.__P_26_3 = null;
        }
        if (value != null) {
          value.bind("enabled", this, "enabled");
          this.__P_26_3 = this.addListener("tap", () => {
    ...
    */
    ...
    destruct() {
      if (true && this.__P_26_0) {
        qx.locale.Manager.getInstance().removeListenerById(this.__P_26_0);
      }
      if (this.__P_26_1 && this.__P_26_4) {
        this.__P_26_1.removeListenerById(this.__P_26_4);
      }
      this.__P_26_1 = null;
    }
