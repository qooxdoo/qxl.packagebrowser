  ...
  qx.Class.define("qx.ui.tabview.TabView", {
    ...
    */
    ...
    construct(barPosition) {
      ...
      // Create manager
      var mgr = this.__P_23_1 = this._createRadioGroupInstance();
      mgr.setWrap(false);
    ...
    members: {
      ...
      */
      ...
      add(page) {
        ...
        // Register button
        this.__P_23_1.add(button);

        // Add state to page
        page.addState(this.__P_23_0[this.getBarPosition()]);
        this.__P_23_2();
        page.addListener("close", this._onPageClose, this);
        page.addListener("changeTabVisibility", this.__P_23_3, this);
      },
      /**
       * Adds a page to the tabview including its needed button
       * (contained in the page).
      ...
      remove(page) {
        ...
        this.__P_23_1.remove(button);

        // Remove state from page
        page.removeState(this.__P_23_0[this.getBarPosition()]);
        this.__P_23_2();
        page.removeListener("close", this._onPageClose, this);
        page.removeListener("changeTabVisibility", this.__P_23_3, this);
      },
      /**
      ...
      */
      ...
      _applyBarPosition(value, old) {
        ...
        // Toggle state to bar
        if (old) {
          var oldState = this.__P_23_0[old];
        ...
        if (value) {
          var newState = this.__P_23_0[value];
      ...
      */
       ...
       */
      getSelection() {
        var buttons = this.__P_23_1.getSelection();
        var result = [];
      ...
      setSelection(items) {
        ...
        this.__P_23_1.setSelection(buttons);
      },
      /**
       * Clears the whole selection at once.
       */
      resetSelection() {
        this.__P_23_1.resetSelection();
      },
      /**
      ...
      isSelected(item) {
        ...
        return this.__P_23_1.isSelected(button);
      },
      /**
       ...
       */
      isSelectionEmpty() {
        return this.__P_23_1.isSelectionEmpty();
      },
      /**
       ...
       */
      getSelectables(all) {
        var buttons = this.__P_23_1.getSelectables(all);
        var result = [];
        for (var i = 0; i < buttons.length; i++) {
          result.push(buttons[i].getUserData("page"));
        }
