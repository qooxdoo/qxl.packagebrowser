  ...
  qx.Class.define("qx.ui.form.SelectBox", {
    ...
    */
    ...
    construct() {
      ...
      this.addListener("changeSelection", this.__P_27_0, this);
    },
    /*
    *****************************************************************************
       PROPERTIES
    ...
    members: {
      ...
      */
      ...
      _createQxObjectImpl(id) {
        {
          let object = qx.core.MObjectId.handleObjects(qx.ui.form.SelectBox, this, ...arguments);
          if (object !== undefined) {
            return object;
          }
        }
      ...
      */
      ...
      _onKeyPress(e) {
        ...
        if ((iden == "Down" || iden == "Up") && e.isAltPressed()) {
          ...
          if (this.__P_27_1) {
            this.setSelection([this.__P_27_1]);
            this.__P_27_1 = null;
          }
          this.toggle();
          e.stop();
      ...
      _onListChangeSelection(e) {
        ...
        if (old && old.length > 0) {
          old[0].removeListener("changeIcon", this.__P_27_2, this);
          old[0].removeListener("changeLabel", this.__P_27_3, this);
        }
        if (current.length > 0) {
          ...
          current[0].addListener("changeIcon", this.__P_27_2, this);
          current[0].addListener("changeLabel", this.__P_27_3, this);
        } else {
          this.resetSelection();
        }
