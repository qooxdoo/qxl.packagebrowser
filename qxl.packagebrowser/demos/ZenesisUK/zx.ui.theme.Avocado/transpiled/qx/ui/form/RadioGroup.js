  ...
  qx.Class.define("qx.ui.form.RadioGroup", {
    ...
    */
    ...
    construct(varargs) {
      ...
      this.addListener("changeSelection", this.__P_72_1, this);
      if (varargs != null) {
    ...
    members: {
      ...
      */
      ...
      _applyInvalidMessage(value, old) {
        for (var i = 0; i < this.__P_72_0.length; i++) {
          this.__P_72_0[i].setInvalidMessage(value);
        }
      },
      // property apply
      _applyValid(value, old) {
        for (var i = 0; i < this.__P_72_0.length; i++) {
          this.__P_72_0[i].setValid(value);
        }
      },
      // property apply
      ...
      */
      ...
      __P_72_1(e) {
        ...
        if (value) {
          ...
          if (this.__P_72_2() && value.isFocusable()) {
            value.focus();
          }
        }
      },
