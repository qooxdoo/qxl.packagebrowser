    ...
    */
    ...
    members: {
      ...
      */
      ...
      __P_227_3() {
        if (this.isAutoSize()) {
          var clone = this.__P_227_4();
          if (clone && this.getBounds()) {
            // Remember original area height
            this.__P_227_2 = this.__P_227_2 || this._getAreaHeight();
            ...
            var desiredHeight = Math.max(scrolledHeight, this.__P_227_2);
       ...
       */
      __P_227_4() {
        this.__P_227_0 = this.__P_227_0 || this.__P_227_7();
      ...
      */
      ...
      _applyAutoSize(value, old) {
        if (value) {
          this.__P_227_3();
          this.addListener("input", this.__P_227_3, this);
          ...
          this.removeListener("input", this.__P_227_3);
          this.getContentElement().setStyle("overflowY", "auto");
        }
      },
      // property apply
      ...
      */
      ...
      _getContentHint() {
        ...
        if (this.isAutoSize()) {
          hint.height = this.__P_227_1 || hint.height;
        }
        return hint;
      }
    },
