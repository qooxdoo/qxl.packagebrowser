  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.ui.form.VirtualSelectBox", {
    ...
    construct(model) {
      ...
      this.__P_231_1 = new qx.event.Timer(500);
      this.__P_231_1.addListener("interval", this.__P_231_2, this);
      this.getSelection().addListener("change", this._updateSelectionValue, this);
      if (this.isIncrementalSearch()) {
        this.__P_231_3();
      }
      this.initHtmlMarkers(['<span style="' + this.__P_231_4() + '">', "</span>"]);
    },
    properties: {
      // overridden
      appearance: {
    ...
    members: {
      ...
      */
      ...
      _handleKeyboard(event) {
        ...
        switch (action) {
          case "search":
            if (!this.isIncrementalSearch()) {
              this.__P_231_6 += this.__P_231_7(event.getKeyIdentifier());
              this.__P_231_1.restart();
            }
            break;
          default:
      ...
      */
      ...
      __P_231_2() {
        this.__P_231_1.stop();
        var searchValue = this.__P_231_6;
      ...
      */
      ...
      _searchRegExp: null,
      __P_231_13() {
        var input = this.__P_231_11 = new qx.ui.form.TextField().set({
          appearance: "widget",
          liveUpdate: true,
          height: 0,
          width: 1 // must be > 0
      ...
      _highlightFilterValuePlainFunction(parts) {
        ...
        return parts[1] + this.__P_231_12[0] + parts[2] + this.__P_231_12[1] + parts[3];
      },
      // htmlEscape all label parts
      _highlightFilterValueHtmlFunction(parts) {
        // the array elements will contain '' if empty
        // the markers will be HTML strings
        return qx.module.util.String.escapeHtml(parts[1]) + this.__P_231_12[0] + qx.module.util.String.escapeHtml(parts[2]) + this.__P_231_12[1] + qx.module.util.String.escapeHtml(parts[3]);
      },
      ...
      __P_231_14(lastFilterValue) {
        this.__P_231_10++;
        var filterValue = lastFilterValue !== undefined ? lastFilterValue : this.__P_231_11.getValue();
        this.__P_231_8 = filterValue;
        ...
        if (item) {
          this.__P_231_9 = filterValue;
          this.getSelection().setItem(0, item);
        } else {
          var len = filterValue.length;
          var last = len > this.__P_231_9.length + 1 ? this.__P_231_11.getValue().charAt(len - 1) : "";
          filterValue = this.__P_231_9 + last;
          this.__P_231_14(filterValue);
        }
      ...
      __P_231_3() {
        ...
        labelOptions.converter = function (data, model, source, target) {
          var filterValue = that.__P_231_8;
      ...
      __P_231_5(value, old) {
        ...
        if (value.length < 2) {
          this.__P_231_12[1] = this.__P_231_12[0];
        }
      },
      _applyIncrementalSearch(value, old) {
        if (value) {
          this.__P_231_1.stop();
          this.__P_231_1.setEnabled(false);
          this.__P_231_3();
        } else {
          this.__P_231_1.setEnabled(true);
        }
      }
    },
    destruct() {
      ...
      this.__P_231_1.removeListener("interval", this.__P_231_2, this);
