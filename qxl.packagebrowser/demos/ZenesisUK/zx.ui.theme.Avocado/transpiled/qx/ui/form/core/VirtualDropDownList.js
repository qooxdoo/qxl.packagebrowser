  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.ui.form.core.VirtualDropDownList", {
    ...
    construct(target) {
      ...
      this.addListener("changeVisibility", this.__P_281_0, this);
      this.__P_281_1 = new qx.data.Array();
      this.initSelection(this.__P_281_1);
    },
    properties: {
      // overridden
      autoHide: {
    ...
    members: {
      ...
      */
      ...
      setPreselected(modelItem) {
        ...
        this.__P_281_5(helper, listSelection);
        helper.dispose();
        this.__P_281_3 = false;
      },
      /*
      ---------------------------------------------------------------------------
        INTERNAL API
      ...
      */
      ...
      __P_281_7(event) {
        ...
        var listSelection = this.getChildControl("list").getSelection();
        this.__P_281_3 = true;
        this.__P_281_5(selection, listSelection);
        this.__P_281_3 = false;
        this.__P_281_2 = true;
        this.__P_281_5(listSelection, selection);
        this.__P_281_2 = false;
      },
      /**
      ...
      _onListChangeSelection(event) {
        ...
        if (this.isVisible()) {
          ...
          this.__P_281_2 = true;
          this.__P_281_5(listSelection, this.getSelection());
          this.__P_281_2 = false;
        }
      },
      /**
      ...
      */
      ...
      _applySelection(value, old) {
        value.addListener("change", this.__P_281_7, this);
        if (old != null) {
          old.removeListener("change", this.__P_281_7, this);
        }
        this.__P_281_5(value, this.getChildControl("list").getSelection(value));
      },
      /*
      ---------------------------------------------------------------------------
        HELPER METHODS
      ...
      */
      ...
      _adjustWidth() {
        ...
        if (this.getAllowGrowDropDown()) {
          ...
          this.setWidth(null);
          if (this.__P_281_4 > 0) {
            uiList.setWidth(this.__P_281_4);
          } else {
