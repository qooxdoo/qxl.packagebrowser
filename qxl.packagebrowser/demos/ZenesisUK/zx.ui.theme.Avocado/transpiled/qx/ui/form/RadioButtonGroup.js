  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.ui.form.RadioButtonGroup", {
    ...
    construct(layout) {
      ...
      this.__P_162_0 = new qx.ui.form.RadioGroup();

      // attach the listener
      this.__P_162_0.addListener("changeSelection", this._onChangeSelection, this);
    },
    properties: {
      /**
    ...
    members: {
      ...
      */
      ...
      removeAll() {
        ...
        var radioItems = this.__P_162_0.getItems();
        for (var i = radioItems.length - 1; i >= 0; i--) {
          this.__P_162_0.remove(radioItems[i]);
        }
      ...
      */
       ...
       */
      getSelection() {
        return this.__P_162_0.getSelection();
      },
      /**
       ...
       */
      setSelection(items) {
        this.__P_162_0.setSelection(items);
      },
      /**
       * Clears the whole selection at once.
       */
      resetSelection() {
        this.__P_162_0.resetSelection();
      },
      /**
       ...
       */
      isSelected(item) {
        return this.__P_162_0.isSelected(item);
      },
      /**
       ...
       */
      isSelectionEmpty() {
        return this.__P_162_0.isSelectionEmpty();
      },
      /**
       ...
       */
      getSelectables(all) {
        return this.__P_162_0.getSelectables(all);
      },
      /**
       * Select given value.
       *
      ...
      setValue(item) {
        if (item && "object" === typeof item && item instanceof qx.ui.form.IRadioItem) {
          return this.__P_162_0.setValue(item);
        } else {
       ...
       */
      getValue() {
        return this.__P_162_0.getValue();
      },
      /**
       * Reset radio item selection.
       */
      resetValue() {
        this.__P_162_0.resetValue();
      },
      /**
    ...
    destruct() {
      this.__P_162_0.removeListener("changeSelection", this._onChangeSelection, this);
