  ...
  qx.Class.define("qx.ui.form.DateField", {
    ...
    */
    ...
    statics: {
      ...
      getDefaultDateFormatter() {
        ...
        if (format == this.__P_235_0) {
          return this.__P_235_1;
        }
        if (this.__P_235_1) {
          this.__P_235_1.dispose();
        }
        this.__P_235_1 = new qx.util.format.DateFormat(format, qx.locale.Manager.getInstance().getLocale());
        this.__P_235_0 = format;
        return this.__P_235_1;
      }
    },
    /*
    ...
    */
    ...
    members: {
      ...
      */
      ...
      _addLocaleChangeListener() {
        ...
        {
          this.__P_235_2 = qx.locale.Manager.getInstance().addListener("changeLocale", () => {
            this._setDefaultDateFormat();
          });
        }
      },
    ...
    destruct() {
      ...
      {
        if (this.__P_235_2) {
          qx.locale.Manager.getInstance().removeListenerById(this.__P_235_2);
        }
      }
    }
  });
