  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.ui.form.VirtualComboBox", {
    ...
    construct(model) {
      ...
      this.__P_229_0 = dropdown.getSelection();
      this.__P_229_0.addListener("change", this.__P_229_1, this);
    ...
    members: {
      ...
      */
       ...
       */
      __P_229_1(event) {
        if (this.__P_229_4 == true) {
          return;
        }
        var selected = this.__P_229_0.getItem(0);
        if (selected) {
          selected = this.__P_229_6(selected);
      ...
      */
      ...
      __P_229_5() {
        ...
        if (selected === undefined || this.__P_229_6(selected) !== value) {
          ...
          for (var i = 0, l = lookupTable.length; i < l; i++) {
            ...
            var itemLabel = this.__P_229_6(modelItem);
    ...
    destruct() {
      ...
      this.__P_229_0.removeListener("change", this.__P_229_1, this);
      this.__P_229_0 = null;
    }
  });
