(function () {
  ...
  ************************************************************************ */
  ...
  qx.Mixin.define("qx.ui.form.MForm", {
    construct() {
      {
        qx.locale.Manager.getInstance().addListener("changeLocale", this.__P_168_0, this);
      }
    },
    properties: {
      /**
    ...
    members: {
       ...
       */
      __P_168_0: qx.core.Environment.select("qx.dynlocale", {
        true(e) {
          // invalid message
    ...
    destruct() {
      {
        qx.locale.Manager.getInstance().removeListener("changeLocale", this.__P_168_0, this);
      }
    }
  });
