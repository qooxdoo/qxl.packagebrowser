(function () {
  ...
  ************************************************************************ */
  ...
  qx.Mixin.define("qx.ui.form.MForm", {
    construct() {
      {
        this.__P_171_0 = qx.locale.Manager.getInstance().addListener("changeLocale", this.__P_171_1, this);
      }
    },
    properties: {
      /**
    ...
    members: {
       ...
       */
      __P_171_1: qx.core.Environment.select("qx.dynlocale", {
        true(e) {
          // invalid message
    ...
    destruct() {
      if (true && this.__P_171_0) {
        qx.locale.Manager.getInstance().removeListenerById(this.__P_171_0);
      }
    }
  });
