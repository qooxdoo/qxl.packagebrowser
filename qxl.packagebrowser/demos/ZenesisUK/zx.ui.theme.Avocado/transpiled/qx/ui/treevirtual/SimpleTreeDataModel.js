    ...
    members: {
      ...
      setColumnEditable(columnIndex, editable) {
        if (editable != this.isColumnEditable(columnIndex)) {
          ...
          this.__P_205_0[columnIndex] = editable;
          this.fireEvent("metaDataChanged");
        }
      },
      // overridden
      isColumnEditable(columnIndex) {
        if (columnIndex == this._treeColumn) {
          return this.__P_205_1.getAllowNodeEdit();
        }
        return this.__P_205_0 ? this.__P_205_0[columnIndex] == true : false;
      },
      // overridden
      ...
      setValue(columnIndex, rowIndex, value) {
        ...
        if (columnIndex === this._treeColumn) {
          if (!this.__P_205_1.getAllowNodeEdit() || value["label"] === undefined) {
            return;
          }
       ...
       */
      addBranch(parentNodeId, label, bOpened, bHideOpenCloseButton, icon, iconSelected) {
      ...
      __P_205_4(nodeId, level) {
        ...
        var index = 0;
        var children = this.__P_205_2[nodeId] = [];
        for (var i = 0; i < numChildren; i++) {
          ...
          if (!this.__P_205_3) {
            this.__P_205_5(child, i == numChildren - 1);
          }
          ...
          if (child.bOpened) {
            ...
            this.__P_205_4(childNodeId, level + 1);
          }
          index++;
        }
      },
       ...
       */
      __P_205_6(nodeId) {
        var tempTreeData = this.__P_205_2;
      ...
      isNodeEditable(rowIndex) {
        return this.__P_205_1.getAllowNodeEdit() && this.getNodeFromRow(rowIndex).bCanEdit;
      }
    },
    destruct() {
      this._rowArr = this._nodeArr = this._nodeRowMap = this._selections = this.__P_205_1 = this.__P_205_2 = null;
    },
    defer(statics) {
