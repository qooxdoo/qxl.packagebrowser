  ...
  ************************************************************************ */
  ...
  qx.Mixin.define("qx.ui.decoration.MLinearBackgroundGradient", {
    ...
    members: {
       ...
       */
      __P_120_1(startColor, endColor, unit, orientation, startColorPosition, endColorPosition, styles, backgroundStyle) {
       ...
       * @return {Boolean} Whether this implementation supports multiple gradients atop each other (true).
       */
      __P_120_2(startColor, endColor, unit, orientation, startColorPosition, endColorPosition, styles, backgroundStyle) {
        const me = qx.ui.decoration.MLinearBackgroundGradient.__P_120_2;
        if (!me.__P_120_5) {
       ...
       */
      __P_120_3(startColor, endColor, unit, orientation, startColorPosition, endColorPosition, styles, backgroundStyle) {
       ...
       * @return {Boolean} Whether this implementation supports multiple gradients atop each other (true).
       */
      __P_120_0(startColor, endColor, unit, orientation, startColorPosition, endColorPosition, styles, backgroundStyle) {
