  ...
  qx.Class.define("qx.ui.tooltip.Manager", {
    ...
    */
    ...
    construct() {
      ...
      // Register events
      qx.event.Registration.addListener(document.body, "pointerover", this.__P_42_0, this, true);

      // Instantiate timers
      this.__P_42_1 = new qx.event.Timer();
      this.__P_42_1.addListener("interval", this.__P_42_2, this);
      this.__P_42_3 = new qx.event.Timer();
      this.__P_42_3.addListener("interval", this.__P_42_4, this);
    ...
    members: {
      ...
      */
      ...
      _applyCurrent(value, old) {
        ...
        if (value) {
          this.__P_42_1.startWith(value.getShowTimeout());
    ...
    */
    ...
    destruct() {
      // Deregister events
      qx.event.Registration.removeListener(document.body, "pointerover", this.__P_42_0, this, true);
