    ...
    members: {
      ...
      */
      ...
      __P_56_2() {
        ...
        if (!menuBounds) {
          this.addListenerOnce("resize", this.__P_56_2, this);
          return;
        }
