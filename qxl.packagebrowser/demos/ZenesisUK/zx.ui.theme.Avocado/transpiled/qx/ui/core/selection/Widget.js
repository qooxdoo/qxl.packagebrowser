    ...
    */
    ...
    members: {
      ...
      */
      ...
      // overridden
      _isSelectable(item) {
        return this._isItemSelectable(item) && item.getLayoutParent() === this.__P_264_0;
      },
      // overridden
      ...
      // overridden
      _capture() {
        this.__P_264_0.capture();
      },
      // overridden
      _releaseCapture() {
        this.__P_264_0.releaseCapture();
      },
      /**
      ...
      */
      ...
      // overridden
      _getLocation() {
        var elem = this.__P_264_0.getContentElement().getDomElement();
        return elem ? qx.bom.element.Location.get(elem) : null;
      },
      // overridden
      _getDimension() {
        return this.__P_264_0.getInnerSize();
      },
      // overridden
      ...
      */
      ...
      _scrollItemIntoView(item) {
        this.__P_264_0.scrollChildIntoView(item);
      },
      /*
      ---------------------------------------------------------------------------
        QUERY SUPPORT
      ...
      */
      ...
      getSelectables(all) {
        ...
        var children = this.__P_264_0.getChildren();
        var result = [];
        var child;
      ...
      _getRelatedSelectable(item, relation) {
        var vertical = this.__P_264_0.getOrientation() === "vertical";
        var children = this.__P_264_0.getChildren();
