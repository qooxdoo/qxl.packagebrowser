  ...
  ************************************************************************ */
  ...
  qx.Mixin.define("qx.ui.core.MMovable", {
    ...
    members: {
      ...
      */
      ...
      _activateMoveHandle(widget) {
        ...
        widget.addListener("losecapture", this.__P_241_10, this);
      },
      /**
       ...
       */
      __P_241_11() {
        var frame = this.__P_241_1;
        if (!frame) {
          frame = this.__P_241_1 = new qx.ui.core.Widget();
      ...
      */
      ...
      __P_241_13(e) {
        ...
        var viewportLeft = this.__P_241_3 + pointerLeft;
        var viewportTop = this.__P_241_4 + pointerTop;
        return {
          viewportLeft: parseInt(viewportLeft, 10),
          viewportTop: parseInt(viewportTop, 10),
          parentLeft: parseInt(viewportLeft - this.__P_241_5, 10),
          parentTop: parseInt(viewportTop - this.__P_241_6, 10)
        };
      },
      /*
      ---------------------------------------------------------------------------
      ...
      */
      ...
      _onMovePointerDown(e) {
        ...
        if (qx.Class.implementsInterface(parent, qx.ui.window.IDesktop)) {
          if (!parent.isBlocked()) {
            this.__P_241_8 = parent.getBlockerColor();
            this.__P_241_9 = parent.getBlockerOpacity();
        ...
        this.__P_241_5 = parentLocation.left;
        this.__P_241_6 = parentLocation.top;
        this.__P_241_3 = widgetLocation.left - e.getDocumentLeft();
        this.__P_241_4 = widgetLocation.top - e.getDocumentTop();

        // Add state
        this.addState("move");

        // Enable capturing
        this.__P_241_0.capture();
      ...
      _onMovePointerMove(e) {
        ...
        var coords = this.__P_241_13(e);
        if (this.getUseMoveFrame()) {
          this.__P_241_11().setDomPosition(coords.viewportLeft, coords.viewportTop);
        } else {
      ...
      _onMovePointerUp(e) {
        ...
        if (qx.Class.implementsInterface(parent, qx.ui.window.IDesktop)) {
          if (this.__P_241_7) {
            parent.unblock();
            parent.setBlockerColor(this.__P_241_8);
            parent.setBlockerOpacity(this.__P_241_9);
            this.__P_241_8 = null;
            this.__P_241_9 = 0;
    ...
    */
    ...
    destruct() {
      this._disposeObjects("__P_241_1", "__P_241_0");
      this.__P_241_2 = null;
    }
  });
