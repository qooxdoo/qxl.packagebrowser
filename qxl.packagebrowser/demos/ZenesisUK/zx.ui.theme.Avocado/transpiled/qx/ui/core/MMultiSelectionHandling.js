  ...
  qx.Mixin.define("qx.ui.core.MMultiSelectionHandling", {
    ...
    */
    ...
    construct() {
      ...
      var manager = this.__P_203_0 = new clazz(this);
    ...
    */
    ...
    members: {
      ...
      */
       ...
       */
      getValue() {
        return this.__P_203_0.getSelection();
      },
      /**
      ...
      isSelected(item) {
        ...
        return this.__P_203_0.isItemSelected(item);
      },
      /**
      ...
      removeFromSelection(item) {
        ...
        this.__P_203_0.removeItem(item);
      },
      /**
      ...
      selectRange(begin, end) {
        this.__P_203_0.selectItemRange(begin, end);
      },
      /**
      ...
      setSelection(items) {
        ...
        if (items.length === 0) {
          ...
          if (!qx.lang.Array.equals(currentSelection, items)) {
            this.__P_203_0.replaceSelection(items);
          }
        }
      },
      /**
       ...
       */
      getSortedSelection() {
        return this.__P_203_0.getSortedSelection();
      },
      /**
       ...
       */
      isSelectionEmpty() {
        return this.__P_203_0.isSelectionEmpty();
      },
      /**
       ...
       */
      getSelectionContext() {
        return this.__P_203_0.getSelectionContext();
      },
      /**
       ...
       */
      getSelectables(all) {
        return this.__P_203_0.getSelectables(all);
      },
      /**
       * Invert the selection. Select the non selected and deselect the selected.
       */
      invertSelection() {
        this.__P_203_0.invertSelection();
      },
      /**
       ...
       */
      _getLeadItem() {
        var mode = this.__P_203_0.getMode();
        if (mode === "single" || mode === "one") {
          return this.__P_203_0.getSelectedItem();
        } else {
          return this.__P_203_0.getLeadItem();
        }
      },
      /*
      ---------------------------------------------------------------------------
      ...
      */
      ...
      _applySelectionMode(value, old) {
        this.__P_203_0.setMode(value);
      },
      // property apply
      _applyDragSelection(value, old) {
        this.__P_203_0.setDrag(value);
      },
      // property apply
      _applyQuickSelection(value, old) {
        this.__P_203_0.setQuick(value);
      },
      /*
      ---------------------------------------------------------------------------
        EVENT HANDLER
