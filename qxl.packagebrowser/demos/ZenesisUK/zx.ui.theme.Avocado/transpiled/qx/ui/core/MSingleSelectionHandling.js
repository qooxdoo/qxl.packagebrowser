      ...
      */
      ...
      setValue(item) {
        ...
        if (item instanceof qx.ui.core.Widget) {
          this.__P_91_1().setSelected(item);
          return null;
        } else {
       ...
       */
      getValue() {
        return this.__P_91_1().getSelected() || null;
      },
      /**
       * resetValue implements part of the {@link qx.ui.form.IField} interface.
       */
      resetValue() {
        this.__P_91_1().resetSelected();
      },
      /**
       ...
       */
      getSelection() {
        var selected = this.__P_91_1().getSelected();
        if (selected) {
          return [selected];
        } else {
          return [];
      ...
      setSelection(items) {
        switch (items.length) {
          case 0:
            ...
            break;
          case 1:
            this.__P_91_1().setSelected(items[0]);
            break;
          default:
       ...
       */
      isSelected(item) {
        return this.__P_91_1().isSelected(item);
      },
      /**
       ...
       */
      isSelectionEmpty() {
        return this.__P_91_1().isSelectionEmpty();
      },
      /**
       ...
       */
      getSelectables(all) {
        return this.__P_91_1().getSelectables(all);
      },
      /*
      ---------------------------------------------------------------------------
        EVENT HANDLER
      ...
      */
      ...
      __P_91_1() {
        if (this.__P_91_0 == null) {
          var that = this;
          this.__P_91_0 = new qx.ui.core.SingleSelectionManager({
            getItems() {
          ...
          this.__P_91_0.addListener("changeSelected", this._onChangeSelected, this);
        }
        this.__P_91_0.setAllowEmptySelection(this._isAllowEmptySelection());
