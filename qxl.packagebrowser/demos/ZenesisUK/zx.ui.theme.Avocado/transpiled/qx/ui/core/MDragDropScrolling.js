  ...
  qx.Mixin.define("qx.ui.core.MDragDropScrolling", {
    ...
    */
    ...
    construct() {
      ...
      widget.addListener("drag", this.__P_68_0, this);
      widget.addListener("dragend", this.__P_68_1, this);
      this.__P_68_2 = ["left", "right"];
      this.__P_68_3 = ["top", "bottom"];
    },
    /*
    *****************************************************************************
       PROPERTIES
    ...
    */
    ...
    members: {
       ...
       */
      _getAxis(edgeType) {
        if (this.__P_68_2.indexOf(edgeType) !== -1) {
          return "x";
        } else if (this.__P_68_3.indexOf(edgeType) !== -1) {
          return "y";
        } else {
      ...
      __P_68_0(e) {
        ...
        while (scrollable) {
          ...
          if (this._isScrollbarVisible(scrollable, axis)) {
            ...
            if (this.__P_68_4) {
              this.__P_68_4.dispose();
            }
            this.__P_68_4 = new qx.event.Timer(50);
            this.__P_68_4.addListener("interval", function (scrollable, axis, amount) {
