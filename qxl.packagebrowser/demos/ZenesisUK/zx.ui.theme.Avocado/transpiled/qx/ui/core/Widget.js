  ...
  qx.Class.define("qx.ui.core.Widget", {
    ...
    members: {
      ...
      _applyToolTipText(value, old) {
        {
          ...
          this.__P_20_4 = manager.addListener("changeLocale", () => {
      ...
      */
      ...
      addAriaLabelledBy(...labelWidgets) {
        this.__P_20_16(labelWidgets, "aria-labelledby");
      },
      /**
      ...
      addAriaDescribedBy(...describingWidgets) {
        this.__P_20_16(describingWidgets, "aria-describedby");
      },
      /**
    ...
    */
    ...
    destruct() {
      ...
      this._disposeArray("__P_20_7");

      // Cleanup map of appearance states
      this.__P_20_12 = this.__P_20_13 = null;
