    ...
    members: {
      ...
      placeToWidget(target, liveupdate) {
        ...
        if (liveupdate) {
          ...
          this.__P_124_2 = qx.lang.Function.bind(this.placeToWidget, this, target, false);
          qx.event.Idle.getInstance().addListener("interval", this.__P_124_2);

          // Remove the listener when the element disappears.
          this.__P_124_4 = function () {
            this.__P_124_7();
          };
          this.addListener("disappear", this.__P_124_4, this);
        }
        var coords = target.getContentLocation() || this.getLayoutLocation(target);
        var size = this.__P_124_8();
        if (coords != null) {
          const boundsAreEqual = (bound1, bound2) => bound1 && bound2 && bound1.top === bound2.top && bound1.right === bound2.right && bound1.bottom === bound2.bottom && bound1.left === bound2.left;
          if (boundsAreEqual(coords, this.__P_124_5) && boundsAreEqual(size, this.__P_124_6)) {
            return true;
          }
          this.__P_124_5 = coords;
          this.__P_124_6 = size;
          this._place(coords);
          return true;
        } else {
      ...
      __P_124_7() {
        if (this.__P_124_2) {
          qx.event.Idle.getInstance().removeListener("interval", this.__P_124_2);
          this.__P_124_2 = null;
        }
        if (this.__P_124_4) {
          this.removeListener("disappear", this.__P_124_4, this);
          this.__P_124_4 = null;
        }
      },
      /**
      ...
      placeToElement(elem, liveupdate) {
        ...
        if (liveupdate) {
          // Bind target and livupdate to placeToWidget
          this.__P_124_2 = qx.lang.Function.bind(this.placeToElement, this, elem, false);
          qx.event.Idle.getInstance().addListener("interval", this.__P_124_2);
