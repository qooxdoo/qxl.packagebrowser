  ...
  qx.Mixin.define("qx.ui.list.core.MWidgetController", {
    ...
    members: {
      ...
      bindPropertyReverse(targetPath, sourceProperty, options, sourceWidget, index) {
        ...
        var bindPath = this.__P_267_1(index, targetPath, type);
        var id = sourceWidget.bind(sourceProperty, this._list, bindPath, options);
        this.__P_267_2(sourceWidget, id);
      },
      /**
      ...
      _removeBindingsFrom(item) {
        var bindings = this.__P_267_3(item);
        ...
        if (this.__P_267_0.includes(item)) {
          qx.lang.Array.remove(this.__P_267_0, item);
        }
      },
      /**
       ...
       */
      __P_267_2(widget, id) {
        var bindings = this.__P_267_3(widget);
        if (!bindings.includes(id)) {
          bindings.push(id);
        }
        if (!this.__P_267_0.includes(widget)) {
          this.__P_267_0.push(widget);
        }
      },
      /**
