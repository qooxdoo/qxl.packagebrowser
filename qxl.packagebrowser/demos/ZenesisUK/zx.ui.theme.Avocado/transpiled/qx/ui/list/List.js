  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.ui.list.List", {
    ...
    construct(model) {
      ...
      this._init();
      this.__P_146_0 = new qx.data.Array();
      this.initGroups(this.__P_146_0);
      if (model != null) {
    ...
    members: {
      ...
      _init() {
        ...
        this.__P_146_2 = [];
        this.__P_146_3 = {};
        this.__P_146_4 = false;
        this.__P_146_5 = false;
        this.__P_146_6 = false;
      ...
      */
       ...
       */
      _lookupGroup(row) {
        return this.__P_146_2.indexOf(row);
      },
      /**
      ...
      _reverseLookup(index) {
        ...
        return this.__P_146_1.indexOf(index);
      },
      /**
      ...
      */
      ...
      _onLayerUpdated() {
        ...
        if (this.__P_146_7 === null) {
          this.__P_146_7 = new qx.util.DeferredCall(function () {
            this._setRowItemSize();
          }, this);
        }
        this.__P_146_7.schedule();
      },
      /*
      ---------------------------------------------------------------------------
        HELPER ROUTINES
      ...
      */
       ...
       */
      __P_146_10() {
        this.getPane().getRowConfig().setItemCount(this.__P_146_1.length);
        this.getPane().fullUpdate();
      },
      /**
      ...
      __P_146_9() {
        ...
        rc.resetItemSizes();
        if (gh) {
          for (var i = 0, l = this.__P_146_1.length; i < l; ++i) {
            if (this.__P_146_1[i] == -1) {
              rc.setItemSize(i, gh);
            }
          }
        }
      ...
      _runDelegateSorter(model) {
        ...
        if (sorter != null) {
          this.__P_146_1.sort(function (a, b) {
      ...
      _runDelegateGroup(model) {
        ...
        if (groupMethod != null) {
          for (var i = 0, l = this.__P_146_1.length; i < l; ++i) {
            var index = this.__P_146_1[i];
            var item = this.getModel().getItem(index);
            var group = groupMethod(item);
            this.__P_146_11(group, index);
          }
          this.__P_146_1 = this.__P_146_12();
        }
      },
      /**
       ...
       */
      __P_146_11(group, index) {
        // if group is null add to default group
        if (group == null) {
          this.__P_146_6 = true;
          group = "???";
        }
        var name = this.__P_146_13(group);
        if (this.__P_146_3[name] == null) {
          this.__P_146_3[name] = [];
          if (this.isAutoGrouping()) {
            this.getGroups().push(group);
          }
        }
        this.__P_146_3[name].push(index);
      },
      /**
      ...
      __P_146_12() {
        ...
        for (var i = 0; i < groups.getLength(); i++) {
          ...
          result.push(-1);
          this.__P_146_2.push(row);
          row++;
          var key = this.__P_146_13(group);
          var groupMembers = this.__P_146_3[key];
       ...
       */
      __P_146_14() {
        if (this.__P_146_5 && this.__P_146_6 || this.__P_146_5 && this.__P_146_4) {
    ...
    destruct() {
      this._disposeObjects("__P_146_7");
      var model = this.getModel();
      if (model != null) {
      ...
      this._layer.dispose();
      this._background = this._provider = this._layer = this.__P_146_1 = this.__P_146_2 = this.__P_146_3 = null;
      if (this.__P_146_0) {
