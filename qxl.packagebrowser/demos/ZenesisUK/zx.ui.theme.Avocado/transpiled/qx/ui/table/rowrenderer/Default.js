  ...
  qx.Class.define("qx.ui.table.rowrenderer.Default", {
    ...
    */
    ...
    construct() {
      ...
      {
        this.__P_221_0 = qx.theme.manager.Meta.getInstance().addListener("changeTheme", this.initThemeValues, this);
      }
    },
    /*
    *****************************************************************************
    ...
    */
    ...
    destruct() {
      ...
      if (true && this.__P_221_0) {
        qx.theme.manager.Meta.getInstance().removeListenerById(this.__P_221_0);
      }
    }
  });
