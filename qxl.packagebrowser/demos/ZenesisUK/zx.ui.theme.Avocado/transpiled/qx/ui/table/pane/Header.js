  ...
  qx.Class.define("qx.ui.table.pane.Header", {
    ...
    */
    ...
    construct(paneScroller) {
      ...
      // add blocker
      this.__P_221_0 = new qx.ui.core.Blocker(this);
      this.__P_221_1 = paneScroller;
    ...
    */
    ...
    members: {
       ...
       */
      getTable() {
        return this.__P_221_1.getTable();
      },
      /**
      ...
      setPointerOverColumn(col) {
        if (col != this.__P_221_3) {
          if (this.__P_221_3 != null) {
            var widget = this.getHeaderWidgetAtColumn(this.__P_221_3);
            if (widget != null) {
      ...
      showColumnMoveFeedback(col, x) {
        ...
        if (this.__P_221_2 == null) {
          ...
          this.__P_221_2 = feedback;
        }
        this.__P_221_2.setLayoutProperties({
          left: pos.left + x
        });
        this.__P_221_2.show();
      },
    ...
    */
    ...
    destruct() {
      ...
      this._disposeObjects("__P_221_1");
    }
  });
