  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.ui.table.columnmodel.resizebehavior.Default", {
    ...
    construct() {
      ...
      this.__P_263_1 = new qx.ui.layout.HBox();
      this.__P_263_1.connectToWidget(this);
      this.__P_263_2 = new qx.util.DeferredCall(this._computeColumnsFlexWidth, this);
    },
    /*
    *****************************************************************************
       PROPERTIES
    ...
    */
    ...
    members: {
      ...
      setWidth(col, width, flex) {
        ...
        if (col >= this.__P_263_0.length) {
          throw new Error("Column number out of range");
        }

        // Set the new width
        this.__P_263_0[col].setColumnWidth(width, flex);
        this.__P_263_2.schedule();
      },
      /**
      ...
      setMinWidth(col, width) {
        ...
        // Set the new width
        this.__P_263_0[col].setMinWidth(width);
        this.__P_263_2.schedule();
      },
      /**
      ...
      setMaxWidth(col, width) {
        ...
        // Set the new width
        this.__P_263_0[col].setMaxWidth(width);
        this.__P_263_2.schedule();
      },
      /**
      ...
      onAppear(event, forceRefresh) {
        ...
        if (forceRefresh === true || !this.__P_263_4 || this.getInitializeWidthsOnEveryAppear()) {
       ...
       */
      __P_263_5() {
        this.__P_263_1.invalidateChildrenCache();
        var children = this.__P_263_3;
    ...
    */
    ...
    destruct() {
      this.__P_263_0 = this.__P_263_3 = null;
      this._disposeObjects("__P_263_1", "__P_263_2");
    }
  });
