  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.ui.table.cellrenderer.Abstract", {
    ...
    construct() {
      ...
      if (!cr.__P_262_0) {
        cr.__P_262_0 = qx.ui.table.cellrenderer.Abstract;
    ...
    members: {
      ...
      _onChangeTheme: qx.core.Environment.select("qx.dyntheme", {
        true() {
          qx.bom.Stylesheet.removeAllRules(qx.ui.table.cellrenderer.Abstract.__P_262_0.stylesheet);
          this._createStyleSheet();
        },
        false: null
      }),
      ...
      _createStyleSheet() {
        ...
        qx.ui.table.cellrenderer.Abstract.__P_262_0.stylesheet = qx.bom.Stylesheet.createElement(stylesheet);
      },
      /**
