  ...
  qx.Class.define("qx.ui.table.cellrenderer.Boolean", {
    ...
    */
    ...
    construct() {
      ...
      this.__P_153_0 = qx.util.AliasManager.getInstance();
      this.initIconTrue();
      this.initIconFalse();

      // dynamic theme switch
      {
        this.__P_153_1 = qx.theme.manager.Meta.getInstance().addListener("changeTheme", this._onChangeTheme, this);
      }
    },
    /*
     *****************************************************************************
    ...
    */
    ...
    members: {
      ...
      _applyIconTrue(value) {
        this.__P_153_2 = this.__P_153_0.resolve(value);
      },
      // property apply
      _applyIconFalse(value) {
        this.__P_153_3 = this.__P_153_0.resolve(value);
      },
      // overridden
      _identifyImage(cellInfo) {
        ...
        if (rm.has(this.__P_153_2)) {
          id = this.__P_153_2;
        } else {
          ids = rm.getIds(this.__P_153_2);
        ...
        switch (cellInfo.value) {
          case true:
            imageHints.url = this.__P_153_2;
            break;
          case false:
            imageHints.url = this.__P_153_3;
            break;
          default:
            imageHints.url = null;
            break;
    ...
    */
    ...
    destruct() {
      ...
      if (true && this.__P_153_1) {
        qx.theme.manager.Meta.getInstance().removeListenerById(this.__P_153_1);
      }
    }
  });
