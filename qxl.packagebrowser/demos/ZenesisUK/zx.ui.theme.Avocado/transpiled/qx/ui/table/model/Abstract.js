  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.ui.table.model.Abstract", {
    ...
    members: {
      ...
      // overridden
      getColumnCount() {
        return this.__P_216_0.length;
      },
      // overridden
      getColumnIndexById(columnId) {
        return this.__P_216_2[columnId];
      },
      // overridden
      getColumnId(columnIndex) {
        return this.__P_216_0[columnIndex];
      },
      // overridden
      getColumnName(columnIndex) {
        return this.__P_216_1[columnIndex];
      },
      /**
      ...
      setColumnIds(columnIdArr) {
        this.__P_216_0 = columnIdArr;

        // Create the reverse map
        this.__P_216_2 = {};
        for (var i = 0; i < columnIdArr.length; i++) {
          this.__P_216_2[columnIdArr[i]] = i;
        }
        this.__P_216_1 = new Array(columnIdArr.length);
      ...
      setColumnNamesByIndex(columnNameArr) {
        if (this.__P_216_0.length != columnNameArr.length) {
          throw new Error("this.__columnIdArr and columnNameArr have different length: " + this.__P_216_0.length + " != " + columnNameArr.length);
        }
        this.__P_216_1 = columnNameArr;
      ...
      setColumnNamesById(columnNameMap) {
        this.__P_216_1 = new Array(this.__P_216_0.length);
        for (var i = 0; i < this.__P_216_0.length; ++i) {
          this.__P_216_1[i] = columnNameMap[this.__P_216_0[i]];
        }
      },
      /**
      ...
      setColumns(columnNameArr, columnIdArr) {
        var bSetIds = this.__P_216_0.length == 0 || columnIdArr;
        if (columnIdArr == null) {
          if (this.__P_216_0.length == 0) {
            columnIdArr = columnNameArr;
          } else {
            columnIdArr = this.__P_216_0;
          }
        }
