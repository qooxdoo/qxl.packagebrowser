(function () {
  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.ui.table.model.Simple", {
    ...
    members: {
      ...
      setColumnEditable(columnIndex, editable) {
        if (editable != this.isColumnEditable(columnIndex)) {
          if (this.__P_147_2 == null) {
            this.__P_147_2 = [];
          }
          this.__P_147_2[columnIndex] = editable;
          this.fireEvent("metaDataChanged");
        }
      },
      // overridden
      isColumnEditable(columnIndex) {
        return this.__P_147_2 ? this.__P_147_2[columnIndex] == true : false;
      },
      /**
      ...
      setColumnSortable(columnIndex, sortable) {
        if (sortable != this.isColumnSortable(columnIndex)) {
          if (this.__P_147_3 == null) {
            this.__P_147_3 = [];
          }
          this.__P_147_3[columnIndex] = sortable;
          this.fireEvent("metaDataChanged");
        }
      },
      // overridden
      isColumnSortable(columnIndex) {
        return this.__P_147_3 ? this.__P_147_3[columnIndex] !== false : true;
      },
      // overridden
      sortByColumn(columnIndex, ascending) {
        ...
        var comparator;
        var sortMethods = this.__P_147_1[columnIndex];
        if (sortMethods) {
        ...
        this.__P_147_0 = columnIndex;
        this.__P_147_4 = ascending;
        var data = {
      ...
      setSortMethods(columnIndex, compare) {
        ...
        this.__P_147_1[columnIndex] = methods;
      },
      /**
    ...
    destruct() {
      this._rowArr = this.__P_147_2 = this.__P_147_1 = this.__P_147_3 = null;
    }
  });
