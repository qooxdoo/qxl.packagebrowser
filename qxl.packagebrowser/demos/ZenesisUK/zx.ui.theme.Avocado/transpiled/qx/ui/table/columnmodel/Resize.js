    ...
    */
    ...
    members: {
      ...
      init(numColumns, table) {
        ...
        if (this.__P_208_2 == null) {
          this.__P_208_2 = table;
      ...
      _onappear(event) {
        ...
        this.__P_208_2._updateScrollerWidths();
        this.__P_208_2._updateScrollBarVisibility();
        this.__P_208_0 = false;
        this.__P_208_1 = true;
      },
      /**
      ...
      _onTableWidthChanged(event) {
        ...
        if (this.__P_208_0 || !this.__P_208_1) {
          // Yup.  Ignore it.
          return;
        }
        this.__P_208_0 = true;
      ...
      _onverticalscrollbarchanged(event) {
        ...
        qx.event.Timer.once(function () {
          if (this.__P_208_2 && !this.__P_208_2.isDisposed()) {
            this.__P_208_2._updateScrollerWidths();
            this.__P_208_2._updateScrollBarVisibility();
          }
        }, this, 0);
