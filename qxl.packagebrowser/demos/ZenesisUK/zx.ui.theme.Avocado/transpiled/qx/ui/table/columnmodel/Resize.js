    ...
    */
    ...
    members: {
      ...
      _onappear(event) {
        ...
        this.__P_212_2._updateScrollerWidths();
        this.__P_212_2._updateScrollBarVisibility();
        this.__P_212_0 = false;
        this.__P_212_1 = true;
      },
      /**
      ...
      _onTableWidthChanged(event) {
        ...
        if (this.__P_212_0 || !this.__P_212_1) {
          // Yup.  Ignore it.
          return;
        }
        this.__P_212_0 = true;
      ...
      _onverticalscrollbarchanged(event) {
        ...
        qx.event.Timer.once(function () {
          if (this.__P_212_2 && !this.__P_212_2.isDisposed()) {
            this.__P_212_2._updateScrollerWidths();
            this.__P_212_2._updateScrollBarVisibility();
          }
        }, this, 0);
