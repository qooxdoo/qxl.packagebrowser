  ...
  qx.Class.define("qx.ui.embed.Iframe", {
    ...
    */
    ...
    construct(source) {
      ...
      this.__P_160_1 = this._createBlockerElement();
    ...
    */
    ...
    members: {
      ...
      _createContentElement() {
        var iframe = new qx.html.Iframe(this.__P_160_0);
      ...
      */
       ...
       */
      block() {
        this.__P_160_1.setStyle("display", "block");
      },
      /**
       ...
       */
      release() {
        this.__P_160_1.setStyle("display", "none");
      },
      /*
      ---------------------------------------------------------------------------
        EVENT HANDLER
      ...
      */
      ...
      setLayoutParent(parent) {
        if (parent === null) {
          this.getLayoutParent().getContentElement().remove(this.__P_160_1);
        }
        qx.ui.embed.Iframe.superclass.prototype.setLayoutParent.call(this, parent);
        if (parent) {
          this.getLayoutParent().getContentElement().add(this.__P_160_1);
        }
      }
    },
    /*
    ...
    */
    ...
    destruct() {
      if (this.getLayoutParent() && this.__P_160_1.getParent()) {
        this.getLayoutParent().getContentElement().remove(this.__P_160_1);
      }
      this._disposeObjects("__P_160_1");
