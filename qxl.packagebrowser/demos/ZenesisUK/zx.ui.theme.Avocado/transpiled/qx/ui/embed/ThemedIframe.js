    ...
    members: {
      ...
      */
      ...
      _startIframeObserver() {
        ...
        this.__P_161_1 = idle.addListener("interval", this._onIframeObserverInterval, this);
      },
      /**
      ...
      _stopIframeObserver() {
        ...
        var idle = qx.event.Idle.getInstance();
        idle.removeListenerById(this.__P_161_1);
      },
      /**
      ...
      _onIframeObserverInterval() {
        ...
        if (this.__P_161_0 && iframeSize.width == this.__P_161_0.width && iframeSize.height == this.__P_161_0.height) {
          return;
        }
        this.__P_161_0 = iframeSize;
