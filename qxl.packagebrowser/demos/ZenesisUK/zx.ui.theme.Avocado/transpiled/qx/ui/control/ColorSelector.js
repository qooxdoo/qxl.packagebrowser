    ...
    */
    ...
    members: {
      ...
      */
       ...
       */
      __P_155_1: ["maroon", "red", "orange", "yellow", "olive", "purple", "fuchsia", "lime", "green", "navy", "blue", "aqua", "teal", "black", "#333", "#666", "#999", "#BBB", "#EEE", "white"],
      /**
          ...
          case "preset-grid":
            ...
            for (var i = 0; i < 2; i++) {
              for (var j = 0; j < 10; j++) {
                ...
                colorField.setBackgroundColor(this.__P_155_1[colorPos]);
       ...
       */
      getValue() {
        return this.__P_155_6 ? null : qx.util.ColorUtil.rgbToHexString([this.getRed(), this.getGreen(), this.getBlue()]);
      },
      /**
      ...
      */
      ...
      _applyRed(value, old) {
        if (this.__P_155_0 === null) {
          this.__P_155_0 = "redModifier";
        }
        if (this.__P_155_0 !== "rgbSpinner") {
          this.getChildControl("rgb-spinner-red").setValue(value);
        }
        if (this.__P_155_0 !== "hexField") {
          this._setHexFromRgb();
        }
        switch (this.__P_155_0) {
          case "rgbSpinner":
          case "hexField":
          case "redModifier":
            this._setHueFromRgb();
        ...
        this.__P_155_8();
        if (this.__P_155_0 === "redModifier") {
          this.__P_155_0 = null;
        }
      },
      // property apply
      _applyGreen(value, old) {
        if (this.__P_155_0 === null) {
          this.__P_155_0 = "greenModifier";
        }
        if (this.__P_155_0 !== "rgbSpinner") {
        ...
        this._setPreviewFromRgb();
        this.__P_155_8();
        if (this.__P_155_0 === "greenModifier") {
          this.__P_155_0 = null;
        }
      },
      // property apply
      _applyBlue(value, old) {
        if (this.__P_155_0 === null) {
          this.__P_155_0 = "blueModifier";
        }
        if (this.__P_155_0 !== "rgbSpinner") {
        ...
        this._setPreviewFromRgb();
        this.__P_155_8();
        if (this.__P_155_0 === "blueModifier") {
          this.__P_155_0 = null;
        }
      },
      /*
      ...
      */
      ...
      _applyHue(value, old) {
        if (this.__P_155_0 === null) {
          this.__P_155_0 = "hueModifier";
        }
        if (this.__P_155_0 !== "hsbSpinner") {
          this.getChildControl("hsb-spinner-hue").setValue(value);
        }
        if (this.__P_155_0 !== "hueSaturationField") {
        ...
        if (this.__P_155_0 === "hueModifier") {
          this.__P_155_0 = null;
        }
      },
      // property apply
      _applySaturation(value, old) {
        if (this.__P_155_0 === null) {
          this.__P_155_0 = "saturationModifier";
        }
        if (this.__P_155_0 !== "hsbSpinner") {
        ...
        if (this.__P_155_0 === "saturationModifier") {
          this.__P_155_0 = null;
        }
      },
      // property apply
      _applyBrightness(value, old) {
        if (this.__P_155_0 === null) {
          this.__P_155_0 = "brightnessModifier";
        }
        if (this.__P_155_0 !== "hsbSpinner") {
          this.getChildControl("hsb-spinner-brightness").setValue(value);
        }
        if (this.__P_155_0 !== "brightnessField") {
        ...
        if (this.__P_155_0 === "brightnessModifier") {
          this.__P_155_0 = null;
        }
      },
      /*
      ...
      */
       ...
       */
      _onBrightnessHandlePointerDown(e) {
        // Activate Capturing
        this.getChildControl("brightness-handle").capture();
        this.__P_155_2 = "brightness-handle";
        ...
        this.__P_155_3 = locationBrightnessField.top + (e.getDocumentTop() - locationBrightnessHandle.top) - fieldBounds.top;
       ...
       * @param e {qx.event.type.Pointer} Incoming event object
       */
      _onBrightnessHandlePointerUp(e) {
        // Disabling capturing
       ...
       * @param e {qx.event.type.Pointer} Incoming event object
       */
      _onBrightnessHandlePointerMove(e) {
        // Update if captured currently (through previous pointerdown)
        if (this.__P_155_2 === "brightness-handle") {
       ...
       * @param e {qx.event.type.Pointer} Incoming event object
       */
      _onBrightnessFieldPointerDown(e) {
        ...
        this.__P_155_3 = location.top + bounds.height / 2;
       ...
       * @param e {qx.event.type.Pointer} Incoming event object
       */
      _setBrightnessOnFieldEvent(e) {
        var value = qx.lang.Number.limit(e.getDocumentTop() - this.__P_155_3, 0, 256);
        this.__P_155_0 = "brightnessField";
        if (this.getChildControl("brightness-handle").getBounds()) {
      ...
      */
       ...
       * @param e {qx.event.type.Pointer} Incoming event object
       */
      _onHueSaturationHandlePointerUp(e) {
        // Disabling capturing
        if (this.__P_155_2) {
          e.stopPropagation();
       ...
       * @param e {qx.event.type.Pointer} Incoming event object
       */
      _onHueSaturationHandlePointerMove(e) {
        // Update if captured currently (through previous pointerdown)
        if (this.__P_155_2 === "hue-saturation-handle") {
       ...
       * @param e {qx.event.type.Pointer} Incoming event object
       */
      _onHueSaturationFieldPointerDown(e) {
        ...
        this.__P_155_4 = location.top + handleBounds.height / 2 - fieldBounds.top;
        this.__P_155_5 = location.left + handleBounds.width / 2 - fieldBounds.left;
        ...
        this.__P_155_2 = "hue-saturation-handle";
      },
      /**
       ...
       * @param e {qx.event.type.Pointer} Incoming event object
       */
      _setHueSaturationOnFieldEvent(e) {
        var vTop = qx.lang.Number.limit(e.getDocumentTop() - this.__P_155_4, 0, 256);
        var vLeft = qx.lang.Number.limit(e.getDocumentLeft() - this.__P_155_5, 0, 256);
        this.getChildControl("hue-saturation-handle").setDomPosition(vLeft, vTop);
        this.__P_155_0 = "hueSaturationField";
      ...
      */
       ...
       */
      setPreviousColor(red, green, blue) {
