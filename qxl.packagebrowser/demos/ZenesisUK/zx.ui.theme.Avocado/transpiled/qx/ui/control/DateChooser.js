  ...
  qx.Class.define("qx.ui.control.DateChooser", {
    ...
    */
    ...
    construct(date) {
      ...
      {
        this.__P_160_0 = qx.locale.Manager.getInstance().addListener("changeLocale", this._updateDatePane, this);
      }
      ...
      */
      ...
      _updateDatePane() {
        ...
        for (var week = 0; week < 6; week++) {
          this.__P_160_3[week].setValue(weekFormat.format(helpDate));
          for (var i = 0; i < 7; i++) {
            var dayLabel = this.__P_160_2[week * 7 + i];
            ...
            dayLabel.setEnabled(!this.__P_160_4(helpDate));
    ...
    */
    ...
    destruct() {
      if (true && this.__P_160_0) {
        qx.locale.Manager.getInstance().removeListenerById(this.__P_160_0);
      }
      this.__P_160_1 = this.__P_160_2 = this.__P_160_3 = null;
    }
  });
