      ...
      */
      ...
      _updateDatePane() {
        ...
        for (var week = 0; week < 6; week++) {
          this.__P_157_2[week].setValue(weekFormat.format(helpDate));
          for (var i = 0; i < 7; i++) {
            var dayLabel = this.__P_157_1[week * 7 + i];
            ...
            dayLabel.setEnabled(!this.__P_157_3(helpDate));
