  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.ui.tree.VirtualTree", {
    ...
    members: {
      ...
      */
      ...
      openNodeAndParents(node) {
        this.__P_145_7(this.getModel(), node);
        this.buildLookupTable();
      },
      // Interface implementation
      closeNode(node) {
        if (this.__P_145_1.includes(node)) {
          qx.lang.Array.remove(this.__P_145_1, node);
      ...
      // Interface implementation
      isNodeOpen(node) {
        return this.__P_145_1.includes(node);
      },
      /**
      ...
      */
       ...
       */
      _init() {
        this.__P_145_0 = new qx.data.Array();
        this.__P_145_1 = [];
        this.__P_145_2 = [];
        this._initLayer();
      },
       ...
       */
      _getDataFromRow(row) {
        return this.__P_145_0.getItem(row);
      },
      /**
      ...
      */
      ...
      _onChangeBubble(event) {
        ...
        if (propertyName.startsWith(this.getChildProperty())) {
          ...
          if (this.__P_145_0.indexOf(item) != -1 || isRootAndHidden) {
            this.__P_145_8();
          }
        }
      },
       ...
       */
      _onUpdated(event) {
        if (this.__P_145_3 == null) {
          this.__P_145_3 = new qx.util.DeferredCall(function () {
            qx.ui.core.queue.Widget.add(this);
          }, this);
        }
        this.__P_145_3.schedule();
      },
      /**
      ...
      _onOpen(event) {
        ...
        var item = this.__P_145_0.getItem(row);
        if (this.isNode(item)) {
      ...
      */
      ...
      _beforeApplySelection(newSelection) {
        if (newSelection.length === 0 && this.getSelectionMode() === "one") {
          var visibleParent = this.__P_145_9();
      ...
      _afterApplySelection() {
        ...
        if (selection.getLength() > 0 && this.getSelectionMode() === "one") {
          this.__P_145_10(selection.getItem(0));
        } else {
          this.__P_145_4 = [];
        }
      },
      ...
      */
      ...
      buildLookupTable() {
        ...
        if (root != null) {
          if (!this.isHideRoot()) {
            ...
            this.__P_145_2.push(nestedLevel);
          }
          if (this.isNodeOpen(root)) {
            var visibleChildren = this.__P_145_11(root, nestedLevel);
            lookupTable = lookupTable.concat(visibleChildren);
          }
        }
        if (!qx.lang.Array.equals(this.__P_145_0.toArray(), lookupTable)) {
          this._provider.removeBindings();
          this.__P_145_0.removeAll();
          this.__P_145_0.append(lookupTable);
          this.__P_145_12();
        ...
        for (var i = 0; i < children.getLength(); i++) {
          ...
          if (this.isNode(child)) {
            ...
            if (this.isNodeOpen(child)) {
              var visibleChildren = this.__P_145_11(child, nestedLevel);
       ...
       */
      __P_145_7(startNode, targetNode) {
        if (startNode === targetNode) {
          this.__P_145_6(targetNode);
          return true;
        }
        ...
        for (var i = 0; i < children.getLength(); i++) {
          var child = children.getItem(i);
          var result = this.__P_145_7(child, targetNode);
          if (result === true) {
            this.__P_145_6(child);
            return true;
          }
        }
        return false;
       ...
       */
      __P_145_12() {
        this.getPane().getRowConfig().setItemCount(this.__P_145_0.getLength());
       ...
       */
      getParent(item) {
        var index = this.__P_145_0.indexOf(item);
        if (index < 0) {
          return null;
        }
        var level = this.__P_145_2[index];
        while (index > 0) {
          index--;
          var levelBefore = this.__P_145_2[index];
          if (levelBefore < level) {
            return this.__P_145_0.getItem(index);
          }
        }
        return null;
      },
      ...
      __P_145_9() {
        ...
        var parent = this.__P_145_4.pop();
        while (parent != null) {
          if (lookupTable.contains(parent)) {
            return parent;
          }
          parent = this.__P_145_4.pop();
        }
        return this.getModel();
      }
    },
    destruct() {
      ...
      if (!qx.core.ObjectRegistry.inShutDown && this.__P_145_3 != null) {
        this.__P_145_3.cancel();
        this.__P_145_3.dispose();
      }
      ...
      this._layer = this._provider = this.__P_145_0 = this.__P_145_1 = this.__P_145_3 = null;
    }
  });
