  ...
  qx.Mixin.define("qx.ui.tree.core.MWidgetController", {
    ...
    members: {
      ...
      bindDefaultProperties(item, index) {
        ...
        var bindPath = this.__P_260_1(index);
      ...
      bindProperty(sourcePath, targetProperty, options, targetWidget, index) {
        var bindPath = this.__P_260_1(index, sourcePath);
        var bindTarget = this._tree.getLookupTable();
        var id = bindTarget.bind(bindPath, targetWidget, targetProperty, options);
        this.__P_260_2(targetWidget, id);
      },
      /**
      ...
      bindPropertyReverse(targetPath, sourceProperty, options, sourceWidget, index) {
        var bindPath = this.__P_260_1(index, targetPath);
        var bindTarget = this._tree.getLookupTable();
        var id = sourceWidget.bind(sourceProperty, bindTarget, bindPath, options);
        this.__P_260_2(sourceWidget, id);
      },
      /**
       * Remove all bindings from all bounded items.
       */
      removeBindings() {
        while (this.__P_260_0.length > 0) {
          var item = this.__P_260_0.pop();
      ...
      _removeBindingsFrom(item) {
        var bindings = this.__P_260_3(item);
        ...
        if (this.__P_260_0.includes(item)) {
          qx.lang.Array.remove(this.__P_260_0, item);
        }
      },
      /**
       ...
       */
      __P_260_2(widget, id) {
        var bindings = this.__P_260_3(widget);
        if (!bindings.includes(id)) {
          bindings.push(id);
        }
        if (!this.__P_260_0.includes(widget)) {
