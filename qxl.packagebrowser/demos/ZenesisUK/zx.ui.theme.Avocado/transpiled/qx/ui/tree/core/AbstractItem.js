  ...
  qx.Class.define("qx.ui.tree.core.AbstractItem", {
    ...
    members: {
      ...
      */
      ...
      addSpacer() {
        if (!this.__P_258_2) {
          this.__P_258_2 = new qx.ui.core.Spacer();
        } else {
          this._remove(this.__P_258_2);
        }
        this._add(this.__P_258_2);
      },
      /**
      ...
      */
      ...
      _applyIconOpened(value, old) {
        if (this.isOpen()) {
          ...
          if (this.__P_258_5() && this.__P_258_3()) {
            this.__P_258_4(value);
          }

          // .. only "opened" icon was user-defined
          else if (!this.__P_258_5() && this.__P_258_3()) {
            this.__P_258_4(value);
          }
        }
      },
      ...
      _applyOpen(value, old) {
        ...
        if (value) {
          ...
          source = this.__P_258_3() ? this.getIconOpened() : null;
        }
      ...
      */
      ...
      _updateIndent() {
        ...
        if (this.__P_258_2) {
          this.__P_258_2.setWidth((this.getLevel() + 1) * this.getIndent() - openWidth);
        }
      },
      // property apply
    ...
    destruct() {
      this._disposeObjects("__P_258_2");
    }
  });
