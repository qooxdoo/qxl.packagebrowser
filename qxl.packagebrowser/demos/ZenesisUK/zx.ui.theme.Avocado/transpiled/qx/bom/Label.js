    ...
    */
    ...
    statics: {
      ...
      getHtmlSize(content, styles, width) {
        let cacheKey = this.__P_89_7(styles, width);
        let size = this.__P_89_8(cacheKey, content);
        if (size !== undefined) {
          return size;
        }
      ...
      getTextSize(text, styles) {
        let cacheKey = this.__P_89_7(styles);
        let size = this.__P_89_8(cacheKey, text);
        if (size !== undefined) {
          return size;
        }
       ...
       * @returns {*} size object
       */
      __P_89_8(cacheKey, text) {
        let cache = qx.bom.Label.__P_89_1[cacheKey];
