(function () {
  ...
  ************************************************************************ */
  ...
  qx.Bootstrap.define("qx.bom.request.Xhr", {
    ...
    construct() {
      var boundFunc = qx.Bootstrap.bind(this.__P_215_0, this);
      ...
      if (qx.event && qx.event.GlobalError && qx.event.GlobalError.observeMethod) {
        this.__P_215_1 = qx.event.GlobalError.observeMethod(boundFunc);
      } else {
        this.__P_215_1 = boundFunc;
      }
      this.__P_215_2 = qx.Bootstrap.bind(this.__P_215_3, this);
      this.__P_215_4 = qx.Bootstrap.bind(this.__P_215_5, this);
      this.__P_215_6 = qx.Bootstrap.bind(this.__P_215_7, this);
      this.__P_215_8();
      ...
      if (window.attachEvent) {
        this.__P_215_9 = qx.Bootstrap.bind(this.__P_215_10, this);
        window.attachEvent("onunload", this.__P_215_9);
      }
    },
    statics: {
      UNSENT: 0,
    ...
    members: {
      ...
      */
      ...
      open(method, url, async, user, password) {
        ...
        this.__P_215_12 = false;
        this.__P_215_13 = false;
        this.__P_215_14 = false;
        ...
        if (!this.__P_215_17() && this.readyState > qx.bom.request.Xhr.UNSENT) {
        ...
        try {
          ...
          if (this.__P_215_16) {
            ...
            if (window.XDomainRequest) {
              this.readyState = 4;
              this.__P_215_18 = new window.XDomainRequest();
              this.__P_215_18.onerror = qx.Bootstrap.bind(function () {
        ...
        if (qx.core.Environment.get("engine.name") === "mshtml" && qx.core.Environment.get("browser.documentmode") < 9 && this.__P_215_18.readyState > 0) {
          this.__P_215_18.setRequestHeader("If-Modified-Since", "-1");
        }

        // BUGFIX: Firefox
        // Firefox < 4 fails to trigger onreadystatechange OPENED for sync requests
        if (qx.core.Environment.get("engine.name") === "gecko" && parseInt(qx.core.Environment.get("engine.version"), 10) < 2 && !this.__P_215_16) {
      ...
      setRequestHeader(key, value) {
        ...
        if (key == "If-Match" || key == "If-Modified-Since" || key == "If-None-Match" || key == "If-Range") {
          this.__P_215_14 = true;
        }
        this.__P_215_18.setRequestHeader(key, value);
        return this;
      },
      /**
       * Sends request.
      ...
      send(data) {
        ...
        //
        if (!this.__P_215_16 && this.__P_215_19) {
          throw this.__P_215_19;
        }
        ...
        // Timeout
        if (this.timeout > 0) {
          this.__P_215_21 = window.setTimeout(this.__P_215_6, this.timeout);
        }
        ...
        data = data !== null && this.__P_215_22.indexOf(dataType) === -1 ? data.toString() : data;
        ...
        try {
          ...
          if (this.__P_215_16) {
            this.__P_215_18.responseType = this.responseType;
          }
          this.__P_215_18.send(data);
        } catch (SendError) {
          if (!this.__P_215_16) {
            throw SendError;
          }
        ...
        if (qx.core.Environment.get("engine.name") === "gecko" && !this.__P_215_16) {
          // Properties all set, only missing native readystatechange event
          this.__P_215_0();
        }

        // Set send flag
        this.__P_215_13 = true;
        return this;
      },
      /**
      ...
      abort() {
        this.__P_215_11();
        this.__P_215_12 = true;
        this.__P_215_18.abort();
        if (this.__P_215_18 && this.readyState !== qx.bom.request.Xhr.DONE) {
          this.readyState = this.__P_215_18.readyState;
        }
        return this;
      },
      /**
      ...
      getResponseHeader(header) {
        this.__P_215_11();
        if (qx.core.Environment.get("browser.documentmode") === 9 && this.__P_215_18.aborted) {
          return "";
        }
        return this.__P_215_18.getResponseHeader(header);
      },
      /**
      ...
      getAllResponseHeaders() {
        ...
        return this.__P_215_18.getAllResponseHeaders();
      },
      /**
      ...
      overrideMimeType(mimeType) {
        this.__P_215_11();
        if (this.__P_215_18.overrideMimeType) {
          this.__P_215_18.overrideMimeType(mimeType);
        } else {
      ...
      */
      ...
      dispose() {
        ...
        window.clearTimeout(this.__P_215_21);

        // Remove unload listener in IE. Aborting on unload is no longer required
        // for this instance.
        if (window.detachEvent) {
          window.detachEvent("onunload", this.__P_215_9);
        }

        // May fail in IE
        try {
          this.__P_215_18.onreadystatechange;
        ...
        this.__P_215_18.onreadystatechange = noop;
        this.__P_215_18.onload = noop;
        this.__P_215_18.onerror = noop;
        this.__P_215_18.onprogress = noop;

        // Abort any network activity
        this.abort();

        // Remove reference to native XHR
        this.__P_215_18 = null;
      ...
      */
      ...
      __P_215_8() {
        ...
        this.__P_215_18 = this._createNativeXhr();

        // Track native ready state changes
        this.__P_215_18.onreadystatechange = this.__P_215_1;

        // Track native abort, when supported
        if (qx.Bootstrap.getClass(this.__P_215_18.onabort) !== "Undefined") {
          this.__P_215_18.onabort = this.__P_215_2;
        }

        // Track native progress, when supported
        if (qx.Bootstrap.getClass(this.__P_215_18.onprogress) !== "Undefined") {
          this.__P_215_18.onprogress = this.__P_215_4;
          this.progress = {
        ...
        // Reset flags
        this.__P_215_20 = this.__P_215_13 = this.__P_215_12 = false;

        // Initialize data white list
        this.__P_215_22 = ["ArrayBuffer", "Blob", "File", "HTMLDocument", "String", "FormData"];
      },
      /**
       * Track native abort.
       *
      ...
      __P_215_0() {
        ...
        // without send flag
        if (this.readyState === qx.bom.request.Xhr.DONE && this.__P_215_12 && !this.__P_215_13) {
          return;
        }
        ...
        // be fired.
        if (!this.__P_215_16 && (nxhr.readyState == 2 || nxhr.readyState == 3)) {
          return;
        }
