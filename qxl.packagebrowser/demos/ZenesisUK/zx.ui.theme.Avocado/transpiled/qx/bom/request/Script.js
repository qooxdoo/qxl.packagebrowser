(function () {
  ...
  ************************************************************************ */
  ...
  qx.Bootstrap.define("qx.bom.request.Script", {
    ...
    construct() {
      this.__P_216_0();
      this.__P_216_1 = qx.Bootstrap.bind(this._onNativeLoad, this);
      this.__P_216_2 = qx.Bootstrap.bind(this._onNativeError, this);
      this.__P_216_3 = qx.Bootstrap.bind(this._onTimeout, this);
      this.__P_216_4 = document.head || document.getElementsByTagName("head")[0] || document.documentElement;
      ...
      this.timeout = this.__P_216_5() ? 0 : 15000;
    },
    events: {
    ...
    members: {
      ...
      open(method, url) {
        ...
        this.__P_216_8 = null;
        this.__P_216_9 = url;
        if (this.__P_216_10("qx.debug.io")) {
      ...
      setRequestHeader(key, value) {
        ...
        param[key] = value;
        this.__P_216_9 = qx.util.Uri.appendParamsToUrl(this.__P_216_9, param);
        return this;
      },
      /**
       * Sends request.
      ...
      send() {
        ...
        var script = this.__P_216_11(),
          head = this.__P_216_4,
          that = this;
        if (this.timeout > 0) {
          this.__P_216_12 = window.setTimeout(this.__P_216_3, this.timeout);
        }
        if (this.__P_216_10("qx.debug.io")) {
      ...
      setDetermineSuccess(check) {
        this.__P_216_6 = check;
      },
      /**
       * Dispose object.
       */
      dispose() {
        var script = this.__P_216_14;
        if (!this.__P_216_7) {
          ...
          if (this.__P_216_12) {
            window.clearTimeout(this.__P_216_12);
          }
          this.__P_216_7 = true;
        }
      },
      ...
      */
      ...
      _onNativeLoad() {
        var script = this.__P_216_14,
          determineSuccess = this.__P_216_6,
          that = this;
        ...
        if (this.__P_216_10("engine.name") === "mshtml" && this.__P_216_10("browser.documentmode") < 9) {
      ...
      */
       ...
       */
      __P_216_5() {
        var isLegacyIe = this.__P_216_10("engine.name") === "mshtml" && this.__P_216_10("browser.documentmode") < 9;
        var isOpera = this.__P_216_10("engine.name") === "opera";
       ...
       */
      __P_216_11() {
        var script = this.__P_216_14 = document.createElement("script");
        script.src = this.__P_216_9;
        script.onerror = this.__P_216_2;
        script.onload = this.__P_216_1;

        // BUGFIX: IE < 9
        // Legacy IEs do not fire the "load" event for script elements.
        // Instead, they support the "readystatechange" event
        if (this.__P_216_10("engine.name") === "mshtml" && this.__P_216_10("browser.documentmode") < 9) {
          script.onreadystatechange = this.__P_216_1;
        }
        return script;
      },
      /**
      ...
      __P_216_13() {
        ...
        if (script && script.parentNode) {
          this.__P_216_4.removeChild(script);
        }
      },
      /**
