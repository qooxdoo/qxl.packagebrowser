  ...
  ************************************************************************ */
  ...
  qx.Bootstrap.define("qx.bom.client.OperatingSystem", {
    statics: {
       ...
       */
      getVersion() {
        var version = qx.bom.client.OperatingSystem.__P_10_1(navigator.userAgent);
        if (version == null) {
          version = qx.bom.client.OperatingSystem.__P_10_2(navigator.userAgent);
        }
        if (version != null) {
          return version;
        } else {
      ...
      __P_10_1(userAgent) {
        var str = [];
        for (var key in qx.bom.client.OperatingSystem.__P_10_0) {
          str.push(key);
        }
        var reg = new RegExp("(" + str.join("|").replace(/\./g, ".") + ")", "g");
        var match = reg.exec(userAgent);
        if (match && match[1]) {
          return qx.bom.client.OperatingSystem.__P_10_0[match[1]];
        }
        return null;
      },
      /**
