  ...
  ************************************************************************ */
  ...
  qx.Bootstrap.define("qx.bom.client.Plugin", {
    statics: {
       ...
       */
      __P_257_1(activeXName, pluginNames, forceActiveX) {
        var available = qx.bom.client.Plugin.__P_257_2(activeXName, pluginNames, forceActiveX);
       ...
       */
      __P_257_2(activeXName, pluginNames, forceActiveX) {
        // IE checks
        if (qx.bom.client.Engine.getName() == "mshtml" && (qx.bom.client.Browser.getDocumentMode() < 11 || forceActiveX)) {
          if (!this.getActiveX()) {
            return false;
