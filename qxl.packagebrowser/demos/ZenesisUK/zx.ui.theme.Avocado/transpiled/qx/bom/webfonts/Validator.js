  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.bom.webfonts.Validator", {
    ...
    */
    ...
    statics: {
      ...
      removeDefaultHelperElements() {
        var defaultHelpers = qx.bom.webfonts.Validator.__P_251_3;
        if (defaultHelpers) {
          for (var prop in defaultHelpers) {
            document.body.removeChild(defaultHelpers[prop]);
          }
        }
        delete qx.bom.webfonts.Validator.__P_251_3;
      }
    },
    /*
    *****************************************************************************
    ...
    */
    ...
    members: {
      ...
      */
      ...
      validate() {
        ...
        if (document.fonts && typeof document.fonts.load == "function") {
          this.__P_251_5 = new Date().getTime();
          ...
          const timerCheck = () => {
            if (this._isFontValid()) {
              ...
              if (now - this.__P_251_5 >= this.getTimeout()) {
                setValidImpl(false);
              }
            }
          };
          ...
          qx.event.Timer.once(() => {
            this.__P_251_4 = new qx.event.Timer(100);
            this.__P_251_4.addListener("interval", timerCheck);
            this.__P_251_4.start();
          }, this, 0);
        }
      },
      /**
      ...
      */
       ...
       */
      _isFontValid() {
        if (!qx.bom.webfonts.Validator.__P_251_2) {
          this.__P_251_6();
        }
        if (!this.__P_251_0) {
          this.__P_251_0 = this._getRequestedHelpers();
        ...
        if (requestedSans !== cls.__P_251_2.sans || requestedSerif !== cls.__P_251_2.serif) {
          return true;
        }
        return false;
      },
      ...
      */
      ...
      __P_251_6() {
        ...
        cls.__P_251_2 = {
          sans: qx.bom.element.Dimension.getWidth(cls.__P_251_3.sans),
          serif: qx.bom.element.Dimension.getWidth(cls.__P_251_3.serif)
        };
      }
    },
    /*
    ...
    */
    ...
    destruct() {
      this._reset();
      if (this.__P_251_4 != null) {
        this.__P_251_4.stop();
      }
      this._disposeObjects("__P_251_4");
    }
  });
