  ...
  ************************************************************************ */
  ...
  qx.Bootstrap.define("qx.bom.element.Transform", {
    statics: {
      ...
      __P_255_0: qx.core.Environment.get("css.transform"),
      /**
      ...
      setOrigin(el, value) {
        if (this.__P_255_0 != null) {
          el.style[this.__P_255_0["origin"]] = value;
        }
      },
      /**
      ...
      getOrigin(el) {
        if (this.__P_255_0 != null) {
          return el.style[this.__P_255_0["origin"]];
        }
        return "";
      },
      /**
      ...
      setStyle(el, value) {
        if (this.__P_255_0 != null) {
          el.style[this.__P_255_0["style"]] = value;
        }
      },
      /**
      ...
      getStyle(el) {
        if (this.__P_255_0 != null) {
          return el.style[this.__P_255_0["style"]];
        }
        return "";
      },
      /**
      ...
      setPerspective(el, value) {
        if (this.__P_255_0 != null) {
          el.style[this.__P_255_0["perspective"]] = value + "px";
        }
      },
      /**
      ...
      getPerspective(el) {
        if (this.__P_255_0 != null) {
          return el.style[this.__P_255_0["perspective"]];
        }
        return "";
      },
      /**
      ...
      setPerspectiveOrigin(el, value) {
        if (this.__P_255_0 != null) {
          el.style[this.__P_255_0["perspective-origin"]] = value;
        }
      },
      /**
      ...
      getPerspectiveOrigin(el) {
        if (this.__P_255_0 != null) {
          var value = el.style[this.__P_255_0["perspective-origin"]];
          if (value != "") {
            return value;
          } else {
            var valueX = el.style[this.__P_255_0["perspective-origin"] + "X"];
            var valueY = el.style[this.__P_255_0["perspective-origin"] + "Y"];
            if (valueX != "") {
      ...
      setBackfaceVisibility(el, value) {
        if (this.__P_255_0 != null) {
          el.style[this.__P_255_0["backface-visibility"]] = value ? "visible" : "hidden";
        }
      },
      /**
      ...
      getBackfaceVisibility(el) {
        if (this.__P_255_0 != null) {
          return el.style[this.__P_255_0["backface-visibility"]] == "visible";
        }
        return true;
      },
      /**
