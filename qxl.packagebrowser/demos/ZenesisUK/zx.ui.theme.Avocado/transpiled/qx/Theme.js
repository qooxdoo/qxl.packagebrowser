    ...
    statics: {
      ...
      */
      ...
      define(name, config) {
        ...
        config.patch = this.__P_3_0(config.patch);
      ...
      */
       ...
       */
      __P_3_1(theme, config) {
        var type = this.__P_3_3(config);
      ...
      __P_3_5: qx.core.Environment.select("qx.debug", {
        true: {
          title: "string",
          // String
          aliases: "object",
      ...
      __P_3_6: qx.core.Environment.select("qx.debug", {
        true: {
          color: "object",
          border: "object",
          decoration: "object",
       ...
       */
      __P_3_7: qx.core.Environment.select("qx.debug", {
        true(name, config) {
          var allowed = this.__P_3_5;
