  ...
  ************************************************************************ */
  ...
  qx.Class.define("zx.ui.theme.avocado.demo.pages.List", {
    ...
    construct() {
      ...
      this.__P_75_0 = new qx.ui.container.Composite(new qx.ui.layout.Grid(10));
      this.__P_75_1 = qx.util.ResourceManager.getInstance().toUri("qxl/widgetbrowser/people.json");
      this.add(this.__P_75_0);
      this.initWidgets();
    },
    members: {
      __P_75_0: null,
      ...
      initWidgets() {
        ...
        this.__P_75_0.add(label, {
          row: 0,
          column: 0
        });
        var list = this.__P_75_2();
        this.__P_75_0.add(list, {
          row: 1,
          column: 0
        });
        widgets.push(list);
        ...
        var virtualList = this.__P_75_3();
        this.__P_75_0.add(virtualList, {
          row: 1,
          column: 1
        });
        ...
        var groupedVirtualList = this.__P_75_4();
        this.__P_75_0.add(groupedVirtualList, {
          row: 1,
          column: 2
        });
      ...
      __P_75_2() {
        ...
        list.setWidth(150);
        var req = new qx.io.request.Xhr(this.__P_75_1);
        req.setParser("json");
      ...
      __P_75_5(widget) {
        var store = new qx.data.store.Json(this.__P_75_1);
        store.bind("model.people", widget, "model");
      }
    }
  });
  zx.ui.theme.avocado.demo.pages.List.$$dbClassInfo = $$dbClassInfo;
})();
