(function () {
  ...
  ************************************************************************ */
  ...
  qx.Class.define("zx.ui.theme.avocado.demo.pages.Embed", {
    ...
    construct() {
      ...
      this.__P_80_0 = new qx.ui.container.Composite(gridLayout);
    ...
    members: {
      ...
      initWidgets() {
        ...
        if (qx.core.Environment.get("html.canvas")) {
          ...
          canvas.addListener("redraw", this.__P_80_1, this);
          widgets.push(canvas);
          this.__P_80_0.add(canvas, {
            row: 3,
            column: 0
          });
        } else {
          this.__P_80_0.add(new qx.ui.basic.Label("Browser does not support canvas"), {
            row: 3,
            column: 0
          });
        }
        ...
        this.__P_80_0.add(htmlContainer, {
          row: 3,
          column: 1
        });
  ...
  zx.ui.theme.avocado.demo.pages.Embed.$$dbClassInfo = $$dbClassInfo;
})();
