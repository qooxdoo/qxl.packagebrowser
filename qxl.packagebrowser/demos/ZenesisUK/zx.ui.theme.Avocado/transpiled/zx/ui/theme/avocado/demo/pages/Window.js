(function () {
  ...
  ************************************************************************ */
  ...
  qx.Class.define("zx.ui.theme.avocado.demo.pages.Window", {
    ...
    construct() {
      ...
      this.__P_77_0 = new qx.ui.window.Desktop().set({
        decorator: decorator
      });
      this.add(this.__P_77_0, {
        edge: 0,
        top: 0
      });
      this.initWidgets();
    ...
    members: {
      ...
      __P_77_4() {
        ...
        wm1.setModal(true);
        wm1.moveTo(150, 150);
        this.__P_77_0.add(wm1);
        var wm2 = this.__P_77_5();
  ...
  zx.ui.theme.avocado.demo.pages.Window.$$dbClassInfo = $$dbClassInfo;
})();
