(function () {
  ...
  ************************************************************************ */
  ...
  qx.Class.define("zx.ui.theme.avocado.demo.pages.Misc", {
    extend: zx.ui.theme.avocado.demo.pages.AbstractPage,
    construct() {
      zx.ui.theme.avocado.demo.pages.AbstractPage.constructor.call(this);
      this.__P_82_0 = new qx.ui.container.Composite(new qx.ui.layout.VBox(10));
    ...
    members: {
      ...
      initWidgets() {
        ...
        widgets.push(pb);
        this.__P_82_0.add(label);
        this.__P_82_0.add(pb);
        ...
        this.__P_82_0.add(label);
        this.__P_82_0.add(subcontainer);
  ...
  zx.ui.theme.avocado.demo.pages.Misc.$$dbClassInfo = $$dbClassInfo;
})();
