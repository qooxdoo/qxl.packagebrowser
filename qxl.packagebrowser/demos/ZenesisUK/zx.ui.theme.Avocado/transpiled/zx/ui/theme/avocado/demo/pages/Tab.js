(function () {
  ...
  ************************************************************************ */
  ...
  qx.Class.define("zx.ui.theme.avocado.demo.pages.Tab", {
    extend: zx.ui.theme.avocado.demo.pages.AbstractPage,
    construct() {
      zx.ui.theme.avocado.demo.pages.AbstractPage.constructor.call(this);
      this.__P_78_0 = new qx.ui.container.Composite(new qx.ui.layout.Grid(10, 20));
      this.add(this.__P_78_0);
      this.initWidgets();
    },
    members: {
      __P_78_0: null,
      initWidgets() {
        ...
        var tabTop = this.__P_78_1();
        tabTop.setBarPosition("top");
        this.__P_78_0.add(tabTop, {
          row: 0,
          column: 0
        });
        widgets.push(tabTop);
        var tabBottom = this.__P_78_1();
        tabBottom.setBarPosition("bottom");
        this.__P_78_0.add(tabBottom, {
          row: 0,
          column: 1
        });
        widgets.push(tabBottom);
        var tabLeft = this.__P_78_1();
        tabLeft.setBarPosition("left");
        this.__P_78_0.add(tabLeft, {
          row: 1,
          column: 0
        });
        widgets.push(tabLeft);
        var tabRight = this.__P_78_1();
        tabRight.setBarPosition("right");
        this.__P_78_0.add(tabRight, {
          row: 1,
          column: 1
        });
        widgets.push(tabRight);
      },
      toggleOverflow(tabView, enable) {
        if (!enable) {
  ...
  zx.ui.theme.avocado.demo.pages.Tab.$$dbClassInfo = $$dbClassInfo;
})();
