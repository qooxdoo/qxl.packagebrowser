  ...
  qx.Class.define("zx.ui.theme.avocado.demo.FormItems", {
    ...
    members: {
      ...
      _createView: function _createView() {
        ...
        textField.setRequired(true);
        this.__P_154_0.push(passwordField);
        ...
        this.__P_154_1(comboBox);
        this.__P_154_0.push(comboBox);
        ...
        this.__P_154_2(virtualComboBox);
        this.__P_154_0.push(virtualComboBox);
        ...
        this.__P_154_1(selectBox);
        this.__P_154_0.push(selectBox);
        ...
        this.__P_154_2(virtualSelectBox);
        this.__P_154_0.push(virtualSelectBox);
        ...
        this.__P_154_0.push(radioButtonGroup);
        ...
        this.__P_154_0.push(toggleButton);
        ...
        this.__P_154_0.push(repeatButton);

        // menu button
        var menuButton = new qx.ui.form.MenuButton("MenuButton", null, this.__P_154_3()).set({
          tabIndex: tabIndex++
        });
        ...
        this.__P_154_0.push(menuButton);

        // split button
        var splitButton = new qx.ui.form.SplitButton("SplitButton", null, this.__P_154_4()).set({
          tabIndex: tabIndex++
        });
        ...
        this.__P_154_0.push(splitButton);
        ...
        this.__P_154_0.push(triCheckBox);
        ...
        this.__P_154_0.push(radioButton);
        renderedForm = new qx.ui.form.renderer.Single(form);
