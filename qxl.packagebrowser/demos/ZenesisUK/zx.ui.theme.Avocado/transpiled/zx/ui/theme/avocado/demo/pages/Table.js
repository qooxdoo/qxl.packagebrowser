(function () {
  ...
  ************************************************************************ */
  ...
  qx.Class.define("zx.ui.theme.avocado.demo.pages.Table", {
    ...
    members: {
      ...
      initWidgets() {
        ...
        var table = this.__P_76_1();
        table.setFocusedCell(2, 5);
        widgets.push(table);
        this.add(table);
      },
      __P_76_1() {
        var rowData = this.__P_76_2(500);
      ...
      __P_76_2(rowCount) {
        ...
        for (var row = 0; row < rowCount; row++) {
          ...
          rowData.push([this.__P_76_0++, Math.random() * 10000, date, Math.random() > 0.5]);
        }
        return rowData;
      }
    }
  });
  zx.ui.theme.avocado.demo.pages.Table.$$dbClassInfo = $$dbClassInfo;
})();
