  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.locale.LocalizedString", {
    ...
    construct(translation, messageId, args, localized) {
      ...
      this.__P_73_0 = messageId;
      this.__P_73_1 = !!localized;
      this.__P_73_2 = args;
    },
    members: {
      __P_73_1: null,
      ...
      translate() {
        if (this.__P_73_1) {
          return qx.locale.Manager.getInstance().localize(this.__P_73_0, this.__P_73_2);
        }
        return qx.locale.Manager.getInstance().translate(this.__P_73_0, this.__P_73_2);
      },
      /**
