    ...
    statics: {
      ...
      */
      ...
      define(name, config) {
        ...
        config.patch = this.__P_8_0(config.patch);
      ...
      */
       ...
       */
      __P_8_1(theme, config) {
        var type = this.__P_8_3(config);
      ...
      __P_8_5: qx.core.Environment.select("qx.debug", {
        true: {
          title: "string",
          // String
          aliases: "object",
      ...
      __P_8_6: qx.core.Environment.select("qx.debug", {
        true: {
          color: "object",
          border: "object",
          decoration: "object",
       ...
       */
      __P_8_7: qx.core.Environment.select("qx.debug", {
        true(name, config) {
          var allowed = this.__P_8_5;
