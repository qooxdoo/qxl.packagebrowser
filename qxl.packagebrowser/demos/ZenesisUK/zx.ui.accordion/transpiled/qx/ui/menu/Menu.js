    ...
    members: {
      ...
      */
      ...
      __P_55_2() {
        ...
        if (!menuBounds) {
          this.addListenerOnce("resize", this.__P_55_2, this);
          return;
        }
