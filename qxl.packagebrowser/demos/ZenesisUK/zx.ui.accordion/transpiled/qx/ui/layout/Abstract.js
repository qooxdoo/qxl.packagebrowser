  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.ui.layout.Abstract", {
    ...
    members: {
      ...
      */
      ...
      getSizeHint() {
        ...
        return this.__P_20_0 = this._computeSizeHint();
      },
      /**
      ...
      _renderSeparator(separator, bounds) {
        this.__P_20_1.renderSeparator(separator, bounds);
      },
      /**
      ...
      _applyLayoutChange() {
        if (this.__P_20_1) {
          this.__P_20_1.scheduleLayoutUpdate();
        }
      },
      /**
       ...
       */
      _getLayoutChildren() {
        return this.__P_20_1.getLayoutChildren();
      }
    },
    /*
    *****************************************************************************
    ...
    */
    ...
    destruct() {
      this.__P_20_1 = this.__P_20_0 = null;
    }
  });
