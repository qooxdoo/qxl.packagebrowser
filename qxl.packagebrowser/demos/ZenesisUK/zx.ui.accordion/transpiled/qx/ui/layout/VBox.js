  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.ui.layout.VBox", {
    ...
    members: {
      ...
      */
      ...
      __P_5_4() {
        ...
        var reuse = this.__P_5_0 && this.__P_5_0.length != length && this.__P_5_1 && this.__P_5_0;
        var props;

        // Sparse array (keep old one if lengths has not been modified)
        var heights = reuse ? this.__P_5_0 : new Array(length);
        var flexs = reuse ? this.__P_5_1 : new Array(length);
        ...
        // Store data
        if (!reuse) {
          this.__P_5_0 = heights;
          this.__P_5_1 = flexs;
        }
        this.__P_5_2 = enableFlex;
        this.__P_5_3 = children;
      ...
      */
      ...
      renderLayout(availWidth, availHeight, padding) {
        ...
        if (this.__P_5_2 && allocatedHeight != availHeight) {
          var flexibles = {};
          var flex, offset;
      ...
      _computeSizeHint() {
        ...
        for (var i = 0, l = children.length; i < l; i += 1) {
          ...
          var flex = this.__P_5_1[i];
          var percent = this.__P_5_0[i];
          if (flex) {
    ...
    */
    ...
    destruct() {
      this.__P_5_0 = this.__P_5_1 = this.__P_5_3 = null;
    }
  });
