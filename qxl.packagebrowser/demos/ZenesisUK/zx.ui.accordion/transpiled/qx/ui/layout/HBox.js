    ...
    members: {
      ...
      */
      ...
      __P_6_4() {
        ...
        var widths = reuse ? this.__P_6_0 : new Array(length);
        var flexs = reuse ? this.__P_6_1 : new Array(length);
      ...
      */
      ...
      renderLayout(availWidth, availHeight, padding) {
        ...
        if (this.__P_6_2 && allocatedWidth != availWidth) {
          var flexibles = {};
          var flex, offset;
