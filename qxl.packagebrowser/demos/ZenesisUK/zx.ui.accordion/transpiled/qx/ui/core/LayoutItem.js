  ...
  qx.Class.define("qx.ui.core.LayoutItem", {
    ...
    */
    ...
    members: {
      ...
      */
       ...
       */
      getBounds() {
        return this.__P_54_5 || this.__P_54_1 || null;
      },
      /**
      ...
      renderLayout(left, top, width, height) {
        ...
        var computed = this.__P_54_1;
        if (!computed) {
          computed = this.__P_54_1 = {};
        }
        ...
        if (this.__P_54_2) {
          changes.local = true;
          delete this.__P_54_2;
        }
        if (this.__P_54_4) {
          changes.margin = true;
          delete this.__P_54_4;
        }
        ...
        if (this.getHeight() == null && this._hasHeightForWidth()) {
          ...
          if (flowHeight != null && flowHeight !== this.__P_54_0) {
            // This variable is used in the next computation of the size hint
            this.__P_54_0 = flowHeight;
      ...
      getSizeHint(compute) {
        ...
        // Compute as defined
        hint = this.__P_54_3 = this._computeSizeHint();

        // Respect height for width
        if (this._hasHeightForWidth() && this.__P_54_0 && this.getHeight() == null) {
          hint.height = this.__P_54_0;
        }
      ...
      */
      ...
      setLayoutProperties(props) {
        ...
        var storage = this.__P_54_6;
        if (!storage) {
          storage = this.__P_54_6 = {};
        }
       ...
       */
      getLayoutProperties() {
        return this.__P_54_6 || this.__P_54_7;
      },
      /**
      ...
      */
      ...
      clone() {
        ...
        var props = this.__P_54_6;
        if (props) {
          clone.__P_54_6 = qx.lang.Object.clone(props);
        }
        return clone;
      }
    },
    ...
    */
    ...
    destruct() {
      ...
      this.$$parent = this.$$subparent = this.__P_54_6 = this.__P_54_1 = this.__P_54_5 = this.__P_54_3 = null;
    }
  });
