  ...
  qx.Mixin.define("qx.ui.core.MRemoteChildrenHandling", {
    ...
    */
    ...
    members: {
       ...
       */
      __P_18_0(functionName, a1, a2, a3) {
       ...
       */
      getChildren() {
        return this.__P_18_0("getChildren");
      },
      /**
       ...
       */
      hasChildren() {
        return this.__P_18_0("hasChildren");
      },
      /**
       ...
       */
      add(child, options) {
        return this.__P_18_0("add", child, options);
      },
      /**
       ...
       */
      remove(child) {
        return this.__P_18_0("remove", child);
      },
      /**
       * Remove all children.
       ...
       */
      removeAll() {
        return this.__P_18_0("removeAll");
      },
      /**
       ...
       */
      indexOf(child) {
        return this.__P_18_0("indexOf", child);
      },
      /**
      ...
      addAt(child, index, options) {
        this.__P_18_0("addAt", child, index, options);
      },
      /**
      ...
      addBefore(child, before, options) {
        this.__P_18_0("addBefore", child, before, options);
      },
      /**
      ...
      addAfter(child, after, options) {
        this.__P_18_0("addAfter", child, after, options);
      },
      /**
       ...
       */
      removeAt(index) {
        return this.__P_18_0("removeAt", index);
      }
    }
  });
