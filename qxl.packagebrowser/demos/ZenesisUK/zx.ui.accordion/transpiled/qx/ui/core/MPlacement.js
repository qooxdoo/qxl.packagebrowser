    ...
    members: {
      ...
      placeToWidget(target, liveupdate) {
        ...
        if (liveupdate) {
          ...
          qx.event.Idle.getInstance().addListener("interval", this.__P_107_2);
        ...
        if (coords != null) {
          ...
          if (boundsAreEqual(coords, this.__P_107_5) && boundsAreEqual(size, this.__P_107_6)) {
            return true;
          }
          this.__P_107_5 = coords;
          this.__P_107_6 = size;
          this._place(coords);
          return true;
        } else {
