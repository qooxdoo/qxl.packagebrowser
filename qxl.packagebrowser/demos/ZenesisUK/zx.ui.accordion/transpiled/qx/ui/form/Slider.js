    ...
    members: {
      ...
      */
      ...
      _onPointerDown(e) {
        ...
        var isHorizontal = this.__P_184_13;
        ...
        var sliderLocation = this.__P_184_0 = qx.bom.element.Location.get(this.getContentElement().getDomElement())[locationProperty];
        sliderLocation += padding;
        var knobLocation = this.__P_184_1 = qx.bom.element.Location.get(knob.getContentElement().getDomElement())[locationProperty];
        if (e.getTarget() === knob) {
          // Switch into drag mode
          this.__P_184_3 = true;
          if (!this.__P_184_9) {
            // create a timer to fire delayed dragging events if dragging stops.
            this.__P_184_9 = new qx.event.Timer(100);
            this.__P_184_9.addListener("interval", this._fireValue, this);
          }
          this.__P_184_9.start();
          // Compute dragOffset (includes both: inner position of the widget and
          // cursor position on knob)
          this.__P_184_4 = cursorLocation + sliderLocation - knobLocation;
          ...
          this.__P_184_6 = cursorLocation <= knobLocation ? -1 : 1;
          ...
          if (!this.__P_184_8) {
            this.__P_184_8 = new qx.event.Timer(100);
            this.__P_184_8.addListener("interval", this._onInterval, this);
          }

          // Start timer
          this.__P_184_8.start();
        }
      ...
      _onPointerUp(e) {
        if (this.__P_184_3) {
          ...
          if (e.getType() === "pointerup") {
            ...
            var positionSlider;
            if (this.__P_184_13) {
              deltaSlider = e.getDocumentLeft() - (this._valueToPosition(this.getValue()) + this.__P_184_0);
              ...
              deltaSlider = e.getDocumentTop() - (this._valueToPosition(this.getValue()) + this.__P_184_0);
            ...
            if (deltaPosition < 0 || deltaPosition > this.__P_184_2 || deltaSlider < 0 || deltaSlider > this.__P_184_2) {
          ...
          // Cleanup status flags
          delete this.__P_184_5;
          delete this.__P_184_6;
          delete this.__P_184_7;
        }
      ...
      _onPointerMove(e) {
        if (this.__P_184_3) {
          var dragStop = this.__P_184_13 ? e.getDocumentLeft() : e.getDocumentTop();
          var position = dragStop - this.__P_184_4;
      ...
      _onInterval(e) {
        // Compute new value
        var value = this.getValue() + this.__P_184_6 * this.getPageStep();
        ...
        var slideBack = this.__P_184_6 == -1;
        if (slideBack && value <= this.__P_184_7 || !slideBack && value >= this.__P_184_7) {
          value = this.__P_184_7;
        }
      ...
      _onUpdate(e) {
        ...
        var sizeProperty = this.__P_184_13 ? "width" : "height";

        // Sync knob size
        this._updateKnobSize();

        // Store knob size
        this.__P_184_15 = availSize[sizeProperty] - knobSize[sizeProperty];
        this.__P_184_2 = knobSize[sizeProperty];
      ...
      */
      ...
      __P_184_14(e) {
        var isHorizontal = this.__P_184_13;
        var cursorLocation = isHorizontal ? e.getDocumentLeft() : e.getDocumentTop();
        var sliderLocation = this.__P_184_0;
        var knobLocation = this.__P_184_1;
        var knobSize = this.__P_184_2;
        ...
        if (value < min) {
          ...
          var method = this.__P_184_6 < 0 ? "floor" : "ceil";
        ...
        if (this.__P_184_7 == null || this.__P_184_6 == -1 && value <= this.__P_184_7 || this.__P_184_6 == 1 && value >= this.__P_184_7) {
          this.__P_184_7 = value;
        }
      },
      /**
      ...
      */
      ...
      slideTo(value, duration) {
        ...
        if (duration) {
          this.__P_184_16(value, duration);
        } else {
      ...
      updatePosition(value) {
        this.setValue(this.__P_184_17(value));
      },
      /**
      ...
      stopSlideAnimation() {
        if (this.__P_184_12) {
          this.__P_184_12.cancelSequence();
          this.__P_184_12 = null;
        }
      },
      /**
       ...
       * @param duration {Number} The time in milliseconds the slide to should take.
       */
      __P_184_16(to, duration) {
        to = this.__P_184_17(to);
        var from = this.getValue();
        this.__P_184_12 = new qx.bom.AnimationFrame();
        this.__P_184_12.on("frame", function (timePassed) {
          this.setValue(parseInt(timePassed / duration * (to - from) + from));
        }, this);
        this.__P_184_12.on("end", function () {
          this.setValue(to);
          this.__P_184_12 = null;
          this.fireEvent("slideAnimationEnd");
        }, this);
        this.__P_184_12.startSequence(duration);
      },
      /*
      ---------------------------------------------------------------------------
      ...
      */
      ...
      _applyOrientation(value, old) {
        ...
        this.__P_184_13 = value === "horizontal";
      ...
      _fireValue() {
        ...
        var tmp = this.__P_184_11;
        this.__P_184_11 = null;
