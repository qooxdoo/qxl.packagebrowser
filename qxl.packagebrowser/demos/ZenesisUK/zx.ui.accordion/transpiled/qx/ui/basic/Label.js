      ...
      */
      ...
      _applyFont(value, old) {
        ...
        if (value) {
          ...
          this.__P_7_0 = value;
          if (this.__P_7_0 instanceof qx.bom.webfonts.WebFont && !this.__P_7_0.isValid()) {
            this.__P_7_3 = this.__P_7_0.addListener("changeStatus", evt => {
      ...
      */
      ...
      _applyBuddy(value, old) {
        ...
        if (value != null) {
          ...
          this.__P_7_2 = this.addListener("tap", () => {
