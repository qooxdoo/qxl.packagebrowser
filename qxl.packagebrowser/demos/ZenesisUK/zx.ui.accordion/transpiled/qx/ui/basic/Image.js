      ...
      */
      ...
      __P_69_15(el, source) {
        ...
        if (isFont) {
          ...
          if (this.getScale()) {
            ...
            var font = this.__P_69_20(source);
          ...
          this.__P_69_21(ResourceManager.getImageWidth(source), ResourceManager.getImageHeight(source));
        }
      },
      __P_69_22(el, width, height) {
        if (this.getScale()) {
      ...
      _applyDimension() {
        ...
        if (isFont) {
          ...
          if (el) {
            ...
            this.__P_69_22(el, width, height);
          }
        } else {
          this.__P_69_21();
        }
      ...
      __P_69_18(el, source) {
        ...
        if (!ImageLoader.isFailed(source)) {
          ImageLoader.load(source, this.__P_69_23, this);
        } else {
          this.__P_69_12(el);
        }
      },
      ...
      __P_69_8(el, source) {
        ...
        if (isFont) {
          ...
          this.__P_69_22(el, this.__P_69_1, this.__P_69_2);
