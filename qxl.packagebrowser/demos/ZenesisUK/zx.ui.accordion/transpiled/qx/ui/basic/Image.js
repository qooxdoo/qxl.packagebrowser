    ...
    members: {
      ...
      */
      ...
      __P_69_9() {
        ...
        var mode = this.__P_69_11();
        if (this.__P_69_0[mode] == null) {
          this.__P_69_0[mode] = this.__P_69_13(mode);
        }
      ...
      _styleSource() {
        ...
        var source = AliasManager.resolve(this.__P_69_8);
        var element = this.getContentElement();
        if (this.__P_69_5) {
          element = element.getChild(0);
        }
        if (!source) {
          this.__P_69_14(element);
          return;
        }
        this.__P_69_15(source);
        ...
        if (ResourceManager.isFontUri(source)) {
          ...
          this.__P_69_19(contentEl, source);
          this.__P_69_18();
        } else {
          this.__P_69_20(contentEl, source);
        }
      },
      /**
       ...
       */
      __P_69_15: qx.core.Environment.select("engine.name", {
        mshtml(source) {
          ...
          if (isFont) {
            ...
            if (this.getScale() && this.__P_69_11() != "alphaScaled") {
              this.__P_69_12("alphaScaled");
            } else if (!this.getScale() && this.__P_69_11() != "nonScaled") {
              this.__P_69_12("nonScaled");
            }
          } else {
            if (this.getScale() && this.__P_69_11() != "scaled") {
              this.__P_69_12("scaled");
            } else if (!this.getScale() && this.__P_69_11() != "nonScaled") {
              this.__P_69_12("nonScaled");
            }
          }
          this.__P_69_21(this.__P_69_9());
        },
        default(source) {
          var isFont = source && qx.lang.String.startsWith(source, "@");
          if (isFont) {
            this.__P_69_12("font");
          } else if (this.getScale() && this.__P_69_11() != "scaled") {
            this.__P_69_12("scaled");
          } else if (!this.getScale() && this.__P_69_11() != "nonScaled") {
            this.__P_69_12("nonScaled");
          }
      ...
      __P_69_17(el, source) {
        ...
        if (isFont) {
          ...
          if (this.getScale()) {
            ...
            var font = this.__P_69_22(source);
          ...
          this.__P_69_23(ResourceManager.getImageWidth(source), ResourceManager.getImageHeight(source));
        }
      },
      __P_69_24(el, width, height) {
        if (this.getScale()) {
          el.setStyle("fontSize", (width > height ? height : width) + "px");
        } else {
          var source = qx.util.AliasManager.getInstance().resolve(this.__P_69_8);
      ...
      _applyDimension() {
        ...
        var isFont = this.__P_69_8 && qx.lang.String.startsWith(this.__P_69_8, "@");
        if (isFont) {
          var el = this.getContentElement();
          if (el) {
            var hint = this.getSizeHint();
            ...
            this.__P_69_24(el, width, height);
          }
        } else {
          this.__P_69_23();
        }
      ...
      __P_69_20(el, source) {
        ...
        if (!ImageLoader.isFailed(source)) {
          ImageLoader.load(source, this.__P_69_25, this);
        } else {
          this.__P_69_14(el);
          if (!this.__P_69_7 && this.getFallbackSource()) {
            this.__P_69_7 = true;
            this.__P_69_8 = this.getFallbackSource();
            this._styleSource();
          }
        }
      },
      ...
      __P_69_10(el, source) {
        ...
        if (isFont) {
          ...
          this.__P_69_24(el, this.__P_69_1, this.__P_69_2);
      ...
      __P_69_25(source, imageInfo) {
        ...
        if (source !== qx.util.AliasManager.getInstance().resolve(this.__P_69_8)) {
          this.fireEvent("aborted");
          return;
        }
        ...
        // Update image
        this.__P_69_19(this.__P_69_16(), source);
      },
      /**
    ...
    destruct() {
      for (var mode in this.__P_69_0) {
        if (this.__P_69_0.hasOwnProperty(mode)) {
          this.__P_69_0[mode].disconnectObject(this);
        }
      }
