  ...
  qx.Bootstrap.define("qx.Interface", {
    statics: {
      ...
      */
       ...
       */
      __P_9_0(object, clazz, iface, wrap, shouldThrow) {
        // Validate members
       ...
       */
      __P_9_3(clazz, iface, shouldThrow) {
        if (iface.$$properties) {
       ...
       */
      __P_9_4(clazz, iface, shouldThrow) {
        if (iface.$$events) {
      ...
      */
       ...
       */
      __P_9_2: qx.core.Environment.select("qx.debug", {
