  ...
  ************************************************************************ */
  ...
  qx.Bootstrap.define("qx.core.Property", {
    statics: {
       ...
       */
      __P_13_12(instance, members, name, variant, code, args) {
        var fn = this.__P_13_13(instance.constructor, name, variant, code, args);
       ...
       * @return {var} Return value of the generated function
       */
      __P_13_13(clazz, name, variant, code, args) {
       ...
       * @param name {String} name of the property
       */
      __P_13_17(code, clazz, config, name) {
        code.push("var equ=");
       ...
       */
      __P_13_18(code, config, name, variant, incomingValue) {
        {
       ...
       * @param name {String} name of the property
       */
      __P_13_20(code, clazz, config, name) {
       ...
       * @param variant {String} Method variant.
       */
      __P_13_21(code, incomingValue, store, variant) {
       ...
       * @param variant {String} Method variant.
       */
      __P_13_27: qx.core.Environment.select("qx.debug", {
        true(code, config, clazz, name, variant) {
          ...
          if (config.check !== undefined) {
            ...
            code.push("if(");
            if (this.__P_13_1[config.check] !== undefined) {
              code.push("!(", this.__P_13_1[config.check], ")");
       ...
       * @param incomingValue {Boolean} Whether the setter has an incoming value
       */
      __P_13_22(code, name, variant, incomingValue) {
       ...
       * @param incomingValue {Boolean} Whether the setter has an incoming value
       */
      __P_13_23(code, config, name, variant, incomingValue) {
       ...
       * @param variant {String} Method variant.
       */
      __P_13_24(code, config, name, variant) {
       ...
       * @param variant {String} Method variant.
       */
      __P_13_25(code, config, name, variant) {
       ...
       */
      __P_13_26(code, config, name, variant, refresh) {
