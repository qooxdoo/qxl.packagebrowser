  ...
  qx.Mixin.define("qx.core.MEvent", {
    members: {
      ...
      __P_92_3(result) {
        {
          ...
          let newPromise = result.then(result => {
            delete this.__P_92_1[hashCode];
            let promise = this.__P_92_2;
            if (promise && Object.keys(this.__P_92_1).length == 0) {
              this.__P_92_1 = null;
              this.__P_92_2 = null;
              promise.resolve();
            }
          ...
          this.__P_92_1[hashCode] = newPromise;
          return newPromise;
        }
      },
      /**
      ...
      fireEvent(type, clazz, args) {
        if (!this.$$disposed) {
          return this.__P_92_3(this.__P_92_0.fireEvent(this, type, clazz, args));
        }
        return true;
      },
      /**
      ...
      fireEventAsync(type, clazz, args) {
        if (!this.$$disposed) {
          return this.__P_92_3(this.__P_92_0.fireEventAsync(this, type, clazz, args));
        }
      ...
      fireNonBubblingEvent(type, clazz, args) {
        if (!this.$$disposed) {
          return this.__P_92_3(this.__P_92_0.fireNonBubblingEvent(this, type, clazz, args));
        }
        return true;
      },
      /**
      ...
      fireNonBubblingEventAsync(type, clazz, args) {
        if (!this.$$disposed) {
          return this.__P_92_3(this.__P_92_0.fireNonBubblingEventAsync(this, type, clazz, args));
        }
        return qx.Promise.resolve(true);
      },
      /**
      ...
      fireDataEvent(type, data, oldData, cancelable) {
        if (!this.$$disposed) {
          ...
          return this.__P_92_3(this.__P_92_0.fireEvent(this, type, qx.event.type.Data, [data, oldData, !!cancelable]));
        }
        return true;
      },
      /**
      ...
      fireDataEventAsync(type, data, oldData, cancelable) {
        if (!this.$$disposed) {
          ...
          return this.__P_92_3(this.__P_92_0.fireEventAsync(this, type, qx.event.type.Data, [data, oldData, !!cancelable]));
        }
        return qx.Promise.resolve(true);
      }
    }
