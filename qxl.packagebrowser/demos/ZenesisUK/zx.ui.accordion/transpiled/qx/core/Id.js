  ...
  qx.Class.define("qx.core.Id", {
    ...
    members: {
      ...
      _createQxObjectImpl(id) {
        {
          let object = qx.core.MObjectId.handleObjects(qx.core.Id, this, ...arguments);
          if (object !== undefined) {
            return object;
          }
        }
        if (this.__P_114_0) {
          var obj = this.__P_114_0[id];
          if (obj !== undefined) {
            return obj;
          }
        }
      ...
      getAbsoluteIdOf(obj, suppressWarnings) {
        if (this.__P_114_1 && this.__P_114_1[obj.toHashCode()]) {
        ...
        while (obj) {
          ...
          if (owner) {
            ...
            if (owner === application) {
              ...
              ownerId = this.__P_114_1 && this.__P_114_1[owner.toHashCode()] || null;
            }
      ...
      register(obj, id) {
        ...
        this.__P_114_0[id] = obj;
        this.__P_114_1[obj.toHashCode()] = id;
      ...
      unregister(data) {
        ...
        var obj = this.__P_114_0[id];
        if (obj) {
          delete this.__P_114_0[id];
          delete this.__P_114_1[obj.toHashCode()];
          obj._cascadeQxObjectIdChanges();
          return true;
        }
        return false;
