  ...
  qx.Class.define("qx.promise.NativeWrapper", {
    ...
    construct(arg0) {
      ...
      if (typeof arg0 === "function") {
        this.__P_84_0 = new Promise(arg0);
    ...
    members: {
       ...
       */
      bind(context) {
        let promise = new qx.promise.NativeWrapper(this.__P_84_0);
        return promise.__P_84_2(context);
      },
      /**
      ...
      then(onResolved, onRejected) {
        onResolved = onResolved.bind(this.__P_84_1);
        if (onRejected) {
          onRejected = onRejected.bind(this.__P_84_1);
        }
        return qx.promise.NativeWrapper.__P_84_3(this.__P_84_0.then(onResolved, onRejected)).__P_84_2(this.__P_84_1);
      },
      /**
       * Same as for Native Promise
       * @returns {qx.promise.NativeWrapper}
       */
        ...
        handler = handler.bind(this.__P_84_1);
        return qx.promise.NativeWrapper.__P_84_3(this.__P_84_0.catch(handler)).__P_84_2(this.__P_84_1);
      },
      /**
       * Same as for Native Promise
       * @returns {qx.promise.NativeWrapper}
       ...
       */
        ...
        handler = handler.bind(this.__P_84_1);
        return qx.promise.NativeWrapper.__P_84_3(this.__P_84_0.finally(handler)).__P_84_2(this.__P_84_1);
      },
      /**
    ...
    statics: {
       ...
       */
      resolve(value) {
        return qx.promise.NativeWrapper.__P_84_3(Promise.resolve(value));
      },
      /**
       ...
       */
      reject(reason) {
        return qx.promise.NativeWrapper.__P_84_3(Promise.reject(reason));
      },
      /**
       ...
       */
      all(iterable) {
        return qx.promise.NativeWrapper.resolve(iterable).then(iterable => qx.promise.NativeWrapper.__P_84_3(Promise.all(iterable)));
      },
      /**
       ...
       */
      method(cb) {
        return (...args) => new qx.promise.NativeWrapper(resolve => resolve(cb.call(this.__P_84_1, ...args)));
      },
      /**
