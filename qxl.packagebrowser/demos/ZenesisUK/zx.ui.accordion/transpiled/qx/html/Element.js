  ...
  qx.Class.define("qx.html.Element", {
    ...
    */
    ...
    construct(tagName, styles, attributes) {
      ...
      this.__P_58_0 = styles || null;
      this.__P_58_1 = attributes || null;
      this.__P_58_2 = new Map();
      if (attributes) {
    ...
    */
    ...
    statics: {
      ...
      */
       ...
       */
      _scheduleFlush(job) {
        qx.html.Element.__P_58_6.schedule();
      },
      /**
        ...
        }
        {
          ...
          for (var hc in scroll) {
            ...
            if (elem && elem.offsetWidth) {
              ...
              // ScrollToX
              if (obj.__P_58_10 != null) {
                obj._domNode.scrollLeft = obj.__P_58_10;
                delete obj.__P_58_10;
              }

              // ScrollToY
              if (obj.__P_58_11 != null) {
                obj._domNode.scrollTop = obj.__P_58_11;
                delete obj.__P_58_11;
              }

              // ScrollIntoViewX
              var intoViewX = obj.__P_58_12;
              if (intoViewX != null) {
      ...
      __P_58_7() {
        {
          if (!this.__P_58_4) {
            ...
            this.__P_58_4 = eventManager.getHandler(qx.event.handler.Focus);
          }
      ...
      __P_58_9() {
        {
          if (!this.__P_58_5) {
            var eventManager = qx.event.Registration.getManager(window);
            this.__P_58_5 = eventManager.getDispatcher(qx.event.dispatch.MouseCapture);
          }
          return this.__P_58_5.getCaptureElement();
        }
      },
      /**
    ...
    */
    ...
    members: {
      ...
      */
      ...
      _serializeImpl(serializer) {
        ...
        // Copy attributes
        if (this.__P_58_1) {
          for (var key in this.__P_58_1) {
            let result = qx.bom.element.Attribute.serialize(key, this.__P_58_1[key]);
      ...
      */
      ...
      hasSlots(projection) {
        if (projection === null || projection === undefined) {
          return this.__P_58_2.size > 0;
        }
        if (projection === true || projection === qx.html.Slot.DEFAULT) {
          return this.__P_58_2.has(qx.html.Slot.DEFAULT);
        }
        if (typeof projection === "string") {
          return this.__P_58_2.has(projection);
        }
      ...
      inject(childNode, slotNameOverride) {
        ...
        const slotName = (_ref = (_childNode$getAttribu = (_childNode$getAttribu2 = childNode.getAttribute) === null || _childNode$getAttribu2 === void 0 ? void 0 : _childNode$getAttribu2.call(childNode, "slot")) !== null && _childNode$getAttribu !== void 0 ? _childNode$getAttribu : slotNameOverride) !== null && _ref !== void 0 ? _ref : qx.html.Slot.DEFAULT;
        if (!this.__P_58_18(slotName)) {
          return;
        }
        this.__P_58_2.get(slotName).add(childNode);

        // Chaining support
        return this;
      },
      __P_58_19(element) {
        var _element$getIsCustomE, _element$getChildren;
        ...
        (_element$getChildren = element.getChildren()) === null || _element$getChildren === void 0 || _element$getChildren.forEach(child => slots.push(...this.__P_58_19(child)));
        return slots;
      },
      _slotScanAdd(element) {
        for (const slot of this.__P_58_19(element)) {
          this.__P_58_2.set(slot.getName(), slot);
        }
      },
      _slotScanRemove(child) {
        for (const slot of this.__P_58_19(child)) {
          this.__P_58_2.delete(slot.getName());
        }
      },
      /*
      ---------------------------------------------------------------------------
      ...
      */
       ...
       */
      setRoot(root) {
        if (root && !this.__P_58_14) {
          qx.html.Element._hasRoots++;
        } else if (!root && this.__P_58_14) {
          qx.html.Element._hasRoots--;
        }
        this.__P_58_14 = root;
      },
      ...
      */
      ...
      disableScrolling() {
        ...
        this.scrollToX(0);
        this.scrollToY(0);
        this.addListener("scroll", this.__P_58_20, this);
      },
      /**
       * Re-enables browser-native scrolling
       */
      enableScrolling() {
        this.removeListener("scroll", this.__P_58_20, this);
      },
      __P_58_21: null,
      /**
      ...
      */
      ...
      setTextSelection(start, end) {
        ...
        qx.html.Element.__P_58_3[this.toHashCode()] = {
          element: this,
          start: start,
          end: end
        };
      ...
      clearTextSelection() {
        ...
        delete qx.html.Element.__P_58_3[this.toHashCode()];
      },
      /*
      ---------------------------------------------------------------------------
      ...
      */
      ...
      capture(containerCapture) {
        {
          this.__P_58_22("capture", [containerCapture !== false]);
        }
      },
      /**
      ...
      */
      ...
      setStyle(key, value, direct) {
        ...
        if (this.__P_58_0[key] == value) {
          return this;
        }
        this._applyStyle(key, value, this.__P_58_0[key]);
        if (value == null) {
          delete this.__P_58_0[key];
        } else {
          this.__P_58_0[key] = value;
        }
       ...
       */
      getStyle(key) {
        return this.__P_58_0 ? this.__P_58_0[key] : null;
      },
      /**
      ...
      */
      ...
      addClass(name) {
        ...
        this.setAttribute("class", this.__P_58_24(classes));
        return this;
      },
      /**
      ...
      _applyIsCustomElement(value, oldValue) {
        ...
        (_this$getChildren = this.getChildren()) === null || _this$getChildren === void 0 || _this$getChildren.forEach(child => this._slotScanAdd(child));
      },
      /*
      ---------------------------------------------------------------------------
      ...
      */
      ...
      setAttribute(key, value, direct) {
        ...
        if (this.__P_58_1[key] == value) {
          return this;
        }
        if (value == null) {
          delete this.__P_58_1[key];
        } else {
          this.__P_58_1[key] = value;
        }
        if (key == "data-qx-object-id") {
       ...
       */
      getAttribute(key) {
        return this.__P_58_1 ? this.__P_58_1[key] : null;
      }
    },
    /*
     *****************************************************************************
    ...
    defer(statics) {
      statics.__P_58_6 = new qx.util.DeferredCall(statics.flush, statics);
    },
    /*
    *****************************************************************************
       DESTRUCT
    ...
    */
    ...
    destruct() {
      ...
      this.setRoot(false);
      this.__P_58_1 = this.__P_58_0 = this.__P_58_16 = this.__P_58_15 = this.__P_58_12 = this.__P_58_13 = null;
    }
  });
