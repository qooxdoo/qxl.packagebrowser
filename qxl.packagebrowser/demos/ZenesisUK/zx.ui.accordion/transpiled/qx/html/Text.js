  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.html.Text", {
    ...
    members: {
       ...
       */
      _createDomElement() {
        return window.document.createTextNode(this.__P_115_0 || "");
      },
      /*
       * @Override
       */
      ...
      _serializeImpl(serializer) {
        serializer.rawTextInBody(this.__P_115_0);
      },
      /**
       * @Override
       */
    ...
    defer(statics) {
      statics.__P_115_1 = new qx.util.DeferredCall(statics.flush, statics);
    },
    /*
     * ****************************************************************************
     * DESTRUCT
    ...
    destruct() {
      ...
      this.__P_115_2 = this.__P_115_3 = this.__P_115_4 = this.__P_115_5 = this.__P_115_6 = this.__P_115_7 = this.__P_115_8 = null;
    }
  });
