  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.html.Serializer", {
    ...
    members: {
       ...
       */
      __P_157_5() {
        return this.__P_157_2[this.__P_157_2.length - 1];
      },
      /**
      ...
      __P_157_4(closeTag) {
        ...
        if (!tagData.openTagWritten) {
          ...
          this.write(tmp.join(" "));
          if (closeTag) {
            if (qx.html.Serializer.__P_157_6[tagData.tagName]) {
              this.write("/>");
            } else {
       ...
       */
      peekQxObject() {
        return this.__P_157_1[this.__P_157_1.length - 1] || null;
      },
      /**
      ...
      getQxObjectIdFor(target) {
        ...
        if (stackTop === target) {
          const secondTop = this.__P_157_1.slice(-2)[0] || null;
        ...
        const stackFirst = this.__P_157_1[0];
        let tmp = target;
        do {
          const owner = tmp.getQxOwner();
          if (this.__P_157_1.indexOf(owner) < 0) {
            break;
    ...
    defer(statics) {
      ...
      ["area", "base", "br", "col", "embed", "hr", "img", "input", "link", "meta", "param", "source", "track", "wbr"].forEach(function (tagName) {
        statics.__P_157_6[tagName] = true;
      });
    }
  });
