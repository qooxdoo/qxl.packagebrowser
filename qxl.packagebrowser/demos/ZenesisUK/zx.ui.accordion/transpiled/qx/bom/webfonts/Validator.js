  ...
  qx.Class.define("qx.bom.webfonts.Validator", {
    ...
    */
    ...
    construct(fontFamily, comparisonString, fontWeight, fontStyle) {
      ...
      if (fontFamily) {
        ...
        this.__P_135_0 = this._getRequestedHelpers();
      }
      this.__P_135_1 = new qx.Promise();
    },
    /*
    *****************************************************************************
       STATICS
    ...
    */
    ...
    statics: {
      ...
      removeDefaultHelperElements() {
        var defaultHelpers = qx.bom.webfonts.Validator.__P_135_3;
        if (defaultHelpers) {
          for (var prop in defaultHelpers) {
            document.body.removeChild(defaultHelpers[prop]);
          }
        }
        delete qx.bom.webfonts.Validator.__P_135_3;
      }
    },
    /*
    *****************************************************************************
    ...
    */
    ...
    members: {
      ...
      */
      ...
      validate() {
        ...
        if (document.fonts && typeof document.fonts.load == "function") {
          this.__P_135_5 = new Date().getTime();
          ...
          const timerCheck = () => {
            if (this._isFontValid()) {
              ...
              if (now - this.__P_135_5 >= this.getTimeout()) {
                setValidImpl(false);
              }
            }
          };
          ...
          qx.event.Timer.once(() => {
            this.__P_135_4 = new qx.event.Timer(100);
            this.__P_135_4.addListener("interval", timerCheck);
            this.__P_135_4.start();
          }, this, 0);
        }
      },
      /**
      ...
      */
      ...
      _reset() {
        if (this.__P_135_0) {
          for (var prop in this.__P_135_0) {
            var elem = this.__P_135_0[prop];
       ...
       */
      _isFontValid() {
        if (!qx.bom.webfonts.Validator.__P_135_2) {
          this.__P_135_6();
        }
        if (!this.__P_135_0) {
          this.__P_135_0 = this._getRequestedHelpers();
        ...
        this.__P_135_0.sans.style.visibility = "visible";
        this.__P_135_0.sans.style.visibility = "hidden";
        this.__P_135_0.serif.style.visibility = "visible";
        this.__P_135_0.serif.style.visibility = "hidden";
        var requestedSans = qx.bom.element.Dimension.getWidth(this.__P_135_0.sans);
        var requestedSerif = qx.bom.element.Dimension.getWidth(this.__P_135_0.serif);
        var cls = qx.bom.webfonts.Validator;
        if (requestedSans !== cls.__P_135_2.sans || requestedSerif !== cls.__P_135_2.serif) {
          return true;
        }
        return false;
      },
      ...
      */
      ...
      __P_135_6() {
        ...
        cls.__P_135_2 = {
          sans: qx.bom.element.Dimension.getWidth(cls.__P_135_3.sans),
          serif: qx.bom.element.Dimension.getWidth(cls.__P_135_3.serif)
        };
      }
    },
    /*
    ...
    */
    ...
    destruct() {
      ...
      this._disposeObjects("__P_135_4");
    }
  });
