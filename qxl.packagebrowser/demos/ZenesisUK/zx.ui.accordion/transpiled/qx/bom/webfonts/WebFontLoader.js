    ...
    */
    ...
    members: {
      ...
      getValidator(fontWeight, fontStyle) {
        ...
        let validator = this.__P_77_0[id];
        if (!validator) {
          validator = this.__P_77_0[id] = new qx.bom.webfonts.Validator(this.getFontFamily(), this.getComparisonString(), fontWeight, fontStyle);
      ...
      async load() {
        (this.getCss() || []).forEach(url => {
          ...
          qx.bom.webfonts.WebFontLoader.__P_77_3(url);
        });
        ...
        if (fontFaces) {
          ...
          this.__P_77_1 = qx.lang.Array.clone(fontFaces);
          this.__P_77_2 = new qx.Promise();
        }
        this.__P_77_4();
      },
      async promiseLoaded() {
        return await this.__P_77_2;
      },
      /**
       * Adds the font faces in __fontFacesQueue
       */
      __P_77_4() {
        if (this.__P_77_1 == null) {
          return;
        }
        let fontFace = this.__P_77_1.pop();
        this.__P_77_5(fontFace);
        if (this.__P_77_1.length == 0) {
          this.__P_77_1 = null;
          this.__P_77_2.resolve(true);
        }
      ...
      __P_77_5(fontFace) {
        ...
        if (qx.bom.webfonts.WebFontLoader.__P_77_6[fontLookupKey]) {
          return;
        }
        if (!qx.bom.webfonts.WebFontLoader.__P_77_7) {
          let styleSheet = qx.bom.Stylesheet.createElement();
          qx.bom.webfonts.WebFontLoader.__P_77_7 = styleSheet;
        }
        let sourcesMap = {};
        ...
        rule = "@font-face {\n" + rule + "}\n";
        let styleSheet = qx.bom.webfonts.WebFontLoader.__P_77_7;
        try {
          if (qx.core.Environment.get("browser.name") == "ie" && qx.core.Environment.get("browser.documentmode") < 9) {
            let cssText = qx.bom.webfonts.WebFontLoader.__P_77_8(styleSheet.cssText);
            cssText += rule;
        ...
        qx.bom.webfonts.WebFontLoader.__P_77_6[fontLookupKey] = true;
      },
      // property apply
    ...
    statics: {
      ...
      getLoader(name, create) {
        let loader = qx.bom.webfonts.WebFontLoader.__P_77_11[name];
        if (!loader && create) {
          loader = qx.bom.webfonts.WebFontLoader.__P_77_11[name] = new qx.bom.webfonts.WebFontLoader(name);
        }
        return loader;
      },
      /**
       ...
       */
      __P_77_3(url) {
        if (qx.bom.webfonts.WebFontLoader.__P_77_10[url]) {
          return;
        }
        qx.bom.Stylesheet.includeFile(url);
        qx.bom.webfonts.WebFontLoader.__P_77_10[url] = true;
      },
      /**
       ...
       */
      getPreferredFormats() {
        if (qx.bom.webfonts.WebFontLoader.__P_77_9) {
          return qx.bom.webfonts.WebFontLoader.__P_77_9;
        }
        ...
        return qx.bom.webfonts.WebFontLoader.__P_77_9 = preferredFormats;
      },
      /**
