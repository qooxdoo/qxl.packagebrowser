  ...
  ************************************************************************ */
  ...
  qx.Bootstrap.define("qx.bom.element.AnimationHandle", {
    ...
    construct() {
      ...
      this.__P_166_0 = css && css["play-state"];
      this.__P_166_1 = true;
      this.addListenerOnce("end", this.__P_166_2, this);
    },
    events: {
    ...
    members: {
       ...
       */
      isPaused() {
        return this.el.style[this.__P_166_0] == "paused";
      },
      /**
      ...
      pause() {
        if (this.el) {
          this.el.style[this.__P_166_0] = "paused";
          this.el.$$animation.__P_166_1 = false;
      ...
      play() {
        if (this.el) {
          this.el.style[this.__P_166_0] = "running";
          this.el.$$animation.__P_166_1 = true;
          // in case the animation is based on JS
      ...
      stop() {
        if (this.el && qx.core.Environment.get("css.animation") && !this.jsAnimation) {
          this.el.style[this.__P_166_0] = "";
          this.el.style[qx.core.Environment.get("css.animation").name] = "";
          this.el.$$animation.__P_166_1 = false;
          this.el.$$animation.__P_166_3 = true;
        }
        // in case the animation is based on JS
