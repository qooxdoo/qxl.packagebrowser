    ...
    statics: {
      ...
      _animate(el, desc, duration, reverse) {
        ...
        if (this.__P_143_5 != null) {
          ...
          el.style[qx.lang.String.camelCase(this.__P_143_5["name"])] = style;
       ...
       * @param desc {Map} The description of the animation.
       */
      __P_143_12: qx.core.Environment.select("qx.debug", {
        true(desc) {
