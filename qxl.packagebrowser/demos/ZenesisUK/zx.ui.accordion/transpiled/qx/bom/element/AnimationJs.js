  ...
  ************************************************************************ */
  ...
  qx.Bootstrap.define("qx.bom.element.AnimationJs", {
    statics: {
       ...
       */
      __P_140_6(steps, stepTime, keys, keyFrames, duration, timing) {
       ...
       */
      __P_140_10(nextItem, lastItem, timing, x) {
