  ...
  ************************************************************************ */
  ...
  qx.Bootstrap.define("qx.bom.element.AnimationJs", {
    statics: {
       ...
       */
      __P_144_6(steps, stepTime, keys, keyFrames, duration, timing) {
       ...
       */
      __P_144_10(nextItem, lastItem, timing, x) {
