    ...
    statics: {
      ...
      create(content, html, win) {
        ...
        if (!qx.core.Environment.get("css.textoverflow") && qx.core.Environment.get("html.xul")) {
          ...
          qx.bom.element.Style.setStyles(el, this.__P_30_4(html));
        }
        if (content) {
      ...
      setValue(element, value) {
        value = value || "";
        if (element.useHtml) {
          if (qx.bom.Label.__P_30_5 && typeof qx.bom.Label.__P_30_5 === "function") {
            value = qx.bom.Label.__P_30_5(value);
          }
      ...
      getHtmlSize(content, styles, width) {
        var element = this._htmlElement || this.__P_30_3();

        // apply width
        element.style.width = width != undefined ? width + "px" : "auto";
        // insert content
        element.innerHTML = content;
        return this.__P_30_6(element, styles);
      },
      /**
      ...
      getTextSize(text, styles) {
        var element = this._textElement || this.__P_30_1();
        if (!qx.core.Environment.get("css.textoverflow") && qx.core.Environment.get("html.xul")) {
