  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.theme.manager.Decoration", {
    ...
    construct() {
      ...
      this.__P_21_0 = [];
      this.__P_21_1 = qx.core.Environment.get("engine.name") == "mshtml" && qx.core.Environment.get("browser.documentmode") < 9;
    },
    /*
    *****************************************************************************
       PROPERTIES
    ...
    */
    ...
    members: {
      ...
      addCssClass(value) {
        ...
        Object.keys(styles).sort().forEach(function (key) {
          ...
          if (qx.Bootstrap.isObject(styles[key])) {
            ...
            var innerSelector = this.__P_21_1 ? selector : selector + (inner ? ":" : "");
            this.__P_21_0.push(innerSelector + key);
       ...
       */
      isCached(decorator) {
        return !this.__P_21_2 ? false : qx.lang.Object.contains(this.__P_21_2, decorator);
      },
      // property apply
