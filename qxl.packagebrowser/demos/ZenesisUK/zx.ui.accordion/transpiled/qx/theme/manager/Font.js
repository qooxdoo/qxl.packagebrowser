    ...
    members: {
      ...
      resolve(value) {
        ...
        if (theme !== null && theme.fonts[value]) {
          let createdFonts = this.__P_26_0(theme.fonts);
      ...
      isDynamic(value) {
        ...
        if (theme !== null && value && theme.fonts[value]) {
          var fontClass = this.__P_26_1(theme.fonts[value]);
      ...
      __P_26_0(fontDefs) {
        ...
        for (var fontId in fontDefs) {
          ...
          var fontClass = this.__P_26_1(fontDef);
          var font = new fontClass();
      ...
      _applyTheme(value) {
        ...
        if (value) {
          ...
          createdFonts = this.__P_26_0(fonts);
        }
