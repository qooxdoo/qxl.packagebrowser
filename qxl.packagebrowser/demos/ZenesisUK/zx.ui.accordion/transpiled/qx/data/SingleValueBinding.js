  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.data.SingleValueBinding", {
    statics: {
       ...
       */
      __P_118_2(sourceObject, sourcePropertyChain, targetObject, targetPropertyChain, options) {
        // get the property names
       ...
       */
      __P_118_10(targetObject, targetPropertyChain) {
       ...
       */
      __P_118_9(targetObject, targetPropertyChain, value) {
        // get the last target object of the chain
        var properties = this.__P_118_12(targetPropertyChain);
        var target = this.__P_118_13(targetObject, properties);
        if (target) {
       ...
       */
      __P_118_12(targetPropertyChain) {
       ...
       *   should be set.
       */
      __P_118_13(targetObject, targetProperties, index) {
       ...
       */
      __P_118_5(value, targetObject, targetPropertyChain, options, sourceObject) {
       ...
       *   property.
       */
      __P_118_6(sourceObject, sourceEvent, targetObject, targetProperty, options, arrayIndex) {
        // checks
       ...
       *   object.
       */
      __P_118_8(id, sourceObject, sourceEvent, targetObject, targetProperty) {
        var hash;
       ...
       */
      __P_118_11(value, targetObject, targetPropertyChain, options, sourceObject) {
       ...
       */
      __P_118_14(sourceObject, sourceProperty) {
        // get the event name
