  ...
  ************************************************************************ */
  ...
  qx.Bootstrap.define("qx.event.handler.GestureCore", {
    ...
    members: {
       ...
       */
      __P_148_22(deltaX, deltaY, domEvent, target, time) {
       ...
       * @param target {Element} event target
       */
      __P_148_19(type, domEvent, target) {
       ...
       */
      __P_148_25(domEvent, target, rollFactor) {
        domEvent.delta = {
