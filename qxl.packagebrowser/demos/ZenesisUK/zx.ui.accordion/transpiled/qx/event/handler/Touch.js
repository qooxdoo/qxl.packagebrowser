  ...
  qx.Class.define("qx.event.handler.Touch", {
    ...
    */
    ...
    construct(manager) {
      ...
      qx.event.handler.TouchCore.apply(this, [this.__P_155_2]);
    },
    /*
    *****************************************************************************
       STATICS
    ...
    members: {
      ...
      */
      ...
      _fireEvent(domEvent, type, target, eventTypeClass) {
        ...
        qx.event.Registration.fireEvent(this.__P_155_1, "useraction", qx.event.type.Data, [type]);
      },
      /*
      ---------------------------------------------------------------------------
