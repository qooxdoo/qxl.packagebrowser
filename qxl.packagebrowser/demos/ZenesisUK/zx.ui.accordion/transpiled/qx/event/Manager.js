    ...
    members: {
      ...
      */
      ...
      getListeners(target, type, capture) {
        ...
        var targetMap = this.__P_88_3.get(targetKey);
        if (!targetMap) {
          return null;
        }
       ...
       */
      getAllListeners() {
        return Object.fromEntries(this.__P_88_3.entries().map(([targetKey, targetMap]) => [targetKey, Object.fromEntries(targetMap.entries().map(([entryKey, entryMap]) => {
          var listeners = [...entryMap.values()];
      ...
      importListeners(target, list) {
        ...
        if (!targetMap) {
          targetMap = new Map();
          this.__P_88_3.set(targetKey, targetMap);
        }
      ...
      removeAllListeners(target) {
        ...
        this.__P_88_3.delete(targetKey);
        return true;
      },
      /**
      ...
      */
      ...
      dispose() {
        ...
        qx.util.DisposeUtil.disposeMap(this, "__P_88_5");
