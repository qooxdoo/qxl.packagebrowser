  ...
  qx.Bootstrap.define("qx.bom.client.Engine", {
    ...
    statics: {
      ...
      getVersion: function getVersion() {
        ...
        var version = "";
        if (qx.bom.client.Engine.__P_78_0()) {
        ...
        } else if (qx.bom.client.Engine.__P_78_1()) {
        ...
        } else if (qx.bom.client.Engine.__P_78_2()) {
        ...
        } else if (qx.bom.client.Engine.__P_78_3()) {
      ...
      __P_78_0: function __P_78_0() {
        ...
        if (qx.bom.client.Engine.__P_78_4()) {
          return true;
        }
        return false;
      },
