  ...
  qx.Class.define("qx.data.marshal.Json", {
    ...
    statics: {
      ...
      checkIfWarnAboutNotBreakingOnNonPojos: function checkIfWarnAboutNotBreakingOnNonPojos() {
        if (!qx.core.Environment.get("qx.data.marshal.Json.breakOnNonPojos") && !this.__P_125_1) {
    ...
    members: {
       ...
       */
      __P_125_2: function __P_125_2(data, includeBubbleEvents) {
        if (this.__P_125_0 && this.__P_125_0.getJsonHash) {
          return this.__P_125_0.getJsonHash(data, includeBubbleEvents);
        }
        return Object.keys(data).sort().join("|") + (includeBubbleEvents === true ? "♥" : "");
      },
      /**
       ...
       * @return {String} The hash representation of the given JavaScript object.
       */
      __P_125_3: function __P_125_3(data, includeBubbleEvents) {
        // forced mode?
        //
        if (includeBubbleEvents === true) {
          return this.__P_125_2(data, true);
        }
        if (includeBubbleEvents === false) {
          return this.__P_125_2(data, false);
        }

        // automatic mode!
        //
        var hash = this.__P_125_2(data); // without bubble event feature
      ...
      toClass: function toClass(data, includeBubbleEvents) {
        this.__P_125_4(data, includeBubbleEvents, null, 0);
      },
      /**
       ...
       */
      __P_125_4: function __P_125_4(data, includeBubbleEvents, parentProperty, depth) {
        ...
        if (shouldBreak) {
          ...
          if (data instanceof Array || qx.Bootstrap.getClass(data) == "Array") {
            for (var i = 0; i < data.length; i++) {
              this.__P_125_4(data[i], includeBubbleEvents, parentProperty + "[" + i + "]", depth + 1);
            }
          }
        ...
        var hash = this.__P_125_2(data, includeBubbleEvents);

        // ignore rules
        if (this.__P_125_5(hash, parentProperty, depth)) {
          return;
        }

        // check for the possible child classes
        for (var key in data) {
          this.__P_125_4(data[key], includeBubbleEvents, key, depth + 1);
        }
        ...
        if (this.__P_125_0 && this.__P_125_0.getModelClass && this.__P_125_0.getModelClass(hash, data, parentProperty, depth) != null) {
          return;
        }
        ...
        var members = {
          __P_125_6: this.__P_125_6
        };
        for (var key in data) {
          // apply the property names mapping
          if (this.__P_125_0 && this.__P_125_0.getPropertyMapping) {
            key = this.__P_125_0.getPropertyMapping(key, hash);
          }
          ...
          // validation rules
          if (this.__P_125_0 && this.__P_125_0.getValidationRule) {
            var rule = this.__P_125_0.getValidationRule(hash, key);
            if (rule) {
        ...
        if (this.__P_125_0 && this.__P_125_0.getModelSuperClass) {
          var superClass = this.__P_125_0.getModelSuperClass(hash, parentProperty, depth) || qx.core.Object;
        } else {
        ...
        var mixins = [];
        if (this.__P_125_0 && this.__P_125_0.getModelMixins) {
          var delegateMixins = this.__P_125_0.getModelMixins(hash, parentProperty, depth);
       ...
       */
      __P_125_6: function __P_125_6(item) {
       ...
       * @return {qx.core.Object} An instance of the corresponding class.
       */
      __P_125_7: function __P_125_7(hash, data, parentProperty, depth) {
        var delegateClass;
        // get the class from the delegate
        if (this.__P_125_0 && this.__P_125_0.getModelClass) {
          delegateClass = this.__P_125_0.getModelClass(hash, data, parentProperty, depth);
        }
       ...
       */
      __P_125_5: function __P_125_5(hash, parentProperty, depth) {
        var del = this.__P_125_0;
      ...
      toModel: function toModel(data, includeBubbleEvents) {
        return this.__P_125_8(data, includeBubbleEvents, null, 0);
      },
      /**
       ...
       * @return {qx.core.Object} The created model object.
       */
      __P_125_8: function __P_125_8(data, includeBubbleEvents, parentProperty, depth) {
        var breakOnNonPojos = qx.core.Environment.get("qx.data.marshal.Json.breakOnNonPojos");
        this.constructor.checkIfWarnAboutNotBreakingOnNonPojos();
        ...
        if (shouldBreak) {
          ...
          // ignore rules
        } else if (this.__P_125_5(this.__P_125_3(data, includeBubbleEvents), parentProperty, depth)) {
          return data;
        } else if (isArray) {
          var arrayClass = qx.data.Array;
          if (this.__P_125_0 && this.__P_125_0.getArrayClass) {
            var customArrayClass = this.__P_125_0.getArrayClass(parentProperty, depth);
          ...
          for (var i = 0; i < data.length; i++) {
            array.push(this.__P_125_8(data[i], includeBubbleEvents, parentProperty + "[" + i + "]", depth + 1));
          }
          return array;
        } else if (breakOnNonPojos ? isPojo : isObject) {
          // create an instance for the object
          var hash = this.__P_125_3(data, includeBubbleEvents);
          var model = this.__P_125_7(hash, data, parentProperty, depth);
          ...
          for (var key in data) {
            ...
            if (this.__P_125_0 && this.__P_125_0.getPropertyMapping) {
              propertyName = this.__P_125_0.getPropertyMapping(key, hash);
            }
            ...
            if (model[setterName]) {
              model[setterName](this.__P_125_8(data[key], includeBubbleEvents, key, depth + 1));
            }
          }
          return model;
        }
