  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.ui.form.core.VirtualDropDownList", {
    ...
    construct: function construct(target) {
      ...
      this.addListener("changeVisibility", this.__P_275_0, this);
      this.__P_275_1 = new qx.data.Array();
      this.initSelection(this.__P_275_1);
    },
    properties: {
      // overridden
      autoHide: {
    ...
    members: {
      ...
      */
      ...
      setPreselected: function setPreselected(modelItem) {
        ...
        this.__P_275_5(helper, listSelection);
        helper.dispose();
        this.__P_275_3 = false;
      },
      /*
      ---------------------------------------------------------------------------
        INTERNAL API
      ...
      */
       ...
       */
      __P_275_7: function __P_275_7(event) {
        if (this.__P_275_2) {
          return;
        }
        ...
        var listSelection = this.getChildControl("list").getSelection();
        this.__P_275_3 = true;
        this.__P_275_5(selection, listSelection);
        this.__P_275_3 = false;
        this.__P_275_2 = true;
        this.__P_275_5(listSelection, selection);
      ...
      _onListChangeSelection: function _onListChangeSelection(event) {
        ...
        if (this.isVisible()) {
          ...
          this.__P_275_2 = true;
          this.__P_275_5(listSelection, this.getSelection());
          this.__P_275_2 = false;
        }
      },
      /**
       ...
       */
      __P_275_0: function __P_275_0(event) {
        if (this.isVisible()) {
      ...
      */
      ...
      _applySelection: function _applySelection(value, old) {
        value.addListener("change", this.__P_275_7, this);
        if (old != null) {
          old.removeListener("change", this.__P_275_7, this);
        }
        this.__P_275_5(value, this.getChildControl("list").getSelection(value));
      },
      /*
      ---------------------------------------------------------------------------
        HELPER METHODS
      ...
      */
       ...
       */
      __P_275_5: function __P_275_5(source, target) {
      ...
      _adjustWidth: function _adjustWidth() {
        ...
        if (this.getAllowGrowDropDown()) {
          ...
          this.setWidth(null);
          if (this.__P_275_4 > 0) {
            uiList.setWidth(this.__P_275_4);
          } else {
      ...
      _getMaxListItemWidth: function _getMaxListItemWidth() {
        return this.__P_275_4;
      }
    },
    destruct: function destruct() {
      if (this.__P_275_1) {
        this.__P_275_1.dispose();
      }
    }
  });
