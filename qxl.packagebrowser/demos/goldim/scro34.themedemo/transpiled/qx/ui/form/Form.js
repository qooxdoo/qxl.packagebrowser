  ...
  qx.Class.define("qx.ui.form.Form", {
    ...
    members: {
      ...
      */
      ...
      add: function add(item, label, validator, name, validatorContext, options) {
        ...
        this.__P_101_0[this._groupCounter].items.push(item);
        this.__P_101_0[this._groupCounter].labels.push(label);
        this.__P_101_0[this._groupCounter].options.push(options);
        // if no name is given, use the label without not working character
        if (name == null) {
          name = label.replace(/\s+|&|-|\+|\*|\/|\||!|\.|,|:|\?|;|~|%|\{|\}|\(|\)|\[|\]|<|>|=|\^|@|\\/g, "");
        }
        this.__P_101_0[this._groupCounter].names.push(name);
      ...
      __P_101_1: function __P_101_1() {
        return this.__P_101_0.length === 0;
      },
      /*
      ---------------------------------------------------------------------------
         REMOVE
          ...
          if (group.title === title) {
            ...
            if (i == 0) {
              ...
              if (this.__P_101_0.length == 1) {
                ...
                // add to the next
                targetGroup = this.__P_101_0[i + 1];
              }
            } else {
    ...
    */
    destruct: function destruct() {
      ...
      this.__P_101_0 = this._buttons = this._buttonOptions = null;
