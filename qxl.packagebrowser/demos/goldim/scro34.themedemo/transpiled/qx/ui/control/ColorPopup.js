  ...
  qx.Class.define("qx.ui.control.ColorPopup", {
    ...
    members: {
      ...
      */
      ...
      _createBoxes: function _createBoxes() {
        ...
        for (var tableId in tables) {
          ...
          this.__P_23_1[tableId] = box;
          this.add(box);
          for (var i = 0; i < this.__P_23_6; i++) {
      ...
      _createColorSelector: function _createColorSelector() {
        ...
        win.moveTo(20, 20);
        this.__P_23_3 = new qx.ui.control.ColorSelector();
        win.add(this.__P_23_3);
        this.__P_23_4 = new qx.ui.container.Composite(new qx.ui.layout.HBox(8, "right"));
        win.add(this.__P_23_4);
        ...
        this.__P_23_4.add(btnCancel);
        this.__P_23_4.add(btnOk);
      },
      /*
      ---------------------------------------------------------------------------
        APPLY ROUTINES
      ...
      */
      ...
      _rotatePreviousColors: function _rotatePreviousColors() {
        ...
        var vRecentTable = this._tables[this.__P_23_5].values;
        var vRecentBox = this.__P_23_1[this.__P_23_5];
        if (!vRecentTable) {
          return;
        }
        ...
        } else if (vRecentTable.length == this.__P_23_6) {
          vRecentTable.shift();
        }
      ...
      */
      ...
      _onSelectorButtonExecute: function _onSelectorButtonExecute() {
        ...
        this.__P_23_3.setRed(red);
        this.__P_23_3.setGreen(green);
        this.__P_23_3.setBlue(blue);
        this.__P_23_2.open();
      },
      /**
    ...
    */
    destruct: function destruct() {
      if (this.__P_23_2) {
        this.__P_23_2.destroy();
        this.__P_23_3.destroy();
        this.__P_23_4.destroy();
      }
      this._tables = this.__P_23_1 = null;
    }
  });
