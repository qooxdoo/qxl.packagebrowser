    ...
    members: {
      ...
      setColumnEditable: function setColumnEditable(columnIndex, editable) {
        if (editable != this.isColumnEditable(columnIndex)) {
          if (this.__P_171_0 == null) {
            this.__P_171_0 = [];
          }
          this.__P_171_0[columnIndex] = editable;
          this.fireEvent("metaDataChanged");
        }
      },
      // overridden
      isColumnEditable: function isColumnEditable(columnIndex) {
        if (columnIndex == this._treeColumn) {
          return this.__P_171_1.getAllowNodeEdit();
        }
        return this.__P_171_0 ? this.__P_171_0[columnIndex] == true : false;
      },
      // overridden
      ...
      setValue: function setValue(columnIndex, rowIndex, value) {
        ...
        if (columnIndex === this._treeColumn) {
          if (!this.__P_171_1.getAllowNodeEdit() || value["label"] === undefined) {
            return;
          }
       ...
       */
      __P_171_4: function __P_171_4(nodeId, level) {
        ...
        var index = 0;
        var children = this.__P_171_2[nodeId] = [];
        for (var i = 0; i < numChildren; i++) {
          ...
          if (!this.__P_171_3) {
            this.__P_171_5(child, i == numChildren - 1);
          }
          ...
          if (child.bOpened) {
            ...
            this.__P_171_4(childNodeId, level + 1);
          }
          index++;
        }
      },
       ...
       *   {@link #addLeaf}.
       */
      __P_171_6: function __P_171_6(nodeId) {
        var tempTreeData = this.__P_171_2;
       ...
       */
      __P_171_5: function __P_171_5(node, isLastChild) {
      ...
      isNodeEditable: function isNodeEditable(rowIndex) {
        return this.__P_171_1.getAllowNodeEdit() && this.getNodeFromRow(rowIndex).bCanEdit;
      }
    },
    destruct: function destruct() {
      this._rowArr = this._nodeArr = this._nodeRowMap = this._selections = this.__P_171_1 = this.__P_171_2 = null;
    },
