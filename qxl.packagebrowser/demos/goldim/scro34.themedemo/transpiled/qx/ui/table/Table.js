  ...
  qx.Class.define("qx.ui.table.Table", {
    ...
    */
    ...
    members: {
      ...
      getEmptyTableModel: function getEmptyTableModel() {
        if (!this.__P_40_11) {
          this.__P_40_11 = new qx.ui.table.model.Simple();
          this.__P_40_11.setColumns([]);
          this.__P_40_11.setData([]);
        }
      ...
      getTableColumnModel: function getTableColumnModel() {
        if (!this.__P_40_10) {
          var columnModel = this.__P_40_10 = this.getNewTableColumnModel()(this);
      ...
      _updateTableData: function _updateTableData(firstRow, lastRow, firstColumn, lastColumn, removeStart, removeCount) {
        ...
        if (colCount != this.__P_40_7) {
          this.__P_40_7 = colCount;
      ...
      _onColVisibilityChanged: function _onColVisibilityChanged(evt) {
        ...
        var data = evt.getData();
        if (this.__P_40_9 != null && data.col != null && data.visible != null) {
          this.__P_40_9[data.col].setColumnVisible(data.visible);
        }
        this._updateScrollerWidths();
        this._updateScrollBarVisibility();
      },
      ...
      _updateScrollBarVisibility: function _updateScrollBarVisibility() {
        ...
        for (var i = 0; i < scrollerArr.length; i++) {
          ...
          if (isLast) {
            ...
            if (this.__P_40_12 == null) {
              this.__P_40_12 = scrollerArr[i].getVerticalScrollBarVisible();
              this.__P_40_13 = qx.event.Timer.once(function () {
          ...
          // has changed...
          if (isLast && verNeeded != this.__P_40_12) {
    ...
    */
    destruct: function destruct() {
      ...
      this._disposeObjects("__P_40_1", "__P_40_0", "__P_40_11", "__P_40_11", "__P_40_10", "__P_40_13");
      this._disposeMap("__P_40_9");
    }
  });
