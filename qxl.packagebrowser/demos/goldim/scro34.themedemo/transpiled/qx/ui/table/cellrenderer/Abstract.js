  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.ui.table.cellrenderer.Abstract", {
    ...
    construct: function construct() {
      ...
      if (!cr.__P_248_0) {
        cr.__P_248_0 = qx.ui.table.cellrenderer.Abstract;
        this._createStyleSheet();

        // add dynamic theme listener
        {
          this.__P_248_1 = qx.theme.manager.Meta.getInstance().addListener("changeTheme", this._onChangeTheme, this);
        }
      }
    },
    properties: {
    ...
    members: {
      ...
      _onChangeTheme: qx.core.Environment.select("qx.dyntheme", {
        "true": function _true() {
          qx.bom.Stylesheet.removeAllRules(qx.ui.table.cellrenderer.Abstract.__P_248_0.stylesheet);
          this._createStyleSheet();
        },
        "false": null
      }),
      ...
      _createStyleSheet: function _createStyleSheet() {
        ...
        qx.ui.table.cellrenderer.Abstract.__P_248_0.stylesheet = qx.bom.Stylesheet.createElement(stylesheet);
      },
      /**
    ...
    destruct: function destruct() {
      ...
      if (true && this.__P_248_1) {
        qx.theme.manager.Meta.getInstance().removeListenerById(this.__P_248_1);
      }
    }
  });
