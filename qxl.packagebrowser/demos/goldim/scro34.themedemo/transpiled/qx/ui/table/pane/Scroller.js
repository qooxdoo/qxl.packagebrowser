  ...
  qx.Class.define("qx.ui.table.pane.Scroller", {
    ...
    */
    ...
    construct: function construct(table) {
      ...
      this.__P_156_2 = this._showChildControl("pane");
      ...
      this.__P_156_6 = this._showChildControl("scrollbar-y");

      // init focus indicator
      this.__P_156_7 = this.getChildControl("focus-indicator");
    ...
    */
    ...
    members: {
      ...
      _onRoll: function _onRoll(e) {
        ...
        var scrolled = delta.y != 0 && !this.__P_156_29(this.__P_156_6, delta.y);
        ...
        this.__P_156_5.scrollBy(parseInt(delta.x, 10));

        // Update the focus
        if (this.__P_156_21 && this.getFocusCellOnPointerMove()) {
          this._focusCellAtPagePos(this.__P_156_21, this.__P_156_22);
        }
        scrolled = scrolled || delta.x != 0 && !this.__P_156_29(this.__P_156_5, delta.x);
      ...
      __P_156_31: function __P_156_31(pageX) {
        ...
        if (this.__P_156_1.isShowingColumnMoveFeedback() || pageX > this.__P_156_14 + tapTolerance || pageX < this.__P_156_14 - tapTolerance) {
          ...
          this.__P_156_1.showColumnMoveFeedback(this._moveColumn, this.__P_156_13);
      ...
      startEditing: function startEditing() {
        ...
        if (!this.isEditing() && col != null && tableModel.isColumnEditable(col)) {
          ...
          // Get a cell editor
          this._cellEditor = this.__P_156_25.createCellEditor(cellInfo);
          ...
          if (this._cellEditor === null) {
            ...
            this.__P_156_27 = this.__P_156_7.addListener("pointerdown", function (e) {
              _this.__P_156_18 = {
                row: _this.__P_156_24,
                col: _this.__P_156_23
              };
              e.stopPropagation();
            });
            ...
            this.__P_156_7.setKeepActive(false);
      ...
      _getRowForPagePos: function _getRowForPagePos(pageX, pageY) {
        ...
        if (pageY >= panePos.top && pageY <= panePos.bottom) {
          ...
          var rowHeight = this.__P_156_2.getRenderedRowHeight();
