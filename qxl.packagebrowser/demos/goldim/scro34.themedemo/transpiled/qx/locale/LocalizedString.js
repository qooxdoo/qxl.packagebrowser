  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.locale.LocalizedString", {
    ...
    construct: function construct(translation, messageId, args, localized) {
      ...
      this.__P_196_0 = messageId;
      this.__P_196_1 = !!localized;
      this.__P_196_2 = args;
    },
    members: {
      __P_196_1: null,
      ...
      translate: function translate() {
        if (this.__P_196_1) {
          return qx.locale.Manager.getInstance().localize(this.__P_196_0, this.__P_196_2);
        }
        return qx.locale.Manager.getInstance().translate(this.__P_196_0, this.__P_196_2);
      },
      /**
