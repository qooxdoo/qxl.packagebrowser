    ...
    statics: {
      ...
      */
      ...
      define: function define(name, config) {
        ...
        config.include = this.__P_14_0(config.include);
        config.patch = this.__P_14_0(config.patch);
        ...
        this.__P_14_1(theme, config);
        this.__P_14_2(theme, config);
       ...
       */
      __P_14_0: function __P_14_0(objectOrArray) {
        if (!objectOrArray) {
          return [];
        }
       ...
       * @param config {Map} config structure
       */
      __P_14_2: function __P_14_2(theme, config) {
      ...
      */
       ...
       */
      __P_14_3: function __P_14_3(config) {
        for (var i = 0, keys = this.__P_14_4, l = keys.length; i < l; i++) {
          if (config[keys[i]]) {
            return keys[i];
          }
        }
       ...
       */
      __P_14_1: function __P_14_1(theme, config) {
        var type = this.__P_14_3(config);
      ...
      __P_14_4: ["colors", "borders", "decorations", "fonts", "icons", "widgets", "appearances", "meta"],
      /** @type {Map} allowed keys in theme definition */
      __P_14_5: qx.core.Environment.select("qx.debug", {
        "true": {
          title: "string",
          // String
          aliases: "object",
      ...
      __P_14_6: qx.core.Environment.select("qx.debug", {
        "true": {
          color: "object",
          border: "object",
          decoration: "object",
       ...
       */
      __P_14_7: qx.core.Environment.select("qx.debug", {
        "true": function _true(name, config) {
          var allowed = this.__P_14_5;
      ...
      patch: function patch(theme, mixinTheme) {
        this.__P_14_8(mixinTheme);
        var type = this.__P_14_3(mixinTheme);
        if (type !== this.__P_14_3(theme)) {
       ...
       */
      __P_14_8: function __P_14_8(mixinTheme) {
