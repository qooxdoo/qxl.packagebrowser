  ...
  ************************************************************************ */
  ...
  qx.Class.define("scro34.themedemo.IconFactory", {
    ...
    construct: function construct() {
      this.__P_56_0 = new scro34.themedemo.Icons();
    },
    members: {
      __P_56_1: null,
      getIcon: function getIcon(name) {
        if (this.__P_56_1) {
          var icon = this.__P_56_1.getIcon(name);
          if (icon) {
            return icon;
          }
        }
        return this.__P_56_0.getIcon(name);
      },
      hasCustomIcon: function hasCustomIcon(name) {
        return this.__P_56_1 && this.__P_56_1.getIcon(name);
      },
