  ...
  ************************************************************************ */
  ...
  qx.Class.define("scro34.themedemo.PanelButton", {
    ...
    construct: function construct(options) {
      ...
      this.__P_253_0 = options.name;
      this.__P_253_1 = options.position;
      this.__P_253_2 = options.center;
    ...
    members: {
      ...
      __P_253_4: function __P_253_4() {
        var _this2 = this;
        this.window = scro34.themedemo.window.Factory.getWindow(this.__P_253_0);
        this.window.addListener("close", function () {
          _this2.setValue(false);
          _this2.fireEvent("windowClose");
        });
        scro34.themedemo.Desktop.getInstance().add(this.window, this.__P_253_1);
        if (this.__P_253_2) {
          this.window.center();
        }
      },
      __P_253_3: function __P_253_3(openFunc) {
        if (this.getValue()) {
          openFunc();
        } else {
