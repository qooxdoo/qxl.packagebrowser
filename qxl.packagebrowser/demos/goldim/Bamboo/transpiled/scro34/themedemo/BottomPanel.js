  ...
  ************************************************************************ */
  ...
  qx.Class.define("scro34.themedemo.BottomPanel", {
    ...
    construct: function construct(docHeight) {
      ...
      this.__P_16_0 = docHeight;
      this.setLayout(new qx.ui.layout.Canvas());
      var buttonPanel = this.__P_16_1 = new scro34.themedemo.ButtonPanel();
    ...
    members: {
      _onMouseMove: function _onMouseMove(e) {
        var docHeight = this.__P_16_0;
        var buttonDockHeight = this._computeSizeHint().height;
        var buttonPanel = this.__P_16_1;
      ...
      createVersionInfo: function createVersionInfo() {
        ...
        qooxdoo.addListener("click", function () {
          return _this.__P_16_1.pressButton("WebBrowser");
        });
        ...
        container.add(new qx.ui.basic.Label("7.9.3").set({
          font: "small"
        }));
        return container;
      }
