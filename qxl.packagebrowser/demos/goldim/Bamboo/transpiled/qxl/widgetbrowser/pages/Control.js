  ...
  ************************************************************************ */
  ...
  qx.Class.define("qxl.widgetbrowser.pages.Control", {
    ...
    construct: function construct() {
      ...
      this.__P_231_0 = new qx.ui.container.Composite(new qx.ui.layout.VBox(20));
    ...
    members: {
      ...
      initWidgets: function initWidgets() {
        ...
        this.__P_231_0.add(colorSelector);
        ...
        this.__P_231_0.add(label);
        this.__P_231_0.add(openColorPopup);
        ...
        this.__P_231_0.add(label);
        this.__P_231_0.add(dateChooser);
      }
    }
  });
