  ...
  ************************************************************************ */
  ...
  qx.Class.define("qxl.widgetbrowser.pages.Misc", {
    ...
    construct: function construct() {
      ...
      this.__P_234_0 = new qx.ui.container.Composite(new qx.ui.layout.VBox(10));
    ...
    members: {
      ...
      initWidgets: function initWidgets() {
        ...
        widgets.push(pb);
        this.__P_234_0.add(label);
        this.__P_234_0.add(pb);
        ...
        this.__P_234_0.add(label);
        this.__P_234_0.add(subcontainer);
