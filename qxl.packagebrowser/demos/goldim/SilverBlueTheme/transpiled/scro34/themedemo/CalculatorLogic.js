  ...
  qx.Class.define("scro34.themedemo.CalculatorLogic", {
    ...
    members: {
      ...
      setCurrentValue: function setCurrentValue(currentValue) {
        if (this.__P_198_6) {
          this.__P_198_7 *= 10;
          this.__P_198_0 = this.__P_198_0 + currentValue / this.__P_198_7;
          if (currentValue == 0) {
            this.__P_198_8++;
          }
        } else {
          this.__P_198_6 = false;
          if (this.__P_198_0 < 0) {
            this.__P_198_0 = this.__P_198_0 * 10 - currentValue;
          } else {
            this.__P_198_0 = this.__P_198_0 * 10 + currentValue;
          }
        }
      ...
      getResult: function getResult() {
        return Math.round(this.__P_198_1 * 10000000) / 10000000;
      },
      /**
       * sets the operator.
       *
      ...
      setSign: function setSign() {
        this.__P_198_10++;
        if (this.__P_198_10 % 2 == 0) {
          this.__P_198_9 = false;
        } else {
          this.__P_198_9 = true;
        }
        if (this.__P_198_0 == null) {
          this.__P_198_0 = this.__P_198_1;
        }
        this.__P_198_0 = this.__P_198_0 * -1;
        if (this.__P_198_1 == 0) {
          this.__P_198_1 = this.__P_198_0;
        }
        if (this.__P_198_1 != 0) {
          this.__P_198_4 = this.__P_198_1;
          this.__P_198_1 = this.__P_198_0;
      ...
      deleteNumber: function deleteNumber() {
        ...
        if (this.__P_198_0 != null) {
          if (this.__P_198_0.toString().lastIndexOf(".") != -1) {
            this.__P_198_0 = this.__P_198_0 * this.__P_198_7;
            isDecimal = true;
          }
        }
        var num1 = this.__P_198_0 % 10;
        var num2 = num1 / 10;
        this.__P_198_0 = this.__P_198_0 / 10;
        this.__P_198_0 = this.__P_198_0 - num2;
        if (isDecimal) {
          this.__P_198_7 /= 10;
          this.__P_198_0 = this.__P_198_0 / this.__P_198_7;
          isDecimal = false;
      ...
      calculate: function calculate(currentOperation) {
        if (currentOperation == "+" || currentOperation == "*" || currentOperation == "/" || currentOperation == "-" || currentOperation == "=") {
          ...
          if (this.__P_198_2 != "n") {
            if (this.__P_198_2 == "+") {
              if (this.__P_198_1 == null) {
                this.__P_198_1 = this.__P_198_4;
              }
              if (this.__P_198_9) {
                this.__P_198_1 = this.__P_198_4 + this.__P_198_0;
              } else {
                this.__P_198_1 = this.__P_198_1 + this.__P_198_0;
              }
              this.__P_198_0 = this.__P_198_1;
              this.__P_198_4 = this.__P_198_1;
            }
          ...
          if (currentOperation != "=") {
            this.__P_198_2 = currentOperation;
          } else {
            this.__P_198_3++;
            this.__P_198_1 = this.__P_198_4;
            this.__P_198_2 = "n";
