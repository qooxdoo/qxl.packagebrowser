  ...
  qx.Class.define("qx.event.Timer", {
    ...
    */
    statics: {
      ...
      once: function once(func, obj, timeout) {
        ...
        timer.__P_159_1 = func; // Add event listener to interval

        timer.addListener("interval", function (e) {
          timer.stop();
          func.call(obj, e);
          delete timer.__P_159_1;
          timer.dispose();
          obj = null;
    ...
    members: {
      ...
      */
      ...
      _applyEnabled: function _applyEnabled(value, old) {
        if (old) {
          window.clearInterval(this.__P_159_2);
          this.__P_159_2 = null;
        } else if (value) {
          this.__P_159_2 = window.setInterval(this.__P_159_0, this.getInterval());
        }
      },
    ...
    */
    destruct: function destruct() {
      ...
      this.__P_159_2 = this.__P_159_0 = null;
    }
  });
  qx.event.Timer.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=Timer.js.map?dt=1626056278861