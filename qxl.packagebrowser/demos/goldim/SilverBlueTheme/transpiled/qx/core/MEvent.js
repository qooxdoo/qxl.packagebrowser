  ...
  ************************************************************************ */
  ...
  qx.Mixin.define("qx.core.MEvent", {
    members: {
       ...
       */
      __P_66_3: function __P_66_3(result) {
        var _this = this;
        {
          ...
          var newPromise = result.then(function (result) {
            delete _this.__P_66_1[hashCode];
            var promise = _this.__P_66_2;
            if (promise && Object.keys(_this.__P_66_1).length == 0) {
              _this.__P_66_1 = null;
              _this.__P_66_2 = null;
              promise.resolve();
            }
        ...
        return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
          ...
          return _regeneratorRuntime().wrap(function _callee$(_context) {
            while (1) switch (_context.prev = _context.next) {
              ...
              case 2:
                if (!_this2.__P_66_2) {
                  _this2.__P_66_2 = new qx.Promise();
                }
                promise = _this2.__P_66_2;
                _context.next = 6;
                return promise;
              case 6:
              case "end":
