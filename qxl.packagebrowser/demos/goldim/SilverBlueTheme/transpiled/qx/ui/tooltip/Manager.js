  ...
  qx.Class.define("qx.ui.tooltip.Manager", {
    ...
    */
    construct: function construct() {
      ...
      // Register events
      qx.event.Registration.addListener(document.body, "pointerover", this.__P_58_0, this, true);

      // Instantiate timers
      this.__P_58_1 = new qx.event.Timer();
      this.__P_58_1.addListener("interval", this.__P_58_2, this);
      this.__P_58_3 = new qx.event.Timer();
      this.__P_58_3.addListener("interval", this.__P_58_4, this);
    ...
    members: {
      ...
      */
      ...
      _applyCurrent: function _applyCurrent(value, old) {
        ...
        if (value) {
          this.__P_58_1.startWith(value.getShowTimeout());
    ...
    */
    destruct: function destruct() {
      // Deregister events
      qx.event.Registration.removeListener(document.body, "pointerover", this.__P_58_0, this, true);
