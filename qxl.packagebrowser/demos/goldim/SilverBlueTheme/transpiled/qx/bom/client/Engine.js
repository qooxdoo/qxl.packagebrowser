  ...
  qx.Bootstrap.define("qx.bom.client.Engine", {
    ...
    statics: {
      ...
      getVersion: function getVersion() {
        ...
        if (qx.bom.client.Engine.__P_74_0()) {
        ...
        } else if (qx.bom.client.Engine.__P_74_1()) {
        ...
        } else if (qx.bom.client.Engine.__P_74_2()) {
        ...
        } else if (qx.bom.client.Engine.__P_74_3()) {
      ...
      __P_74_0: function __P_74_0() {
        ...
        if (qx.bom.client.Engine.__P_74_4()) {
          return true;
        }
...
//# sourceMappingURL=Engine.js.map?dt=1626056270646