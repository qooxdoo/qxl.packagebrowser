  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.util.placement.Placement", {
    ...
    construct: function construct() {
      ...
      this.__P_183_0 = qx.util.placement.DirectAxis;
    },
    properties: {
      /**
    ...
    statics: {
      ...
      compute: function compute(size, area, target, offsets, position, modeX, modeY) {
        this.__P_183_1 = this.__P_183_1 || new qx.util.placement.Placement();
        var splitted = position.split("-");
        var edge = splitted[0];
        var align = splitted[1];
        this.__P_183_1.set({
          axisX: this.__P_183_2(modeX),
          axisY: this.__P_183_2(modeY),
          edge: edge,
          align: align
        });
        return this.__P_183_1.compute(size, area, target, offsets);
      },
      __P_183_3: null,
      __P_183_4: null,
      __P_183_5: null,
       ...
       */
      __P_183_2: function __P_183_2(mode) {
        switch (mode) {
          case "direct":
            this.__P_183_3 = this.__P_183_3 || qx.util.placement.DirectAxis;
            return this.__P_183_3;
          case "keep-align":
            this.__P_183_4 = this.__P_183_4 || qx.util.placement.KeepAlignAxis;
            return this.__P_183_4;
          case "best-fit":
            this.__P_183_5 = this.__P_183_5 || qx.util.placement.BestFitAxis;
            return this.__P_183_5;
          default:
    ...
    members: {
      ...
      compute: function compute(size, area, target, offsets) {
        var axisX = this.getAxisX() || this.__P_183_0;
        ...
        }, area.width, this.__P_183_6());
        var axisY = this.getAxisY() || this.__P_183_0;
