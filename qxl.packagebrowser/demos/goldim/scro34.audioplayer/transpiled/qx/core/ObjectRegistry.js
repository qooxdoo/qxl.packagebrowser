    ...
    */
    ...
    statics: {
      ...
      createHashCode: function createHashCode() {
        var hash = String(this.__P_100_1++ + this.__P_100_2);
        return hash;
      },
      /**
      ...
      fromHashCode: function fromHashCode(hash, suppressWarnings) {
        var obj = this.__P_100_0[hash] || null;
