    ...
    */
    ...
    members: {
      ...
      getValidator: function getValidator(fontWeight, fontStyle) {
        ...
        var validator = this.__P_137_0[id];
        if (!validator) {
            ...
            while (1) switch (_context.prev = _context.next) {
              case 0:
                ...
                if (fontFaces) {
                  ...
                  _this.__P_137_1 = qx.lang.Array.clone(fontFaces);
                  _this.__P_137_2 = new qx.Promise();
                }
                _this.__P_137_4();
              case 4:
              case "end":
      ...
      __P_137_4: function __P_137_4() {
        ...
        var fontFace = this.__P_137_1.pop();
       ...
       * @returns
       */
      __P_137_5: function __P_137_5(fontFace) {
        ...
        if (!qx.bom.webfonts.WebFontLoader.__P_137_7) {
          ...
          qx.bom.webfonts.WebFontLoader.__P_137_7 = _styleSheet;
        }
        var sourcesMap = {};
        ...
        rule = "@font-face {\n" + rule + "}\n";
        var styleSheet = qx.bom.webfonts.WebFontLoader.__P_137_7;
        try {
          if (qx.core.Environment.get("browser.name") == "ie" && qx.core.Environment.get("browser.documentmode") < 9) {
            var cssText = qx.bom.webfonts.WebFontLoader.__P_137_8(styleSheet.cssText);
            cssText += rule;
    ...
    statics: {
      ...
      getLoader: function getLoader(name, create) {
        var loader = qx.bom.webfonts.WebFontLoader.__P_137_11[name];
        if (!loader && create) {
       ...
       * @param {String} url
       */
      __P_137_3: function __P_137_3(url) {
       ...
       */
      __P_137_12: function __P_137_12(sources) {
       ...
       */
      __P_137_8: function __P_137_8(cssText) {
