  ...
  qx.Bootstrap.define("qx.bom.client.Engine", {
    ...
    statics: {
      ...
      getVersion: function getVersion() {
        ...
        var version = "";
        if (qx.bom.client.Engine.__P_46_0()) {
        ...
        } else if (qx.bom.client.Engine.__P_46_1()) {
        ...
        } else if (qx.bom.client.Engine.__P_46_2()) {
        ...
        } else if (qx.bom.client.Engine.__P_46_3()) {
      ...
      __P_46_0: function __P_46_0() {
        ...
        if (qx.bom.client.Engine.__P_46_4()) {
          return true;
        }
        return false;
      },
