    ...
    members: {
      ...
      */
      ...
      __P_80_2: function __P_80_2() {
        ...
        if (!menuBounds) {
          this.addListenerOnce("resize", this.__P_80_2, this);
          return;
        }
      ...
      syncWidget: function syncWidget(jobs) {
        ...
        if (this.__P_80_1) {
          this.__P_80_1.call(this);
          delete this.__P_80_1;
        }
      },
      /*
      ---------------------------------------------------------------------------
