  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.ui.core.Blocker", {
    ...
    construct: function construct(widget) {
      ...
      this._widget = widget;
      widget.addListener("resize", this.__P_101_0, this);
      widget.addListener("move", this.__P_101_0, this);
      widget.addListener("disappear", this.__P_101_1, this);
      ...
      {
        this.__P_101_2 = qx.theme.manager.Meta.getInstance().addListener("changeTheme", this._onChangeTheme, this);
      }
      this.__P_101_3 = [];
      this.__P_101_4 = [];
    },
    ...
    */
    ...
    members: {
       ...
       */
      __P_101_0: function __P_101_0(e) {
        var data = e.getData();
        if (this.isBlocked()) {
      ...
      __P_101_1: function __P_101_1() {
        if (this.isBlocked()) {
          ...
          this._widget.addListenerOnce("appear", this.__P_101_10, this);
        }
      },
      /**
      ...
      _updateBlockerBounds: function _updateBlockerBounds(bounds) {
        ...
        var left = this.__P_101_7 ? 0 : bounds.left;
        var top = this.__P_101_7 ? 0 : bounds.top;
      ...
      _applyColor: function _applyColor(value, old) {
        ...
        this.__P_101_11("backgroundColor", color);
      },
      // property apply
      _applyOpacity: function _applyOpacity(value, old) {
        this.__P_101_11("opacity", value);
      },
      /**
       ...
       */
      __P_101_11: function __P_101_11(key, value) {
        var blockers = [];
        this.__P_101_5 && blockers.push(this.__P_101_5);
      ...
      _backupActiveWidget: function _backupActiveWidget() {
        ...
        this.__P_101_3.push(activeWidget);
        this.__P_101_4.push(focusedWidget);
        if (activeWidget) {
      ...
      _restoreActiveWidget: function _restoreActiveWidget() {
        var widget;
        var focusElementsLength = this.__P_101_4.length;
        if (focusElementsLength > 0) {
          widget = this.__P_101_4.pop();
          if (widget && !widget.isDisposed() && widget.isFocusable()) {
            widget.focus();
          }
        }
        var activeElementsLength = this.__P_101_3.length;
        if (activeElementsLength > 0) {
          widget = this.__P_101_3.pop();
       ...
       */
      __P_101_12: function __P_101_12() {
      ...
      getBlockerElement: function getBlockerElement(widget) {
        if (!this.__P_101_5) {
          this.__P_101_5 = this.__P_101_12();
          this.__P_101_5.setStyle("zIndex", 15);
          if (!widget) {
            if (this._isRoot) {
              widget = this._widget;
            } else {
          ...
          widget.getContentElement().add(this.__P_101_5);
          this.__P_101_5.exclude();
        }
      ...
      _block: function _block(zIndex, blockContent) {
        if (!this._isRoot && !this._widget.getLayoutParent()) {
          if (!this.__P_101_9) {
            this.__P_101_9 = this._widget.addListenerOnce("appear", this._block.bind(this, zIndex, blockContent));
          }
          return;
        }
        var parent;
        ...
        if (this.__P_101_6 < 2) {
          ...
          this.__P_101_7 = blockContent === true;
          ...
          blocker.addListener("deactivate", this.__P_101_13, this);
          blocker.addListener("keypress", this.__P_101_14, this);
          blocker.addListener("keydown", this.__P_101_14, this);
          blocker.addListener("keyup", this.__P_101_14, this);
      ...
      unblock: function unblock() {
        if (this.__P_101_9) {
          this._widget.removeListenerById(this.__P_101_9);
          this.__P_101_9 = null;
        }
        if (!this.isBlocked()) {
          return;
       ...
       */
      __P_101_15: function __P_101_15() {
        this._restoreActiveWidget();
        var blocker = this.getBlockerElement();
        blocker.removeListener("deactivate", this.__P_101_13, this);
        blocker.removeListener("keypress", this.__P_101_14, this);
        blocker.removeListener("keydown", this.__P_101_14, this);
        blocker.removeListener("keyup", this.__P_101_14, this);
        blocker.exclude();

        // Reset blocking content state
        this.__P_101_7 = false;
       ...
       */
      __P_101_14: function __P_101_14(e) {
       ...
       */
      __P_101_13: function __P_101_13() {
        //
    ...
    */
    destruct: function destruct() {
      ...
      if (true && this.__P_101_2) {
        qx.theme.manager.Meta.getInstance().removeListenerById(this.__P_101_2);
      }
      this._widget.removeListener("resize", this.__P_101_0, this);
      this._widget.removeListener("move", this.__P_101_0, this);
      this._widget.removeListener("appear", this.__P_101_10, this);
      this._widget.removeListener("disappear", this.__P_101_1, this);
      if (this.__P_101_9) {
        this._widget.removeListenerById(this.__P_101_9);
      }
      this._disposeObjects("__P_101_5", "__P_101_8");
      this.__P_101_3 = this.__P_101_4 = this._widget = null;
    }
  });
