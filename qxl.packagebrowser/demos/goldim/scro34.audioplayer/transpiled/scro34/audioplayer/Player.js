(function () {
  var $$dbClassInfo = {
    "dependsOn": {
      ...
      "scro34.audioplayer.toolbar.Button": {},
      "scro34.audioplayer.toolbar.CheckBox": {},
      "qx.ui.toolbar.ToolBar": {},
      "qx.ui.form.List": {},
      "scro34.audioplayer.Separator": {},
  ...
  ************************************************************************ */
  ...
  qx.Class.define("scro34.audioplayer.Player", {
    ...
    members: {
      ...
      _playlistUrl: null,
      _uri: null,
      _applyPlaylist: function _applyPlaylist(url) {
      ...
      _createPlayBar: function _createPlayBar() {
        ...
        var btnSkipBackward = this._btnSkipBackward = new scro34.audioplayer.toolbar.Button("MEDIA_PLAYER_SKIP_BACK").set({
          enabled: false,
          toolTip: new qx.ui.tooltip.ToolTip("Previous song")
        });
        btnSkipBackward.addListener("execute", this._onSkipBackward, this);
        var btnSkipForward = this._btnSkipForward = new scro34.audioplayer.toolbar.Button("MEDIA_PLAYER_SKIP_FORWARD").set({
          enabled: false,
          toolTip: new qx.ui.tooltip.ToolTip("Next song")
        });
        btnSkipForward.addListener("execute", this._onSkipForward, this);
        var btnPlay = this._btnPlay = new scro34.audioplayer.toolbar.CheckBox("MEDIA_PLAYER_START", "MEDIA_PLAYER_PAUSE").set({
          enabled: false,
      ...
      _createVolumeControl: function _createVolumeControl() {
        var volumeIcon = this._volumeIcon = new qx.ui.basic.Image(scro34.audioplayer.IconFactory.getInstance().getIcon("MEDIA_PLAYER_LEVEL_50")).set({
          enabled: false
        });
      ...
      _createInfoBar: function _createInfoBar() {
        ...
        var btnHomepage = this._btnHomepage = new scro34.audioplayer.toolbar.Button("GO_HOME").set({
          enabled: false
        });
        ...
        var btnWikipedia = this._btnWikipedia = new scro34.audioplayer.toolbar.Button("WIKIPEDIA").set({
          enabled: false
        });
        ...
        var btnVideo = this._btnVideo = new scro34.audioplayer.toolbar.Button("YOUTUBE").set({
          enabled: false
        });
      ...
      _onPlay: function _onPlay(e) {
        ...
        if (pressed) {
          ...
          var decorator = qx.theme.manager.Decoration.getInstance().resolve("slider-knob-hovered");
          if (decorator) {
          ...
          this._btnPlay.pause();
          this._audio.pause();
          var _decorator = qx.theme.manager.Decoration.getInstance().resolve("slider-knob");
          if (_decorator) {
            this._positionKnob.setDecorator(_decorator);
          }
  ...
  scro34.audioplayer.Player.$$dbClassInfo = $$dbClassInfo;
})();
