  ...
  ************************************************************************ */
  ...
  qx.Class.define("scro34.audioplayer.WebBrowser", {
    ...
    construct: function construct() {
      scro34.audioplayer.Window.constructor.call(this);
    ...
    */
    ...
    members: {
      ...
      _createToolbar: function _createToolbar() {
        ...
        var btnBack = new scro34.audioplayer.toolbar.Button("WEB_BROWSER_PREVIOUS");
        btnBack.addListener("execute", function (e) {
          // this.iframe.getWindow().history.back();
        });
        toolbar.add(btnBack);
        var btnForward = new scro34.audioplayer.toolbar.Button("WEB_BROWSER_NEXT");
        ...
        var btnGo = new scro34.audioplayer.toolbar.Button("WEB_BROWSER_GO");
  ...
  scro34.audioplayer.WebBrowser.$$dbClassInfo = $$dbClassInfo;
})();
