  ...
  ************************************************************************ */
  ...
  qx.Class.define("qxl.widgetbrowser.pages.Window", {
    ...
    construct: function construct() {
      ...
      this.__P_229_0 = new qx.ui.window.Desktop().set({
        decorator: decorator
      });
      this.add(this.__P_229_0, {
        edge: 0,
        top: 0
      });
      this.initWidgets();
    ...
    members: {
      ...
      __P_229_4: function __P_229_4() {
        ...
        wm1.setModal(true);
        wm1.moveTo(150, 150);
        this.__P_229_0.add(wm1);
        var wm2 = this.__P_229_5();
