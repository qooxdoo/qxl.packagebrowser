  ...
  ************************************************************************ */
  ...
  qx.Mixin.define("qx.ui.form.MForm", {
    construct: function construct() {
      {
        this.__P_194_0 = qx.locale.Manager.getInstance().addListener("changeLocale", this.__P_194_1, this);
      }
    },
    properties: {
      /**
    ...
    members: {
       ...
       */
      __P_194_1: qx.core.Environment.select("qx.dynlocale", {
    ...
    destruct: function destruct() {
      if (true && this.__P_194_0) {
        qx.locale.Manager.getInstance().removeListenerById(this.__P_194_0);
      }
    }
  });
