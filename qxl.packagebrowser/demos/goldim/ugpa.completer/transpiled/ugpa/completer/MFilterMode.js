    ...
    members: {
      ...
      filterByInput: function filterByInput(input, source) {
        ...
        if (this.getCaseSensitivity() === "insensitive") {
          values = this.__P_98_2(input, source);
        } else {
          values = this.__P_98_3(input, source);
        }
        return values;
      },
      __P_98_2: function __P_98_2(input, source) {
        var _this = this;
        input = input.toLowerCase();
        return source.filter(function (value) {
          value = _this.__P_98_4(value);
          value = value.toLowerCase();
          return _this.__P_98_0(input)(value);
        }, this);
      },
      __P_98_3: function __P_98_3(input, source) {
        var _this2 = this;
        return source.filter(function (value) {
          value = _this2.__P_98_4(value);
          return _this2.__P_98_0(input)(value);
        }, this);
      },
      __P_98_4: function __P_98_4(value) {
