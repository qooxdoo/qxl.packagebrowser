    ...
    members: {
      ...
      resolve: function resolve(value) {
        ...
        if (theme !== null && theme.fonts[value]) {
          var createdFonts = this.__P_86_0(theme.fonts);
       ...
       */
      __P_86_2: function __P_86_2(fonts, fontName) {
       ...
       */
      __P_86_0: function __P_86_0(fontDefs) {
        var _this = this;
        var webFontDefs = [];
        var createdFonts = {};
        var _loop = function _loop() {
            ...
            if (fontDef.include && fontDefs[fontDef.include]) {
              _this.__P_86_2(fontDefs, fontId);
            }
            if (fontDef.fontName) {
            ...
            fontClass = _this.__P_86_1(fontDef);
       ...
       * @return {Class}
       */
      __P_86_1: function __P_86_1(config) {
