    ...
    members: {
      ...
      */
      ...
      _initObserver: function _initObserver() {
        ...
        this.__P_208_2 = qx.bom.Event.supportsEvent(this.__P_208_1, "orientationchange") ? "orientationchange" : "resize";
        var Event = qx.bom.Event;
        Event.addNativeListener(this.__P_208_1, this.__P_208_2, this.__P_208_3);
      },
      /*
      ---------------------------------------------------------------------------
        OBSERVER STOP
      ...
      */
      ...
      _stopObserver: function _stopObserver() {
        var Event = qx.bom.Event;
        Event.removeNativeListener(this.__P_208_1, this.__P_208_2, this.__P_208_3);
      },
      /*
      ---------------------------------------------------------------------------
      ...
      */
      ...
      _onOrientationChange: function _onOrientationChange(domEvent) {
        ...
        if (this._currentOrientation != orientation) {
          ...
          qx.event.Registration.fireEvent(this.__P_208_1, "orientationchange", qx.event.type.Orientation, [orientation, mode]);
        }
      }
    },
    /*
