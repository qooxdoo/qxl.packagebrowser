  ...
  qx.Class.define("qx.event.handler.Offline", {
    ...
    members: {
      ...
      */
      ...
      _initObserver: function _initObserver() {
        this.__P_189_2 = qx.lang.Function.listener(this._onNative, this);
        qx.bom.Event.addNativeListener(this.__P_189_1, "offline", this.__P_189_2);
        qx.bom.Event.addNativeListener(this.__P_189_1, "online", this.__P_189_2);
      },
      /**
       * Disconnects the native online and offline event listeners.
       */
      _stopObserver: function _stopObserver() {
        qx.bom.Event.removeNativeListener(this.__P_189_1, "offline", this.__P_189_2);
        qx.bom.Event.removeNativeListener(this.__P_189_1, "online", this.__P_189_2);
      },
      /**
      ...
      _onNative: qx.event.GlobalError.observeMethod(function (domEvent) {
        qx.event.Registration.fireEvent(this.__P_189_1, domEvent.type, qx.event.type.Event, []);
      }),
      /*
      ---------------------------------------------------------------------------
        USER ACCESS
      ...
      */
      ...
      isOnline: function isOnline() {
        return !!this.__P_189_1.navigator.onLine;
      }
    },
    /*
    *****************************************************************************
    ...
    */
    destruct: function destruct() {
      ...
      // Deregister
      delete qx.event.handler.Appear.__P_189_3[this.toHashCode()];
    },
    /*
    *****************************************************************************
       DEFER
