  ...
  qx.Bootstrap.define("qx.Interface", {
    statics: {
      ...
      */
       ...
       */
      __P_13_0: function __P_13_0(object, clazz, iface, wrap, shouldThrow) {
        // Validate members
       ...
       *   system.
       */
      __P_13_1: function __P_13_1(clazz, methodName) {
       ...
       */
      __P_13_3: function __P_13_3(clazz, iface, shouldThrow) {
        if (iface.$$properties) {
       ...
       */
      __P_13_4: function __P_13_4(clazz, iface, shouldThrow) {
        if (iface.$$events) {
      ...
      assertObject: function assertObject(object, iface) {
        ...
        this.__P_13_4(clazz, iface, true);
      ...
      */
       ...
       */
      __P_13_2: qx.core.Environment.select("qx.debug", {
      ...
      __P_13_5: qx.core.Environment.select("qx.debug", {
        "true": {
          extend: "object",
          // Interface | Interface[]
          statics: "object",
       ...
       */
      __P_13_6: qx.core.Environment.select("qx.debug", {
