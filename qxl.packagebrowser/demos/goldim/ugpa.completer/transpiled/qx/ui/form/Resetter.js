    ...
    members: {
      ...
      remove: function remove(field) {
        ...
        for (var i = 0; i < this.__P_47_0.length; i++) {
          var storedItem = this.__P_47_0[i];
          if (storedItem.item === field) {
            this.__P_47_0.splice(i, 1);
            return true;
          }
        }
        return false;
      ...
      redefine: function redefine() {
        ...
        for (var i = 0; i < this.__P_47_0.length; i++) {
          var item = this.__P_47_0[i].item;
          // set the new init value for the item
          this.__P_47_0[i].init = item.getValue();
        }
      },
      /**
       ...
       * @private
       */
      __P_47_1: function __P_47_1(field) {
