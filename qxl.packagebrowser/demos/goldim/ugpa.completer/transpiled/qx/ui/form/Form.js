  ...
  qx.Class.define("qx.ui.form.Form", {
    ...
    members: {
      ...
      */
      ...
      add: function add(item, label, validator, name, validatorContext, options) {
        ...
        this.__P_9_0[this._groupCounter].items.push(item);
        this.__P_9_0[this._groupCounter].labels.push(label);
        this.__P_9_0[this._groupCounter].options.push(options);
        // if no name is given, use the label without not working character
        if (name == null) {
          name = label.replace(/\s+|&|-|\+|\*|\/|\||!|\.|,|:|\?|;|~|%|\{|\}|\(|\)|\[|\]|<|>|=|\^|@|\\/g, "");
        }
        this.__P_9_0[this._groupCounter].names.push(name);
    ...
    */
    destruct: function destruct() {
      ...
      this.__P_9_0 = this._buttons = this._buttonOptions = null;
