  ...
  ************************************************************************ */
  ...
  qx.Mixin.define("qx.ui.virtual.selection.MModel", {
    construct: function construct() {
      ...
      this.__P_99_0 = new qx.data.Array();
      this.__P_99_0.addListener("change", this._onChangeSelection, this);
      this._applySelection(this.__P_99_0, null);
    },
    properties: {
    ...
    members: {
      ...
      */
       ...
       */
      __P_99_5: function __P_99_5(newSelection) {
        var selection = this.getSelection();
