  ...
  qx.Class.define("qx.ui.virtual.layer.Abstract", {
    ...
    */
    ...
    members: {
      ...
      syncWidget: function syncWidget(jobs) {
        ...
        if (this.__P_190_0.fullUpdate || this.__P_190_0.updateLayerWindow && this.__P_190_0.updateLayerData) {
          this._fullUpdate.apply(this, this.__P_190_1);
        } else if (this.__P_190_0.updateLayerWindow) {
          this._updateLayerWindow.apply(this, this.__P_190_1);
        } else if (this.__P_190_0.updateLayerData && this.__P_190_4) {
          this._updateLayerData();
        }
        if (this.__P_190_0.fullUpdate || this.__P_190_0.updateLayerWindow) {
          var args = this.__P_190_1;
          this.__P_190_2 = args[0];
          this.__P_190_3 = args[1];
          this.__P_190_4 = args[2];
          this.__P_190_5 = args[3];
        }
        this.__P_190_0 = {};
      },
      /**
      ...
      _updateLayerData: function _updateLayerData() {
        this._fullUpdate(this.__P_190_2, this.__P_190_3, this.__P_190_4, this.__P_190_5);
      },
      /**
    ...
    */
    destruct: function destruct() {
      this.__P_190_0 = this.__P_190_1 = this.__P_190_4 = this.__P_190_5 = null;
    }
  });
