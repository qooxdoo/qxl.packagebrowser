(function () {
  ...
  ************************************************************************ */
    ...
    appearances: {
      ...
      */
      ...
      "button": {
        ...
        style: function style(states) {
          return {
            padding: states.pressed || states.checked || states.checked && states.disabled ? [4, 4, 0, 6] : [2, 6, 2, 4],
      ...
      "button-simple": {
        ...
        style: function style(states) {
          return {
            padding: states.pressed || states.checked || states.checked && states.disabled ? [4, 2, 2, 4] : [3],
            decorator: states.disabled ? "button-simple-disabled" : states.pressed || states.checked ? "button-simple-checked" : states.hovered ? "button-simple-hovered" : "button-simple",
      ...
      */
      ...
      "splitbutton/button": {
        ...
        style: function style(states) {
          return {
            padding: states.pressed || states.checked || states.checked && states.disabled ? [4, 2, 2, 4] : [3],
            decorator: states.disabled ? "splitbutton-disabled" : states.pressed || states.checked ? "splitbutton-checked" : states.hovered ? "splitbutton-hovered" : "splitbutton",
            textColor: "text-button",
            center: true
          };
        }
      ...
      "splitbutton/arrow": {
        ...
        style: function style(states) {
          return {
            ...
            decorator: states.disabled ? "splitbutton-right-disabled" : states.pressed || states.checked ? "splitbutton-right-checked" : states.hovered ? "splitbutton-right-hovered" : "splitbutton-right",
            marginLeft: 1,
            marginRight: 1
          };
        }
      ...
      */
      ...
      "slider/knob": {
        style: function style(states) {
          return {
            decorator: states.disabled ? "slider-knob-disabled" : states.pressed ? "slider-knob-pressed" : states.hovered ? "slider-knob-hovered" : "slider-knob",
            maxHeight: 16,
            maxWidth: 16,
            cursor: states.disabled ? "default" : "pointer"
          };
      ...
      "slidebar/button-forward": {
        ...
        style: function style(states) {
          return {
            padding: 5,
            center: true,
            icon: states.vertical ? "decoration/arrows/down-invert.png" : "decoration/arrows/right-invert.png"
          };
        }
      },
      "slidebar/button-backward": {
        ...
        style: function style(states) {
          return {
            padding: 5,
            center: true,
            icon: states.vertical ? "decoration/arrows/up-invert.png" : "decoration/arrows/left-invert.png"
          };
        }
      },
      ...
      "table-header-cell": {
        ...
        style: function style(states) {
          return {
            ...
            sortIcon: states.sorted ? states.sortedAscending ? "decoration/arrows/down-invert.png" : "decoration/arrows/up-invert.png" : undefined
          };
        }
      },
      ...
      */
      ...
      "toolbar-button": {
        ...
        style: function style(states) {
          return {
            ...
            decorator: states.pressed || states.checked ? states.disabled ? "toolbar-button-checked-disabled" : "toolbar-button-checked" : states.hovered && !states.disabled ? "toolbar-button-hovered" : undefined,
            textColor: "text-button"
          };
        }
      },
      "toolbar-button-light": {
        ...
        style: function style(states) {
          return {
            padding: states.pressed || states.checked ? [6, 4, 4, 6] : [6, 6, 6, 6],
            margin: states.pressed || states.checked ? [0] : [0],
            decorator: states.pressed || states.checked ? "toolbar-button-light-checked" : states.hovered && !states.disabled ? "toolbar-button-light-hovered" : undefined,
            textColor: "text-button"
          };
        }
      },
      ...
      "toolbar-splitbutton/button": {
        style: function style(states) {
          return {
            ...
            decorator: states.pressed || states.checked && !states.hovered || states.checked && states.disabled ? "toolbar-button-checked" : states.hovered && !states.disabled ? "toolbar-splitbutton-hovered" : undefined
          };
        }
      },
      "toolbar-splitbutton/arrow": {
        style: function style(states) {
          return {
            icon: "decoration/arrows/down-invert.png",
            padding: states.pressed || states.checked ? [6, 4, 4, 5] : states.hovered && !states.disabled ? [6, 5, 6, 5] : [6, 5, 6, 7],
            decorator: states.pressed || states.checked && !states.hovered || states.checked && states.disabled ? "toolbar-button-checked" : states.hovered && !states.disabled ? "toolbar-splitbutton-arrow-hovered" : undefined
          };
        }
      },
      "toolbar-splitbutton-light/button": {
        style: function style(states) {
          return {
            padding: states.pressed || states.checked ? [6, 5, 4, 6] : [6, 6, 6, 6],
            decorator: states.pressed || states.checked && !states.hovered || states.checked && states.disabled ? "toolbar-button-light-checked" : states.hovered && !states.disabled ? "toolbar-splitbutton-light-hovered" : undefined
          };
        }
      },
      "toolbar-splitbutton-light/arrow": {
        style: function style(states) {
          return {
            icon: "decoration/arrows/down-invert.png",
            padding: states.pressed || states.checked ? [6, 4, 4, 5] : states.hovered && !states.disabled ? [6, 5, 6, 5] : [6, 5, 6, 7],
            decorator: states.pressed || states.checked && !states.hovered || states.checked && states.disabled ? "toolbar-button-light-checked" : states.hovered && !states.disabled ? "toolbar-splitbutton-light-arrow-hovered" : undefined
          };
        }
      },
      "toolbar-separator": {
  ...
  scro34.theme.dark.Appearance.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=Appearance.js.map?dt=1626056183920