(function () {
  ...
  ************************************************************************ */
    ...
    appearances: {
      ...
      */
      ...
      "menu-slidebar/button-backward": {
        ...
        style: function style(states) {
          return {
            icon: scro34.theme.graydient.Image.URLS["arrow-up" + (states.hovered ? "-invert" : "")]
          };
        }
      },
      "menu-slidebar/button-forward": {
        ...
        style: function style(states) {
          return {
            icon: scro34.theme.graydient.Image.URLS["arrow-down" + (states.hovered ? "-invert" : "")]
          };
        }
      },
      "menu-separator": {
      ...
      "menu-button/arrow": {
        ...
        style: function style(states) {
          return {
            source: scro34.theme.graydient.Image.URLS["arrow-right" + (states.selected ? "-invert" : "")],
            alignY: "middle",
            marginLeft: 10
          };
        }
      ...
      "menu-checkbox": {
        ...
        style: function style(states) {
          return {
            icon: !states.checked ? undefined : scro34.theme.graydient.Image.URLS["menu-checkbox" + (states.selected ? "-invert" : "")]
          };
        }
      },
      "menu-radiobutton": {
        ...
        style: function style(states) {
          return {
            icon: !states.checked ? undefined : scro34.theme.graydient.Image.URLS["menu-radiobutton" + (states.selected ? "-invert" : "")]
          };
        }
      },
      ...
      "splitpane/splitter/knob": {
        style: function style(states) {
          return {
            ...
            source: states.horizontal ? scro34.theme.graydient.Image.URLS["knob-horizontal"] : scro34.theme.graydient.Image.URLS["knob-vertical"]
          };
        }
      },
      "splitpane/slider": {
      ...
      "table-header-cell": {
        ...
        style: function style(states) {
          return {
            ...
            margin: 0,
            cursor: states.disabled ? "default" : "pointer",
            sortIcon: states.sorted ? scro34.theme.graydient.Image.URLS["table-" + (states.sortedAscending ? "ascending" : "descending")] : undefined
          };
        }
      },
      ...
      */
      ...
      "tabview-page/button/close-button": {
        ...
        style: function style(states) {
          return {
            cursor: states.disabled ? undefined : "pointer",
            icon: states.hovered ? scro34.theme.graydient.Image.URLS["tabview-close-hovered"] : scro34.theme.graydient.Image.URLS["tabview-close"]
          };
        }
      },
  ...
  scro34.theme.graydient.Appearance.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=Appearance.js.map?dt=1626056184453