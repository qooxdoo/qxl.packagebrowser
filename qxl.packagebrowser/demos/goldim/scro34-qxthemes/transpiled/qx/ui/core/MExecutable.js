    ...
    */
    members: {
      ...
      _applyCommand: function _applyCommand(value, old) {
        ...
        if (value != null) {
          this.__P_78_2 = value.addListener("execute", this.__P_78_3, this);
        } // binding stuff


        var ids = this.__P_78_0;
...
//# sourceMappingURL=MExecutable.js.map?dt=1626056194631