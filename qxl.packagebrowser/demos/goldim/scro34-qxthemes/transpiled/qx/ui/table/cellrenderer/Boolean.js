  ...
  qx.Class.define("qx.ui.table.cellrenderer.Boolean", {
    ...
    */
    members: {
      ...
      _applyIconTrue: function _applyIconTrue(value) {
        this.__P_41_1 = this.__P_41_0.resolve(value);
      },
      // property apply
      ...
      _identifyImage: function _identifyImage(cellInfo) {
        ...
        if (rm.has(this.__P_41_1)) {
          id = this.__P_41_1;
        } else {
          ids = rm.getIds(this.__P_41_1); // If ID was found, we'll use its first (likely only) element here.
    ...
    */
    destruct: function destruct() {
      this.__P_41_0 = null; // remove dynamic theme listener
...
//# sourceMappingURL=Boolean.js.map?dt=1626056190195