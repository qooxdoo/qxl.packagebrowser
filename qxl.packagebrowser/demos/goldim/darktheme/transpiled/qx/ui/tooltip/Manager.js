  ...
  qx.Class.define("qx.ui.tooltip.Manager", {
    ...
    */
    construct: function construct() {
      ...
      qx.event.Registration.addListener(document.body, "pointerover", this.__P_187_0, this, true); // Instantiate timers

      this.__P_187_1 = new qx.event.Timer();

      this.__P_187_1.addListener("interval", this.__P_187_2, this);

      this.__P_187_3 = new qx.event.Timer();

      this.__P_187_3.addListener("interval", this.__P_187_4, this); // Init pointer position
    ...
    */
    members: {
      ...
      getSharedTooltip: function getSharedTooltip() {
        if (!this.__P_187_6) {
          this.__P_187_6 = new qx.ui.tooltip.ToolTip().set({
            rich: true
          });
        }

        return this.__P_187_6;
      },
      ...
      getSharedErrorTooltip: function getSharedErrorTooltip() {
        if (!this.__P_187_7) {
          this.__P_187_7 = new qx.ui.tooltip.ToolTip().set({
            appearance: "tooltip-error",
            rich: true
          });

          this.__P_187_7.setLabel(""); // trigger label widget creation


          this.__P_187_7.syncAppearance();
        }
      ...
      */
      ...
      _applyCurrent: function _applyCurrent(value, old) {
        ...
        if (value) {
          this.__P_187_1.startWith(value.getShowTimeout()); // Register hide handler


          Registration.addListener(el, "pointerout", this.__P_187_8, this, true);
          Registration.addListener(el, "focusout", this.__P_187_9, this, true);
          Registration.addListener(el, "pointermove", this.__P_187_10, this, true);
        } else {
          // Deregister hide handler
          Registration.removeListener(el, "pointerout", this.__P_187_8, this, true);
          Registration.removeListener(el, "focusout", this.__P_187_9, this, true);
          Registration.removeListener(el, "pointermove", this.__P_187_10, this, true);
        }
      },
      ...
      */
       ...
       */
      __P_187_2: function __P_187_2(e) {
        var current = this.getCurrent();

        if (current && !current.isDisposed()) {
          this.__P_187_3.startWith(current.getHideTimeout());

          if (current.getPlaceMethod() == "widget") {
            current.placeToWidget(current.getOpener());
          } else {
            current.placeToPoint(this.__P_187_5);
          }
       ...
       * @param e {qx.event.type.Event} Event object
       */
      __P_187_4: function __P_187_4(e) {
        var current = this.getCurrent();
      ...
      */
       ...
       */
      __P_187_0: function __P_187_0(e) {
    ...
    */
    destruct: function destruct() {
      // Deregister events
      qx.event.Registration.removeListener(document.body, "pointerover", this.__P_187_0, this, true); // Dispose timers

      this._disposeObjects("__P_187_1", "__P_187_3", "__P_187_6");
...
//# sourceMappingURL=Manager.js.map?dt=1626056050816