  ...
  qx.Class.define("qx.event.handler.Mouse", {
    ...
    */
    ...
    construct: function construct(manager) {
      ...
      this.__P_208_2 = this.__P_208_1.document; // Initialize observers
    ...
    */
    members: {
      ...
      */
       ...
       */
      __P_208_9: function __P_208_9(domEvent, type, target) {
        if (!target) {
      ...
      */
      ...
      _initButtonObserver: function _initButtonObserver() {
        this.__P_208_3 = qx.lang.Function.listener(this._onButtonEvent, this);
        var Event = qx.bom.Event;
        Event.addNativeListener(this.__P_208_2, "mousedown", this.__P_208_3);
        Event.addNativeListener(this.__P_208_2, "mouseup", this.__P_208_3);
        Event.addNativeListener(this.__P_208_2, "click", this.__P_208_3);
        Event.addNativeListener(this.__P_208_2, "auxclick", this.__P_208_3);
        Event.addNativeListener(this.__P_208_2, "dblclick", this.__P_208_3);
        Event.addNativeListener(this.__P_208_2, "contextmenu", this.__P_208_3);
      },
      ...
      _initMoveObserver: function _initMoveObserver() {
        this.__P_208_4 = qx.lang.Function.listener(this._onMoveEvent, this);
        var Event = qx.bom.Event;
        Event.addNativeListener(this.__P_208_2, "mousemove", this.__P_208_4);
        Event.addNativeListener(this.__P_208_2, "mouseover", this.__P_208_4);
        Event.addNativeListener(this.__P_208_2, "mouseout", this.__P_208_4);
      },
      ...
      _initWheelObserver: function _initWheelObserver() {
        this.__P_208_5 = qx.lang.Function.listener(this._onWheelEvent, this);
        var data = qx.bom.client.Event.getMouseWheel(this.__P_208_1);
        qx.bom.Event.addNativeListener(data.target, data.type, this.__P_208_5);
      },
      ...
      */
      ...
      _stopButtonObserver: function _stopButtonObserver() {
        var Event = qx.bom.Event;
        Event.removeNativeListener(this.__P_208_2, "mousedown", this.__P_208_3);
        Event.removeNativeListener(this.__P_208_2, "mouseup", this.__P_208_3);
        Event.removeNativeListener(this.__P_208_2, "click", this.__P_208_3);
        Event.removeNativeListener(this.__P_208_2, "dblclick", this.__P_208_3);
        Event.removeNativeListener(this.__P_208_2, "contextmenu", this.__P_208_3);
      },
      ...
      _stopMoveObserver: function _stopMoveObserver() {
        var Event = qx.bom.Event;
        Event.removeNativeListener(this.__P_208_2, "mousemove", this.__P_208_4);
        Event.removeNativeListener(this.__P_208_2, "mouseover", this.__P_208_4);
        Event.removeNativeListener(this.__P_208_2, "mouseout", this.__P_208_4);
      },
      ...
      */
      ...
      _onButtonEvent: qx.event.GlobalError.observeMethod(function (domEvent) {
        ...
        if (type == "click" && this.__P_208_8) {
          delete this.__P_208_8;
          return;
        ...
        this.__P_208_9(domEvent, type, target);
        /*
        ...
        if (type == "auxclick" && domEvent.button == 1) {
          this.__P_208_9(domEvent, "click", target);
        }
      ...
      _onWheelEvent: qx.event.GlobalError.observeMethod(function (domEvent) {
        this.__P_208_9(domEvent, "mousewheel");
      }),
      ...
      */
      ...
      __P_208_11: qx.core.Environment.select("engine.name", {
        "opera": function opera(domEvent, type, target) {
          if (type == "mouseup" && domEvent.button == 2) {
            this.__P_208_9(domEvent, "contextmenu", target);
          }
        },
        "default": null
      }),
       ...
       * @signature function(domEvent, type, target)
       */
      __P_208_10: qx.core.Environment.select("engine.name", {
        "mshtml": function mshtml(domEvent, type, target) {
          ...
          if (type == "mouseup" && this.__P_208_6 == "click") {
            this.__P_208_9(domEvent, "mousedown", target);
      ...
      __P_208_12: qx.core.Environment.select("engine.name", {
        ...
        "default": function _default(domEvent, type, target) {
          switch (type) {
            case "mousedown":
              this.__P_208_7 = target;
              break;

            case "mouseup":
              if (target !== this.__P_208_7) {
                var commonParent = qx.dom.Hierarchy.getCommonParent(target, this.__P_208_7);

                if (commonParent) {
                  this.__P_208_9(domEvent, "click", commonParent);
                }
              }
    ...
    */
    destruct: function destruct() {
      ...
      this.__P_208_0 = this.__P_208_1 = this.__P_208_2 = this.__P_208_7 = null;
    },
...
//# sourceMappingURL=Mouse.js.map?dt=1626056053077