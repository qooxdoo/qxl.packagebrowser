  ...
  ************************************************************************ */
  ...
  qx.Class.define("qxl.widgetbrowser.pages.Tab", {
    ...
    construct: function construct() {
      ...
      this.__P_235_0 = new qx.ui.container.Composite(new qx.ui.layout.Grid(10, 20));
      this.add(this.__P_235_0);
      this.initWidgets();
    },
    members: {
      __P_235_0: null,
      initWidgets: function initWidgets() {
        ...
        var tabTop = this.__P_235_1();
        tabTop.setBarPosition("top");
        this.__P_235_0.add(tabTop, {
          row: 0,
          column: 0
        });
        widgets.push(tabTop);
        var tabBottom = this.__P_235_1();
        tabBottom.setBarPosition("bottom");
        this.__P_235_0.add(tabBottom, {
          row: 0,
          column: 1
        });
        widgets.push(tabBottom);
        var tabLeft = this.__P_235_1();
        tabLeft.setBarPosition("left");
        this.__P_235_0.add(tabLeft, {
          row: 1,
          column: 0
        });
        widgets.push(tabLeft);
        var tabRight = this.__P_235_1();
        tabRight.setBarPosition("right");
        this.__P_235_0.add(tabRight, {
          row: 1,
          column: 1
        });
