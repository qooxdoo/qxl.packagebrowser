  ...
  ************************************************************************ */
  ...
  qx.Class.define("qxl.widgetbrowser.pages.Tree", {
    ...
    construct: function construct() {
      ...
      this.__P_231_0 = new qx.ui.container.Composite(new qx.ui.layout.Grid(10));
      this.add(this.__P_231_0);
      this.initWidgets();
    },
    members: {
      __P_231_0: null,
      initWidgets: function initWidgets() {
        ...
        this.__P_231_0.add(label, {
          row: 0,
          column: 0
        });
        var tree = this.__P_231_1();
        this.__P_231_0.add(tree, {
          row: 1,
          column: 0
        });
        widgets.push(tree);
        ...
        var virtualTree = this.__P_231_2();
        this.__P_231_0.add(virtualTree, {
          row: 1,
          column: 1
        });
        ...
        var treeVirtual = this.__P_231_3();
        this.__P_231_0.add(treeVirtual, {
          row: 1,
          column: 2
        });
