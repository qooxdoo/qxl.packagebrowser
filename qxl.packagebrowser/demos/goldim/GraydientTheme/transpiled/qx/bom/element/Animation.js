  ...
  qx.Bootstrap.define("qx.bom.element.Animation", {
    statics: {
      ...
      animate: function animate(el, desc, duration) {
        var onlyCssKeys = qx.bom.element.Animation.__P_267_0(el, desc.keyFrames);
       ...
       */
      __P_267_0: function __P_267_0(el, keyFrames) {
        var keys = [];
...
//# sourceMappingURL=Animation.js.map?dt=1626056137211