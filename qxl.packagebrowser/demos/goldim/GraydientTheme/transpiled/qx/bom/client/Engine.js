  ...
  qx.Bootstrap.define("qx.bom.client.Engine", {
    ...
    statics: {
      ...
      getVersion: function getVersion() {
        ...
        var version = "";
        if (qx.bom.client.Engine.__P_42_0()) {
        ...
        } else if (qx.bom.client.Engine.__P_42_1()) {
        ...
        } else if (qx.bom.client.Engine.__P_42_2()) {
        ...
        } else if (qx.bom.client.Engine.__P_42_3()) {
      ...
      __P_42_0: function __P_42_0() {
        ...
        if (qx.bom.client.Engine.__P_42_4()) {
          return true;
        }
        return false;
      },
