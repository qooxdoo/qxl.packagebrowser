      ...
      */
      ...
      __P_94_15: function __P_94_15(el, source) {
        ...
        if (isFont) {
          ...
          if (this.getScale()) {
            ...
            var font = this.__P_94_20(source);
          ...
          this.__P_94_21(ResourceManager.getImageWidth(source), ResourceManager.getImageHeight(source));
        }
      },
      __P_94_22: function __P_94_22(el, width, height) {
        if (this.getScale()) {
      ...
      _applyDimension: function _applyDimension() {
        ...
        if (isFont) {
          ...
          if (el) {
            ...
            this.__P_94_22(el, width, height);
          }
        } else {
          this.__P_94_21();
        }
      ...
      __P_94_18: function __P_94_18(el, source) {
        ...
        if (!ImageLoader.isFailed(source)) {
          ImageLoader.load(source, this.__P_94_23, this);
        } else {
          this.__P_94_12(el);
        }
      },
      ...
      __P_94_20: function __P_94_20(source) {
      ...
      __P_94_8: function __P_94_8(el, source) {
        ...
        if (isFont) {
          ...
          this.__P_94_22(el, this.__P_94_1, this.__P_94_2);
       ...
       */
      __P_94_23: function __P_94_23(source, imageInfo) {
       ...
       */
      __P_94_21: function __P_94_21(width, height) {
        if (width === undefined) {
          width = this.__P_94_1;
        }
        if (height === undefined) {
