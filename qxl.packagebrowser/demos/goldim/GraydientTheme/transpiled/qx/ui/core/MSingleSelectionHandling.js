      ...
      */
      ...
      setValue: function setValue(item) {
        ...
        if (item instanceof qx.ui.core.Widget) {
          this.__P_162_1().setSelected(item);
      ...
      getValue: function getValue() {
        return this.__P_162_1().getSelected() || null;
      },
      ...
      getSelection: function getSelection() {
        var selected = this.__P_162_1().getSelected();
      ...
      setSelection: function setSelection(items) {
        switch (items.length) {
          ...
          case 1:
            this.__P_162_1().setSelected(items[0]);
      ...
      isSelected: function isSelected(item) {
        return this.__P_162_1().isSelected(item);
      },
      ...
      isSelectionEmpty: function isSelectionEmpty() {
        return this.__P_162_1().isSelectionEmpty();
      },
      ...
      getSelectables: function getSelectables(all) {
        return this.__P_162_1().getSelectables(all);
      },
      ...
      */
      ...
      __P_162_1: function __P_162_1() {
        if (this.__P_162_0 == null) {
          var that = this;
          this.__P_162_0 = new qx.ui.core.SingleSelectionManager({
          ...
          this.__P_162_0.addListener("changeSelected", this._onChangeSelected, this);
        }

        this.__P_162_0.setAllowEmptySelection(this._isAllowEmptySelection());
...
//# sourceMappingURL=MSingleSelectionHandling.js.map?dt=1626056124836