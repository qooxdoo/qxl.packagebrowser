  ...
  qx.Class.define("qx.ui.form.RadioGroup", {
    ...
    */
    ...
    construct: function construct(varargs) {
      ...
      this.addListener("changeSelection", this.__P_183_1, this);
      if (varargs != null) {
    ...
    members: {
      ...
      */
      ...
      _applyInvalidMessage: function _applyInvalidMessage(value, old) {
        for (var i = 0; i < this.__P_183_0.length; i++) {
          this.__P_183_0[i].setInvalidMessage(value);
        }
      },
      // property apply
      _applyValid: function _applyValid(value, old) {
        for (var i = 0; i < this.__P_183_0.length; i++) {
          this.__P_183_0[i].setValid(value);
        }
      },
      // property apply
      ...
      */
      ...
      _isItemSelectable: function _isItemSelectable(item) {
        return this.__P_183_0.indexOf(item) != -1;
      },
      /**
      ...
      __P_183_1: function __P_183_1(e) {
        ...
        if (value) {
          ...
          if (this.__P_183_2() && value.isFocusable()) {
            value.focus();
          }
        }
      },
