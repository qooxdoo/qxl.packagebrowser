  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.ui.form.VirtualComboBox", {
    ...
    construct: function construct(model) {
      ...
      this.__P_103_0 = dropdown.getSelection();

      this.__P_103_0.addListener("change", this.__P_103_1, this);
    ...
    members: {
      ...
      */
       ...
       */
      __P_103_1: function __P_103_1(event) {
        if (this.__P_103_4 == true) {
          return;
        }

        var selected = this.__P_103_0.getItem(0);

        if (selected) {
          selected = this.__P_103_6(selected);
      ...
      */
      ...
      __P_103_5: function __P_103_5() {
        ...
        if (selected === undefined || this.__P_103_6(selected) !== value) {
          ...
          for (var i = 0, l = lookupTable.length; i < l; i++) {
            ...
            var itemLabel = this.__P_103_6(modelItem);
       ...
       */
      __P_103_6: function __P_103_6(modelItem) {
    ...
    destruct: function destruct() {
      ...
      this.__P_103_0.removeListener("change", this.__P_103_1, this);
...
//# sourceMappingURL=VirtualComboBox.js.map?dt=1626056119020