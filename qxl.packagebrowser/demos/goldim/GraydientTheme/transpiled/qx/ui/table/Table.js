  ...
  qx.Class.define("qx.ui.table.Table", {
    ...
    */
    ...
    construct: function construct(tableModel, custom) {
      ...
      this.__P_39_2 = null;
      this.__P_39_3 = null; // add an event listener which updates the table content on locale change
    ...
    */
    members: {
      ...
      getEmptyTableModel: function getEmptyTableModel() {
        if (!this.__P_39_10) {
          this.__P_39_10 = new qx.ui.table.model.Simple();

          this.__P_39_10.setColumns([]);

          this.__P_39_10.setData([]);
        }
      ...
      getTableColumnModel: function getTableColumnModel() {
        if (!this.__P_39_9) {
          var columnModel = this.__P_39_9 = this.getNewTableColumnModel()(this);
      ...
      _applyMetaColumnCounts: function _applyMetaColumnCounts(value, old) {
        ...
        if (value > old) {
          ...
          for (var evName in qx.ui.table.Table.__P_39_4) {
            handlers[evName] = {};
        ...
        if (metaColumnCounts.length > scrollerArr.length) {
          ...
          for (var i = scrollerArr.length; i < metaColumnCounts.length; i++) {
            ...
            for (evName in qx.ui.table.Table.__P_39_4) {
      ...
      _updateTableData: function _updateTableData(firstRow, lastRow, firstColumn, lastColumn, removeStart, removeCount) {
        ...
        if (rowCount != this.__P_39_6) {
          this.__P_39_6 = rowCount;
      ...
      _onScrollY: function _onScrollY(evt) {
        if (!this.__P_39_7) {
          this.__P_39_7 = true; // Set the same scroll position to all meta columns
      ...
      _onColVisibilityChanged: function _onColVisibilityChanged(evt) {
        ...
        if (this.__P_39_8 != null && data.col != null && data.visible != null) {
          this.__P_39_8[data.col].setColumnVisible(data.visible);
        }
      ...
      setFocusedCell: function setFocusedCell(col, row, scrollVisible) {
        if (!this.isEditing() && (col != this.__P_39_2 || row != this.__P_39_3)) {
          if (col === null) {
            col = 0;
          }
      ...
      moveFocusedCell: function moveFocusedCell(deltaX, deltaY) {
        ...
        var row = this.__P_39_3; // could also be undefined [BUG #4676]
      ...
      _updateScrollBarVisibility: function _updateScrollBarVisibility() {
        ...
        for (var i = 0; i < scrollerArr.length; i++) {
          ...
          if (isLast) {
            ...
            if (this.__P_39_11 == null) {
              this.__P_39_11 = scrollerArr[i].getVerticalScrollBarVisible();
              this.__P_39_12 = qx.event.Timer.once(function () {
          ...
          if (isLast && verNeeded != this.__P_39_11) {
      ...
      addListener: function addListener(type, listener, self, capture) {
        if (qx.ui.table.Table.__P_39_4[type]) {
    ...
    */
    destruct: function destruct() {
      ...
      this._disposeObjects("__P_39_1", "__P_39_0", "__P_39_10", "__P_39_10", "__P_39_9", "__P_39_12");

      this._disposeMap("__P_39_8");
    }
  });
  qx.ui.table.Table.$$dbClassInfo = $$dbClassInfo;
})();

//# sourceMappingURL=Table.js.map?dt=1626056111691