  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.core.Object", {
    ...
    */
    ...
    members: {
      __P_25_0: true ? qx.core.Property : null,
      /*
      ---------------------------------------------------------------------------
        BASICS
      ---------------------------------------------------------------------------
      ...
      */
      ...
      clone: function clone() {
        ...
        var user = this.__P_25_0.$$store.user;
        var setter = this.__P_25_0.$$method.set;
        var name;
