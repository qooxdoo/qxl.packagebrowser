  ...
  qx.Bootstrap.define("qx.core.Property", {
    statics: {
      ...
      __P_9_12: function __P_9_12(instance, members, name, variant, code, args) {
        var fn = this.__P_9_13(instance.constructor, name, variant, code, args);
       ...
       * @param variant {String} Method variant.
       */
      __P_9_27: qx.core.Environment.select("qx.debug", {
        "true": function _true(code, config, clazz, name, variant) {
          ...
          if (config.check !== undefined) {
            ...
            code.push("if(");
            if (this.__P_9_1[config.check] !== undefined) {
              code.push("!(", this.__P_9_1[config.check], ")");
