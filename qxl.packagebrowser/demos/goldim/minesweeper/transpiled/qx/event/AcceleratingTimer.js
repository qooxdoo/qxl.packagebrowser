  ...
  ************************************************************************ */
  ...
  qx.Class.define("qx.event.AcceleratingTimer", {
    ...
    construct: function construct() {
      ...
      this.__P_188_0 = new qx.event.Timer(this.getInterval());
      this.__P_188_0.addListener("interval", this._onInterval, this);
    },
    events: {
    ...
    members: {
      ...
      start: function start() {
        this.__P_188_0.setInterval(this.getFirstInterval());
        this.__P_188_0.start();
      },
      /**
       * Stop the timer
       */
      ...
      _onInterval: function _onInterval() {
        this.__P_188_0.stop();
        if (this.__P_188_1 == null) {
          this.__P_188_1 = this.getInterval();
        }
        this.__P_188_1 = Math.max(this.getMinimum(), this.__P_188_1 - this.getDecrease());
        this.__P_188_0.setInterval(this.__P_188_1);
        this.__P_188_0.start();
