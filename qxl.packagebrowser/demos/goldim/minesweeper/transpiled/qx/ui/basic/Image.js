  ...
  qx.Class.define("qx.ui.basic.Image", {
    ...
    members: {
      ...
      */
      ...
      _getContentHint: function _getContentHint() {
        return {
          width: this.__P_114_1 || 0,
          height: this.__P_114_2 || 0
        };
      },
      // overridden
      _applyDecorator: function _applyDecorator(value, old) {
        ...
        this.__P_114_8(el, source);
      },
      // overridden
      _applyTextColor: function _applyTextColor(value) {
        if (this.__P_114_9() === "font") {
          var el = this.getContentElement();
          if (this.__P_114_5) {
            el = el.getChild(0);
          }
      ...
      */
       ...
       */
      __P_114_10: function __P_114_10(mode) {
        this.__P_114_3 = mode;
      },
      /**
       ...
       */
      __P_114_9: function __P_114_9() {
        if (this.__P_114_3 == null) {
          var source = this.getSource();
          ...
          if (this.getScale() && isPng && qx.core.Environment.get("css.alphaimageloaderneeded")) {
            this.__P_114_3 = "alphaScaled";
          } else if (this.getScale()) {
            this.__P_114_3 = "scaled";
          } else {
            this.__P_114_3 = "nonScaled";
          }
        }
       ...
       */
      __P_114_11: function __P_114_11(mode) {
        var scale;
        var tagName;
        ...
        if (mode == "font") {
          ...
          if (qx.core.Environment.get("css.alphaimageloaderneeded")) {
            var wrapper = this.__P_114_5 = new qx.html.Element("div");
            element.connectObject(this);
      ...
      __P_114_7: function __P_114_7() {
        ...
        var mode = this.__P_114_9();
        if (this.__P_114_0[mode] == null) {
          this.__P_114_0[mode] = this.__P_114_11(mode);
        }
        var element = this.__P_114_0[mode];
        if (!this.__P_114_4) {
          this.__P_114_4 = element;
        }
        return element;
      },
      /**
      ...
      _styleSource: function _styleSource() {
        ...
        if (!source) {
          this.__P_114_12(element);
          return;
        }
        this.__P_114_13(source);
        ...
        var contentEl = this.__P_114_14();

        // Detect if the image registry knows this image
        if (ResourceManager.isFontUri(source)) {
          this.__P_114_15(contentEl, source);
          ...
          if (highResolutionSource) {
            ...
            this.__P_114_4.setStyle("background-size", backgroundSize);
          ...
          this.__P_114_17(contentEl, source);
          this.__P_114_16();
        } else {
          this.__P_114_18(contentEl, source);
        }
      },
      /**
      ...
      __P_114_16: function __P_114_16() {
        ...
        qx.bom.AnimationFrame.request(function (rId) {
          ...
          if (rId === this.__P_114_6) {
            this.fireEvent("loaded");
          } else {
            this.fireEvent("aborted");
          }
        }.bind(this, this.__P_114_6));
      },
      /**
       * Returns the content element.
       * @return {qx.html.Image} content element
       */
      __P_114_14: function __P_114_14() {
        var contentEl = this.__P_114_4;
        if (this.__P_114_5) {
       ...
       */
      __P_114_13: qx.core.Environment.select("engine.name", {
        mshtml: function mshtml(source) {
          ...
          if (isFont) {
            this.__P_114_10("font");
          } else if (alphaImageLoader && isPng) {
            if (this.getScale() && this.__P_114_9() != "alphaScaled") {
              this.__P_114_10("alphaScaled");
            } else if (!this.getScale() && this.__P_114_9() != "nonScaled") {
              this.__P_114_10("nonScaled");
            }
          } else {
            if (this.getScale() && this.__P_114_9() != "scaled") {
              this.__P_114_10("scaled");
            } else if (!this.getScale() && this.__P_114_9() != "nonScaled") {
              this.__P_114_10("nonScaled");
            }
          }
          this.__P_114_19(this.__P_114_7());
        },
        "default": function _default(source) {
          var isFont = source && qx.lang.String.startsWith(source, "@");
          if (isFont) {
            this.__P_114_10("font");
          } else if (this.getScale() && this.__P_114_9() != "scaled") {
            this.__P_114_10("scaled");
          } else if (!this.getScale() && this.__P_114_9() != "nonScaled") {
            this.__P_114_10("nonScaled");
          }
       ...
       */
      __P_114_19: function __P_114_19(elementToAdd) {
        var currentContentElement = this.__P_114_4;
        if (currentContentElement != elementToAdd) {
          if (currentContentElement != null) {
            ...
            styles.zIndex = 10;
            var newEl = this.__P_114_5 ? elementToAdd.getChild(0) : elementToAdd;
       ...
       */
      __P_114_15: function __P_114_15(el, source) {
        var ResourceManager = qx.util.ResourceManager.getInstance();
        ...
        if (isFont) {
          ...
          if (this.getScale()) {
            ...
            var font = this.__P_114_20(source);
          ...
          this.__P_114_21(ResourceManager.getImageWidth(source), ResourceManager.getImageHeight(source));
        }
      },
      __P_114_22: function __P_114_22(el, width, height) {
        if (this.getScale()) {
      ...
      _applyDimension: function _applyDimension() {
        ...
        if (isFont) {
          ...
          if (el) {
            ...
            this.__P_114_22(el, width, height);
          }
        } else {
          this.__P_114_21();
        }
       ...
       * @param source {String} source path
       */
      __P_114_17: function __P_114_17(el, source) {
       ...
       * @param source {String} source path
       */
      __P_114_18: function __P_114_18(el, source) {
        var ImageLoader = qx.io.ImageLoader;
        // only try to load the image if it not already failed
        if (!ImageLoader.isFailed(source)) {
          ImageLoader.load(source, this.__P_114_23, this);
        } else {
          this.__P_114_12(el);
        }
      },
       ...
       * @param el {Element} image DOM element
       */
      __P_114_12: function __P_114_12(el) {
        if (el != null) {
      ...
      __P_114_20: function __P_114_20(source) {
       ...
       * @param source {String} source path
       */
      __P_114_8: function __P_114_8(el, source) {
        var isFont = source && qx.lang.String.startsWith(source, "@");
        if (isFont) {
          var ResourceManager = qx.util.ResourceManager.getInstance();
          var font = this.__P_114_20(source);
          ...
          this.__P_114_22(el, this.__P_114_1, this.__P_114_2);
       ...
       */
      __P_114_23: function __P_114_23(source, imageInfo) {
        ...
        // Update image
        this.__P_114_17(this.__P_114_14(), source);
      },
      /**
       ...
       */
      __P_114_21: function __P_114_21(width, height) {
        if (width === undefined) {
          width = this.__P_114_1;
        }
        if (height === undefined) {
          height = this.__P_114_2;
        }
      ...
      _recalc: function _recalc(originalWidth, originalHeight) {
        ...
        if (width != this.__P_114_1 || height != this.__P_114_2) {
          this.__P_114_1 = width;
          this.__P_114_2 = height;
          return true;
        }
        return false;
      }
    ...
    */
    destruct: function destruct() {
      for (var mode in this.__P_114_0) {
        if (this.__P_114_0.hasOwnProperty(mode)) {
          this.__P_114_0[mode].disconnectObject(this);
        }
      }
      delete this.__P_114_4;
      if (this.__P_114_5) {
        delete this.__P_114_5;
      }
      this._disposeMap("__P_114_0");
    }
  });
