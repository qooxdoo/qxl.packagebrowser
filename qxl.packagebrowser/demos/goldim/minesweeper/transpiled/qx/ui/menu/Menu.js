    ...
    members: {
      ...
      */
      ...
      __P_95_2: function __P_95_2() {
        ...
        if (!menuBounds) {
          this.addListenerOnce("resize", this.__P_95_2, this);
          return;
        }
      ...
      syncWidget: function syncWidget(jobs) {
        ...
        if (this.__P_95_1) {
          this.__P_95_1.call(this);
          delete this.__P_95_1;
        }
      },
      /*
      ---------------------------------------------------------------------------
