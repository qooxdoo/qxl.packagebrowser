    ...
    members: {
      ...
      */
      ...
      __P_93_2: function __P_93_2() {
        ...
        if (!menuBounds) {
          this.addListenerOnce("resize", this.__P_93_2, this);
          return;
        }
