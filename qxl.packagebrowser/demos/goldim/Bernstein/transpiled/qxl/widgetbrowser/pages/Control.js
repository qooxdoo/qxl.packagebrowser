  ...
  ************************************************************************ */
  ...
  qx.Class.define("qxl.widgetbrowser.pages.Control", {
    ...
    construct: function construct() {
      ...
      this.__P_236_0 = new qx.ui.container.Composite(new qx.ui.layout.VBox(20));
      this.add(this.__P_236_0, {
        top: 0
      });
      this.initWidgets();
    },
    members: {
      ...
      initWidgets: function initWidgets() {
        ...
        this.__P_236_0.add(label);
        this.__P_236_0.add(colorSelector);
        ...
        this.__P_236_0.add(label);
        this.__P_236_0.add(openColorPopup);
        ...
        this.__P_236_0.add(label);
        this.__P_236_0.add(dateChooser);
      }
    }
  });
