  ...
  ************************************************************************ */
  ...
  qx.Class.define("qxl.widgetbrowser.pages.Embed", {
    ...
    construct: function construct() {
      ...
      this.__P_232_0 = new qx.ui.container.Composite(gridLayout);
    ...
    members: {
      ...
      initWidgets: function initWidgets() {
        ...
        if (qx.core.Environment.get("html.canvas")) {
          ...
          canvas.addListener("redraw", this.__P_232_1, this);
          widgets.push(canvas);
          this.__P_232_0.add(canvas, {
            row: 3,
            column: 0
          });
        } else {
          this.__P_232_0.add(new qx.ui.basic.Label("Browser does not support canvas"), {
            row: 3,
            column: 0
          });
        }
        ...
        this.__P_232_0.add(htmlContainer, {
          row: 3,
          column: 1
        });
      ...
      __P_232_1: function __P_232_1(e) {
        var data = e.getData();
