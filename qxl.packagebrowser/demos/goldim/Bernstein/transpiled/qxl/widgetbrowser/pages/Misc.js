  ...
  ************************************************************************ */
  ...
  qx.Class.define("qxl.widgetbrowser.pages.Misc", {
    ...
    construct: function construct() {
      ...
      this.__P_239_0 = new qx.ui.container.Composite(new qx.ui.layout.VBox(10));
      this.add(this.__P_239_0);
      this.initWidgets();
    },
    members: {
      __P_239_0: null,
      initWidgets: function initWidgets() {
        ...
        widgets.push(pb);
        this.__P_239_0.add(label);
        this.__P_239_0.add(pb);
        ...
        this.__P_239_0.add(label);
        this.__P_239_0.add(subcontainer);
