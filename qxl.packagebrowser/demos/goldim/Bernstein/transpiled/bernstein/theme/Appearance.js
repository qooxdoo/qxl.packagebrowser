(function () {
  ...
  ************************************************************************ */
      ...
      "tabview-page/button": {
        ...
        style: function style(states) {
          ...
          return {
            ...
            textColor: states.disabled ? "text-disabled" : states.checked ? "text-active" : states.hovered ? "text-selected" : "text-label",
  ...
  bernstein.theme.Appearance.$$dbClassInfo = $$dbClassInfo;
})();
