  ...
  qx.Class.define("scro34.themedemo.window.Player", {
    ...
    members: {
      ...
      _createPlayBar: function _createPlayBar() {
        ...
        var btnSkipBackward = this._btnSkipBackward = new scro34.themedemo.toolbar.Button("MEDIA_PLAYER_SKIP_BACK").set({
          enabled: false,
          toolTip: new qx.ui.tooltip.ToolTip("Previous song")
        });
        btnSkipBackward.addListener("execute", this._onSkipBackward, this);
        var btnSkipForward = this._btnSkipForward = new scro34.themedemo.toolbar.Button("MEDIA_PLAYER_SKIP_FORWARD").set({
          enabled: false,
          toolTip: new qx.ui.tooltip.ToolTip("Next song")
        });
        btnSkipForward.addListener("execute", this._onSkipForward, this);
        var btnPlay = this._btnPlay = new scro34.themedemo.toolbar.CheckBox("MEDIA_PLAYER_START", "MEDIA_PLAYER_PAUSE").set({
          enabled: false,
      ...
      _createInfoBar: function _createInfoBar() {
        var _this2 = this;
        var icons = scro34.themedemo.IconFactory.getInstance();
        var btnHomepage = this._btnHomepage = new scro34.themedemo.toolbar.Button("GO_HOME").set({
          enabled: false
        });
        ...
        var btnWikipedia = this._btnWikipedia = new scro34.themedemo.toolbar.Button("WIKIPEDIA").set({
          enabled: false
        });
        ...
        var btnVideo = this._btnVideo = new scro34.themedemo.toolbar.Button("YOUTUBE").set({
          enabled: false
        });
