    ...
    members: {
      ...
      */
      ...
      __P_14_4: function __P_14_4() {
        ...
        var widths = reuse ? this.__P_14_0 : new Array(length);
        var flexs = reuse ? this.__P_14_1 : new Array(length);
        ...
        // Store data
        if (!reuse) {
          this.__P_14_0 = widths;
          this.__P_14_1 = flexs;
        }
        this.__P_14_2 = enableFlex;
        this.__P_14_3 = children;
      ...
      */
      ...
      renderLayout: function renderLayout(availWidth, availHeight, padding) {
        ...
        if (this.__P_14_2 && allocatedWidth != availWidth) {
          var flexibles = {};
          var flex, offset;
