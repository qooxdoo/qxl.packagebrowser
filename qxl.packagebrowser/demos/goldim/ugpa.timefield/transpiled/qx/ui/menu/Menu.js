    ...
    members: {
      ...
      */
      ...
      __P_84_2: function __P_84_2() {
        ...
        if (!menuBounds) {
          this.addListenerOnce("resize", this.__P_84_2, this);
          return;
        }
