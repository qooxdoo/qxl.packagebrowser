  ...
  qx.Class.define("qx.ui.popup.Manager", {
    ...
    */
    construct: function construct() {
      ...
      qx.event.Registration.addListener(document.documentElement, "pointerdown", this.__P_93_1, this, true);
    ...
    */
    ...
    members: {
      ...
      remove: function remove(obj) {
        qx.lang.Array.remove(this.__P_93_0, obj);
        this.__P_93_2();
      },
      /**
      ...
      hideAll: function hideAll() {
        var l = this.__P_93_0.length,
          current = {};
        while (l--) {
          current = this.__P_93_0[l];
    ...
    */
    destruct: function destruct() {
      qx.event.Registration.removeListener(document.documentElement, "pointerdown", this.__P_93_1, this, true);
