    ...
    members: {
      ...
      */
      ...
      __P_20_5: function __P_20_5() {
        ...
        if (!this.__P_20_2 && this.__P_20_0 && qx.$$loader.scriptLoaded) {
      ...
      */
      ...
      _onNativeLoad: function _onNativeLoad() {
        var callback = qx.core.Environment.select("qx.globalErrorHandling", {
          "true": qx.event.GlobalError.observeMethod(this.__P_20_7),
          "false": this.__P_20_7
        });
      ...
      _onNativeUnload: function _onNativeUnload() {
        var callback = qx.core.Environment.select("qx.globalErrorHandling", {
          "true": qx.event.GlobalError.observeMethod(this.__P_20_8),
          "false": this.__P_20_8
        });
        callback.apply(this, arguments);
      },
