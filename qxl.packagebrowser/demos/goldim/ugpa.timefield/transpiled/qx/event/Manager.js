  ...
  qx.Class.define("qx.event.Manager", {
    ...
    */
    ...
    construct: function construct(win, registration) {
      ...
      this.__P_58_0 = win;
      this.__P_58_1 = qx.core.ObjectRegistry.toHashCode(win);
      this.__P_58_2 = registration;
      ...
      this.__P_58_3 = new Map();

      // The handler and dispatcher instances
      this.__P_58_4 = {};
      this.__P_58_5 = {};
      this.__P_58_6 = {};
      this.__P_58_7 = new qx.util.DeferredCall(function () {
        this.__P_58_8 = null;
      }, this);
      this.__P_58_7.$$blackListCleaner = true;
    },
    /*
    *****************************************************************************
       STATICS
    ...
    members: {
      ...
      */
      ...
      getHandler: function getHandler(clazz) {
        var handler = this.__P_58_4[clazz.classname];
        if (handler) {
          return handler;
        }
        return this.__P_58_4[clazz.classname] = new clazz(this);
      },
      /**
      ...
      getDispatcher: function getDispatcher(clazz) {
        var dispatcher = this.__P_58_5[clazz.classname];
        if (dispatcher) {
          return dispatcher;
        }
        return this.__P_58_5[clazz.classname] = new clazz(this, this.__P_58_2);
      },
      /*
      ---------------------------------------------------------------------------
      ...
      */
      ...
      getListeners: function getListeners(target, type, capture) {
        ...
        var targetMap = this.__P_58_3.get(targetKey);
        if (!targetMap) {
          return null;
        }
      ...
      getAllListeners: function getAllListeners() {
        return Object.fromEntries(this.__P_58_3.entries().map(function (_ref) {
        ...
        if (targetMap) {
          ...
          try {
            for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
              ...
              if (enable) {
                this.__P_58_12(target, type, capture);
              } else {
                this.__P_58_13(target, type, capture);
              }
            }
          } catch (err) {
            _iterator2.e(err);
      ...
      importListeners: function importListeners(target, list) {
        ...
        if (!targetMap) {
          targetMap = new Map();
          this.__P_58_3.set(targetKey, targetMap);
        }
        for (var listKey in list) {
          ...
          if (entryMap.size === 0) {
            ...
            this.__P_58_12(target, item.type, item.capture);
          }
      ...
      findHandler: function findHandler(target, type) {
        ...
        var cache = this.__P_58_6;
        if (cache[key]) {
          return cache[key];
        }
        var classes = this.__P_58_2.getHandlers();
       ...
       */
      __P_58_12: function __P_58_12(target, type, capture) {
      ...
      removeAllListeners: function removeAllListeners(target) {
        ...
        this.__P_58_3["delete"](targetKey);
        return true;
      },
      /**
       ...
       * @throws {Error} if there is no handler for the event
       */
      __P_58_13: function __P_58_13(target, type, capture) {
        var handler = this.findHandler(target, type);
        if (handler) {
      ...
      */
      ...
      dispatchEvent: function dispatchEvent(target, event) {
        ...
        var monitors = qx.event.Manager.__P_58_10;
        if (monitors.length) {
        ...
        // Interacion data
        var classes = this.__P_58_2.getDispatchers();
        var instance;
      ...
      dispose: function dispose() {
        ...
        this.__P_58_2.removeManager(this);
        qx.util.DisposeUtil.disposeMap(this, "__P_58_4");
        qx.util.DisposeUtil.disposeMap(this, "__P_58_5");

        // Dispose data fields
        this.__P_58_3 = this.__P_58_0 = this.__P_58_11 = null;
        this.__P_58_2 = this.__P_58_6 = null;
      },
      /**
       ...
       */
      __P_58_14: function __P_58_14(uid) {
        if (this.__P_58_8 === null) {
          this.__P_58_8 = {};
          this.__P_58_7.schedule();
        }
        this.__P_58_8[uid] = true;
      },
      /**
      ...
      isBlacklisted: function isBlacklisted(uid) {
        return this.__P_58_8 !== null && this.__P_58_8[uid] === true;
      }
    }
  });
