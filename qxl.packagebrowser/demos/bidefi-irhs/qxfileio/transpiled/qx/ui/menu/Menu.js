    ...
    members: {
      ...
      */
      ...
      __P_113_2: function __P_113_2() {
        ...
        if (!menuBounds) {
          this.addListenerOnce("resize", this.__P_113_2, this);
          return;
        }
      ...
      syncWidget: function syncWidget(jobs) {
        ...
        if (this.__P_113_1) {
          this.__P_113_1.call(this);
          delete this.__P_113_1;
        }
      },
      /*
      ---------------------------------------------------------------------------
