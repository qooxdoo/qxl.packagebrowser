    ...
    */
    ...
    members: {
      ...
      */
       ...
       */
      __P_94_12: function __P_94_12(mode) {
        this.__P_94_3 = mode;
      },
      /**
       ...
       */
      __P_94_13: function __P_94_13(mode) {
        var scale;
        var tagName;
      ...
      __P_94_9: function __P_94_9() {
        ...
        var mode = this.__P_94_11();
        if (this.__P_94_0[mode] == null) {
          this.__P_94_0[mode] = this.__P_94_13(mode);
        }
      ...
      _styleSource: function _styleSource() {
        ...
        var source = AliasManager.resolve(this.__P_94_8);
        var element = this.getContentElement();
        if (this.__P_94_5) {
          element = element.getChild(0);
        }
        if (!source) {
          this.__P_94_14(element);
          return;
        }
        this.__P_94_15(source);
        ...
        if (ResourceManager.isFontUri(source)) {
          ...
          this.__P_94_19(contentEl, source);
          this.__P_94_18();
        } else {
          this.__P_94_20(contentEl, source);
        }
      },
      /**
       ...
       */
      __P_94_15: qx.core.Environment.select("engine.name", {
        mshtml: function mshtml(source) {
          ...
          if (isFont) {
            ...
            if (this.getScale() && this.__P_94_11() != "alphaScaled") {
              this.__P_94_12("alphaScaled");
            } else if (!this.getScale() && this.__P_94_11() != "nonScaled") {
              this.__P_94_12("nonScaled");
            }
          } else {
            if (this.getScale() && this.__P_94_11() != "scaled") {
              this.__P_94_12("scaled");
            } else if (!this.getScale() && this.__P_94_11() != "nonScaled") {
              this.__P_94_12("nonScaled");
            }
          }
          this.__P_94_21(this.__P_94_9());
        },
        "default": function _default(source) {
          var isFont = source && qx.lang.String.startsWith(source, "@");
          if (isFont) {
            this.__P_94_12("font");
          } else if (this.getScale() && this.__P_94_11() != "scaled") {
            this.__P_94_12("scaled");
          } else if (!this.getScale() && this.__P_94_11() != "nonScaled") {
            this.__P_94_12("nonScaled");
          }
       ...
       */
      __P_94_21: function __P_94_21(elementToAdd) {
      ...
      __P_94_17: function __P_94_17(el, source) {
        ...
        if (isFont) {
          ...
          if (this.getScale()) {
            ...
            var font = this.__P_94_22(source);
          ...
          this.__P_94_23(ResourceManager.getImageWidth(source), ResourceManager.getImageHeight(source));
        }
      },
      __P_94_24: function __P_94_24(el, width, height) {
        if (this.getScale()) {
          el.setStyle("fontSize", (width > height ? height : width) + "px");
        } else {
          var source = qx.util.AliasManager.getInstance().resolve(this.__P_94_8);
      ...
      _applyDimension: function _applyDimension() {
        ...
        var isFont = this.__P_94_8 && qx.lang.String.startsWith(this.__P_94_8, "@");
        if (isFont) {
          var el = this.getContentElement();
          if (el) {
            var hint = this.getSizeHint();
            ...
            this.__P_94_24(el, width, height);
          }
        } else {
          this.__P_94_23();
        }
       ...
       * @param source {String} source path
       */
      __P_94_19: function __P_94_19(el, source) {
       ...
       * @param source {String} source path
       */
      __P_94_20: function __P_94_20(el, source) {
        var ImageLoader = qx.io.ImageLoader;
        // only try to load the image if it not already failed
        if (!ImageLoader.isFailed(source)) {
          ImageLoader.load(source, this.__P_94_25, this);
        } else {
          this.__P_94_14(el);
          if (!this.__P_94_7 && this.getFallbackSource()) {
            this.__P_94_7 = true;
            this.__P_94_8 = this.getFallbackSource();
            this._styleSource();
          }
        }
      },
       ...
       * @param el {Element} image DOM element
       */
      __P_94_14: function __P_94_14(el) {
        if (el != null) {
      ...
      __P_94_22: function __P_94_22(source) {
       ...
       * @param source {String} source path
       */
      __P_94_10: function __P_94_10(el, source) {
        var isFont = source && qx.lang.String.startsWith(source, "@");
        if (isFont) {
          var ResourceManager = qx.util.ResourceManager.getInstance();
          var font = this.__P_94_22(source);
          ...
          this.__P_94_24(el, this.__P_94_1, this.__P_94_2);
       ...
       */
      __P_94_25: function __P_94_25(source, imageInfo) {
        ...
        if (source !== qx.util.AliasManager.getInstance().resolve(this.__P_94_8)) {
          this.fireEvent("aborted");
          return;
        }
        ...
        // Update image
        this.__P_94_19(this.__P_94_16(), source);
      },
      /**
       ...
       */
      __P_94_23: function __P_94_23(width, height) {
        if (width === undefined) {
          width = this.__P_94_1;
        }
        if (height === undefined) {
    ...
    destruct: function destruct() {
      for (var mode in this.__P_94_0) {
        if (this.__P_94_0.hasOwnProperty(mode)) {
          this.__P_94_0[mode].disconnectObject(this);
        }
      }
