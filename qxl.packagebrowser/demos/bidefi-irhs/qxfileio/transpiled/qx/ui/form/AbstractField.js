  ...
  qx.Class.define("qx.ui.form.AbstractField", {
    ...
    statics: {
      ...
      __P_16_2: function __P_16_2() {
        if (qx.ui.form.AbstractField.__P_16_1) {
          return;
        }
        qx.ui.form.AbstractField.__P_16_1 = true;
    ...
    */
    ...
    construct: function construct(value) {
      ...
      this.__P_16_3 = !qx.core.Environment.get("css.placeholder");
      if (value != null) {
        this.setValue(value);
      }
      ...
      if (this.__P_16_3) {
        ...
        qx.ui.form.AbstractField.__P_16_2();
    ...
    members: {
      ...
      */
      ...
      _getContentHint: function _getContentHint() {
        return {
          width: this.__P_16_9.width * 10,
          height: this.__P_16_9.height || 16
        };
      },
      // overridden
      _applyFont: function _applyFont(value, old) {
        if (old && this.__P_16_7 && this.__P_16_8) {
          this.__P_16_7.removeListenerById(this.__P_16_8);
          this.__P_16_8 = null;
        }
        ...
        if (value) {
          ...
          this.__P_16_7 = value;
          if (this.__P_16_7 instanceof qx.bom.webfonts.WebFont && !this.__P_16_7.isValid()) {
            this.__P_16_8 = this.__P_16_7.addListener("changeStatus", this._onWebFontStatusChange, this);
          }
          styles = this.__P_16_7.getStyles();
        } else {
        ...
        // Compute text size
        if (value) {
          this.__P_16_9 = qx.bom.Label.getTextSize("A", styles);
        } else {
          delete this.__P_16_9;
        }
      ...
      */
      ...
      _onHtmlInput: function _onHtmlInput(e) {
        ...
        if (this.__P_16_6 && this.__P_16_6 === value) {
          fireEvents = false;
        }
        ...
        if (this.getFilter() != null) {
          ...
          if (filteredValue != value) {
            fireEvents = this.__P_16_6 !== filteredValue;
            value = filteredValue;
        ...
        if (fireEvents) {
          ...
          this.fireDataEvent("input", value, this.__P_16_6);
          this.__P_16_6 = value;

          // check for the live change event
          if (this.getLiveUpdate()) {
            this.__P_16_10(value);
          }
      ...
      _onWebFontStatusChange: function _onWebFontStatusChange(ev) {
        if (ev.getData().valid === true) {
          var styles = this.__P_16_7.getStyles();
          this.__P_16_9 = qx.bom.Label.getTextSize("A", styles);
          qx.ui.core.queue.Layout.add(this);
        }
      },
       ...
       */
      __P_16_10: function __P_16_10(value) {
        var old = this.__P_16_5;
        this.__P_16_5 = value;
        if (old != value) {
      ...
      */
      ...
      setValue: function setValue(value) {
        ...
        if (qx.lang.Type.isString(value)) {
          ...
          if (elem.getValue() != value) {
            ...
            elem.setValue(value);
            var data = this.__P_16_4 ? null : value;
            this.__P_16_5 = oldValue;
            this.__P_16_10(data);
            // reset the input value on setValue calls [BUG #6892]
            this.__P_16_6 = this.__P_16_5;
          }
      ...
      getValue: function getValue() {
        return this.isDisposed() || this.__P_16_4 ? null : this.getContentElement().getValue();
      },
      /**
      ...
      _onChangeContent: function _onChangeContent(e) {
        this.__P_16_4 = e.getData() === null;
        this.__P_16_10(e.getData());
      },
      /*
      ---------------------------------------------------------------------------
      ...
      */
      ...
      _syncPlaceholder: function _syncPlaceholder() {
        if (this.hasState("showingPlaceholder") && this.__P_16_3) {
      ...
      _onChangeTheme: function _onChangeTheme() {
        ...
        if (!this.__P_16_3 && qx.ui.form.AbstractField.__P_16_0) {
    ...
    */
    destruct: function destruct() {
      ...
      this._placeholder = this.__P_16_7 = null;
      {
        qx.locale.Manager.getInstance().removeListener("changeLocale", this._onChangeLocale, this);
      }
      if (this.__P_16_7 && this.__P_16_8) {
        this.__P_16_7.removeListenerById(this.__P_16_8);
      }
